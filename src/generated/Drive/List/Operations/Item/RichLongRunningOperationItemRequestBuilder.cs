...
namespace ApiSdk.Drive.List.Operations.Item {
    ...
    public class RichLongRunningOperationItemRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.Description = "Delete navigation property operations for drive";
            ...
            command.SetHandler(async (object[] parameters) => {
                var richLongRunningOperationId = (string) parameters[0];
            ...
            }, new CollectionBinding(richLongRunningOperationIdOption, ifMatchOption, new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(richLongRunningOperationIdOption, selectOption, expandOption, outputOption, queryOption, jsonNoIndentOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        ...
        public Command BuildPatchCommand() {
            ...
            command.Description = "Update the navigation property operations in drive";
            // Create options for all the parameters
            var richLongRunningOperationIdOption = new Option<string>("--rich-long-running-operation-id", description: "key: id of richLongRunningOperation") {
            };
            richLongRunningOperationIdOption.IsRequired = true;
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                await RequestAdapter.SendNoContentAsync(requestInfo, errorMapping: errorMapping, cancellationToken: cancellationToken);
                Console.WriteLine("Success");
            }, new CollectionBinding(richLongRunningOperationIdOption, bodyOption, new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
