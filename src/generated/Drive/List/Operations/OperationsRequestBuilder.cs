using ApiSdk.Drive.List.Operations.Count;
using ApiSdk.Drive.List.Operations.Item;
using ApiSdk.Models;
...
namespace ApiSdk.Drive.List.Operations {
    ...
    public class OperationsRequestBuilder {
        ...
        public Command BuildCreateCommand() {
            ...
            command.Description = "Create new navigation property to operations for drive";
