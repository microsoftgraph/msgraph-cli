...
namespace ApiSdk.Drive.List.Subscriptions.Item {
    ...
    public class SubscriptionRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string subscriptionId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, subscriptionIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The set of subscriptions on the list.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string subscriptionId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, subscriptionIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The set of subscriptions on the list.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string subscriptionId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, subscriptionIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
