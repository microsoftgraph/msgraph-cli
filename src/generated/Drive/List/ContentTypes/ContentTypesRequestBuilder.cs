using ApiSdk.Drive.List.ContentTypes.AddCopy;
using ApiSdk.Drive.List.ContentTypes.AddCopyFromContentTypeHub;
using ApiSdk.Drive.List.ContentTypes.Count;
using ApiSdk.Drive.List.ContentTypes.GetCompatibleHubContentTypes;
...
namespace ApiSdk.Drive.List.ContentTypes {
    ...
    public class ContentTypesRequestBuilder {
        ...
        public Command BuildCreateCommand() {
            ...
            command.Description = "Create new navigation property to contentTypes for drive";
