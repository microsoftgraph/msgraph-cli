...
using System.IO;
using System.Linq;
namespace ApiSdk.Drive.List.ContentTypes.Item.IsPublished {
    ...
    public class IsPublishedResponse : IAdditionalDataHolder, IParsable {
        ...
        /// </summary>
        public static ApiSdk.Drive.List.ContentTypes.Item.IsPublished.IsPublishedResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
