...
namespace ApiSdk.Drive.List.ContentTypes.Item.Base.Publish {
    /// <summary>Builds and executes requests for operations under \drive\list\contentTypes\{contentType-id}\base\microsoft.graph.publish</summary>
    public class PublishRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (string contentTypeId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, contentTypeIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        ...
        public PublishRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drive/list/contentTypes/{contentType_id}/base/microsoft.graph.publish";
