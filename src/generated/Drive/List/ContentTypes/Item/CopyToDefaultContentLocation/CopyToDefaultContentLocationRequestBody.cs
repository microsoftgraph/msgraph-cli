...
namespace ApiSdk.Drive.List.ContentTypes.Item.CopyToDefaultContentLocation {
    ...
    public class CopyToDefaultContentLocationRequestBody : IAdditionalDataHolder, IParsable {
        ...
        /// </summary>
        public static ApiSdk.Drive.List.ContentTypes.Item.CopyToDefaultContentLocation.CopyToDefaultContentLocationRequestBody CreateFromDiscriminatorValue(IParseNode parseNode) {
