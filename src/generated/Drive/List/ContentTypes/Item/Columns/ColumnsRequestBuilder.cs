using ApiSdk.Drive.List.ContentTypes.Item.Columns.Count;
using ApiSdk.Drive.List.ContentTypes.Item.Columns.Item;
using ApiSdk.Models;
...
namespace ApiSdk.Drive.List.ContentTypes.Item.Columns {
    ...
    public class ColumnsRequestBuilder {
        ...
        public Command BuildCreateCommand() {
            ...
            command.Description = "Create new navigation property to columns for drive";
