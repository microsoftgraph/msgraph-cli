using ApiSdk.Drive.List.ContentTypes.Item.BaseTypes.AddCopy;
using ApiSdk.Drive.List.ContentTypes.Item.BaseTypes.Ref;
...
namespace ApiSdk.Drive.List.ContentTypes.Item.BaseTypes {
    ...
    public class BaseTypesRequestBuilder {
        ...
        public Command BuildAddCopyCommand() {
            ...
            var builder = new ApiSdk.Drive.List.ContentTypes.Item.BaseTypes.AddCopy.AddCopyRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildRefCommand() {
            ...
            var builder = new ApiSdk.Drive.List.ContentTypes.Item.BaseTypes.@Ref.RefRequestBuilder(PathParameters, RequestAdapter);
