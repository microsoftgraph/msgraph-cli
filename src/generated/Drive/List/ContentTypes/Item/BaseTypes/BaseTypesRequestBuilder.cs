using ApiSdk.Drive.List.ContentTypes.Item.BaseTypes.Count;
using ApiSdk.Drive.List.ContentTypes.Item.BaseTypes.Item;
using ApiSdk.Models;
...
namespace ApiSdk.Drive.List.ContentTypes.Item.BaseTypes {
    ...
    public class BaseTypesRequestBuilder {
        ...
        public Command BuildCommand() {
            ...
            var builder = new ApiSdk.Drive.List.ContentTypes.Item.BaseTypes.Item.ContentTypeItemRequestBuilder(PathParameters, RequestAdapter);
