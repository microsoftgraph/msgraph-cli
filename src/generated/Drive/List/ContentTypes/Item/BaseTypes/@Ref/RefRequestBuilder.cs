...
namespace ApiSdk.Drive.List.ContentTypes.Item.BaseTypes.@Ref {
    ...
    public class RefRequestBuilder {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<ApiSdk.Drive.List.ContentTypes.Item.BaseTypes.@Ref.@Ref> PostAsync(ApiSdk.Drive.List.ContentTypes.Item.BaseTypes.@Ref.@Ref model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
            _ = model ?? throw new ArgumentNullException(nameof(model));
            var requestInfo = CreatePostRequestInformation(model, h, o);
            return await RequestAdapter.SendAsync<ApiSdk.Drive.List.ContentTypes.Item.BaseTypes.@Ref.@Ref>(requestInfo, responseHandler);
        }
