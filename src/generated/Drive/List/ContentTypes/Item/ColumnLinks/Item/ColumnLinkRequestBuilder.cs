...
namespace ApiSdk.Drive.List.ContentTypes.Item.ColumnLinks.Item {
    ...
    public class ColumnLinkRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            }, contentTypeIdOption, columnLinkIdOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// The collection of columns that are required by this content type
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string contentTypeId, string columnLinkId, string[] select, string[] expand, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
            ...
            }, contentTypeIdOption, columnLinkIdOption, selectOption, expandOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// The collection of columns that are required by this content type
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string contentTypeId, string columnLinkId, string body, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                ...
                await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                console.WriteLine("Success");
            }, contentTypeIdOption, columnLinkIdOption, bodyOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
