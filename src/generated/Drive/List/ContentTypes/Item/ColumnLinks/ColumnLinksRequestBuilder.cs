...
namespace ApiSdk.Drive.List.ContentTypes.Item.ColumnLinks {
    ...
    public class ColumnLinksRequestBuilder {
        ...
        public Command BuildListCommand() {
            ...
            command.Handler = CommandHandler.Create<string, int?, int?, string, string, bool?, object, object, object>(async (contentTypeId, top, skip, search, filter, count, orderby, select, expand) => {
