using ApiSdk.Drive.List.ContentTypes.Item.ColumnLinks.Count;
...
namespace ApiSdk.Drive.List.ContentTypes.Item.ColumnLinks {
    ...
    public class ColumnLinksRequestBuilder {
        ...
        public Command BuildCreateCommand() {
            ...
            command.Description = "Create new navigation property to columnLinks for drive";
