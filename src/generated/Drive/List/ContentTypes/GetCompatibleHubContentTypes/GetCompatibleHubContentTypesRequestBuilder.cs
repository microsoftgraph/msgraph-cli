...
namespace ApiSdk.Drive.List.ContentTypes.GetCompatibleHubContentTypes {
    /// <summary>
    ...
    public class GetCompatibleHubContentTypesRequestBuilder {
        ...
        public GetCompatibleHubContentTypesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drive/list/contentTypes/microsoft.graph.getCompatibleHubContentTypes(){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}";
