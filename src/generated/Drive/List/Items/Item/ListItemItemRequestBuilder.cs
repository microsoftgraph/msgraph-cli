...
namespace ApiSdk.Drive.List.Items.Item {
    ...
    public class ListItemItemRequestBuilder {
        ...
        public Command BuildAnalyticsCommand() {
            ...
            var builder = new ApiSdk.Drive.List.Items.Item.Analytics.AnalyticsRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildDeleteCommand() {
            ...
            }, new CollectionBinding(listItemIdOption, new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        public Command BuildDriveItemCommand() {
            var command = new Command("drive-item");
            var builder = new ApiSdk.Drive.List.Items.Item.DriveItem.DriveItemRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildFieldsCommand() {
            ...
            var builder = new ApiSdk.Drive.List.Items.Item.Fields.FieldsRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildDeleteCommand());
            command.AddCommand(builder.BuildGetCommand());
            command.AddCommand(builder.BuildPatchCommand());
            return command;
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(listItemIdOption, selectOption, expandOption, outputOption, queryOption, jsonNoIndentOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// All items contained in the list.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                await RequestAdapter.SendNoContentAsync(requestInfo, errorMapping: default, cancellationToken: cancellationToken);
                Console.WriteLine("Success");
            }, new CollectionBinding(listItemIdOption, bodyOption, new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        public Command BuildVersionsCommand() {
            var command = new Command("versions");
            var builder = new ApiSdk.Drive.List.Items.Item.Versions.VersionsRequestBuilder(PathParameters, RequestAdapter);
