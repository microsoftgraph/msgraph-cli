...
namespace ApiSdk.Drive.List.Items.Item.Versions {
    ...
    public class VersionsRequestBuilder {
        ...
        public Command BuildListCommand() {
            ...
            command.Handler = CommandHandler.Create<string, int?, int?, string, string, bool?, object, object, object>(async (listItemId, top, skip, search, filter, count, orderby, select, expand) => {
