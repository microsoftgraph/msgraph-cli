...
namespace ApiSdk.Drive.List.Items.Item.Versions.Item.Fields {
    ...
    public class FieldsRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            }, listItemIdOption, listItemVersionIdOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// A collection of the fields and values for this version of the list item.
        ...
        public Command BuildGetCommand() {
            ...
            }, listItemIdOption, listItemVersionIdOption, selectOption, expandOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// A collection of the fields and values for this version of the list item.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string listItemId, string listItemVersionId, string body, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                ...
                await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                console.WriteLine("Success");
            }, listItemIdOption, listItemVersionIdOption, bodyOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
