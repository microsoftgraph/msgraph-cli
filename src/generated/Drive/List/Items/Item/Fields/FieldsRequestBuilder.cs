...
namespace ApiSdk.Drive.List.Items.Item.Fields {
    ...
    public class FieldsRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string listItemId, IConsole console) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string listItemId, string[] select, string[] expand, FormatterType output, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string listItemId, string body, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
