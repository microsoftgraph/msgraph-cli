...
namespace ApiSdk.Drive.SearchWithQ {
    ...
    public class SearchWithQRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string q, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, qOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
