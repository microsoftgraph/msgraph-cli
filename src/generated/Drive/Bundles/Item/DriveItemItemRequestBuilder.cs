using ApiSdk.Drive.Bundles.Item.Content;
...
namespace ApiSdk.Drive.Bundles.Item {
    ...
    public class DriveItemItemRequestBuilder {
        ...
        public Command BuildContentCommand() {
            ...
            var builder = new ApiSdk.Drive.Bundles.Item.Content.ContentRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(driveItemIdOption, selectOption, expandOption, outputOption, queryOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// Collection of [bundles][bundle] (albums and multi-select-shared sets of items). Only in personal OneDrive.
