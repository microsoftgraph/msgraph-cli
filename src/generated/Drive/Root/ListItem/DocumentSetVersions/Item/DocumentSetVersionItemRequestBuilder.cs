using ApiSdk.Drive.Root.ListItem.DocumentSetVersions.Item.Restore;
using ApiSdk.Models;
...
namespace ApiSdk.Drive.Root.ListItem.DocumentSetVersions.Item {
    ...
    public class DocumentSetVersionItemRequestBuilder {
        ...
        public DocumentSetVersionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drive/root/listItem/documentSetVersions/{documentSetVersion%2Did}{?%24select,%24expand}";
