using ApiSdk.Drive.Root.Thumbnails.Count;
using ApiSdk.Drive.Root.Thumbnails.Item;
using ApiSdk.Models;
...
namespace ApiSdk.Drive.Root.Thumbnails {
    ...
    public class ThumbnailsRequestBuilder {
        ...
        public Command BuildCreateCommand() {
            ...
            command.Description = "Create new navigation property to thumbnails for drive";
        ...
        public ThumbnailsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drive/root/thumbnails{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
