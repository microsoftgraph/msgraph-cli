using ApiSdk.Drive.Root.Permissions.Count;
using ApiSdk.Drive.Root.Permissions.Item;
...
namespace ApiSdk.Drive.Root.Permissions {
    ...
    public class PermissionsRequestBuilder {
        ...
        public PermissionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drive/root/permissions{?top,skip,search,filter,count,orderby,select,expand}";
