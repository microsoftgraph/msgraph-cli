using ApiSdk.Drive.Root.Versions.Count;
using ApiSdk.Drive.Root.Versions.Item;
using ApiSdk.Models;
...
namespace ApiSdk.Drive.Root.Versions {
    ...
    public class VersionsRequestBuilder {
        ...
        public VersionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drive/root/versions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
