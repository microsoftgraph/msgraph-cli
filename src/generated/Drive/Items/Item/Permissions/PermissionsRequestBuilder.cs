using ApiSdk.Drive.Items.Item.Permissions.Count;
using ApiSdk.Drive.Items.Item.Permissions.Item;
...
namespace ApiSdk.Drive.Items.Item.Permissions {
    ...
    public class PermissionsRequestBuilder {
        ...
        public Command BuildCreateCommand() {
            ...
            command.Description = "Create new navigation property to permissions for drive";
        ...
        public PermissionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drive/items/{driveItem_id}/permissions{?top,skip,search,filter,count,orderby,select,expand}";
