using ApiSdk.Drive.Items.Item.Subscriptions.Count;
using ApiSdk.Drive.Items.Item.Subscriptions.Item;
using ApiSdk.Models;
...
namespace ApiSdk.Drive.Items.Item.Subscriptions {
    ...
    public class SubscriptionsRequestBuilder {
        ...
        public Command BuildCreateCommand() {
            ...
            command.Description = "Create new navigation property to subscriptions for drive";
