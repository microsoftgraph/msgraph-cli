using ApiSdk.Drive.Items.Item.Children.Count;
using ApiSdk.Drive.Items.Item.Children.Item;
using ApiSdk.Models;
...
namespace ApiSdk.Drive.Items.Item.Children {
    ...
    public class ChildrenRequestBuilder {
        ...
        public List<Command> BuildCommand() {
            var builder = new ApiSdk.Drive.Items.Item.Children.Item.DriveItemItemRequestBuilder(PathParameters, RequestAdapter);
        ...
        public ChildrenRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drive/items/{driveItem%2Did}/children{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
