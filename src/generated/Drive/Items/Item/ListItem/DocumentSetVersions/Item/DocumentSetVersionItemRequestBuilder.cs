using ApiSdk.Drive.Items.Item.ListItem.DocumentSetVersions.Item.Restore;
using ApiSdk.Models;
...
namespace ApiSdk.Drive.Items.Item.ListItem.DocumentSetVersions.Item {
    /// <summary>
    ...
    public class DocumentSetVersionItemRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.Description = "Delete navigation property documentSetVersions for drive";
        ...
        public Command BuildPatchCommand() {
            ...
            command.Description = "Update the navigation property documentSetVersions in drive";
            // Create options for all the parameters
            var driveItemIdOption = new Option<string>("--drive-item-id", description: "key: id of driveItem") {
            };
            driveItemIdOption.IsRequired = true;
        ...
        public DocumentSetVersionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drive/items/{driveItem%2Did}/listItem/documentSetVersions/{documentSetVersion%2Did}{?%24select,%24expand}";
