using ApiSdk.Drive.Items.Item.ListItem.DocumentSetVersions.Count;
using ApiSdk.Drive.Items.Item.ListItem.DocumentSetVersions.Item;
using ApiSdk.Models;
...
namespace ApiSdk.Drive.Items.Item.ListItem.DocumentSetVersions {
    ...
    public class DocumentSetVersionsRequestBuilder {
        ...
        public Command BuildCreateCommand() {
            ...
            command.Description = "Create new navigation property to documentSetVersions for drive";
