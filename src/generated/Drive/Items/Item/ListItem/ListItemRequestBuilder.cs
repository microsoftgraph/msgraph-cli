using ApiSdk.Drive.Items.Item.ListItem.Analytics;
using ApiSdk.Drive.Items.Item.ListItem.DriveItem;
using ApiSdk.Drive.Items.Item.ListItem.Fields;
using ApiSdk.Drive.Items.Item.ListItem.GetActivitiesByInterval;
using ApiSdk.Drive.Items.Item.ListItem.GetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithInterval;
using ApiSdk.Drive.Items.Item.ListItem.Versions;
using ApiSdk.Models;
...
namespace ApiSdk.Drive.Items.Item.ListItem {
    ...
    public class ListItemRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.Description = "Delete navigation property listItem for drive";
            ...
            }, new CollectionBinding(driveItemIdOption, ifMatchOption, new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        ...
        public Command BuildPatchCommand() {
            ...
            command.Description = "Update the navigation property listItem in drive";
            // Create options for all the parameters
            var driveItemIdOption = new Option<string>("--drive-item-id", description: "key: id of driveItem") {
            };
            driveItemIdOption.IsRequired = true;
