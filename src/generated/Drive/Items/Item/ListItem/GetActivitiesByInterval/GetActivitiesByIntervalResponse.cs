...
namespace ApiSdk.Drive.Items.Item.ListItem.GetActivitiesByInterval {
    ...
    public class GetActivitiesByIntervalResponse : IAdditionalDataHolder, IParsable {
        ...
        /// </summary>
        public static ApiSdk.Drive.Items.Item.ListItem.GetActivitiesByInterval.GetActivitiesByIntervalResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
