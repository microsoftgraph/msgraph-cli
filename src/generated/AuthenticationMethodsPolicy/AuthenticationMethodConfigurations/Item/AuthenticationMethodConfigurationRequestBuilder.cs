...
namespace ApiSdk.AuthenticationMethodsPolicy.AuthenticationMethodConfigurations.Item {
    ...
    public class AuthenticationMethodConfigurationRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.Description = "Represents the settings for each authentication method.";
            ...
            command.SetHandler(async (string authenticationMethodConfigurationId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, authenticationMethodConfigurationIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// Represents the settings for each authentication method.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string authenticationMethodConfigurationId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, authenticationMethodConfigurationIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// Represents the settings for each authentication method.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string authenticationMethodConfigurationId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, authenticationMethodConfigurationIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(AuthenticationMethodConfiguration model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
