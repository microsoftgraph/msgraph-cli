...
namespace ApiSdk.AuthenticationMethodsPolicy.AuthenticationMethodConfigurations.Item {
    ...
    public class AuthenticationMethodConfigurationRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string authenticationMethodConfigurationId, IConsole console) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string authenticationMethodConfigurationId, string[] select, string[] expand, FormatterType output, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string authenticationMethodConfigurationId, string body, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
