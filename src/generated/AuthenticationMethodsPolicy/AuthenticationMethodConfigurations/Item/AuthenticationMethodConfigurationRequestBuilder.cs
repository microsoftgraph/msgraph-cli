...
namespace ApiSdk.AuthenticationMethodsPolicy.AuthenticationMethodConfigurations.Item {
    ...
    public class AuthenticationMethodConfigurationRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            }, authenticationMethodConfigurationIdOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// Represents the settings for each authentication method.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string authenticationMethodConfigurationId, string[] select, string[] expand, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
            ...
            }, authenticationMethodConfigurationIdOption, selectOption, expandOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// Represents the settings for each authentication method.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string authenticationMethodConfigurationId, string body, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                ...
                await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                console.WriteLine("Success");
            }, authenticationMethodConfigurationIdOption, bodyOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
