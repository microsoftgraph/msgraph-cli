...
namespace ApiSdk.Contracts {
    ...
    public class ContractsRequestBuilder {
        ...
        public List<Command> BuildCommand() {
            var builder = new ContractItemRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildGetAvailableExtensionPropertiesCommand() {
            ...
            var builder = new ApiSdk.Contracts.GetAvailableExtensionProperties.GetAvailableExtensionPropertiesRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildPostCommand());
            return command;
        }
        public Command BuildGetByIdsCommand() {
            var command = new Command("get-by-ids");
            var builder = new ApiSdk.Contracts.GetByIds.GetByIdsRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildPostCommand());
            return command;
        }
        /// <summary>
        ...
        public Command BuildValidatePropertiesCommand() {
            ...
            var builder = new ApiSdk.Contracts.ValidateProperties.ValidatePropertiesRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildPostCommand());
            return command;
        }
        /// <summary>
