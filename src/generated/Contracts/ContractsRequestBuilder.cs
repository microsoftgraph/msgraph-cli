...
namespace ApiSdk.Contracts {
    ...
    public class ContractsRequestBuilder : BaseCliRequestBuilder {
        ...
        public ContractsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/contracts{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Retrieve a list of contract objects associated to a partner tenant.
        /// </summary>
...
#nullable restore
        ...
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ContractsRequestBuilderGetQueryParameters>> requestConfiguration = default) {
            ...
            if (requestConfiguration != null) {
                var requestConfig = new RequestConfiguration<ContractsRequestBuilderGetQueryParameters>();
