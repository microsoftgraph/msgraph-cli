...
using ApiSdk.Contracts.MicrosoftGraphGetAvailableExtensionProperties;
using ApiSdk.Contracts.MicrosoftGraphGetByIds;
using ApiSdk.Contracts.MicrosoftGraphValidateProperties;
using ApiSdk.Models;
