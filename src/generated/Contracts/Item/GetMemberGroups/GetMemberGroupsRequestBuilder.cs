...
namespace ApiSdk.Contracts.Item.GetMemberGroups {
    ...
    public class GetMemberGroupsRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (string contractId, string body, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, contractIdOption, bodyOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
