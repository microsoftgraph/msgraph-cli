...
namespace ApiSdk.Contracts.Item.Restore {
    ...
    public class RestoreRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (string contractId, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, contractIdOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
