...
namespace ApiSdk.Identity.B2xUserFlows.Item.UserAttributeAssignments.Item {
    ...
    public class IdentityUserFlowAttributeAssignmentRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string b2xIdentityUserFlowId, string identityUserFlowAttributeAssignmentId, string[] select, string[] expand, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
