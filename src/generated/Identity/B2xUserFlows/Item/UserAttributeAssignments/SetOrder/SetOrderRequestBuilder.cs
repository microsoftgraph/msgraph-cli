...
namespace ApiSdk.Identity.B2xUserFlows.Item.UserAttributeAssignments.SetOrder {
    ...
    public class SetOrderRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(SetOrderRequestBody model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
