...
namespace ApiSdk.Identity.B2xUserFlows.Item.Languages.Item.DefaultPages.Item.Value
{
    ...
    public partial class ContentRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildGetCommand()
        {
            ...
            command.Description = "Read the values in a userFlowLanguagePage object for a language in a user flow. These values are shown to a user during a user journey defined by a user flow.\n\nFind more info here:\n  https://learn.microsoft.com/graph/api/userflowlanguagepage-get?view=graph-rest-1.0";
            var b2xIdentityUserFlowIdOption = new Option<string>("--b2x-identity-user-flow-id", description: "The unique identifier of b2xIdentityUserFlow") {
            };
            b2xIdentityUserFlowIdOption.IsRequired = true;
            command.AddOption(b2xIdentityUserFlowIdOption);
