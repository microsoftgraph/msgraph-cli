...
namespace ApiSdk.Identity.B2xUserFlows.Item.Languages.Item.DefaultPages.Item {
    ...
    public class UserFlowLanguagePageRequestBuilder {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(UserFlowLanguagePage model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
