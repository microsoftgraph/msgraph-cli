...
namespace ApiSdk.Identity.B2xUserFlows.Item.Languages.Item.DefaultPages.Item {
    ...
    public class UserFlowLanguagePageItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public UserFlowLanguagePageItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/identity/b2xUserFlows/{b2xIdentityUserFlow%2Did}/languages/{userFlowLanguageConfiguration%2Did}/defaultPages/{userFlowLanguagePage%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Delete navigation property defaultPages for identity
        /// </summary>
