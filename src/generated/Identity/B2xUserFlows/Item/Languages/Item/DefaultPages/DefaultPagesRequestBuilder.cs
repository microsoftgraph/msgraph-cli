...
namespace ApiSdk.Identity.B2xUserFlows.Item.Languages.Item.DefaultPages {
    ...
    public class DefaultPagesRequestBuilder {
        ...
        public Command BuildListCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, int?, int?, string, string, bool?, string[], string[], string[]>(async (b2xIdentityUserFlowId, userFlowLanguageConfigurationId, top, skip, search, filter, count, orderby, select, expand) => {
