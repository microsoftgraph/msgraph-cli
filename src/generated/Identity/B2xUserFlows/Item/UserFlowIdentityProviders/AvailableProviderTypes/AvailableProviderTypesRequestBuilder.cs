...
namespace ApiSdk.Identity.B2xUserFlows.Item.UserFlowIdentityProviders.AvailableProviderTypes {
    ...
    public class AvailableProviderTypesRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string b2xIdentityUserFlowId, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, b2xIdentityUserFlowIdOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
