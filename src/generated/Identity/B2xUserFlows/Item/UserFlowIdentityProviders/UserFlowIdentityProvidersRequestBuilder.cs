    ...
    public class UserFlowIdentityProvidersRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.Handler = CommandHandler.Create<string, int?, int?, string, string, bool?, object, object, object>(async (b2xIdentityUserFlowId, top, skip, search, filter, count, orderby, select, expand) => {
                ...
                var result = await RequestAdapter.SendAsync<UserFlowIdentityProvidersResponse>(requestInfo);
        ...
        public Command BuildRefCommand() {
            ...
            var builder = new ApiSdk.Identity.B2xUserFlows.Item.UserFlowIdentityProviders.@Ref.RefRequestBuilder(PathParameters, RequestAdapter);
