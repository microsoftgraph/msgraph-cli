using ApiSdk.Identity.B2xUserFlows.Item.UserFlowIdentityProviders.Count;
using ApiSdk.Identity.B2xUserFlows.Item.UserFlowIdentityProviders.Item;
...
namespace ApiSdk.Identity.B2xUserFlows.Item.UserFlowIdentityProviders {
    ...
    public class UserFlowIdentityProvidersRequestBuilder : BaseCliRequestBuilder {
        ...
        public UserFlowIdentityProvidersRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/identity/b2xUserFlows/{b2xIdentityUserFlow%2Did}/userFlowIdentityProviders{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Get userFlowIdentityProviders from identity
        /// </summary>
...
#nullable restore
        ...
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<UserFlowIdentityProvidersRequestBuilderGetQueryParameters>> requestConfiguration = default) {
            ...
            if (requestConfiguration != null) {
                var requestConfig = new RequestConfiguration<UserFlowIdentityProvidersRequestBuilderGetQueryParameters>();
