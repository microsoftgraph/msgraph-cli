    ...
    public class IdentityProviderBaseItemRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                var identityProviderBaseId = (string) parameters[1];
                ...
                PathParameters.Add("identityProviderBase_id", identityProviderBaseId);
            ...
            }, new CollectionBinding(b2xIdentityUserFlowIdOption, identityProviderBaseIdOption, selectOption, expandOption, outputOption, queryOption, jsonNoIndentOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        ...
        public IdentityProviderBaseItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/identity/b2xUserFlows/{b2xIdentityUserFlow_id}/userFlowIdentityProviders/{identityProviderBase_id}{?select,expand}";
