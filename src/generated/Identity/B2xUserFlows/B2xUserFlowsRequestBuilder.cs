...
namespace ApiSdk.Identity.B2xUserFlows {
    ...
    public class B2xUserFlowsRequestBuilder : BaseCliRequestBuilder {
        ...
        public B2xUserFlowsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/identity/b2xUserFlows{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Retrieve a list of b2xIdentityUserFlow objects.
        /// </summary>
...
#nullable restore
        ...
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<B2xUserFlowsRequestBuilderGetQueryParameters>> requestConfiguration = default) {
            ...
            if (requestConfiguration != null) {
                var requestConfig = new RequestConfiguration<B2xUserFlowsRequestBuilderGetQueryParameters>();
