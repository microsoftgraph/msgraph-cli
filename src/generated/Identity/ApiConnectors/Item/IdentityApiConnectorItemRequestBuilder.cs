...
namespace ApiSdk.Identity.ApiConnectors.Item {
    ...
    public class IdentityApiConnectorItemRequestBuilder {
        ...
        /// <param name="options">Request options</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(IdentityApiConnector body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
