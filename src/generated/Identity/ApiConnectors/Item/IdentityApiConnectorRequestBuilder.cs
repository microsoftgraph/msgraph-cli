...
namespace ApiSdk.Identity.ApiConnectors.Item {
    ...
    public class IdentityApiConnectorRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string identityApiConnectorId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, identityApiConnectorIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// Represents entry point for API connectors.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string identityApiConnectorId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, identityApiConnectorIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// Represents entry point for API connectors.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string identityApiConnectorId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, identityApiConnectorIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        public Command BuildUploadClientCertificateCommand() {
            var command = new Command("upload-client-certificate");
            var builder = new ApiSdk.Identity.ApiConnectors.Item.UploadClientCertificate.UploadClientCertificateRequestBuilder(PathParameters, RequestAdapter);
