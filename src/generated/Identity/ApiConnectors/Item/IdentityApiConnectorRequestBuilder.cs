...
namespace ApiSdk.Identity.ApiConnectors.Item {
    ...
    public class IdentityApiConnectorRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string identityApiConnectorId, IConsole console) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string identityApiConnectorId, string[] select, string[] expand, FormatterType output, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string identityApiConnectorId, string body, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
