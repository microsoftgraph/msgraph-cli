...
namespace ApiSdk.Identity.ApiConnectors.Item {
    ...
    public class IdentityApiConnectorRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string identityApiConnectorId, string[] select, string[] expand, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string identityApiConnectorId, string body, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
