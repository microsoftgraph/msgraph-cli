...
namespace ApiSdk.Identity.ApiConnectors.Item.UploadClientCertificate {
    ...
    public class UploadClientCertificateRequestBuilder {
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(UploadClientCertificateRequestBody body, Action<UploadClientCertificateRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
