...
namespace ApiSdk.Identity.ApiConnectors.Item.UploadClientCertificate {
    ...
    public class UploadClientCertificateRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (string identityApiConnectorId, string body, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, identityApiConnectorIdOption, bodyOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
