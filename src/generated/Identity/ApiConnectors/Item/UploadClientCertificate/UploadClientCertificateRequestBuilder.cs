...
namespace ApiSdk.Identity.ApiConnectors.Item.UploadClientCertificate {
    ...
    public class UploadClientCertificateRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            }, new CollectionBinding(identityApiConnectorIdOption, bodyOption, outputOption, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
