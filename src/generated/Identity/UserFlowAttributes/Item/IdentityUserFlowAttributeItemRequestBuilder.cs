...
namespace ApiSdk.Identity.UserFlowAttributes.Item {
    ...
    public class IdentityUserFlowAttributeItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.Description = "Delete a custom identityUserFlowAttribute. This API is available in the following national cloud deployments.\n\nFind more info here:\n  https://learn.microsoft.com/graph/api/identityuserflowattribute-delete?view=graph-rest-1.0";
        ...
        public Command BuildGetCommand() {
            ...
            command.Description = "Retrieve the properties and relationships of a identityUserFlowAttribute object. This API is available in the following national cloud deployments.\n\nFind more info here:\n  https://learn.microsoft.com/graph/api/identityuserflowattribute-get?view=graph-rest-1.0";
            var identityUserFlowAttributeIdOption = new Option<string>("--identity-user-flow-attribute-id", description: "The unique identifier of identityUserFlowAttribute") {
            };
            identityUserFlowAttributeIdOption.IsRequired = true;
            command.AddOption(identityUserFlowAttributeIdOption);
        ...
        public Command BuildPatchCommand() {
            ...
            command.Description = "Update the properties of a custom identityUserFlowAttribute object. This API is available in the following national cloud deployments.\n\nFind more info here:\n  https://learn.microsoft.com/graph/api/identityuserflowattribute-update?view=graph-rest-1.0";
            var identityUserFlowAttributeIdOption = new Option<string>("--identity-user-flow-attribute-id", description: "The unique identifier of identityUserFlowAttribute") {
            };
            identityUserFlowAttributeIdOption.IsRequired = true;
            command.AddOption(identityUserFlowAttributeIdOption);
