...
namespace ApiSdk.Identity.ConditionalAccess {
    ...
    public class ConditionalAccessRequestBuilder {
        ...
        public Command BuildAuthenticationContextClassReferencesCommand() {
            ...
            var builder = new AuthenticationContextClassReferencesRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildNamedLocationsCommand() {
            ...
            var builder = new NamedLocationsRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildCommand());
            command.AddCommand(builder.BuildCountCommand());
            command.AddCommand(builder.BuildCreateCommand());
            command.AddCommand(builder.BuildListCommand());
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<ConditionalAccessRoot>(ConditionalAccessRoot.CreateFromDiscriminatorValue);
        ...
        public Command BuildTemplatesCommand() {
            ...
            var builder = new TemplatesRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildCommand());
            command.AddCommand(builder.BuildCountCommand());
            command.AddCommand(builder.BuildListCommand());
            return command;
