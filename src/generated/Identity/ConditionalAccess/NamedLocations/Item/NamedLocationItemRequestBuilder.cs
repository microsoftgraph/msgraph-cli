...
namespace ApiSdk.Identity.ConditionalAccess.NamedLocations.Item {
    ...
    public class NamedLocationItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.Description = "Delete a namedLocation object. This API is available in the following national cloud deployments.\n\nFind more info here:\n  https://learn.microsoft.com/graph/api/namedlocation-delete?view=graph-rest-1.0";
        ...
        public Command BuildGetCommand() {
            ...
            command.Description = "Retrieve the properties and relationships of an ipNamedLocation object. This API is available in the following national cloud deployments.\n\nFind more info here:\n  https://learn.microsoft.com/graph/api/ipnamedlocation-get?view=graph-rest-1.0";
            var namedLocationIdOption = new Option<string>("--named-location-id", description: "The unique identifier of namedLocation") {
            };
            namedLocationIdOption.IsRequired = true;
            command.AddOption(namedLocationIdOption);
        ...
        public Command BuildPatchCommand() {
            ...
            command.Description = "Update the properties of an ipNamedLocation object. This API is available in the following national cloud deployments.\n\nFind more info here:\n  https://learn.microsoft.com/graph/api/ipnamedlocation-update?view=graph-rest-1.0";
            var namedLocationIdOption = new Option<string>("--named-location-id", description: "The unique identifier of namedLocation") {
            };
            namedLocationIdOption.IsRequired = true;
            command.AddOption(namedLocationIdOption);
        ...
        public NamedLocationItemRequestBuilder(string rawUrl) : base("{+baseurl}/identity/conditionalAccess/namedLocations/{namedLocation%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Delete a namedLocation object. This API is available in the following national cloud deployments.
        /// </summary>
