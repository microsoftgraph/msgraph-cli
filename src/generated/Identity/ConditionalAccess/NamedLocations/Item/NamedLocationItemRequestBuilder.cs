...
namespace ApiSdk.Identity.ConditionalAccess.NamedLocations.Item {
    ...
    public class NamedLocationItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.Description = "Delete a countryNamedLocation object. This API is available in the following national cloud deployments.\n\nFind more info here:\n  https://learn.microsoft.com/graph/api/countrynamedlocation-delete?view=graph-rest-1.0";
        ...
        public Command BuildGetCommand() {
            ...
            command.Description = "Retrieve the properties and relationships of a countryNamedLocation object. This API is available in the following national cloud deployments.\n\nFind more info here:\n  https://learn.microsoft.com/graph/api/countrynamedlocation-get?view=graph-rest-1.0";
            var namedLocationIdOption = new Option<string>("--named-location-id", description: "The unique identifier of namedLocation") {
            };
            namedLocationIdOption.IsRequired = true;
            command.AddOption(namedLocationIdOption);
