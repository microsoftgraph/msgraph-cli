...
namespace ApiSdk.Identity.ConditionalAccess.AuthenticationContextClassReferences {
    ...
    public class AuthenticationContextClassReferencesRequestBuilder : BaseCliRequestBuilder {
        ...
        public AuthenticationContextClassReferencesRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/identity/conditionalAccess/authenticationContextClassReferences{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Retrieve a list of authenticationContextClassReference objects.
        /// </summary>
...
#nullable restore
        ...
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<AuthenticationContextClassReferencesRequestBuilderGetQueryParameters>> requestConfiguration = default) {
            ...
            if (requestConfiguration != null) {
                var requestConfig = new RequestConfiguration<AuthenticationContextClassReferencesRequestBuilderGetQueryParameters>();
