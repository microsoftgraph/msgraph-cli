...
namespace ApiSdk.Identity.ConditionalAccess.AuthenticationStrength.Policies {
    ...
    public class PoliciesRequestBuilder : BaseCliRequestBuilder {
        ...
        public PoliciesRequestBuilder(string rawUrl) : base("{+baseurl}/identity/conditionalAccess/authenticationStrength/policies{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// A collection of authentication strength policies that exist for this tenant, including both built-in and custom policies.
        /// </summary>
