...
namespace ApiSdk.Identity.ConditionalAccess.AuthenticationStrength.Policies.Item {
    ...
    public class AuthenticationStrengthPolicyItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public AuthenticationStrengthPolicyItemRequestBuilder(string rawUrl) : base("{+baseurl}/identity/conditionalAccess/authenticationStrength/policies/{authenticationStrengthPolicy%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Delete navigation property policies for identity
        /// </summary>
