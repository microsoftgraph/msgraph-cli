using ApiSdk.Identity.ConditionalAccess.AuthenticationStrength.Policies.Item.CombinationConfigurations;
using ApiSdk.Identity.ConditionalAccess.AuthenticationStrength.Policies.Item.UpdateAllowedCombinations;
using ApiSdk.Identity.ConditionalAccess.AuthenticationStrength.Policies.Item.Usage;
...
using System;
namespace ApiSdk.Identity.ConditionalAccess.AuthenticationStrength.Policies.Item {
    /// <summary>
    ...
    public class AuthenticationStrengthPolicyItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public AuthenticationStrengthPolicyItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/identity/conditionalAccess/authenticationStrength/policies/{authenticationStrengthPolicy%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Delete navigation property policies for identity
        /// </summary>
