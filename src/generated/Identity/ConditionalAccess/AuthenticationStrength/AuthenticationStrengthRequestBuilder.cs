...
namespace ApiSdk.Identity.ConditionalAccess.AuthenticationStrength {
    ...
    public class AuthenticationStrengthRequestBuilder : BaseCliRequestBuilder {
        ...
        public AuthenticationStrengthRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/identity/conditionalAccess/authenticationStrength{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Delete navigation property authenticationStrength for identity
        /// </summary>
...
#nullable restore
        ...
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<AuthenticationStrengthRequestBuilderGetQueryParameters>> requestConfiguration = default) {
            ...
            if (requestConfiguration != null) {
                var requestConfig = new RequestConfiguration<AuthenticationStrengthRequestBuilderGetQueryParameters>();
                requestConfiguration.Invoke(requestConfig);
                requestInfo.AddQueryParameters(requestConfig.QueryParameters);
                requestInfo.AddRequestOptions(requestConfig.Options);
                requestInfo.AddHeaders(requestConfig.Headers);
