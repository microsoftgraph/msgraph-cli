...
namespace ApiSdk.DeviceManagement.DeviceManagementPartners.Item.Terminate {
    ...
    /// </summary>
    public class TerminateRequestBuilder {
        ...
        public TerminateRequestBuilder(Dictionary<string, object> pathParameters) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            UrlTemplate = "{+baseurl}/deviceManagement/deviceManagementPartners/{deviceManagementPartner%2Did}/terminate";
