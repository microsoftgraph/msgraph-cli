...
namespace ApiSdk.DeviceManagement.DeviceCompliancePolicies.Item.DeviceStatuses.Item {
    ...
    public class DeviceComplianceDeviceStatusRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string deviceCompliancePolicyId, string deviceComplianceDeviceStatusId) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string deviceCompliancePolicyId, string deviceComplianceDeviceStatusId, string[] select, string[] expand) => {
            ...
            }, deviceCompliancePolicyIdOption, deviceComplianceDeviceStatusIdOption, selectOption, expandOption);
            return command;
        }
        /// <summary>
        /// List of DeviceComplianceDeviceStatus.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string deviceCompliancePolicyId, string deviceComplianceDeviceStatusId, string body) => {
