...
namespace ApiSdk.DeviceManagement.DeviceCompliancePolicies.Item.DeviceStatuses.Item {
    ...
    public class DeviceComplianceDeviceStatusRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            var deviceComplianceDeviceStatusIdOption = new Option<string>("--devicecompliancedevicestatus-id", description: "key: id of deviceComplianceDeviceStatus") {
            };
            deviceComplianceDeviceStatusIdOption.IsRequired = true;
            command.AddOption(deviceComplianceDeviceStatusIdOption);
            command.SetHandler(async (string deviceCompliancePolicyId, string deviceComplianceDeviceStatusId, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                var requestInfo = CreateDeleteRequestInformation(q => {
                });
                await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                console.WriteLine("Success");
            }, deviceCompliancePolicyIdOption, deviceComplianceDeviceStatusIdOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// List of DeviceComplianceDeviceStatus.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string deviceCompliancePolicyId, string deviceComplianceDeviceStatusId, string[] select, string[] expand, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
            ...
            }, deviceCompliancePolicyIdOption, deviceComplianceDeviceStatusIdOption, selectOption, expandOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// List of DeviceComplianceDeviceStatus.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string deviceCompliancePolicyId, string deviceComplianceDeviceStatusId, string body, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                ...
                await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                console.WriteLine("Success");
            }, deviceCompliancePolicyIdOption, deviceComplianceDeviceStatusIdOption, bodyOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
