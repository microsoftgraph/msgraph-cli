...
namespace ApiSdk.DeviceManagement.DeviceCompliancePolicies.Item.DeviceStatuses.Item {
    ...
    public class DeviceComplianceDeviceStatusRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string deviceCompliancePolicyId, string deviceComplianceDeviceStatusId, IConsole console) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string deviceCompliancePolicyId, string deviceComplianceDeviceStatusId, string[] select, string[] expand, FormatterType output, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string deviceCompliancePolicyId, string deviceComplianceDeviceStatusId, string body, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
