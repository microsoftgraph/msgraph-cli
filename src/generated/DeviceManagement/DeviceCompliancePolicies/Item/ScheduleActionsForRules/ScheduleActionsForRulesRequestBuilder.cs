    ...
    public class ScheduleActionsForRulesRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                var model = parseNode.GetObjectValue<ScheduleActionsForRulesRequestBody>(ScheduleActionsForRulesRequestBody.CreateFromDiscriminatorValue);
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ScheduleActionsForRulesRequestBody body, Action<ScheduleActionsForRulesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
