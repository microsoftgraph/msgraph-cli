...
namespace ApiSdk.DeviceManagement.DeviceCompliancePolicies.Item.UserStatusOverview {
    ...
    public class UserStatusOverviewRequestBuilder : BaseCliRequestBuilder {
        ...
        public UserStatusOverviewRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/deviceManagement/deviceCompliancePolicies/{deviceCompliancePolicy%2Did}/userStatusOverview{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Delete navigation property userStatusOverview for deviceManagement
        /// </summary>
