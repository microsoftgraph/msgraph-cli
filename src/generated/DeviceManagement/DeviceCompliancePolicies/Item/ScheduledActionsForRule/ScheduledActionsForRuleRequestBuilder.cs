...
namespace ApiSdk.DeviceManagement.DeviceCompliancePolicies.Item.ScheduledActionsForRule {
    ...
    public class ScheduledActionsForRuleRequestBuilder {
        ...
        public Command BuildListCommand() {
            ...
            command.Handler = CommandHandler.Create<string, int?, int?, string, string, bool?, string[], string[], string[]>(async (deviceCompliancePolicyId, top, skip, search, filter, count, orderby, select, expand) => {
