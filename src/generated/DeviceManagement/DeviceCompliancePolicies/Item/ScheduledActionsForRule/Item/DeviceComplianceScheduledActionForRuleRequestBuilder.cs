...
namespace ApiSdk.DeviceManagement.DeviceCompliancePolicies.Item.ScheduledActionsForRule.Item {
    ...
    public class DeviceComplianceScheduledActionForRuleRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string deviceCompliancePolicyId, string deviceComplianceScheduledActionForRuleId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, deviceCompliancePolicyIdOption, deviceComplianceScheduledActionForRuleIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The list of scheduled action for this rule
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string deviceCompliancePolicyId, string deviceComplianceScheduledActionForRuleId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, deviceCompliancePolicyIdOption, deviceComplianceScheduledActionForRuleIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The list of scheduled action for this rule
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string deviceCompliancePolicyId, string deviceComplianceScheduledActionForRuleId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, deviceCompliancePolicyIdOption, deviceComplianceScheduledActionForRuleIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
