...
namespace ApiSdk.DeviceManagement.DeviceCompliancePolicies.Item.UserStatuses.Item {
    ...
    public class DeviceComplianceUserStatusItemRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(deviceCompliancePolicyIdOption, deviceComplianceUserStatusIdOption, selectOption, expandOption, outputOption, outputFilterOption, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// List of DeviceComplianceUserStatus.
