...
namespace ApiSdk.DeviceManagement.DeviceCompliancePolicies.Item.UserStatuses {
    ...
    public class UserStatusesRequestBuilder {
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(DeviceComplianceUserStatus body, Action<UserStatusesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
