...
namespace ApiSdk.DeviceManagement.TermsAndConditions.Item.AcceptanceStatuses.Item.TermsAndConditions.Ref {
    ...
    public class RefRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string termsAndConditionsItemId, string termsAndConditionsAcceptanceStatusId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, termsAndConditionsItemIdOption, termsAndConditionsAcceptanceStatusIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// Navigation link to the terms and conditions that are assigned.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string termsAndConditionsItemId, string termsAndConditionsAcceptanceStatusId, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, termsAndConditionsItemIdOption, termsAndConditionsAcceptanceStatusIdOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// Navigation link to the terms and conditions that are assigned.
        ...
        public Command BuildPutCommand() {
            ...
            command.SetHandler(async (string termsAndConditionsItemId, string termsAndConditionsAcceptanceStatusId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, termsAndConditionsItemIdOption, termsAndConditionsAcceptanceStatusIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
