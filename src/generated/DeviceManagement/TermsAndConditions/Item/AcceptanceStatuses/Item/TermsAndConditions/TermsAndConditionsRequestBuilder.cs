...
namespace ApiSdk.DeviceManagement.TermsAndConditions.Item.AcceptanceStatuses.Item.TermsAndConditions {
    ...
    public class TermsAndConditionsRequestBuilder : BaseCliRequestBuilder {
        ...
        public TermsAndConditionsRequestBuilder(string rawUrl) : base("{+baseurl}/deviceManagement/termsAndConditions/{termsAndConditions%2Did}/acceptanceStatuses/{termsAndConditionsAcceptanceStatus%2Did}/termsAndConditions{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Navigation link to the terms and conditions that are assigned.
        /// </summary>
