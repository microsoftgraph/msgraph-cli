...
namespace ApiSdk.DeviceManagement.TermsAndConditions.Item.AcceptanceStatuses {
    /// <summary>Builds and executes requests for operations under \deviceManagement\termsAndConditions\{termsAndConditionsItem-id}\acceptanceStatuses</summary>
    public class AcceptanceStatusesRequestBuilder {
        ...
        public List<Command> BuildCommand() {
            var builder = new TermsAndConditionsAcceptanceStatusItemRequestBuilder(PathParameters, RequestAdapter);
            var commands = new List<Command>();
            commands.Add(builder.BuildDeleteCommand());
            commands.Add(builder.BuildGetCommand());
            commands.Add(builder.BuildPatchCommand());
            commands.Add(builder.BuildTermsAndConditionsCommand());
            return commands;
        }
        /// <summary>
