...
namespace ApiSdk.DeviceManagement.TermsAndConditions.Item.Assignments.Item {
    ...
    public class TermsAndConditionsAssignmentRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string termsAndConditionsItemId, string termsAndConditionsAssignmentId, IOutputFormatterFactory outputFormatterFactory, CancellationToken cancellationToken) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string termsAndConditionsItemId, string termsAndConditionsAssignmentId, string[] select, string[] expand, FormatterType output, IOutputFormatterFactory outputFormatterFactory, CancellationToken cancellationToken) => {
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string termsAndConditionsItemId, string termsAndConditionsAssignmentId, string body, IOutputFormatterFactory outputFormatterFactory, CancellationToken cancellationToken) => {
