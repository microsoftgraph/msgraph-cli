...
namespace ApiSdk.DeviceManagement.TermsAndConditions.Item.Assignments.Item {
    ...
    public class TermsAndConditionsAssignmentItemRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            }, new CollectionBinding(termsAndConditionsItemIdOption, termsAndConditionsAssignmentIdOption, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// The list of assignments for this T&C policy.
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(termsAndConditionsItemIdOption, termsAndConditionsAssignmentIdOption, selectOption, expandOption, outputOption, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// The list of assignments for this T&C policy.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                await RequestAdapter.SendNoContentAsync(requestInfo, errorMapping: default, cancellationToken: cancellationToken);
                Console.WriteLine("Success");
            }, new CollectionBinding(termsAndConditionsItemIdOption, termsAndConditionsAssignmentIdOption, bodyOption, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
