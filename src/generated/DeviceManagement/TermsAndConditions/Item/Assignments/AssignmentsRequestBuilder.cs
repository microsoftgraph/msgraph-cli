...
namespace ApiSdk.DeviceManagement.TermsAndConditions.Item.Assignments {
    ...
    public class AssignmentsRequestBuilder {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<TermsAndConditionsAssignment> PostAsync(TermsAndConditionsAssignment model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
