...
namespace ApiSdk.DeviceManagement.TermsAndConditions {
    ...
    public class TermsAndConditionsRequestBuilder {
        ...
        public Command BuildCommand() {
            ...
            command.AddCommand(builder.BuildAcceptanceStatusesCommand());
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ApiSdk.Models.TermsAndConditions body, Action<TermsAndConditionsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
