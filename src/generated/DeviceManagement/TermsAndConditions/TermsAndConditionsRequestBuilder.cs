...
namespace ApiSdk.DeviceManagement.TermsAndConditions {
    ...
    public class TermsAndConditionsRequestBuilder {
        ...
        /// <param name="options">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ApiSdk.Models.TermsAndConditions body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
