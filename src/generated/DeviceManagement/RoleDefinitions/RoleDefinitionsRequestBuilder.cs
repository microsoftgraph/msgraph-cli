...
namespace ApiSdk.DeviceManagement.RoleDefinitions {
    ...
    public class RoleDefinitionsRequestBuilder {
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ApiSdk.Models.RoleDefinition body, Action<RoleDefinitionsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
