...
namespace ApiSdk.DeviceManagement.RoleDefinitions {
    ...
    public class RoleDefinitionsRequestBuilder {
        ...
        public List<Command> BuildCommand() {
            var builder = new RoleDefinitionItemRequestBuilder(PathParameters, RequestAdapter);
            var commands = new List<Command>();
            commands.Add(builder.BuildDeleteCommand());
            commands.Add(builder.BuildGetCommand());
            commands.Add(builder.BuildPatchCommand());
            commands.Add(builder.BuildRoleAssignmentsCommand());
            return commands;
        }
        ...
        /// <param name="options">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ApiSdk.Models.Microsoft.Graph.RoleDefinition body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
