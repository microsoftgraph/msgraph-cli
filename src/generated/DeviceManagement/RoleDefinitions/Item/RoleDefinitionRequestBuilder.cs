...
namespace ApiSdk.DeviceManagement.RoleDefinitions.Item {
    ...
    public class RoleDefinitionRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            }, roleDefinitionIdOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// The Role Definitions.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string roleDefinitionId, string[] select, string[] expand, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
            ...
            }, roleDefinitionIdOption, selectOption, expandOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// The Role Definitions.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string roleDefinitionId, string body, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                ...
                await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                console.WriteLine("Success");
            }, roleDefinitionIdOption, bodyOption, new OutputFormatterFactoryBinder());
            return command;
        }
