...
namespace ApiSdk.DeviceManagement.RoleDefinitions.Item.RoleAssignments {
    ...
    public class RoleAssignmentsRequestBuilder {
        ...
        public Command BuildListCommand() {
            ...
            command.Handler = CommandHandler.Create<string, int?, int?, string, string, bool?, object, object, object>(async (roleDefinitionId, top, skip, search, filter, count, orderby, select, expand) => {
