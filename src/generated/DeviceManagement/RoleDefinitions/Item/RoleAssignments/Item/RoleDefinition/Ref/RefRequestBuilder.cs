...
namespace ApiSdk.DeviceManagement.RoleDefinitions.Item.RoleAssignments.Item.RoleDefinition.Ref {
    ...
    public class RefRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string roleDefinitionId, string roleAssignmentId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, roleDefinitionIdOption, roleAssignmentIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// Role definition this assignment is part of.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string roleDefinitionId, string roleAssignmentId, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, roleDefinitionIdOption, roleAssignmentIdOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// Role definition this assignment is part of.
        ...
        public Command BuildPutCommand() {
            ...
            command.SetHandler(async (string roleDefinitionId, string roleAssignmentId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, roleDefinitionIdOption, roleAssignmentIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PutAsync(ApiSdk.DeviceManagement.RoleDefinitions.Item.RoleAssignments.Item.RoleDefinition.Ref.Ref model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
