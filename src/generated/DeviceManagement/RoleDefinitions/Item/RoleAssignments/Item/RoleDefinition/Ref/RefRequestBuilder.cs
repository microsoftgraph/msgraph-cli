...
namespace ApiSdk.DeviceManagement.RoleDefinitions.Item.RoleAssignments.Item.RoleDefinition.Ref {
    ...
    public class RefRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string roleDefinitionId, string roleAssignmentId, IConsole console) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string roleDefinitionId, string roleAssignmentId, FormatterType output, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
        ...
        public Command BuildPutCommand() {
            ...
            command.SetHandler(async (string roleDefinitionId, string roleAssignmentId, string body, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
