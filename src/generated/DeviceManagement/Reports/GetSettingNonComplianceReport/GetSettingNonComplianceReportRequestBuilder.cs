...
namespace ApiSdk.DeviceManagement.Reports.GetSettingNonComplianceReport {
    ...
    public class GetSettingNonComplianceReportRequestBuilder {
        ...
        /// </summary>
        public async Task<Stream> PostAsync(GetSettingNonComplianceReportRequestBody model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
