...
namespace ApiSdk.DeviceManagement.Reports.GetConfigurationPolicyNonComplianceReport {
    ...
    public class GetConfigurationPolicyNonComplianceReportRequestBuilder {
        ...
        public GetConfigurationPolicyNonComplianceReportRequestBuilder(Dictionary<string, object> pathParameters) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            UrlTemplate = "{+baseurl}/deviceManagement/reports/getConfigurationPolicyNonComplianceReport";
