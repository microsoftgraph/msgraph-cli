    ...
    public class GetConfigurationPolicyNonComplianceReportRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                var model = parseNode.GetObjectValue<GetConfigurationPolicyNonComplianceReportRequestBody>(GetConfigurationPolicyNonComplianceReportRequestBody.CreateFromDiscriminatorValue);
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(GetConfigurationPolicyNonComplianceReportRequestBody body, Action<GetConfigurationPolicyNonComplianceReportRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
