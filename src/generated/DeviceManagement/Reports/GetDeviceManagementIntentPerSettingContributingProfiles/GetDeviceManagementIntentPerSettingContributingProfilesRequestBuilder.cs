    ...
    public class GetDeviceManagementIntentPerSettingContributingProfilesRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.Handler = CommandHandler.Create<string, FileInfo>(async (body, output) => {
                ...
                var model = parseNode.GetObjectValue<GetDeviceManagementIntentPerSettingContributingProfilesRequestBody>();
        ...
        /// </summary>
        public async Task<Stream> PostAsync(GetDeviceManagementIntentPerSettingContributingProfilesRequestBody model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
