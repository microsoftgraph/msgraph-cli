    ...
    public class GetDeviceManagementIntentPerSettingContributingProfilesRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                var model = parseNode.GetObjectValue<GetDeviceManagementIntentPerSettingContributingProfilesRequestBody>(GetDeviceManagementIntentPerSettingContributingProfilesRequestBody.CreateFromDiscriminatorValue);
