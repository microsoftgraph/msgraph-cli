...
namespace ApiSdk.DeviceManagement.Reports.GetDeviceManagementIntentPerSettingContributingProfiles {
    ...
    public class GetDeviceManagementIntentPerSettingContributingProfilesRequestBuilder {
        ...
        /// </summary>
        public async Task<Stream> PostAsync(GetDeviceManagementIntentPerSettingContributingProfilesRequestBody model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
