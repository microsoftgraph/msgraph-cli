...
namespace ApiSdk.DeviceManagement.Reports.GetCompliancePolicyNonComplianceSummaryReport {
    ...
    public class GetCompliancePolicyNonComplianceSummaryReportRequestBody : IAdditionalDataHolder, IParsable {
        ...
        /// </summary>
        public static ApiSdk.DeviceManagement.Reports.GetCompliancePolicyNonComplianceSummaryReport.GetCompliancePolicyNonComplianceSummaryReportRequestBody CreateFromDiscriminatorValue(IParseNode parseNode) {
