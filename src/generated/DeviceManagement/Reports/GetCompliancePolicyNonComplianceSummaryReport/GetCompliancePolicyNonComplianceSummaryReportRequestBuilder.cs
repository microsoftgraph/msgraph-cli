...
namespace ApiSdk.DeviceManagement.Reports.GetCompliancePolicyNonComplianceSummaryReport {
    ...
    public class GetCompliancePolicyNonComplianceSummaryReportRequestBuilder {
        ...
        /// </summary>
        public async Task<Stream> PostAsync(GetCompliancePolicyNonComplianceSummaryReportRequestBody model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
