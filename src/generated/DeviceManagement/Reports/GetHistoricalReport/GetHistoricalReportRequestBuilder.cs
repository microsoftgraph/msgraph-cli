    ...
    public class GetHistoricalReportRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.DeviceManagement.Reports.GetHistoricalReport.GetHistoricalReportRequestBody>(ApiSdk.DeviceManagement.Reports.GetHistoricalReport.GetHistoricalReportRequestBody.CreateFromDiscriminatorValue);
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ApiSdk.DeviceManagement.Reports.GetHistoricalReport.GetHistoricalReportRequestBody body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
