...
namespace ApiSdk.DeviceManagement.Reports.GetCachedReport {
    ...
    public class GetCachedReportRequestBuilder {
        ...
        /// </summary>
        public async Task<Stream> PostAsync(GetCachedReportRequestBody model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
