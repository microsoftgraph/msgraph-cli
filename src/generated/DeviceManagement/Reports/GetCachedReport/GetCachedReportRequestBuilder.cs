    ...
    public class GetCachedReportRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (string body, FileInfo file, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                ...
                var model = parseNode.GetObjectValue<GetCachedReportRequestBody>();
        ...
        /// </summary>
        public async Task<Stream> PostAsync(GetCachedReportRequestBody model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
