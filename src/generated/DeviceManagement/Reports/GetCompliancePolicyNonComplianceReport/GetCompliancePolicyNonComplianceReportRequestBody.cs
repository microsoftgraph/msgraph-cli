...
namespace ApiSdk.DeviceManagement.Reports.GetCompliancePolicyNonComplianceReport {
    ...
    public class GetCompliancePolicyNonComplianceReportRequestBody : IAdditionalDataHolder, IParsable {
        ...
        /// </summary>
        public static ApiSdk.DeviceManagement.Reports.GetCompliancePolicyNonComplianceReport.GetCompliancePolicyNonComplianceReportRequestBody CreateFromDiscriminatorValue(IParseNode parseNode) {
