...
namespace ApiSdk.DeviceManagement.Reports.GetPolicyNonComplianceSummaryReport {
    ...
    public class GetPolicyNonComplianceSummaryReportRequestBuilder {
        ...
        /// </summary>
        public async Task<Stream> PostAsync(GetPolicyNonComplianceSummaryReportRequestBody model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
