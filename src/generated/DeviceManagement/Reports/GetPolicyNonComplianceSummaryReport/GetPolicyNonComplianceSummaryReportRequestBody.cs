...
namespace ApiSdk.DeviceManagement.Reports.GetPolicyNonComplianceSummaryReport {
    ...
    public class GetPolicyNonComplianceSummaryReportRequestBody : IAdditionalDataHolder, IParsable {
        ...
        /// </summary>
        public static ApiSdk.DeviceManagement.Reports.GetPolicyNonComplianceSummaryReport.GetPolicyNonComplianceSummaryReportRequestBody CreateFromDiscriminatorValue(IParseNode parseNode) {
