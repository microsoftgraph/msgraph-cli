...
namespace ApiSdk.DeviceManagement.Reports.GetConfigurationSettingNonComplianceReport {
    ...
    public class GetConfigurationSettingNonComplianceReportResponse : IAdditionalDataHolder, IParsable {
        ...
        /// </summary>
        public static ApiSdk.DeviceManagement.Reports.GetConfigurationSettingNonComplianceReport.GetConfigurationSettingNonComplianceReportResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
