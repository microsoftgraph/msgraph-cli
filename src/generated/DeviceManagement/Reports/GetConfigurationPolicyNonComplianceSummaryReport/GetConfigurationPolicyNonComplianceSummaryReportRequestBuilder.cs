    ...
    public class GetConfigurationPolicyNonComplianceSummaryReportRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                var model = parseNode.GetObjectValue<GetConfigurationPolicyNonComplianceSummaryReportRequestBody>(GetConfigurationPolicyNonComplianceSummaryReportRequestBody.CreateFromDiscriminatorValue);
