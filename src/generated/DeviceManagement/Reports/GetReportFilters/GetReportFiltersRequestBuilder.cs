...
namespace ApiSdk.DeviceManagement.Reports.GetReportFilters {
    ...
    public class GetReportFiltersRequestBuilder {
        ...
        /// </summary>
        public async Task<Stream> PostAsync(GetReportFiltersRequestBody model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
