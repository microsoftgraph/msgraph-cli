...
namespace ApiSdk.DeviceManagement.Reports.GetPolicyNonComplianceMetadata {
    ...
    public class GetPolicyNonComplianceMetadataRequestBuilder {
        ...
        /// </summary>
        public async Task<Stream> PostAsync(GetPolicyNonComplianceMetadataRequestBody model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
