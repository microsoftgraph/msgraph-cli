...
namespace ApiSdk.DeviceManagement.AuditEvents.MicrosoftGraphGetAuditActivityTypesWithCategory {
    /// <summary>
    ...
    public class GetAuditActivityTypesWithCategoryRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (invocationContext) => {
                var category = invocationContext.ParseResult.GetValueForOption(categoryOption);
                ...
                if (category is not null) requestInfo.PathParameters.Add("category", category);
        ...
        public GetAuditActivityTypesWithCategoryRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string category = "") {
