...
using System;
namespace ApiSdk.DeviceManagement.UserExperienceAnalyticsWorkFromAnywhereMetrics.Item.MetricDevices.Item {
    /// <summary>
    ...
    public class UserExperienceAnalyticsWorkFromAnywhereDeviceItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            userExperienceAnalyticsWorkFromAnywhereMetricIdOption.IsRequired = true;
            command.AddOption(userExperienceAnalyticsWorkFromAnywhereMetricIdOption);
            var userExperienceAnalyticsWorkFromAnywhereDeviceIdOption = new Option<string>("--user-experience-analytics-work-from-anywhere-device-id", description: "The unique identifier of userExperienceAnalyticsWorkFromAnywhereDevice") {
            };
            userExperienceAnalyticsWorkFromAnywhereDeviceIdOption.IsRequired = true;
            command.AddOption(userExperienceAnalyticsWorkFromAnywhereDeviceIdOption);
            ...
            command.SetHandler(async (invocationContext) => {
                var userExperienceAnalyticsWorkFromAnywhereMetricId = invocationContext.ParseResult.GetValueForOption(userExperienceAnalyticsWorkFromAnywhereMetricIdOption);
                var userExperienceAnalyticsWorkFromAnywhereDeviceId = invocationContext.ParseResult.GetValueForOption(userExperienceAnalyticsWorkFromAnywhereDeviceIdOption);
                var ifMatch = invocationContext.ParseResult.GetValueForOption(ifMatchOption);
                var cancellationToken = invocationContext.GetCancellationToken();
                var reqAdapter = invocationContext.GetRequestAdapter();
                var requestInfo = ToDeleteRequestInformation(q => {
                });
                if (userExperienceAnalyticsWorkFromAnywhereMetricId is not null) requestInfo.PathParameters.Add("userExperienceAnalyticsWorkFromAnywhereMetric%2Did", userExperienceAnalyticsWorkFromAnywhereMetricId);
                if (userExperienceAnalyticsWorkFromAnywhereDeviceId is not null) requestInfo.PathParameters.Add("userExperienceAnalyticsWorkFromAnywhereDevice%2Did", userExperienceAnalyticsWorkFromAnywhereDeviceId);
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<UserExperienceAnalyticsWorkFromAnywhereDevice>(UserExperienceAnalyticsWorkFromAnywhereDevice.CreateFromDiscriminatorValue);
...
#nullable restore
        ...
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<UserExperienceAnalyticsWorkFromAnywhereDeviceItemRequestBuilderGetQueryParameters>> requestConfiguration = default) {
            ...
            if (requestConfiguration != null) {
                var requestConfig = new RequestConfiguration<UserExperienceAnalyticsWorkFromAnywhereDeviceItemRequestBuilderGetQueryParameters>();
                requestConfiguration.Invoke(requestConfig);
                requestInfo.AddQueryParameters(requestConfig.QueryParameters);
                requestInfo.AddRequestOptions(requestConfig.Options);
                requestInfo.AddHeaders(requestConfig.Headers);
