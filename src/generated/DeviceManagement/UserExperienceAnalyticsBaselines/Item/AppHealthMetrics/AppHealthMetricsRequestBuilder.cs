...
using System;
namespace ApiSdk.DeviceManagement.UserExperienceAnalyticsBaselines.Item.AppHealthMetrics {
    /// <summary>
    ...
    public class AppHealthMetricsRequestBuilder : BaseCliRequestBuilder {
        ...
        public AppHealthMetricsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/deviceManagement/userExperienceAnalyticsBaselines/{userExperienceAnalyticsBaseline%2Did}/appHealthMetrics{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// The scores and insights for the application health metrics.
        /// </summary>
...
#nullable restore
        ...
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<AppHealthMetricsRequestBuilderGetQueryParameters>> requestConfiguration = default) {
            ...
            if (requestConfiguration != null) {
                var requestConfig = new RequestConfiguration<AppHealthMetricsRequestBuilderGetQueryParameters>();
