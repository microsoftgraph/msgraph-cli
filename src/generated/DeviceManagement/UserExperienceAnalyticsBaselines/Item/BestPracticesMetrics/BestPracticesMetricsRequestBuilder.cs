...
namespace ApiSdk.DeviceManagement.UserExperienceAnalyticsBaselines.Item.BestPracticesMetrics {
    ...
    public class BestPracticesMetricsRequestBuilder : BaseCliRequestBuilder {
        ...
        public BestPracticesMetricsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/deviceManagement/userExperienceAnalyticsBaselines/{userExperienceAnalyticsBaseline%2Did}/bestPracticesMetrics{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// The scores and insights for the best practices metrics.
        /// </summary>
...
#nullable restore
        ...
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<BestPracticesMetricsRequestBuilderGetQueryParameters>> requestConfiguration = default) {
            ...
            if (requestConfiguration != null) {
                var requestConfig = new RequestConfiguration<BestPracticesMetricsRequestBuilderGetQueryParameters>();
