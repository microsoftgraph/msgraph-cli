...
namespace ApiSdk.DeviceManagement.UserExperienceAnalyticsBaselines.Item.RebootAnalyticsMetrics {
    ...
    public class RebootAnalyticsMetricsRequestBuilder : BaseCliRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.Description = "The scores and insights for the reboot analytics metrics.";
        ...
        public RebootAnalyticsMetricsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/deviceManagement/userExperienceAnalyticsBaselines/{userExperienceAnalyticsBaseline%2Did}/rebootAnalyticsMetrics{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// The scores and insights for the reboot analytics metrics.
        /// </summary>
...
#nullable restore
        ...
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<RebootAnalyticsMetricsRequestBuilderGetQueryParameters>> requestConfiguration = default) {
            ...
            if (requestConfiguration != null) {
                var requestConfig = new RequestConfiguration<RebootAnalyticsMetricsRequestBuilderGetQueryParameters>();
