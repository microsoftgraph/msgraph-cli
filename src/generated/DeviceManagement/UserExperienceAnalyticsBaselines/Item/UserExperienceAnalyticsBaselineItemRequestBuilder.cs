...
namespace ApiSdk.DeviceManagement.UserExperienceAnalyticsBaselines.Item {
    ...
    public class UserExperienceAnalyticsBaselineItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public UserExperienceAnalyticsBaselineItemRequestBuilder(string rawUrl) : base("{+baseurl}/deviceManagement/userExperienceAnalyticsBaselines/{userExperienceAnalyticsBaseline%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Delete navigation property userExperienceAnalyticsBaselines for deviceManagement
        /// </summary>
