...
using System;
namespace ApiSdk.DeviceManagement.UserExperienceAnalyticsAppHealthApplicationPerformance.Item {
    /// <summary>
    ...
    public class UserExperienceAnalyticsAppHealthApplicationPerformanceItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            userExperienceAnalyticsAppHealthApplicationPerformanceIdOption.IsRequired = true;
            command.AddOption(userExperienceAnalyticsAppHealthApplicationPerformanceIdOption);
            ...
            command.SetHandler(async (invocationContext) => {
                var userExperienceAnalyticsAppHealthApplicationPerformanceId = invocationContext.ParseResult.GetValueForOption(userExperienceAnalyticsAppHealthApplicationPerformanceIdOption);
                var ifMatch = invocationContext.ParseResult.GetValueForOption(ifMatchOption);
                var cancellationToken = invocationContext.GetCancellationToken();
                var reqAdapter = invocationContext.GetRequestAdapter();
                var requestInfo = ToDeleteRequestInformation(q => {
                });
                if (userExperienceAnalyticsAppHealthApplicationPerformanceId is not null) requestInfo.PathParameters.Add("userExperienceAnalyticsAppHealthApplicationPerformance%2Did", userExperienceAnalyticsAppHealthApplicationPerformanceId);
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Models.UserExperienceAnalyticsAppHealthApplicationPerformance>(ApiSdk.Models.UserExperienceAnalyticsAppHealthApplicationPerformance.CreateFromDiscriminatorValue);
...
#nullable restore
        ...
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<UserExperienceAnalyticsAppHealthApplicationPerformanceItemRequestBuilderGetQueryParameters>> requestConfiguration = default) {
            ...
            if (requestConfiguration != null) {
                var requestConfig = new RequestConfiguration<UserExperienceAnalyticsAppHealthApplicationPerformanceItemRequestBuilderGetQueryParameters>();
                requestConfiguration.Invoke(requestConfig);
                requestInfo.AddQueryParameters(requestConfig.QueryParameters);
                requestInfo.AddRequestOptions(requestConfig.Options);
                requestInfo.AddHeaders(requestConfig.Headers);
