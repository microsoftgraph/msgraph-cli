...
using System;
namespace ApiSdk.DeviceManagement.UserExperienceAnalyticsDevicePerformance.Item {
    /// <summary>
    ...
    public class UserExperienceAnalyticsDevicePerformanceItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            userExperienceAnalyticsDevicePerformanceIdOption.IsRequired = true;
            command.AddOption(userExperienceAnalyticsDevicePerformanceIdOption);
            ...
            command.SetHandler(async (invocationContext) => {
                var userExperienceAnalyticsDevicePerformanceId = invocationContext.ParseResult.GetValueForOption(userExperienceAnalyticsDevicePerformanceIdOption);
                var ifMatch = invocationContext.ParseResult.GetValueForOption(ifMatchOption);
                var cancellationToken = invocationContext.GetCancellationToken();
                var reqAdapter = invocationContext.GetRequestAdapter();
                var requestInfo = ToDeleteRequestInformation(q => {
                });
                if (userExperienceAnalyticsDevicePerformanceId is not null) requestInfo.PathParameters.Add("userExperienceAnalyticsDevicePerformance%2Did", userExperienceAnalyticsDevicePerformanceId);
        ...
        public UserExperienceAnalyticsDevicePerformanceItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/deviceManagement/userExperienceAnalyticsDevicePerformance/{userExperienceAnalyticsDevicePerformance%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Delete navigation property userExperienceAnalyticsDevicePerformance for deviceManagement
        /// </summary>
...
#nullable restore
        ...
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<UserExperienceAnalyticsDevicePerformanceItemRequestBuilderGetQueryParameters>> requestConfiguration = default) {
            ...
            if (requestConfiguration != null) {
                var requestConfig = new RequestConfiguration<UserExperienceAnalyticsDevicePerformanceItemRequestBuilderGetQueryParameters>();
                requestConfiguration.Invoke(requestConfig);
                requestInfo.AddQueryParameters(requestConfig.QueryParameters);
                requestInfo.AddRequestOptions(requestConfig.Options);
                requestInfo.AddHeaders(requestConfig.Headers);
