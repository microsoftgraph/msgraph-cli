...
namespace ApiSdk.DeviceManagement.ApplePushNotificationCertificate.DownloadApplePushNotificationCertificateSigningRequest {
    ...
    public class DownloadApplePushNotificationCertificateSigningRequestResponse : IAdditionalDataHolder, IParsable {
        ...
        /// </summary>
        public static ApiSdk.DeviceManagement.ApplePushNotificationCertificate.DownloadApplePushNotificationCertificateSigningRequest.DownloadApplePushNotificationCertificateSigningRequestResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
