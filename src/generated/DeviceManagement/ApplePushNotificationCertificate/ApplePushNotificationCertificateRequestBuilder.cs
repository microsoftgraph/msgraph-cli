...
namespace ApiSdk.DeviceManagement.ApplePushNotificationCertificate {
    ...
    public class ApplePushNotificationCertificateRequestBuilder {
        ...
        /// <param name="options">Request options</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(ApiSdk.Models.ApplePushNotificationCertificate body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
