...
namespace ApiSdk.DeviceManagement.VerifyWindowsEnrollmentAutoDiscoveryWithDomainName {
    ...
    public class VerifyWindowsEnrollmentAutoDiscoveryWithDomainNameRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string domainName, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, domainNameOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
