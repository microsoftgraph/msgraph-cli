...
namespace ApiSdk.DeviceManagement.DeviceEnrollmentConfigurations.Item.Assignments {
    ...
    public class AssignmentsRequestBuilder {
        ...
        public Command BuildListCommand() {
            ...
            command.Handler = CommandHandler.Create<string, int?, int?, string, string, bool?, string[], string[], string[]>(async (deviceEnrollmentConfigurationId, top, skip, search, filter, count, orderby, select, expand) => {
