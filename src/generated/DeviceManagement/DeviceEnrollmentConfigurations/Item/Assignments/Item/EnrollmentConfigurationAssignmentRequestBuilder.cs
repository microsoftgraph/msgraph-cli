...
namespace ApiSdk.DeviceManagement.DeviceEnrollmentConfigurations.Item.Assignments.Item {
    ...
    public class EnrollmentConfigurationAssignmentRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string deviceEnrollmentConfigurationId, string enrollmentConfigurationAssignmentId, IOutputFormatterFactory outputFormatterFactory, CancellationToken cancellationToken) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string deviceEnrollmentConfigurationId, string enrollmentConfigurationAssignmentId, string[] select, string[] expand, FormatterType output, IOutputFormatterFactory outputFormatterFactory, CancellationToken cancellationToken) => {
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string deviceEnrollmentConfigurationId, string enrollmentConfigurationAssignmentId, string body, IOutputFormatterFactory outputFormatterFactory, CancellationToken cancellationToken) => {
