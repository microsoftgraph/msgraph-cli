...
namespace ApiSdk.DeviceManagement.DeviceEnrollmentConfigurations.Item.Assignments.Item {
    ...
    public class EnrollmentConfigurationAssignmentItemRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            }, new CollectionBinding(deviceEnrollmentConfigurationIdOption, enrollmentConfigurationAssignmentIdOption, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// The list of group assignments for the device configuration profile
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(deviceEnrollmentConfigurationIdOption, enrollmentConfigurationAssignmentIdOption, selectOption, expandOption, outputOption, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// The list of group assignments for the device configuration profile
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                await RequestAdapter.SendNoContentAsync(requestInfo, errorMapping: default, cancellationToken: cancellationToken);
                Console.WriteLine("Success");
            }, new CollectionBinding(deviceEnrollmentConfigurationIdOption, enrollmentConfigurationAssignmentIdOption, bodyOption, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
