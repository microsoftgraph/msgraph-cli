...
namespace ApiSdk.DeviceManagement.DeviceEnrollmentConfigurations.Item {
    ...
    public class DeviceEnrollmentConfigurationRequestBuilder {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(DeviceEnrollmentConfiguration model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
