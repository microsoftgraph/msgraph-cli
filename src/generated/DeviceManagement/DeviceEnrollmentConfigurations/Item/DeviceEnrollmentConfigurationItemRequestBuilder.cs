...
namespace ApiSdk.DeviceManagement.DeviceEnrollmentConfigurations.Item {
    ...
    public class DeviceEnrollmentConfigurationItemRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(deviceEnrollmentConfigurationIdOption, selectOption, expandOption, outputOption, outputFilterOption, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// The list of device enrollment configurations
