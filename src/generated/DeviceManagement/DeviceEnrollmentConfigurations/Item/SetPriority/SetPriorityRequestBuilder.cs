...
namespace ApiSdk.DeviceManagement.DeviceEnrollmentConfigurations.Item.SetPriority {
    ...
    public class SetPriorityRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            }, new CollectionBinding(deviceEnrollmentConfigurationIdOption, bodyOption, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
