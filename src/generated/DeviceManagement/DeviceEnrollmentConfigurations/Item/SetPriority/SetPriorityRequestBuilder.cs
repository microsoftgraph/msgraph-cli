...
namespace ApiSdk.DeviceManagement.DeviceEnrollmentConfigurations.Item.SetPriority {
    ...
    public class SetPriorityRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (string deviceEnrollmentConfigurationId, string body, IConsole console) => {
        ...
        /// </summary>
        public async Task PostAsync(SetPriorityRequestBody model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
