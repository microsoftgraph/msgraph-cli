...
namespace ApiSdk.DeviceManagement.DeviceEnrollmentConfigurations.Item.SetPriority {
    ...
    public class SetPriorityRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(SetPriorityRequestBody model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
