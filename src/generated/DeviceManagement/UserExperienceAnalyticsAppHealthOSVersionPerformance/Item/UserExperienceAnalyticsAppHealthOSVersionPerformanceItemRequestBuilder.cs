...
using System;
namespace ApiSdk.DeviceManagement.UserExperienceAnalyticsAppHealthOSVersionPerformance.Item {
    /// <summary>
    ...
    public class UserExperienceAnalyticsAppHealthOSVersionPerformanceItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            userExperienceAnalyticsAppHealthOSVersionPerformanceIdOption.IsRequired = true;
            command.AddOption(userExperienceAnalyticsAppHealthOSVersionPerformanceIdOption);
            ...
            command.SetHandler(async (invocationContext) => {
                var userExperienceAnalyticsAppHealthOSVersionPerformanceId = invocationContext.ParseResult.GetValueForOption(userExperienceAnalyticsAppHealthOSVersionPerformanceIdOption);
                var ifMatch = invocationContext.ParseResult.GetValueForOption(ifMatchOption);
                var cancellationToken = invocationContext.GetCancellationToken();
                var reqAdapter = invocationContext.GetRequestAdapter();
                var requestInfo = ToDeleteRequestInformation(q => {
                });
                if (userExperienceAnalyticsAppHealthOSVersionPerformanceId is not null) requestInfo.PathParameters.Add("userExperienceAnalyticsAppHealthOSVersionPerformance%2Did", userExperienceAnalyticsAppHealthOSVersionPerformanceId);
        ...
        public UserExperienceAnalyticsAppHealthOSVersionPerformanceItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/deviceManagement/userExperienceAnalyticsAppHealthOSVersionPerformance/{userExperienceAnalyticsAppHealthOSVersionPerformance%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Delete navigation property userExperienceAnalyticsAppHealthOSVersionPerformance for deviceManagement
        /// </summary>
...
#nullable restore
        ...
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<UserExperienceAnalyticsAppHealthOSVersionPerformanceItemRequestBuilderGetQueryParameters>> requestConfiguration = default) {
            ...
            if (requestConfiguration != null) {
                var requestConfig = new RequestConfiguration<UserExperienceAnalyticsAppHealthOSVersionPerformanceItemRequestBuilderGetQueryParameters>();
                requestConfiguration.Invoke(requestConfig);
                requestInfo.AddQueryParameters(requestConfig.QueryParameters);
                requestInfo.AddRequestOptions(requestConfig.Options);
                requestInfo.AddHeaders(requestConfig.Headers);
