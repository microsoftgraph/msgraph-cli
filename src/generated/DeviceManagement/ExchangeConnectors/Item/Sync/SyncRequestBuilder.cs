...
namespace ApiSdk.DeviceManagement.ExchangeConnectors.Item.Sync {
    ...
    public class SyncRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            }, new CollectionBinding(deviceManagementExchangeConnectorIdOption, bodyOption, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
