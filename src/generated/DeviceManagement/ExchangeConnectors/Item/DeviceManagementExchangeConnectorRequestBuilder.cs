...
namespace ApiSdk.DeviceManagement.ExchangeConnectors.Item {
    ...
    public class DeviceManagementExchangeConnectorRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string deviceManagementExchangeConnectorId, IConsole console) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string deviceManagementExchangeConnectorId, string[] select, string[] expand, FormatterType output, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string deviceManagementExchangeConnectorId, string body, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
