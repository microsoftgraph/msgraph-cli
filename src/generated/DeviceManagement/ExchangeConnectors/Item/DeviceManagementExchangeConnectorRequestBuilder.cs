...
namespace ApiSdk.DeviceManagement.ExchangeConnectors.Item {
    ...
    public class DeviceManagementExchangeConnectorRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string deviceManagementExchangeConnectorId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, deviceManagementExchangeConnectorIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The list of Exchange Connectors configured by the tenant.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string deviceManagementExchangeConnectorId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, deviceManagementExchangeConnectorIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The list of Exchange Connectors configured by the tenant.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string deviceManagementExchangeConnectorId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, deviceManagementExchangeConnectorIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(DeviceManagementExchangeConnector model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
