    ...
    public class DeviceManagementExchangeConnectorRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.Handler = CommandHandler.Create<string>(async (deviceManagementExchangeConnectorId) => {
                ...
                if (!String.IsNullOrEmpty(deviceManagementExchangeConnectorId)) requestInfo.PathParameters.Add("deviceManagementExchangeConnector_id", deviceManagementExchangeConnectorId);
        ...
        public Command BuildGetCommand() {
            ...
            command.Handler = CommandHandler.Create<string, object, object>(async (deviceManagementExchangeConnectorId, select, expand) => {
                var requestInfo = CreateGetRequestInformation();
                if (!String.IsNullOrEmpty(deviceManagementExchangeConnectorId)) requestInfo.PathParameters.Add("deviceManagementExchangeConnector_id", deviceManagementExchangeConnectorId);
                requestInfo.QueryParameters.Add("select", select);
                requestInfo.QueryParameters.Add("expand", expand);
                var result = await RequestAdapter.SendAsync<DeviceManagementExchangeConnector>(requestInfo);
                // Print request output. What if the request has no return?
