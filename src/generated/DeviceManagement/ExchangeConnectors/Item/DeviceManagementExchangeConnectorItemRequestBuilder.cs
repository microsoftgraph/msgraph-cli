...
namespace ApiSdk.DeviceManagement.ExchangeConnectors.Item {
    ...
    public class DeviceManagementExchangeConnectorItemRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            }, new CollectionBinding(deviceManagementExchangeConnectorIdOption, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// The list of Exchange Connectors configured by the tenant.
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(deviceManagementExchangeConnectorIdOption, selectOption, expandOption, outputOption, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// The list of Exchange Connectors configured by the tenant.
