...
namespace ApiSdk.DeviceManagement.RoleAssignments.Item {
    ...
    public class DeviceAndAppManagementRoleAssignmentItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.Description = "Deletes a deviceAndAppManagementRoleAssignment.\n\nFind more info here:\n  https://docs.microsoft.com/graph/api/intune-rbac-deviceandappmanagementroleassignment-delete?view=graph-rest-1.0";
        ...
        public Command BuildGetCommand() {
            ...
            command.Description = "Read properties and relationships of the deviceAndAppManagementRoleAssignment object.\n\nFind more info here:\n  https://docs.microsoft.com/graph/api/intune-rbac-deviceandappmanagementroleassignment-get?view=graph-rest-1.0";
            var deviceAndAppManagementRoleAssignmentIdOption = new Option<string>("--device-and-app-management-role-assignment-id", description: "The unique identifier of deviceAndAppManagementRoleAssignment") {
            };
            deviceAndAppManagementRoleAssignmentIdOption.IsRequired = true;
            command.AddOption(deviceAndAppManagementRoleAssignmentIdOption);
        ...
        public Command BuildPatchCommand() {
            ...
            command.Description = "Update the properties of a deviceAndAppManagementRoleAssignment object.\n\nFind more info here:\n  https://docs.microsoft.com/graph/api/intune-rbac-deviceandappmanagementroleassignment-update?view=graph-rest-1.0";
            var deviceAndAppManagementRoleAssignmentIdOption = new Option<string>("--device-and-app-management-role-assignment-id", description: "The unique identifier of deviceAndAppManagementRoleAssignment") {
            };
            deviceAndAppManagementRoleAssignmentIdOption.IsRequired = true;
            command.AddOption(deviceAndAppManagementRoleAssignmentIdOption);
        ...
        public DeviceAndAppManagementRoleAssignmentItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/deviceManagement/roleAssignments/{deviceAndAppManagementRoleAssignment%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Deletes a deviceAndAppManagementRoleAssignment.
        /// </summary>
...
#nullable restore
        ...
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<DeviceAndAppManagementRoleAssignmentItemRequestBuilderGetQueryParameters>> requestConfiguration = default) {
            ...
            if (requestConfiguration != null) {
                var requestConfig = new RequestConfiguration<DeviceAndAppManagementRoleAssignmentItemRequestBuilderGetQueryParameters>();
                requestConfiguration.Invoke(requestConfig);
                requestInfo.AddQueryParameters(requestConfig.QueryParameters);
                requestInfo.AddRequestOptions(requestConfig.Options);
                requestInfo.AddHeaders(requestConfig.Headers);
