...
namespace ApiSdk.DeviceManagement.RoleAssignments {
    ...
    public class RoleAssignmentsRequestBuilder {
        ...
        public List<Command> BuildCommand() {
            var builder = new DeviceAndAppManagementRoleAssignmentRequestBuilder(PathParameters, RequestAdapter);
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<DeviceAndAppManagementRoleAssignment> PostAsync(DeviceAndAppManagementRoleAssignment model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
