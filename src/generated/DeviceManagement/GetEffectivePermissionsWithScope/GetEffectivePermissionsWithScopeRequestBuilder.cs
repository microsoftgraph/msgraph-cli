...
namespace ApiSdk.DeviceManagement.GetEffectivePermissionsWithScope {
    ...
    public class GetEffectivePermissionsWithScopeRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string scope, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, scopeOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
