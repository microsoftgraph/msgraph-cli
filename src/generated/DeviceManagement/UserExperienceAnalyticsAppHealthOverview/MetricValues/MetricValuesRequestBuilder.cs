...
namespace ApiSdk.DeviceManagement.UserExperienceAnalyticsAppHealthOverview.MetricValues {
    ...
    public class MetricValuesRequestBuilder : BaseCliRequestBuilder {
        ...
        public MetricValuesRequestBuilder(string rawUrl) : base("{+baseurl}/deviceManagement/userExperienceAnalyticsAppHealthOverview/metricValues{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// The metric values for the user experience analytics category. Read-only.
        /// </summary>
