using ApiSdk.DeviceManagement.UserExperienceAnalyticsAppHealthOverview.MetricValues.Count;
using ApiSdk.DeviceManagement.UserExperienceAnalyticsAppHealthOverview.MetricValues.Item;
...
namespace ApiSdk.DeviceManagement.UserExperienceAnalyticsAppHealthOverview.MetricValues {
    ...
    public class MetricValuesRequestBuilder : BaseCliRequestBuilder {
        ...
        public MetricValuesRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/deviceManagement/userExperienceAnalyticsAppHealthOverview/metricValues{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// The metric values for the user experience analytics category. Read-only.
        /// </summary>
...
#nullable restore
        ...
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<MetricValuesRequestBuilderGetQueryParameters>> requestConfiguration = default) {
            ...
            if (requestConfiguration != null) {
                var requestConfig = new RequestConfiguration<MetricValuesRequestBuilderGetQueryParameters>();
