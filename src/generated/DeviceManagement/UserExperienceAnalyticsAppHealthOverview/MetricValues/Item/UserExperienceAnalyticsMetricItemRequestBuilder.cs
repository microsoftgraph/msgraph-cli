...
namespace ApiSdk.DeviceManagement.UserExperienceAnalyticsAppHealthOverview.MetricValues.Item {
    ...
    public class UserExperienceAnalyticsMetricItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public UserExperienceAnalyticsMetricItemRequestBuilder(string rawUrl) : base("{+baseurl}/deviceManagement/userExperienceAnalyticsAppHealthOverview/metricValues/{userExperienceAnalyticsMetric%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Delete navigation property metricValues for deviceManagement
        /// </summary>
