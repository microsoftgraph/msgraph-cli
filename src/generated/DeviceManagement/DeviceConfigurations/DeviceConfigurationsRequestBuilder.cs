...
namespace ApiSdk.DeviceManagement.DeviceConfigurations {
    ...
    public class DeviceConfigurationsRequestBuilder {
        ...
        public List<Command> BuildCommand() {
            var builder = new DeviceConfigurationItemRequestBuilder(PathParameters, RequestAdapter);
            var commands = new List<Command>();
            commands.Add(builder.BuildAssignCommand());
            commands.Add(builder.BuildAssignmentsCommand());
            commands.Add(builder.BuildDeleteCommand());
            commands.Add(builder.BuildDeviceSettingStateSummariesCommand());
            commands.Add(builder.BuildDeviceStatusesCommand());
            commands.Add(builder.BuildDeviceStatusOverviewCommand());
