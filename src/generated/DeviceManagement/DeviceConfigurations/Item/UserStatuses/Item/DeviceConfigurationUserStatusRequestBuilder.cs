...
namespace ApiSdk.DeviceManagement.DeviceConfigurations.Item.UserStatuses.Item {
    ...
    public class DeviceConfigurationUserStatusRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string deviceConfigurationId, string deviceConfigurationUserStatusId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, deviceConfigurationIdOption, deviceConfigurationUserStatusIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// Device configuration installation status by user.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string deviceConfigurationId, string deviceConfigurationUserStatusId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, deviceConfigurationIdOption, deviceConfigurationUserStatusIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// Device configuration installation status by user.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string deviceConfigurationId, string deviceConfigurationUserStatusId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, deviceConfigurationIdOption, deviceConfigurationUserStatusIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
