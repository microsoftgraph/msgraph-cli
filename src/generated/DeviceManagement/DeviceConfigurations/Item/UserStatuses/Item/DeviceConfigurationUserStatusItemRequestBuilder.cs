...
namespace ApiSdk.DeviceManagement.DeviceConfigurations.Item.UserStatuses.Item {
    ...
    public class DeviceConfigurationUserStatusItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public DeviceConfigurationUserStatusItemRequestBuilder(string rawUrl) : base("{+baseurl}/deviceManagement/deviceConfigurations/{deviceConfiguration%2Did}/userStatuses/{deviceConfigurationUserStatus%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Deletes a deviceConfigurationUserStatus.
        /// </summary>
