...
namespace ApiSdk.DeviceManagement.DeviceConfigurations.Item.UserStatuses {
    ...
    public class UserStatusesRequestBuilder {
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(DeviceConfigurationUserStatus body, Action<UserStatusesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
