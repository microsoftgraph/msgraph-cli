...
namespace ApiSdk.DeviceManagement.DeviceConfigurations.Item.UserStatuses {
    ...
    public class UserStatusesRequestBuilder {
        ...
        public List<Command> BuildCommand() {
            var builder = new DeviceConfigurationUserStatusItemRequestBuilder(PathParameters, RequestAdapter);
        ...
        public UserStatusesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/deviceManagement/deviceConfigurations/{deviceConfiguration%2Did}/userStatuses{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
        ...
        /// <param name="options">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(DeviceConfigurationUserStatus body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
