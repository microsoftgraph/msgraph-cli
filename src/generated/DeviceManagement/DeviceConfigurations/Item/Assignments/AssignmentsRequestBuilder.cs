...
namespace ApiSdk.DeviceManagement.DeviceConfigurations.Item.Assignments {
    ...
    public class AssignmentsRequestBuilder {
        ...
        public List<Command> BuildCommand() {
            var builder = new DeviceConfigurationAssignmentRequestBuilder(PathParameters, RequestAdapter);
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<DeviceConfigurationAssignment> PostAsync(DeviceConfigurationAssignment model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
