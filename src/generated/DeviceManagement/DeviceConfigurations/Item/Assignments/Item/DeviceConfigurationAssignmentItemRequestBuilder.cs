    ...
    public class DeviceConfigurationAssignmentItemRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                requestInfo.PathParameters.Add("deviceConfigurationAssignment%2Did", deviceConfigurationAssignmentId);
            ...
            }, new CollectionBinding(deviceConfigurationIdOption, deviceConfigurationAssignmentIdOption, ifMatchOption, new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
