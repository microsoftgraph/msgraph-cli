...
namespace ApiSdk.DeviceManagement.DeviceConfigurations.Item.Assignments.Item {
    ...
    public class DeviceConfigurationAssignmentRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            var deviceConfigurationAssignmentIdOption = new Option<string>("--deviceconfigurationassignment-id", description: "key: id of deviceConfigurationAssignment") {
            };
            deviceConfigurationAssignmentIdOption.IsRequired = true;
            command.AddOption(deviceConfigurationAssignmentIdOption);
            command.SetHandler(async (string deviceConfigurationId, string deviceConfigurationAssignmentId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, deviceConfigurationIdOption, deviceConfigurationAssignmentIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The list of assignments for the device configuration profile.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string deviceConfigurationId, string deviceConfigurationAssignmentId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, deviceConfigurationIdOption, deviceConfigurationAssignmentIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The list of assignments for the device configuration profile.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string deviceConfigurationId, string deviceConfigurationAssignmentId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, deviceConfigurationIdOption, deviceConfigurationAssignmentIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
