...
namespace ApiSdk.DeviceManagement.DeviceConfigurations.Item.Assignments.Item {
    ...
    public class DeviceConfigurationAssignmentRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string deviceConfigurationId, string deviceConfigurationAssignmentId, IOutputFormatterFactory outputFormatterFactory, CancellationToken cancellationToken) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string deviceConfigurationId, string deviceConfigurationAssignmentId, string[] select, string[] expand, FormatterType output, IOutputFormatterFactory outputFormatterFactory, CancellationToken cancellationToken) => {
            ...
            }, deviceConfigurationIdOption, deviceConfigurationAssignmentIdOption, selectOption, expandOption, outputOption);
            return command;
        }
        /// <summary>
        /// The list of assignments for the device configuration profile.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string deviceConfigurationId, string deviceConfigurationAssignmentId, string body, IOutputFormatterFactory outputFormatterFactory, CancellationToken cancellationToken) => {
