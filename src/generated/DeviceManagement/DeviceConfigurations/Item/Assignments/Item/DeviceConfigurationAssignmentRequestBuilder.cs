...
namespace ApiSdk.DeviceManagement.DeviceConfigurations.Item.Assignments.Item {
    ...
    public class DeviceConfigurationAssignmentRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string deviceConfigurationId, string deviceConfigurationAssignmentId, string[] select, string[] expand) => {
            ...
            }, deviceConfigurationIdOption, deviceConfigurationAssignmentIdOption, selectOption, expandOption);
            return command;
        }
        /// <summary>
        /// The list of assignments for the device configuration profile.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string deviceConfigurationId, string deviceConfigurationAssignmentId, string body) => {
