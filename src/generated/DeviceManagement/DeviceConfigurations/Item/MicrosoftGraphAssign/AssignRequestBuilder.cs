...
namespace ApiSdk.DeviceManagement.DeviceConfigurations.Item.MicrosoftGraphAssign {
    /// <summary>
    ...
    public class AssignRequestBuilder {
        ...
        public AssignRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/deviceManagement/deviceConfigurations/{deviceConfiguration%2Did}/microsoft.graph.assign";
