...
namespace ApiSdk.DeviceManagement.DeviceConfigurations.Item.DeviceStatuses.Item {
    ...
    public class DeviceConfigurationDeviceStatusItemRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            }, new CollectionBinding(deviceConfigurationIdOption, deviceConfigurationDeviceStatusIdOption, ifMatchOption, new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        ...
        /// <param name="options">Request options</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(DeviceConfigurationDeviceStatus body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
