...
namespace ApiSdk.DeviceManagement.DeviceConfigurations.Item.DeviceStatuses {
    ...
    public class DeviceStatusesRequestBuilder : BaseCliRequestBuilder {
        ...
        public DeviceStatusesRequestBuilder(string rawUrl) : base("{+baseurl}/deviceManagement/deviceConfigurations/{deviceConfiguration%2Did}/deviceStatuses{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// List properties and relationships of the deviceConfigurationDeviceStatus objects.
        /// </summary>
