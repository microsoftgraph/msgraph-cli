...
namespace ApiSdk.DeviceManagement.DeviceConfigurations.Item.DeviceStatuses {
    ...
    public class DeviceStatusesRequestBuilder {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<DeviceConfigurationDeviceStatus> PostAsync(DeviceConfigurationDeviceStatus model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
