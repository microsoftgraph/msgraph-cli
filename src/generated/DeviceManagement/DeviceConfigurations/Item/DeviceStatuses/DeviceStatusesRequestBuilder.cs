...
namespace ApiSdk.DeviceManagement.DeviceConfigurations.Item.DeviceStatuses {
    ...
    public class DeviceStatusesRequestBuilder {
        ...
        public Command BuildListCommand() {
            ...
            command.Handler = CommandHandler.Create<string, int?, int?, string, string, bool?, object, object, object>(async (deviceConfigurationId, top, skip, search, filter, count, orderby, select, expand) => {
