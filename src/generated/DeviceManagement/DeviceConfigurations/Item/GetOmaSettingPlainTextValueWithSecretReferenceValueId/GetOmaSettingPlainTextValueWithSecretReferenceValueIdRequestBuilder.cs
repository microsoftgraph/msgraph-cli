...
namespace ApiSdk.DeviceManagement.DeviceConfigurations.Item.GetOmaSettingPlainTextValueWithSecretReferenceValueId {
    ...
    public class GetOmaSettingPlainTextValueWithSecretReferenceValueIdRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string deviceConfigurationId, string secretReferenceValueId, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, deviceConfigurationIdOption, secretReferenceValueIdOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
