...
namespace ApiSdk.DeviceManagement.DeviceConfigurations.Item.Assign {
    ...
    public class AssignRequestBuilder {
        ...
        /// </summary>
        public async Task<IEnumerable<ApiSdk.DeviceManagement.DeviceConfigurations.Item.Assign.Assign>> PostAsync(AssignRequestBody model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = model ?? throw new ArgumentNullException(nameof(model));
            var requestInfo = CreatePostRequestInformation(model, h, o);
            return await RequestAdapter.SendCollectionAsync<ApiSdk.DeviceManagement.DeviceConfigurations.Item.Assign.Assign>(requestInfo, responseHandler, cancellationToken);
        }
    }
}
