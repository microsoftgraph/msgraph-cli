...
namespace ApiSdk.DeviceManagement.DeviceConfigurations.Item.Assign {
    ...
    public class AssignRequestBuilder {
        ...
        /// </summary>
        public async Task<IEnumerable<ApiSdk.DeviceManagement.DeviceConfigurations.Item.Assign.Assign>> PostAsync(AssignRequestBody model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
