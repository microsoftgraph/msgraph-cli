...
namespace ApiSdk.DeviceManagement.DeviceConfigurations.Item.DeviceSettingStateSummaries.Item {
    ...
    public class SettingStateDeviceSummaryItemRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            }, new CollectionBinding(deviceConfigurationIdOption, settingStateDeviceSummaryIdOption, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// Device Configuration Setting State Device Summary
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(deviceConfigurationIdOption, settingStateDeviceSummaryIdOption, selectOption, expandOption, outputOption, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// Device Configuration Setting State Device Summary
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                await RequestAdapter.SendNoContentAsync(requestInfo, errorMapping: default, cancellationToken: cancellationToken);
                Console.WriteLine("Success");
            }, new CollectionBinding(deviceConfigurationIdOption, settingStateDeviceSummaryIdOption, bodyOption, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
