...
namespace ApiSdk.DeviceManagement.ComplianceManagementPartners.Item {
    ...
    public class ComplianceManagementPartnerRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string complianceManagementPartnerId) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string complianceManagementPartnerId, string[] select, string[] expand) => {
                var requestInfo = CreateGetRequestInformation(q => {
                    q.Select = select;
                    q.Expand = expand;
                });
                var result = await RequestAdapter.SendAsync<ComplianceManagementPartner>(requestInfo);
                // Print request output. What if the request has no return?
            ...
            }, complianceManagementPartnerIdOption, selectOption, expandOption);
            return command;
        }
        /// <summary>
        /// The list of Compliance Management Partners configured by the tenant.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string complianceManagementPartnerId, string body) => {
