...
namespace ApiSdk.DeviceManagement.ComplianceManagementPartners.Item {
    ...
    public class ComplianceManagementPartnerRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string complianceManagementPartnerId, IConsole console) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string complianceManagementPartnerId, string[] select, string[] expand, FormatterType output, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string complianceManagementPartnerId, string body, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
