...
namespace ApiSdk.DeviceManagement.ComplianceManagementPartners.Item {
    ...
    public class ComplianceManagementPartnerRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string complianceManagementPartnerId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, complianceManagementPartnerIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The list of Compliance Management Partners configured by the tenant.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string complianceManagementPartnerId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, complianceManagementPartnerIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The list of Compliance Management Partners configured by the tenant.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string complianceManagementPartnerId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, complianceManagementPartnerIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
