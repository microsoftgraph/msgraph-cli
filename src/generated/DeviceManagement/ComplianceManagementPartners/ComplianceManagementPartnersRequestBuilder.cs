...
namespace ApiSdk.DeviceManagement.ComplianceManagementPartners {
    ...
    public class ComplianceManagementPartnersRequestBuilder {
        ...
        public List<Command> BuildCommand() {
            var builder = new ComplianceManagementPartnerRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildListCommand() {
            ...
            command.Handler = CommandHandler.Create<int?, int?, string, string, bool?, object, object, object>(async (top, skip, search, filter, count, orderby, select, expand) => {
                ...
                var result = await RequestAdapter.SendAsync<ComplianceManagementPartnersResponse>(requestInfo);
                // Print request output. What if the request has no return?
                using var serializer = RequestAdapter.SerializationWriterFactory.GetSerializationWriter("application/json");
                serializer.WriteObjectValue(null, result);
                using var content = serializer.GetSerializedContent();
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<ComplianceManagementPartner> PostAsync(ComplianceManagementPartner model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
