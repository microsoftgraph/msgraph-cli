...
namespace ApiSdk.DeviceManagement.TelecomExpenseManagementPartners.Item {
    ...
    public class TelecomExpenseManagementPartnerItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public TelecomExpenseManagementPartnerItemRequestBuilder(string rawUrl) : base("{+baseurl}/deviceManagement/telecomExpenseManagementPartners/{telecomExpenseManagementPartner%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Deletes a telecomExpenseManagementPartner.
        /// </summary>
