...
namespace ApiSdk.DeviceManagement.TelecomExpenseManagementPartners.Item {
    ...
    public class TelecomExpenseManagementPartnerItemRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(telecomExpenseManagementPartnerIdOption, selectOption, expandOption, outputOption, outputFilterOption, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// The telecom expense management partners.
