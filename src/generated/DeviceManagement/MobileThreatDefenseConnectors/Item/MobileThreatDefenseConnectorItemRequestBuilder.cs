...
namespace ApiSdk.DeviceManagement.MobileThreatDefenseConnectors.Item {
    ...
    public class MobileThreatDefenseConnectorItemRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            }, new CollectionBinding(mobileThreatDefenseConnectorIdOption, new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// The list of Mobile threat Defense connectors configured by the tenant.
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(mobileThreatDefenseConnectorIdOption, selectOption, expandOption, outputOption, queryOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// The list of Mobile threat Defense connectors configured by the tenant.
