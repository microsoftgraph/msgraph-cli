...
namespace ApiSdk.DeviceManagement.MobileThreatDefenseConnectors.Item {
    ...
    public class MobileThreatDefenseConnectorItemRequestBuilder {
        ...
        /// <param name="options">Request options</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(MobileThreatDefenseConnector body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
