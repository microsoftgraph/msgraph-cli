using ApiSdk.DeviceManagement.TroubleshootingEvents.Count;
...
namespace ApiSdk.DeviceManagement.TroubleshootingEvents {
    ...
    public class TroubleshootingEventsRequestBuilder {
        ...
        public Command BuildCommand() {
            ...
            var builder = new DeviceManagementTroubleshootingEventItemRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildCreateCommand() {
            ...
            command.Description = "Create new navigation property to troubleshootingEvents for deviceManagement";
        ...
        public TroubleshootingEventsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/deviceManagement/troubleshootingEvents{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
        ...
        /// </summary>
        public RequestInformation CreateGetRequestInformation(Action<TroubleshootingEventsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(DeviceManagementTroubleshootingEvent body, Action<TroubleshootingEventsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
