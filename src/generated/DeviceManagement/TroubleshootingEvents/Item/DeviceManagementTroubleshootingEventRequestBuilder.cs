...
namespace ApiSdk.DeviceManagement.TroubleshootingEvents.Item {
    ...
    public class DeviceManagementTroubleshootingEventRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string deviceManagementTroubleshootingEventId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, deviceManagementTroubleshootingEventIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The list of troubleshooting events for the tenant.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string deviceManagementTroubleshootingEventId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, deviceManagementTroubleshootingEventIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The list of troubleshooting events for the tenant.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string deviceManagementTroubleshootingEventId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, deviceManagementTroubleshootingEventIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(DeviceManagementTroubleshootingEvent model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
