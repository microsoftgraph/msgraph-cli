...
namespace ApiSdk.DeviceManagement.TroubleshootingEvents.Item {
    ...
    public class DeviceManagementTroubleshootingEventItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.Description = "Delete navigation property troubleshootingEvents for deviceManagement";
        ...
        public Command BuildPatchCommand() {
            ...
            command.Description = "Update the navigation property troubleshootingEvents in deviceManagement";
            var deviceManagementTroubleshootingEventIdOption = new Option<string>("--device-management-troubleshooting-event-id", description: "The unique identifier of deviceManagementTroubleshootingEvent") {
            };
            deviceManagementTroubleshootingEventIdOption.IsRequired = true;
            command.AddOption(deviceManagementTroubleshootingEventIdOption);
        ...
        public DeviceManagementTroubleshootingEventItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/deviceManagement/troubleshootingEvents/{deviceManagementTroubleshootingEvent%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Delete navigation property troubleshootingEvents for deviceManagement
        /// </summary>
...
#nullable restore
        ...
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<DeviceManagementTroubleshootingEventItemRequestBuilderGetQueryParameters>> requestConfiguration = default) {
            ...
            if (requestConfiguration != null) {
                var requestConfig = new RequestConfiguration<DeviceManagementTroubleshootingEventItemRequestBuilderGetQueryParameters>();
                requestConfiguration.Invoke(requestConfig);
                requestInfo.AddQueryParameters(requestConfig.QueryParameters);
                requestInfo.AddRequestOptions(requestConfig.Options);
                requestInfo.AddHeaders(requestConfig.Headers);
