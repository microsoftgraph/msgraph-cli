...
namespace ApiSdk.DeviceManagement.WindowsAutopilotDeviceIdentities {
    ...
    public class WindowsAutopilotDeviceIdentitiesRequestBuilder {
        ...
        public List<Command> BuildCommand() {
            ...
            commands.Add(builder.BuildAssignUserToDeviceCommand());
            commands.Add(builder.BuildDeleteCommand());
            commands.Add(builder.BuildGetCommand());
            commands.Add(builder.BuildPatchCommand());
            commands.Add(builder.BuildUnassignUserFromDeviceCommand());
            commands.Add(builder.BuildUpdateDevicePropertiesCommand());
            return commands;
        }
        /// <summary>
