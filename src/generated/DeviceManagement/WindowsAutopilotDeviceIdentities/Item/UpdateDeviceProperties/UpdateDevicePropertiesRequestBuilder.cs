...
namespace ApiSdk.DeviceManagement.WindowsAutopilotDeviceIdentities.Item.UpdateDeviceProperties {
    ...
    public class UpdateDevicePropertiesRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(UpdateDevicePropertiesRequestBody model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
