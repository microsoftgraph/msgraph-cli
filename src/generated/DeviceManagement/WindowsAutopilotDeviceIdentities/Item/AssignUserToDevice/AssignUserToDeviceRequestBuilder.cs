...
namespace ApiSdk.DeviceManagement.WindowsAutopilotDeviceIdentities.Item.AssignUserToDevice {
    ...
    public class AssignUserToDeviceRequestBuilder {
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(AssignUserToDevicePostRequestBody body, Action<AssignUserToDeviceRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
