...
namespace ApiSdk.DeviceManagement.WindowsAutopilotDeviceIdentities.Item {
    ...
    public class WindowsAutopilotDeviceIdentityItemRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(windowsAutopilotDeviceIdentityIdOption, selectOption, expandOption, outputOption, queryOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// The Windows autopilot device identities contained collection.
