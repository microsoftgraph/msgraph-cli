...
namespace ApiSdk.DeviceManagement.DeviceCategories {
    ...
    public class DeviceCategoriesRequestBuilder {
        ...
        /// <param name="options">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ApiSdk.Models.DeviceCategory body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
