...
namespace ApiSdk.DeviceManagement.DeviceCategories {
    ...
    public class DeviceCategoriesRequestBuilder {
        ...
        public List<Command> BuildCommand() {
            var builder = new DeviceCategoryItemRequestBuilder(PathParameters, RequestAdapter);
        ...
        /// <param name="options">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ApiSdk.Models.Microsoft.Graph.DeviceCategory body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
