...
namespace ApiSdk.DeviceManagement.DeviceCategories {
    ...
    public class DeviceCategoriesRequestBuilder {
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ApiSdk.Models.DeviceCategory body, Action<DeviceCategoriesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
