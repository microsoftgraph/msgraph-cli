...
namespace ApiSdk.DeviceManagement.DetectedApps.Item {
    ...
    public class DetectedAppRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string detectedAppId, IConsole console) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string detectedAppId, string[] select, string[] expand, FormatterType output, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string detectedAppId, string body, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
