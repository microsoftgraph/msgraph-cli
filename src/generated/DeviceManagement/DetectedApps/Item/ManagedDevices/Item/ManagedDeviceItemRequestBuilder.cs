    ...
    public class ManagedDeviceItemRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                var detectedAppId = (string) parameters[0];
                ...
                requestInfo.PathParameters.Add("detectedApp%2Did", detectedAppId);
            ...
            }, new CollectionBinding(detectedAppIdOption, managedDeviceIdOption, selectOption, expandOption, outputOption, queryOption, jsonNoIndentOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
