...
namespace ApiSdk.DeviceManagement.DetectedApps.Item.ManagedDevices.Item {
    ...
    public class ManagedDeviceItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public ManagedDeviceItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/deviceManagement/detectedApps/{detectedApp%2Did}/managedDevices/{managedDevice%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// The devices that have the discovered application installed
        /// </summary>
