...
namespace ApiSdk.DeviceManagement.DetectedApps.Item.ManagedDevices {
    ...
    public class ManagedDevicesRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(detectedAppIdOption, topOption, skipOption, searchOption, filterOption, countOption, orderbyOption, selectOption, expandOption, outputOption, outputFilterOption, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
