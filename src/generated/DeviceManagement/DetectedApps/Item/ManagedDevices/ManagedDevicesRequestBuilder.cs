...
namespace ApiSdk.DeviceManagement.DetectedApps.Item.ManagedDevices {
    ...
    public class ManagedDevicesRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.Handler = CommandHandler.Create<string, int?, int?, string, string, bool?, string[], string[], string[]>(async (detectedAppId, top, skip, search, filter, count, orderby, select, expand) => {
