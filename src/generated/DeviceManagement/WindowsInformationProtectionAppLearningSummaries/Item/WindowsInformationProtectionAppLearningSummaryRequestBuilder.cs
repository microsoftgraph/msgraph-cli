...
namespace ApiSdk.DeviceManagement.WindowsInformationProtectionAppLearningSummaries.Item {
    ...
    public class WindowsInformationProtectionAppLearningSummaryRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            }, windowsInformationProtectionAppLearningSummaryIdOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// The windows information protection app learning summaries.
        ...
        public Command BuildGetCommand() {
            ...
            }, windowsInformationProtectionAppLearningSummaryIdOption, selectOption, expandOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// The windows information protection app learning summaries.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string windowsInformationProtectionAppLearningSummaryId, string body, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                ...
                await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                console.WriteLine("Success");
            }, windowsInformationProtectionAppLearningSummaryIdOption, bodyOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
