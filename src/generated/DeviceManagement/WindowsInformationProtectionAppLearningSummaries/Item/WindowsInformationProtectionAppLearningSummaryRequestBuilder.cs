...
namespace ApiSdk.DeviceManagement.WindowsInformationProtectionAppLearningSummaries.Item {
    ...
    public class WindowsInformationProtectionAppLearningSummaryRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string windowsInformationProtectionAppLearningSummaryId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, windowsInformationProtectionAppLearningSummaryIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The windows information protection app learning summaries.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string windowsInformationProtectionAppLearningSummaryId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, windowsInformationProtectionAppLearningSummaryIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The windows information protection app learning summaries.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string windowsInformationProtectionAppLearningSummaryId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, windowsInformationProtectionAppLearningSummaryIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
