...
namespace ApiSdk.DeviceManagement.WindowsInformationProtectionAppLearningSummaries {
    ...
    public class WindowsInformationProtectionAppLearningSummariesRequestBuilder {
        ...
        public Command BuildCommand() {
            ...
            var builder = new WindowsInformationProtectionAppLearningSummaryItemRequestBuilder(PathParameters, RequestAdapter);
        ...
        public WindowsInformationProtectionAppLearningSummariesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/deviceManagement/windowsInformationProtectionAppLearningSummaries{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
        ...
        /// </summary>
        public RequestInformation CreateGetRequestInformation(Action<WindowsInformationProtectionAppLearningSummariesRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(WindowsInformationProtectionAppLearningSummary body, Action<WindowsInformationProtectionAppLearningSummariesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
