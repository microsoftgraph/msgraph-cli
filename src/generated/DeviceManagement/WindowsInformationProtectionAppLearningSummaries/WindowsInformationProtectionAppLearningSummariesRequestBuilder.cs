...
namespace ApiSdk.DeviceManagement.WindowsInformationProtectionAppLearningSummaries {
    ...
    public class WindowsInformationProtectionAppLearningSummariesRequestBuilder {
        ...
        /// <param name="options">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(WindowsInformationProtectionAppLearningSummary body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
