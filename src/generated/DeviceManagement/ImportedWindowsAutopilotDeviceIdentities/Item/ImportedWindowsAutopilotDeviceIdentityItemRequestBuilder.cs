...
namespace ApiSdk.DeviceManagement.ImportedWindowsAutopilotDeviceIdentities.Item {
    ...
    public class ImportedWindowsAutopilotDeviceIdentityItemRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            }, new CollectionBinding(importedWindowsAutopilotDeviceIdentityIdOption, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// Collection of imported Windows autopilot devices.
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(importedWindowsAutopilotDeviceIdentityIdOption, selectOption, expandOption, outputOption, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// Collection of imported Windows autopilot devices.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                await RequestAdapter.SendNoContentAsync(requestInfo, errorMapping: default, cancellationToken: cancellationToken);
                Console.WriteLine("Success");
            }, new CollectionBinding(importedWindowsAutopilotDeviceIdentityIdOption, bodyOption, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
