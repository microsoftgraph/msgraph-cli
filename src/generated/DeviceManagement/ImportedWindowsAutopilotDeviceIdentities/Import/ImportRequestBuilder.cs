    ...
    public class ImportRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.DeviceManagement.ImportedWindowsAutopilotDeviceIdentities.Import.ImportRequestBody>(ApiSdk.DeviceManagement.ImportedWindowsAutopilotDeviceIdentities.Import.ImportRequestBody.CreateFromDiscriminatorValue);
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ApiSdk.DeviceManagement.ImportedWindowsAutopilotDeviceIdentities.Import.ImportRequestBody body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
