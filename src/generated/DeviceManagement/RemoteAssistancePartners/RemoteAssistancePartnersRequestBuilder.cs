...
namespace ApiSdk.DeviceManagement.RemoteAssistancePartners {
    ...
    public class RemoteAssistancePartnersRequestBuilder {
        ...
        public List<Command> BuildCommand() {
            var builder = new RemoteAssistancePartnerItemRequestBuilder(PathParameters, RequestAdapter);
            var commands = new List<Command>();
            commands.Add(builder.BuildBeginOnboardingCommand());
            commands.Add(builder.BuildDeleteCommand());
            commands.Add(builder.BuildDisconnectCommand());
