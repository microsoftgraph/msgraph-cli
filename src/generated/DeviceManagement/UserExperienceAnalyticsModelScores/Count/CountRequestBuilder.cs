...
using System;
namespace ApiSdk.DeviceManagement.UserExperienceAnalyticsModelScores.Count {
    /// <summary>
    ...
    public class CountRequestBuilder : BaseCliRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/deviceManagement/userExperienceAnalyticsModelScores/$count{?%24search,%24filter}", pathParameters) {
        }
        /// <summary>
        /// Get the number of the resource
        /// </summary>
