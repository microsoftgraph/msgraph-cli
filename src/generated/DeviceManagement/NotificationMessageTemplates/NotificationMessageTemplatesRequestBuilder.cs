...
namespace ApiSdk.DeviceManagement.NotificationMessageTemplates {
    ...
    public class NotificationMessageTemplatesRequestBuilder {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<NotificationMessageTemplate> PostAsync(NotificationMessageTemplate model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
