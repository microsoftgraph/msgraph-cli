...
namespace ApiSdk.DeviceManagement.NotificationMessageTemplates.Item {
    ...
    public class NotificationMessageTemplateItemRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(notificationMessageTemplateIdOption, selectOption, expandOption, outputOption, outputFilterOption, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
