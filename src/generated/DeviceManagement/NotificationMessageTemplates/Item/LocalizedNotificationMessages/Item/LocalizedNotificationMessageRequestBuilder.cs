...
namespace ApiSdk.DeviceManagement.NotificationMessageTemplates.Item.LocalizedNotificationMessages.Item {
    ...
    public class LocalizedNotificationMessageRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string notificationMessageTemplateId, string localizedNotificationMessageId, IConsole console) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string notificationMessageTemplateId, string localizedNotificationMessageId, string[] select, string[] expand, FormatterType output, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string notificationMessageTemplateId, string localizedNotificationMessageId, string body, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
