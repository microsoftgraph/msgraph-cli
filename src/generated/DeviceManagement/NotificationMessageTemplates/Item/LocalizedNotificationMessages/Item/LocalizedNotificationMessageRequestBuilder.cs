...
namespace ApiSdk.DeviceManagement.NotificationMessageTemplates.Item.LocalizedNotificationMessages.Item {
    ...
    public class LocalizedNotificationMessageRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            }, notificationMessageTemplateIdOption, localizedNotificationMessageIdOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// The list of localized messages for this Notification Message Template.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string notificationMessageTemplateId, string localizedNotificationMessageId, string[] select, string[] expand, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
            ...
            }, notificationMessageTemplateIdOption, localizedNotificationMessageIdOption, selectOption, expandOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// The list of localized messages for this Notification Message Template.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string notificationMessageTemplateId, string localizedNotificationMessageId, string body, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                ...
                await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                console.WriteLine("Success");
            }, notificationMessageTemplateIdOption, localizedNotificationMessageIdOption, bodyOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
