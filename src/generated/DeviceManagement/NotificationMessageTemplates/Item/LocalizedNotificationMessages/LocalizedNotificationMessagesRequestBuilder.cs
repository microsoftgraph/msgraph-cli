...
namespace ApiSdk.DeviceManagement.NotificationMessageTemplates.Item.LocalizedNotificationMessages {
    ...
    public class LocalizedNotificationMessagesRequestBuilder {
        ...
        public Command BuildCommand() {
            ...
            var builder = new LocalizedNotificationMessageItemRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildCreateCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                requestInfo.PathParameters.Add("notificationMessageTemplate%2Did", notificationMessageTemplateId);
            ...
            }, new CollectionBinding(notificationMessageTemplateIdOption, bodyOption, outputOption, queryOption, jsonNoIndentOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        ...
        /// </summary>
        public RequestInformation CreateGetRequestInformation(Action<LocalizedNotificationMessagesRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(LocalizedNotificationMessage body, Action<LocalizedNotificationMessagesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
