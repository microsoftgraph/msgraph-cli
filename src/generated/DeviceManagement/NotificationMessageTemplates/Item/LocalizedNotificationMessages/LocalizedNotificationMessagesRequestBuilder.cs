...
namespace ApiSdk.DeviceManagement.NotificationMessageTemplates.Item.LocalizedNotificationMessages {
    ...
    public class LocalizedNotificationMessagesRequestBuilder {
        ...
        public Command BuildListCommand() {
            ...
            command.Handler = CommandHandler.Create<string, int?, int?, string, string, bool?, string[], string[], string[]>(async (notificationMessageTemplateId, top, skip, search, filter, count, orderby, select, expand) => {
