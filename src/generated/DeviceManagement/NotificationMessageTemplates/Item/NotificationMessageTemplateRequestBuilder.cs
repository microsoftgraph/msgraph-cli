...
namespace ApiSdk.DeviceManagement.NotificationMessageTemplates.Item {
    ...
    public class NotificationMessageTemplateRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string notificationMessageTemplateId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, notificationMessageTemplateIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string notificationMessageTemplateId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, notificationMessageTemplateIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        public Command BuildSendTestMessageCommand() {
            var command = new Command("send-test-message");
            var builder = new ApiSdk.DeviceManagement.NotificationMessageTemplates.Item.SendTestMessage.SendTestMessageRequestBuilder(PathParameters, RequestAdapter);
