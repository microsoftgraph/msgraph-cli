...
namespace ApiSdk.DeviceManagement.NotificationMessageTemplates.Item {
    ...
    public class NotificationMessageTemplateRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string notificationMessageTemplateId, string[] select, string[] expand, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string notificationMessageTemplateId, string body, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
