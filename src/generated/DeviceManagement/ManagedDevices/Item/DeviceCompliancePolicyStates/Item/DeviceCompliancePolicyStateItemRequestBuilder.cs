...
namespace ApiSdk.DeviceManagement.ManagedDevices.Item.DeviceCompliancePolicyStates.Item {
    ...
    public class DeviceCompliancePolicyStateItemRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(managedDeviceIdOption, deviceCompliancePolicyStateIdOption, selectOption, expandOption, outputOption, queryOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// Device compliance policy states for this device.
