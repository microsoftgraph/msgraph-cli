...
namespace ApiSdk.DeviceManagement.ManagedDevices.Item.DeviceCompliancePolicyStates.Item
{
    ...
    public class DeviceCompliancePolicyStateItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.DeviceManagement.ManagedDevices.Item.DeviceCompliancePolicyStates.Item.DeviceCompliancePolicyStateItemRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public DeviceCompliancePolicyStateItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/deviceManagement/managedDevices/{managedDevice%2Did}/deviceCompliancePolicyStates/{deviceCompliancePolicyState%2Did}{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.DeviceManagement.ManagedDevices.Item.DeviceCompliancePolicyStates.Item.DeviceCompliancePolicyStateItemRequestBuilder"/> and sets the default values.
        ...
        public DeviceCompliancePolicyStateItemRequestBuilder(string rawUrl) : base("{+baseurl}/deviceManagement/managedDevices/{managedDevice%2Did}/deviceCompliancePolicyStates/{deviceCompliancePolicyState%2Did}{?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
        /// Delete navigation property deviceCompliancePolicyStates for deviceManagement
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.DeviceManagement.ManagedDevices.Item.DeviceCompliancePolicyStates.Item.DeviceCompliancePolicyStateItemRequestBuilder.DeviceCompliancePolicyStateItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.DeviceManagement.ManagedDevices.Item.DeviceCompliancePolicyStates.Item.DeviceCompliancePolicyStateItemRequestBuilder.DeviceCompliancePolicyStateItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
