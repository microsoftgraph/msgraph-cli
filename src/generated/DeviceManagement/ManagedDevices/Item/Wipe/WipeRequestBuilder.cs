...
namespace ApiSdk.DeviceManagement.ManagedDevices.Item.Wipe {
    ...
    public class WipeRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(WipeRequestBody model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
