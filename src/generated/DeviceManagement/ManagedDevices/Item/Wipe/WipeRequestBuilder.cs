    ...
    public class WipeRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.DeviceManagement.ManagedDevices.Item.Wipe.WipeRequestBody>(ApiSdk.DeviceManagement.ManagedDevices.Item.Wipe.WipeRequestBody.CreateFromDiscriminatorValue);
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ApiSdk.DeviceManagement.ManagedDevices.Item.Wipe.WipeRequestBody body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
