...
namespace ApiSdk.DeviceManagement.ManagedDevices.Item.CleanWindowsDevice {
    ...
    public class CleanWindowsDeviceRequestBody : IAdditionalDataHolder, IParsable {
        ...
        /// </summary>
        public static ApiSdk.DeviceManagement.ManagedDevices.Item.CleanWindowsDevice.CleanWindowsDeviceRequestBody CreateFromDiscriminatorValue(IParseNode parseNode) {
