...
namespace ApiSdk.DeviceManagement.ManagedDevices.Item.CleanWindowsDevice {
    ...
    public class CleanWindowsDeviceRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(CleanWindowsDeviceRequestBody model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
