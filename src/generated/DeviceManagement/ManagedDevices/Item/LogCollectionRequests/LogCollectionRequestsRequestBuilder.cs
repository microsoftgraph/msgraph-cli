...
namespace ApiSdk.DeviceManagement.ManagedDevices.Item.LogCollectionRequests {
    ...
    public class LogCollectionRequestsRequestBuilder : BaseCliRequestBuilder {
        ...
        public LogCollectionRequestsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/deviceManagement/managedDevices/{managedDevice%2Did}/logCollectionRequests{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// List of log collection requests
        /// </summary>
...
#nullable restore
        ...
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<LogCollectionRequestsRequestBuilderGetQueryParameters>> requestConfiguration = default) {
            ...
            if (requestConfiguration != null) {
                var requestConfig = new RequestConfiguration<LogCollectionRequestsRequestBuilderGetQueryParameters>();
