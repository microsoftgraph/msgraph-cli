...
namespace ApiSdk.DeviceManagement.ManagedDevices.Item.DeleteUserFromSharedAppleDevice {
    ...
    public class DeleteUserFromSharedAppleDeviceRequestBody : IAdditionalDataHolder, IParsable {
        ...
        /// </summary>
        public static ApiSdk.DeviceManagement.ManagedDevices.Item.DeleteUserFromSharedAppleDevice.DeleteUserFromSharedAppleDeviceRequestBody CreateFromDiscriminatorValue(IParseNode parseNode) {
