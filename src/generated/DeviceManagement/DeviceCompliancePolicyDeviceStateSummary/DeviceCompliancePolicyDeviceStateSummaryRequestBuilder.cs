...
namespace ApiSdk.DeviceManagement.DeviceCompliancePolicyDeviceStateSummary {
    ...
    public class DeviceCompliancePolicyDeviceStateSummaryRequestBuilder {
        ...
        public DeviceCompliancePolicyDeviceStateSummaryRequestBuilder(Dictionary<string, object> pathParameters) {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.DeviceCompliancePolicyDeviceStateSummary body, Action<DeviceCompliancePolicyDeviceStateSummaryRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.DeviceCompliancePolicyDeviceStateSummary body, Action<DeviceCompliancePolicyDeviceStateSummaryRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
