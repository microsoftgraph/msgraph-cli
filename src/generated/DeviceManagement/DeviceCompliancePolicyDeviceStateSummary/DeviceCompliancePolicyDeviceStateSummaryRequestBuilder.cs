...
namespace ApiSdk.DeviceManagement.DeviceCompliancePolicyDeviceStateSummary {
    ...
    public class DeviceCompliancePolicyDeviceStateSummaryRequestBuilder {
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(ApiSdk.Models.DeviceCompliancePolicyDeviceStateSummary body, Action<DeviceCompliancePolicyDeviceStateSummaryRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
