...
namespace ApiSdk.DeviceManagement.DeviceCompliancePolicyDeviceStateSummary {
    ...
    public class DeviceCompliancePolicyDeviceStateSummaryRequestBuilder {
        ...
        /// <param name="options">Request options</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(ApiSdk.Models.DeviceCompliancePolicyDeviceStateSummary body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
