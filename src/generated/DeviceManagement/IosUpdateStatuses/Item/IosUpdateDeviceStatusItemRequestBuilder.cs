...
namespace ApiSdk.DeviceManagement.IosUpdateStatuses.Item {
    ...
    public class IosUpdateDeviceStatusItemRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(iosUpdateDeviceStatusIdOption, selectOption, expandOption, outputOption, queryOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// The IOS software update installation statuses for this account.
