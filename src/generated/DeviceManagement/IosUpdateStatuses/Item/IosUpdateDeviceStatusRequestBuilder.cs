...
namespace ApiSdk.DeviceManagement.IosUpdateStatuses.Item {
    ...
    public class IosUpdateDeviceStatusRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.AddOption(new Option<string>("--iosupdatedevicestatus-id", description: "key: id of iosUpdateDeviceStatus"));
            command.Handler = CommandHandler.Create<string>(async (iosUpdateDeviceStatusId) => {
                var requestInfo = CreateDeleteRequestInformation();
                if (!String.IsNullOrEmpty(iosUpdateDeviceStatusId)) requestInfo.PathParameters.Add("iosUpdateDeviceStatus_id", iosUpdateDeviceStatusId);
        ...
        public Command BuildGetCommand() {
            ...
            command.Handler = CommandHandler.Create<string, object, object>(async (iosUpdateDeviceStatusId, select, expand) => {
        ...
        public Command BuildPatchCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string>(async (iosUpdateDeviceStatusId, body) => {
