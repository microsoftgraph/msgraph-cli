...
namespace ApiSdk.DeviceManagement.IosUpdateStatuses.Item {
    ...
    public class IosUpdateDeviceStatusRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            var iosUpdateDeviceStatusIdOption = new Option<string>("--iosupdatedevicestatus-id", description: "key: id of iosUpdateDeviceStatus") {
            };
            iosUpdateDeviceStatusIdOption.IsRequired = true;
            command.AddOption(iosUpdateDeviceStatusIdOption);
            command.SetHandler(async (string iosUpdateDeviceStatusId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, iosUpdateDeviceStatusIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The IOS software update installation statuses for this account.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string iosUpdateDeviceStatusId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, iosUpdateDeviceStatusIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The IOS software update installation statuses for this account.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string iosUpdateDeviceStatusId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, iosUpdateDeviceStatusIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(IosUpdateDeviceStatus model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
