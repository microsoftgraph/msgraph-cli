...
namespace ApiSdk.DeviceManagement.IosUpdateStatuses.Item {
    ...
    public class IosUpdateDeviceStatusRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            }, iosUpdateDeviceStatusIdOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// The IOS software update installation statuses for this account.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string iosUpdateDeviceStatusId, string[] select, string[] expand, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
            ...
            }, iosUpdateDeviceStatusIdOption, selectOption, expandOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// The IOS software update installation statuses for this account.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string iosUpdateDeviceStatusId, string body, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                ...
                await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                console.WriteLine("Success");
            }, iosUpdateDeviceStatusIdOption, bodyOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
