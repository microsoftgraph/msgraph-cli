...
namespace ApiSdk.DeviceManagement.IosUpdateStatuses.Item {
    ...
    public class IosUpdateDeviceStatusRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string iosUpdateDeviceStatusId) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string iosUpdateDeviceStatusId, string[] select, string[] expand) => {
            ...
            }, iosUpdateDeviceStatusIdOption, selectOption, expandOption);
            return command;
        }
        /// <summary>
        /// The IOS software update installation statuses for this account.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string iosUpdateDeviceStatusId, string body) => {
