...
namespace ApiSdk.DeviceManagement.DeviceCompliancePolicySettingStateSummaries.Item.DeviceComplianceSettingStates {
    ...
    public class DeviceComplianceSettingStatesRequestBuilder {
        ...
        public Command BuildListCommand() {
            ...
            command.Handler = CommandHandler.Create<string, int?, int?, string, string, bool?, object, object, object>(async (deviceCompliancePolicySettingStateSummaryId, top, skip, search, filter, count, orderby, select, expand) => {
