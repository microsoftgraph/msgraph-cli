...
namespace ApiSdk.DeviceManagement.WindowsInformationProtectionNetworkLearningSummaries.Item {
    ...
    public class WindowsInformationProtectionNetworkLearningSummaryRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            }, windowsInformationProtectionNetworkLearningSummaryIdOption, selectOption, expandOption, outputOption);
            return command;
        }
        /// <summary>
        /// The windows information protection network learning summaries.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string windowsInformationProtectionNetworkLearningSummaryId, string body, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                ...
                await RequestAdapter.SendNoContentAsync(requestInfo);
                console.WriteLine("Success");
            }, windowsInformationProtectionNetworkLearningSummaryIdOption, bodyOption);
            return command;
        }
        /// <summary>
