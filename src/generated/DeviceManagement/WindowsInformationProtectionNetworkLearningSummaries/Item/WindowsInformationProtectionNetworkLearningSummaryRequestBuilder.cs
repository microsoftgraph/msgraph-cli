...
namespace ApiSdk.DeviceManagement.WindowsInformationProtectionNetworkLearningSummaries.Item {
    ...
    public class WindowsInformationProtectionNetworkLearningSummaryRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string windowsInformationProtectionNetworkLearningSummaryId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, windowsInformationProtectionNetworkLearningSummaryIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The windows information protection network learning summaries.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string windowsInformationProtectionNetworkLearningSummaryId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, windowsInformationProtectionNetworkLearningSummaryIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The windows information protection network learning summaries.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string windowsInformationProtectionNetworkLearningSummaryId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, windowsInformationProtectionNetworkLearningSummaryIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
