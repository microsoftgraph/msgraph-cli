...
namespace ApiSdk.DeviceManagement.WindowsInformationProtectionNetworkLearningSummaries.Item {
    ...
    public class WindowsInformationProtectionNetworkLearningSummaryItemRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(windowsInformationProtectionNetworkLearningSummaryIdOption, selectOption, expandOption, outputOption, queryOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// The windows information protection network learning summaries.
