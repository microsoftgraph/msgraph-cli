...
namespace ApiSdk.TeamsTemplates.Item {
    ...
    public class TeamsTemplateItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public TeamsTemplateItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/teamsTemplates/{teamsTemplate%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Delete entity from teamsTemplates
        /// </summary>
...
#nullable restore
        ...
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<TeamsTemplateItemRequestBuilderGetQueryParameters>> requestConfiguration = default) {
            ...
            if (requestConfiguration != null) {
                var requestConfig = new RequestConfiguration<TeamsTemplateItemRequestBuilderGetQueryParameters>();
                requestConfiguration.Invoke(requestConfig);
                requestInfo.AddQueryParameters(requestConfig.QueryParameters);
                requestInfo.AddRequestOptions(requestConfig.Options);
                requestInfo.AddHeaders(requestConfig.Headers);
