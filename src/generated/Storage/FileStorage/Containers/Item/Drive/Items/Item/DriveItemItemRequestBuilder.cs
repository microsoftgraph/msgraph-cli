...
using ApiSdk.Storage.FileStorage.Containers.Item.Drive.Items.Item.GetActivitiesByInterval;
...
namespace ApiSdk.Storage.FileStorage.Containers.Item.Drive.Items.Item
{
    ...
    public class DriveItemItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildGetActivitiesByIntervalNavCommand()
        {
            ...
            var builder = new ApiSdk.Storage.FileStorage.Containers.Item.Drive.Items.Item.GetActivitiesByInterval.GetActivitiesByIntervalRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
