...
using ApiSdk.Storage.FileStorage.Containers.Item.Drive.List.Items.Item.GetActivitiesByInterval;
...
namespace ApiSdk.Storage.FileStorage.Containers.Item.Drive.List.Items.Item
{
    ...
    public class ListItemItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildGetActivitiesByIntervalNavCommand()
        {
            ...
            var builder = new ApiSdk.Storage.FileStorage.Containers.Item.Drive.List.Items.Item.GetActivitiesByInterval.GetActivitiesByIntervalRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
