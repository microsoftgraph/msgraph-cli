...
using System;
namespace ApiSdk.Storage.FileStorage.Containers.Item.Drive.List.ContentTypes.Item.Base
{
    /// <summary>
    ...
    public class BaseRequestBuilderEscaped : BaseCliRequestBuilder
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Storage.FileStorage.Containers.Item.Drive.List.ContentTypes.Item.Base.BaseRequestBuilderEscaped"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public BaseRequestBuilderEscaped(Dictionary<string, object> pathParameters) : base("{+baseurl}/storage/fileStorage/containers/{fileStorageContainer%2Did}/drive/list/contentTypes/{contentType%2Did}/base{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Storage.FileStorage.Containers.Item.Drive.List.ContentTypes.Item.Base.BaseRequestBuilderEscaped"/> and sets the default values.
        ...
        public BaseRequestBuilderEscaped(string rawUrl) : base("{+baseurl}/storage/fileStorage/containers/{fileStorageContainer%2Did}/drive/list/contentTypes/{contentType%2Did}/base{?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
        /// Parent contentType from which this content type is derived.
...
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Storage.FileStorage.Containers.Item.Drive.List.ContentTypes.Item.Base.BaseRequestBuilderEscaped.BaseRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Storage.FileStorage.Containers.Item.Drive.List.ContentTypes.Item.Base.BaseRequestBuilderEscaped.BaseRequestBuilderGetQueryParameters>> requestConfiguration = default)
