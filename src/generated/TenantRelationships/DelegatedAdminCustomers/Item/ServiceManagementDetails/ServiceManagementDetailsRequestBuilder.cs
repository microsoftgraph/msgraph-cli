...
namespace ApiSdk.TenantRelationships.DelegatedAdminCustomers.Item.ServiceManagementDetails {
    ...
    public class ServiceManagementDetailsRequestBuilder : BaseCliRequestBuilder {
        ...
        public Command BuildListCommand() {
            ...
            command.Description = "Get a list of the delegatedAdminServiceManagementDetail objects and their properties. This API is available in the following national cloud deployments.\n\nFind more info here:\n  https://learn.microsoft.com/graph/api/delegatedadmincustomer-list-servicemanagementdetails?view=graph-rest-1.0";
            var delegatedAdminCustomerIdOption = new Option<string>("--delegated-admin-customer-id", description: "The unique identifier of delegatedAdminCustomer") {
            };
            delegatedAdminCustomerIdOption.IsRequired = true;
            command.AddOption(delegatedAdminCustomerIdOption);
        ...
        public ServiceManagementDetailsRequestBuilder(string rawUrl) : base("{+baseurl}/tenantRelationships/delegatedAdminCustomers/{delegatedAdminCustomer%2Did}/serviceManagementDetails{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Get a list of the delegatedAdminServiceManagementDetail objects and their properties. This API is available in the following national cloud deployments.
        /// </summary>
