...
namespace ApiSdk.TenantRelationships {
    ...
    public class TenantRelationshipsRequestBuilder {
        ...
        public Command BuildDelegatedAdminCustomersCommand() {
            ...
            var builder = new DelegatedAdminCustomersRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildDelegatedAdminRelationshipsCommand() {
            ...
            var builder = new DelegatedAdminRelationshipsRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildCommand());
            command.AddCommand(builder.BuildCountCommand());
            command.AddCommand(builder.BuildCreateCommand());
            command.AddCommand(builder.BuildListCommand());
