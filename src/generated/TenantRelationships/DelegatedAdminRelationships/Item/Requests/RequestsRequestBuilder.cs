...
namespace ApiSdk.TenantRelationships.DelegatedAdminRelationships.Item.Requests {
    ...
    public class RequestsRequestBuilder {
        ...
        public Command BuildCommand() {
            ...
            var builder = new DelegatedAdminRelationshipRequestItemRequestBuilder(PathParameters, RequestAdapter);
        ...
        public RequestsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/tenantRelationships/delegatedAdminRelationships/{delegatedAdminRelationship%2Did}/requests{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
