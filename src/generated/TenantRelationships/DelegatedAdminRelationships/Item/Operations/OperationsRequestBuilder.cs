...
namespace ApiSdk.TenantRelationships.DelegatedAdminRelationships.Item.Operations {
    ...
    public class OperationsRequestBuilder {
        ...
        public Command BuildCommand() {
            ...
            var builder = new DelegatedAdminRelationshipOperationItemRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildListCommand() {
            ...
            command.Description = "Get operations from tenantRelationships";
            // Create options for all the parameters
            var delegatedAdminRelationshipIdOption = new Option<string>("--delegated-admin-relationship-id", description: "key: id of delegatedAdminRelationship") {
            };
            delegatedAdminRelationshipIdOption.IsRequired = true;
        ...
        public OperationsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/tenantRelationships/delegatedAdminRelationships/{delegatedAdminRelationship%2Did}/operations{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
