...
namespace ApiSdk.TenantRelationships.DelegatedAdminRelationships.Item.Operations.Item {
    ...
    public class DelegatedAdminRelationshipOperationItemRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            var delegatedAdminRelationshipOperationIdOption = new Option<string>("--delegated-admin-relationship-operation-id", description: "key: id of delegatedAdminRelationshipOperation") {
            };
        ...
        public DelegatedAdminRelationshipOperationItemRequestBuilder(Dictionary<string, object> pathParameters) {
