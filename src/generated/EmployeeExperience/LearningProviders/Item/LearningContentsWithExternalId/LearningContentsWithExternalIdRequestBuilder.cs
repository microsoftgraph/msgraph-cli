...
namespace ApiSdk.EmployeeExperience.LearningProviders.Item.LearningContentsWithExternalId {
    ...
    public class LearningContentsWithExternalIdRequestBuilder : BaseCliRequestBuilder {
        ...
        public LearningContentsWithExternalIdRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/employeeExperience/learningProviders/{learningProvider%2Did}/learningContents(externalId='{externalId}'){?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new LearningContentsWithExternalIdRequestBuilder and sets the default values.
        /// </summary>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public LearningContentsWithExternalIdRequestBuilder(string rawUrl) : base("{+baseurl}/employeeExperience/learningProviders/{learningProvider%2Did}/learningContents(externalId='{externalId}'){?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Delete the specified learningContent resource that represents the metadata of the specified provider&apos;s ingested content.
        /// </summary>
