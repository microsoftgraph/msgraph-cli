...
namespace ApiSdk.EmployeeExperience.LearningProviders.Item.LearningCourseActivities {
    ...
    public class LearningCourseActivitiesRequestBuilder : BaseCliRequestBuilder {
        ...
        public LearningCourseActivitiesRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/employeeExperience/learningProviders/{learningProvider%2Did}/learningCourseActivities{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Get learningCourseActivities from employeeExperience
        /// </summary>
