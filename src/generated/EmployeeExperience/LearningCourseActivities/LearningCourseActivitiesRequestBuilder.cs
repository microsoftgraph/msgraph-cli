using ApiSdk.EmployeeExperience.LearningCourseActivities.Count;
using ApiSdk.EmployeeExperience.LearningCourseActivities.Item;
...
using System;
namespace ApiSdk.EmployeeExperience.LearningCourseActivities {
    /// <summary>
    ...
    public class LearningCourseActivitiesRequestBuilder : BaseCliRequestBuilder {
        ...
        public LearningCourseActivitiesRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/employeeExperience/learningCourseActivities{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Get the specified learningCourseActivity object using either an ID or an **externalCourseActivityId** of the learning provider, or a **courseActivityId** of a user.
        /// </summary>
...
#nullable restore
        ...
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<LearningCourseActivitiesRequestBuilderGetQueryParameters>> requestConfiguration = default) {
            ...
            if (requestConfiguration != null) {
                var requestConfig = new RequestConfiguration<LearningCourseActivitiesRequestBuilderGetQueryParameters>();
