...
namespace ApiSdk.Security.ThreatIntelligence.HostCookies.Item.Host
{
    ...
    public class HostRequestBuilder : BaseCliRequestBuilder
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Security.ThreatIntelligence.HostCookies.Item.Host.HostRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Security.ThreatIntelligence.HostCookies.Item.Host.HostRequestBuilder.HostRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Security.ThreatIntelligence.HostCookies.Item.Host.HostRequestBuilder.HostRequestBuilderGetQueryParameters>> requestConfiguration = default)
