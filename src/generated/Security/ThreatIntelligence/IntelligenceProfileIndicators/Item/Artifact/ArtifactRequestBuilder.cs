...
using System;
namespace ApiSdk.Security.ThreatIntelligence.IntelligenceProfileIndicators.Item.Artifact {
    /// <summary>
    ...
    public class ArtifactRequestBuilder : BaseCliRequestBuilder {
        ...
        public ArtifactRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/security/threatIntelligence/intelligenceProfileIndicators/{intelligenceProfileIndicator%2Did}/artifact{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// The artifact related to this indicator.
        /// </summary>
...
#nullable restore
        ...
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ArtifactRequestBuilderGetQueryParameters>> requestConfiguration = default) {
            ...
            if (requestConfiguration != null) {
                var requestConfig = new RequestConfiguration<ArtifactRequestBuilderGetQueryParameters>();
