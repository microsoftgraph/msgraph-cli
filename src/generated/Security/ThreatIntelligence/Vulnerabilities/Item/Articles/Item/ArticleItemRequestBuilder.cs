...
namespace ApiSdk.Security.ThreatIntelligence.Vulnerabilities.Item.Articles.Item {
    ...
    public class ArticleItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public ArticleItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/security/threatIntelligence/vulnerabilities/{vulnerability%2Did}/articles/{article%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Articles related to this vulnerability.
        /// </summary>
