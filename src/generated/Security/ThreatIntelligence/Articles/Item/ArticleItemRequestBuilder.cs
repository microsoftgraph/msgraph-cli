...
namespace ApiSdk.Security.ThreatIntelligence.Articles.Item {
    ...
    public class ArticleItemRequestBuilder : BaseCliRequestBuilder {
        ...
        /// Find more info here <see href="https://docs.microsoft.com/graph/api/security-article-get?view=graph-rest-1.0" />
        /// </summary>
        public Command BuildGetCommand() {
            var command = new Command("get");
            command.Description = "Read the properties and relationships of an article object.\n\nFind more info here:\n  https://docs.microsoft.com/graph/api/security-article-get?view=graph-rest-1.0";
            var articleIdOption = new Option<string>("--article-id", description: "The unique identifier of article") {
            };
            articleIdOption.IsRequired = true;
            command.AddOption(articleIdOption);
...
#nullable restore
        ...
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ArticleItemRequestBuilderGetQueryParameters>> requestConfiguration = default) {
            ...
            if (requestConfiguration != null) {
                var requestConfig = new RequestConfiguration<ArticleItemRequestBuilderGetQueryParameters>();
                requestConfiguration.Invoke(requestConfig);
                requestInfo.AddQueryParameters(requestConfig.QueryParameters);
                requestInfo.AddRequestOptions(requestConfig.Options);
                requestInfo.AddHeaders(requestConfig.Headers);
