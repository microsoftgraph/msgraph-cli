...
namespace ApiSdk.Security.ThreatIntelligence.WhoisHistoryRecords.Item
{
    ...
    public class WhoisHistoryRecordItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildHostNavCommand()
        {
            ...
            var builder = new ApiSdk.Security.ThreatIntelligence.WhoisHistoryRecords.Item.Host.HostRequestBuilder(PathParameters);
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Security.ThreatIntelligence.WhoisHistoryRecords.Item.WhoisHistoryRecordItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Security.ThreatIntelligence.WhoisHistoryRecords.Item.WhoisHistoryRecordItemRequestBuilder.WhoisHistoryRecordItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Security.ThreatIntelligence.WhoisHistoryRecords.Item.WhoisHistoryRecordItemRequestBuilder.WhoisHistoryRecordItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.Security.WhoisHistoryRecord body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.Security.WhoisHistoryRecord body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
