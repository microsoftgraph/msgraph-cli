...
namespace ApiSdk.Security.ThreatIntelligence.IntelProfiles.Item.Indicators.Item {
    ...
    public class IntelligenceProfileIndicatorItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public IntelligenceProfileIndicatorItemRequestBuilder(string rawUrl) : base("{+baseurl}/security/threatIntelligence/intelProfiles/{intelligenceProfile%2Did}/indicators/{intelligenceProfileIndicator%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Includes an assemblage of high-fidelity network indicators of compromise.
        /// </summary>
