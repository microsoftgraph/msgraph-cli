...
namespace ApiSdk.Security.ThreatIntelligence.IntelProfiles.Item.Indicators {
    ...
    public class IndicatorsRequestBuilder : BaseCliRequestBuilder {
        ...
        public IndicatorsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/security/threatIntelligence/intelProfiles/{intelligenceProfile%2Did}/indicators{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Get the intelligenceProfileIndicator resources from the **indicators** navigation property of an intelligenceProfile.
        /// </summary>
...
#nullable restore
        ...
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<IndicatorsRequestBuilderGetQueryParameters>> requestConfiguration = default) {
            ...
            if (requestConfiguration != null) {
                var requestConfig = new RequestConfiguration<IndicatorsRequestBuilderGetQueryParameters>();
