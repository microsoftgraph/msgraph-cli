...
namespace ApiSdk.Security.ThreatIntelligence.HostTrackers.Item.Host
{
    ...
    public class HostRequestBuilder : BaseCliRequestBuilder
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Security.ThreatIntelligence.HostTrackers.Item.Host.HostRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Security.ThreatIntelligence.HostTrackers.Item.Host.HostRequestBuilder.HostRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Security.ThreatIntelligence.HostTrackers.Item.Host.HostRequestBuilder.HostRequestBuilderGetQueryParameters>> requestConfiguration = default)
