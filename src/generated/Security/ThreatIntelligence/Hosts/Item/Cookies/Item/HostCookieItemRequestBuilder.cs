...
namespace ApiSdk.Security.ThreatIntelligence.Hosts.Item.Cookies.Item {
    ...
    public class HostCookieItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public HostCookieItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/security/threatIntelligence/hosts/{host%2Did}/cookies/{hostCookie%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// The hostCookies that are associated with this host.
        /// </summary>
...
#nullable restore
        ...
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<HostCookieItemRequestBuilderGetQueryParameters>> requestConfiguration = default) {
            ...
            if (requestConfiguration != null) {
                var requestConfig = new RequestConfiguration<HostCookieItemRequestBuilderGetQueryParameters>();
