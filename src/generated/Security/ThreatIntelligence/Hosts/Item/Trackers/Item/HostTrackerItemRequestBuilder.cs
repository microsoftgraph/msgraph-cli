...
namespace ApiSdk.Security.ThreatIntelligence.Hosts.Item.Trackers.Item {
    ...
    public class HostTrackerItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.Description = "The hostTrackers that are associated with this host.";
        ...
        public HostTrackerItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/security/threatIntelligence/hosts/{host%2Did}/trackers/{hostTracker%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// The hostTrackers that are associated with this host.
        /// </summary>
