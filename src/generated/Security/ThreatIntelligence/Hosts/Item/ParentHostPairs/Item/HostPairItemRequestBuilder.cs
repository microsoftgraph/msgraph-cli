...
namespace ApiSdk.Security.ThreatIntelligence.Hosts.Item.ParentHostPairs.Item
{
    ...
    public partial class HostPairItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Security.ThreatIntelligence.Hosts.Item.ParentHostPairs.Item.HostPairItemRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public HostPairItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/security/threatIntelligence/hosts/{host%2Did}/parentHostPairs/{hostPair%2Did}{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Security.ThreatIntelligence.Hosts.Item.ParentHostPairs.Item.HostPairItemRequestBuilder"/> and sets the default values.
        ...
        public HostPairItemRequestBuilder(string rawUrl) : base("{+baseurl}/security/threatIntelligence/hosts/{host%2Did}/parentHostPairs/{hostPair%2Did}{?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
        /// The hostPairs that are associated with a host, where that host is the childHost and has an incoming pairing with a parentHost.
...
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Security.ThreatIntelligence.Hosts.Item.ParentHostPairs.Item.HostPairItemRequestBuilder.HostPairItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Security.ThreatIntelligence.Hosts.Item.ParentHostPairs.Item.HostPairItemRequestBuilder.HostPairItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
