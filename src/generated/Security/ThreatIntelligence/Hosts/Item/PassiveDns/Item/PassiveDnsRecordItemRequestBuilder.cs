...
namespace ApiSdk.Security.ThreatIntelligence.Hosts.Item.PassiveDns.Item {
    ...
    public class PassiveDnsRecordItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public PassiveDnsRecordItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/security/threatIntelligence/hosts/{host%2Did}/passiveDns/{passiveDnsRecord%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Passive DNS retrieval about this host.
        /// </summary>
