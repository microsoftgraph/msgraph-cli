...
using System;
namespace ApiSdk.Security.ThreatIntelligence.Hosts.Item.PassiveDnsReverse.Item {
    /// <summary>
    ...
    public class PassiveDnsRecordItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public PassiveDnsRecordItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/security/threatIntelligence/hosts/{host%2Did}/passiveDnsReverse/{passiveDnsRecord%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Reverse passive DNS retrieval about this host.
        /// </summary>
...
#nullable restore
        ...
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<PassiveDnsRecordItemRequestBuilderGetQueryParameters>> requestConfiguration = default) {
            ...
            if (requestConfiguration != null) {
                var requestConfig = new RequestConfiguration<PassiveDnsRecordItemRequestBuilderGetQueryParameters>();
