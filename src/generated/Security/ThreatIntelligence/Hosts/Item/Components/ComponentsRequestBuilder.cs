...
namespace ApiSdk.Security.ThreatIntelligence.Hosts.Item.Components {
    ...
    public class ComponentsRequestBuilder : BaseCliRequestBuilder {
        ...
        public Command BuildListCommand() {
            ...
            command.Description = "Get a list of hostComponent resources.\n\nFind more info here:\n  https://docs.microsoft.com/graph/api/security-host-list-components?view=graph-rest-1.0";
        ...
        public ComponentsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/security/threatIntelligence/hosts/{host%2Did}/components{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Get a list of hostComponent resources.
        /// </summary>
