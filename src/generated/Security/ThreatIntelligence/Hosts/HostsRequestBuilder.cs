...
namespace ApiSdk.Security.ThreatIntelligence.Hosts {
    ...
    public class HostsRequestBuilder : BaseCliRequestBuilder {
        ...
        public HostsRequestBuilder(string rawUrl) : base("{+baseurl}/security/threatIntelligence/hosts{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Read the properties and relationships of a host object. The host resource is the abstract base type that returns an implementation. A host can be of one of the following types: This API is available in the following national cloud deployments.
        /// </summary>
