...
using ApiSdk.Security.ThreatIntelligence.Hosts.Count;
using ApiSdk.Security.ThreatIntelligence.Hosts.Item;
...
namespace ApiSdk.Security.ThreatIntelligence.Hosts {
    ...
    public class HostsRequestBuilder : BaseCliRequestBuilder {
        ...
        public Tuple<List<Command>, List<Command>> BuildCommand() {
            ...
            var builder = new HostItemRequestBuilder(PathParameters);
            commands.Add(builder.BuildComponentsNavCommand());
            commands.Add(builder.BuildCookiesNavCommand());
            ...
            commands.Add(builder.BuildTrackersNavCommand());
        ...
        public Command BuildCreateCommand() {
            ...
            command.Description = "Create new navigation property to hosts for security";
        ...
        public HostsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/security/threatIntelligence/hosts{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Read the properties and relationships of a host object. The host resource is the abstract base type that returns an implementation. A host can be of one of the following types:
        /// </summary>
