...
namespace ApiSdk.Security.ThreatIntelligence.HostSslCertificates.Item {
    ...
    public class HostSslCertificateItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public HostSslCertificateItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/security/threatIntelligence/hostSslCertificates/{hostSslCertificate%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new HostSslCertificateItemRequestBuilder and sets the default values.
        /// </summary>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public HostSslCertificateItemRequestBuilder(string rawUrl) : base("{+baseurl}/security/threatIntelligence/hostSslCertificates/{hostSslCertificate%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Delete navigation property hostSslCertificates for security
        /// </summary>
