...
namespace ApiSdk.Security.ThreatIntelligence.HostPorts.Item {
    ...
    public class HostPortItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public HostPortItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/security/threatIntelligence/hostPorts/{hostPort%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new HostPortItemRequestBuilder and sets the default values.
        /// </summary>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public HostPortItemRequestBuilder(string rawUrl) : base("{+baseurl}/security/threatIntelligence/hostPorts/{hostPort%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Delete navigation property hostPorts for security
        /// </summary>
