...
namespace ApiSdk.Security.ThreatIntelligence.PassiveDnsRecords.Item {
    ...
    public class PassiveDnsRecordItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public PassiveDnsRecordItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/security/threatIntelligence/passiveDnsRecords/{passiveDnsRecord%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Delete navigation property passiveDnsRecords for security
        /// </summary>
