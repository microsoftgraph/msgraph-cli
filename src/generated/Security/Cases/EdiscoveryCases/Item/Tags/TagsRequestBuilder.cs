...
namespace ApiSdk.Security.Cases.EdiscoveryCases.Item.Tags {
    ...
    public class TagsRequestBuilder {
        ...
        public Command BuildCommand() {
            ...
            var builder = new EdiscoveryReviewTagItemRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildMicrosoftGraphSecurityAsHierarchyCommand() {
            ...
            var builder = new AsHierarchyRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildGetCommand());
            return command;
        }
        /// <summary>
