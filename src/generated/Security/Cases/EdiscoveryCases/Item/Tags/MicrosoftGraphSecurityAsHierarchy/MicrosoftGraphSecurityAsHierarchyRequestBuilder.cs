...
namespace ApiSdk.Security.Cases.EdiscoveryCases.Item.Tags.MicrosoftGraphSecurityAsHierarchy {
    ...
    public class MicrosoftGraphSecurityAsHierarchyRequestBuilder : BaseCliRequestBuilder {
        ...
        public MicrosoftGraphSecurityAsHierarchyRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/tags/microsoft.graph.security.asHierarchy(){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}", pathParameters) {
        }
        /// <summary>
        /// Invoke function asHierarchy
        /// </summary>
...
#nullable restore
        ...
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<MicrosoftGraphSecurityAsHierarchyRequestBuilderGetQueryParameters>> requestConfiguration = default) {
            ...
            if (requestConfiguration != null) {
                var requestConfig = new RequestConfiguration<MicrosoftGraphSecurityAsHierarchyRequestBuilderGetQueryParameters>();
