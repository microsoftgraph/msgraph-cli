...
namespace ApiSdk.Security.Cases.EdiscoveryCases.Item.Tags.Item.Parent {
    ...
    public class ParentRequestBuilder : BaseCliRequestBuilder {
        ...
        public ParentRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/tags/{ediscoveryReviewTag%2Did}/parent{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Returns the parent tag of the specified tag.
        /// </summary>
...
#nullable restore
        ...
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ParentRequestBuilderGetQueryParameters>> requestConfiguration = default) {
            ...
            if (requestConfiguration != null) {
                var requestConfig = new RequestConfiguration<ParentRequestBuilderGetQueryParameters>();
