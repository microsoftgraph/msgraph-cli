...
namespace ApiSdk.Security.Cases.EdiscoveryCases.Item.Tags.Item.ChildTags.Item {
    ...
    public class EdiscoveryReviewTagItemRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            var ediscoveryReviewTagId1Option = new Option<string>("--ediscovery-review-tag-id1", description: "key: id of ediscoveryReviewTag") {
            };
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                requestInfo.PathParameters.Add("ediscoveryReviewTag%2Did", ediscoveryReviewTagId);
                requestInfo.PathParameters.Add("ediscoveryReviewTag%2Did1", ediscoveryReviewTagId1);
