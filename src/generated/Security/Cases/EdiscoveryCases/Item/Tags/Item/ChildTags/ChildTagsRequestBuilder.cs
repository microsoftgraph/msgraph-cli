...
namespace ApiSdk.Security.Cases.EdiscoveryCases.Item.Tags.Item.ChildTags {
    ...
    public class ChildTagsRequestBuilder {
        ...
        public Command BuildCommand() {
            ...
            var builder = new ApiSdk.Security.Cases.EdiscoveryCases.Item.Tags.Item.ChildTags.Item.EdiscoveryReviewTagItemRequestBuilder(PathParameters, RequestAdapter);
