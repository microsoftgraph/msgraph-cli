...
namespace ApiSdk.Security.Cases.EdiscoveryCases.Item.NoncustodialDataSources.SecurityRemoveHold {
    ...
    public class SecurityRemoveHoldRequestBuilder : BaseCliRequestBuilder {
        ...
        public SecurityRemoveHoldRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/noncustodialDataSources/security.removeHold", pathParameters) {
        }
        /// <summary>
        /// Invoke action removeHold
        /// </summary>
