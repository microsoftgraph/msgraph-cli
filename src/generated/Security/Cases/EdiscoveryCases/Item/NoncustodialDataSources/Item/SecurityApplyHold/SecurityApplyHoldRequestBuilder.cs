...
namespace ApiSdk.Security.Cases.EdiscoveryCases.Item.NoncustodialDataSources.Item.SecurityApplyHold {
    /// <summary>
    ...
    public class SecurityApplyHoldRequestBuilder {
        ...
        public SecurityApplyHoldRequestBuilder(Dictionary<string, object> pathParameters) {
            ...
            UrlTemplate = "{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/noncustodialDataSources/{ediscoveryNoncustodialDataSource%2Did}/security.applyHold";
...
#nullable enable
        public RequestInformation ToPostRequestInformation(Action<SecurityApplyHoldRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(Action<SecurityApplyHoldRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
