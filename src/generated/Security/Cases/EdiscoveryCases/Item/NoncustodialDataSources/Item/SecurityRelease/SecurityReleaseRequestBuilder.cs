...
namespace ApiSdk.Security.Cases.EdiscoveryCases.Item.NoncustodialDataSources.Item.SecurityRelease {
    /// <summary>
    ...
    public class SecurityReleaseRequestBuilder : BaseCliRequestBuilder {
        ...
        public SecurityReleaseRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/noncustodialDataSources/{ediscoveryNoncustodialDataSource%2Did}/security.release", pathParameters) {
        }
        /// <summary>
        /// Release the non-custodial data source from the case.
        /// </summary>
