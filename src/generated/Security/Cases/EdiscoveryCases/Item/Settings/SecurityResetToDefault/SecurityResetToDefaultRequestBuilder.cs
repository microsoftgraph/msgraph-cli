...
namespace ApiSdk.Security.Cases.EdiscoveryCases.Item.Settings.SecurityResetToDefault {
    ...
    /// </summary>
    public class SecurityResetToDefaultRequestBuilder : BaseCliRequestBuilder {
        /// <summary>
        ...
        public SecurityResetToDefaultRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/settings/security.resetToDefault", pathParameters) {
        }
        /// <summary>
        /// Reset a caseSettings object to the default values.
        /// </summary>
