...
namespace ApiSdk.Security.Cases.EdiscoveryCases.Item.SecurityClose {
    /// <summary>
    /// Provides operations to call the close method.
    /// </summary>
    public class SecurityCloseRequestBuilder : BaseCliRequestBuilder {
        /// <summary>
        ...
        public SecurityCloseRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/security.close", pathParameters) {
        }
        /// <summary>
        /// Close an eDiscovery case. For details, see Close a case.
        /// </summary>
