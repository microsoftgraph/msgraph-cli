...
namespace ApiSdk.Security.Cases.EdiscoveryCases.Item.Custodians.SecurityRemoveHold {
    /// <summary>
    /// Provides operations to call the removeHold method.
    /// </summary>
    public class SecurityRemoveHoldRequestBuilder : BaseCliRequestBuilder {
        /// <summary>
        ...
        public SecurityRemoveHoldRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/custodians/security.removeHold", pathParameters) {
        }
        /// <summary>
        /// Invoke action removeHold
        /// </summary>
