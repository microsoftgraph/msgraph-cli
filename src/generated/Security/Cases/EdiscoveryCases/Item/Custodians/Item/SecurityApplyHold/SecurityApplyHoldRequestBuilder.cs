...
namespace ApiSdk.Security.Cases.EdiscoveryCases.Item.Custodians.Item.SecurityApplyHold {
    ...
    public class SecurityApplyHoldRequestBuilder : BaseCliRequestBuilder {
        ...
        public SecurityApplyHoldRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/custodians/{ediscoveryCustodian%2Did}/security.applyHold", pathParameters) {
        }
        /// <summary>
        /// Start the process of applying hold on eDiscovery custodians. After the operation is created, you can get the status by retrieving the `Location` parameter from the response headers. The location provides a URL that will return an eDiscoveryHoldOperation object.
        /// </summary>
