...
namespace ApiSdk.Security.Cases.EdiscoveryCases.Item.Custodians.Item.SecurityRelease {
    /// <summary>
    /// Provides operations to call the release method.
    /// </summary>
    public class SecurityReleaseRequestBuilder : BaseCliRequestBuilder {
        /// <summary>
        ...
        public SecurityReleaseRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/custodians/{ediscoveryCustodian%2Did}/security.release", pathParameters) {
        }
        /// <summary>
        /// Release a custodian from a case. For details, see Release a custodian from a case.
        /// </summary>
