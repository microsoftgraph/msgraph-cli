...
namespace ApiSdk.Security.Cases.EdiscoveryCases.Item.Custodians.Item.SiteSources.Item.Site {
    ...
    public class SiteRequestBuilder : BaseCliRequestBuilder {
        ...
        public SiteRequestBuilder(string rawUrl) : base("{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/custodians/{ediscoveryCustodian%2Did}/siteSources/{siteSource%2Did}/site{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// The SharePoint site associated with the siteSource.
        /// </summary>
