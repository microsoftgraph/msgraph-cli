...
namespace ApiSdk.Security.Cases.EdiscoveryCases.Item.Custodians.Item.SiteSources.Item.Site {
    ...
    public class SiteRequestBuilder : BaseCliRequestBuilder {
        ...
        public SiteRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/custodians/{ediscoveryCustodian%2Did}/siteSources/{siteSource%2Did}/site{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// The SharePoint site associated with the siteSource.
        /// </summary>
...
#nullable restore
        ...
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<SiteRequestBuilderGetQueryParameters>> requestConfiguration = default) {
            ...
            if (requestConfiguration != null) {
                var requestConfig = new RequestConfiguration<SiteRequestBuilderGetQueryParameters>();
