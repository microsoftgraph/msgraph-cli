...
namespace ApiSdk.Security.Cases.EdiscoveryCases.Item.Custodians.Item.SecurityUpdateIndex {
    /// <summary>
    ...
    public class SecurityUpdateIndexRequestBuilder : BaseCliRequestBuilder {
        ...
        public SecurityUpdateIndexRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/custodians/{ediscoveryCustodian%2Did}/security.updateIndex", pathParameters) {
        }
        /// <summary>
        /// Trigger an indexOperation to make a custodian and associated sources searchable.
        /// </summary>
