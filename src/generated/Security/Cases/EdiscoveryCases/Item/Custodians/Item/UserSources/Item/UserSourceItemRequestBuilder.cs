...
namespace ApiSdk.Security.Cases.EdiscoveryCases.Item.Custodians.Item.UserSources.Item {
    ...
    public class UserSourceItemRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            var userSourceIdOption = new Option<string>("--user-source-id", description: "key: id of userSource") {
            };
        ...
        public UserSourceItemRequestBuilder(Dictionary<string, object> pathParameters) {
