...
namespace ApiSdk.Security.Cases.EdiscoveryCases.Item.ReviewSets.Item.Queries {
    ...
    public class QueriesRequestBuilder {
        ...
        public Command BuildCommand() {
            ...
            var builder = new EdiscoveryReviewSetQueryItemRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildApplyTagsCommand());
        ...
        public QueriesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/reviewSets/{ediscoveryReviewSet%2Did}/queries{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(EdiscoveryReviewSetQuery body, Action<QueriesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
