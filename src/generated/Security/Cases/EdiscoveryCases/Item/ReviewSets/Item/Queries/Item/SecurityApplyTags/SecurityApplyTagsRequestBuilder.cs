...
namespace ApiSdk.Security.Cases.EdiscoveryCases.Item.ReviewSets.Item.Queries.Item.SecurityApplyTags {
    ...
    /// </summary>
    public class SecurityApplyTagsRequestBuilder : BaseCliRequestBuilder {
        /// <summary>
        ...
        public SecurityApplyTagsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/reviewSets/{ediscoveryReviewSet%2Did}/queries/{ediscoveryReviewSetQuery%2Did}/security.applyTags", pathParameters) {
        }
        /// <summary>
        /// Apply tags to files in an eDiscovery review set. For details, see Tag documents in a review set in eDiscovery.
        /// </summary>
