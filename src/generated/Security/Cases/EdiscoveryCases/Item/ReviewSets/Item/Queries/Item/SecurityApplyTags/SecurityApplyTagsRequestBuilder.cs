...
namespace ApiSdk.Security.Cases.EdiscoveryCases.Item.ReviewSets.Item.Queries.Item.SecurityApplyTags {
    /// <summary>
    ...
    public class SecurityApplyTagsRequestBuilder {
        ...
        public SecurityApplyTagsRequestBuilder(Dictionary<string, object> pathParameters) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            UrlTemplate = "{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/reviewSets/{ediscoveryReviewSet%2Did}/queries/{ediscoveryReviewSetQuery%2Did}/security.applyTags";
...
#nullable enable
        public RequestInformation ToPostRequestInformation(ApplyTagsPostRequestBody body, Action<SecurityApplyTagsRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(ApplyTagsPostRequestBody body, Action<SecurityApplyTagsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            if (requestConfiguration != null) {
                var requestConfig = new SecurityApplyTagsRequestBuilderPostRequestConfiguration();
        ...
        /// </summary>
        public class SecurityApplyTagsRequestBuilderPostRequestConfiguration {
            ...
            /// </summary>
            public SecurityApplyTagsRequestBuilderPostRequestConfiguration() {
