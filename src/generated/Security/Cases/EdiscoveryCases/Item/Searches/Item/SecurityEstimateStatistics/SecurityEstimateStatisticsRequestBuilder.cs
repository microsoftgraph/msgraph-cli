...
namespace ApiSdk.Security.Cases.EdiscoveryCases.Item.Searches.Item.SecurityEstimateStatistics {
    ...
    /// </summary>
    public class SecurityEstimateStatisticsRequestBuilder : BaseCliRequestBuilder {
        /// <summary>
        ...
        public SecurityEstimateStatisticsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/searches/{ediscoverySearch%2Did}/security.estimateStatistics", pathParameters) {
        }
        /// <summary>
        /// Run an estimate of the number of emails and documents in the eDiscovery search. To learn more about searches in eDiscovery, see Collect data for a case in eDiscovery (Premium).
        /// </summary>
