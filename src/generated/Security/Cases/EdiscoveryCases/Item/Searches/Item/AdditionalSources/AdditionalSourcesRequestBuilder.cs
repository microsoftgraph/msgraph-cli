...
namespace ApiSdk.Security.Cases.EdiscoveryCases.Item.Searches.Item.AdditionalSources {
    ...
    public class AdditionalSourcesRequestBuilder {
        ...
        public Command BuildCommand() {
            ...
            var builder = new DataSourceItemRequestBuilder(PathParameters, RequestAdapter);
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ApiSdk.Models.Security.DataSource body, Action<AdditionalSourcesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
