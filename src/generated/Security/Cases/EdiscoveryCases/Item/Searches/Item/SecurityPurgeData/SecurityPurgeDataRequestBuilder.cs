...
namespace ApiSdk.Security.Cases.EdiscoveryCases.Item.Searches.Item.SecurityPurgeData {
    ...
    /// </summary>
    public class SecurityPurgeDataRequestBuilder : BaseCliRequestBuilder {
        /// <summary>
        ...
        public SecurityPurgeDataRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/searches/{ediscoverySearch%2Did}/security.purgeData", pathParameters) {
        }
        /// <summary>
        /// Invoke action purgeData
        /// </summary>
