...
namespace ApiSdk.Security.Cases.EdiscoveryCases.Item.Searches.Item.CustodianSources.Item {
    ...
    public class DataSourceItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.Description = "Remove a dataSource object.\n\nFind more info here:\n  https://docs.microsoft.com/graph/api/security-ediscoverysearch-delete-custodiansources?view=graph-rest-1.0";
        ...
        public DataSourceItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/searches/{ediscoverySearch%2Did}/custodianSources/{dataSource%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Remove a dataSource object.
        /// </summary>
