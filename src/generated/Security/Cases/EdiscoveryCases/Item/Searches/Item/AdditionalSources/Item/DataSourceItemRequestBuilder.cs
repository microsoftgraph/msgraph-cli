...
namespace ApiSdk.Security.Cases.EdiscoveryCases.Item.Searches.Item.AdditionalSources.Item {
    ...
    public class DataSourceItemRequestBuilder {
        ...
        public DataSourceItemRequestBuilder(Dictionary<string, object> pathParameters) {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.Security.DataSource body, Action<DataSourceItemRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.Security.DataSource body, Action<DataSourceItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
