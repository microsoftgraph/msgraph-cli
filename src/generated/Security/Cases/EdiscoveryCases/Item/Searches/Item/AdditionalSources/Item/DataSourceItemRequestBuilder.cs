    ...
    public class DataSourceItemRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                requestInfo.PathParameters.Add("dataSource%2Did", dataSourceId);
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(ApiSdk.Models.Security.DataSource body, Action<DataSourceItemRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
