...
namespace ApiSdk.Security.Cases.EdiscoveryCases.Item.Searches {
    ...
    public class SearchesRequestBuilder {
        ...
        public Command BuildCommand() {
            ...
            var builder = new EdiscoverySearchItemRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildAdditionalSourcesCommand());
            command.AddCommand(builder.BuildAddToReviewSetOperationCommand());
            command.AddCommand(builder.BuildCustodianSourcesCommand());
            command.AddCommand(builder.BuildDeleteCommand());
            command.AddCommand(builder.BuildEstimateStatisticsCommand());
            ...
            command.AddCommand(builder.BuildPurgeDataCommand());
            return command;
        }
        /// <summary>
