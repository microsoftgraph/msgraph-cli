...
namespace ApiSdk.Security.SecureScoreControlProfiles {
    ...
    public class SecureScoreControlProfilesRequestBuilder {
        ...
        public List<Command> BuildCommand() {
            var builder = new SecureScoreControlProfileItemRequestBuilder(PathParameters, RequestAdapter);
        ...
        public SecureScoreControlProfilesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/security/secureScoreControlProfiles{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
        ...
        /// <param name="options">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(SecureScoreControlProfile body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
