...
using ApiSdk.Models;
using ApiSdk.Security.SubjectRightsRequests.Item.Approvers;
using ApiSdk.Security.SubjectRightsRequests.Item.ApproversWithUserPrincipalName;
using ApiSdk.Security.SubjectRightsRequests.Item.Collaborators;
using ApiSdk.Security.SubjectRightsRequests.Item.CollaboratorsWithUserPrincipalName;
using ApiSdk.Security.SubjectRightsRequests.Item.GetFinalAttachment;
using ApiSdk.Security.SubjectRightsRequests.Item.GetFinalReport;
using ApiSdk.Security.SubjectRightsRequests.Item.Notes;
using ApiSdk.Security.SubjectRightsRequests.Item.Team;
...
namespace ApiSdk.Security.SubjectRightsRequests.Item
{
    ...
    public partial class SubjectRightsRequestItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildApproversNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Security.SubjectRightsRequests.Item.Approvers.ApproversRequestBuilder(PathParameters);
        ...
        public Command BuildApproversWithUserPrincipalNameRbCommand()
        {
            ...
            command.Description = "Provides operations to manage the approvers property of the microsoft.graph.subjectRightsRequest entity.";
            var builder = new global::ApiSdk.Security.SubjectRightsRequests.Item.ApproversWithUserPrincipalName.ApproversWithUserPrincipalNameRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildCollaboratorsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Security.SubjectRightsRequests.Item.Collaborators.CollaboratorsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildListCommand());
        ...
        public Command BuildCollaboratorsWithUserPrincipalNameRbCommand()
        {
            ...
            command.Description = "Provides operations to manage the collaborators property of the microsoft.graph.subjectRightsRequest entity.";
            var builder = new global::ApiSdk.Security.SubjectRightsRequests.Item.CollaboratorsWithUserPrincipalName.CollaboratorsWithUserPrincipalNameRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildGetFinalAttachmentNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Security.SubjectRightsRequests.Item.GetFinalAttachment.GetFinalAttachmentRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildGetFinalReportNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Security.SubjectRightsRequests.Item.GetFinalReport.GetFinalReportRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildNotesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Security.SubjectRightsRequests.Item.Notes.NotesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
        ...
        public Command BuildTeamNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Security.SubjectRightsRequests.Item.Team.TeamRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Security.SubjectRightsRequests.Item.SubjectRightsRequestItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Security.SubjectRightsRequests.Item.SubjectRightsRequestItemRequestBuilder.SubjectRightsRequestItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Security.SubjectRightsRequests.Item.SubjectRightsRequestItemRequestBuilder.SubjectRightsRequestItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
