...
namespace ApiSdk.Security.SubjectRightsRequests.Item.Collaborators.Item {
    ...
    public class UserItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public UserItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/security/subjectRightsRequests/{subjectRightsRequest%2Did}/collaborators/{user%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new UserItemRequestBuilder and sets the default values.
        /// </summary>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public UserItemRequestBuilder(string rawUrl) : base("{+baseurl}/security/subjectRightsRequests/{subjectRightsRequest%2Did}/collaborators/{user%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Collection of users who can collaborate on the request.
        /// </summary>
