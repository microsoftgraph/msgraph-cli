...
namespace ApiSdk.Security.SubjectRightsRequests.Item.Notes {
    ...
    public class NotesRequestBuilder : BaseCliRequestBuilder {
        ...
        public NotesRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/security/subjectRightsRequests/{subjectRightsRequest%2Did}/notes{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new NotesRequestBuilder and sets the default values.
        /// </summary>
