...
namespace ApiSdk.Security.Incidents.Item.Alerts.Item
{
    ...
    public class AlertItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildCommentsNavCommand()
        {
            ...
            var builder = new ApiSdk.Security.Incidents.Item.Alerts.Item.Comments.CommentsRequestBuilder(PathParameters);
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Security.Incidents.Item.Alerts.Item.AlertItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Security.Incidents.Item.Alerts.Item.AlertItemRequestBuilder.AlertItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Security.Incidents.Item.Alerts.Item.AlertItemRequestBuilder.AlertItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
