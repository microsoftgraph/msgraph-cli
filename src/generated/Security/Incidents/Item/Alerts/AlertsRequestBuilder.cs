...
namespace ApiSdk.Security.Incidents.Item.Alerts {
    ...
    public class AlertsRequestBuilder : BaseCliRequestBuilder {
        ...
        public AlertsRequestBuilder(string rawUrl) : base("{+baseurl}/security/incidents/{incident%2Did}/alerts{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// The list of related alerts. Supports $expand.
        /// </summary>
