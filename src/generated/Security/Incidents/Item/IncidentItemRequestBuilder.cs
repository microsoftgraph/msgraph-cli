...
namespace ApiSdk.Security.Incidents.Item {
    ...
    public class IncidentItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public Command BuildPatchCommand() {
            ...
            command.Description = "Update the properties of an incident object. This API is available in the following national cloud deployments.\n\nFind more info here:\n  https://learn.microsoft.com/graph/api/security-incident-update?view=graph-rest-1.0";
            var incidentIdOption = new Option<string>("--incident-id", description: "The unique identifier of incident") {
            };
            incidentIdOption.IsRequired = true;
            command.AddOption(incidentIdOption);
        ...
        public IncidentItemRequestBuilder(string rawUrl) : base("{+baseurl}/security/incidents/{incident%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Delete navigation property incidents for security
        /// </summary>
