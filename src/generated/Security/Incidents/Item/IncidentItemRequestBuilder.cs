...
namespace ApiSdk.Security.Incidents.Item {
    ...
    public class IncidentItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.Description = "Retrieve the properties and relationships of an incident object. Attacks are typically inflicted on different types of entities, such as devices, users, and mailboxes, resulting in multiple alert objects. Microsoft 365 Defender correlates alerts with the same attack techniques or the same attacker into an **incident**. \n\nFind more info here:\n  https://docs.microsoft.com/graph/api/security-incident-get?view=graph-rest-1.0";
            var incidentIdOption = new Option<string>("--incident-id", description: "The unique identifier of incident") {
            };
            incidentIdOption.IsRequired = true;
            command.AddOption(incidentIdOption);
        ...
        public Command BuildPatchCommand() {
            ...
            command.Description = "Update the properties of an incident object.\n\nFind more info here:\n  https://docs.microsoft.com/graph/api/security-incident-update?view=graph-rest-1.0";
            var incidentIdOption = new Option<string>("--incident-id", description: "The unique identifier of incident") {
            };
            incidentIdOption.IsRequired = true;
            command.AddOption(incidentIdOption);
        ...
        public IncidentItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/security/incidents/{incident%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Delete navigation property incidents for security
        /// </summary>
...
#nullable restore
        ...
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<IncidentItemRequestBuilderGetQueryParameters>> requestConfiguration = default) {
            ...
            if (requestConfiguration != null) {
                var requestConfig = new RequestConfiguration<IncidentItemRequestBuilderGetQueryParameters>();
                requestConfiguration.Invoke(requestConfig);
                requestInfo.AddQueryParameters(requestConfig.QueryParameters);
                requestInfo.AddRequestOptions(requestConfig.Options);
                requestInfo.AddHeaders(requestConfig.Headers);
