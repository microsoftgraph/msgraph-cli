...
namespace ApiSdk.Security.Labels.RetentionLabels.Item.Descriptors
{
    ...
    public partial class DescriptorsRequestBuilder : BaseCliRequestBuilder
    {
        /// <summary>
        ...
        public Command BuildAuthorityTemplateNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Security.Labels.RetentionLabels.Item.Descriptors.AuthorityTemplate.AuthorityTemplateRequestBuilder(PathParameters);
        ...
        public Command BuildCategoryTemplateNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Security.Labels.RetentionLabels.Item.Descriptors.CategoryTemplate.CategoryTemplateRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildCitationTemplateNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Security.Labels.RetentionLabels.Item.Descriptors.CitationTemplate.CitationTemplateRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildDepartmentTemplateNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Security.Labels.RetentionLabels.Item.Descriptors.DepartmentTemplate.DepartmentTemplateRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildFilePlanReferenceTemplateNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Security.Labels.RetentionLabels.Item.Descriptors.FilePlanReferenceTemplate.FilePlanReferenceTemplateRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<global::ApiSdk.Models.Security.FilePlanDescriptor>(global::ApiSdk.Models.Security.FilePlanDescriptor.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Security.Labels.RetentionLabels.Item.Descriptors.DescriptorsRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Security.Labels.RetentionLabels.Item.Descriptors.DescriptorsRequestBuilder.DescriptorsRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Security.Labels.RetentionLabels.Item.Descriptors.DescriptorsRequestBuilder.DescriptorsRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.Security.FilePlanDescriptor body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.Security.FilePlanDescriptor body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
