...
using ApiSdk.Security.Labels.Authorities;
using ApiSdk.Security.Labels.Categories;
using ApiSdk.Security.Labels.Citations;
using ApiSdk.Security.Labels.Departments;
using ApiSdk.Security.Labels.FilePlanReferences;
using ApiSdk.Security.Labels.RetentionLabels;
...
namespace ApiSdk.Security.Labels
{
    ...
    public partial class LabelsRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildAuthoritiesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Security.Labels.Authorities.AuthoritiesRequestBuilder(PathParameters);
        ...
        public Command BuildCategoriesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Security.Labels.Categories.CategoriesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildCitationsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Security.Labels.Citations.CitationsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildDeleteCommand()
        {
            ...
            command.Description = "Delete navigation property labels for security";
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildDepartmentsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Security.Labels.Departments.DepartmentsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildFilePlanReferencesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Security.Labels.FilePlanReferences.FilePlanReferencesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildGetCommand()
        {
            ...
            command.Description = "Get labels from security";
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.Description = "Update the navigation property labels in security";
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<global::ApiSdk.Models.Security.LabelsRoot>(global::ApiSdk.Models.Security.LabelsRoot.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildRetentionLabelsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Security.Labels.RetentionLabels.RetentionLabelsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Security.Labels.LabelsRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Security.Labels.LabelsRequestBuilder.LabelsRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Security.Labels.LabelsRequestBuilder.LabelsRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.Security.LabelsRoot body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.Security.LabelsRoot body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
