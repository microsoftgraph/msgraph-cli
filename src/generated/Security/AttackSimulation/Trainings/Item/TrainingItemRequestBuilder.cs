...
namespace ApiSdk.Security.AttackSimulation.Trainings.Item
{
    ...
    public class TrainingItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildLanguageDetailsNavCommand()
        {
            ...
            var builder = new ApiSdk.Security.AttackSimulation.Trainings.Item.LanguageDetails.LanguageDetailsRequestBuilder(PathParameters);
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Security.AttackSimulation.Trainings.Item.TrainingItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Security.AttackSimulation.Trainings.Item.TrainingItemRequestBuilder.TrainingItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Security.AttackSimulation.Trainings.Item.TrainingItemRequestBuilder.TrainingItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.Training body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.Training body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
