...
namespace ApiSdk.Security.AttackSimulation.EndUserNotifications.Item
{
    ...
    public class EndUserNotificationItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildDetailsNavCommand()
        {
            ...
            var builder = new ApiSdk.Security.AttackSimulation.EndUserNotifications.Item.Details.DetailsRequestBuilder(PathParameters);
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Security.AttackSimulation.EndUserNotifications.Item.EndUserNotificationItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Security.AttackSimulation.EndUserNotifications.Item.EndUserNotificationItemRequestBuilder.EndUserNotificationItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Security.AttackSimulation.EndUserNotifications.Item.EndUserNotificationItemRequestBuilder.EndUserNotificationItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.EndUserNotification body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.EndUserNotification body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
