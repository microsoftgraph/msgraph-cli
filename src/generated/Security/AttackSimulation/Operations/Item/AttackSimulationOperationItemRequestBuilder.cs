...
namespace ApiSdk.Security.AttackSimulation.Operations.Item {
    ...
    public class AttackSimulationOperationItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public AttackSimulationOperationItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/security/attackSimulation/operations/{attackSimulationOperation%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new AttackSimulationOperationItemRequestBuilder and sets the default values.
        /// </summary>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public AttackSimulationOperationItemRequestBuilder(string rawUrl) : base("{+baseurl}/security/attackSimulation/operations/{attackSimulationOperation%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Delete navigation property operations for security
        /// </summary>
