...
namespace ApiSdk.Security.AttackSimulation.SimulationAutomations.Item.Runs.Item {
    ...
    public class SimulationAutomationRunItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            var simulationAutomationRunIdOption = new Option<string>("--simulation-automation-run-id", description: "The unique identifier of simulationAutomationRun") {
            };
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                if (simulationAutomationRunId is not null) requestInfo.PathParameters.Add("simulationAutomationRun%2Did", simulationAutomationRunId);
...
#nullable restore
        ...
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<SimulationAutomationRunItemRequestBuilderGetQueryParameters>> requestConfiguration = default) {
            ...
            if (requestConfiguration != null) {
                var requestConfig = new RequestConfiguration<SimulationAutomationRunItemRequestBuilderGetQueryParameters>();
                requestConfiguration.Invoke(requestConfig);
                requestInfo.AddQueryParameters(requestConfig.QueryParameters);
                requestInfo.AddRequestOptions(requestConfig.Options);
                requestInfo.AddHeaders(requestConfig.Headers);
