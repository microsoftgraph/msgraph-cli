...
namespace ApiSdk.Security.AttackSimulation.SimulationAutomations.Item.Runs.Item
{
    ...
    public class SimulationAutomationRunItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Security.AttackSimulation.SimulationAutomations.Item.Runs.Item.SimulationAutomationRunItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Security.AttackSimulation.SimulationAutomations.Item.Runs.Item.SimulationAutomationRunItemRequestBuilder.SimulationAutomationRunItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Security.AttackSimulation.SimulationAutomations.Item.Runs.Item.SimulationAutomationRunItemRequestBuilder.SimulationAutomationRunItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.SimulationAutomationRun body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.SimulationAutomationRun body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
