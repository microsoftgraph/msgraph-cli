...
namespace ApiSdk.Security.AttackSimulation {
    ...
    public class AttackSimulationRequestBuilder {
        ...
        public Command BuildSimulationAutomationsCommand() {
            ...
            var builder = new SimulationAutomationsRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildSimulationsCommand() {
            ...
            var builder = new SimulationsRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildCommand());
            command.AddCommand(builder.BuildCountCommand());
            command.AddCommand(builder.BuildCreateCommand());
            command.AddCommand(builder.BuildListCommand());
