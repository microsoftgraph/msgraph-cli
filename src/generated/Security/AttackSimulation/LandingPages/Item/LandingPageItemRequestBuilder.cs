...
using ApiSdk.Models;
using ApiSdk.Security.AttackSimulation.LandingPages.Item.Details;
...
namespace ApiSdk.Security.AttackSimulation.LandingPages.Item
{
    ...
    public partial class LandingPageItemRequestBuilder : BaseCliRequestBuilder
    {
        /// <summary>
        ...
        public Command BuildDeleteCommand()
        {
            ...
            command.Description = "Delete navigation property landingPages for security";
        ...
        public Command BuildDetailsNavCommand()
        {
            ...
            command.Description = "Provides operations to manage the details property of the microsoft.graph.landingPage entity.";
            var builder = new global::ApiSdk.Security.AttackSimulation.LandingPages.Item.Details.DetailsRequestBuilder(PathParameters);
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.Description = "Update the navigation property landingPages in security";
            var landingPageIdOption = new Option<string>("--landing-page-id", description: "The unique identifier of landingPage") {
            };
            landingPageIdOption.IsRequired = true;
            command.AddOption(landingPageIdOption);
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Security.AttackSimulation.LandingPages.Item.LandingPageItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Security.AttackSimulation.LandingPages.Item.LandingPageItemRequestBuilder.LandingPageItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Security.AttackSimulation.LandingPages.Item.LandingPageItemRequestBuilder.LandingPageItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.LandingPage body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.LandingPage body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
