...
namespace ApiSdk.Security.AttackSimulation.LoginPages {
    ...
    public class LoginPagesRequestBuilder : BaseCliRequestBuilder {
        ...
        public LoginPagesRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/security/attackSimulation/loginPages{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new LoginPagesRequestBuilder and sets the default values.
        /// </summary>
