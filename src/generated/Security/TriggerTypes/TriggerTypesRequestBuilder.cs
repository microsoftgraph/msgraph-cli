...
namespace ApiSdk.Security.TriggerTypes
{
    ...
    public partial class TriggerTypesRequestBuilder : BaseCliRequestBuilder
    {
        /// <summary>
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<global::ApiSdk.Models.Security.TriggerTypesRoot>(global::ApiSdk.Models.Security.TriggerTypesRoot.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        public Command BuildRetentionEventTypesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Security.TriggerTypes.RetentionEventTypes.RetentionEventTypesRequestBuilder(PathParameters);
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Security.TriggerTypes.TriggerTypesRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Security.TriggerTypes.TriggerTypesRequestBuilder.TriggerTypesRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Security.TriggerTypes.TriggerTypesRequestBuilder.TriggerTypesRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.Security.TriggerTypesRoot body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.Security.TriggerTypesRoot body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
