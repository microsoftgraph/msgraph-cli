...
using ApiSdk.Security.TriggerTypes.RetentionEventTypes;
...
using System;
namespace ApiSdk.Security.TriggerTypes {
    /// <summary>
    /// Provides operations to manage the triggerTypes property of the microsoft.graph.security entity.
    /// </summary>
    public class TriggerTypesRequestBuilder : BaseCliRequestBuilder {
        /// <summary>
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<TriggerTypesRoot>(TriggerTypesRoot.CreateFromDiscriminatorValue);
        ...
        public Command BuildRetentionEventTypesNavCommand() {
            ...
            var builder = new RetentionEventTypesRequestBuilder(PathParameters);
        ...
        public TriggerTypesRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/security/triggerTypes{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Delete navigation property triggerTypes for security
        /// </summary>
...
#nullable restore
        ...
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<TriggerTypesRequestBuilderGetQueryParameters>> requestConfiguration = default) {
            ...
            if (requestConfiguration != null) {
                var requestConfig = new RequestConfiguration<TriggerTypesRequestBuilderGetQueryParameters>();
                requestConfiguration.Invoke(requestConfig);
                requestInfo.AddQueryParameters(requestConfig.QueryParameters);
                requestInfo.AddRequestOptions(requestConfig.Options);
                requestInfo.AddHeaders(requestConfig.Headers);
