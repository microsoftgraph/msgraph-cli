using ApiSdk.FilterOperators.Count;
using ApiSdk.FilterOperators.Item;
...
namespace ApiSdk.FilterOperators {
    ...
    public class FilterOperatorsRequestBuilder : BaseCliRequestBuilder {
        ...
        public Tuple<List<Command>, List<Command>> BuildCommand() {
            ...
            var builder = new FilterOperatorSchemaItemRequestBuilder(PathParameters);
        ...
        public Command BuildCreateCommand() {
            ...
            command.Description = "Add new entity to filterOperators";
        ...
        public Command BuildListCommand() {
            ...
            command.Description = "Get entities from filterOperators";
        ...
        public FilterOperatorsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/filterOperators{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Get entities from filterOperators
        /// </summary>
