...
namespace ApiSdk.FilterOperators.Item {
    ...
    public class FilterOperatorSchemaItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            filterOperatorSchemaIdOption.IsRequired = true;
            command.AddOption(filterOperatorSchemaIdOption);
            ...
            command.SetHandler(async (invocationContext) => {
                var filterOperatorSchemaId = invocationContext.ParseResult.GetValueForOption(filterOperatorSchemaIdOption);
                var ifMatch = invocationContext.ParseResult.GetValueForOption(ifMatchOption);
                var cancellationToken = invocationContext.GetCancellationToken();
                var reqAdapter = invocationContext.GetRequestAdapter();
                var requestInfo = ToDeleteRequestInformation(q => {
                });
                if (filterOperatorSchemaId is not null) requestInfo.PathParameters.Add("filterOperatorSchema%2Did", filterOperatorSchemaId);
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<FilterOperatorSchema>(FilterOperatorSchema.CreateFromDiscriminatorValue);
        ...
        public FilterOperatorSchemaItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/filterOperators/{filterOperatorSchema%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Delete entity from filterOperators
        /// </summary>
...
#nullable restore
        ...
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<FilterOperatorSchemaItemRequestBuilderGetQueryParameters>> requestConfiguration = default) {
            ...
            if (requestConfiguration != null) {
                var requestConfig = new RequestConfiguration<FilterOperatorSchemaItemRequestBuilderGetQueryParameters>();
                requestConfiguration.Invoke(requestConfig);
                requestInfo.AddQueryParameters(requestConfig.QueryParameters);
                requestInfo.AddRequestOptions(requestConfig.Options);
                requestInfo.AddHeaders(requestConfig.Headers);
