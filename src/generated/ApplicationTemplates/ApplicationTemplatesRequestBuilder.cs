...
namespace ApiSdk.ApplicationTemplates {
    ...
    public class ApplicationTemplatesRequestBuilder {
        ...
        public List<Command> BuildCommand() {
            var builder = new ApplicationTemplateItemRequestBuilder(PathParameters, RequestAdapter);
        ...
        /// <param name="options">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ApplicationTemplate body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
