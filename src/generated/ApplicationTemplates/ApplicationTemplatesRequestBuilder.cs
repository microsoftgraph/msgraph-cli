...
namespace ApiSdk.ApplicationTemplates {
    ...
    public class ApplicationTemplatesRequestBuilder {
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ApplicationTemplate body, Action<ApplicationTemplatesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
