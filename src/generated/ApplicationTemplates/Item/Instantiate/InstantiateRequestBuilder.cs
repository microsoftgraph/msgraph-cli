...
namespace ApiSdk.ApplicationTemplates.Item.Instantiate {
    ...
    public class InstantiateRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (string applicationTemplateId, string body, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
            ...
            }, applicationTemplateIdOption, bodyOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        ...
        /// </summary>
        public async Task<InstantiateResponse> PostAsync(InstantiateRequestBody model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
