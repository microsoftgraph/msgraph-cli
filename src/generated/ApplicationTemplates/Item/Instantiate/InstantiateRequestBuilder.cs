...
namespace ApiSdk.ApplicationTemplates.Item.Instantiate {
    ...
    public class InstantiateRequestBuilder {
        ...
        /// </summary>
        public async Task<InstantiateResponse> PostAsync(InstantiateRequestBody model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
