...
namespace ApiSdk.ApplicationTemplates.Item.Instantiate {
    ...
    public class InstantiateRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            }, new CollectionBinding(applicationTemplateIdOption, bodyOption, outputOption, outputFilterOption, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
