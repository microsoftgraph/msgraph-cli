...
namespace ApiSdk.GroupLifecyclePolicies.Item {
    ...
    public class GroupLifecyclePolicyItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.Description = "Delete a groupLifecyclePolicy. This API is available in the following national cloud deployments.\n\nFind more info here:\n  https://learn.microsoft.com/graph/api/grouplifecyclepolicy-delete?view=graph-rest-1.0";
        ...
        public Command BuildGetCommand() {
            ...
            command.Description = "Retrieve the properties and relationships of a groupLifecyclePolicies object. This API is available in the following national cloud deployments.\n\nFind more info here:\n  https://learn.microsoft.com/graph/api/grouplifecyclepolicy-get?view=graph-rest-1.0";
            var groupLifecyclePolicyIdOption = new Option<string>("--group-lifecycle-policy-id", description: "The unique identifier of groupLifecyclePolicy") {
            };
            groupLifecyclePolicyIdOption.IsRequired = true;
            command.AddOption(groupLifecyclePolicyIdOption);
        ...
        public Command BuildPatchCommand() {
            ...
            command.Description = "Update the properties of a groupLifecyclePolicygroupLifecyclePolicy resource type object. This API is available in the following national cloud deployments.\n\nFind more info here:\n  https://learn.microsoft.com/graph/api/grouplifecyclepolicy-update?view=graph-rest-1.0";
            var groupLifecyclePolicyIdOption = new Option<string>("--group-lifecycle-policy-id", description: "The unique identifier of groupLifecyclePolicy") {
            };
            groupLifecyclePolicyIdOption.IsRequired = true;
            command.AddOption(groupLifecyclePolicyIdOption);
        ...
        public GroupLifecyclePolicyItemRequestBuilder(string rawUrl) : base("{+baseurl}/groupLifecyclePolicies/{groupLifecyclePolicy%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Delete a groupLifecyclePolicy. This API is available in the following national cloud deployments.
        /// </summary>
