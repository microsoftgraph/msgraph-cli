...
namespace ApiSdk.GroupLifecyclePolicies.Item.RemoveGroup {
    ...
    public class RemoveGroupResponse : IAdditionalDataHolder, IParsable {
        ...
        /// </summary>
        public static ApiSdk.GroupLifecyclePolicies.Item.RemoveGroup.RemoveGroupResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"value", (o,n) => { (o as RemoveGroupResponse).Value = n.GetBoolValue(); } },
            };
        }
        /// <summary>
