...
namespace ApiSdk.Privacy.SubjectRightsRequests.Item.GetFinalReport {
    ...
    public class GetFinalReportRequestBuilder {
        ...
        public GetFinalReportRequestBuilder(Dictionary<string, object> pathParameters) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            UrlTemplate = "{+baseurl}/privacy/subjectRightsRequests/{subjectRightsRequest%2Did}/getFinalReport()";
