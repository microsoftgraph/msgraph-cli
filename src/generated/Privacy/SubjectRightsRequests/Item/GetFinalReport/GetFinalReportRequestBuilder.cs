...
namespace ApiSdk.Privacy.SubjectRightsRequests.Item.GetFinalReport {
    ...
    public class GetFinalReportRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(subjectRightsRequestIdOption, outputOption, queryOption, jsonNoIndentOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
