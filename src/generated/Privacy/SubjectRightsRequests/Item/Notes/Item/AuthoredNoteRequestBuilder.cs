...
namespace ApiSdk.Privacy.SubjectRightsRequests.Item.Notes.Item {
    ...
    public class AuthoredNoteRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            }, subjectRightsRequestIdOption, authoredNoteIdOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// List of notes associcated with the request.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string subjectRightsRequestId, string authoredNoteId, string[] select, string[] expand, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
            ...
            }, subjectRightsRequestIdOption, authoredNoteIdOption, selectOption, expandOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// List of notes associcated with the request.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string subjectRightsRequestId, string authoredNoteId, string body, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                ...
                await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                console.WriteLine("Success");
            }, subjectRightsRequestIdOption, authoredNoteIdOption, bodyOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
