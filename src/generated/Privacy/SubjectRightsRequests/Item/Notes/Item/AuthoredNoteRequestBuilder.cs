...
namespace ApiSdk.Privacy.SubjectRightsRequests.Item.Notes.Item {
    ...
    public class AuthoredNoteRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string subjectRightsRequestId, string authoredNoteId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, subjectRightsRequestIdOption, authoredNoteIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// List of notes associcated with the request.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string subjectRightsRequestId, string authoredNoteId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, subjectRightsRequestIdOption, authoredNoteIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// List of notes associcated with the request.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string subjectRightsRequestId, string authoredNoteId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, subjectRightsRequestIdOption, authoredNoteIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
