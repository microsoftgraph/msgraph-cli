...
namespace ApiSdk.Privacy.SubjectRightsRequests.Item.Notes.Item {
    ...
    public class AuthoredNoteItemRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(subjectRightsRequestIdOption, authoredNoteIdOption, selectOption, expandOption, outputOption, outputFilterOption, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// List of notes associcated with the request.
