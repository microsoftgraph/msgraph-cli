...
namespace ApiSdk.Privacy.SubjectRightsRequests.Item.Notes {
    ...
    public class NotesRequestBuilder {
        ...
        public Command BuildListCommand() {
            ...
            command.Handler = CommandHandler.Create<string, int?, int?, string, string, bool?, object, object, object>(async (subjectRightsRequestId, top, skip, search, filter, count, orderby, select, expand) => {
