...
namespace ApiSdk.Privacy.SubjectRightsRequests.Item.Notes {
    ...
    public class NotesRequestBuilder : BaseCliRequestBuilder {
        ...
        public NotesRequestBuilder(string rawUrl) : base("{+baseurl}/privacy/subjectRightsRequests/{subjectRightsRequest%2Did}/notes{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Get the list of authored notes assoicated with a subject rights request.  This API is available in the following national cloud deployments.
        /// </summary>
