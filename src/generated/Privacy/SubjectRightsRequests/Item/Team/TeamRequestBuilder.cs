...
using ApiSdk.Privacy.SubjectRightsRequests.Item.Team.Ref;
...
namespace ApiSdk.Privacy.SubjectRightsRequests.Item.Team {
    ...
    public class TeamRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string subjectRightsRequestId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, subjectRightsRequestIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        public Command BuildRefCommand() {
            var command = new Command("ref");
            var builder = new ApiSdk.Privacy.SubjectRightsRequests.Item.Team.Ref.RefRequestBuilder(PathParameters, RequestAdapter);
