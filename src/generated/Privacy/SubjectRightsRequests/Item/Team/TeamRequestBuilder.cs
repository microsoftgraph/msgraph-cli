...
namespace ApiSdk.Privacy.SubjectRightsRequests.Item.Team {
    ...
    public class TeamRequestBuilder : BaseCliRequestBuilder {
        ...
        public TeamRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/privacy/subjectRightsRequests/{subjectRightsRequest%2Did}/team{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Information about the Microsoft Teams team that was created for the request.
        /// </summary>
