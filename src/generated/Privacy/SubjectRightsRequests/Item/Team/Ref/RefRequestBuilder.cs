...
namespace ApiSdk.Privacy.SubjectRightsRequests.Item.Team.Ref {
    ...
    public class RefRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(subjectRightsRequestIdOption, outputOption, outputFilterOption, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// Information about the Microsoft Teams team that was created for the request.
