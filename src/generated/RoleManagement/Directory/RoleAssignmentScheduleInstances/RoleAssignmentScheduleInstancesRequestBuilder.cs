...
using ApiSdk.RoleManagement.Directory.RoleAssignmentScheduleInstances.Count;
using ApiSdk.RoleManagement.Directory.RoleAssignmentScheduleInstances.FilterByCurrentUserWithOn;
using ApiSdk.RoleManagement.Directory.RoleAssignmentScheduleInstances.Item;
...
namespace ApiSdk.RoleManagement.Directory.RoleAssignmentScheduleInstances {
    ...
    public class RoleAssignmentScheduleInstancesRequestBuilder {
        ...
        public List<Command> BuildCommand() {
            var builder = new UnifiedRoleAssignmentScheduleInstanceItemRequestBuilder(PathParameters, RequestAdapter);
            var commands = new List<Command>();
            commands.Add(builder.BuildActivatedUsingCommand());
