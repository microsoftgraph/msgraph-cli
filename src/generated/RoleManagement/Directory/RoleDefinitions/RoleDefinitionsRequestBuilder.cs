...
using ApiSdk.RoleManagement.Directory.RoleDefinitions.Count;
using ApiSdk.RoleManagement.Directory.RoleDefinitions.Item;
...
namespace ApiSdk.RoleManagement.Directory.RoleDefinitions {
    ...
    public class RoleDefinitionsRequestBuilder {
        ...
        public Command BuildCommand() {
            ...
            command.AddCommand(builder.BuildInheritsPermissionsFromCommand());
