...
namespace ApiSdk.RoleManagement.Directory.RoleDefinitions.Item.InheritsPermissionsFrom {
    ...
    public class InheritsPermissionsFromRequestBuilder {
        ...
        public Command BuildListCommand() {
            ...
            command.SetHandler(async (string unifiedRoleDefinitionId, int? top, int? skip, string search, string filter, bool? count, string[] orderby, string[] select, string[] expand) => {
                ...
                var result = await RequestAdapter.SendAsync<InheritsPermissionsFromResponse>(requestInfo);
                // Print request output. What if the request has no return?
                using var serializer = RequestAdapter.SerializationWriterFactory.GetSerializationWriter("application/json");
                serializer.WriteObjectValue(null, result);
                using var content = serializer.GetSerializedContent();
                ...
                var strContent = await reader.ReadToEndAsync();
                Console.Write(strContent + "\n");
            }, unifiedRoleDefinitionIdOption, topOption, skipOption, searchOption, filterOption, countOption, orderbyOption, selectOption, expandOption);
            return command;
        }
        /// <summary>
