...
using ApiSdk.RoleManagement.Directory.RoleAssignmentSchedules.Count;
using ApiSdk.RoleManagement.Directory.RoleAssignmentSchedules.FilterByCurrentUserWithOn;
using ApiSdk.RoleManagement.Directory.RoleAssignmentSchedules.Item;
...
namespace ApiSdk.RoleManagement.Directory.RoleAssignmentSchedules {
    ...
    public class RoleAssignmentSchedulesRequestBuilder {
        ...
        public List<Command> BuildCommand() {
            var builder = new UnifiedRoleAssignmentScheduleItemRequestBuilder(PathParameters, RequestAdapter);
