...
namespace ApiSdk.RoleManagement.Directory.RoleAssignmentScheduleRequests.Item.ActivatedUsing {
    ...
    public class ActivatedUsingRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.Description = "If the request is from an eligible administrator to activate a role, this parameter will show the related eligible assignment for that activation.";
