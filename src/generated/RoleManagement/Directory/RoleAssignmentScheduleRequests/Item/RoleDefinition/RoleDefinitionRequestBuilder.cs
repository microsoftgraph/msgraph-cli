...
namespace ApiSdk.RoleManagement.Directory.RoleAssignmentScheduleRequests.Item.RoleDefinition {
    ...
    public class RoleDefinitionRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.Description = "Property indicating the roleDefinition the assignment is for. Provided so that callers can get the role definition using $expand at the same time as getting the role assignment. roleDefinition.Id will be auto expanded.";
            ...
            command.SetHandler(async (object[] parameters) => {
                var unifiedRoleAssignmentScheduleRequestId = (string) parameters[0];
            ...
            }, new CollectionBinding(unifiedRoleAssignmentScheduleRequestIdOption, selectOption, expandOption, outputOption, queryOption, jsonNoIndentOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
