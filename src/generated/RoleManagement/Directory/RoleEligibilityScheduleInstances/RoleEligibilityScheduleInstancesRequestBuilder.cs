...
using ApiSdk.RoleManagement.Directory.RoleEligibilityScheduleInstances.Count;
using ApiSdk.RoleManagement.Directory.RoleEligibilityScheduleInstances.FilterByCurrentUserWithOn;
using ApiSdk.RoleManagement.Directory.RoleEligibilityScheduleInstances.Item;
...
namespace ApiSdk.RoleManagement.Directory.RoleEligibilityScheduleInstances {
    ...
    public class RoleEligibilityScheduleInstancesRequestBuilder {
        ...
        public Command BuildCommand() {
            ...
            var builder = new UnifiedRoleEligibilityScheduleInstanceItemRequestBuilder(PathParameters, RequestAdapter);
