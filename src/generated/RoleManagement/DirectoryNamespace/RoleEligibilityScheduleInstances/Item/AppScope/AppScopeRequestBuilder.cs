...
namespace ApiSdk.RoleManagement.DirectoryNamespace.RoleEligibilityScheduleInstances.Item.AppScope {
    ...
    public class AppScopeRequestBuilder : BaseCliRequestBuilder {
        ...
        public AppScopeRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/roleManagement/directory/roleEligibilityScheduleInstances/{unifiedRoleEligibilityScheduleInstance%2Did}/appScope{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Read-only property with details of the app-specific scope when the assignment or role eligibility is scoped to an app. Nullable.
        /// </summary>
