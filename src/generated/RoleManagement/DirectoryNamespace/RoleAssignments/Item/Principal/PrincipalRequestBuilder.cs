...
namespace ApiSdk.RoleManagement.DirectoryNamespace.RoleAssignments.Item.Principal {
    ...
    public class PrincipalRequestBuilder : BaseCliRequestBuilder {
        ...
        public PrincipalRequestBuilder(string rawUrl) : base("{+baseurl}/roleManagement/directory/roleAssignments/{unifiedRoleAssignment%2Did}/principal{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Referencing the assigned principal. Read-only. Supports $expand.
        /// </summary>
