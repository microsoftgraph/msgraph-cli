...
namespace ApiSdk.RoleManagement.DirectoryNamespace.RoleAssignments.Item.Principal {
    ...
    public class PrincipalRequestBuilder : BaseCliRequestBuilder {
        ...
        public PrincipalRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/roleManagement/directory/roleAssignments/{unifiedRoleAssignment%2Did}/principal{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Referencing the assigned principal. Read-only. Supports $expand.
        /// </summary>
