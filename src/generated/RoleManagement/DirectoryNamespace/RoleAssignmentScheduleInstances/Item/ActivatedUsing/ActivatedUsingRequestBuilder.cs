...
namespace ApiSdk.RoleManagement.DirectoryNamespace.RoleAssignmentScheduleInstances.Item.ActivatedUsing {
    ...
    public class ActivatedUsingRequestBuilder : BaseCliRequestBuilder {
        ...
        public ActivatedUsingRequestBuilder(string rawUrl) : base("{+baseurl}/roleManagement/directory/roleAssignmentScheduleInstances/{unifiedRoleAssignmentScheduleInstance%2Did}/activatedUsing{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// If the request is from an eligible administrator to activate a role, this parameter will show the related eligible assignment for that activation. Otherwise, it is null. Supports $expand.
        /// </summary>
