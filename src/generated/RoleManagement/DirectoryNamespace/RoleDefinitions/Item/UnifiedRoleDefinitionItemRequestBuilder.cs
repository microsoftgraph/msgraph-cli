...
namespace ApiSdk.RoleManagement.DirectoryNamespace.RoleDefinitions.Item {
    ...
    public class UnifiedRoleDefinitionItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public UnifiedRoleDefinitionItemRequestBuilder(string rawUrl) : base("{+baseurl}/roleManagement/directory/roleDefinitions/{unifiedRoleDefinition%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Delete a unifiedRoleDefinition object. You cannot delete built-in roles. This feature requires an Azure AD Premium P1 or P2 license.
        /// </summary>
