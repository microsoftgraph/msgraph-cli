...
namespace ApiSdk.RoleManagement.DirectoryNamespace.RoleDefinitions.Item.InheritsPermissionsFrom.Item {
    ...
    public class UnifiedRoleDefinitionItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public UnifiedRoleDefinitionItemRequestBuilder(string rawUrl) : base("{+baseurl}/roleManagement/directory/roleDefinitions/{unifiedRoleDefinition%2Did}/inheritsPermissionsFrom/{unifiedRoleDefinition%2Did1}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Delete navigation property inheritsPermissionsFrom for roleManagement
        /// </summary>
