...
namespace ApiSdk.RoleManagement.DirectoryNamespace.RoleAssignmentSchedules.Item.DirectoryScope {
    ...
    public class DirectoryScopeRequestBuilder : BaseCliRequestBuilder {
        ...
        public DirectoryScopeRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/roleManagement/directory/roleAssignmentSchedules/{unifiedRoleAssignmentSchedule%2Did}/directoryScope{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// The directory object that is the scope of the role eligibility or assignment. Read-only.
        /// </summary>
