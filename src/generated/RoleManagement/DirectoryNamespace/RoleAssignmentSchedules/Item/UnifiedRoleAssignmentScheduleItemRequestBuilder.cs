...
namespace ApiSdk.RoleManagement.DirectoryNamespace.RoleAssignmentSchedules.Item {
    ...
    public class UnifiedRoleAssignmentScheduleItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public UnifiedRoleAssignmentScheduleItemRequestBuilder(string rawUrl) : base("{+baseurl}/roleManagement/directory/roleAssignmentSchedules/{unifiedRoleAssignmentSchedule%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Delete navigation property roleAssignmentSchedules for roleManagement
        /// </summary>
