...
namespace ApiSdk.RoleManagement.DirectoryNamespace.RoleAssignmentScheduleRequests.Item.Principal {
    ...
    public class PrincipalRequestBuilder : BaseCliRequestBuilder {
        ...
        public PrincipalRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/roleManagement/directory/roleAssignmentScheduleRequests/{unifiedRoleAssignmentScheduleRequest%2Did}/principal{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// The principal that&apos;s getting a role assignment through the request. Supports $expand.
        /// </summary>
