...
namespace ApiSdk.RoleManagement.EntitlementManagement.RoleEligibilityScheduleInstances {
    ...
    public class RoleEligibilityScheduleInstancesRequestBuilder : BaseCliRequestBuilder {
        ...
        public RoleEligibilityScheduleInstancesRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/roleManagement/entitlementManagement/roleEligibilityScheduleInstances{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Get the instances of role eligibilities.
        /// </summary>
