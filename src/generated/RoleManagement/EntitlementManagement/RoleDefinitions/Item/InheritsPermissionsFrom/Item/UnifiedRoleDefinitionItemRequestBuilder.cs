...
namespace ApiSdk.RoleManagement.EntitlementManagement.RoleDefinitions.Item.InheritsPermissionsFrom.Item {
    ...
    public class UnifiedRoleDefinitionItemRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            }, new CollectionBinding(unifiedRoleDefinitionIdOption, unifiedRoleDefinitionId1Option, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// Read-only collection of role definitions that the given role definition inherits from. Only Azure AD built-in roles support this attribute.
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(unifiedRoleDefinitionIdOption, unifiedRoleDefinitionId1Option, selectOption, expandOption, outputOption, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// Read-only collection of role definitions that the given role definition inherits from. Only Azure AD built-in roles support this attribute.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                await RequestAdapter.SendNoContentAsync(requestInfo, errorMapping: default, cancellationToken: cancellationToken);
                Console.WriteLine("Success");
            }, new CollectionBinding(unifiedRoleDefinitionIdOption, unifiedRoleDefinitionId1Option, bodyOption, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
