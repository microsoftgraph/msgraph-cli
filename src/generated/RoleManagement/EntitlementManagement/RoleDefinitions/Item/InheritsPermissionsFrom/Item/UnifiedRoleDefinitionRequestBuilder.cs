...
namespace ApiSdk.RoleManagement.EntitlementManagement.RoleDefinitions.Item.InheritsPermissionsFrom.Item {
    ...
    public class UnifiedRoleDefinitionRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            }, unifiedRoleDefinitionIdOption, unifiedRoleDefinitionId1Option, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// Read-only collection of role definitions that the given role definition inherits from. Only Azure AD built-in roles support this attribute.
        ...
        public Command BuildGetCommand() {
            ...
            }, unifiedRoleDefinitionIdOption, unifiedRoleDefinitionId1Option, selectOption, expandOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// Read-only collection of role definitions that the given role definition inherits from. Only Azure AD built-in roles support this attribute.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string unifiedRoleDefinitionId, string unifiedRoleDefinitionId1, string body, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                ...
                await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                console.WriteLine("Success");
            }, unifiedRoleDefinitionIdOption, unifiedRoleDefinitionId1Option, bodyOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
