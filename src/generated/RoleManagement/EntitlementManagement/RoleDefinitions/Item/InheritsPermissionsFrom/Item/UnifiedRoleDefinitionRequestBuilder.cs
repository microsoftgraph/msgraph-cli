...
namespace ApiSdk.RoleManagement.EntitlementManagement.RoleDefinitions.Item.InheritsPermissionsFrom.Item {
    ...
    public class UnifiedRoleDefinitionRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string unifiedRoleDefinitionId, string unifiedRoleDefinitionId1, IConsole console) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string unifiedRoleDefinitionId, string unifiedRoleDefinitionId1, string[] select, string[] expand, FormatterType output, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string unifiedRoleDefinitionId, string unifiedRoleDefinitionId1, string body, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
