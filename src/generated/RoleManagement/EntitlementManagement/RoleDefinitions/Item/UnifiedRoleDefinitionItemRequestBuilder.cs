...
namespace ApiSdk.RoleManagement.EntitlementManagement.RoleDefinitions.Item {
    ...
    public class UnifiedRoleDefinitionItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public UnifiedRoleDefinitionItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/roleManagement/entitlementManagement/roleDefinitions/{unifiedRoleDefinition%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Delete navigation property roleDefinitions for roleManagement
        /// </summary>
