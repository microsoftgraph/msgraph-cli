...
namespace ApiSdk.RoleManagement.EntitlementManagement.RoleDefinitions.Item {
    ...
    public class UnifiedRoleDefinitionRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string unifiedRoleDefinitionId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, unifiedRoleDefinitionIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// Resource representing the roles allowed by RBAC providers and the permissions assigned to the roles.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string unifiedRoleDefinitionId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, unifiedRoleDefinitionIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        public Command BuildInheritsPermissionsFromCommand() {
            var command = new Command("inherits-permissions-from");
            var builder = new ApiSdk.RoleManagement.EntitlementManagement.RoleDefinitions.Item.InheritsPermissionsFrom.InheritsPermissionsFromRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string unifiedRoleDefinitionId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, unifiedRoleDefinitionIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
