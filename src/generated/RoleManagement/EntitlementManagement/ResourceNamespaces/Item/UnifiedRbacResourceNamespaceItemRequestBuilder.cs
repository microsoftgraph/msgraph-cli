...
namespace ApiSdk.RoleManagement.EntitlementManagement.ResourceNamespaces.Item {
    ...
    public class UnifiedRbacResourceNamespaceItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public UnifiedRbacResourceNamespaceItemRequestBuilder(string rawUrl) : base("{+baseurl}/roleManagement/entitlementManagement/resourceNamespaces/{unifiedRbacResourceNamespace%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Delete navigation property resourceNamespaces for roleManagement
        /// </summary>
