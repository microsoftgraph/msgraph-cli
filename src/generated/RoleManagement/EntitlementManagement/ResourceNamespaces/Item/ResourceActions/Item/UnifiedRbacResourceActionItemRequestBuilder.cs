...
namespace ApiSdk.RoleManagement.EntitlementManagement.ResourceNamespaces.Item.ResourceActions.Item {
    ...
    public class UnifiedRbacResourceActionItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public UnifiedRbacResourceActionItemRequestBuilder(string rawUrl) : base("{+baseurl}/roleManagement/entitlementManagement/resourceNamespaces/{unifiedRbacResourceNamespace%2Did}/resourceActions/{unifiedRbacResourceAction%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Delete navigation property resourceActions for roleManagement
        /// </summary>
