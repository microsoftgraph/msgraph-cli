...
namespace ApiSdk.RoleManagement.EntitlementManagement.RoleEligibilityScheduleRequests.Item.MicrosoftGraphCancel {
    /// <summary>
    ...
    public class MicrosoftGraphCancelRequestBuilder {
        ...
        public MicrosoftGraphCancelRequestBuilder(Dictionary<string, object> pathParameters) {
            ...
            UrlTemplate = "{+baseurl}/roleManagement/entitlementManagement/roleEligibilityScheduleRequests/{unifiedRoleEligibilityScheduleRequest%2Did}/microsoft.graph.cancel";
