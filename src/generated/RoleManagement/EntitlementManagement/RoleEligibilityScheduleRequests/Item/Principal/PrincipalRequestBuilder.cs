...
namespace ApiSdk.RoleManagement.EntitlementManagement.RoleEligibilityScheduleRequests.Item.Principal {
    ...
    public class PrincipalRequestBuilder : BaseCliRequestBuilder {
        ...
        public PrincipalRequestBuilder(string rawUrl) : base("{+baseurl}/roleManagement/entitlementManagement/roleEligibilityScheduleRequests/{unifiedRoleEligibilityScheduleRequest%2Did}/principal{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// The principal that&apos;s getting a role eligibility through the request. Supports $expand.
        /// </summary>
