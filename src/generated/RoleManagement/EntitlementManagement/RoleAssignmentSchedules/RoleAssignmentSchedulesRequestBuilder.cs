...
namespace ApiSdk.RoleManagement.EntitlementManagement.RoleAssignmentSchedules {
    ...
    public class RoleAssignmentSchedulesRequestBuilder : BaseCliRequestBuilder {
        ...
        public RoleAssignmentSchedulesRequestBuilder(string rawUrl) : base("{+baseurl}/roleManagement/entitlementManagement/roleAssignmentSchedules{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Get the schedules for active role assignment operations. This API is available in the following national cloud deployments.
        /// </summary>
