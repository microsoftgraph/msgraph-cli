...
namespace ApiSdk.RoleManagement.EntitlementManagement.RoleAssignmentSchedules.Item.AppScope {
    ...
    public class AppScopeRequestBuilder : BaseCliRequestBuilder {
        ...
        public AppScopeRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/roleManagement/entitlementManagement/roleAssignmentSchedules/{unifiedRoleAssignmentSchedule%2Did}/appScope{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Read-only property with details of the app-specific scope when the role eligibility or assignment is scoped to an app. Nullable.
        /// </summary>
