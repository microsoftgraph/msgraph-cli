...
namespace ApiSdk.RoleManagement.EntitlementManagement.RoleAssignmentSchedules.Item.ActivatedUsing {
    ...
    public class ActivatedUsingRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.Description = "If the roleAssignmentSchedule is activated by a roleEligibilitySchedule, this is the link to that schedule.";
        ...
        public ActivatedUsingRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/roleManagement/entitlementManagement/roleAssignmentSchedules/{unifiedRoleAssignmentSchedule%2Did}/activatedUsing{?%24select,%24expand}";
