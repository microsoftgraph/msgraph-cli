    ...
    public class EntitlementManagementRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.Handler = CommandHandler.Create<object, object>(async (select, expand) => {
                ...
                var result = await RequestAdapter.SendAsync<RbacApplication>(requestInfo);
                // Print request output. What if the request has no return?
        ...
        public Command BuildPatchCommand() {
            ...
            command.Handler = CommandHandler.Create<string>(async (body) => {
                ...
                var model = parseNode.GetObjectValue<RbacApplication>();
        ...
        public Command BuildRoleAssignmentsCommand() {
            ...
            var builder = new ApiSdk.RoleManagement.EntitlementManagement.RoleAssignments.RoleAssignmentsRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildRoleDefinitionsCommand() {
            ...
            var builder = new ApiSdk.RoleManagement.EntitlementManagement.RoleDefinitions.RoleDefinitionsRequestBuilder(PathParameters, RequestAdapter);
            foreach (var cmd in builder.BuildCommand()) {
                command.AddCommand(cmd);
            }
            command.AddCommand(builder.BuildCreateCommand());
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(RbacApplication model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
