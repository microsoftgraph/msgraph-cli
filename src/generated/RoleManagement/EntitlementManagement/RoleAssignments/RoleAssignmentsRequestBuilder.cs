...
namespace ApiSdk.RoleManagement.EntitlementManagement.RoleAssignments {
    ...
    public class RoleAssignmentsRequestBuilder : BaseCliRequestBuilder {
        ...
        public RoleAssignmentsRequestBuilder(string rawUrl) : base("{+baseurl}/roleManagement/entitlementManagement/roleAssignments{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Get a list of unifiedRoleAssignment objects for the RBAC provider. The following RBAC providers are currently supported:- directory (Microsoft Entra ID)- entitlement management (Microsoft Entra Entitlement Management) This API is available in the following national cloud deployments.
        /// </summary>
