...
namespace ApiSdk.AuditLogs.Provisioning {
    public class ProvisioningResponse : IAdditionalDataHolder, IParsable {
        ...
        /// </summary>
        public static ProvisioningResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as ProvisioningResponse).Value = n.GetCollectionOfObjectValues<ProvisioningObjectSummary>(ProvisioningObjectSummary.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
