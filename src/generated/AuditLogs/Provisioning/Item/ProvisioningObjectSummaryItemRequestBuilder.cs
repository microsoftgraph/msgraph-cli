    ...
    public class ProvisioningObjectSummaryItemRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                PathParameters.Add("provisioningObjectSummary_id", provisioningObjectSummaryId);
                var requestInfo = CreateDeleteRequestInformation(q => {
                });
                await RequestAdapter.SendNoContentAsync(requestInfo, errorMapping: default, cancellationToken: cancellationToken);
                Console.WriteLine("Success");
            }, new CollectionBinding(provisioningObjectSummaryIdOption, new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
