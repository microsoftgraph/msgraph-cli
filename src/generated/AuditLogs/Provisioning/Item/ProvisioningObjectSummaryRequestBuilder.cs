...
namespace ApiSdk.AuditLogs.Provisioning.Item {
    ...
    public class ProvisioningObjectSummaryRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string provisioningObjectSummaryId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, provisioningObjectSummaryIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string provisioningObjectSummaryId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, provisioningObjectSummaryIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string provisioningObjectSummaryId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, provisioningObjectSummaryIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
