...
namespace ApiSdk.AuditLogs.Provisioning.Item {
    ...
    public class ProvisioningObjectSummaryRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string provisioningObjectSummaryId, IOutputFormatterFactory outputFormatterFactory, CancellationToken cancellationToken) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string provisioningObjectSummaryId, string[] select, string[] expand, FormatterType output, IOutputFormatterFactory outputFormatterFactory, CancellationToken cancellationToken) => {
            ...
            }, provisioningObjectSummaryIdOption, selectOption, expandOption, outputOption);
            return command;
        }
        /// <summary>
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string provisioningObjectSummaryId, string body, IOutputFormatterFactory outputFormatterFactory, CancellationToken cancellationToken) => {
