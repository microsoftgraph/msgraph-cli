...
namespace ApiSdk.AuditLogs.Provisioning.Item {
    ...
    public class ProvisioningObjectSummaryRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string provisioningObjectSummaryId, IConsole console) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string provisioningObjectSummaryId, string[] select, string[] expand, FormatterType output, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string provisioningObjectSummaryId, string body, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
