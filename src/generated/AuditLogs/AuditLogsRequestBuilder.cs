...
namespace ApiSdk.AuditLogs {
    ...
    public class AuditLogsRequestBuilder : BaseCliRequestBuilder {
        ...
        public AuditLogsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/auditLogs{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Get auditLogs
        /// </summary>
...
#nullable restore
        ...
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<AuditLogsRequestBuilderGetQueryParameters>> requestConfiguration = default) {
            ...
            if (requestConfiguration != null) {
                var requestConfig = new RequestConfiguration<AuditLogsRequestBuilderGetQueryParameters>();
