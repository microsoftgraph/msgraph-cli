...
namespace ApiSdk.AuditLogs.DirectoryAudits.Item {
    ...
    public class DirectoryAuditItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.Description = "Get a specific Azure Active Directory audit log item. This includes an audit log item generated by various services within Azure Active Directory like user, application, device and group management, privileged identity management (PIM), access reviews, terms of use, identity protection, password management (self-service and admin password resets), self-service group management, and so on.\n\nFind more info here:\n  https://docs.microsoft.com/graph/api/directoryaudit-get?view=graph-rest-1.0";
            var directoryAuditIdOption = new Option<string>("--directory-audit-id", description: "The unique identifier of directoryAudit") {
            };
            directoryAuditIdOption.IsRequired = true;
            command.AddOption(directoryAuditIdOption);
