using ApiSdk.AuditLogs.RestrictedSignIns.Count;
...
namespace ApiSdk.AuditLogs.RestrictedSignIns {
    ...
    public class RestrictedSignInsRequestBuilder {
        ...
        public Command BuildCommand() {
            ...
            var builder = new RestrictedSignInItemRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildCreateCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                var model = parseNode.GetObjectValue<RestrictedSignIn>(RestrictedSignIn.CreateFromDiscriminatorValue);
