...
namespace ApiSdk.Models
{
    ...
    public partial class ImportedWindowsAutopilotDeviceIdentity : global::ApiSdk.Models.Entity, IParsable
    {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::ApiSdk.Models.ImportedWindowsAutopilotDeviceIdentityState? State { get; set; }
#nullable restore
#else
        public global::ApiSdk.Models.ImportedWindowsAutopilotDeviceIdentityState State { get; set; }
#endif
        ...
        /// </summary>
        /// <returns>A <see cref="global::ApiSdk.Models.ImportedWindowsAutopilotDeviceIdentity"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::ApiSdk.Models.ImportedWindowsAutopilotDeviceIdentity CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::ApiSdk.Models.ImportedWindowsAutopilotDeviceIdentity();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "state", n => { State = n.GetObjectValue<global::ApiSdk.Models.ImportedWindowsAutopilotDeviceIdentityState>(global::ApiSdk.Models.ImportedWindowsAutopilotDeviceIdentityState.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::ApiSdk.Models.ImportedWindowsAutopilotDeviceIdentityState>("state", State);
        }
    }
}
