...
namespace ApiSdk.Models
{
    ...
    /// </summary>
    public class WindowsInformationProtectionPolicy : ApiSdk.Models.WindowsInformationProtection, IParsable
    {
...
#nullable restore
        ...
        public ApiSdk.Models.WindowsInformationProtectionPinCharacterRequirements? PinLowercaseLetters { get; set; }
        ...
        /// <summary>Pin Character Requirements</summary>
        public ApiSdk.Models.WindowsInformationProtectionPinCharacterRequirements? PinSpecialCharacters { get; set; }
        /// <summary>Pin Character Requirements</summary>
        public ApiSdk.Models.WindowsInformationProtectionPinCharacterRequirements? PinUppercaseLetters { get; set; }
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Models.WindowsInformationProtectionPolicy"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.WindowsInformationProtectionPolicy"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new ApiSdk.Models.WindowsInformationProtectionPolicy CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.WindowsInformationProtectionPolicy();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "pinLowercaseLetters", n => { PinLowercaseLetters = n.GetEnumValue<ApiSdk.Models.WindowsInformationProtectionPinCharacterRequirements>(); } },
                { "pinMinimumLength", n => { PinMinimumLength = n.GetIntValue(); } },
                { "pinSpecialCharacters", n => { PinSpecialCharacters = n.GetEnumValue<ApiSdk.Models.WindowsInformationProtectionPinCharacterRequirements>(); } },
                { "pinUppercaseLetters", n => { PinUppercaseLetters = n.GetEnumValue<ApiSdk.Models.WindowsInformationProtectionPinCharacterRequirements>(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<ApiSdk.Models.WindowsInformationProtectionPinCharacterRequirements>("pinLowercaseLetters", PinLowercaseLetters);
            writer.WriteIntValue("pinMinimumLength", PinMinimumLength);
            writer.WriteEnumValue<ApiSdk.Models.WindowsInformationProtectionPinCharacterRequirements>("pinSpecialCharacters", PinSpecialCharacters);
            writer.WriteEnumValue<ApiSdk.Models.WindowsInformationProtectionPinCharacterRequirements>("pinUppercaseLetters", PinUppercaseLetters);
