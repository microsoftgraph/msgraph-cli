...
namespace ApiSdk.Models
{
    ...
    public partial class WindowsInformationProtectionPolicy : global::ApiSdk.Models.WindowsInformationProtection, IParsable
    {
...
#nullable restore
        ...
        public global::ApiSdk.Models.WindowsInformationProtectionPinCharacterRequirements? PinLowercaseLetters { get; set; }
        ...
        /// <summary>Pin Character Requirements</summary>
        public global::ApiSdk.Models.WindowsInformationProtectionPinCharacterRequirements? PinSpecialCharacters { get; set; }
        /// <summary>Pin Character Requirements</summary>
        public global::ApiSdk.Models.WindowsInformationProtectionPinCharacterRequirements? PinUppercaseLetters { get; set; }
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Models.WindowsInformationProtectionPolicy"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::ApiSdk.Models.WindowsInformationProtectionPolicy"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::ApiSdk.Models.WindowsInformationProtectionPolicy CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::ApiSdk.Models.WindowsInformationProtectionPolicy();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "pinLowercaseLetters", n => { PinLowercaseLetters = n.GetEnumValue<global::ApiSdk.Models.WindowsInformationProtectionPinCharacterRequirements>(); } },
                { "pinMinimumLength", n => { PinMinimumLength = n.GetIntValue(); } },
                { "pinSpecialCharacters", n => { PinSpecialCharacters = n.GetEnumValue<global::ApiSdk.Models.WindowsInformationProtectionPinCharacterRequirements>(); } },
                { "pinUppercaseLetters", n => { PinUppercaseLetters = n.GetEnumValue<global::ApiSdk.Models.WindowsInformationProtectionPinCharacterRequirements>(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::ApiSdk.Models.WindowsInformationProtectionPinCharacterRequirements>("pinLowercaseLetters", PinLowercaseLetters);
            writer.WriteIntValue("pinMinimumLength", PinMinimumLength);
            writer.WriteEnumValue<global::ApiSdk.Models.WindowsInformationProtectionPinCharacterRequirements>("pinSpecialCharacters", PinSpecialCharacters);
            writer.WriteEnumValue<global::ApiSdk.Models.WindowsInformationProtectionPinCharacterRequirements>("pinUppercaseLetters", PinUppercaseLetters);
