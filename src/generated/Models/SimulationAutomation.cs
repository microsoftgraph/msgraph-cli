...
namespace ApiSdk.Models
{
    ...
    public class SimulationAutomation : ApiSdk.Models.Entity, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<ApiSdk.Models.SimulationAutomationRun>? Runs { get; set; }
#nullable restore
#else
        public List<ApiSdk.Models.SimulationAutomationRun> Runs { get; set; }
#endif
        ...
        public ApiSdk.Models.SimulationAutomationStatus? Status { get; set; }
        /// <summary>
        /// Creates a new instance of the appropriate class based on discriminator value
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.SimulationAutomation"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new ApiSdk.Models.SimulationAutomation CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.SimulationAutomation();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "runs", n => { Runs = n.GetCollectionOfObjectValues<ApiSdk.Models.SimulationAutomationRun>(ApiSdk.Models.SimulationAutomationRun.CreateFromDiscriminatorValue)?.ToList(); } },
                { "status", n => { Status = n.GetEnumValue<ApiSdk.Models.SimulationAutomationStatus>(); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<ApiSdk.Models.SimulationAutomationRun>("runs", Runs);
            writer.WriteEnumValue<ApiSdk.Models.SimulationAutomationStatus>("status", Status);
        }
    }
}
