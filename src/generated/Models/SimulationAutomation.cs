...
namespace ApiSdk.Models
{
    ...
    public partial class SimulationAutomation : global::ApiSdk.Models.Entity, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::ApiSdk.Models.SimulationAutomationRun>? Runs { get; set; }
#nullable restore
#else
        public List<global::ApiSdk.Models.SimulationAutomationRun> Runs { get; set; }
#endif
        ...
        public global::ApiSdk.Models.SimulationAutomationStatus? Status { get; set; }
        /// <summary>
        /// Creates a new instance of the appropriate class based on discriminator value
        /// </summary>
        /// <returns>A <see cref="global::ApiSdk.Models.SimulationAutomation"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::ApiSdk.Models.SimulationAutomation CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::ApiSdk.Models.SimulationAutomation();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "runs", n => { Runs = n.GetCollectionOfObjectValues<global::ApiSdk.Models.SimulationAutomationRun>(global::ApiSdk.Models.SimulationAutomationRun.CreateFromDiscriminatorValue)?.AsList(); } },
                { "status", n => { Status = n.GetEnumValue<global::ApiSdk.Models.SimulationAutomationStatus>(); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::ApiSdk.Models.SimulationAutomationRun>("runs", Runs);
            writer.WriteEnumValue<global::ApiSdk.Models.SimulationAutomationStatus>("status", Status);
        }
    }
}
