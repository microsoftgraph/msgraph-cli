...
namespace ApiSdk.Models
{
    ...
    public partial class ItemRetentionLabel : global::ApiSdk.Models.Entity, IParsable
...
#nullable enable
        public global::ApiSdk.Models.IdentitySet? LabelAppliedBy { get; set; }
#nullable restore
#else
        public global::ApiSdk.Models.IdentitySet LabelAppliedBy { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::ApiSdk.Models.RetentionLabelSettings? RetentionSettings { get; set; }
#nullable restore
#else
        public global::ApiSdk.Models.RetentionLabelSettings RetentionSettings { get; set; }
#endif
        ...
        /// </summary>
        /// <returns>A <see cref="global::ApiSdk.Models.ItemRetentionLabel"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::ApiSdk.Models.ItemRetentionLabel CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::ApiSdk.Models.ItemRetentionLabel();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "labelAppliedBy", n => { LabelAppliedBy = n.GetObjectValue<global::ApiSdk.Models.IdentitySet>(global::ApiSdk.Models.IdentitySet.CreateFromDiscriminatorValue); } },
                { "labelAppliedDateTime", n => { LabelAppliedDateTime = n.GetDateTimeOffsetValue(); } },
                { "name", n => { Name = n.GetStringValue(); } },
                { "retentionSettings", n => { RetentionSettings = n.GetObjectValue<global::ApiSdk.Models.RetentionLabelSettings>(global::ApiSdk.Models.RetentionLabelSettings.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::ApiSdk.Models.IdentitySet>("labelAppliedBy", LabelAppliedBy);
            writer.WriteDateTimeOffsetValue("labelAppliedDateTime", LabelAppliedDateTime);
            writer.WriteStringValue("name", Name);
            writer.WriteObjectValue<global::ApiSdk.Models.RetentionLabelSettings>("retentionSettings", RetentionSettings);
        }
    }
}
