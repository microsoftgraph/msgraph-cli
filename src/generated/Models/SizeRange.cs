...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Models.SizeRange"/> and sets the default values.
        /// </summary>
        public SizeRange()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.SizeRange"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static ApiSdk.Models.SizeRange CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.SizeRange();
        }
        /// <summary>
