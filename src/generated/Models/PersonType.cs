...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Models.PersonType"/> and sets the default values.
        /// </summary>
        public PersonType()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.PersonType"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static ApiSdk.Models.PersonType CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.PersonType();
        }
        /// <summary>
