...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Models.SearchQuery"/> and sets the default values.
        /// </summary>
        public SearchQuery()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.SearchQuery"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static ApiSdk.Models.SearchQuery CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.SearchQuery();
        }
        /// <summary>
