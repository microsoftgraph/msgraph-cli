...
#nullable enable
        public List<ApiSdk.Models.LocationConstraintItem>? Locations { get; set; }
#nullable restore
#else
        public List<ApiSdk.Models.LocationConstraintItem> Locations { get; set; }
#endif
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Models.LocationConstraint"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.LocationConstraint"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static ApiSdk.Models.LocationConstraint CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.LocationConstraint();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "locations", n => { Locations = n.GetCollectionOfObjectValues<ApiSdk.Models.LocationConstraintItem>(ApiSdk.Models.LocationConstraintItem.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<ApiSdk.Models.LocationConstraintItem>("locations", Locations);
