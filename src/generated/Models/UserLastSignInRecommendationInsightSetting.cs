...
namespace ApiSdk.Models
{
    ...
    public class UserLastSignInRecommendationInsightSetting : ApiSdk.Models.AccessReviewRecommendationInsightSetting, IParsable
    #pragma warning restore CS1591
    {
        ...
        public ApiSdk.Models.UserSignInRecommendationScope? SignInScope { get; set; }
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Models.UserLastSignInRecommendationInsightSetting"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.UserLastSignInRecommendationInsightSetting"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new ApiSdk.Models.UserLastSignInRecommendationInsightSetting CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.UserLastSignInRecommendationInsightSetting();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "signInScope", n => { SignInScope = n.GetEnumValue<ApiSdk.Models.UserSignInRecommendationScope>(); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<ApiSdk.Models.UserSignInRecommendationScope>("signInScope", SignInScope);
        }
    }
}
