...
namespace ApiSdk.Models
{
    ...
    public class DocumentSetVersion : ApiSdk.Models.ListItemVersion, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<ApiSdk.Models.DocumentSetVersionItem>? Items { get; set; }
#nullable restore
#else
        public List<ApiSdk.Models.DocumentSetVersionItem> Items { get; set; }
#endif
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Models.DocumentSetVersion"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.DocumentSetVersion"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new ApiSdk.Models.DocumentSetVersion CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.DocumentSetVersion();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "items", n => { Items = n.GetCollectionOfObjectValues<ApiSdk.Models.DocumentSetVersionItem>(ApiSdk.Models.DocumentSetVersionItem.CreateFromDiscriminatorValue)?.ToList(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<ApiSdk.Models.DocumentSetVersionItem>("items", Items);
