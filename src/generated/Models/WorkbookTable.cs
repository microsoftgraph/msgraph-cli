...
namespace ApiSdk.Models
{
    ...
    public partial class WorkbookTable : global::ApiSdk.Models.Entity, IParsable
    #pragma warning restore CS1591
    {
        /// <summary>The list of all the columns in the table. Read-only.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::ApiSdk.Models.WorkbookTableColumn>? Columns { get; set; }
#nullable restore
#else
        public List<global::ApiSdk.Models.WorkbookTableColumn> Columns { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::ApiSdk.Models.WorkbookTableRow>? Rows { get; set; }
#nullable restore
#else
        public List<global::ApiSdk.Models.WorkbookTableRow> Rows { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::ApiSdk.Models.WorkbookTableSort? Sort { get; set; }
#nullable restore
#else
        public global::ApiSdk.Models.WorkbookTableSort Sort { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::ApiSdk.Models.WorkbookTable"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::ApiSdk.Models.WorkbookTable CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::ApiSdk.Models.WorkbookTable();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "columns", n => { Columns = n.GetCollectionOfObjectValues<global::ApiSdk.Models.WorkbookTableColumn>(global::ApiSdk.Models.WorkbookTableColumn.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "rows", n => { Rows = n.GetCollectionOfObjectValues<global::ApiSdk.Models.WorkbookTableRow>(global::ApiSdk.Models.WorkbookTableRow.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "sort", n => { Sort = n.GetObjectValue<global::ApiSdk.Models.WorkbookTableSort>(global::ApiSdk.Models.WorkbookTableSort.CreateFromDiscriminatorValue); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::ApiSdk.Models.WorkbookTableColumn>("columns", Columns);
            ...
            writer.WriteCollectionOfObjectValues<global::ApiSdk.Models.WorkbookTableRow>("rows", Rows);
            ...
            writer.WriteObjectValue<global::ApiSdk.Models.WorkbookTableSort>("sort", Sort);
