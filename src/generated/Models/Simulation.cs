...
namespace ApiSdk.Models
{
    ...
    public class Simulation : ApiSdk.Models.Entity, IParsable
    #pragma warning restore CS1591
    {
        ...
        public ApiSdk.Models.SimulationAttackTechnique? AttackTechnique { get; set; }
        ...
        public ApiSdk.Models.SimulationAttackType? AttackType { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public ApiSdk.Models.SimulationReport? Report { get; set; }
#nullable restore
#else
        public ApiSdk.Models.SimulationReport Report { get; set; }
#endif
        ...
        public ApiSdk.Models.SimulationStatus? Status { get; set; }
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.Simulation"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new ApiSdk.Models.Simulation CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.Simulation();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "attackTechnique", n => { AttackTechnique = n.GetEnumValue<ApiSdk.Models.SimulationAttackTechnique>(); } },
                { "attackType", n => { AttackType = n.GetEnumValue<ApiSdk.Models.SimulationAttackType>(); } },
                ...
                { "payloadDeliveryPlatform", n => { PayloadDeliveryPlatform = n.GetEnumValue<ApiSdk.Models.PayloadDeliveryPlatform>(); } },
                { "report", n => { Report = n.GetObjectValue<ApiSdk.Models.SimulationReport>(ApiSdk.Models.SimulationReport.CreateFromDiscriminatorValue); } },
                { "status", n => { Status = n.GetEnumValue<ApiSdk.Models.SimulationStatus>(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<ApiSdk.Models.SimulationAttackTechnique>("attackTechnique", AttackTechnique);
            writer.WriteEnumValue<ApiSdk.Models.SimulationAttackType>("attackType", AttackType);
            ...
            writer.WriteEnumValue<ApiSdk.Models.PayloadDeliveryPlatform>("payloadDeliveryPlatform", PayloadDeliveryPlatform);
            writer.WriteObjectValue<ApiSdk.Models.SimulationReport>("report", Report);
            writer.WriteEnumValue<ApiSdk.Models.SimulationStatus>("status", Status);
