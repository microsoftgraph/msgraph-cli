...
#nullable restore
        ...
        public ApiSdk.Models.AttributeFlowBehavior? FlowBehavior { get; set; }
        /// <summary>The flowType property</summary>
        public ApiSdk.Models.AttributeFlowType? FlowType { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public ApiSdk.Models.AttributeMappingSource? Source { get; set; }
#nullable restore
#else
        public ApiSdk.Models.AttributeMappingSource Source { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Models.AttributeMapping"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.AttributeMapping"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static ApiSdk.Models.AttributeMapping CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.AttributeMapping();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "flowBehavior", n => { FlowBehavior = n.GetEnumValue<ApiSdk.Models.AttributeFlowBehavior>(); } },
                { "flowType", n => { FlowType = n.GetEnumValue<ApiSdk.Models.AttributeFlowType>(); } },
                { "matchingPriority", n => { MatchingPriority = n.GetIntValue(); } },
                { "@odata.type", n => { OdataType = n.GetStringValue(); } },
                { "source", n => { Source = n.GetObjectValue<ApiSdk.Models.AttributeMappingSource>(ApiSdk.Models.AttributeMappingSource.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<ApiSdk.Models.AttributeFlowBehavior>("flowBehavior", FlowBehavior);
            writer.WriteEnumValue<ApiSdk.Models.AttributeFlowType>("flowType", FlowType);
            writer.WriteIntValue("matchingPriority", MatchingPriority);
            writer.WriteStringValue("@odata.type", OdataType);
            writer.WriteObjectValue<ApiSdk.Models.AttributeMappingSource>("source", Source);
