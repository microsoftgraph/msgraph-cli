...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Models.ItemBody"/> and sets the default values.
        /// </summary>
        public ItemBody()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.ItemBody"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static ApiSdk.Models.ItemBody CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.ItemBody();
        }
        /// <summary>
