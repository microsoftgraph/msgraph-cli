...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Models.SectionLinks"/> and sets the default values.
        /// </summary>
        public SectionLinks()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.SectionLinks"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static ApiSdk.Models.SectionLinks CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.SectionLinks();
        }
        /// <summary>
