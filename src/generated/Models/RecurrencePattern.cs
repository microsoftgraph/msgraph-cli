...
#nullable restore
        ...
        public ApiSdk.Models.DayOfWeekObject? FirstDayOfWeek { get; set; }
        ...
        public ApiSdk.Models.WeekIndex? Index { get; set; }
...
#nullable restore
        ...
        public ApiSdk.Models.RecurrencePatternType? Type { get; set; }
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Models.RecurrencePattern"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.RecurrencePattern"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static ApiSdk.Models.RecurrencePattern CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.RecurrencePattern();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "firstDayOfWeek", n => { FirstDayOfWeek = n.GetEnumValue<ApiSdk.Models.DayOfWeekObject>(); } },
                { "index", n => { Index = n.GetEnumValue<ApiSdk.Models.WeekIndex>(); } },
                { "interval", n => { Interval = n.GetIntValue(); } },
                { "month", n => { Month = n.GetIntValue(); } },
                { "@odata.type", n => { OdataType = n.GetStringValue(); } },
                { "type", n => { Type = n.GetEnumValue<ApiSdk.Models.RecurrencePatternType>(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<ApiSdk.Models.DayOfWeekObject>("firstDayOfWeek", FirstDayOfWeek);
            writer.WriteEnumValue<ApiSdk.Models.WeekIndex>("index", Index);
            writer.WriteIntValue("interval", Interval);
            writer.WriteIntValue("month", Month);
            writer.WriteStringValue("@odata.type", OdataType);
            writer.WriteEnumValue<ApiSdk.Models.RecurrencePatternType>("type", Type);
