...
#nullable enable
        public ApiSdk.Models.ImageInfo? Attribution { get; set; }
#nullable restore
#else
        public ApiSdk.Models.ImageInfo Attribution { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public ApiSdk.Models.Json? Content { get; set; }
#nullable restore
#else
        public ApiSdk.Models.Json Content { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Models.VisualInfo"/> and sets the default values.
        /// </summary>
        public VisualInfo()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.VisualInfo"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static ApiSdk.Models.VisualInfo CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.VisualInfo();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "attribution", n => { Attribution = n.GetObjectValue<ApiSdk.Models.ImageInfo>(ApiSdk.Models.ImageInfo.CreateFromDiscriminatorValue); } },
                { "backgroundColor", n => { BackgroundColor = n.GetStringValue(); } },
                { "content", n => { Content = n.GetObjectValue<ApiSdk.Models.Json>(ApiSdk.Models.Json.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<ApiSdk.Models.ImageInfo>("attribution", Attribution);
            writer.WriteStringValue("backgroundColor", BackgroundColor);
            writer.WriteObjectValue<ApiSdk.Models.Json>("content", Content);
