...
namespace ApiSdk.Models {
    public class PhoneAuthenticationMethodCollectionResponse : IAdditionalDataHolder, IParsable {
        ...
        /// </summary>
        public static PhoneAuthenticationMethodCollectionResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
