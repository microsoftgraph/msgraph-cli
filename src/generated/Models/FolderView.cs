...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Models.FolderView"/> and sets the default values.
        /// </summary>
        public FolderView()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.FolderView"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static ApiSdk.Models.FolderView CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.FolderView();
        }
        /// <summary>
