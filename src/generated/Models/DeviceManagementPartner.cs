...
namespace ApiSdk.Models
{
    ...
    public partial class DeviceManagementPartner : global::ApiSdk.Models.Entity, IParsable
    {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::ApiSdk.Models.DeviceManagementPartnerAssignment>? GroupsRequiringPartnerEnrollment { get; set; }
#nullable restore
#else
        public List<global::ApiSdk.Models.DeviceManagementPartnerAssignment> GroupsRequiringPartnerEnrollment { get; set; }
#endif
        ...
        public global::ApiSdk.Models.DeviceManagementPartnerAppType? PartnerAppType { get; set; }
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::ApiSdk.Models.DeviceManagementPartner"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::ApiSdk.Models.DeviceManagementPartner CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::ApiSdk.Models.DeviceManagementPartner();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "groupsRequiringPartnerEnrollment", n => { GroupsRequiringPartnerEnrollment = n.GetCollectionOfObjectValues<global::ApiSdk.Models.DeviceManagementPartnerAssignment>(global::ApiSdk.Models.DeviceManagementPartnerAssignment.CreateFromDiscriminatorValue)?.AsList(); } },
                { "isConfigured", n => { IsConfigured = n.GetBoolValue(); } },
                { "lastHeartbeatDateTime", n => { LastHeartbeatDateTime = n.GetDateTimeOffsetValue(); } },
                { "partnerAppType", n => { PartnerAppType = n.GetEnumValue<global::ApiSdk.Models.DeviceManagementPartnerAppType>(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::ApiSdk.Models.DeviceManagementPartnerAssignment>("groupsRequiringPartnerEnrollment", GroupsRequiringPartnerEnrollment);
            ...
            writer.WriteEnumValue<global::ApiSdk.Models.DeviceManagementPartnerAppType>("partnerAppType", PartnerAppType);
