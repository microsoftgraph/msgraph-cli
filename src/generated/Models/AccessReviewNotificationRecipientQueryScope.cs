...
namespace ApiSdk.Models
{
    ...
    public class AccessReviewNotificationRecipientQueryScope : ApiSdk.Models.AccessReviewNotificationRecipientScope, IParsable
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Models.AccessReviewNotificationRecipientQueryScope"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.AccessReviewNotificationRecipientQueryScope"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new ApiSdk.Models.AccessReviewNotificationRecipientQueryScope CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.AccessReviewNotificationRecipientQueryScope();
        }
        /// <summary>
