...
namespace ApiSdk.Models
{
    ...
    /// </summary>
    public class WindowsInformationProtectionDesktopApp : ApiSdk.Models.WindowsInformationProtectionApp, IParsable
    {
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Models.WindowsInformationProtectionDesktopApp"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.WindowsInformationProtectionDesktopApp"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new ApiSdk.Models.WindowsInformationProtectionDesktopApp CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.WindowsInformationProtectionDesktopApp();
        }
        /// <summary>
