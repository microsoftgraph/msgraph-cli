...
namespace ApiSdk.Models
{
    ...
    public partial class BrowserSharedCookie : global::ApiSdk.Models.Entity, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::ApiSdk.Models.BrowserSharedCookieHistory>? History { get; set; }
#nullable restore
#else
        public List<global::ApiSdk.Models.BrowserSharedCookieHistory> History { get; set; }
#endif
...
#nullable restore
        ...
        public global::ApiSdk.Models.BrowserSharedCookieStatus? Status { get; set; }
        /// <summary>
        /// Creates a new instance of the appropriate class based on discriminator value
        /// </summary>
        /// <returns>A <see cref="global::ApiSdk.Models.BrowserSharedCookie"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::ApiSdk.Models.BrowserSharedCookie CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::ApiSdk.Models.BrowserSharedCookie();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "history", n => { History = n.GetCollectionOfObjectValues<global::ApiSdk.Models.BrowserSharedCookieHistory>(global::ApiSdk.Models.BrowserSharedCookieHistory.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "status", n => { Status = n.GetEnumValue<global::ApiSdk.Models.BrowserSharedCookieStatus>(); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::ApiSdk.Models.BrowserSharedCookieHistory>("history", History);
            ...
            writer.WriteEnumValue<global::ApiSdk.Models.BrowserSharedCookieStatus>("status", Status);
        }
    }
}
