...
#nullable enable
        public global::ApiSdk.Models.SynchronizationError? Error { get; set; }
#nullable restore
#else
        public global::ApiSdk.Models.SynchronizationError Error { get; set; }
#endif
...
#nullable restore
        ...
        public global::ApiSdk.Models.QuarantineReason? Reason { get; set; }
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Models.SynchronizationQuarantine"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::ApiSdk.Models.SynchronizationQuarantine"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::ApiSdk.Models.SynchronizationQuarantine CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::ApiSdk.Models.SynchronizationQuarantine();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "error", n => { Error = n.GetObjectValue<global::ApiSdk.Models.SynchronizationError>(global::ApiSdk.Models.SynchronizationError.CreateFromDiscriminatorValue); } },
                { "nextAttempt", n => { NextAttempt = n.GetDateTimeOffsetValue(); } },
                { "@odata.type", n => { OdataType = n.GetStringValue(); } },
                { "reason", n => { Reason = n.GetEnumValue<global::ApiSdk.Models.QuarantineReason>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::ApiSdk.Models.SynchronizationError>("error", Error);
            writer.WriteDateTimeOffsetValue("nextAttempt", NextAttempt);
            writer.WriteStringValue("@odata.type", OdataType);
            writer.WriteEnumValue<global::ApiSdk.Models.QuarantineReason>("reason", Reason);
