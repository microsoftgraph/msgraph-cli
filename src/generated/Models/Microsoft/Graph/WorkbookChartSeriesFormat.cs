...
namespace ApiSdk.Models.Microsoft.Graph {
    public class WorkbookChartSeriesFormat : Entity, IParsable {
        ...
        /// </summary>
        public static new ApiSdk.Models.Microsoft.Graph.WorkbookChartSeriesFormat CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                {"fill", (o,n) => { (o as WorkbookChartSeriesFormat).Fill = n.GetObjectValue<ApiSdk.Models.Microsoft.Graph.WorkbookChartFill>(ApiSdk.Models.Microsoft.Graph.WorkbookChartFill.CreateFromDiscriminatorValue); } },
                {"line", (o,n) => { (o as WorkbookChartSeriesFormat).Line = n.GetObjectValue<ApiSdk.Models.Microsoft.Graph.WorkbookChartLineFormat>(ApiSdk.Models.Microsoft.Graph.WorkbookChartLineFormat.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
