...
namespace ApiSdk.Models.Microsoft.Graph {
    public class UserActivity : Entity, IParsable {
        ...
        public ApiSdk.Models.Microsoft.Graph.Json ContentInfo { get; set; }
        ...
        public List<ApiSdk.Models.Microsoft.Graph.ActivityHistoryItem> HistoryItems { get; set; }
        ...
        public ApiSdk.Models.Microsoft.Graph.VisualInfo VisualElements { get; set; }
        /// <summary>
        /// Creates a new instance of the appropriate class based on discriminator value
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        /// </summary>
        public static new ApiSdk.Models.Microsoft.Graph.UserActivity CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"contentInfo", (o,n) => { (o as UserActivity).ContentInfo = n.GetObjectValue<ApiSdk.Models.Microsoft.Graph.Json>(ApiSdk.Models.Microsoft.Graph.Json.CreateFromDiscriminatorValue); } },
                ...
                {"historyItems", (o,n) => { (o as UserActivity).HistoryItems = n.GetCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.ActivityHistoryItem>(ApiSdk.Models.Microsoft.Graph.ActivityHistoryItem.CreateFromDiscriminatorValue).ToList(); } },
                ...
                {"visualElements", (o,n) => { (o as UserActivity).VisualElements = n.GetObjectValue<ApiSdk.Models.Microsoft.Graph.VisualInfo>(ApiSdk.Models.Microsoft.Graph.VisualInfo.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<ApiSdk.Models.Microsoft.Graph.Json>("contentInfo", ContentInfo);
            writer.WriteStringValue("contentUrl", ContentUrl);
            writer.WriteDateTimeOffsetValue("createdDateTime", CreatedDateTime);
            writer.WriteDateTimeOffsetValue("expirationDateTime", ExpirationDateTime);
            writer.WriteStringValue("fallbackUrl", FallbackUrl);
            writer.WriteCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.ActivityHistoryItem>("historyItems", HistoryItems);
            writer.WriteDateTimeOffsetValue("lastModifiedDateTime", LastModifiedDateTime);
            writer.WriteEnumValue<Status>("status", Status);
            writer.WriteStringValue("userTimezone", UserTimezone);
            writer.WriteObjectValue<ApiSdk.Models.Microsoft.Graph.VisualInfo>("visualElements", VisualElements);
        }
    }
}
