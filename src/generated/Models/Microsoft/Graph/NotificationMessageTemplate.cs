...
namespace ApiSdk.Models.Microsoft.Graph {
    public class NotificationMessageTemplate : Entity, IParsable {
        ...
        public List<ApiSdk.Models.Microsoft.Graph.LocalizedNotificationMessage> LocalizedNotificationMessages { get; set; }
        /// <summary>
        /// Creates a new instance of the appropriate class based on discriminator value
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        /// </summary>
        public static new ApiSdk.Models.Microsoft.Graph.NotificationMessageTemplate CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"localizedNotificationMessages", (o,n) => { (o as NotificationMessageTemplate).LocalizedNotificationMessages = n.GetCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.LocalizedNotificationMessage>(ApiSdk.Models.Microsoft.Graph.LocalizedNotificationMessage.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.LocalizedNotificationMessage>("localizedNotificationMessages", LocalizedNotificationMessages);
        }
    }
}
