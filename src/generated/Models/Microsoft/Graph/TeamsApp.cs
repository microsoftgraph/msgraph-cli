...
namespace ApiSdk.Models.Microsoft.Graph {
    public class TeamsApp : Entity, IParsable {
        ...
        /// </summary>
        public static new ApiSdk.Models.Microsoft.Graph.TeamsApp CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                {"appDefinitions", (o,n) => { (o as TeamsApp).AppDefinitions = n.GetCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.TeamsAppDefinition>(ApiSdk.Models.Microsoft.Graph.TeamsAppDefinition.CreateFromDiscriminatorValue).ToList(); } },
