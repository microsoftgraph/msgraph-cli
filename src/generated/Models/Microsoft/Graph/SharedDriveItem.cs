...
namespace ApiSdk.Models.Microsoft.Graph {
    public class SharedDriveItem : BaseItem, IParsable {
        ...
        /// </summary>
        public static new ApiSdk.Models.Microsoft.Graph.SharedDriveItem CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"owner", (o,n) => { (o as SharedDriveItem).Owner = n.GetObjectValue<ApiSdk.Models.Microsoft.Graph.IdentitySet>(ApiSdk.Models.Microsoft.Graph.IdentitySet.CreateFromDiscriminatorValue); } },
