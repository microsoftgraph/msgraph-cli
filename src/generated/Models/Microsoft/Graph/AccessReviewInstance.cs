...
namespace ApiSdk.Models.Microsoft.Graph {
    public class AccessReviewInstance : Entity, IParsable {
        ...
        public List<ApiSdk.Models.Microsoft.Graph.AccessReviewReviewer> ContactedReviewers { get; set; }
        ...
        public List<ApiSdk.Models.Microsoft.Graph.AccessReviewInstanceDecisionItem> Decisions { get; set; }
        ...
        public List<ApiSdk.Models.Microsoft.Graph.AccessReviewReviewerScope> FallbackReviewers { get; set; }
        ...
        public ApiSdk.Models.Microsoft.Graph.AccessReviewScope Scope { get; set; }
        ...
        /// </summary>
        public static new ApiSdk.Models.Microsoft.Graph.AccessReviewInstance CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                {"contactedReviewers", (o,n) => { (o as AccessReviewInstance).ContactedReviewers = n.GetCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.AccessReviewReviewer>(ApiSdk.Models.Microsoft.Graph.AccessReviewReviewer.CreateFromDiscriminatorValue).ToList(); } },
                {"decisions", (o,n) => { (o as AccessReviewInstance).Decisions = n.GetCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.AccessReviewInstanceDecisionItem>(ApiSdk.Models.Microsoft.Graph.AccessReviewInstanceDecisionItem.CreateFromDiscriminatorValue).ToList(); } },
                {"endDateTime", (o,n) => { (o as AccessReviewInstance).EndDateTime = n.GetDateTimeOffsetValue(); } },
                {"fallbackReviewers", (o,n) => { (o as AccessReviewInstance).FallbackReviewers = n.GetCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.AccessReviewReviewerScope>(ApiSdk.Models.Microsoft.Graph.AccessReviewReviewerScope.CreateFromDiscriminatorValue).ToList(); } },
                {"reviewers", (o,n) => { (o as AccessReviewInstance).Reviewers = n.GetCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.AccessReviewReviewerScope>(ApiSdk.Models.Microsoft.Graph.AccessReviewReviewerScope.CreateFromDiscriminatorValue).ToList(); } },
                {"scope", (o,n) => { (o as AccessReviewInstance).Scope = n.GetObjectValue<ApiSdk.Models.Microsoft.Graph.AccessReviewScope>(ApiSdk.Models.Microsoft.Graph.AccessReviewScope.CreateFromDiscriminatorValue); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.AccessReviewReviewer>("contactedReviewers", ContactedReviewers);
            writer.WriteCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.AccessReviewInstanceDecisionItem>("decisions", Decisions);
            writer.WriteDateTimeOffsetValue("endDateTime", EndDateTime);
            writer.WriteCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.AccessReviewReviewerScope>("fallbackReviewers", FallbackReviewers);
            writer.WriteCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.AccessReviewReviewerScope>("reviewers", Reviewers);
            writer.WriteObjectValue<ApiSdk.Models.Microsoft.Graph.AccessReviewScope>("scope", Scope);
