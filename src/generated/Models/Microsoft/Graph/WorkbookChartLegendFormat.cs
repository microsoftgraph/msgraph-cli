...
namespace ApiSdk.Models.Microsoft.Graph {
    public class WorkbookChartLegendFormat : Entity, IParsable {
        ...
        /// </summary>
        public static new ApiSdk.Models.Microsoft.Graph.WorkbookChartLegendFormat CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                {"fill", (o,n) => { (o as WorkbookChartLegendFormat).Fill = n.GetObjectValue<ApiSdk.Models.Microsoft.Graph.WorkbookChartFill>(ApiSdk.Models.Microsoft.Graph.WorkbookChartFill.CreateFromDiscriminatorValue); } },
                {"font", (o,n) => { (o as WorkbookChartLegendFormat).Font = n.GetObjectValue<ApiSdk.Models.Microsoft.Graph.WorkbookChartFont>(ApiSdk.Models.Microsoft.Graph.WorkbookChartFont.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
