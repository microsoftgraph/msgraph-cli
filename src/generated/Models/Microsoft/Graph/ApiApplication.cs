...
namespace ApiSdk.Models.Microsoft.Graph {
    public class ApiApplication : IAdditionalDataHolder, IParsable {
        ...
        public List<ApiSdk.Models.Microsoft.Graph.PreAuthorizedApplication> PreAuthorizedApplications { get; set; }
        ...
        /// </summary>
        public static ApiSdk.Models.Microsoft.Graph.ApiApplication CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"oauth2PermissionScopes", (o,n) => { (o as ApiApplication).Oauth2PermissionScopes = n.GetCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.PermissionScope>(ApiSdk.Models.Microsoft.Graph.PermissionScope.CreateFromDiscriminatorValue).ToList(); } },
                {"preAuthorizedApplications", (o,n) => { (o as ApiApplication).PreAuthorizedApplications = n.GetCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.PreAuthorizedApplication>(ApiSdk.Models.Microsoft.Graph.PreAuthorizedApplication.CreateFromDiscriminatorValue).ToList(); } },
        ...
        public void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.PreAuthorizedApplication>("preAuthorizedApplications", PreAuthorizedApplications);
