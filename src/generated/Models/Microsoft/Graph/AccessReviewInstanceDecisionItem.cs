...
namespace ApiSdk.Models.Microsoft.Graph {
    public class AccessReviewInstanceDecisionItem : Entity, IParsable {
        ...
        public ApiSdk.Models.Microsoft.Graph.UserIdentity AppliedBy { get; set; }
        ...
        public ApiSdk.Models.Microsoft.Graph.AccessReviewInstanceDecisionItemResource Resource { get; set; }
        ...
        public ApiSdk.Models.Microsoft.Graph.UserIdentity ReviewedBy { get; set; }
        ...
        /// </summary>
        public static new ApiSdk.Models.Microsoft.Graph.AccessReviewInstanceDecisionItem CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"appliedBy", (o,n) => { (o as AccessReviewInstanceDecisionItem).AppliedBy = n.GetObjectValue<ApiSdk.Models.Microsoft.Graph.UserIdentity>(ApiSdk.Models.Microsoft.Graph.UserIdentity.CreateFromDiscriminatorValue); } },
                ...
                {"principal", (o,n) => { (o as AccessReviewInstanceDecisionItem).Principal = n.GetObjectValue<ApiSdk.Models.Microsoft.Graph.Identity>(ApiSdk.Models.Microsoft.Graph.Identity.CreateFromDiscriminatorValue); } },
                ...
                {"resource", (o,n) => { (o as AccessReviewInstanceDecisionItem).Resource = n.GetObjectValue<ApiSdk.Models.Microsoft.Graph.AccessReviewInstanceDecisionItemResource>(ApiSdk.Models.Microsoft.Graph.AccessReviewInstanceDecisionItemResource.CreateFromDiscriminatorValue); } },
                {"resourceLink", (o,n) => { (o as AccessReviewInstanceDecisionItem).ResourceLink = n.GetStringValue(); } },
                {"reviewedBy", (o,n) => { (o as AccessReviewInstanceDecisionItem).ReviewedBy = n.GetObjectValue<ApiSdk.Models.Microsoft.Graph.UserIdentity>(ApiSdk.Models.Microsoft.Graph.UserIdentity.CreateFromDiscriminatorValue); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<ApiSdk.Models.Microsoft.Graph.UserIdentity>("appliedBy", AppliedBy);
            ...
            writer.WriteObjectValue<ApiSdk.Models.Microsoft.Graph.AccessReviewInstanceDecisionItemResource>("resource", Resource);
            writer.WriteStringValue("resourceLink", ResourceLink);
            writer.WriteObjectValue<ApiSdk.Models.Microsoft.Graph.UserIdentity>("reviewedBy", ReviewedBy);
