...
namespace ApiSdk.Models.Microsoft.Graph {
    public class WorkbookTableColumn : Entity, IParsable {
        ...
        public ApiSdk.Models.Microsoft.Graph.WorkbookFilter Filter { get; set; }
        ...
        /// </summary>
        public static new ApiSdk.Models.Microsoft.Graph.WorkbookTableColumn CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                {"filter", (o,n) => { (o as WorkbookTableColumn).Filter = n.GetObjectValue<ApiSdk.Models.Microsoft.Graph.WorkbookFilter>(ApiSdk.Models.Microsoft.Graph.WorkbookFilter.CreateFromDiscriminatorValue); } },
                {"index", (o,n) => { (o as WorkbookTableColumn).Index = n.GetIntValue(); } },
                {"name", (o,n) => { (o as WorkbookTableColumn).Name = n.GetStringValue(); } },
                {"values", (o,n) => { (o as WorkbookTableColumn).Values = n.GetObjectValue<ApiSdk.Models.Microsoft.Graph.Json>(ApiSdk.Models.Microsoft.Graph.Json.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<ApiSdk.Models.Microsoft.Graph.WorkbookFilter>("filter", Filter);
