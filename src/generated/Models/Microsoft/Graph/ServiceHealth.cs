...
namespace ApiSdk.Models.Microsoft.Graph {
    public class ServiceHealth : Entity, IParsable {
        ...
        /// </summary>
        public static new ApiSdk.Models.Microsoft.Graph.ServiceHealth CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                {"issues", (o,n) => { (o as ServiceHealth).Issues = n.GetCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.ServiceHealthIssue>(ApiSdk.Models.Microsoft.Graph.ServiceHealthIssue.CreateFromDiscriminatorValue).ToList(); } },
