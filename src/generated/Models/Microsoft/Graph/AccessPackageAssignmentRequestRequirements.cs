...
namespace ApiSdk.Models.Microsoft.Graph {
    public class AccessPackageAssignmentRequestRequirements : IAdditionalDataHolder, IParsable {
        ...
        /// </summary>
        public static ApiSdk.Models.Microsoft.Graph.AccessPackageAssignmentRequestRequirements CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"schedule", (o,n) => { (o as AccessPackageAssignmentRequestRequirements).Schedule = n.GetObjectValue<ApiSdk.Models.Microsoft.Graph.EntitlementManagementSchedule>(ApiSdk.Models.Microsoft.Graph.EntitlementManagementSchedule.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
