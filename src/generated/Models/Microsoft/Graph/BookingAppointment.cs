...
namespace ApiSdk.Models.Microsoft.Graph {
    public class BookingAppointment : Entity, IParsable {
        ...
        public List<ApiSdk.Models.Microsoft.Graph.BookingCustomerInformationBase> Customers { get; set; }
        ...
        public ApiSdk.Models.Microsoft.Graph.DateTimeTimeZone EndDateTime { get; set; }
        ...
        public List<ApiSdk.Models.Microsoft.Graph.BookingReminder> Reminders { get; set; }
        ...
        public ApiSdk.Models.Microsoft.Graph.Location ServiceLocation { get; set; }
        ...
        /// </summary>
        public static new ApiSdk.Models.Microsoft.Graph.BookingAppointment CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"customers", (o,n) => { (o as BookingAppointment).Customers = n.GetCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.BookingCustomerInformationBase>(ApiSdk.Models.Microsoft.Graph.BookingCustomerInformationBase.CreateFromDiscriminatorValue).ToList(); } },
                ...
                {"endDateTime", (o,n) => { (o as BookingAppointment).EndDateTime = n.GetObjectValue<ApiSdk.Models.Microsoft.Graph.DateTimeTimeZone>(ApiSdk.Models.Microsoft.Graph.DateTimeTimeZone.CreateFromDiscriminatorValue); } },
                ...
                {"reminders", (o,n) => { (o as BookingAppointment).Reminders = n.GetCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.BookingReminder>(ApiSdk.Models.Microsoft.Graph.BookingReminder.CreateFromDiscriminatorValue).ToList(); } },
                ...
                {"serviceLocation", (o,n) => { (o as BookingAppointment).ServiceLocation = n.GetObjectValue<ApiSdk.Models.Microsoft.Graph.Location>(ApiSdk.Models.Microsoft.Graph.Location.CreateFromDiscriminatorValue); } },
                ...
                {"startDateTime", (o,n) => { (o as BookingAppointment).StartDateTime = n.GetObjectValue<ApiSdk.Models.Microsoft.Graph.DateTimeTimeZone>(ApiSdk.Models.Microsoft.Graph.DateTimeTimeZone.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.BookingCustomerInformationBase>("customers", Customers);
            writer.WriteStringValue("customerTimeZone", CustomerTimeZone);
            writer.WriteTimeSpanValue("duration", Duration);
            writer.WriteObjectValue<ApiSdk.Models.Microsoft.Graph.DateTimeTimeZone>("endDateTime", EndDateTime);
            ...
            writer.WriteCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.BookingReminder>("reminders", Reminders);
            writer.WriteStringValue("selfServiceAppointmentId", SelfServiceAppointmentId);
            writer.WriteStringValue("serviceId", ServiceId);
            writer.WriteObjectValue<ApiSdk.Models.Microsoft.Graph.Location>("serviceLocation", ServiceLocation);
