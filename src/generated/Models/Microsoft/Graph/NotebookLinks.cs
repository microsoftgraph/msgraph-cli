...
namespace ApiSdk.Models.Microsoft.Graph {
    public class NotebookLinks : IAdditionalDataHolder, IParsable {
        ...
        /// </summary>
        public static ApiSdk.Models.Microsoft.Graph.NotebookLinks CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"oneNoteClientUrl", (o,n) => { (o as NotebookLinks).OneNoteClientUrl = n.GetObjectValue<ApiSdk.Models.Microsoft.Graph.ExternalLink>(ApiSdk.Models.Microsoft.Graph.ExternalLink.CreateFromDiscriminatorValue); } },
                {"oneNoteWebUrl", (o,n) => { (o as NotebookLinks).OneNoteWebUrl = n.GetObjectValue<ApiSdk.Models.Microsoft.Graph.ExternalLink>(ApiSdk.Models.Microsoft.Graph.ExternalLink.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
