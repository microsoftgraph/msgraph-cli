...
namespace ApiSdk.Models.Microsoft.Graph {
    public class Conversation : Entity, IParsable {
        ...
        /// </summary>
        public static new ApiSdk.Models.Microsoft.Graph.Conversation CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"threads", (o,n) => { (o as Conversation).Threads = n.GetCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.ConversationThread>(ApiSdk.Models.Microsoft.Graph.ConversationThread.CreateFromDiscriminatorValue).ToList(); } },
