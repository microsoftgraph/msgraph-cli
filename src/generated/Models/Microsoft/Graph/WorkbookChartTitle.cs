...
namespace ApiSdk.Models.Microsoft.Graph {
    public class WorkbookChartTitle : Entity, IParsable {
        ...
        public ApiSdk.Models.Microsoft.Graph.WorkbookChartTitleFormat Format { get; set; }
        ...
        /// </summary>
        public static new ApiSdk.Models.Microsoft.Graph.WorkbookChartTitle CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                {"format", (o,n) => { (o as WorkbookChartTitle).Format = n.GetObjectValue<ApiSdk.Models.Microsoft.Graph.WorkbookChartTitleFormat>(ApiSdk.Models.Microsoft.Graph.WorkbookChartTitleFormat.CreateFromDiscriminatorValue); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<ApiSdk.Models.Microsoft.Graph.WorkbookChartTitleFormat>("format", Format);
