...
namespace ApiSdk.Models.Microsoft.Graph {
    public class AccessReviewScheduleDefinition : Entity, IParsable {
        ...
        public List<ApiSdk.Models.Microsoft.Graph.AccessReviewNotificationRecipientItem> AdditionalNotificationRecipients { get; set; }
        ...
        public ApiSdk.Models.Microsoft.Graph.AccessReviewScope InstanceEnumerationScope { get; set; }
        ...
        public List<ApiSdk.Models.Microsoft.Graph.AccessReviewInstance> Instances { get; set; }
        ...
        public ApiSdk.Models.Microsoft.Graph.AccessReviewScheduleSettings Settings { get; set; }
        ...
        /// </summary>
        public static new ApiSdk.Models.Microsoft.Graph.AccessReviewScheduleDefinition CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                {"additionalNotificationRecipients", (o,n) => { (o as AccessReviewScheduleDefinition).AdditionalNotificationRecipients = n.GetCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.AccessReviewNotificationRecipientItem>(ApiSdk.Models.Microsoft.Graph.AccessReviewNotificationRecipientItem.CreateFromDiscriminatorValue).ToList(); } },
                {"createdBy", (o,n) => { (o as AccessReviewScheduleDefinition).CreatedBy = n.GetObjectValue<ApiSdk.Models.Microsoft.Graph.UserIdentity>(ApiSdk.Models.Microsoft.Graph.UserIdentity.CreateFromDiscriminatorValue); } },
                ...
                {"fallbackReviewers", (o,n) => { (o as AccessReviewScheduleDefinition).FallbackReviewers = n.GetCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.AccessReviewReviewerScope>(ApiSdk.Models.Microsoft.Graph.AccessReviewReviewerScope.CreateFromDiscriminatorValue).ToList(); } },
                {"instanceEnumerationScope", (o,n) => { (o as AccessReviewScheduleDefinition).InstanceEnumerationScope = n.GetObjectValue<ApiSdk.Models.Microsoft.Graph.AccessReviewScope>(ApiSdk.Models.Microsoft.Graph.AccessReviewScope.CreateFromDiscriminatorValue); } },
                {"instances", (o,n) => { (o as AccessReviewScheduleDefinition).Instances = n.GetCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.AccessReviewInstance>(ApiSdk.Models.Microsoft.Graph.AccessReviewInstance.CreateFromDiscriminatorValue).ToList(); } },
                {"lastModifiedDateTime", (o,n) => { (o as AccessReviewScheduleDefinition).LastModifiedDateTime = n.GetDateTimeOffsetValue(); } },
                {"reviewers", (o,n) => { (o as AccessReviewScheduleDefinition).Reviewers = n.GetCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.AccessReviewReviewerScope>(ApiSdk.Models.Microsoft.Graph.AccessReviewReviewerScope.CreateFromDiscriminatorValue).ToList(); } },
                {"scope", (o,n) => { (o as AccessReviewScheduleDefinition).Scope = n.GetObjectValue<ApiSdk.Models.Microsoft.Graph.AccessReviewScope>(ApiSdk.Models.Microsoft.Graph.AccessReviewScope.CreateFromDiscriminatorValue); } },
                {"settings", (o,n) => { (o as AccessReviewScheduleDefinition).Settings = n.GetObjectValue<ApiSdk.Models.Microsoft.Graph.AccessReviewScheduleSettings>(ApiSdk.Models.Microsoft.Graph.AccessReviewScheduleSettings.CreateFromDiscriminatorValue); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.AccessReviewNotificationRecipientItem>("additionalNotificationRecipients", AdditionalNotificationRecipients);
            ...
            writer.WriteObjectValue<ApiSdk.Models.Microsoft.Graph.AccessReviewScope>("instanceEnumerationScope", InstanceEnumerationScope);
            writer.WriteCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.AccessReviewInstance>("instances", Instances);
            ...
            writer.WriteObjectValue<ApiSdk.Models.Microsoft.Graph.AccessReviewScheduleSettings>("settings", Settings);
