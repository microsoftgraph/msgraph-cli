...
namespace ApiSdk.Models.Microsoft.Graph {
    public class Alert : Entity, IParsable {
        ...
        public List<ApiSdk.Models.Microsoft.Graph.AlertDetection> AlertDetections { get; set; }
        ...
        public List<ApiSdk.Models.Microsoft.Graph.CloudAppSecurityState> CloudAppStates { get; set; }
        ...
        public List<ApiSdk.Models.Microsoft.Graph.FileSecurityState> FileStates { get; set; }
        /// <summary>A collection of alertHistoryStates comprising an audit log of all updates made to an alert.</summary>
        public List<ApiSdk.Models.Microsoft.Graph.AlertHistoryState> HistoryStates { get; set; }
        /// <summary>Security-related stateful information generated by the provider about the host(s) related to this alert.</summary>
        public List<ApiSdk.Models.Microsoft.Graph.HostSecurityState> HostStates { get; set; }
        /// <summary>IDs of incidents related to current alert.</summary>
        public List<string> IncidentIds { get; set; }
        public List<ApiSdk.Models.Microsoft.Graph.InvestigationSecurityState> InvestigationSecurityStates { get; set; }
        ...
        public List<ApiSdk.Models.Microsoft.Graph.MalwareState> MalwareStates { get; set; }
        public List<ApiSdk.Models.Microsoft.Graph.MessageSecurityState> MessageSecurityStates { get; set; }
        ...
        public List<ApiSdk.Models.Microsoft.Graph.NetworkConnection> NetworkConnections { get; set; }
        ...
        public List<ApiSdk.Models.Microsoft.Graph.Process> Processes { get; set; }
        ...
        public List<ApiSdk.Models.Microsoft.Graph.RegistryKeyState> RegistryKeyStates { get; set; }
        /// <summary>Resources related to current alert. For example, for some alerts this can have the Azure Resource value.</summary>
        public List<ApiSdk.Models.Microsoft.Graph.SecurityResource> SecurityResources { get; set; }
        ...
        public List<ApiSdk.Models.Microsoft.Graph.AlertTrigger> Triggers { get; set; }
        public List<ApiSdk.Models.Microsoft.Graph.UriClickSecurityState> UriClickSecurityStates { get; set; }
        ...
        public List<ApiSdk.Models.Microsoft.Graph.UserSecurityState> UserStates { get; set; }
        ...
        public List<ApiSdk.Models.Microsoft.Graph.VulnerabilityState> VulnerabilityStates { get; set; }
        /// <summary>
        /// Creates a new instance of the appropriate class based on discriminator value
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        /// </summary>
        public static new ApiSdk.Models.Microsoft.Graph.Alert CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"alertDetections", (o,n) => { (o as Alert).AlertDetections = n.GetCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.AlertDetection>(ApiSdk.Models.Microsoft.Graph.AlertDetection.CreateFromDiscriminatorValue).ToList(); } },
                ...
                {"cloudAppStates", (o,n) => { (o as Alert).CloudAppStates = n.GetCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.CloudAppSecurityState>(ApiSdk.Models.Microsoft.Graph.CloudAppSecurityState.CreateFromDiscriminatorValue).ToList(); } },
                ...
                {"fileStates", (o,n) => { (o as Alert).FileStates = n.GetCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.FileSecurityState>(ApiSdk.Models.Microsoft.Graph.FileSecurityState.CreateFromDiscriminatorValue).ToList(); } },
                {"historyStates", (o,n) => { (o as Alert).HistoryStates = n.GetCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.AlertHistoryState>(ApiSdk.Models.Microsoft.Graph.AlertHistoryState.CreateFromDiscriminatorValue).ToList(); } },
                {"hostStates", (o,n) => { (o as Alert).HostStates = n.GetCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.HostSecurityState>(ApiSdk.Models.Microsoft.Graph.HostSecurityState.CreateFromDiscriminatorValue).ToList(); } },
                {"incidentIds", (o,n) => { (o as Alert).IncidentIds = n.GetCollectionOfPrimitiveValues<string>().ToList(); } },
                {"investigationSecurityStates", (o,n) => { (o as Alert).InvestigationSecurityStates = n.GetCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.InvestigationSecurityState>(ApiSdk.Models.Microsoft.Graph.InvestigationSecurityState.CreateFromDiscriminatorValue).ToList(); } },
                ...
                {"malwareStates", (o,n) => { (o as Alert).MalwareStates = n.GetCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.MalwareState>(ApiSdk.Models.Microsoft.Graph.MalwareState.CreateFromDiscriminatorValue).ToList(); } },
                {"messageSecurityStates", (o,n) => { (o as Alert).MessageSecurityStates = n.GetCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.MessageSecurityState>(ApiSdk.Models.Microsoft.Graph.MessageSecurityState.CreateFromDiscriminatorValue).ToList(); } },
                {"networkConnections", (o,n) => { (o as Alert).NetworkConnections = n.GetCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.NetworkConnection>(ApiSdk.Models.Microsoft.Graph.NetworkConnection.CreateFromDiscriminatorValue).ToList(); } },
                {"processes", (o,n) => { (o as Alert).Processes = n.GetCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.Process>(ApiSdk.Models.Microsoft.Graph.Process.CreateFromDiscriminatorValue).ToList(); } },
                {"recommendedActions", (o,n) => { (o as Alert).RecommendedActions = n.GetCollectionOfPrimitiveValues<string>().ToList(); } },
                {"registryKeyStates", (o,n) => { (o as Alert).RegistryKeyStates = n.GetCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.RegistryKeyState>(ApiSdk.Models.Microsoft.Graph.RegistryKeyState.CreateFromDiscriminatorValue).ToList(); } },
                {"securityResources", (o,n) => { (o as Alert).SecurityResources = n.GetCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.SecurityResource>(ApiSdk.Models.Microsoft.Graph.SecurityResource.CreateFromDiscriminatorValue).ToList(); } },
                ...
                {"triggers", (o,n) => { (o as Alert).Triggers = n.GetCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.AlertTrigger>(ApiSdk.Models.Microsoft.Graph.AlertTrigger.CreateFromDiscriminatorValue).ToList(); } },
                {"uriClickSecurityStates", (o,n) => { (o as Alert).UriClickSecurityStates = n.GetCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.UriClickSecurityState>(ApiSdk.Models.Microsoft.Graph.UriClickSecurityState.CreateFromDiscriminatorValue).ToList(); } },
                {"userStates", (o,n) => { (o as Alert).UserStates = n.GetCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.UserSecurityState>(ApiSdk.Models.Microsoft.Graph.UserSecurityState.CreateFromDiscriminatorValue).ToList(); } },
                {"vendorInformation", (o,n) => { (o as Alert).VendorInformation = n.GetObjectValue<ApiSdk.Models.Microsoft.Graph.SecurityVendorInformation>(ApiSdk.Models.Microsoft.Graph.SecurityVendorInformation.CreateFromDiscriminatorValue); } },
                {"vulnerabilityStates", (o,n) => { (o as Alert).VulnerabilityStates = n.GetCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.VulnerabilityState>(ApiSdk.Models.Microsoft.Graph.VulnerabilityState.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.AlertDetection>("alertDetections", AlertDetections);
            ...
            writer.WriteCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.CloudAppSecurityState>("cloudAppStates", CloudAppStates);
            ...
            writer.WriteCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.FileSecurityState>("fileStates", FileStates);
            writer.WriteCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.AlertHistoryState>("historyStates", HistoryStates);
            writer.WriteCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.HostSecurityState>("hostStates", HostStates);
            writer.WriteCollectionOfPrimitiveValues<string>("incidentIds", IncidentIds);
            writer.WriteCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.InvestigationSecurityState>("investigationSecurityStates", InvestigationSecurityStates);
            writer.WriteDateTimeOffsetValue("lastEventDateTime", LastEventDateTime);
            writer.WriteDateTimeOffsetValue("lastModifiedDateTime", LastModifiedDateTime);
            writer.WriteCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.MalwareState>("malwareStates", MalwareStates);
            writer.WriteCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.MessageSecurityState>("messageSecurityStates", MessageSecurityStates);
            writer.WriteCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.NetworkConnection>("networkConnections", NetworkConnections);
            writer.WriteCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.Process>("processes", Processes);
            writer.WriteCollectionOfPrimitiveValues<string>("recommendedActions", RecommendedActions);
            writer.WriteCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.RegistryKeyState>("registryKeyStates", RegistryKeyStates);
            writer.WriteCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.SecurityResource>("securityResources", SecurityResources);
            ...
            writer.WriteCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.AlertTrigger>("triggers", Triggers);
            writer.WriteCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.UriClickSecurityState>("uriClickSecurityStates", UriClickSecurityStates);
            writer.WriteCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.UserSecurityState>("userStates", UserStates);
            writer.WriteObjectValue<ApiSdk.Models.Microsoft.Graph.SecurityVendorInformation>("vendorInformation", VendorInformation);
            writer.WriteCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.VulnerabilityState>("vulnerabilityStates", VulnerabilityStates);
        }
    }
}
