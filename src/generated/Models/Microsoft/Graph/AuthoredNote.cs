...
namespace ApiSdk.Models.Microsoft.Graph {
    public class AuthoredNote : Entity, IParsable {
        ...
        public ApiSdk.Models.Microsoft.Graph.ItemBody Content { get; set; }
        ...
        /// </summary>
        public static new ApiSdk.Models.Microsoft.Graph.AuthoredNote CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                {"author", (o,n) => { (o as AuthoredNote).Author = n.GetObjectValue<ApiSdk.Models.Microsoft.Graph.Identity>(ApiSdk.Models.Microsoft.Graph.Identity.CreateFromDiscriminatorValue); } },
                {"content", (o,n) => { (o as AuthoredNote).Content = n.GetObjectValue<ApiSdk.Models.Microsoft.Graph.ItemBody>(ApiSdk.Models.Microsoft.Graph.ItemBody.CreateFromDiscriminatorValue); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<ApiSdk.Models.Microsoft.Graph.ItemBody>("content", Content);
