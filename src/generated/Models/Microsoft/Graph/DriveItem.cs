...
namespace ApiSdk.Models.Microsoft.Graph {
    public class DriveItem : BaseItem, IParsable {
        ...
        public ApiSdk.Models.Microsoft.Graph.GeoCoordinates Location { get; set; }
        ...
        public List<ApiSdk.Models.Microsoft.Graph.ThumbnailSet> Thumbnails { get; set; }
        /// <summary>The list of previous versions of the item. For more info, see [getting previous versions][]. Read-only. Nullable.</summary>
        public List<ApiSdk.Models.Microsoft.Graph.DriveItemVersion> Versions { get; set; }
        ...
        /// </summary>
        public static new ApiSdk.Models.Microsoft.Graph.DriveItem CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                {"analytics", (o,n) => { (o as DriveItem).Analytics = n.GetObjectValue<ApiSdk.Models.Microsoft.Graph.ItemAnalytics>(ApiSdk.Models.Microsoft.Graph.ItemAnalytics.CreateFromDiscriminatorValue); } },
                ...
                {"children", (o,n) => { (o as DriveItem).Children = n.GetCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.DriveItem>(ApiSdk.Models.Microsoft.Graph.DriveItem.CreateFromDiscriminatorValue).ToList(); } },
                ...
                {"location", (o,n) => { (o as DriveItem).Location = n.GetObjectValue<ApiSdk.Models.Microsoft.Graph.GeoCoordinates>(ApiSdk.Models.Microsoft.Graph.GeoCoordinates.CreateFromDiscriminatorValue); } },
                ...
                {"permissions", (o,n) => { (o as DriveItem).Permissions = n.GetCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.Permission>(ApiSdk.Models.Microsoft.Graph.Permission.CreateFromDiscriminatorValue).ToList(); } },
                ...
                {"publication", (o,n) => { (o as DriveItem).Publication = n.GetObjectValue<ApiSdk.Models.Microsoft.Graph.PublicationFacet>(ApiSdk.Models.Microsoft.Graph.PublicationFacet.CreateFromDiscriminatorValue); } },
                ...
                {"subscriptions", (o,n) => { (o as DriveItem).Subscriptions = n.GetCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.Subscription>(ApiSdk.Models.Microsoft.Graph.Subscription.CreateFromDiscriminatorValue).ToList(); } },
                {"thumbnails", (o,n) => { (o as DriveItem).Thumbnails = n.GetCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.ThumbnailSet>(ApiSdk.Models.Microsoft.Graph.ThumbnailSet.CreateFromDiscriminatorValue).ToList(); } },
                {"versions", (o,n) => { (o as DriveItem).Versions = n.GetCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.DriveItemVersion>(ApiSdk.Models.Microsoft.Graph.DriveItemVersion.CreateFromDiscriminatorValue).ToList(); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<ApiSdk.Models.Microsoft.Graph.GeoCoordinates>("location", Location);
            ...
            writer.WriteCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.ThumbnailSet>("thumbnails", Thumbnails);
            writer.WriteCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.DriveItemVersion>("versions", Versions);
