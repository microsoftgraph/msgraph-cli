...
namespace ApiSdk.Models.Microsoft.Graph {
    public class OnenoteEntityHierarchyModel : OnenoteEntitySchemaObjectModel, IParsable {
        ...
        /// </summary>
        public static new ApiSdk.Models.Microsoft.Graph.OnenoteEntityHierarchyModel CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                {"createdBy", (o,n) => { (o as OnenoteEntityHierarchyModel).CreatedBy = n.GetObjectValue<ApiSdk.Models.Microsoft.Graph.IdentitySet>(ApiSdk.Models.Microsoft.Graph.IdentitySet.CreateFromDiscriminatorValue); } },
                {"displayName", (o,n) => { (o as OnenoteEntityHierarchyModel).DisplayName = n.GetStringValue(); } },
                {"lastModifiedBy", (o,n) => { (o as OnenoteEntityHierarchyModel).LastModifiedBy = n.GetObjectValue<ApiSdk.Models.Microsoft.Graph.IdentitySet>(ApiSdk.Models.Microsoft.Graph.IdentitySet.CreateFromDiscriminatorValue); } },
