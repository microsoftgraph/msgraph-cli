...
namespace ApiSdk.Models.Microsoft.Graph {
    public class Device : DirectoryObject, IParsable {
        ...
        public List<ApiSdk.Models.Microsoft.Graph.AlternativeSecurityId> AlternativeSecurityIds { get; set; }
        ...
        public List<ApiSdk.Models.Microsoft.Graph.DirectoryObject> RegisteredOwners { get; set; }
        ...
        public List<ApiSdk.Models.Microsoft.Graph.DirectoryObject> RegisteredUsers { get; set; }
        ...
        /// </summary>
        public static new ApiSdk.Models.Microsoft.Graph.Device CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"alternativeSecurityIds", (o,n) => { (o as Device).AlternativeSecurityIds = n.GetCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.AlternativeSecurityId>(ApiSdk.Models.Microsoft.Graph.AlternativeSecurityId.CreateFromDiscriminatorValue).ToList(); } },
                ...
                {"extensions", (o,n) => { (o as Device).Extensions = n.GetCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.Extension>(ApiSdk.Models.Microsoft.Graph.Extension.CreateFromDiscriminatorValue).ToList(); } },
                ...
                {"memberOf", (o,n) => { (o as Device).MemberOf = n.GetCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.DirectoryObject>(ApiSdk.Models.Microsoft.Graph.DirectoryObject.CreateFromDiscriminatorValue).ToList(); } },
                ...
                {"registeredOwners", (o,n) => { (o as Device).RegisteredOwners = n.GetCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.DirectoryObject>(ApiSdk.Models.Microsoft.Graph.DirectoryObject.CreateFromDiscriminatorValue).ToList(); } },
                {"registeredUsers", (o,n) => { (o as Device).RegisteredUsers = n.GetCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.DirectoryObject>(ApiSdk.Models.Microsoft.Graph.DirectoryObject.CreateFromDiscriminatorValue).ToList(); } },
                {"systemLabels", (o,n) => { (o as Device).SystemLabels = n.GetCollectionOfPrimitiveValues<string>().ToList(); } },
                {"transitiveMemberOf", (o,n) => { (o as Device).TransitiveMemberOf = n.GetCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.DirectoryObject>(ApiSdk.Models.Microsoft.Graph.DirectoryObject.CreateFromDiscriminatorValue).ToList(); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.AlternativeSecurityId>("alternativeSecurityIds", AlternativeSecurityIds);
            ...
            writer.WriteCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.DirectoryObject>("registeredOwners", RegisteredOwners);
            writer.WriteCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.DirectoryObject>("registeredUsers", RegisteredUsers);
