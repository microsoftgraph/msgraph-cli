...
namespace ApiSdk.Models.Microsoft.Graph {
    public class WorkbookChartLegend : Entity, IParsable {
        ...
        public ApiSdk.Models.Microsoft.Graph.WorkbookChartLegendFormat Format { get; set; }
        ...
        /// </summary>
        public static new ApiSdk.Models.Microsoft.Graph.WorkbookChartLegend CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                {"format", (o,n) => { (o as WorkbookChartLegend).Format = n.GetObjectValue<ApiSdk.Models.Microsoft.Graph.WorkbookChartLegendFormat>(ApiSdk.Models.Microsoft.Graph.WorkbookChartLegendFormat.CreateFromDiscriminatorValue); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<ApiSdk.Models.Microsoft.Graph.WorkbookChartLegendFormat>("format", Format);
