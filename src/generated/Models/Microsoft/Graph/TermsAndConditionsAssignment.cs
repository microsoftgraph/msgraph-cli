...
namespace ApiSdk.Models.Microsoft.Graph {
    public class TermsAndConditionsAssignment : Entity, IParsable {
        ...
        /// </summary>
        public static new ApiSdk.Models.Microsoft.Graph.TermsAndConditionsAssignment CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                {"target", (o,n) => { (o as TermsAndConditionsAssignment).Target = n.GetObjectValue<ApiSdk.Models.Microsoft.Graph.DeviceAndAppManagementAssignmentTarget>(ApiSdk.Models.Microsoft.Graph.DeviceAndAppManagementAssignmentTarget.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
