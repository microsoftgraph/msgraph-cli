...
namespace ApiSdk.Models.Microsoft.Graph {
    public class DirectoryAudit : Entity, IParsable {
        ...
        public List<ApiSdk.Models.Microsoft.Graph.KeyValue> AdditionalDetails { get; set; }
        ...
        public ApiSdk.Models.Microsoft.Graph.AuditActivityInitiator InitiatedBy { get; set; }
        ...
        public List<ApiSdk.Models.Microsoft.Graph.TargetResource> TargetResources { get; set; }
        /// <summary>
        /// Creates a new instance of the appropriate class based on discriminator value
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        /// </summary>
        public static new ApiSdk.Models.Microsoft.Graph.DirectoryAudit CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"additionalDetails", (o,n) => { (o as DirectoryAudit).AdditionalDetails = n.GetCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.KeyValue>(ApiSdk.Models.Microsoft.Graph.KeyValue.CreateFromDiscriminatorValue).ToList(); } },
                ...
                {"initiatedBy", (o,n) => { (o as DirectoryAudit).InitiatedBy = n.GetObjectValue<ApiSdk.Models.Microsoft.Graph.AuditActivityInitiator>(ApiSdk.Models.Microsoft.Graph.AuditActivityInitiator.CreateFromDiscriminatorValue); } },
                ...
                {"targetResources", (o,n) => { (o as DirectoryAudit).TargetResources = n.GetCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.TargetResource>(ApiSdk.Models.Microsoft.Graph.TargetResource.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.KeyValue>("additionalDetails", AdditionalDetails);
            writer.WriteStringValue("category", Category);
            writer.WriteStringValue("correlationId", CorrelationId);
            writer.WriteObjectValue<ApiSdk.Models.Microsoft.Graph.AuditActivityInitiator>("initiatedBy", InitiatedBy);
            ...
            writer.WriteCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.TargetResource>("targetResources", TargetResources);
        }
    }
}
