...
namespace ApiSdk.Models.Microsoft.Graph {
    public class Application : DirectoryObject, IParsable {
        ...
        public ApiSdk.Models.Microsoft.Graph.ApiApplication Api { get; set; }
        ...
        public List<ApiSdk.Models.Microsoft.Graph.ExtensionProperty> ExtensionProperties { get; set; }
        ...
        public ApiSdk.Models.Microsoft.Graph.OptionalClaims OptionalClaims { get; set; }
        ...
        public ApiSdk.Models.Microsoft.Graph.ParentalControlSettings ParentalControlSettings { get; set; }
        ...
        public ApiSdk.Models.Microsoft.Graph.PublicClientApplication PublicClient { get; set; }
        ...
        public List<ApiSdk.Models.Microsoft.Graph.RequiredResourceAccess> RequiredResourceAccess { get; set; }
        ...
        public ApiSdk.Models.Microsoft.Graph.SpaApplication Spa { get; set; }
        ...
        public ApiSdk.Models.Microsoft.Graph.VerifiedPublisher VerifiedPublisher { get; set; }
        /// <summary>Specifies settings for a web application.</summary>
        public ApiSdk.Models.Microsoft.Graph.WebApplication Web { get; set; }
        /// <summary>
        /// Creates a new instance of the appropriate class based on discriminator value
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        /// </summary>
        public static new ApiSdk.Models.Microsoft.Graph.Application CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                {"addIns", (o,n) => { (o as Application).AddIns = n.GetCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.AddIn>(ApiSdk.Models.Microsoft.Graph.AddIn.CreateFromDiscriminatorValue).ToList(); } },
                {"api", (o,n) => { (o as Application).Api = n.GetObjectValue<ApiSdk.Models.Microsoft.Graph.ApiApplication>(ApiSdk.Models.Microsoft.Graph.ApiApplication.CreateFromDiscriminatorValue); } },
                ...
                {"appRoles", (o,n) => { (o as Application).AppRoles = n.GetCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.AppRole>(ApiSdk.Models.Microsoft.Graph.AppRole.CreateFromDiscriminatorValue).ToList(); } },
                {"createdDateTime", (o,n) => { (o as Application).CreatedDateTime = n.GetDateTimeOffsetValue(); } },
                {"createdOnBehalfOf", (o,n) => { (o as Application).CreatedOnBehalfOf = n.GetObjectValue<ApiSdk.Models.Microsoft.Graph.DirectoryObject>(ApiSdk.Models.Microsoft.Graph.DirectoryObject.CreateFromDiscriminatorValue); } },
                ...
                {"extensionProperties", (o,n) => { (o as Application).ExtensionProperties = n.GetCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.ExtensionProperty>(ApiSdk.Models.Microsoft.Graph.ExtensionProperty.CreateFromDiscriminatorValue).ToList(); } },
                {"groupMembershipClaims", (o,n) => { (o as Application).GroupMembershipClaims = n.GetStringValue(); } },
                {"homeRealmDiscoveryPolicies", (o,n) => { (o as Application).HomeRealmDiscoveryPolicies = n.GetCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.HomeRealmDiscoveryPolicy>(ApiSdk.Models.Microsoft.Graph.HomeRealmDiscoveryPolicy.CreateFromDiscriminatorValue).ToList(); } },
                {"identifierUris", (o,n) => { (o as Application).IdentifierUris = n.GetCollectionOfPrimitiveValues<string>().ToList(); } },
                {"info", (o,n) => { (o as Application).Info = n.GetObjectValue<ApiSdk.Models.Microsoft.Graph.InformationalUrl>(ApiSdk.Models.Microsoft.Graph.InformationalUrl.CreateFromDiscriminatorValue); } },
                ...
                {"keyCredentials", (o,n) => { (o as Application).KeyCredentials = n.GetCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.KeyCredential>(ApiSdk.Models.Microsoft.Graph.KeyCredential.CreateFromDiscriminatorValue).ToList(); } },
                ...
                {"optionalClaims", (o,n) => { (o as Application).OptionalClaims = n.GetObjectValue<ApiSdk.Models.Microsoft.Graph.OptionalClaims>(ApiSdk.Models.Microsoft.Graph.OptionalClaims.CreateFromDiscriminatorValue); } },
                {"owners", (o,n) => { (o as Application).Owners = n.GetCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.DirectoryObject>(ApiSdk.Models.Microsoft.Graph.DirectoryObject.CreateFromDiscriminatorValue).ToList(); } },
                {"parentalControlSettings", (o,n) => { (o as Application).ParentalControlSettings = n.GetObjectValue<ApiSdk.Models.Microsoft.Graph.ParentalControlSettings>(ApiSdk.Models.Microsoft.Graph.ParentalControlSettings.CreateFromDiscriminatorValue); } },
                {"passwordCredentials", (o,n) => { (o as Application).PasswordCredentials = n.GetCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.PasswordCredential>(ApiSdk.Models.Microsoft.Graph.PasswordCredential.CreateFromDiscriminatorValue).ToList(); } },
                {"publicClient", (o,n) => { (o as Application).PublicClient = n.GetObjectValue<ApiSdk.Models.Microsoft.Graph.PublicClientApplication>(ApiSdk.Models.Microsoft.Graph.PublicClientApplication.CreateFromDiscriminatorValue); } },
                {"publisherDomain", (o,n) => { (o as Application).PublisherDomain = n.GetStringValue(); } },
                {"requiredResourceAccess", (o,n) => { (o as Application).RequiredResourceAccess = n.GetCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.RequiredResourceAccess>(ApiSdk.Models.Microsoft.Graph.RequiredResourceAccess.CreateFromDiscriminatorValue).ToList(); } },
                {"signInAudience", (o,n) => { (o as Application).SignInAudience = n.GetStringValue(); } },
                {"spa", (o,n) => { (o as Application).Spa = n.GetObjectValue<ApiSdk.Models.Microsoft.Graph.SpaApplication>(ApiSdk.Models.Microsoft.Graph.SpaApplication.CreateFromDiscriminatorValue); } },
                ...
                {"tokenIssuancePolicies", (o,n) => { (o as Application).TokenIssuancePolicies = n.GetCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.TokenIssuancePolicy>(ApiSdk.Models.Microsoft.Graph.TokenIssuancePolicy.CreateFromDiscriminatorValue).ToList(); } },
                {"tokenLifetimePolicies", (o,n) => { (o as Application).TokenLifetimePolicies = n.GetCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.TokenLifetimePolicy>(ApiSdk.Models.Microsoft.Graph.TokenLifetimePolicy.CreateFromDiscriminatorValue).ToList(); } },
                {"verifiedPublisher", (o,n) => { (o as Application).VerifiedPublisher = n.GetObjectValue<ApiSdk.Models.Microsoft.Graph.VerifiedPublisher>(ApiSdk.Models.Microsoft.Graph.VerifiedPublisher.CreateFromDiscriminatorValue); } },
                {"web", (o,n) => { (o as Application).Web = n.GetObjectValue<ApiSdk.Models.Microsoft.Graph.WebApplication>(ApiSdk.Models.Microsoft.Graph.WebApplication.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<ApiSdk.Models.Microsoft.Graph.ApiApplication>("api", Api);
            ...
            writer.WriteCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.ExtensionProperty>("extensionProperties", ExtensionProperties);
            ...
            writer.WriteObjectValue<ApiSdk.Models.Microsoft.Graph.OptionalClaims>("optionalClaims", OptionalClaims);
            writer.WriteCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.DirectoryObject>("owners", Owners);
            writer.WriteObjectValue<ApiSdk.Models.Microsoft.Graph.ParentalControlSettings>("parentalControlSettings", ParentalControlSettings);
            ...
            writer.WriteObjectValue<ApiSdk.Models.Microsoft.Graph.PublicClientApplication>("publicClient", PublicClient);
            writer.WriteStringValue("publisherDomain", PublisherDomain);
            writer.WriteCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.RequiredResourceAccess>("requiredResourceAccess", RequiredResourceAccess);
            writer.WriteStringValue("signInAudience", SignInAudience);
            writer.WriteObjectValue<ApiSdk.Models.Microsoft.Graph.SpaApplication>("spa", Spa);
            ...
            writer.WriteObjectValue<ApiSdk.Models.Microsoft.Graph.VerifiedPublisher>("verifiedPublisher", VerifiedPublisher);
            writer.WriteObjectValue<ApiSdk.Models.Microsoft.Graph.WebApplication>("web", Web);
        }
    }
}
