...
namespace ApiSdk.Models.Microsoft.Graph {
    public class EducationAssignment : Entity, IParsable {
        ...
        public ApiSdk.Models.Microsoft.Graph.EducationAssignmentRecipient AssignTo { get; set; }
        /// <summary>When set, enables users to easily find assignments of a given type.  Read-only. Nullable.</summary>
        public List<ApiSdk.Models.Microsoft.Graph.EducationCategory> Categories { get; set; }
        ...
        public ApiSdk.Models.Microsoft.Graph.EducationItemBody Instructions { get; set; }
        ...
        public List<ApiSdk.Models.Microsoft.Graph.EducationAssignmentResource> Resources { get; set; }
        ...
        public ApiSdk.Models.Microsoft.Graph.EducationRubric Rubric { get; set; }
        ...
        public List<ApiSdk.Models.Microsoft.Graph.EducationSubmission> Submissions { get; set; }
        ...
        /// </summary>
        public static new ApiSdk.Models.Microsoft.Graph.EducationAssignment CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"assignTo", (o,n) => { (o as EducationAssignment).AssignTo = n.GetObjectValue<ApiSdk.Models.Microsoft.Graph.EducationAssignmentRecipient>(ApiSdk.Models.Microsoft.Graph.EducationAssignmentRecipient.CreateFromDiscriminatorValue); } },
                {"categories", (o,n) => { (o as EducationAssignment).Categories = n.GetCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.EducationCategory>(ApiSdk.Models.Microsoft.Graph.EducationCategory.CreateFromDiscriminatorValue).ToList(); } },
                ...
                {"createdBy", (o,n) => { (o as EducationAssignment).CreatedBy = n.GetObjectValue<ApiSdk.Models.Microsoft.Graph.IdentitySet>(ApiSdk.Models.Microsoft.Graph.IdentitySet.CreateFromDiscriminatorValue); } },
                ...
                {"grading", (o,n) => { (o as EducationAssignment).Grading = n.GetObjectValue<ApiSdk.Models.Microsoft.Graph.EducationAssignmentGradeType>(ApiSdk.Models.Microsoft.Graph.EducationAssignmentGradeType.CreateFromDiscriminatorValue); } },
                {"instructions", (o,n) => { (o as EducationAssignment).Instructions = n.GetObjectValue<ApiSdk.Models.Microsoft.Graph.EducationItemBody>(ApiSdk.Models.Microsoft.Graph.EducationItemBody.CreateFromDiscriminatorValue); } },
                {"lastModifiedBy", (o,n) => { (o as EducationAssignment).LastModifiedBy = n.GetObjectValue<ApiSdk.Models.Microsoft.Graph.IdentitySet>(ApiSdk.Models.Microsoft.Graph.IdentitySet.CreateFromDiscriminatorValue); } },
                ...
                {"resources", (o,n) => { (o as EducationAssignment).Resources = n.GetCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.EducationAssignmentResource>(ApiSdk.Models.Microsoft.Graph.EducationAssignmentResource.CreateFromDiscriminatorValue).ToList(); } },
                {"resourcesFolderUrl", (o,n) => { (o as EducationAssignment).ResourcesFolderUrl = n.GetStringValue(); } },
                {"rubric", (o,n) => { (o as EducationAssignment).Rubric = n.GetObjectValue<ApiSdk.Models.Microsoft.Graph.EducationRubric>(ApiSdk.Models.Microsoft.Graph.EducationRubric.CreateFromDiscriminatorValue); } },
                {"status", (o,n) => { (o as EducationAssignment).Status = n.GetEnumValue<EducationAssignmentStatus>(); } },
                {"submissions", (o,n) => { (o as EducationAssignment).Submissions = n.GetCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.EducationSubmission>(ApiSdk.Models.Microsoft.Graph.EducationSubmission.CreateFromDiscriminatorValue).ToList(); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<ApiSdk.Models.Microsoft.Graph.EducationAssignmentRecipient>("assignTo", AssignTo);
            writer.WriteCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.EducationCategory>("categories", Categories);
            ...
            writer.WriteObjectValue<ApiSdk.Models.Microsoft.Graph.EducationItemBody>("instructions", Instructions);
            ...
            writer.WriteCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.EducationAssignmentResource>("resources", Resources);
            writer.WriteStringValue("resourcesFolderUrl", ResourcesFolderUrl);
            writer.WriteObjectValue<ApiSdk.Models.Microsoft.Graph.EducationRubric>("rubric", Rubric);
            writer.WriteEnumValue<EducationAssignmentStatus>("status", Status);
            writer.WriteCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.EducationSubmission>("submissions", Submissions);
