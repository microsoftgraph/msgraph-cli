...
namespace ApiSdk.Models.Microsoft.Graph.ExternalConnectors {
    public class IdentityCollectionResponse : IAdditionalDataHolder, IParsable {
        ...
        /// </summary>
        public static ApiSdk.Models.Microsoft.Graph.ExternalConnectors.IdentityCollectionResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as IdentityCollectionResponse).Value = n.GetCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.ExternalConnectors.Identity>(ApiSdk.Models.Microsoft.Graph.ExternalConnectors.Identity.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
