...
namespace ApiSdk.Models.Microsoft.Graph.ExternalConnectors {
    public class ExternalItem : Entity, IParsable {
        ...
        public ApiSdk.Models.Microsoft.Graph.ExternalConnectors.ExternalItemContent Content { get; set; }
        ...
        /// </summary>
        public static new ApiSdk.Models.Microsoft.Graph.ExternalConnectors.ExternalItem CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"content", (o,n) => { (o as ExternalItem).Content = n.GetObjectValue<ApiSdk.Models.Microsoft.Graph.ExternalConnectors.ExternalItemContent>(ApiSdk.Models.Microsoft.Graph.ExternalConnectors.ExternalItemContent.CreateFromDiscriminatorValue); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<ApiSdk.Models.Microsoft.Graph.ExternalConnectors.ExternalItemContent>("content", Content);
