    ...
    public class ExternalGroup : Entity, IParsable {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                ...
                {"members", (o,n) => { (o as ExternalGroup).Members = n.GetCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.Identity>().ToList(); } },
            };
        }
        /// <summary>
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.Identity>("members", Members);
        }
    }
}
