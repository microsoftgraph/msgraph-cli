...
namespace ApiSdk.Models.Microsoft.Graph {
    public class PrintJob : Entity, IParsable {
        public ApiSdk.Models.Microsoft.Graph.PrintJobConfiguration Configuration { get; set; }
        ...
        public ApiSdk.Models.Microsoft.Graph.PrintJobStatus Status { get; set; }
        ...
        /// </summary>
        public static new ApiSdk.Models.Microsoft.Graph.PrintJob CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                {"configuration", (o,n) => { (o as PrintJob).Configuration = n.GetObjectValue<ApiSdk.Models.Microsoft.Graph.PrintJobConfiguration>(ApiSdk.Models.Microsoft.Graph.PrintJobConfiguration.CreateFromDiscriminatorValue); } },
                {"createdBy", (o,n) => { (o as PrintJob).CreatedBy = n.GetObjectValue<ApiSdk.Models.Microsoft.Graph.UserIdentity>(ApiSdk.Models.Microsoft.Graph.UserIdentity.CreateFromDiscriminatorValue); } },
                {"createdDateTime", (o,n) => { (o as PrintJob).CreatedDateTime = n.GetDateTimeOffsetValue(); } },
                {"documents", (o,n) => { (o as PrintJob).Documents = n.GetCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.PrintDocument>(ApiSdk.Models.Microsoft.Graph.PrintDocument.CreateFromDiscriminatorValue).ToList(); } },
                ...
                {"status", (o,n) => { (o as PrintJob).Status = n.GetObjectValue<ApiSdk.Models.Microsoft.Graph.PrintJobStatus>(ApiSdk.Models.Microsoft.Graph.PrintJobStatus.CreateFromDiscriminatorValue); } },
                {"tasks", (o,n) => { (o as PrintJob).Tasks = n.GetCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.PrintTask>(ApiSdk.Models.Microsoft.Graph.PrintTask.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<ApiSdk.Models.Microsoft.Graph.PrintJobConfiguration>("configuration", Configuration);
            ...
            writer.WriteObjectValue<ApiSdk.Models.Microsoft.Graph.PrintJobStatus>("status", Status);
