...
namespace ApiSdk.Models.Microsoft.Graph.CallRecords {
    public class Session : Entity, IParsable {
        ...
        public ApiSdk.Models.Microsoft.Graph.CallRecords.Endpoint Callee { get; set; }
        /// <summary>Endpoint that initiated the session.</summary>
        public ApiSdk.Models.Microsoft.Graph.CallRecords.Endpoint Caller { get; set; }
        ...
        public List<ApiSdk.Models.Microsoft.Graph.CallRecords.Segment> Segments { get; set; }
        ...
        /// </summary>
        public static new ApiSdk.Models.Microsoft.Graph.CallRecords.Session CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                {"callee", (o,n) => { (o as Session).Callee = n.GetObjectValue<ApiSdk.Models.Microsoft.Graph.CallRecords.Endpoint>(ApiSdk.Models.Microsoft.Graph.CallRecords.Endpoint.CreateFromDiscriminatorValue); } },
                {"caller", (o,n) => { (o as Session).Caller = n.GetObjectValue<ApiSdk.Models.Microsoft.Graph.CallRecords.Endpoint>(ApiSdk.Models.Microsoft.Graph.CallRecords.Endpoint.CreateFromDiscriminatorValue); } },
                {"endDateTime", (o,n) => { (o as Session).EndDateTime = n.GetDateTimeOffsetValue(); } },
                {"failureInfo", (o,n) => { (o as Session).FailureInfo = n.GetObjectValue<ApiSdk.Models.Microsoft.Graph.CallRecords.FailureInfo>(ApiSdk.Models.Microsoft.Graph.CallRecords.FailureInfo.CreateFromDiscriminatorValue); } },
                {"modalities", (o,n) => { (o as Session).Modalities = n.GetCollectionOfEnumValues<Modality>().ToList(); } },
                {"segments", (o,n) => { (o as Session).Segments = n.GetCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.CallRecords.Segment>(ApiSdk.Models.Microsoft.Graph.CallRecords.Segment.CreateFromDiscriminatorValue).ToList(); } },
        ...
        public new void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<ApiSdk.Models.Microsoft.Graph.CallRecords.Endpoint>("callee", Callee);
            writer.WriteObjectValue<ApiSdk.Models.Microsoft.Graph.CallRecords.Endpoint>("caller", Caller);
            ...
            writer.WriteCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.CallRecords.Segment>("segments", Segments);
