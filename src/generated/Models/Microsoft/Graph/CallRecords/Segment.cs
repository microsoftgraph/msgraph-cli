...
namespace ApiSdk.Models.Microsoft.Graph.CallRecords {
    public class Segment : Entity, IParsable {
        ...
        /// </summary>
        public static new ApiSdk.Models.Microsoft.Graph.CallRecords.Segment CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public new IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>>(base.GetFieldDeserializers<T>()) {
                {"callee", (o,n) => { (o as Segment).Callee = n.GetObjectValue<ApiSdk.Models.Microsoft.Graph.CallRecords.Endpoint>(ApiSdk.Models.Microsoft.Graph.CallRecords.Endpoint.CreateFromDiscriminatorValue); } },
                {"caller", (o,n) => { (o as Segment).Caller = n.GetObjectValue<ApiSdk.Models.Microsoft.Graph.CallRecords.Endpoint>(ApiSdk.Models.Microsoft.Graph.CallRecords.Endpoint.CreateFromDiscriminatorValue); } },
