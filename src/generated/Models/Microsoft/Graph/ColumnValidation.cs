...
namespace ApiSdk.Models.Microsoft.Graph {
    public class ColumnValidation : IAdditionalDataHolder, IParsable {
        ...
        public List<ApiSdk.Models.Microsoft.Graph.DisplayNameLocalization> Descriptions { get; set; }
        ...
        /// </summary>
        public static ApiSdk.Models.Microsoft.Graph.ColumnValidation CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"descriptions", (o,n) => { (o as ColumnValidation).Descriptions = n.GetCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.DisplayNameLocalization>(ApiSdk.Models.Microsoft.Graph.DisplayNameLocalization.CreateFromDiscriminatorValue).ToList(); } },
        ...
        public void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.DisplayNameLocalization>("descriptions", Descriptions);
