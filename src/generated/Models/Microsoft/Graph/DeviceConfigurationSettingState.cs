...
namespace ApiSdk.Models.Microsoft.Graph {
    ...
    public class DeviceConfigurationSettingState : IAdditionalDataHolder, IParsable {
        ...
        /// </summary>
        public static ApiSdk.Models.Microsoft.Graph.DeviceConfigurationSettingState CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"sources", (o,n) => { (o as DeviceConfigurationSettingState).Sources = n.GetCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.SettingSource>(ApiSdk.Models.Microsoft.Graph.SettingSource.CreateFromDiscriminatorValue).ToList(); } },
