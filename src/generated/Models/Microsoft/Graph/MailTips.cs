...
namespace ApiSdk.Models.Microsoft.Graph {
    public class MailTips : IAdditionalDataHolder, IParsable {
        ...
        public ApiSdk.Models.Microsoft.Graph.AutomaticRepliesMailTips AutomaticReplies { get; set; }
        ...
        public ApiSdk.Models.Microsoft.Graph.MailTipsError Error { get; set; }
        ...
        public List<ApiSdk.Models.Microsoft.Graph.Recipient> RecipientSuggestions { get; set; }
        ...
        /// </summary>
        public static ApiSdk.Models.Microsoft.Graph.MailTips CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"automaticReplies", (o,n) => { (o as MailTips).AutomaticReplies = n.GetObjectValue<ApiSdk.Models.Microsoft.Graph.AutomaticRepliesMailTips>(ApiSdk.Models.Microsoft.Graph.AutomaticRepliesMailTips.CreateFromDiscriminatorValue); } },
                ...
                {"error", (o,n) => { (o as MailTips).Error = n.GetObjectValue<ApiSdk.Models.Microsoft.Graph.MailTipsError>(ApiSdk.Models.Microsoft.Graph.MailTipsError.CreateFromDiscriminatorValue); } },
                ...
                {"recipientSuggestions", (o,n) => { (o as MailTips).RecipientSuggestions = n.GetCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.Recipient>(ApiSdk.Models.Microsoft.Graph.Recipient.CreateFromDiscriminatorValue).ToList(); } },
        ...
        public void Serialize(ISerializationWriter writer) {
            ...
            writer.WriteObjectValue<ApiSdk.Models.Microsoft.Graph.AutomaticRepliesMailTips>("automaticReplies", AutomaticReplies);
            ...
            writer.WriteObjectValue<ApiSdk.Models.Microsoft.Graph.MailTipsError>("error", Error);
            ...
            writer.WriteCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.Recipient>("recipientSuggestions", RecipientSuggestions);
