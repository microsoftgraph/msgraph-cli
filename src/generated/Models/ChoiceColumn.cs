...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Models.ChoiceColumn"/> and sets the default values.
        /// </summary>
        public ChoiceColumn()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.ChoiceColumn"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static ApiSdk.Models.ChoiceColumn CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.ChoiceColumn();
        }
        /// <summary>
