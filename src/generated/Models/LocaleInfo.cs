...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Models.LocaleInfo"/> and sets the default values.
        /// </summary>
        public LocaleInfo()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.LocaleInfo"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static ApiSdk.Models.LocaleInfo CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.LocaleInfo();
        }
        /// <summary>
