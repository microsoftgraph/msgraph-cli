...
namespace ApiSdk.Models
{
    ...
    public partial class EndUserNotification : global::ApiSdk.Models.Entity, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::ApiSdk.Models.EndUserNotificationDetail>? Details { get; set; }
#nullable restore
#else
        public List<global::ApiSdk.Models.EndUserNotificationDetail> Details { get; set; }
#endif
...
#nullable restore
        ...
        public global::ApiSdk.Models.EndUserNotificationType? NotificationType { get; set; }
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::ApiSdk.Models.EndUserNotification"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::ApiSdk.Models.EndUserNotification CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::ApiSdk.Models.EndUserNotification();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "details", n => { Details = n.GetCollectionOfObjectValues<global::ApiSdk.Models.EndUserNotificationDetail>(global::ApiSdk.Models.EndUserNotificationDetail.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "notificationType", n => { NotificationType = n.GetEnumValue<global::ApiSdk.Models.EndUserNotificationType>(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::ApiSdk.Models.EndUserNotificationDetail>("details", Details);
            writer.WriteStringValue("displayName", DisplayName);
            writer.WriteObjectValue<global::ApiSdk.Models.EmailIdentity>("lastModifiedBy", LastModifiedBy);
            writer.WriteDateTimeOffsetValue("lastModifiedDateTime", LastModifiedDateTime);
            writer.WriteEnumValue<global::ApiSdk.Models.EndUserNotificationType>("notificationType", NotificationType);
