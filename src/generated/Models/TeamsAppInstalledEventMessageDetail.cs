...
namespace ApiSdk.Models
{
    ...
    public class TeamsAppInstalledEventMessageDetail : ApiSdk.Models.EventMessageDetail, IParsable
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Models.TeamsAppInstalledEventMessageDetail"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.TeamsAppInstalledEventMessageDetail"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new ApiSdk.Models.TeamsAppInstalledEventMessageDetail CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.TeamsAppInstalledEventMessageDetail();
        }
        /// <summary>
