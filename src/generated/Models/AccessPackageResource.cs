...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public ApiSdk.Models.AccessPackageResourceEnvironment? Environment { get; set; }
#nullable restore
#else
        public ApiSdk.Models.AccessPackageResourceEnvironment Environment { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<ApiSdk.Models.AccessPackageResourceRole>? Roles { get; set; }
#nullable restore
#else
        public List<ApiSdk.Models.AccessPackageResourceRole> Roles { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<ApiSdk.Models.AccessPackageResourceScope>? Scopes { get; set; }
#nullable restore
#else
        public List<ApiSdk.Models.AccessPackageResourceScope> Scopes { get; set; }
#endif
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "environment", n => { Environment = n.GetObjectValue<ApiSdk.Models.AccessPackageResourceEnvironment>(ApiSdk.Models.AccessPackageResourceEnvironment.CreateFromDiscriminatorValue); } },
                { "modifiedDateTime", n => { ModifiedDateTime = n.GetDateTimeOffsetValue(); } },
                { "originId", n => { OriginId = n.GetStringValue(); } },
                { "originSystem", n => { OriginSystem = n.GetStringValue(); } },
                { "roles", n => { Roles = n.GetCollectionOfObjectValues<ApiSdk.Models.AccessPackageResourceRole>(ApiSdk.Models.AccessPackageResourceRole.CreateFromDiscriminatorValue)?.ToList(); } },
                { "scopes", n => { Scopes = n.GetCollectionOfObjectValues<ApiSdk.Models.AccessPackageResourceScope>(ApiSdk.Models.AccessPackageResourceScope.CreateFromDiscriminatorValue)?.ToList(); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<ApiSdk.Models.AccessPackageResourceEnvironment>("environment", Environment);
            writer.WriteDateTimeOffsetValue("modifiedDateTime", ModifiedDateTime);
            writer.WriteStringValue("originId", OriginId);
            writer.WriteStringValue("originSystem", OriginSystem);
            writer.WriteCollectionOfObjectValues<ApiSdk.Models.AccessPackageResourceRole>("roles", Roles);
            writer.WriteCollectionOfObjectValues<ApiSdk.Models.AccessPackageResourceScope>("scopes", Scopes);
        }
    }
}
