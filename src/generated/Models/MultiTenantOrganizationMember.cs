...
namespace ApiSdk.Models
{
    ...
    public class MultiTenantOrganizationMember : ApiSdk.Models.DirectoryObject, IParsable
...
#nullable restore
        ...
        public ApiSdk.Models.MultiTenantOrganizationMemberState? State { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public ApiSdk.Models.MultiTenantOrganizationMemberTransitionDetails? TransitionDetails { get; set; }
#nullable restore
#else
        public ApiSdk.Models.MultiTenantOrganizationMemberTransitionDetails TransitionDetails { get; set; }
#endif
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Models.MultiTenantOrganizationMember"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.MultiTenantOrganizationMember"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new ApiSdk.Models.MultiTenantOrganizationMember CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.MultiTenantOrganizationMember();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "state", n => { State = n.GetEnumValue<ApiSdk.Models.MultiTenantOrganizationMemberState>(); } },
                { "tenantId", n => { TenantId = n.GetStringValue(); } },
                { "transitionDetails", n => { TransitionDetails = n.GetObjectValue<ApiSdk.Models.MultiTenantOrganizationMemberTransitionDetails>(ApiSdk.Models.MultiTenantOrganizationMemberTransitionDetails.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<ApiSdk.Models.MultiTenantOrganizationMemberState>("state", State);
            writer.WriteStringValue("tenantId", TenantId);
            writer.WriteObjectValue<ApiSdk.Models.MultiTenantOrganizationMemberTransitionDetails>("transitionDetails", TransitionDetails);
        }
    }
}
