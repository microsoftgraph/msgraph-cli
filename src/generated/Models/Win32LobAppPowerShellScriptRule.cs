...
namespace ApiSdk.Models
{
    ...
    /// </summary>
    public class Win32LobAppPowerShellScriptRule : ApiSdk.Models.Win32LobAppRule, IParsable
    {
...
#nullable restore
        ...
        public ApiSdk.Models.Win32LobAppPowerShellScriptRuleOperationType? OperationType { get; set; }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Models.Win32LobAppPowerShellScriptRule"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.Win32LobAppPowerShellScriptRule"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new ApiSdk.Models.Win32LobAppPowerShellScriptRule CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.Win32LobAppPowerShellScriptRule();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "operationType", n => { OperationType = n.GetEnumValue<ApiSdk.Models.Win32LobAppPowerShellScriptRuleOperationType>(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<ApiSdk.Models.Win32LobAppPowerShellScriptRuleOperationType>("operationType", OperationType);
