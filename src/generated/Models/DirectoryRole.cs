...
namespace ApiSdk.Models
{
    ...
    public class DirectoryRole : ApiSdk.Models.DirectoryObject, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<ApiSdk.Models.ScopedRoleMembership>? ScopedMembers { get; set; }
#nullable restore
#else
        public List<ApiSdk.Models.ScopedRoleMembership> ScopedMembers { get; set; }
#endif
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Models.DirectoryRole"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.DirectoryRole"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new ApiSdk.Models.DirectoryRole CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.DirectoryRole();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>(base.GetFieldDeserializers())
            {
                ...
                { "scopedMembers", n => { ScopedMembers = n.GetCollectionOfObjectValues<ApiSdk.Models.ScopedRoleMembership>(ApiSdk.Models.ScopedRoleMembership.CreateFromDiscriminatorValue)?.ToList(); } },
            };
        }
        /// <summary>
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<ApiSdk.Models.ScopedRoleMembership>("scopedMembers", ScopedMembers);
        }
    }
}
