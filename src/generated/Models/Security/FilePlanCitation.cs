...
namespace ApiSdk.Models.Security
{
    ...
    public class FilePlanCitation : ApiSdk.Models.Security.FilePlanDescriptorBase, IParsable
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.Security.FilePlanCitation"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new ApiSdk.Models.Security.FilePlanCitation CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.Security.FilePlanCitation();
        }
        /// <summary>
