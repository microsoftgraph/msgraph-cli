...
namespace ApiSdk.Models.Security
{
    ...
    public partial class HostPort : global::ApiSdk.Models.Entity, IParsable
    #pragma warning restore CS1591
    {
        /// <summary>The hostPortBanners retrieved from scanning the port.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::ApiSdk.Models.Security.HostPortBanner>? Banners { get; set; }
#nullable restore
#else
        public List<global::ApiSdk.Models.Security.HostPortBanner> Banners { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::ApiSdk.Models.Security.SslCertificate? MostRecentSslCertificate { get; set; }
#nullable restore
#else
        public global::ApiSdk.Models.Security.SslCertificate MostRecentSslCertificate { get; set; }
#endif
        ...
        public global::ApiSdk.Models.Security.HostPortProtocol? Protocol { get; set; }
        /// <summary>The hostPortComponents retrieved from scanning the port.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::ApiSdk.Models.Security.HostPortComponent>? Services { get; set; }
#nullable restore
#else
        public List<global::ApiSdk.Models.Security.HostPortComponent> Services { get; set; }
#endif
        /// <summary>The status of the port. The possible values are: open, filtered, closed, unknownFutureValue.</summary>
        public global::ApiSdk.Models.Security.HostPortStatus? Status { get; set; }
        ...
        /// </summary>
        /// <returns>A <see cref="global::ApiSdk.Models.Security.HostPort"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new global::ApiSdk.Models.Security.HostPort CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::ApiSdk.Models.Security.HostPort();
        }
        /// <summary>
        ...
        public override IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "banners", n => { Banners = n.GetCollectionOfObjectValues<global::ApiSdk.Models.Security.HostPortBanner>(global::ApiSdk.Models.Security.HostPortBanner.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "mostRecentSslCertificate", n => { MostRecentSslCertificate = n.GetObjectValue<global::ApiSdk.Models.Security.SslCertificate>(global::ApiSdk.Models.Security.SslCertificate.CreateFromDiscriminatorValue); } },
                { "port", n => { Port = n.GetIntValue(); } },
                { "protocol", n => { Protocol = n.GetEnumValue<global::ApiSdk.Models.Security.HostPortProtocol>(); } },
                { "services", n => { Services = n.GetCollectionOfObjectValues<global::ApiSdk.Models.Security.HostPortComponent>(global::ApiSdk.Models.Security.HostPortComponent.CreateFromDiscriminatorValue)?.AsList(); } },
                { "status", n => { Status = n.GetEnumValue<global::ApiSdk.Models.Security.HostPortStatus>(); } },
        ...
        public override void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::ApiSdk.Models.Security.HostPortBanner>("banners", Banners);
            ...
            writer.WriteObjectValue<global::ApiSdk.Models.Security.SslCertificate>("mostRecentSslCertificate", MostRecentSslCertificate);
            writer.WriteIntValue("port", Port);
            writer.WriteEnumValue<global::ApiSdk.Models.Security.HostPortProtocol>("protocol", Protocol);
            writer.WriteCollectionOfObjectValues<global::ApiSdk.Models.Security.HostPortComponent>("services", Services);
            writer.WriteEnumValue<global::ApiSdk.Models.Security.HostPortStatus>("status", Status);
