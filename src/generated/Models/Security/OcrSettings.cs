...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Models.Security.OcrSettings"/> and sets the default values.
        /// </summary>
        public OcrSettings()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.Security.OcrSettings"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static ApiSdk.Models.Security.OcrSettings CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.Security.OcrSettings();
        }
        /// <summary>
