...
#nullable restore
        ...
        public global::ApiSdk.Models.AuthenticationAttributeCollectionInputType? InputType { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::ApiSdk.Models.AuthenticationAttributeCollectionOptionConfiguration>? Options { get; set; }
#nullable restore
#else
        public List<global::ApiSdk.Models.AuthenticationAttributeCollectionOptionConfiguration> Options { get; set; }
#endif
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Models.AuthenticationAttributeCollectionInputConfiguration"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::ApiSdk.Models.AuthenticationAttributeCollectionInputConfiguration"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::ApiSdk.Models.AuthenticationAttributeCollectionInputConfiguration CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::ApiSdk.Models.AuthenticationAttributeCollectionInputConfiguration();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "inputType", n => { InputType = n.GetEnumValue<global::ApiSdk.Models.AuthenticationAttributeCollectionInputType>(); } },
                { "label", n => { Label = n.GetStringValue(); } },
                { "@odata.type", n => { OdataType = n.GetStringValue(); } },
                { "options", n => { Options = n.GetCollectionOfObjectValues<global::ApiSdk.Models.AuthenticationAttributeCollectionOptionConfiguration>(global::ApiSdk.Models.AuthenticationAttributeCollectionOptionConfiguration.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::ApiSdk.Models.AuthenticationAttributeCollectionInputType>("inputType", InputType);
            writer.WriteStringValue("label", Label);
            writer.WriteStringValue("@odata.type", OdataType);
            writer.WriteCollectionOfObjectValues<global::ApiSdk.Models.AuthenticationAttributeCollectionOptionConfiguration>("options", Options);
