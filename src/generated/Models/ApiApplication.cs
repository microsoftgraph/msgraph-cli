...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::ApiSdk.Models.PermissionScope>? Oauth2PermissionScopes { get; set; }
#nullable restore
#else
        public List<global::ApiSdk.Models.PermissionScope> Oauth2PermissionScopes { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::ApiSdk.Models.PreAuthorizedApplication>? PreAuthorizedApplications { get; set; }
#nullable restore
#else
        public List<global::ApiSdk.Models.PreAuthorizedApplication> PreAuthorizedApplications { get; set; }
#endif
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Models.ApiApplication"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::ApiSdk.Models.ApiApplication"/></returns>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "oauth2PermissionScopes", n => { Oauth2PermissionScopes = n.GetCollectionOfObjectValues<global::ApiSdk.Models.PermissionScope>(global::ApiSdk.Models.PermissionScope.CreateFromDiscriminatorValue)?.AsList(); } },
                { "@odata.type", n => { OdataType = n.GetStringValue(); } },
                { "preAuthorizedApplications", n => { PreAuthorizedApplications = n.GetCollectionOfObjectValues<global::ApiSdk.Models.PreAuthorizedApplication>(global::ApiSdk.Models.PreAuthorizedApplication.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::ApiSdk.Models.PermissionScope>("oauth2PermissionScopes", Oauth2PermissionScopes);
            writer.WriteStringValue("@odata.type", OdataType);
            writer.WriteCollectionOfObjectValues<global::ApiSdk.Models.PreAuthorizedApplication>("preAuthorizedApplications", PreAuthorizedApplications);
