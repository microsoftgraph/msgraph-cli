...
namespace ApiSdk.Models
{
    ...
    public class InviteParticipantsOperation : ApiSdk.Models.CommsOperation, IParsable
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.InviteParticipantsOperation"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new ApiSdk.Models.InviteParticipantsOperation CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.InviteParticipantsOperation();
        }
        /// <summary>
