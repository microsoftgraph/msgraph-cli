...
namespace ApiSdk.Models
{
    ...
    #pragma warning restore CS1591
    {
        ...
        public global::ApiSdk.Models.RegistryHive? Hive { get; set; }
...
#nullable restore
        ...
        public global::ApiSdk.Models.RegistryOperation? Operation { get; set; }
...
#nullable restore
        ...
        public global::ApiSdk.Models.RegistryValueType? ValueType { get; set; }
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Models.RegistryKeyState"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::ApiSdk.Models.RegistryKeyState"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::ApiSdk.Models.RegistryKeyState CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::ApiSdk.Models.RegistryKeyState();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "hive", n => { Hive = n.GetEnumValue<global::ApiSdk.Models.RegistryHive>(); } },
                ...
                { "operation", n => { Operation = n.GetEnumValue<global::ApiSdk.Models.RegistryOperation>(); } },
                { "processId", n => { ProcessId = n.GetIntValue(); } },
                { "valueData", n => { ValueData = n.GetStringValue(); } },
                { "valueName", n => { ValueName = n.GetStringValue(); } },
                { "valueType", n => { ValueType = n.GetEnumValue<global::ApiSdk.Models.RegistryValueType>(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::ApiSdk.Models.RegistryHive>("hive", Hive);
            ...
            writer.WriteEnumValue<global::ApiSdk.Models.RegistryOperation>("operation", Operation);
            ...
            writer.WriteEnumValue<global::ApiSdk.Models.RegistryValueType>("valueType", ValueType);
