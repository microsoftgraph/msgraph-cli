    ...
    public class CommunicationsRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.Handler = CommandHandler.Create<object, object>(async (select, expand) => {
                ...
                var result = await RequestAdapter.SendAsync<CloudCommunications>(requestInfo);
        ...
        public Command BuildGetPresencesByUserIdCommand() {
            ...
            var builder = new ApiSdk.Communications.GetPresencesByUserId.GetPresencesByUserIdRequestBuilder(PathParameters, RequestAdapter);
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(CloudCommunications model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
