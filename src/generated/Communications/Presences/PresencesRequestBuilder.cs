...
namespace ApiSdk.Communications.Presences {
    ...
    public class PresencesRequestBuilder {
        ...
        public List<Command> BuildCommand() {
            ...
            commands.Add(builder.BuildClearPresenceCommand());
            commands.Add(builder.BuildDeleteCommand());
            commands.Add(builder.BuildGetCommand());
            commands.Add(builder.BuildPatchCommand());
            commands.Add(builder.BuildSetPresenceCommand());
            return commands;
        }
        ...
        /// <param name="options">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ApiSdk.Models.Microsoft.Graph.Presence body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
