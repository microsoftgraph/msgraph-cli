...
namespace ApiSdk.Communications.Presences {
    ...
    public class PresencesRequestBuilder {
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ApiSdk.Models.Presence body, Action<PresencesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
