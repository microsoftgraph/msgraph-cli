...
namespace ApiSdk.Communications.Calls.Item.Redirect {
    ...
    public class RedirectRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(RedirectRequestBody model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
