...
namespace ApiSdk.Communications.Calls.Item.SubscribeToTone {
    ...
    public class SubscribeToToneRequestBuilder {
        ...
        /// </summary>
        public async Task<SubscribeToToneResponse> PostAsync(SubscribeToToneRequestBody model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
