    ...
    public class SubscribeToToneRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                var model = parseNode.GetObjectValue<SubscribeToToneRequestBody>(SubscribeToToneRequestBody.CreateFromDiscriminatorValue);
        ...
        public class SubscribeToToneResponse : IAdditionalDataHolder, IParsable {
            ...
            public ApiSdk.Models.Microsoft.Graph.SubscribeToToneOperation SubscribeToToneOperation { get; set; }
            /// <summary>
            ...
            public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
                return new Dictionary<string, Action<T, IParseNode>> {
                    {"subscribeToToneOperation", (o,n) => { (o as SubscribeToToneResponse).SubscribeToToneOperation = n.GetObjectValue<ApiSdk.Models.Microsoft.Graph.SubscribeToToneOperation>(ApiSdk.Models.Microsoft.Graph.SubscribeToToneOperation.CreateFromDiscriminatorValue); } },
                };
            }
            /// <summary>
            ...
            public void Serialize(ISerializationWriter writer) {
                ...
                writer.WriteObjectValue<ApiSdk.Models.Microsoft.Graph.SubscribeToToneOperation>("subscribeToToneOperation", SubscribeToToneOperation);
