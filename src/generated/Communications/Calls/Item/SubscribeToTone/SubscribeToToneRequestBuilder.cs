    ...
    public class SubscribeToToneRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string>(async (callId, body) => {
                ...
                var model = parseNode.GetObjectValue<SubscribeToToneRequestBody>();
                var requestInfo = CreatePostRequestInformation(model);
                if (!String.IsNullOrEmpty(callId)) requestInfo.PathParameters.Add("call_id", callId);
                var result = await RequestAdapter.SendAsync<SubscribeToToneResponse>(requestInfo);
        ...
        /// </summary>
        public async Task<SubscribeToToneResponse> PostAsync(SubscribeToToneRequestBody model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
