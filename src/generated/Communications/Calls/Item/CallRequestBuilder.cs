...
namespace ApiSdk.Communications.Calls.Item {
    ...
    public class CallRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string callId, string[] select, string[] expand, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string callId, string body, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
