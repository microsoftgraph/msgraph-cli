...
namespace ApiSdk.Communications.Calls.Item.ChangeScreenSharingRole {
    ...
    public class ChangeScreenSharingRoleRequestBuilder {
        ...
        public ChangeScreenSharingRoleRequestBuilder(Dictionary<string, object> pathParameters) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            UrlTemplate = "{+baseurl}/communications/calls/{call%2Did}/changeScreenSharingRole";
