...
namespace ApiSdk.Communications.Calls.Item.ChangeScreenSharingRole {
    ...
    public class ChangeScreenSharingRoleRequestBuilder {
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ChangeScreenSharingRoleRequestBody body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
