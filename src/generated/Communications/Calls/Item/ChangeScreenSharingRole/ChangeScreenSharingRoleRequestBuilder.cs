...
namespace ApiSdk.Communications.Calls.Item.ChangeScreenSharingRole {
    ...
    public class ChangeScreenSharingRoleRequestBuilder {
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ChangeScreenSharingRolePostRequestBody body, Action<ChangeScreenSharingRoleRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
