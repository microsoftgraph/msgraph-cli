    ...
    public class ChangeScreenSharingRoleRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Communications.Calls.Item.ChangeScreenSharingRole.ChangeScreenSharingRoleRequestBody>(ApiSdk.Communications.Calls.Item.ChangeScreenSharingRole.ChangeScreenSharingRoleRequestBody.CreateFromDiscriminatorValue);
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ApiSdk.Communications.Calls.Item.ChangeScreenSharingRole.ChangeScreenSharingRoleRequestBody body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
