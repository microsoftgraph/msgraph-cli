...
namespace ApiSdk.Communications.Calls.Item.Participants.Invite {
    ...
    public class InviteRequestBuilder {
        ...
        /// </summary>
        public async Task<InviteResponse> PostAsync(InviteRequestBody model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
