...
namespace ApiSdk.Communications.Calls.Item.Participants.Item {
    ...
    public class ParticipantRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string callId, string participantId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, callIdOption, participantIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// Read-only. Nullable.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string callId, string participantId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, callIdOption, participantIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string callId, string participantId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, callIdOption, participantIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
