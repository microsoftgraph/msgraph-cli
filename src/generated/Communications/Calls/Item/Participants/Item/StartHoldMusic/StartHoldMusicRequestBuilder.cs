...
namespace ApiSdk.Communications.Calls.Item.Participants.Item.StartHoldMusic {
    ...
    public class StartHoldMusicRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (string callId, string participantId, string body, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, callIdOption, participantIdOption, bodyOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
