...
namespace ApiSdk.Communications.Calls.Item.Participants.Item.StartHoldMusic {
    ...
    public class StartHoldMusicRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            }, new CollectionBinding(callIdOption, participantIdOption, bodyOption, outputOption, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
