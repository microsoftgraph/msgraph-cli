...
namespace ApiSdk.Communications.Calls.Item.Participants.Item.StartHoldMusic {
    ...
    public class StartHoldMusicRequestBuilder {
        ...
        /// </summary>
        public async Task<StartHoldMusicResponse> PostAsync(StartHoldMusicRequestBody model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
