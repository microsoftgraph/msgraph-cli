...
namespace ApiSdk.Communications.Calls.Item.Participants.Item.StopHoldMusic {
    ...
    public class StopHoldMusicRequestBody : IAdditionalDataHolder, IParsable {
        ...
        /// </summary>
        public static ApiSdk.Communications.Calls.Item.Participants.Item.StopHoldMusic.StopHoldMusicRequestBody CreateFromDiscriminatorValue(IParseNode parseNode) {
