...
namespace ApiSdk.Communications.Calls.Item.Participants.Item.StopHoldMusic {
    ...
    public class StopHoldMusicRequestBuilder {
        ...
        public StopHoldMusicRequestBuilder(Dictionary<string, object> pathParameters) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            UrlTemplate = "{+baseurl}/communications/calls/{call%2Did}/participants/{participant%2Did}/stopHoldMusic";
