...
namespace ApiSdk.Communications.Calls.Item.MicrosoftGraphRecordResponse {
    /// <summary>
    ...
    public class RecordResponseRequestBuilder {
        ...
        public RecordResponseRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/communications/calls/{call%2Did}/microsoft.graph.recordResponse";
