...
namespace ApiSdk.Communications.Calls.Item.MicrosoftGraphTransfer {
    /// <summary>
    /// Provides operations to call the transfer method.
    /// </summary>
    public class MicrosoftGraphTransferRequestBuilder {
        ...
        public MicrosoftGraphTransferRequestBuilder(Dictionary<string, object> pathParameters) {
...
#nullable enable
        public RequestInformation ToPostRequestInformation(TransferPostRequestBody body, Action<MicrosoftGraphTransferRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(TransferPostRequestBody body, Action<MicrosoftGraphTransferRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            if (requestConfiguration != null) {
                var requestConfig = new MicrosoftGraphTransferRequestBuilderPostRequestConfiguration();
        ...
        /// </summary>
        public class MicrosoftGraphTransferRequestBuilderPostRequestConfiguration {
            /// <summary>Request headers</summary>
            public RequestHeaders Headers { get; set; }
            /// <summary>Request options</summary>
            public IList<IRequestOption> Options { get; set; }
            /// <summary>
            /// Instantiates a new microsoftGraphTransferRequestBuilderPostRequestConfiguration and sets the default values.
            /// </summary>
            public MicrosoftGraphTransferRequestBuilderPostRequestConfiguration() {
