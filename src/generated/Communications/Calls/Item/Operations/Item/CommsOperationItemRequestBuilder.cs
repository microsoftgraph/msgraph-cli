...
namespace ApiSdk.Communications.Calls.Item.Operations.Item {
    ...
    public class CommsOperationItemRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            var commsOperationIdOption = new Option<string>("--comms-operation-id", description: "key: id of commsOperation") {
            };
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                var commsOperationId = (string) parameters[1];
                var ifMatch = (string) parameters[2];
                var cancellationToken = (CancellationToken) parameters[3];
                var requestInfo = CreateDeleteRequestInformation(q => {
                });
                requestInfo.PathParameters.Add("call%2Did", callId);
                requestInfo.PathParameters.Add("commsOperation%2Did", commsOperationId);
            ...
            }, new CollectionBinding(callIdOption, commsOperationIdOption, ifMatchOption, new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// Read-only. Nullable.
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(callIdOption, commsOperationIdOption, selectOption, expandOption, outputOption, queryOption, jsonNoIndentOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                await RequestAdapter.SendNoContentAsync(requestInfo, errorMapping: errorMapping, cancellationToken: cancellationToken);
                Console.WriteLine("Success");
            }, new CollectionBinding(callIdOption, commsOperationIdOption, bodyOption, new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
