...
namespace ApiSdk.Communications.Calls.Item.Operations {
    ...
    public class OperationsRequestBuilder {
        ...
        public List<Command> BuildCommand() {
            var builder = new CommsOperationRequestBuilder(PathParameters, RequestAdapter);
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<CommsOperation> PostAsync(CommsOperation model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
