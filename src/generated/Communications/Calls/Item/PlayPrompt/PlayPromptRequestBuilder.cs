...
namespace ApiSdk.Communications.Calls.Item.PlayPrompt {
    ...
    public class PlayPromptRequestBuilder {
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(PlayPromptRequestBody body, Action<PlayPromptRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
