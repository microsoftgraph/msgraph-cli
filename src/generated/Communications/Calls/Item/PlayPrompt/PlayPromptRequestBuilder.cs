...
namespace ApiSdk.Communications.Calls.Item.PlayPrompt {
    ...
    public class PlayPromptRequestBuilder {
        ...
        /// </summary>
        public async Task<PlayPromptResponse> PostAsync(PlayPromptRequestBody model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
