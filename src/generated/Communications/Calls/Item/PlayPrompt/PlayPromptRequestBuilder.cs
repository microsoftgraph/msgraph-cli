    ...
    public class PlayPromptRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Communications.Calls.Item.PlayPrompt.PlayPromptRequestBody>(ApiSdk.Communications.Calls.Item.PlayPrompt.PlayPromptRequestBody.CreateFromDiscriminatorValue);
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ApiSdk.Communications.Calls.Item.PlayPrompt.PlayPromptRequestBody body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
