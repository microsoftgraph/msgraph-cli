...
namespace ApiSdk.Communications.Calls.Item.PlayPrompt {
    ...
    public class PlayPromptRequestBuilder {
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(PlayPromptPostRequestBody body, Action<PlayPromptRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
