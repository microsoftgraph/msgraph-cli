...
namespace ApiSdk.Communications.Calls.Item.PlayPrompt {
    ...
    public class PlayPromptRequestBuilder {
        ...
        public PlayPromptRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/communications/calls/{call%2Did}/microsoft.graph.playPrompt";
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(PlayPromptRequestBody body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
