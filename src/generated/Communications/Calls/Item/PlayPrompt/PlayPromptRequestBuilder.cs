    ...
    public class PlayPromptRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (string callId, string body, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                ...
                var model = parseNode.GetObjectValue<PlayPromptRequestBody>();
        ...
        /// </summary>
        public async Task<PlayPromptResponse> PostAsync(PlayPromptRequestBody model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
