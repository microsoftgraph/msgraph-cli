    ...
    public class PlayPromptRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                var model = parseNode.GetObjectValue<PlayPromptRequestBody>(PlayPromptRequestBody.CreateFromDiscriminatorValue);
        ...
        public class PlayPromptResponse : IAdditionalDataHolder, IParsable {
            ...
            public ApiSdk.Models.Microsoft.Graph.PlayPromptOperation PlayPromptOperation { get; set; }
            /// <summary>
            ...
            public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
                return new Dictionary<string, Action<T, IParseNode>> {
                    {"playPromptOperation", (o,n) => { (o as PlayPromptResponse).PlayPromptOperation = n.GetObjectValue<ApiSdk.Models.Microsoft.Graph.PlayPromptOperation>(ApiSdk.Models.Microsoft.Graph.PlayPromptOperation.CreateFromDiscriminatorValue); } },
                };
            }
            /// <summary>
            ...
            public void Serialize(ISerializationWriter writer) {
                ...
                writer.WriteObjectValue<ApiSdk.Models.Microsoft.Graph.PlayPromptOperation>("playPromptOperation", PlayPromptOperation);
