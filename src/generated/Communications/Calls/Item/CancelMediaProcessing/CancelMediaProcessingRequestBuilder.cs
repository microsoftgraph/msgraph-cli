...
namespace ApiSdk.Communications.Calls.Item.CancelMediaProcessing {
    ...
    public class CancelMediaProcessingRequestBuilder {
        ...
        /// </summary>
        public async Task<CancelMediaProcessingResponse> PostAsync(CancelMediaProcessingRequestBody model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
