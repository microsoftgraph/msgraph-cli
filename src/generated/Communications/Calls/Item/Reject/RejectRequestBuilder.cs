...
namespace ApiSdk.Communications.Calls.Item.Reject {
    ...
    public class RejectRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(RejectRequestBody model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
