...
namespace ApiSdk.Communications.Calls.Item.Reject {
    ...
    public class RejectRequestBuilder {
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(RejectRequestBody body, Action<RejectRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
