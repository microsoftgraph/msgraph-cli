    ...
    public class RecordResponseRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (string callId, string body) => {
                ...
                var result = await RequestAdapter.SendAsync<RecordResponseResponse>(requestInfo);
        ...
        /// </summary>
        public async Task<RecordResponseResponse> PostAsync(RecordResponseRequestBody model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
