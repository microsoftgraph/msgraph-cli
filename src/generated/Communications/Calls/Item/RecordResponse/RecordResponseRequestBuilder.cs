...
namespace ApiSdk.Communications.Calls.Item.RecordResponse {
    ...
    public class RecordResponseRequestBuilder {
        ...
        /// </summary>
        public async Task<RecordResponseResponse> PostAsync(RecordResponseRequestBody model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
