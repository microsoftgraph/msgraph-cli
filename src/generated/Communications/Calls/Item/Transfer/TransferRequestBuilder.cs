...
namespace ApiSdk.Communications.Calls.Item.Transfer {
    ...
    public class TransferRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(TransferRequestBody model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
