    ...
    public class LogTeleconferenceDeviceQualityRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                var model = parseNode.GetObjectValue<LogTeleconferenceDeviceQualityRequestBody>(LogTeleconferenceDeviceQualityRequestBody.CreateFromDiscriminatorValue);
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(LogTeleconferenceDeviceQualityRequestBody body, Action<LogTeleconferenceDeviceQualityRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
