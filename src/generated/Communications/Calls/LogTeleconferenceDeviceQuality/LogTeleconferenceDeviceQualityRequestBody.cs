...
namespace ApiSdk.Communications.Calls.LogTeleconferenceDeviceQuality {
    ...
    public class LogTeleconferenceDeviceQualityRequestBody : IAdditionalDataHolder, IParsable {
        ...
        /// </summary>
        public static ApiSdk.Communications.Calls.LogTeleconferenceDeviceQuality.LogTeleconferenceDeviceQualityRequestBody CreateFromDiscriminatorValue(IParseNode parseNode) {
