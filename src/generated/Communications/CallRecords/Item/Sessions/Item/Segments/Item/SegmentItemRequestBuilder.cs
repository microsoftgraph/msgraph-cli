...
namespace ApiSdk.Communications.CallRecords.Item.Sessions.Item.Segments.Item {
    ...
    public class SegmentItemRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(callRecordIdOption, sessionIdOption, segmentIdOption, selectOption, expandOption, outputOption, outputFilterOption, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// The list of segments involved in the session. Read-only. Nullable.
