...
namespace ApiSdk.Communications.CallRecords.Item.Sessions.Item.Segments {
    ...
    public class SegmentsRequestBuilder {
        ...
        public Command BuildListCommand() {
            ...
            command.SetHandler(async (string callRecordId, string sessionId, int? top, int? skip, string search, string filter, bool? count, string[] orderby, string[] select, string[] expand) => {
                ...
                var strContent = await reader.ReadToEndAsync();
                Console.Write(strContent + "\n");
            }, callRecordIdOption, sessionIdOption, topOption, skipOption, searchOption, filterOption, countOption, orderbyOption, selectOption, expandOption);
            return command;
        }
        /// <summary>
