using ApiSdk.Communications.CallRecords.Item.Sessions.Item.Segments.Count;
...
namespace ApiSdk.Communications.CallRecords.Item.Sessions.Item.Segments {
    ...
    /// </summary>
    public class SegmentsRequestBuilder : BaseCliRequestBuilder {
        /// <summary>
        /// Provides operations to manage the segments property of the microsoft.graph.callRecords.session entity.
        /// </summary>
        public Tuple<List<Command>, List<Command>> BuildCommand() {
            var executables = new List<Command>();
            var builder = new SegmentItemRequestBuilder(PathParameters);
        ...
        public SegmentsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/communications/callRecords/{callRecord%2Did}/sessions/{session%2Did}/segments{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// The list of segments involved in the session. Read-only. Nullable.
        /// </summary>
...
#nullable restore
        ...
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<SegmentsRequestBuilderGetQueryParameters>> requestConfiguration = default) {
            ...
            if (requestConfiguration != null) {
                var requestConfig = new RequestConfiguration<SegmentsRequestBuilderGetQueryParameters>();
