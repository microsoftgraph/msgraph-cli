...
namespace ApiSdk.Communications.CallRecords.Item.Sessions.Item.Segments {
    ...
    public class SegmentsRequestBuilder {
        ...
        public Command BuildCreateCommand() {
            ...
            }, callRecordIdOption, sessionIdOption, bodyOption, outputOption);
            return command;
        }
        /// <summary>
        /// The list of segments involved in the session. Read-only. Nullable.
        ...
        public Command BuildListCommand() {
            ...
            command.SetHandler(async (string callRecordId, string sessionId, int? top, int? skip, string search, string filter, bool? count, string[] orderby, string[] select, string[] expand, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                ...
                var formatter = outputFormatterFactory.GetFormatter(output);
                formatter.WriteOutput(response, console);
            }, callRecordIdOption, sessionIdOption, topOption, skipOption, searchOption, filterOption, countOption, orderbyOption, selectOption, expandOption, outputOption);
            return command;
        }
        /// <summary>
