...
namespace ApiSdk.Communications.CallRecords.Item.Sessions.Item.Segments.Item {
    ...
    public class SegmentRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            }, callRecordIdOption, sessionIdOption, segmentIdOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// The list of segments involved in the session. Read-only. Nullable.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string callRecordId, string sessionId, string segmentId, string[] select, string[] expand, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
            ...
            }, callRecordIdOption, sessionIdOption, segmentIdOption, selectOption, expandOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// The list of segments involved in the session. Read-only. Nullable.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string callRecordId, string sessionId, string segmentId, string body, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                ...
                await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                console.WriteLine("Success");
            }, callRecordIdOption, sessionIdOption, segmentIdOption, bodyOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
