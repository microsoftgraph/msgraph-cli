...
namespace ApiSdk.Communications.CallRecords.Item.Sessions.Item.Segments.Item {
    ...
    public class SegmentRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string callRecordId, string sessionId, string segmentId, IConsole console) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string callRecordId, string sessionId, string segmentId, string[] select, string[] expand, FormatterType output, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string callRecordId, string sessionId, string segmentId, string body, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
