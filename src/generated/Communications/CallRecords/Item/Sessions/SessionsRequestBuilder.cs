...
namespace ApiSdk.Communications.CallRecords.Item.Sessions {
    ...
    public class SessionsRequestBuilder {
        ...
        public Command BuildListCommand() {
            ...
            command.Handler = CommandHandler.Create<string, int?, int?, string, string, bool?, string[], string[], string[]>(async (callRecordId, top, skip, search, filter, count, orderby, select, expand) => {
