using ApiSdk.Communications.CallRecords.CallRecordsGetDirectRoutingCallsWithFromDateTimeWithToDateTime;
using ApiSdk.Communications.CallRecords.CallRecordsGetPstnCallsWithFromDateTimeWithToDateTime;
...
namespace ApiSdk.Communications.CallRecords {
    ...
    public class CallRecordsRequestBuilder {
        ...
        public Command BuildCommand() {
            ...
            command.AddCommand(builder.BuildSessionsCommand());
            return command;
        }
        /// <summary>
        ...
        public CallRecordsRequestBuilder(Dictionary<string, object> pathParameters) {
