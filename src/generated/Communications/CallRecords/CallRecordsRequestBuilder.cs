...
namespace ApiSdk.Communications.CallRecords {
    ...
    public class CallRecordsRequestBuilder {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<CallRecord> PostAsync(CallRecord model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
