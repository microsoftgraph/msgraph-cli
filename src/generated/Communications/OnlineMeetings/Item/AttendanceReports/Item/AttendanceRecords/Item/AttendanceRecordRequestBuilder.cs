...
namespace ApiSdk.Communications.OnlineMeetings.Item.AttendanceReports.Item.AttendanceRecords.Item {
    ...
    public class AttendanceRecordRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string onlineMeetingId, string meetingAttendanceReportId, string attendanceRecordId, IConsole console) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string onlineMeetingId, string meetingAttendanceReportId, string attendanceRecordId, string[] select, string[] expand, FormatterType output, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string onlineMeetingId, string meetingAttendanceReportId, string attendanceRecordId, string body, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
