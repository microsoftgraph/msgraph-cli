...
namespace ApiSdk.Communications.OnlineMeetings.Item.AttendanceReports.Item.AttendanceRecords {
    ...
    public class AttendanceRecordsRequestBuilder : BaseCliRequestBuilder {
        ...
        public AttendanceRecordsRequestBuilder(string rawUrl) : base("{+baseurl}/communications/onlineMeetings/{onlineMeeting%2Did}/attendanceReports/{meetingAttendanceReport%2Did}/attendanceRecords{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Get a list of attendanceRecord objects and their properties. This API is available in the following national cloud deployments.
        /// </summary>
