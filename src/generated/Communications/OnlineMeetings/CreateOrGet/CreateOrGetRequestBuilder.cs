    ...
    public class CreateOrGetRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Communications.OnlineMeetings.CreateOrGet.CreateOrGetRequestBody>(ApiSdk.Communications.OnlineMeetings.CreateOrGet.CreateOrGetRequestBody.CreateFromDiscriminatorValue);
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ApiSdk.Communications.OnlineMeetings.CreateOrGet.CreateOrGetRequestBody body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
