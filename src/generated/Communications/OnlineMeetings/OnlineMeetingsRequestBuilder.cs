...
namespace ApiSdk.Communications.OnlineMeetings {
    ...
    public class OnlineMeetingsRequestBuilder {
        ...
        public List<Command> BuildCommand() {
            ...
            commands.Add(builder.BuildAttendanceReportsCommand());
            commands.Add(builder.BuildAttendeeReportCommand());
        ...
        public Command BuildCreateOrGetCommand() {
            ...
            var builder = new ApiSdk.Communications.OnlineMeetings.CreateOrGet.CreateOrGetRequestBuilder(PathParameters, RequestAdapter);
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<OnlineMeeting> PostAsync(OnlineMeeting model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
