...
namespace ApiSdk.Users.Item.CalendarView.Item.Calendar.CalendarPermissions.Item {
    ...
    public class CalendarPermissionRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string userId, string eventId, string calendarPermissionId, string[] select) => {
            ...
            }, userIdOption, eventIdOption, calendarPermissionIdOption, selectOption);
            return command;
        }
        /// <summary>
        /// The permissions of the users with whom the calendar is shared.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string userId, string eventId, string calendarPermissionId, string body) => {
