...
namespace ApiSdk.Users.Item.CalendarView.Item {
    ...
    public class EventRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string userId, string eventId, string startDateTime, string endDateTime, string[] select, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, userIdOption, eventIdOption, startDateTimeOption, endDateTimeOption, selectOption, outputOption, new ServiceProviderBinder());
            return command;
        }
