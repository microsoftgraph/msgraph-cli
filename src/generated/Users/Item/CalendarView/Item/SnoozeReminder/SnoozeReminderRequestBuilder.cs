    ...
    public class SnoozeReminderRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Users.Item.CalendarView.Item.SnoozeReminder.SnoozeReminderRequestBody>(ApiSdk.Users.Item.CalendarView.Item.SnoozeReminder.SnoozeReminderRequestBody.CreateFromDiscriminatorValue);
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ApiSdk.Users.Item.CalendarView.Item.SnoozeReminder.SnoozeReminderRequestBody body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
