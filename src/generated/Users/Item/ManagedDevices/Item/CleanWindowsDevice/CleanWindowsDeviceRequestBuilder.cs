...
namespace ApiSdk.Users.Item.ManagedDevices.Item.CleanWindowsDevice {
    ...
    public class CleanWindowsDeviceRequestBuilder {
        ...
        public CleanWindowsDeviceRequestBuilder(Dictionary<string, object> pathParameters) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            UrlTemplate = "{+baseurl}/users/{user%2Did}/managedDevices/{managedDevice%2Did}/cleanWindowsDevice";
