...
namespace ApiSdk.Users.Item.ManagedDevices.Item.LogCollectionRequests {
    ...
    public class LogCollectionRequestsRequestBuilder : BaseCliRequestBuilder {
        ...
        public LogCollectionRequestsRequestBuilder(string rawUrl) : base("{+baseurl}/users/{user%2Did}/managedDevices/{managedDevice%2Did}/logCollectionRequests{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// List of log collection requests
        /// </summary>
