...
namespace ApiSdk.Users.Item.ManagedDevices.Item.RemoteLock {
    ...
    public class RemoteLockRequestBuilder {
        ...
        public RemoteLockRequestBuilder(Dictionary<string, object> pathParameters) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            UrlTemplate = "{+baseurl}/users/{user%2Did}/managedDevices/{managedDevice%2Did}/remoteLock";
