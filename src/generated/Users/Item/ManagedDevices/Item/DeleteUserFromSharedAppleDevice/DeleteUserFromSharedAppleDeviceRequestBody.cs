...
namespace ApiSdk.Users.Item.ManagedDevices.Item.DeleteUserFromSharedAppleDevice {
    ...
    public class DeleteUserFromSharedAppleDeviceRequestBody : IAdditionalDataHolder, IParsable {
        ...
        /// </summary>
        public static ApiSdk.Users.Item.ManagedDevices.Item.DeleteUserFromSharedAppleDevice.DeleteUserFromSharedAppleDeviceRequestBody CreateFromDiscriminatorValue(IParseNode parseNode) {
