...
namespace ApiSdk.Users.Item.ManagedDevices.Item.BypassActivationLock {
    ...
    public class BypassActivationLockRequestBuilder {
        ...
        public BypassActivationLockRequestBuilder(Dictionary<string, object> pathParameters) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            UrlTemplate = "{+baseurl}/users/{user%2Did}/managedDevices/{managedDevice%2Did}/bypassActivationLock";
