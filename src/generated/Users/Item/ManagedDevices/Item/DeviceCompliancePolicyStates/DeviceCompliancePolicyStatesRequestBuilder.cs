...
namespace ApiSdk.Users.Item.ManagedDevices.Item.DeviceCompliancePolicyStates {
    ...
    public class DeviceCompliancePolicyStatesRequestBuilder : BaseCliRequestBuilder {
        ...
        public DeviceCompliancePolicyStatesRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/users/{user%2Did}/managedDevices/{managedDevice%2Did}/deviceCompliancePolicyStates{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Device compliance policy states for this device.
        /// </summary>
...
#nullable restore
        ...
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<DeviceCompliancePolicyStatesRequestBuilderGetQueryParameters>> requestConfiguration = default) {
            ...
            if (requestConfiguration != null) {
                var requestConfig = new RequestConfiguration<DeviceCompliancePolicyStatesRequestBuilderGetQueryParameters>();
