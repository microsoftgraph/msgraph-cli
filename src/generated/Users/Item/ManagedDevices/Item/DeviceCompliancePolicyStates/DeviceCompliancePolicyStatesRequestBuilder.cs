...
namespace ApiSdk.Users.Item.ManagedDevices.Item.DeviceCompliancePolicyStates {
    ...
    public class DeviceCompliancePolicyStatesRequestBuilder {
        ...
        public Command BuildCommand() {
            ...
            var builder = new DeviceCompliancePolicyStateItemRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildCreateCommand() {
            ...
            }, new CollectionBinding(userIdOption, managedDeviceIdOption, bodyOption, outputOption, queryOption, jsonNoIndentOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        ...
        public DeviceCompliancePolicyStatesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/managedDevices/{managedDevice%2Did}/deviceCompliancePolicyStates{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
