...
namespace ApiSdk.Users.Item.ManagedDevices.Item.DeviceCompliancePolicyStates.Item {
    ...
    public class DeviceCompliancePolicyStateRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string userId, string managedDeviceId, string deviceCompliancePolicyStateId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, userIdOption, managedDeviceIdOption, deviceCompliancePolicyStateIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// Device compliance policy states for this device.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string userId, string managedDeviceId, string deviceCompliancePolicyStateId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, userIdOption, managedDeviceIdOption, deviceCompliancePolicyStateIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// Device compliance policy states for this device.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string userId, string managedDeviceId, string deviceCompliancePolicyStateId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, userIdOption, managedDeviceIdOption, deviceCompliancePolicyStateIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
