...
namespace ApiSdk.Users.Item.ManagedDevices.Item.UpdateWindowsDeviceAccount {
    ...
    public class UpdateWindowsDeviceAccountRequestBuilder {
        ...
        public UpdateWindowsDeviceAccountRequestBuilder(Dictionary<string, object> pathParameters) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            UrlTemplate = "{+baseurl}/users/{user%2Did}/managedDevices/{managedDevice%2Did}/updateWindowsDeviceAccount";
