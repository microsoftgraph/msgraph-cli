...
namespace ApiSdk.Users.Item.ManagedDevices.Item.DeviceConfigurationStates {
    ...
    public class DeviceConfigurationStatesRequestBuilder {
        ...
        public Command BuildCreateCommand() {
            ...
            }, new CollectionBinding(userIdOption, managedDeviceIdOption, bodyOption, outputOption, queryOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// Device configuration states for this device.
