...
namespace ApiSdk.Users.Item.ManagedDevices {
    ...
    public class ManagedDevicesRequestBuilder : BaseCliRequestBuilder {
        ...
        public ManagedDevicesRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/users/{user%2Did}/managedDevices{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// The managed devices associated with the user.
        /// </summary>
