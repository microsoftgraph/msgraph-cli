...
namespace ApiSdk.Users.Item.Authentication.WindowsHelloForBusinessMethods.Item.Device.RegisteredOwners.Item.AppRoleAssignment {
    /// <summary>
    ...
    public class AppRoleAssignmentRequestBuilder {
        ...
        public AppRoleAssignmentRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/authentication/windowsHelloForBusinessMethods/{windowsHelloForBusinessAuthenticationMethod%2Did}/device/registeredOwners/{directoryObject%2Did}/microsoft.graph.appRoleAssignment{?%24select,%24expand}";
