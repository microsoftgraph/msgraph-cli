...
namespace ApiSdk.Users.Item.Authentication.WindowsHelloForBusinessMethods.Item.Device.RegisteredUsers.AppRoleAssignment.Count {
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/authentication/windowsHelloForBusinessMethods/{windowsHelloForBusinessAuthenticationMethod%2Did}/device/registeredUsers/microsoft.graph.appRoleAssignment/$count";
