...
using ApiSdk.Users.Item.Authentication.WindowsHelloForBusinessMethods.Item.Device.RegisteredOwners.ServicePrincipal.Count;
...
namespace ApiSdk.Users.Item.Authentication.WindowsHelloForBusinessMethods.Item.Device.RegisteredOwners.ServicePrincipal {
    ...
    public class ServicePrincipalRequestBuilder {
        ...
        public ServicePrincipalRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/authentication/windowsHelloForBusinessMethods/{windowsHelloForBusinessAuthenticationMethod%2Did}/device/registeredOwners/microsoft.graph.servicePrincipal{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
