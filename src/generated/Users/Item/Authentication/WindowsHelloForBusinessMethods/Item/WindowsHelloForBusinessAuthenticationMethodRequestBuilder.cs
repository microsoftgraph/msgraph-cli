...
namespace ApiSdk.Users.Item.Authentication.WindowsHelloForBusinessMethods.Item {
    ...
    public class WindowsHelloForBusinessAuthenticationMethodRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string userId, string windowsHelloForBusinessAuthenticationMethodId, IConsole console) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string userId, string windowsHelloForBusinessAuthenticationMethodId, string[] select, string[] expand, FormatterType output, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string userId, string windowsHelloForBusinessAuthenticationMethodId, string body, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
