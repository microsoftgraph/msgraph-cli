...
namespace ApiSdk.Users.Item.Authentication.WindowsHelloForBusinessMethods.Item {
    ...
    public class WindowsHelloForBusinessAuthenticationMethodRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string userId, string windowsHelloForBusinessAuthenticationMethodId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, userIdOption, windowsHelloForBusinessAuthenticationMethodIdOption, new ServiceProviderBinder());
            return command;
        }
        public Command BuildDeviceCommand() {
            var command = new Command("device");
            var builder = new ApiSdk.Users.Item.Authentication.WindowsHelloForBusinessMethods.Item.Device.DeviceRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string userId, string windowsHelloForBusinessAuthenticationMethodId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, userIdOption, windowsHelloForBusinessAuthenticationMethodIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        ...
        public Command BuildPatchCommand() {
            ...
            command.Description = "Update the navigation property windowsHelloForBusinessMethods in users";
            // Create options for all the parameters
            var userIdOption = new Option<string>("--user-id", description: "key: id of user") {
            };
            userIdOption.IsRequired = true;
            ...
            command.SetHandler(async (string userId, string windowsHelloForBusinessAuthenticationMethodId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, userIdOption, windowsHelloForBusinessAuthenticationMethodIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
