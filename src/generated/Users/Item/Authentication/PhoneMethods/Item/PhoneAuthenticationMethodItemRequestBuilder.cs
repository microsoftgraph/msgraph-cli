...
namespace ApiSdk.Users.Item.Authentication.PhoneMethods.Item
{
    ...
    public class PhoneAuthenticationMethodItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildDisableSmsSignInNavCommand()
        {
            ...
            var builder = new ApiSdk.Users.Item.Authentication.PhoneMethods.Item.DisableSmsSignIn.DisableSmsSignInRequestBuilder(PathParameters);
        ...
        public Command BuildEnableSmsSignInNavCommand()
        {
            ...
            var builder = new ApiSdk.Users.Item.Authentication.PhoneMethods.Item.EnableSmsSignIn.EnableSmsSignInRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
