...
namespace ApiSdk.Users.Item.Authentication.SoftwareOathMethods {
    ...
    public class SoftwareOathMethodsRequestBuilder {
        ...
        public Command BuildCommand() {
            ...
            var builder = new SoftwareOathAuthenticationMethodItemRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildCreateCommand() {
            ...
            command.Description = "Create new navigation property to softwareOathMethods for users";
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<SoftwareOathAuthenticationMethod>(SoftwareOathAuthenticationMethod.CreateFromDiscriminatorValue);
