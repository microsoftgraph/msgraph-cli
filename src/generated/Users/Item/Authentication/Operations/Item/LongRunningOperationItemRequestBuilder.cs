...
namespace ApiSdk.Users.Item.Authentication.Operations.Item {
    ...
    public class LongRunningOperationItemRequestBuilder {
        ...
        public LongRunningOperationItemRequestBuilder(Dictionary<string, object> pathParameters) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            UrlTemplate = "{+baseurl}/users/{user%2Did}/authentication/operations/{longRunningOperation%2Did}{?%24select,%24expand}";
