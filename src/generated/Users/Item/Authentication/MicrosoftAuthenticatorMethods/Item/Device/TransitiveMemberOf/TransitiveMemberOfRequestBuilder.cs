...
using ApiSdk.Users.Item.Authentication.MicrosoftAuthenticatorMethods.Item.Device.TransitiveMemberOf.Application;
using ApiSdk.Users.Item.Authentication.MicrosoftAuthenticatorMethods.Item.Device.TransitiveMemberOf.Count;
using ApiSdk.Users.Item.Authentication.MicrosoftAuthenticatorMethods.Item.Device.TransitiveMemberOf.Device;
using ApiSdk.Users.Item.Authentication.MicrosoftAuthenticatorMethods.Item.Device.TransitiveMemberOf.Group;
using ApiSdk.Users.Item.Authentication.MicrosoftAuthenticatorMethods.Item.Device.TransitiveMemberOf.Item;
using ApiSdk.Users.Item.Authentication.MicrosoftAuthenticatorMethods.Item.Device.TransitiveMemberOf.OrgContact;
using ApiSdk.Users.Item.Authentication.MicrosoftAuthenticatorMethods.Item.Device.TransitiveMemberOf.ServicePrincipal;
using ApiSdk.Users.Item.Authentication.MicrosoftAuthenticatorMethods.Item.Device.TransitiveMemberOf.User;
...
namespace ApiSdk.Users.Item.Authentication.MicrosoftAuthenticatorMethods.Item.Device.TransitiveMemberOf {
    ...
    public class TransitiveMemberOfRequestBuilder {
        ...
        public Command BuildDeviceCommand() {
            ...
            var builder = new ApiSdk.Users.Item.Authentication.MicrosoftAuthenticatorMethods.Item.Device.TransitiveMemberOf.Device.DeviceRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildCountCommand());
            command.AddCommand(builder.BuildGetCommand());
            return command;
        }
