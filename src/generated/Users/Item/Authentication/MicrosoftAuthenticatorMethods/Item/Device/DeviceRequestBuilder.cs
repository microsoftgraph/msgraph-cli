...
namespace ApiSdk.Users.Item.Authentication.MicrosoftAuthenticatorMethods.Item.Device {
    ...
    public class DeviceRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string userId, string microsoftAuthenticatorAuthenticationMethodId, string[] select, string[] expand) => {
            ...
            }, userIdOption, microsoftAuthenticatorAuthenticationMethodIdOption, selectOption, expandOption);
            return command;
        }
        /// <summary>
        /// The registered device on which Microsoft Authenticator resides. This property is null if the device is not registered for passwordless Phone Sign-In.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string userId, string microsoftAuthenticatorAuthenticationMethodId, string body) => {
