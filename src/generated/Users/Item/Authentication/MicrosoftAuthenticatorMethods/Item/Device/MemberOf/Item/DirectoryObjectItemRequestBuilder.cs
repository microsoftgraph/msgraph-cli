...
namespace ApiSdk.Users.Item.Authentication.MicrosoftAuthenticatorMethods.Item.Device.MemberOf.Item {
    ...
    public class DirectoryObjectItemRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.Description = "Groups that this device is a member of. Read-only. Nullable. Supports $expand.";
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                var directoryObjectId = (string) parameters[2];
        ...
        public DirectoryObjectItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/authentication/microsoftAuthenticatorMethods/{microsoftAuthenticatorAuthenticationMethod_id}/device/memberOf/{directoryObject_id}{?select,expand}";
