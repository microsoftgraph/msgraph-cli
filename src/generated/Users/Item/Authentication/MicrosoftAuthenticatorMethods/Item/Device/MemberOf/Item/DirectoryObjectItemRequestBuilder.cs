...
using ApiSdk.Users.Item.Authentication.MicrosoftAuthenticatorMethods.Item.Device.MemberOf.Item.Application;
using ApiSdk.Users.Item.Authentication.MicrosoftAuthenticatorMethods.Item.Device.MemberOf.Item.Device;
using ApiSdk.Users.Item.Authentication.MicrosoftAuthenticatorMethods.Item.Device.MemberOf.Item.Group;
using ApiSdk.Users.Item.Authentication.MicrosoftAuthenticatorMethods.Item.Device.MemberOf.Item.OrgContact;
using ApiSdk.Users.Item.Authentication.MicrosoftAuthenticatorMethods.Item.Device.MemberOf.Item.ServicePrincipal;
using ApiSdk.Users.Item.Authentication.MicrosoftAuthenticatorMethods.Item.Device.MemberOf.Item.User;
...
namespace ApiSdk.Users.Item.Authentication.MicrosoftAuthenticatorMethods.Item.Device.MemberOf.Item {
    ...
    public class DirectoryObjectItemRequestBuilder {
        ...
        public Command BuildDeviceCommand() {
            ...
            var builder = new ApiSdk.Users.Item.Authentication.MicrosoftAuthenticatorMethods.Item.Device.MemberOf.Item.Device.DeviceRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildGetCommand());
            return command;
        }
        /// <summary>
        ...
        public DirectoryObjectItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/authentication/microsoftAuthenticatorMethods/{microsoftAuthenticatorAuthenticationMethod%2Did}/device/memberOf/{directoryObject%2Did}{?%24select,%24expand}";
