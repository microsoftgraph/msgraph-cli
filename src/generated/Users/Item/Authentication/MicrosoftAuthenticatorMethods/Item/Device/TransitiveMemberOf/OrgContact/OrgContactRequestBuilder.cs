...
using ApiSdk.Users.Item.Authentication.MicrosoftAuthenticatorMethods.Item.Device.TransitiveMemberOf.OrgContact.Count;
...
namespace ApiSdk.Users.Item.Authentication.MicrosoftAuthenticatorMethods.Item.Device.TransitiveMemberOf.OrgContact {
    ...
    public class OrgContactRequestBuilder {
        ...
        public OrgContactRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/authentication/microsoftAuthenticatorMethods/{microsoftAuthenticatorAuthenticationMethod%2Did}/device/transitiveMemberOf/microsoft.graph.orgContact{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
