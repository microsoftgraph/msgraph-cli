...
using ApiSdk.Users.Item.Authentication.MicrosoftAuthenticatorMethods.Item.Device.MemberOf.Application;
using ApiSdk.Users.Item.Authentication.MicrosoftAuthenticatorMethods.Item.Device.MemberOf.Count;
using ApiSdk.Users.Item.Authentication.MicrosoftAuthenticatorMethods.Item.Device.MemberOf.Device;
using ApiSdk.Users.Item.Authentication.MicrosoftAuthenticatorMethods.Item.Device.MemberOf.Group;
using ApiSdk.Users.Item.Authentication.MicrosoftAuthenticatorMethods.Item.Device.MemberOf.Item;
using ApiSdk.Users.Item.Authentication.MicrosoftAuthenticatorMethods.Item.Device.MemberOf.OrgContact;
using ApiSdk.Users.Item.Authentication.MicrosoftAuthenticatorMethods.Item.Device.MemberOf.ServicePrincipal;
using ApiSdk.Users.Item.Authentication.MicrosoftAuthenticatorMethods.Item.Device.MemberOf.User;
...
namespace ApiSdk.Users.Item.Authentication.MicrosoftAuthenticatorMethods.Item.Device.MemberOf {
    ...
    public class MemberOfRequestBuilder {
        ...
        public Command BuildDeviceCommand() {
            ...
            var builder = new ApiSdk.Users.Item.Authentication.MicrosoftAuthenticatorMethods.Item.Device.MemberOf.Device.DeviceRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildCountCommand());
            command.AddCommand(builder.BuildGetCommand());
            return command;
        }
