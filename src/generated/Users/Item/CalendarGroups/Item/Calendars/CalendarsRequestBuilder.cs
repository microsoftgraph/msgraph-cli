...
namespace ApiSdk.Users.Item.CalendarGroups.Item.Calendars {
    ...
    public class CalendarsRequestBuilder {
        ...
        public Command BuildListCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, int?, int?, string, bool?, string[], string[]>(async (userId, calendarGroupId, top, skip, filter, count, orderby, select) => {
