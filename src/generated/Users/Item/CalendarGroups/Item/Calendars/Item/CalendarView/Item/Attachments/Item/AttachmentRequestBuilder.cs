...
namespace ApiSdk.Users.Item.CalendarGroups.Item.Calendars.Item.CalendarView.Item.Attachments.Item {
    ...
    public class AttachmentRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string userId, string calendarGroupId, string calendarId, string eventId, string attachmentId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, userIdOption, calendarGroupIdOption, calendarIdOption, eventIdOption, attachmentIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The collection of FileAttachment, ItemAttachment, and referenceAttachment attachments for the event. Navigation property. Read-only. Nullable.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string userId, string calendarGroupId, string calendarId, string eventId, string attachmentId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, userIdOption, calendarGroupIdOption, calendarIdOption, eventIdOption, attachmentIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The collection of FileAttachment, ItemAttachment, and referenceAttachment attachments for the event. Navigation property. Read-only. Nullable.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string userId, string calendarGroupId, string calendarId, string eventId, string attachmentId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, userIdOption, calendarGroupIdOption, calendarIdOption, eventIdOption, attachmentIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
