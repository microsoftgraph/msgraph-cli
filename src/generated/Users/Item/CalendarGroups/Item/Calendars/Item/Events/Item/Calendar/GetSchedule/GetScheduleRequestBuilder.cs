    ...
    public class GetScheduleRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string, string, string>(async (userId, calendarGroupId, calendarId, eventId, body) => {
                ...
                var result = await RequestAdapter.SendCollectionAsync<ApiSdk.Users.Item.CalendarGroups.Item.Calendars.Item.Events.Item.Calendar.GetSchedule.GetSchedule>(requestInfo);
