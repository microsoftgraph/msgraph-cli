...
namespace ApiSdk.Users.Item.CalendarGroups.Item.Calendars.Item.Events.Item.Extensions.Item {
    ...
    public class ExtensionRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string, string, string, object, object>(async (userId, calendarGroupId, calendarId, eventId, extensionId, select, expand) => {
