...
namespace ApiSdk.Users.Item.CalendarGroups.Item.Calendars.Item.Events.Item.SingleValueExtendedProperties.Item {
    ...
    public class SingleValueLegacyExtendedPropertyRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string userId, string calendarGroupId, string calendarId, string eventId, string singleValueLegacyExtendedPropertyId) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string userId, string calendarGroupId, string calendarId, string eventId, string singleValueLegacyExtendedPropertyId, string[] select, string[] expand) => {
            ...
            }, userIdOption, calendarGroupIdOption, calendarIdOption, eventIdOption, singleValueLegacyExtendedPropertyIdOption, selectOption, expandOption);
            return command;
        }
        /// <summary>
        /// The collection of single-value extended properties defined for the event. Read-only. Nullable.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string userId, string calendarGroupId, string calendarId, string eventId, string singleValueLegacyExtendedPropertyId, string body) => {
