...
namespace ApiSdk.Users.Item.CalendarGroups.Item.Calendars.Item.CalendarPermissions.Item {
    ...
    public class CalendarPermissionRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string userId, string calendarGroupId, string calendarId, string calendarPermissionId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, userIdOption, calendarGroupIdOption, calendarIdOption, calendarPermissionIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The permissions of the users with whom the calendar is shared.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string userId, string calendarGroupId, string calendarId, string calendarPermissionId, string[] select, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, userIdOption, calendarGroupIdOption, calendarIdOption, calendarPermissionIdOption, selectOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The permissions of the users with whom the calendar is shared.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string userId, string calendarGroupId, string calendarId, string calendarPermissionId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, userIdOption, calendarGroupIdOption, calendarIdOption, calendarPermissionIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
