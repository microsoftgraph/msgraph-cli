...
namespace ApiSdk.Users.Item.CalendarGroups.Item.Calendars.Item.CalendarPermissions {
    ...
    public class CalendarPermissionsRequestBuilder {
        ...
        public Command BuildListCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string, int?, int?, string, bool?, string[], string[]>(async (userId, calendarGroupId, calendarId, top, skip, filter, count, orderby, select) => {
