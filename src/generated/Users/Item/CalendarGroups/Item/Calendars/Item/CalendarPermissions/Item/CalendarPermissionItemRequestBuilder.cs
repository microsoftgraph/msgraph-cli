...
namespace ApiSdk.Users.Item.CalendarGroups.Item.Calendars.Item.CalendarPermissions.Item {
    ...
    public class CalendarPermissionItemRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            }, new CollectionBinding(userIdOption, calendarGroupIdOption, calendarIdOption, calendarPermissionIdOption, ifMatchOption, new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
