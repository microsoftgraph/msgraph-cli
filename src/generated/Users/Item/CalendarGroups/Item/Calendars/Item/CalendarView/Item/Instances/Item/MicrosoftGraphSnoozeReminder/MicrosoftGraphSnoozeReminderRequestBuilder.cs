...
namespace ApiSdk.Users.Item.CalendarGroups.Item.Calendars.Item.CalendarView.Item.Instances.Item.MicrosoftGraphSnoozeReminder {
    /// <summary>
    ...
    public class MicrosoftGraphSnoozeReminderRequestBuilder {
        ...
        public MicrosoftGraphSnoozeReminderRequestBuilder(Dictionary<string, object> pathParameters) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            UrlTemplate = "{+baseurl}/users/{user%2Did}/calendarGroups/{calendarGroup%2Did}/calendars/{calendar%2Did}/calendarView/{event%2Did}/instances/{event%2Did1}/microsoft.graph.snoozeReminder";
