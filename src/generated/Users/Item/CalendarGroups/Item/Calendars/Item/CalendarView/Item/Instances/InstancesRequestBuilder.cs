...
namespace ApiSdk.Users.Item.CalendarGroups.Item.Calendars.Item.CalendarView.Item.Instances {
    ...
    public class InstancesRequestBuilder {
        ...
        public Command BuildListCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string, string, int?, int?, string, bool?, object, object>(async (userId, calendarGroupId, calendarId, eventId, top, skip, filter, count, orderby, select) => {
