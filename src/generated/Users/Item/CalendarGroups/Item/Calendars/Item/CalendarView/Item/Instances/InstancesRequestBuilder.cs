...
namespace ApiSdk.Users.Item.CalendarGroups.Item.Calendars.Item.CalendarView.Item.Instances {
    ...
    public class InstancesRequestBuilder {
        ...
        public Command BuildListCommand() {
            ...
            command.AddOption(outputOption);
            command.SetHandler(async (string userId, string calendarGroupId, string calendarId, string eventId, int? top, int? skip, string filter, bool? count, string[] orderby, string[] select, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, userIdOption, calendarGroupIdOption, calendarIdOption, eventIdOption, topOption, skipOption, filterOption, countOption, orderbyOption, selectOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
