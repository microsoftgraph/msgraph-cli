...
namespace ApiSdk.Users.Item.CalendarGroups.Item.Calendars.Item.GetSchedule {
    ...
    public class GetScheduleRequestBody : IAdditionalDataHolder, IParsable {
        ...
        /// </summary>
        public static ApiSdk.Users.Item.CalendarGroups.Item.Calendars.Item.GetSchedule.GetScheduleRequestBody CreateFromDiscriminatorValue(IParseNode parseNode) {
