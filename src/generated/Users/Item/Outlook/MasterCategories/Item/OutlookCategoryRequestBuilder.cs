...
namespace ApiSdk.Users.Item.Outlook.MasterCategories.Item {
    ...
    public class OutlookCategoryRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string userId, string outlookCategoryId, IConsole console) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string userId, string outlookCategoryId, string[] select, FormatterType output, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string userId, string outlookCategoryId, string body, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
