...
namespace ApiSdk.Users.Item.Outlook.MasterCategories.Item {
    ...
    public class OutlookCategoryItemRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(userIdOption, outlookCategoryIdOption, selectOption, outputOption, outputFilterOption, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// A list of categories defined for the user.
