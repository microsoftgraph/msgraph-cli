    ...
    public class GetScheduleRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Users.Item.Calendar.GetSchedule.GetScheduleRequestBody>(ApiSdk.Users.Item.Calendar.GetSchedule.GetScheduleRequestBody.CreateFromDiscriminatorValue);
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ApiSdk.Users.Item.Calendar.GetSchedule.GetScheduleRequestBody body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
