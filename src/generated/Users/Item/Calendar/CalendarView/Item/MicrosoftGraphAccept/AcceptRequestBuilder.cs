...
namespace ApiSdk.Users.Item.Calendar.CalendarView.Item.MicrosoftGraphAccept {
    /// <summary>
    ...
    public class AcceptRequestBuilder {
        ...
        public AcceptRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/calendar/calendarView/{event%2Did}/microsoft.graph.accept";
