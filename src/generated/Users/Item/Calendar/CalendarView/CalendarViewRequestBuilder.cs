...
namespace ApiSdk.Users.Item.Calendar.CalendarView {
    ...
    public class CalendarViewRequestBuilder {
        ...
        public Command BuildListCommand() {
            ...
            command.AddOption(outputOption);
            command.SetHandler(async (string userId, string startDateTime, string endDateTime, int? top, int? skip, string filter, bool? count, string[] orderby, string[] select, FormatterType output, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
