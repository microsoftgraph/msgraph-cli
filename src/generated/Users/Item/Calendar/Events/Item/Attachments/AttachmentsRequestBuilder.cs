...
namespace ApiSdk.Users.Item.Calendar.Events.Item.Attachments {
    ...
    public class AttachmentsRequestBuilder {
        ...
        public Command BuildListCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, int?, int?, string, bool?, object, object, object>(async (userId, eventId, top, skip, filter, count, orderby, select, expand) => {
