...
namespace ApiSdk.Users.Item.AppRoleAssignments.Item {
    ...
    public class AppRoleAssignmentRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string userId, string appRoleAssignmentId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, userIdOption, appRoleAssignmentIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// Represents the app roles a user has been granted for an application. Supports $expand.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string userId, string appRoleAssignmentId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, userIdOption, appRoleAssignmentIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// Represents the app roles a user has been granted for an application. Supports $expand.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string userId, string appRoleAssignmentId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, userIdOption, appRoleAssignmentIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
