...
namespace ApiSdk.Users.Item.AppRoleAssignments.Item {
    ...
    public class AppRoleAssignmentRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string>(async (userId, appRoleAssignmentId) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, object, object>(async (userId, appRoleAssignmentId, select, expand) => {
        ...
        public Command BuildPatchCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string>(async (userId, appRoleAssignmentId, body) => {
