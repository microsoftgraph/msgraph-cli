...
namespace ApiSdk.Users.Item.AppRoleAssignments
{
    ...
    public partial class AppRoleAssignmentsRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildCreateCommand()
        {
            ...
            command.Description = "Assign an app role to a user, creating an appRoleAssignment object. To grant an app role assignment to a user, you need three identifiers:\n\nFind more info here:\n  https://learn.microsoft.com/graph/api/user-post-approleassignments?view=graph-rest-1.0";
