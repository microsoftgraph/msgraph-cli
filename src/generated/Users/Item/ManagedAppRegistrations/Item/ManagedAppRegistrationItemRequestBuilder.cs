...
namespace ApiSdk.Users.Item.ManagedAppRegistrations.Item {
    ...
    public class ManagedAppRegistrationItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public ManagedAppRegistrationItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/users/{user%2Did}/managedAppRegistrations/{managedAppRegistration%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Zero or more managed app registrations that belong to the user.
        /// </summary>
