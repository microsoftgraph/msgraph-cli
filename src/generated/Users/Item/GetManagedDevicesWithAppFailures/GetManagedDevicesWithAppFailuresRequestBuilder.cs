...
namespace ApiSdk.Users.Item.GetManagedDevicesWithAppFailures {
    ...
    public class GetManagedDevicesWithAppFailuresRequestBuilder {
        ...
        public GetManagedDevicesWithAppFailuresRequestBuilder(Dictionary<string, object> pathParameters) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            UrlTemplate = "{+baseurl}/users/{user%2Did}/getManagedDevicesWithAppFailures(){?%24top,%24skip,%24search,%24filter,%24count}";
