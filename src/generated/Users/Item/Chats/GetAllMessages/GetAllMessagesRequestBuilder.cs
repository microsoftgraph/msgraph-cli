...
namespace ApiSdk.Users.Item.Chats.GetAllMessages {
    ...
    public class GetAllMessagesRequestBuilder : BaseCliRequestBuilder {
        ...
        public GetAllMessagesRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/users/{user%2Did}/chats/getAllMessages(){?%24count,%24filter,%24orderby,%24search,%24select,%24skip,%24top,model*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new GetAllMessagesRequestBuilder and sets the default values.
        /// </summary>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public GetAllMessagesRequestBuilder(string rawUrl) : base("{+baseurl}/users/{user%2Did}/chats/getAllMessages(){?%24count,%24filter,%24orderby,%24search,%24select,%24skip,%24top,model*}", rawUrl) {
        }
        /// <summary>
        /// Invoke function getAllMessages
        /// </summary>
