...
namespace ApiSdk.Users.Item.Chats {
    public class ChatsResponse : IAdditionalDataHolder, IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as ChatsResponse).Value = n.GetCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.Chat>(ApiSdk.Models.Microsoft.Graph.Chat.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
