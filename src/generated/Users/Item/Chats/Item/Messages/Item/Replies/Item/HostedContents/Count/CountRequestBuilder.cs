...
namespace ApiSdk.Users.Item.Chats.Item.Messages.Item.Replies.Item.HostedContents.Count {
    ...
    public class CountRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(userIdOption, chatIdOption, chatMessageIdOption, chatMessageId1Option, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
