...
namespace ApiSdk.Users.Item.Oauth2PermissionGrants.@Ref {
    ...
    public class RefRequestBuilder {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<ApiSdk.Users.Item.Oauth2PermissionGrants.@Ref.@Ref> PostAsync(ApiSdk.Users.Item.Oauth2PermissionGrants.@Ref.@Ref model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
