...
namespace ApiSdk.Users.Item.Messages.Item.Extensions.Item {
    ...
    public class ExtensionRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string>(async (userId, messageId, extensionId) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string, object, object>(async (userId, messageId, extensionId, select, expand) => {
        ...
        public Command BuildPatchCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string, string>(async (userId, messageId, extensionId, body) => {
