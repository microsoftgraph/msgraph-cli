...
namespace ApiSdk.Users.Item.Messages.Item.Extensions.Item {
    ...
    public class ExtensionItemRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(userIdOption, messageIdOption, extensionIdOption, selectOption, expandOption, outputOption, outputFilterOption, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// The collection of open extensions defined for the message. Nullable.
