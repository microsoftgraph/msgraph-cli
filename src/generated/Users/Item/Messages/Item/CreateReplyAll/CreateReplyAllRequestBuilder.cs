    ...
    public class CreateReplyAllRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                var model = parseNode.GetObjectValue<CreateReplyAllRequestBody>(CreateReplyAllRequestBody.CreateFromDiscriminatorValue);
        ...
        public class CreateReplyAllResponse : IAdditionalDataHolder, IParsable {
            ...
            public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
                return new Dictionary<string, Action<T, IParseNode>> {
                    {"message", (o,n) => { (o as CreateReplyAllResponse).Message = n.GetObjectValue<ApiSdk.Models.Microsoft.Graph.Message>(ApiSdk.Models.Microsoft.Graph.Message.CreateFromDiscriminatorValue); } },
                };
            }
            /// <summary>
