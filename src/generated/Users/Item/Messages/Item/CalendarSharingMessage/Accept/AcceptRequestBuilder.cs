...
namespace ApiSdk.Users.Item.Messages.Item.CalendarSharingMessage.Accept {
    ...
    public class AcceptRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (string userId, string messageId, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, userIdOption, messageIdOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
