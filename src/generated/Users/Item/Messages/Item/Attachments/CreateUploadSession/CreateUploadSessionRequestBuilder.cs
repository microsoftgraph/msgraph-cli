...
namespace ApiSdk.Users.Item.Messages.Item.Attachments.CreateUploadSession {
    ...
    public class CreateUploadSessionRequestBuilder {
        ...
        /// </summary>
        public async Task<CreateUploadSessionResponse> PostAsync(CreateUploadSessionRequestBody model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
