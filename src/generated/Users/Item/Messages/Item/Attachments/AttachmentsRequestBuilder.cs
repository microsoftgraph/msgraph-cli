...
namespace ApiSdk.Users.Item.Messages.Item.Attachments {
    ...
    public class AttachmentsRequestBuilder {
        ...
        public Command BuildListCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, int?, int?, string, bool?, object, object, object>(async (userId, messageId, top, skip, filter, count, orderby, select, expand) => {
