...
namespace ApiSdk.Users.Item.Messages.Item.SingleValueExtendedProperties {
    ...
    public class SingleValueExtendedPropertiesRequestBuilder {
        ...
        public Command BuildListCommand() {
            ...
            command.SetHandler(async (string userId, string messageId, int? top, int? skip, string search, string filter, bool? count, string[] orderby, string[] select, string[] expand) => {
                ...
                var strContent = await reader.ReadToEndAsync();
                Console.Write(strContent + "\n");
            }, userIdOption, messageIdOption, topOption, skipOption, searchOption, filterOption, countOption, orderbyOption, selectOption, expandOption);
            return command;
        }
        /// <summary>
