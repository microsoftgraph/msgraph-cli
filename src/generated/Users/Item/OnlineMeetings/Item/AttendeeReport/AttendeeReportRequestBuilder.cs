...
namespace ApiSdk.Users.Item.OnlineMeetings.Item.AttendeeReport {
    ...
    public class AttendeeReportRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string userId, string onlineMeetingId, FileInfo output) => {
            ...
            }, userIdOption, onlineMeetingIdOption, outputOption);
            return command;
        }
        /// <summary>
        ...
        public Command BuildPutCommand() {
            ...
            command.SetHandler(async (string userId, string onlineMeetingId, FileInfo file) => {
