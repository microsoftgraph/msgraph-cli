...
namespace ApiSdk.Users.Item.OnlineMeetings.Item.AttendanceReports.Item {
    ...
    public class MeetingAttendanceReportRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string userId, string onlineMeetingId, string meetingAttendanceReportId, IConsole console) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string userId, string onlineMeetingId, string meetingAttendanceReportId, string[] select, string[] expand, FormatterType output, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string userId, string onlineMeetingId, string meetingAttendanceReportId, string body, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
