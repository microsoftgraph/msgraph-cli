...
namespace ApiSdk.Users.Item.OnlineMeetings.Item.AttendanceReports {
    ...
    public class AttendanceReportsRequestBuilder {
        ...
        public Command BuildCreateCommand() {
            ...
            }, new CollectionBinding(userIdOption, onlineMeetingIdOption, bodyOption, outputOption, queryOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// The attendance reports of an online meeting. Read-only.
