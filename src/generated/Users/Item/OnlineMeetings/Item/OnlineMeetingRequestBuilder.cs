...
namespace ApiSdk.Users.Item.OnlineMeetings.Item {
    ...
    public class OnlineMeetingRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string userId, string onlineMeetingId, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                var requestInfo = CreateDeleteRequestInformation(q => {
                });
                await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                console.WriteLine("Success");
            }, userIdOption, onlineMeetingIdOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string userId, string onlineMeetingId, string[] select, string[] expand, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
            ...
            }, userIdOption, onlineMeetingIdOption, selectOption, expandOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string userId, string onlineMeetingId, string body, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
