...
namespace ApiSdk.Users.Item.OnlineMeetings.Item {
    ...
    public class OnlineMeetingItemRequestBuilder {
        ...
        public Command BuildAttendanceReportsCommand() {
            ...
            var builder = new AttendanceReportsRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildAttendeeReportCommand() {
            ...
            var builder = new AttendeeReportRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildDeleteCommand() {
            ...
            }, new CollectionBinding(userIdOption, onlineMeetingIdOption, ifMatchOption, new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(userIdOption, onlineMeetingIdOption, selectOption, expandOption, outputOption, queryOption, jsonNoIndentOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        ...
        public OnlineMeetingItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/onlineMeetings/{onlineMeeting%2Did}{?%24select,%24expand}";
