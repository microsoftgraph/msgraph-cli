...
namespace ApiSdk.Users.Item.Contacts.Item.Extensions {
    ...
    public class ExtensionsRequestBuilder {
        ...
        public Command BuildListCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, int?, int?, string, bool?, object, object, object>(async (userId, contactId, top, skip, filter, count, orderby, select, expand) => {
