...
namespace ApiSdk.Users.Item.Contacts.Item.Photo.Value {
    ...
    public class ContentRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string userId, string contactId, FileInfo output) => {
            ...
            }, userIdOption, contactIdOption, outputOption);
            return command;
        }
        /// <summary>
        /// The user's profile photo. Read-only.
        ...
        public Command BuildPutCommand() {
            ...
            command.SetHandler(async (string userId, string contactId, FileInfo file) => {
