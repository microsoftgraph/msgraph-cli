...
using ApiSdk.Users.Item.OwnedDevices.MicrosoftGraphAppRoleAssignment.Count;
...
namespace ApiSdk.Users.Item.OwnedDevices.MicrosoftGraphAppRoleAssignment {
    /// <summary>
    ...
    public class AppRoleAssignmentRequestBuilder {
        ...
        public AppRoleAssignmentRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/ownedDevices/microsoft.graph.appRoleAssignment{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
