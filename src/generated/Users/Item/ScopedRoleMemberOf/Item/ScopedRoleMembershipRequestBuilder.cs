...
namespace ApiSdk.Users.Item.ScopedRoleMemberOf.Item {
    ...
    public class ScopedRoleMembershipRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string userId, string scopedRoleMembershipId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, userIdOption, scopedRoleMembershipIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The scoped-role administrative unit memberships for this user. Read-only. Nullable.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string userId, string scopedRoleMembershipId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, userIdOption, scopedRoleMembershipIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The scoped-role administrative unit memberships for this user. Read-only. Nullable.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string userId, string scopedRoleMembershipId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, userIdOption, scopedRoleMembershipIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
