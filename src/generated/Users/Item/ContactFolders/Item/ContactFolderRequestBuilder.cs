...
namespace ApiSdk.Users.Item.ContactFolders.Item {
    ...
    public class ContactFolderRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            }, userIdOption, contactFolderIdOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// The user's contacts folders. Read-only. Nullable.
        ...
        public Command BuildGetCommand() {
            ...
            }, userIdOption, contactFolderIdOption, selectOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string userId, string contactFolderId, string body, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                ...
                await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                console.WriteLine("Success");
            }, userIdOption, contactFolderIdOption, bodyOption, new OutputFormatterFactoryBinder());
            return command;
        }
