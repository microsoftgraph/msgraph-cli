...
namespace ApiSdk.Users.Item.ContactFolders.Item.MultiValueExtendedProperties {
    ...
    public class MultiValueExtendedPropertiesRequestBuilder {
        ...
        public Command BuildListCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, int?, int?, string, string, bool?, object, object, object>(async (userId, contactFolderId, top, skip, search, filter, count, orderby, select, expand) => {
