...
using ApiSdk.Users.Item.ContactFolders.Item.ChildFolders.Item.MultiValueExtendedProperties.Count;
using ApiSdk.Users.Item.ContactFolders.Item.ChildFolders.Item.MultiValueExtendedProperties.Item;
...
namespace ApiSdk.Users.Item.ContactFolders.Item.ChildFolders.Item.MultiValueExtendedProperties {
    /// <summary>
    ...
    public class MultiValueExtendedPropertiesRequestBuilder : BaseCliRequestBuilder {
        ...
        public MultiValueExtendedPropertiesRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/users/{user%2Did}/contactFolders/{contactFolder%2Did}/childFolders/{contactFolder%2Did1}/multiValueExtendedProperties{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// The collection of multi-value extended properties defined for the contactFolder. Read-only. Nullable.
        /// </summary>
