...
namespace ApiSdk.Users.Item.ContactFolders.Item.ChildFolders.Item {
    ...
    public class ContactFolderRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string userId, string contactFolderId, string contactFolderId1) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string userId, string contactFolderId, string contactFolderId1, string[] select, string[] expand) => {
            ...
            }, userIdOption, contactFolderIdOption, contactFolderId1Option, selectOption, expandOption);
            return command;
        }
        /// <summary>
        /// The collection of child folders in the folder. Navigation property. Read-only. Nullable.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string userId, string contactFolderId, string contactFolderId1, string body) => {
