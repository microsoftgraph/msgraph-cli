...
namespace ApiSdk.Users.Item.ContactFolders.Item.ChildFolders.Item {
    ...
    public class ContactFolderRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string>(async (userId, contactFolderId, contactFolderId1) => {
                ...
                if (!String.IsNullOrEmpty(contactFolderId1)) requestInfo.PathParameters.Add("contactFolder_id1", contactFolderId1);
        ...
        public Command BuildGetCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string, object, object>(async (userId, contactFolderId, contactFolderId1, select, expand) => {
        ...
        public Command BuildPatchCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string, string>(async (userId, contactFolderId, contactFolderId1, body) => {
