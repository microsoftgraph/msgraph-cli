...
namespace ApiSdk.Users.Item.ContactFolders.Item {
    ...
    public class ContactFolderItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public ContactFolderItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/users/{user%2Did}/contactFolders/{contactFolder%2Did}{?%24select}", pathParameters) {
        }
        /// <summary>
        /// Delete navigation property contactFolders for users
        /// </summary>
