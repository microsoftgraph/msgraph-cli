...
namespace ApiSdk.Users.Item.ContactFolders.Item
{
    ...
    public class ContactFolderItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildChildFoldersNavCommand()
        {
            ...
            var builder = new ApiSdk.Users.Item.ContactFolders.Item.ChildFolders.ChildFoldersRequestBuilder(PathParameters);
        ...
        public Command BuildContactsNavCommand()
        {
            ...
            var builder = new ApiSdk.Users.Item.ContactFolders.Item.Contacts.ContactsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Models.ContactFolder>(ApiSdk.Models.ContactFolder.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Users.Item.ContactFolders.Item.ContactFolderItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Users.Item.ContactFolders.Item.ContactFolderItemRequestBuilder.ContactFolderItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Users.Item.ContactFolders.Item.ContactFolderItemRequestBuilder.ContactFolderItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.ContactFolder body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.ContactFolder body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
