...
namespace ApiSdk.Users.Item.ContactFolders.Item.Contacts.Item {
    ...
    public class ContactItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public ContactItemRequestBuilder(string rawUrl) : base("{+baseurl}/users/{user%2Did}/contactFolders/{contactFolder%2Did}/contacts/{contact%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Delete navigation property contacts for users
        /// </summary>
