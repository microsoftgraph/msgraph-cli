...
namespace ApiSdk.Users.Item.ContactFolders.Item.Contacts.Item.Photo {
    ...
    public class PhotoRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string userId, string contactFolderId, string contactId, string[] select, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
            ...
            }, userIdOption, contactFolderIdOption, contactIdOption, selectOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// Optional contact picture. You can get or set a photo for a contact.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string userId, string contactFolderId, string contactId, string body, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
