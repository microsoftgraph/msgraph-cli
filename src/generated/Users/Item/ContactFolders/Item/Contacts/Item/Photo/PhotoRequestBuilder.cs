...
namespace ApiSdk.Users.Item.ContactFolders.Item.Contacts.Item.Photo {
    ...
    public class PhotoRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(userIdOption, contactFolderIdOption, contactIdOption, selectOption, outputOption, outputFilterOption, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// Optional contact picture. You can get or set a photo for a contact.
