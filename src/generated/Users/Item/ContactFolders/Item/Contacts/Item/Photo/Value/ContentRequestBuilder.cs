...
namespace ApiSdk.Users.Item.ContactFolders.Item.Contacts.Item.Photo.Value {
    ...
    public class ContentRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string userId, string contactFolderId, string contactId, FileInfo file, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, userIdOption, contactFolderIdOption, contactIdOption, fileOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The user's profile photo. Read-only.
        ...
        public Command BuildPutCommand() {
            ...
            command.SetHandler(async (string userId, string contactFolderId, string contactId, FileInfo file, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
