...
namespace ApiSdk.Users.Item.ContactFolders.Item.Contacts.Item.MultiValueExtendedProperties.Item {
    ...
    public class MultiValueLegacyExtendedPropertyRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string, string, string[], string[]>(async (userId, contactFolderId, contactId, multiValueLegacyExtendedPropertyId, select, expand) => {
