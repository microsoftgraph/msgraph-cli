...
namespace ApiSdk.Users.Item.ContactFolders.MicrosoftGraphDelta {
    /// <summary>
    ...
    public class MicrosoftGraphDeltaRequestBuilder {
        ...
        public MicrosoftGraphDeltaRequestBuilder(Dictionary<string, object> pathParameters) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/contactFolders/microsoft.graph.delta(){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}";
