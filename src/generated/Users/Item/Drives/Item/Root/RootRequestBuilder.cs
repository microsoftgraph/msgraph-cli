...
using ApiSdk.Users.Item.Drives.Item.Root.Analytics;
using ApiSdk.Users.Item.Drives.Item.Root.Checkin;
using ApiSdk.Users.Item.Drives.Item.Root.Checkout;
using ApiSdk.Users.Item.Drives.Item.Root.Children;
using ApiSdk.Users.Item.Drives.Item.Root.Content;
using ApiSdk.Users.Item.Drives.Item.Root.Copy;
using ApiSdk.Users.Item.Drives.Item.Root.CreateLink;
using ApiSdk.Users.Item.Drives.Item.Root.CreateUploadSession;
using ApiSdk.Users.Item.Drives.Item.Root.Delta;
using ApiSdk.Users.Item.Drives.Item.Root.DeltaWithToken;
using ApiSdk.Users.Item.Drives.Item.Root.Follow;
using ApiSdk.Users.Item.Drives.Item.Root.GetActivitiesByInterval;
using ApiSdk.Users.Item.Drives.Item.Root.GetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithInterval;
using ApiSdk.Users.Item.Drives.Item.Root.Invite;
using ApiSdk.Users.Item.Drives.Item.Root.ListItem;
using ApiSdk.Users.Item.Drives.Item.Root.Permissions;
using ApiSdk.Users.Item.Drives.Item.Root.Preview;
using ApiSdk.Users.Item.Drives.Item.Root.Restore;
using ApiSdk.Users.Item.Drives.Item.Root.SearchWithQ;
using ApiSdk.Users.Item.Drives.Item.Root.Subscriptions;
using ApiSdk.Users.Item.Drives.Item.Root.Thumbnails;
using ApiSdk.Users.Item.Drives.Item.Root.Unfollow;
using ApiSdk.Users.Item.Drives.Item.Root.ValidatePermission;
using ApiSdk.Users.Item.Drives.Item.Root.Versions;
...
namespace ApiSdk.Users.Item.Drives.Item.Root {
    ...
    public class RootRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.Description = "Delete navigation property root for users";
        ...
        public Command BuildPatchCommand() {
            ...
            command.Description = "Update the navigation property root in users";
            // Create options for all the parameters
            var userIdOption = new Option<string>("--user-id", description: "key: id of user") {
            };
            userIdOption.IsRequired = true;
