...
using ApiSdk.Users.Item.Drives.Item.Root.ListItem.DocumentSetVersions.Item.Restore;
...
namespace ApiSdk.Users.Item.Drives.Item.Root.ListItem.DocumentSetVersions.Item {
    ...
    public class DocumentSetVersionItemRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.Description = "Delete navigation property documentSetVersions for users";
        ...
        public Command BuildPatchCommand() {
            ...
            command.Description = "Update the navigation property documentSetVersions in users";
            // Create options for all the parameters
            var userIdOption = new Option<string>("--user-id", description: "key: id of user") {
            };
            userIdOption.IsRequired = true;
