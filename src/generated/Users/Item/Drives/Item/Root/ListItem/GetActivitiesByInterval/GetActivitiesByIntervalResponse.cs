...
namespace ApiSdk.Users.Item.Drives.Item.Root.ListItem.GetActivitiesByInterval {
    ...
    public class GetActivitiesByIntervalResponse : IAdditionalDataHolder, IParsable {
        ...
        /// </summary>
        public static ApiSdk.Users.Item.Drives.Item.Root.ListItem.GetActivitiesByInterval.GetActivitiesByIntervalResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
