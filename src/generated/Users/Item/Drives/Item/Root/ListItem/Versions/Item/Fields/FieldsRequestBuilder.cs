...
namespace ApiSdk.Users.Item.Drives.Item.Root.ListItem.Versions.Item.Fields {
    ...
    public class FieldsRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            }, new CollectionBinding(userIdOption, driveIdOption, listItemVersionIdOption, new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        ...
        public FieldsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/drives/{drive_id}/root/listItem/versions/{listItemVersion_id}/fields{?select,expand}";
