...
using ApiSdk.Users.Item.Drives.Item.Root.ListItem.Versions.Count;
using ApiSdk.Users.Item.Drives.Item.Root.ListItem.Versions.Item;
...
namespace ApiSdk.Users.Item.Drives.Item.Root.ListItem.Versions {
    ...
    public class VersionsRequestBuilder {
        ...
        public VersionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/drives/{drive%2Did}/root/listItem/versions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
