...
using System.IO;
using System.Linq;
namespace ApiSdk.Users.Item.Drives.Item.Root.Permissions.Item.Grant {
    ...
    public class GrantRequestBody : IAdditionalDataHolder, IParsable {
        ...
        /// </summary>
        public static ApiSdk.Users.Item.Drives.Item.Root.Permissions.Item.Grant.GrantRequestBody CreateFromDiscriminatorValue(IParseNode parseNode) {
