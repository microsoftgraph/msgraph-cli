...
namespace ApiSdk.Users.Item.Drives.Item {
    ...
    public class DriveRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string userId, string driveId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, userIdOption, driveIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// A collection of drives available for this user. Read-only.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string userId, string driveId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, userIdOption, driveIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// A collection of drives available for this user. Read-only.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string userId, string driveId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, userIdOption, driveIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
