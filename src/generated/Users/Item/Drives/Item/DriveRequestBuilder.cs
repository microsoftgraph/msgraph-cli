...
namespace ApiSdk.Users.Item.Drives.Item {
    ...
    public class DriveRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string userId, string driveId) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string userId, string driveId, string[] select, string[] expand) => {
            ...
            }, userIdOption, driveIdOption, selectOption, expandOption);
            return command;
        }
        /// <summary>
        /// A collection of drives available for this user. Read-only.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string userId, string driveId, string body) => {
