...
namespace ApiSdk.Users.Item.Drives.Item.List.Items.Item.DriveItem.Content {
    ...
    public class ContentRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(userIdOption, driveIdOption, listItemIdOption, fileOption, new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// The content stream, if the item represents a file.
