...
using ApiSdk.Users.Item.Drives.Item.List.Items.Item.Analytics;
using ApiSdk.Users.Item.Drives.Item.List.Items.Item.DocumentSetVersions;
using ApiSdk.Users.Item.Drives.Item.List.Items.Item.DriveItem;
using ApiSdk.Users.Item.Drives.Item.List.Items.Item.Fields;
using ApiSdk.Users.Item.Drives.Item.List.Items.Item.GetActivitiesByInterval;
using ApiSdk.Users.Item.Drives.Item.List.Items.Item.GetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithInterval;
using ApiSdk.Users.Item.Drives.Item.List.Items.Item.Versions;
...
namespace ApiSdk.Users.Item.Drives.Item.List.Items.Item {
    ...
    public class ListItemItemRequestBuilder {
        ...
        public Command BuildDriveItemCommand() {
            ...
            var builder = new ApiSdk.Users.Item.Drives.Item.List.Items.Item.DriveItem.DriveItemRequestBuilder(PathParameters, RequestAdapter);
