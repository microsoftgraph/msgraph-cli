...
using ApiSdk.Users.Item.Drives.Item.List.Items.Item.Versions.Count;
using ApiSdk.Users.Item.Drives.Item.List.Items.Item.Versions.Item;
...
namespace ApiSdk.Users.Item.Drives.Item.List.Items.Item.Versions {
    ...
    public class VersionsRequestBuilder {
        ...
        public Command BuildCreateCommand() {
            ...
            command.Description = "Create new navigation property to versions for users";
            ...
            }, new CollectionBinding(userIdOption, driveIdOption, listItemIdOption, bodyOption, outputOption, queryOption, jsonNoIndentOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
