...
using ApiSdk.Users.Item.Drives.Item.List.ContentTypes.Item.Columns.Count;
using ApiSdk.Users.Item.Drives.Item.List.ContentTypes.Item.Columns.Item;
...
namespace ApiSdk.Users.Item.Drives.Item.List.ContentTypes.Item.Columns {
    ...
    public class ColumnsRequestBuilder {
        ...
        public Command BuildCommand() {
            ...
            command.AddCommand(builder.BuildSourceColumnCommand());
            return command;
        }
        ...
        public Command BuildCreateCommand() {
            ...
            command.Description = "Create new navigation property to columns for users";
