...
using ApiSdk.Users.Item.Drives.Item.List.ContentTypes.Item.ColumnLinks.Count;
using ApiSdk.Users.Item.Drives.Item.List.ContentTypes.Item.ColumnLinks.Item;
...
namespace ApiSdk.Users.Item.Drives.Item.List.ContentTypes.Item.ColumnLinks {
    ...
    public class ColumnLinksRequestBuilder {
        ...
        public List<Command> BuildCommand() {
            var builder = new ColumnLinkItemRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildCreateCommand() {
            ...
            command.Description = "Create new navigation property to columnLinks for users";
            ...
            }, new CollectionBinding(userIdOption, driveIdOption, contentTypeIdOption, bodyOption, outputOption, queryOption, jsonNoIndentOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        ...
        public ColumnLinksRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/drives/{drive%2Did}/list/contentTypes/{contentType%2Did}/columnLinks{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
