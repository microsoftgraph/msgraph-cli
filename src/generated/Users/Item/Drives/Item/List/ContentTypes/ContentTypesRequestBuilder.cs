...
using ApiSdk.Users.Item.Drives.Item.List.ContentTypes.AddCopy;
using ApiSdk.Users.Item.Drives.Item.List.ContentTypes.AddCopyFromContentTypeHub;
using ApiSdk.Users.Item.Drives.Item.List.ContentTypes.Count;
using ApiSdk.Users.Item.Drives.Item.List.ContentTypes.GetCompatibleHubContentTypes;
using ApiSdk.Users.Item.Drives.Item.List.ContentTypes.Item;
...
namespace ApiSdk.Users.Item.Drives.Item.List.ContentTypes {
    ...
    public class ContentTypesRequestBuilder {
        ...
        public Command BuildCreateCommand() {
            ...
            command.Description = "Create new navigation property to contentTypes for users";
