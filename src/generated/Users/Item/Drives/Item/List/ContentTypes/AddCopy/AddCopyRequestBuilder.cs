    ...
    public class AddCopyRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Users.Item.Drives.Item.List.ContentTypes.AddCopy.AddCopyRequestBody>(ApiSdk.Users.Item.Drives.Item.List.ContentTypes.AddCopy.AddCopyRequestBody.CreateFromDiscriminatorValue);
        ...
        public AddCopyRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/drives/{drive_id}/list/contentTypes/microsoft.graph.addCopy";
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ApiSdk.Users.Item.Drives.Item.List.ContentTypes.AddCopy.AddCopyRequestBody body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
