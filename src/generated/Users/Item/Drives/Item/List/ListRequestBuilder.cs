...
using ApiSdk.Users.Item.Drives.Item.List.Columns;
using ApiSdk.Users.Item.Drives.Item.List.ContentTypes;
using ApiSdk.Users.Item.Drives.Item.List.Drive;
using ApiSdk.Users.Item.Drives.Item.List.Items;
using ApiSdk.Users.Item.Drives.Item.List.Operations;
using ApiSdk.Users.Item.Drives.Item.List.Subscriptions;
...
namespace ApiSdk.Users.Item.Drives.Item.List {
    /// <summary>
    ...
    public class ListRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.Description = "Delete navigation property list for users";
        ...
        public Command BuildPatchCommand() {
            ...
            command.Description = "Update the navigation property list in users";
            // Create options for all the parameters
            var userIdOption = new Option<string>("--user-id", description: "key: id of user") {
            };
            userIdOption.IsRequired = true;
