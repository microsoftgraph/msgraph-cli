...
using ApiSdk.Users.Item.Drives.Item.Items.Item.Thumbnails.Count;
using ApiSdk.Users.Item.Drives.Item.Items.Item.Thumbnails.Item;
...
namespace ApiSdk.Users.Item.Drives.Item.Items.Item.Thumbnails {
    ...
    public class ThumbnailsRequestBuilder {
        ...
        public Command BuildCreateCommand() {
            ...
            command.Description = "Create new navigation property to thumbnails for users";
        ...
        public ThumbnailsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/drives/{drive%2Did}/items/{driveItem%2Did}/thumbnails{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
