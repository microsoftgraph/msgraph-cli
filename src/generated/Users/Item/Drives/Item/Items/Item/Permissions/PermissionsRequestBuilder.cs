...
using ApiSdk.Users.Item.Drives.Item.Items.Item.Permissions.Count;
using ApiSdk.Users.Item.Drives.Item.Items.Item.Permissions.Item;
...
namespace ApiSdk.Users.Item.Drives.Item.Items.Item.Permissions {
    ...
    public class PermissionsRequestBuilder {
        ...
        public Command BuildCreateCommand() {
            ...
            command.Description = "Create new navigation property to permissions for users";
        ...
        public PermissionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/drives/{drive_id}/items/{driveItem_id}/permissions{?top,skip,search,filter,count,orderby,select,expand}";
