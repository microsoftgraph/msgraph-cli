...
namespace ApiSdk.Users.Item.Drives.Item.Items.Item.ListItem {
    ...
    public class ListItemRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            }, new CollectionBinding(userIdOption, driveIdOption, driveItemIdOption, new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        ...
        public ListItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/drives/{drive_id}/items/{driveItem_id}/listItem{?select,expand}";
