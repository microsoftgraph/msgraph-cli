...
namespace ApiSdk.Users.Item.Drives.Item.Items.Item.Children.Item.Content {
    ...
    public class ContentRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(userIdOption, driveIdOption, driveItemIdOption, driveItemId1Option, fileOption, new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// The content stream, if the item represents a file.
        ...
        public Command BuildPutCommand() {
            ...
            }, new CollectionBinding(userIdOption, driveIdOption, driveItemIdOption, driveItemId1Option, bodyOption, new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        ...
        public ContentRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/drives/{drive%2Did}/items/{driveItem%2Did}/children/{driveItem%2Did1}/content";
