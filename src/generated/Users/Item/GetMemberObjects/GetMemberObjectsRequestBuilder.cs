    ...
    public class GetMemberObjectsRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Users.Item.GetMemberObjects.GetMemberObjectsRequestBody>(ApiSdk.Users.Item.GetMemberObjects.GetMemberObjectsRequestBody.CreateFromDiscriminatorValue);
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ApiSdk.Users.Item.GetMemberObjects.GetMemberObjectsRequestBody body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
