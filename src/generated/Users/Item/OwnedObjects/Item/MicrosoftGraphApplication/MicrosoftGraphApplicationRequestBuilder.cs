...
namespace ApiSdk.Users.Item.OwnedObjects.Item.MicrosoftGraphApplication {
    /// <summary>
    ...
    public class MicrosoftGraphApplicationRequestBuilder {
        ...
        public MicrosoftGraphApplicationRequestBuilder(Dictionary<string, object> pathParameters) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/ownedObjects/{directoryObject%2Did}/microsoft.graph.application{?%24select,%24expand}";
