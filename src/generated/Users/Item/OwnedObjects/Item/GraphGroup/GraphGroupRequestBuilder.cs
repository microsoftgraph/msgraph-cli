...
namespace ApiSdk.Users.Item.OwnedObjects.Item.GraphGroup {
    ...
    public class GraphGroupRequestBuilder : BaseCliRequestBuilder {
        ...
        public GraphGroupRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/users/{user%2Did}/ownedObjects/{directoryObject%2Did}/graph.group{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Get the item of type microsoft.graph.directoryObject as microsoft.graph.group
        /// </summary>
