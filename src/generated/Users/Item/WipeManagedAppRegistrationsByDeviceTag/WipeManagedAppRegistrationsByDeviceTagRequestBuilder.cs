...
namespace ApiSdk.Users.Item.WipeManagedAppRegistrationsByDeviceTag {
    ...
    public class WipeManagedAppRegistrationsByDeviceTagRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(WipeManagedAppRegistrationsByDeviceTagRequestBody model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
