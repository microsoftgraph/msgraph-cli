...
namespace ApiSdk.Users.Item.TransitiveMemberOf.Item.MicrosoftGraphDevice {
    /// <summary>
    ...
    public class MicrosoftGraphDeviceRequestBuilder {
        ...
        public MicrosoftGraphDeviceRequestBuilder(Dictionary<string, object> pathParameters) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/transitiveMemberOf/{directoryObject%2Did}/microsoft.graph.device{?%24select,%24expand}";
