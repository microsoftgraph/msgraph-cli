...
namespace ApiSdk.Users.Item.TransitiveMemberOf.GraphDirectoryRole {
    ...
    public class GraphDirectoryRoleRequestBuilder : BaseCliRequestBuilder {
        ...
        public GraphDirectoryRoleRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/users/{user%2Did}/transitiveMemberOf/graph.directoryRole{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Get the items of type microsoft.graph.directoryRole in the microsoft.graph.directoryObject collection
        /// </summary>
