...
namespace ApiSdk.Users.Item.Planner.Plans.Item.Buckets.Item.Tasks {
    ...
    public class TasksRequestBuilder {
        ...
        public Command BuildListCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string, int?, int?, string, string, bool?, string[], string[], string[]>(async (userId, plannerPlanId, plannerBucketId, top, skip, search, filter, count, orderby, select, expand) => {
