...
namespace ApiSdk.Users.Item.Planner.Plans.Item.Tasks.Item {
    ...
    public class PlannerTaskItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public PlannerTaskItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/users/{user%2Did}/planner/plans/{plannerPlan%2Did}/tasks/{plannerTask%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Delete navigation property tasks for users
        /// </summary>
