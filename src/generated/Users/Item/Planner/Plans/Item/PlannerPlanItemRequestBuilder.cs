...
namespace ApiSdk.Users.Item.Planner.Plans.Item {
    ...
    public class PlannerPlanItemRequestBuilder {
        ...
        public Command BuildBucketsCommand() {
            ...
            var builder = new BucketsRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildDeleteCommand() {
            ...
            }, new CollectionBinding(userIdOption, plannerPlanIdOption, ifMatchOption, new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(userIdOption, plannerPlanIdOption, selectOption, expandOption, outputOption, queryOption, jsonNoIndentOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
