...
namespace ApiSdk.Users.Item.Planner.Tasks.Item {
    ...
    public class PlannerTaskRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string userId, string plannerTaskId) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string userId, string plannerTaskId, string[] select, string[] expand) => {
            ...
            }, userIdOption, plannerTaskIdOption, selectOption, expandOption);
            return command;
        }
        /// <summary>
        /// Read-only. Nullable. Returns the plannerTasks assigned to the user.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string userId, string plannerTaskId, string body) => {
