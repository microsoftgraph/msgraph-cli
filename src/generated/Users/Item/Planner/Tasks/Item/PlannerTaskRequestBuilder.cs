...
namespace ApiSdk.Users.Item.Planner.Tasks.Item {
    ...
    public class PlannerTaskRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string userId, string plannerTaskId, string[] select, string[] expand, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string userId, string plannerTaskId, string body, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
