...
namespace ApiSdk.Users.Item.Planner.Tasks.Item {
    ...
    public class PlannerTaskRequestBuilder {
        ...
        public Command BuildAssignedToTaskBoardFormatCommand() {
            ...
            var builder = new ApiSdk.Users.Item.Planner.Tasks.Item.AssignedToTaskBoardFormat.AssignedToTaskBoardFormatRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildBucketTaskBoardFormatCommand() {
            ...
            var builder = new ApiSdk.Users.Item.Planner.Tasks.Item.BucketTaskBoardFormat.BucketTaskBoardFormatRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildDeleteCommand());
            command.AddCommand(builder.BuildGetCommand());
            command.AddCommand(builder.BuildPatchCommand());
            return command;
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string userId, string plannerTaskId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, userIdOption, plannerTaskIdOption, new ServiceProviderBinder());
            return command;
        }
        public Command BuildDetailsCommand() {
            var command = new Command("details");
            var builder = new ApiSdk.Users.Item.Planner.Tasks.Item.Details.DetailsRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildDeleteCommand());
            command.AddCommand(builder.BuildGetCommand());
            command.AddCommand(builder.BuildPatchCommand());
            return command;
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string userId, string plannerTaskId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, userIdOption, plannerTaskIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// Read-only. Nullable. Returns the plannerTasks assigned to the user.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string userId, string plannerTaskId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, userIdOption, plannerTaskIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        public Command BuildProgressTaskBoardFormatCommand() {
            var command = new Command("progress-task-board-format");
            var builder = new ApiSdk.Users.Item.Planner.Tasks.Item.ProgressTaskBoardFormat.ProgressTaskBoardFormatRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildDeleteCommand());
            command.AddCommand(builder.BuildGetCommand());
            command.AddCommand(builder.BuildPatchCommand());
            return command;
