...
namespace ApiSdk.Users.Item.Activities.Item.HistoryItems.Item.Activity.Ref {
    ...
    public class RefRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string userId, string userActivityId, string activityHistoryItemId, IConsole console) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string userId, string userActivityId, string activityHistoryItemId, FormatterType output, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
        ...
        public Command BuildPutCommand() {
            ...
            command.SetHandler(async (string userId, string userActivityId, string activityHistoryItemId, string body, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
