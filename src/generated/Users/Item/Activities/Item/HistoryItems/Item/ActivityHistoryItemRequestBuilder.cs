...
namespace ApiSdk.Users.Item.Activities.Item.HistoryItems.Item {
    ...
    public class ActivityHistoryItemRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string userId, string userActivityId, string activityHistoryItemId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, userIdOption, userActivityIdOption, activityHistoryItemIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// Optional. NavigationProperty/Containment; navigation property to the activity's historyItems.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string userId, string userActivityId, string activityHistoryItemId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, userIdOption, userActivityIdOption, activityHistoryItemIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// Optional. NavigationProperty/Containment; navigation property to the activity's historyItems.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string userId, string userActivityId, string activityHistoryItemId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, userIdOption, userActivityIdOption, activityHistoryItemIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
