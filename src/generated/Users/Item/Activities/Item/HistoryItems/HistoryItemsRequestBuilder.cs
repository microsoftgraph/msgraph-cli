...
namespace ApiSdk.Users.Item.Activities.Item.HistoryItems {
    ...
    public class HistoryItemsRequestBuilder {
        ...
        public Command BuildListCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, int?, int?, string, string, bool?, string[], string[], string[]>(async (userId, userActivityId, top, skip, search, filter, count, orderby, select, expand) => {
