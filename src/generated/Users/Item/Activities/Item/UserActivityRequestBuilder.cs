...
namespace ApiSdk.Users.Item.Activities.Item {
    ...
    public class UserActivityRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            }, userIdOption, userActivityIdOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// The user's activities across devices. Read-only. Nullable.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string userId, string userActivityId, string[] select, string[] expand, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
            ...
            }, userIdOption, userActivityIdOption, selectOption, expandOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string userId, string userActivityId, string body, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                ...
                await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                console.WriteLine("Success");
            }, userIdOption, userActivityIdOption, bodyOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
