...
namespace ApiSdk.Users.Item.Activities.Item {
    ...
    public class UserActivityRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string userId, string userActivityId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, userIdOption, userActivityIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The user's activities across devices. Read-only. Nullable.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string userId, string userActivityId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, userIdOption, userActivityIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string userId, string userActivityId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, userIdOption, userActivityIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
