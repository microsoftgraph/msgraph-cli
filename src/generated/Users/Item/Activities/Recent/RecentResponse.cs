...
namespace ApiSdk.Users.Item.Activities.Recent {
    ...
    public class RecentResponse : IAdditionalDataHolder, IParsable {
        ...
        /// </summary>
        public static ApiSdk.Users.Item.Activities.Recent.RecentResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"value", (o,n) => { (o as RecentResponse).Value = n.GetCollectionOfObjectValues<UserActivity>(UserActivity.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
