...
namespace ApiSdk.Users.Item.Photos.Item {
    ...
    public class ProfilePhotoRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string userId, string profilePhotoId, string[] select, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string userId, string profilePhotoId, string body, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
