...
namespace ApiSdk.Users.Item.Photos.Item.Value {
    ...
    public class ContentRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string userId, string profilePhotoId, FileInfo output) => {
            ...
            }, userIdOption, profilePhotoIdOption, outputOption);
            return command;
        }
        /// <summary>
        ...
        public Command BuildPutCommand() {
            ...
            command.SetHandler(async (string userId, string profilePhotoId, FileInfo file) => {
