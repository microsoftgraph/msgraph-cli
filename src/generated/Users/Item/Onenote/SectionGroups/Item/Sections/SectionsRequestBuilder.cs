...
namespace ApiSdk.Users.Item.Onenote.SectionGroups.Item.Sections {
    ...
    public class SectionsRequestBuilder {
        ...
        public Command BuildCreateCommand() {
            ...
            }, new CollectionBinding(userIdOption, sectionGroupIdOption, bodyOption, outputOption, outputFilterOption, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// The sections in the section group. Read-only. Nullable.
        ...
        public Command BuildListCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                var formatter = outputFormatterFactory.GetFormatter(output);
                formatter.WriteOutput(response);
            }, new CollectionBinding(userIdOption, sectionGroupIdOption, topOption, skipOption, searchOption, filterOption, countOption, orderbyOption, selectOption, expandOption, outputOption, outputFilterOption, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
