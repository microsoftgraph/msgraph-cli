...
namespace ApiSdk.Users.Item.Onenote.Pages.Item.ParentSection.ParentNotebook.SectionGroups.Item.Sections.Item {
    ...
    public class OnenoteSectionRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string userId, string onenotePageId, string sectionGroupId, string onenoteSectionId, string[] select, string[] expand) => {
            ...
            }, userIdOption, onenotePageIdOption, sectionGroupIdOption, onenoteSectionIdOption, selectOption, expandOption);
            return command;
        }
        /// <summary>
        /// The sections in the section group. Read-only. Nullable.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string userId, string onenotePageId, string sectionGroupId, string onenoteSectionId, string body) => {
