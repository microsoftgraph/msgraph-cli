...
namespace ApiSdk.Users.Item.Onenote.Pages.Item.ParentSection.Pages.Item.CopyToSection {
    ...
    public class CopyToSectionRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            }, new CollectionBinding(userIdOption, onenotePageIdOption, onenotePageId1Option, bodyOption, outputOption, outputFilterOption, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
