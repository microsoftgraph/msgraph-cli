...
namespace ApiSdk.Users.Item.Onenote.Pages.Item.ParentSection.ParentSectionGroup.ParentNotebook.Sections.Item {
    ...
    public class OnenoteSectionRequestBuilder {
        ...
        public Command BuildCopyToNotebookCommand() {
            ...
            var builder = new ApiSdk.Users.Item.Onenote.Pages.Item.ParentSection.ParentSectionGroup.ParentNotebook.Sections.Item.CopyToNotebook.CopyToNotebookRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildPostCommand());
            return command;
        }
        public Command BuildCopyToSectionGroupCommand() {
            var command = new Command("copy-to-section-group");
            var builder = new ApiSdk.Users.Item.Onenote.Pages.Item.ParentSection.ParentSectionGroup.ParentNotebook.Sections.Item.CopyToSectionGroup.CopyToSectionGroupRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildPostCommand());
            return command;
        }
        /// <summary>
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string userId, string onenotePageId, string onenoteSectionId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, userIdOption, onenotePageIdOption, onenoteSectionIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The sections in the notebook. Read-only. Nullable.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string userId, string onenotePageId, string onenoteSectionId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, userIdOption, onenotePageIdOption, onenoteSectionIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The sections in the notebook. Read-only. Nullable.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string userId, string onenotePageId, string onenoteSectionId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, userIdOption, onenotePageIdOption, onenoteSectionIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
