...
namespace ApiSdk.Users.Item.Onenote.Pages.Item.ParentSection.Pages.Item.Content {
    ...
    public class ContentRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(userIdOption, onenotePageIdOption, onenotePageId1Option, fileOption, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
