...
namespace ApiSdk.Users.Item.Onenote.Pages.Item.ParentSection.Pages.Item.Content {
    ...
    public class ContentRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string userId, string onenotePageId, string onenotePageId1, FileInfo file, FormatterType output, IConsole console) => {
        ...
        public Command BuildPutCommand() {
            ...
            command.SetHandler(async (string userId, string onenotePageId, string onenotePageId1, FileInfo file, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
