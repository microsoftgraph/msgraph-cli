...
namespace ApiSdk.Users.Item.Onenote.Pages.Item.ParentNotebook.SectionGroups.Item.SectionGroups.Item {
    ...
    public class SectionGroupRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string userId, string onenotePageId, string sectionGroupId, string sectionGroupId1, IOutputFormatterFactory outputFormatterFactory, CancellationToken cancellationToken) => {
                var requestInfo = CreateDeleteRequestInformation(q => {
                });
                await RequestAdapter.SendNoContentAsync(requestInfo, errorMapping: default, cancellationToken: cancellationToken);
                Console.WriteLine("Success");
            }, userIdOption, onenotePageIdOption, sectionGroupIdOption, sectionGroupId1Option);
            return command;
        }
        /// <summary>
        /// The section groups in the section. Read-only. Nullable.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string userId, string onenotePageId, string sectionGroupId, string sectionGroupId1, string[] select, string[] expand, FormatterType output, IOutputFormatterFactory outputFormatterFactory, CancellationToken cancellationToken) => {
            ...
            }, userIdOption, onenotePageIdOption, sectionGroupIdOption, sectionGroupId1Option, selectOption, expandOption, outputOption);
            return command;
        }
        /// <summary>
        /// The section groups in the section. Read-only. Nullable.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string userId, string onenotePageId, string sectionGroupId, string sectionGroupId1, string body, IOutputFormatterFactory outputFormatterFactory, CancellationToken cancellationToken) => {
                ...
                await RequestAdapter.SendNoContentAsync(requestInfo, errorMapping: default, cancellationToken: cancellationToken);
                Console.WriteLine("Success");
            }, userIdOption, onenotePageIdOption, sectionGroupIdOption, sectionGroupId1Option, bodyOption);
            return command;
        }
        /// <summary>
