...
namespace ApiSdk.Users.Item.Onenote.Pages.Item.ParentNotebook.Sections.Item.ParentSectionGroup.Sections.Item.CopyToNotebook {
    ...
    public class CopyToNotebookRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (string userId, string onenotePageId, string onenoteSectionId, string onenoteSectionId1, string body, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, userIdOption, onenotePageIdOption, onenoteSectionIdOption, onenoteSectionId1Option, bodyOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
