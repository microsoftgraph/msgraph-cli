...
namespace ApiSdk.Users.Item.Onenote.Pages.Item.ParentNotebook.Sections.Item.Pages.Item.Content {
    ...
    public class ContentRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string userId, string onenotePageId, string onenoteSectionId, string onenotePageId1, FileInfo output) => {
            ...
            }, userIdOption, onenotePageIdOption, onenoteSectionIdOption, onenotePageId1Option, outputOption);
            return command;
        }
        /// <summary>
        ...
        public Command BuildPutCommand() {
            ...
            command.SetHandler(async (string userId, string onenotePageId, string onenoteSectionId, string onenotePageId1, FileInfo file) => {
