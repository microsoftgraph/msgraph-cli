...
namespace ApiSdk.Users.Item.Onenote.Pages.Item.ParentNotebook.Sections.Item.Pages.Item.Content {
    ...
    public class ContentRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string, string, FileInfo>(async (userId, onenotePageId, onenoteSectionId, onenotePageId1, output) => {
        ...
        public Command BuildPutCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string, string, FileInfo>(async (userId, onenotePageId, onenoteSectionId, onenotePageId1, file) => {
