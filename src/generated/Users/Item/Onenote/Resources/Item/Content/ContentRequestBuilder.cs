...
namespace ApiSdk.Users.Item.Onenote.Resources.Item.Content {
    ...
    public class ContentRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.Description = "Get media content for the navigation property resources from users";
            ...
            command.SetHandler(async (string userId, string onenoteResourceId, FileInfo file, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
            ...
            }, userIdOption, onenoteResourceIdOption, fileOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        ...
        public Command BuildPutCommand() {
            ...
            command.Description = "Update media content for the navigation property resources in users";
            // Create options for all the parameters
            var userIdOption = new Option<string>("--user-id", description: "key: id of user") {
            };
            userIdOption.IsRequired = true;
            ...
            command.SetHandler(async (string userId, string onenoteResourceId, FileInfo file, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
