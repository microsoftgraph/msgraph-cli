...
namespace ApiSdk.Users.Item.Onenote.Resources.Item.Content {
    ...
    public class ContentRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string userId, string onenoteResourceId, FileInfo output) => {
            ...
            }, userIdOption, onenoteResourceIdOption, outputOption);
            return command;
        }
        /// <summary>
        ...
        public Command BuildPutCommand() {
            ...
            command.SetHandler(async (string userId, string onenoteResourceId, FileInfo file) => {
