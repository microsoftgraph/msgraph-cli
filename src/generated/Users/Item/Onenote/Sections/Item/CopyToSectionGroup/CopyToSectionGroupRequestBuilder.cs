    ...
    public class CopyToSectionGroupRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Users.Item.Onenote.Sections.Item.CopyToSectionGroup.CopyToSectionGroupRequestBody>(ApiSdk.Users.Item.Onenote.Sections.Item.CopyToSectionGroup.CopyToSectionGroupRequestBody.CreateFromDiscriminatorValue);
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ApiSdk.Users.Item.Onenote.Sections.Item.CopyToSectionGroup.CopyToSectionGroupRequestBody body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
