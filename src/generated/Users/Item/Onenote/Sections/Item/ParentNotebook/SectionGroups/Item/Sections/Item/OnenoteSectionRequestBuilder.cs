...
namespace ApiSdk.Users.Item.Onenote.Sections.Item.ParentNotebook.SectionGroups.Item.Sections.Item {
    ...
    public class OnenoteSectionRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string userId, string onenoteSectionId, string sectionGroupId, string onenoteSectionId1) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string userId, string onenoteSectionId, string sectionGroupId, string onenoteSectionId1, string[] select, string[] expand) => {
            ...
            }, userIdOption, onenoteSectionIdOption, sectionGroupIdOption, onenoteSectionId1Option, selectOption, expandOption);
            return command;
        }
        /// <summary>
        /// The sections in the section group. Read-only. Nullable.
