...
namespace ApiSdk.Users.Item.Onenote.Sections.Item.ParentNotebook.SectionGroups.Item.SectionGroups.Item {
    ...
    public class SectionGroupRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string userId, string onenoteSectionId, string sectionGroupId, string sectionGroupId1, IConsole console) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string userId, string onenoteSectionId, string sectionGroupId, string sectionGroupId1, string[] select, string[] expand, FormatterType output, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string userId, string onenoteSectionId, string sectionGroupId, string sectionGroupId1, string body, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
