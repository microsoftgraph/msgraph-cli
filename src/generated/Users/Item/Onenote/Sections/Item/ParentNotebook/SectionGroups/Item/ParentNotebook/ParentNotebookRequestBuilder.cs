...
namespace ApiSdk.Users.Item.Onenote.Sections.Item.ParentNotebook.SectionGroups.Item.ParentNotebook {
    ...
    public class ParentNotebookRequestBuilder {
        ...
        public Command BuildCopyNotebookCommand() {
            ...
            var builder = new ApiSdk.Users.Item.Onenote.Sections.Item.ParentNotebook.SectionGroups.Item.ParentNotebook.CopyNotebook.CopyNotebookRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string userId, string onenoteSectionId, string sectionGroupId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, userIdOption, onenoteSectionIdOption, sectionGroupIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The notebook that contains the section group. Read-only.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string userId, string onenoteSectionId, string sectionGroupId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, userIdOption, onenoteSectionIdOption, sectionGroupIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The notebook that contains the section group. Read-only.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string userId, string onenoteSectionId, string sectionGroupId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, userIdOption, onenoteSectionIdOption, sectionGroupIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
