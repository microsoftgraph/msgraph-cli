...
namespace ApiSdk.Users.Item.Onenote.Sections.Item.ParentSectionGroup.SectionGroups {
    ...
    public class SectionGroupsRequestBuilder {
        ...
        public Command BuildListCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, int?, int?, string, string, bool?, string[], string[], string[]>(async (userId, onenoteSectionId, top, skip, search, filter, count, orderby, select, expand) => {
