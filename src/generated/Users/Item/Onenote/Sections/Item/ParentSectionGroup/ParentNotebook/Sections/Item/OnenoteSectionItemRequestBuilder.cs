...
namespace ApiSdk.Users.Item.Onenote.Sections.Item.ParentSectionGroup.ParentNotebook.Sections.Item {
    ...
    public class OnenoteSectionItemRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            }, new CollectionBinding(userIdOption, onenoteSectionIdOption, onenoteSectionId1Option, new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// The sections in the notebook. Read-only. Nullable.
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(userIdOption, onenoteSectionIdOption, onenoteSectionId1Option, selectOption, expandOption, outputOption, queryOption, jsonNoIndentOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// The sections in the notebook. Read-only. Nullable.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                await RequestAdapter.SendNoContentAsync(requestInfo, errorMapping: default, cancellationToken: cancellationToken);
                Console.WriteLine("Success");
            }, new CollectionBinding(userIdOption, onenoteSectionIdOption, onenoteSectionId1Option, bodyOption, new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
