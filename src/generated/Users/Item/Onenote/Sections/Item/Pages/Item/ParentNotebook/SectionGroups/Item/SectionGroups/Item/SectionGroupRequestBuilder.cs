...
namespace ApiSdk.Users.Item.Onenote.Sections.Item.Pages.Item.ParentNotebook.SectionGroups.Item.SectionGroups.Item {
    ...
    public class SectionGroupRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string, string, string>(async (userId, onenoteSectionId, onenotePageId, sectionGroupId, sectionGroupId1) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string, string, string, object, object>(async (userId, onenoteSectionId, onenotePageId, sectionGroupId, sectionGroupId1, select, expand) => {
        ...
        public Command BuildPatchCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string, string, string, string>(async (userId, onenoteSectionId, onenotePageId, sectionGroupId, sectionGroupId1, body) => {
