...
namespace ApiSdk.Users.Item.Onenote.Sections.Item.Pages.Item.ParentNotebook.SectionGroups {
    ...
    public class SectionGroupsRequestBuilder {
        ...
        public Command BuildCreateCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string, string>(async (userId, onenoteSectionId, onenotePageId, body) => {
        ...
        public Command BuildListCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string, int?, int?, string, string, bool?, string[], string[], string[]>(async (userId, onenoteSectionId, onenotePageId, top, skip, search, filter, count, orderby, select, expand) => {
