...
namespace ApiSdk.Users.Item.Onenote.Sections.Item.Pages.Item {
    ...
    public class OnenotePageRequestBuilder {
        ...
        public Command BuildContentCommand() {
            ...
            var builder = new ApiSdk.Users.Item.Onenote.Sections.Item.Pages.Item.Content.ContentRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildCopyToSectionCommand() {
            ...
            var builder = new ApiSdk.Users.Item.Onenote.Sections.Item.Pages.Item.CopyToSection.CopyToSectionRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string userId, string onenoteSectionId, string onenotePageId, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                var requestInfo = CreateDeleteRequestInformation(q => {
                });
                await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                console.WriteLine("Success");
            }, userIdOption, onenoteSectionIdOption, onenotePageIdOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// The collection of pages in the section.  Read-only. Nullable.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string userId, string onenoteSectionId, string onenotePageId, string[] select, string[] expand, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
            ...
            }, userIdOption, onenoteSectionIdOption, onenotePageIdOption, selectOption, expandOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        public Command BuildOnenotePatchContentCommand() {
            var command = new Command("onenote-patch-content");
            var builder = new ApiSdk.Users.Item.Onenote.Sections.Item.Pages.Item.OnenotePatchContent.OnenotePatchContentRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildPostCommand());
            return command;
        }
        public Command BuildParentNotebookCommand() {
            var command = new Command("parent-notebook");
            var builder = new ApiSdk.Users.Item.Onenote.Sections.Item.Pages.Item.ParentNotebook.ParentNotebookRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildParentSectionCommand() {
            ...
            var builder = new ApiSdk.Users.Item.Onenote.Sections.Item.Pages.Item.ParentSection.ParentSectionRequestBuilder(PathParameters, RequestAdapter);
