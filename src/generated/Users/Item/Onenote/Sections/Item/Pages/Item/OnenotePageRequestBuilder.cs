...
namespace ApiSdk.Users.Item.Onenote.Sections.Item.Pages.Item {
    ...
    public class OnenotePageRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string userId, string onenoteSectionId, string onenotePageId, string[] select, string[] expand) => {
            ...
            }, userIdOption, onenoteSectionIdOption, onenotePageIdOption, selectOption, expandOption);
            return command;
        }
