...
namespace ApiSdk.Users.Item.Onenote.Sections.Item {
    ...
    public class OnenoteSectionRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string userId, string onenoteSectionId, string[] select, string[] expand) => {
            ...
            }, userIdOption, onenoteSectionIdOption, selectOption, expandOption);
            return command;
        }
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string userId, string onenoteSectionId, string body) => {
