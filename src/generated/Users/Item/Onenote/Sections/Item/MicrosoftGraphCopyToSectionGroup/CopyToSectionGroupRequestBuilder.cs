...
namespace ApiSdk.Users.Item.Onenote.Sections.Item.MicrosoftGraphCopyToSectionGroup {
    /// <summary>
    ...
    public class CopyToSectionGroupRequestBuilder {
        ...
        public CopyToSectionGroupRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/onenote/sections/{onenoteSection%2Did}/microsoft.graph.copyToSectionGroup";
