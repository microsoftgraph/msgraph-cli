...
namespace ApiSdk.Users.Item.Onenote.Notebooks.Item.SectionGroups.Item.ParentNotebook.CopyNotebook {
    ...
    public class CopyNotebookRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (string userId, string notebookId, string sectionGroupId, string body, FormatterType output, IOutputFormatterFactory outputFormatterFactory, CancellationToken cancellationToken) => {
            ...
            }, userIdOption, notebookIdOption, sectionGroupIdOption, bodyOption, outputOption);
            return command;
        }
        /// <summary>
