...
namespace ApiSdk.Users.Item.Onenote.Notebooks.Item.SectionGroups.Item.Sections.Item.Pages {
    ...
    public class PagesRequestBuilder {
        ...
        public Command BuildListCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string, string, int?, int?, string, string, bool?, object, object, object>(async (userId, notebookId, sectionGroupId, onenoteSectionId, top, skip, search, filter, count, orderby, select, expand) => {
