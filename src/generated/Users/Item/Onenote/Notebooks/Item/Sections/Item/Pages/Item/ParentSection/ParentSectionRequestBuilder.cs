...
namespace ApiSdk.Users.Item.Onenote.Notebooks.Item.Sections.Item.Pages.Item.ParentSection {
    ...
    public class ParentSectionRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string userId, string notebookId, string onenoteSectionId, string onenotePageId) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string userId, string notebookId, string onenoteSectionId, string onenotePageId, string[] select, string[] expand) => {
            ...
            }, userIdOption, notebookIdOption, onenoteSectionIdOption, onenotePageIdOption, selectOption, expandOption);
            return command;
        }
        /// <summary>
        /// The section that contains the page. Read-only.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string userId, string notebookId, string onenoteSectionId, string onenotePageId, string body) => {
