...
namespace ApiSdk.Users.Item.Onenote.Notebooks.Item.Sections.Item.Pages.Item.Content {
    ...
    public class ContentRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string userId, string notebookId, string onenoteSectionId, string onenotePageId, FileInfo output) => {
            ...
            }, userIdOption, notebookIdOption, onenoteSectionIdOption, onenotePageIdOption, outputOption);
            return command;
        }
        /// <summary>
        ...
        public Command BuildPutCommand() {
            ...
            command.SetHandler(async (string userId, string notebookId, string onenoteSectionId, string onenotePageId, FileInfo file) => {
