...
namespace ApiSdk.Users.Item.Onenote.Notebooks.Item.Sections.Item {
    ...
    public class OnenoteSectionRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string userId, string notebookId, string onenoteSectionId, string[] select, string[] expand) => {
            ...
            }, userIdOption, notebookIdOption, onenoteSectionIdOption, selectOption, expandOption);
            return command;
        }
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string userId, string notebookId, string onenoteSectionId, string body) => {
