    ...
    public class CopyToSectionRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Users.Item.Onenote.Notebooks.Item.Sections.Item.Pages.Item.CopyToSection.CopyToSectionRequestBody>(ApiSdk.Users.Item.Onenote.Notebooks.Item.Sections.Item.Pages.Item.CopyToSection.CopyToSectionRequestBody.CreateFromDiscriminatorValue);
            ...
            }, new CollectionBinding(userIdOption, notebookIdOption, onenoteSectionIdOption, onenotePageIdOption, bodyOption, outputOption, queryOption, jsonNoIndentOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ApiSdk.Users.Item.Onenote.Notebooks.Item.Sections.Item.Pages.Item.CopyToSection.CopyToSectionRequestBody body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
