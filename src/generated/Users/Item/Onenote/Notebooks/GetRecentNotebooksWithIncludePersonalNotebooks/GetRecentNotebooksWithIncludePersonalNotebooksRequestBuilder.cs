...
namespace ApiSdk.Users.Item.Onenote.Notebooks.GetRecentNotebooksWithIncludePersonalNotebooks {
    ...
    public class GetRecentNotebooksWithIncludePersonalNotebooksRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string userId, bool? includePersonalNotebooks, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, userIdOption, includePersonalNotebooksOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
