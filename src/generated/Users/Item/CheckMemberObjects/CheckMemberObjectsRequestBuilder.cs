    ...
    public class CheckMemberObjectsRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Users.Item.CheckMemberObjects.CheckMemberObjectsRequestBody>(ApiSdk.Users.Item.CheckMemberObjects.CheckMemberObjectsRequestBody.CreateFromDiscriminatorValue);
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ApiSdk.Users.Item.CheckMemberObjects.CheckMemberObjectsRequestBody body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
