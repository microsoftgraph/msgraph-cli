...
namespace ApiSdk.Users.Item.Events.Item.Instances {
    ...
    public class InstancesRequestBuilder {
        ...
        public List<Command> BuildCommand() {
            var builder = new ApiSdk.Users.Item.Events.Item.Instances.Item.EventItemRequestBuilder(PathParameters, RequestAdapter);
        ...
        public InstancesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/events/{event%2Did}/instances{?%24top,%24skip,%24filter,%24count,%24orderby,%24select}";
