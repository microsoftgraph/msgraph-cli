...
namespace ApiSdk.Users.Item.MemberOf {
    ...
    public class MemberOfRequestBuilder : BaseCliRequestBuilder {
        ...
        public MemberOfRequestBuilder(string rawUrl) : base("{+baseurl}/users/{user%2Did}/memberOf{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// The groups and directory roles that the user is a member of. Read-only. Nullable. Supports $expand.
        /// </summary>
