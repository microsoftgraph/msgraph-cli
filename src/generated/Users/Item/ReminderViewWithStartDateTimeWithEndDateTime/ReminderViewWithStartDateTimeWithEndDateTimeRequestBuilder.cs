...
namespace ApiSdk.Users.Item.ReminderViewWithStartDateTimeWithEndDateTime {
    ...
    public class ReminderViewWithStartDateTimeWithEndDateTimeRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(userIdOption, StartDateTimeOption, EndDateTimeOption, outputOption, queryOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
