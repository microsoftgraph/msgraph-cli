...
namespace ApiSdk.Users.Item.ReminderViewWithStartDateTimeWithEndDateTime {
    ...
    public class ReminderViewWithStartDateTimeWithEndDateTimeRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string userId, string StartDateTime, string EndDateTime, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, userIdOption, StartDateTimeOption, EndDateTimeOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
