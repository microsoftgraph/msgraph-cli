...
using System;
namespace ApiSdk.Users.Item.JoinedTeams.Item.Photo.Value {
    /// <summary>
    ...
    public class ContentRequestBuilder : BaseCliRequestBuilder {
        ...
        public ContentRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/photo/$value", pathParameters) {
        }
        /// <summary>
        /// Get media content for the navigation property photo from users
        /// </summary>
