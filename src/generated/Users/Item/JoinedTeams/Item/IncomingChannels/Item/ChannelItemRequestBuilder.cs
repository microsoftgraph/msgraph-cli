...
using System;
namespace ApiSdk.Users.Item.JoinedTeams.Item.IncomingChannels.Item {
    /// <summary>
    ...
    public class ChannelItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public ChannelItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/incomingChannels/{channel%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Remove an incoming channel (a **channel** shared with a **team**) from a team.
        /// </summary>
