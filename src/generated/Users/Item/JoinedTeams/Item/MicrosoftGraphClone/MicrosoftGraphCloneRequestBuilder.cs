...
namespace ApiSdk.Users.Item.JoinedTeams.Item.MicrosoftGraphClone {
    /// <summary>
    ...
    public class MicrosoftGraphCloneRequestBuilder {
        ...
        public MicrosoftGraphCloneRequestBuilder(Dictionary<string, object> pathParameters) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            UrlTemplate = "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/microsoft.graph.clone";
