...
namespace ApiSdk.Users.Item.JoinedTeams.Item.PrimaryChannel.MicrosoftGraphProvisionEmail {
    /// <summary>
    ...
    public class MicrosoftGraphProvisionEmailRequestBuilder {
        ...
        public MicrosoftGraphProvisionEmailRequestBuilder(Dictionary<string, object> pathParameters) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            UrlTemplate = "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/primaryChannel/microsoft.graph.provisionEmail";
