...
namespace ApiSdk.Users.Item.JoinedTeams.Item.PrimaryChannel.Tabs.Item.TeamsApp {
    ...
    public class TeamsAppRequestBuilder : BaseCliRequestBuilder {
        ...
        public TeamsAppRequestBuilder(string rawUrl) : base("{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/primaryChannel/tabs/{teamsTab%2Did}/teamsApp{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// The application that is linked to the tab. This can&apos;t be changed after tab creation.
        /// </summary>
