...
using System;
namespace ApiSdk.Users.Item.JoinedTeams.Item.PrimaryChannel.Tabs.Item.TeamsApp {
    /// <summary>
    ...
    public class TeamsAppRequestBuilder : BaseCliRequestBuilder {
        ...
        public TeamsAppRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/primaryChannel/tabs/{teamsTab%2Did}/teamsApp{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// The application that is linked to the tab. This cannot be changed after tab creation.
        /// </summary>
