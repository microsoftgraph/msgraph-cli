...
namespace ApiSdk.Users.Item.JoinedTeams.Item {
    ...
    public class TeamRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string userId, string teamId) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string userId, string teamId, string[] select, string[] expand) => {
            ...
            }, userIdOption, teamIdOption, selectOption, expandOption);
            return command;
        }
        /// <summary>
        /// The Microsoft Teams teams that the user is a member of. Read-only. Nullable.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string userId, string teamId, string body) => {
