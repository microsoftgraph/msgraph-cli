...
namespace ApiSdk.Users.Item.JoinedTeams.Item {
    ...
    public class TeamRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            }, userIdOption, teamIdOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// The Microsoft Teams teams that the user is a member of. Read-only. Nullable.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string userId, string teamId, string[] select, string[] expand, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
            ...
            }, userIdOption, teamIdOption, selectOption, expandOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// The Microsoft Teams teams that the user is a member of. Read-only. Nullable.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string userId, string teamId, string body, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                ...
                await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                console.WriteLine("Success");
            }, userIdOption, teamIdOption, bodyOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
