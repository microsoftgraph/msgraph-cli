...
namespace ApiSdk.Users.Item.JoinedTeams.Item.Operations.Item {
    ...
    public class TeamsAsyncOperationItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public TeamsAsyncOperationItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/operations/{teamsAsyncOperation%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Delete navigation property operations for users
        /// </summary>
