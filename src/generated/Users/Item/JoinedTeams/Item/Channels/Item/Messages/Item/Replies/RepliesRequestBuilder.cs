...
namespace ApiSdk.Users.Item.JoinedTeams.Item.Channels.Item.Messages.Item.Replies {
    ...
    public class RepliesRequestBuilder {
        ...
        public List<Command> BuildCommand() {
            var builder = new ApiSdk.Users.Item.JoinedTeams.Item.Channels.Item.Messages.Item.Replies.Item.ChatMessageItemRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildCreateCommand() {
            ...
            }, new CollectionBinding(userIdOption, teamIdOption, channelIdOption, chatMessageIdOption, bodyOption, outputOption, queryOption, jsonNoIndentOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
