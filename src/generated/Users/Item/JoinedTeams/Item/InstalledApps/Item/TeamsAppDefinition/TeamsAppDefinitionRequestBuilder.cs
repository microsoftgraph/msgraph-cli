...
using System;
namespace ApiSdk.Users.Item.JoinedTeams.Item.InstalledApps.Item.TeamsAppDefinition {
    /// <summary>
    ...
    public class TeamsAppDefinitionRequestBuilder : BaseCliRequestBuilder {
        ...
        public TeamsAppDefinitionRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/installedApps/{teamsAppInstallation%2Did}/teamsAppDefinition{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// The details of this version of the app.
        /// </summary>
