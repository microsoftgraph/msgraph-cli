...
namespace ApiSdk.Users.Item.JoinedTeams.Item.InstalledApps.Item.TeamsApp {
    /// <summary>
    ...
    public class TeamsAppRequestBuilder : BaseCliRequestBuilder {
        ...
        public TeamsAppRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/installedApps/{teamsAppInstallation%2Did}/teamsApp{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// The app that is installed.
        /// </summary>
