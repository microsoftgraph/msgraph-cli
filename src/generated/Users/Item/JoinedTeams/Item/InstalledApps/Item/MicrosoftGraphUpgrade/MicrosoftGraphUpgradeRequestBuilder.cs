...
namespace ApiSdk.Users.Item.JoinedTeams.Item.InstalledApps.Item.MicrosoftGraphUpgrade {
    /// <summary>
    ...
    public class MicrosoftGraphUpgradeRequestBuilder {
        ...
        public MicrosoftGraphUpgradeRequestBuilder(Dictionary<string, object> pathParameters) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/installedApps/{teamsAppInstallation%2Did}/microsoft.graph.upgrade";
