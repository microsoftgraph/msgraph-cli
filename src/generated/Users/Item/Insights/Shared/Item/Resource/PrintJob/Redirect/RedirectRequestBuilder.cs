...
namespace ApiSdk.Users.Item.Insights.Shared.Item.Resource.PrintJob.Redirect {
    ...
    public class RedirectRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            }, new CollectionBinding(userIdOption, sharedInsightIdOption, bodyOption, outputOption, queryOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
