...
namespace ApiSdk.Users.Item.Insights.Shared.Item.Resource.Ref {
    ...
    public class RefRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string userId, string sharedInsightId, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, userIdOption, sharedInsightIdOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// Used for navigating to the item that was shared. For file attachments, the type is fileAttachment. For linked attachments, the type is driveItem.
        ...
        public Command BuildPutCommand() {
            ...
            command.SetHandler(async (string userId, string sharedInsightId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, userIdOption, sharedInsightIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
