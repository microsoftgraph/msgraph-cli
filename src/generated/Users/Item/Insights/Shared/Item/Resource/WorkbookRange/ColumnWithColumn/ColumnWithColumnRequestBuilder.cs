...
namespace ApiSdk.Users.Item.Insights.Shared.Item.Resource.WorkbookRange.ColumnWithColumn {
    ...
    public class ColumnWithColumnRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string userId, string sharedInsightId, int? column, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, userIdOption, sharedInsightIdOption, columnOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
