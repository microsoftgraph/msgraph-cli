...
namespace ApiSdk.Users.Item.Insights.Shared.Item.Resource.WorkbookRangeFormat {
    ...
    public class WorkbookRangeFormatRequestBuilder {
        ...
        public Command BuildAutofitColumnsCommand() {
            ...
            var builder = new ApiSdk.Users.Item.Insights.Shared.Item.Resource.WorkbookRangeFormat.AutofitColumns.AutofitColumnsRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildPostCommand());
            return command;
        }
        public Command BuildAutofitRowsCommand() {
            var command = new Command("autofit-rows");
            var builder = new ApiSdk.Users.Item.Insights.Shared.Item.Resource.WorkbookRangeFormat.AutofitRows.AutofitRowsRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildPostCommand());
            return command;
        }
        /// <summary>
