...
namespace ApiSdk.Users.Item.Insights.Shared.Item.LastSharedMethod.WorkbookRange.ColumnsAfterWithCount {
    ...
    public class ColumnsAfterWithCountRequestBuilder {
        ...
        public class ColumnsAfterWithCountResponse : IAdditionalDataHolder, IParsable {
            ...
            public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
                return new Dictionary<string, Action<T, IParseNode>> {
                    {"workbookRange", (o,n) => { (o as ColumnsAfterWithCountResponse).WorkbookRange = n.GetObjectValue<ApiSdk.Models.Microsoft.Graph.WorkbookRange>(ApiSdk.Models.Microsoft.Graph.WorkbookRange.CreateFromDiscriminatorValue); } },
                };
            }
            /// <summary>
