...
namespace ApiSdk.Users.Item.Insights.Shared.Item.LastSharedMethod.TargetedManagedAppProtection.TargetApps {
    ...
    public class TargetAppsRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (string userId, string sharedInsightId, string body, IOutputFormatterFactory outputFormatterFactory, CancellationToken cancellationToken) => {
