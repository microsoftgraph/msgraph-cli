...
namespace ApiSdk.Users.Item.Insights.Shared.Item.LastSharedMethod.WorkbookRange {
    ...
    public class WorkbookRangeRequestBuilder {
        ...
        public Command BuildClearCommand() {
            ...
            var builder = new ApiSdk.Users.Item.Insights.Shared.Item.LastSharedMethod.WorkbookRange.Clear.ClearRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildPostCommand());
            return command;
        }
        public Command BuildDeleteCommand() {
            var command = new Command("delete");
            var builder = new ApiSdk.Users.Item.Insights.Shared.Item.LastSharedMethod.WorkbookRange.Delete.DeleteRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildPostCommand());
            return command;
        }
        public Command BuildInsertCommand() {
            var command = new Command("insert");
            var builder = new ApiSdk.Users.Item.Insights.Shared.Item.LastSharedMethod.WorkbookRange.Insert.InsertRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildPostCommand());
            return command;
        }
        public Command BuildMergeCommand() {
            var command = new Command("merge");
            var builder = new ApiSdk.Users.Item.Insights.Shared.Item.LastSharedMethod.WorkbookRange.Merge.MergeRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildPostCommand());
            return command;
        }
        public Command BuildUnmergeCommand() {
            var command = new Command("unmerge");
            var builder = new ApiSdk.Users.Item.Insights.Shared.Item.LastSharedMethod.WorkbookRange.Unmerge.UnmergeRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildPostCommand());
            return command;
        }
        /// <summary>
