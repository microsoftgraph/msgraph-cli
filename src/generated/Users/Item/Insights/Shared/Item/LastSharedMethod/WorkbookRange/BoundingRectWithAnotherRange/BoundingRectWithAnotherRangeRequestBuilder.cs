...
namespace ApiSdk.Users.Item.Insights.Shared.Item.LastSharedMethod.WorkbookRange.BoundingRectWithAnotherRange {
    ...
    public class BoundingRectWithAnotherRangeRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string userId, string sharedInsightId, string anotherRange, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, userIdOption, sharedInsightIdOption, anotherRangeOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
