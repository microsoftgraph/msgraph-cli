...
namespace ApiSdk.Users.Item.Insights.Shared.Item.LastSharedMethod.ScheduleChangeRequest.Approve {
    ...
    public class ApproveRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(ApproveRequestBody model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
