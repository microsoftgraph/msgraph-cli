...
namespace ApiSdk.Users.Item.Insights.Shared {
    ...
    public class SharedRequestBuilder {
        ...
        public Command BuildCommand() {
            ...
            command.AddCommand(builder.BuildLastSharedMethodCommand());
        ...
        public SharedRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user%2Did}/insights/shared{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
