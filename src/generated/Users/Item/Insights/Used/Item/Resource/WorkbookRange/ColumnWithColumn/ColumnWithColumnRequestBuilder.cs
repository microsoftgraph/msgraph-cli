...
namespace ApiSdk.Users.Item.Insights.Used.Item.Resource.WorkbookRange.ColumnWithColumn {
    ...
    public class ColumnWithColumnRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string userId, string usedInsightId, int? column, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, userIdOption, usedInsightIdOption, columnOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
