...
namespace ApiSdk.Users.Item.Insights.Used.Item.Resource.WorkbookRange.ColumnsBeforeWithCount {
    ...
    public class ColumnsBeforeWithCountRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string userId, string usedInsightId, int? count, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, userIdOption, usedInsightIdOption, countOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
