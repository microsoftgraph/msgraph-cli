...
namespace ApiSdk.Users.Item.Insights.Used.Item.Resource.PrintJob {
    ...
    public class PrintJobRequestBuilder {
        ...
        public Command BuildAbortCommand() {
            ...
            var builder = new ApiSdk.Users.Item.Insights.Used.Item.Resource.PrintJob.Abort.AbortRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildPostCommand());
            return command;
        }
        public Command BuildCancelCommand() {
            var command = new Command("cancel");
            var builder = new ApiSdk.Users.Item.Insights.Used.Item.Resource.PrintJob.Cancel.CancelRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildPostCommand());
            return command;
        }
        public Command BuildRedirectCommand() {
            var command = new Command("redirect");
            var builder = new ApiSdk.Users.Item.Insights.Used.Item.Resource.PrintJob.Redirect.RedirectRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildPostCommand());
            return command;
        }
        public Command BuildStartCommand() {
            var command = new Command("start");
            var builder = new ApiSdk.Users.Item.Insights.Used.Item.Resource.PrintJob.Start.StartRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildPostCommand());
            return command;
        }
        /// <summary>
