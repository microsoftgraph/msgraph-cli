...
namespace ApiSdk.Users.Item.Insights.Used.Item.Resource.WorkbookRange.OffsetRangeWithRowOffsetWithColumnOffset {
    ...
    public class OffsetRangeWithRowOffsetWithColumnOffsetRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string userId, string usedInsightId, int? rowOffset, int? columnOffset) => {
            ...
            }, userIdOption, usedInsightIdOption, rowOffsetOption, columnOffsetOption);
            return command;
        }
        /// <summary>
