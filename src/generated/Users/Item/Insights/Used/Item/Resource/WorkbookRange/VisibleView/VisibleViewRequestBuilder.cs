...
namespace ApiSdk.Users.Item.Insights.Used.Item.Resource.WorkbookRange.VisibleView {
    ...
    public class VisibleViewRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(userIdOption, usedInsightIdOption, outputOption, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
