...
namespace ApiSdk.Users.Item.Insights.Used.Item.Resource.WorkbookRange.ColumnsAfterWithCount {
    ...
    public class ColumnsAfterWithCountRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string userId, string usedInsightId, int? count, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                var requestInfo = CreateGetRequestInformation(q => {
                });
                var response = await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                var formatter = outputFormatterFactory.GetFormatter(output);
                formatter.WriteOutput(response, console);
            }, userIdOption, usedInsightIdOption, countOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
