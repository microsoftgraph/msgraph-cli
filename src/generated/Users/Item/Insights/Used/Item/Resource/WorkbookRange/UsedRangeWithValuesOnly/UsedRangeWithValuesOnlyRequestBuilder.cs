...
namespace ApiSdk.Users.Item.Insights.Used.Item.Resource.WorkbookRange.UsedRangeWithValuesOnly {
    ...
    public class UsedRangeWithValuesOnlyRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string userId, string usedInsightId, bool? valuesOnly, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, userIdOption, usedInsightIdOption, valuesOnlyOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
