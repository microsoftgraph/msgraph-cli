...
namespace ApiSdk.Users.Item.Insights.Used.Item.Resource.WorkbookRange.IntersectionWithAnotherRange {
    ...
    public class IntersectionWithAnotherRangeRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string userId, string usedInsightId, string anotherRange, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, userIdOption, usedInsightIdOption, anotherRangeOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
