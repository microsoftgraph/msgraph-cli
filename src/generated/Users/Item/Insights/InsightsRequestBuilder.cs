    ...
    public class InsightsRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string[], string[]>(async (userId, select, expand) => {
                ...
                var result = await RequestAdapter.SendAsync<OfficeGraphInsights>(requestInfo);
                // Print request output. What if the request has no return?
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(OfficeGraphInsights model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
