...
namespace ApiSdk.Users.Item.Insights.Trending.Item {
    ...
    public class TrendingItemRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string userId, string trendingItemId, string[] select, string[] expand, FormatterType output, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string userId, string trendingItemId, string body, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
