...
namespace ApiSdk.Users.Item.Insights.Trending.Item.Resource.PrintDocument {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\insights\trending\{trendingItem-Id}\resource\microsoft.graph.printDocument</summary>
    public class PrintDocumentRequestBuilder {
        ...
        public Command BuildCreateUploadSessionCommand() {
            ...
            var builder = new ApiSdk.Users.Item.Insights.Trending.Item.Resource.PrintDocument.CreateUploadSession.CreateUploadSessionRequestBuilder(PathParameters, RequestAdapter);
        ...
        public PrintDocumentRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/insights/trending/{trendingItem_Id}/resource/microsoft.graph.printDocument";
