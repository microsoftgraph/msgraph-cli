...
namespace ApiSdk.Users.Item.Insights.Trending.Item.Resource.WorkbookRange.BoundingRectWithAnotherRange {
    ...
    public class BoundingRectWithAnotherRangeRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string userId, string trendingItemId, string anotherRange, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, userIdOption, trendingItemIdOption, anotherRangeOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
