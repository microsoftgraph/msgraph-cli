...
namespace ApiSdk.Users.Item.Insights.Trending.Item.Resource.WorkbookRange.RowsAbove {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\insights\trending\{trendingItem-Id}\resource\microsoft.graph.workbookRange\microsoft.graph.rowsAbove()</summary>
    public class RowsAboveRequestBuilder {
        ...
        public RowsAboveRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/insights/trending/{trendingItem_Id}/resource/microsoft.graph.workbookRange/microsoft.graph.rowsAbove()";
