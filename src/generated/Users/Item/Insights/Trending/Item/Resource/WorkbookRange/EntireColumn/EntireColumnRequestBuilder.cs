...
namespace ApiSdk.Users.Item.Insights.Trending.Item.Resource.WorkbookRange.EntireColumn {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\insights\trending\{trendingItem-Id}\resource\microsoft.graph.workbookRange\microsoft.graph.entireColumn()</summary>
    public class EntireColumnRequestBuilder {
        ...
        public EntireColumnRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/insights/trending/{trendingItem_Id}/resource/microsoft.graph.workbookRange/microsoft.graph.entireColumn()";
