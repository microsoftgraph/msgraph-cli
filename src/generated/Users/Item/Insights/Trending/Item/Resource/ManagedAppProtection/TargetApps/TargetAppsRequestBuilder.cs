...
namespace ApiSdk.Users.Item.Insights.Trending.Item.Resource.ManagedAppProtection.TargetApps {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\insights\trending\{trendingItem-Id}\resource\microsoft.graph.managedAppProtection\microsoft.graph.targetApps</summary>
    public class TargetAppsRequestBuilder {
        ...
        public TargetAppsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/insights/trending/{trendingItem_Id}/resource/microsoft.graph.managedAppProtection/microsoft.graph.targetApps";
