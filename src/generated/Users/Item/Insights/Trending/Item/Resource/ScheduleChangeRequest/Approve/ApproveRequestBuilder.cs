...
namespace ApiSdk.Users.Item.Insights.Trending.Item.Resource.ScheduleChangeRequest.Approve {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\insights\trending\{trendingItem-Id}\resource\microsoft.graph.scheduleChangeRequest\microsoft.graph.approve</summary>
    public class ApproveRequestBuilder {
        ...
        public ApproveRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/insights/trending/{trendingItem_Id}/resource/microsoft.graph.scheduleChangeRequest/microsoft.graph.approve";
