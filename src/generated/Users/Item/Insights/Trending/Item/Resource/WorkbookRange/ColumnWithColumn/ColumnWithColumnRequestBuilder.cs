...
namespace ApiSdk.Users.Item.Insights.Trending.Item.Resource.WorkbookRange.ColumnWithColumn {
    ...
    public class ColumnWithColumnRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(userIdOption, trendingItemIdOption, columnOption, outputOption, outputFilterOption, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
