...
namespace ApiSdk.Users.Item.Insights.Trending.Item.Resource.WorkbookRange.OffsetRangeWithRowOffsetWithColumnOffset {
    ...
    public class OffsetRangeWithRowOffsetWithColumnOffsetRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string userId, string trendingItemId, int? rowOffset, int? columnOffset, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, userIdOption, trendingItemIdOption, rowOffsetOption, columnOffsetOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
