...
namespace ApiSdk.Users.Item.Insights.Trending.Item.Resource.WindowsInformationProtection.Assign {
    /// <summary>Builds and executes requests for operations under \users\{user-id}\insights\trending\{trendingItem-Id}\resource\microsoft.graph.windowsInformationProtection\microsoft.graph.assign</summary>
    public class AssignRequestBuilder {
        ...
        public AssignRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/insights/trending/{trendingItem_Id}/resource/microsoft.graph.windowsInformationProtection/microsoft.graph.assign";
