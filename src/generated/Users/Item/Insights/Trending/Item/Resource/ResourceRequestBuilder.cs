...
namespace ApiSdk.Users.Item.Insights.Trending.Item.Resource {
    ...
    public class ResourceRequestBuilder : BaseCliRequestBuilder {
        ...
        public ResourceRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/users/{user%2Did}/insights/trending/{trending%2Did}/resource{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Used for navigating to the trending document.
        /// </summary>
