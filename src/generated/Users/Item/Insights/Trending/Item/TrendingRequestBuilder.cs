...
namespace ApiSdk.Users.Item.Insights.Trending.Item {
    ...
    public class TrendingRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string userId, string trendingId, IConsole console) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string userId, string trendingId, string[] select, string[] expand, FormatterType output, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
            ...
            }, userIdOption, trendingIdOption, selectOption, expandOption, outputOption);
            return command;
        }
        /// <summary>
        /// Access this property from the derived type itemInsights.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string userId, string trendingId, string body, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
