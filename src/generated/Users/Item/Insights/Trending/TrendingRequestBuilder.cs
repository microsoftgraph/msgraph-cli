...
namespace ApiSdk.Users.Item.Insights.Trending {
    ...
    public class TrendingRequestBuilder {
        ...
        public Command BuildCommand() {
            ...
            command.AddCommand(builder.BuildResourceCommand());
            return command;
        }
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ApiSdk.Models.Trending body, Action<TrendingRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
