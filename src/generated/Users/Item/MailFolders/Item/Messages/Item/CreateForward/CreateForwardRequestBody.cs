...
namespace ApiSdk.Users.Item.MailFolders.Item.Messages.Item.CreateForward {
    ...
    public class CreateForwardRequestBody : IAdditionalDataHolder, IParsable {
        ...
        /// </summary>
        public static ApiSdk.Users.Item.MailFolders.Item.Messages.Item.CreateForward.CreateForwardRequestBody CreateFromDiscriminatorValue(IParseNode parseNode) {
