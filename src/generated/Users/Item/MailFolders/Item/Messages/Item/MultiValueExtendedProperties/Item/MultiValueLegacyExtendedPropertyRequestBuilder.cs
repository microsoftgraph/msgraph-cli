...
namespace ApiSdk.Users.Item.MailFolders.Item.Messages.Item.MultiValueExtendedProperties.Item {
    ...
    public class MultiValueLegacyExtendedPropertyRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string userId, string mailFolderId, string messageId, string multiValueLegacyExtendedPropertyId, IOutputFormatterFactory outputFormatterFactory, CancellationToken cancellationToken) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string userId, string mailFolderId, string messageId, string multiValueLegacyExtendedPropertyId, string[] select, string[] expand, FormatterType output, IOutputFormatterFactory outputFormatterFactory, CancellationToken cancellationToken) => {
            ...
            }, userIdOption, mailFolderIdOption, messageIdOption, multiValueLegacyExtendedPropertyIdOption, selectOption, expandOption, outputOption);
            return command;
        }
        /// <summary>
        /// The collection of multi-value extended properties defined for the message. Nullable.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string userId, string mailFolderId, string messageId, string multiValueLegacyExtendedPropertyId, string body, IOutputFormatterFactory outputFormatterFactory, CancellationToken cancellationToken) => {
