...
namespace ApiSdk.Users.Item.MailFolders.Item.Messages.Item.Copy {
    ...
    public class CopyRequestBuilder {
        ...
        /// </summary>
        public async Task<CopyResponse> PostAsync(CopyRequestBody model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
