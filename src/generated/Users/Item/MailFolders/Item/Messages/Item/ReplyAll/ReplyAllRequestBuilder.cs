    ...
    public class ReplyAllRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Users.Item.MailFolders.Item.Messages.Item.ReplyAll.ReplyAllRequestBody>(ApiSdk.Users.Item.MailFolders.Item.Messages.Item.ReplyAll.ReplyAllRequestBody.CreateFromDiscriminatorValue);
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ApiSdk.Users.Item.MailFolders.Item.Messages.Item.ReplyAll.ReplyAllRequestBody body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
