...
namespace ApiSdk.Users.Item.MailFolders.Item.Messages.Item.CalendarSharingMessage.Accept {
    ...
    public class AcceptRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            }, new CollectionBinding(userIdOption, mailFolderIdOption, messageIdOption, outputOption, outputFilterOption, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
