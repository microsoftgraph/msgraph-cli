...
namespace ApiSdk.Users.Item.MailFolders.Item.Messages.Item.Attachments.Item {
    ...
    public class AttachmentRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string, string>(async (userId, mailFolderId, messageId, attachmentId) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string, string, object, object>(async (userId, mailFolderId, messageId, attachmentId, select, expand) => {
        ...
        public Command BuildPatchCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string, string, string>(async (userId, mailFolderId, messageId, attachmentId, body) => {
