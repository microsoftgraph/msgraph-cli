...
namespace ApiSdk.Users.Item.MailFolders.Item.Messages.Item.Attachments.Item {
    ...
    public class AttachmentRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string userId, string mailFolderId, string messageId, string attachmentId) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string userId, string mailFolderId, string messageId, string attachmentId, string[] select, string[] expand) => {
            ...
            }, userIdOption, mailFolderIdOption, messageIdOption, attachmentIdOption, selectOption, expandOption);
            return command;
        }
        /// <summary>
        /// The fileAttachment and itemAttachment attachments for the message.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string userId, string mailFolderId, string messageId, string attachmentId, string body) => {
