...
namespace ApiSdk.Users.Item.MailFolders.Item.Messages.Item.Attachments {
    ...
    public class AttachmentsRequestBuilder {
        ...
        public Command BuildListCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string, int?, int?, string, bool?, object, object, object>(async (userId, mailFolderId, messageId, top, skip, filter, count, orderby, select, expand) => {
