    ...
    public class CreateForwardRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Users.Item.MailFolders.Item.Messages.Item.CreateForward.CreateForwardRequestBody>(ApiSdk.Users.Item.MailFolders.Item.Messages.Item.CreateForward.CreateForwardRequestBody.CreateFromDiscriminatorValue);
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ApiSdk.Users.Item.MailFolders.Item.Messages.Item.CreateForward.CreateForwardRequestBody body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
