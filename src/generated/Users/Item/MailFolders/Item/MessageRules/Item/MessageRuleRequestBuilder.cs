...
namespace ApiSdk.Users.Item.MailFolders.Item.MessageRules.Item {
    ...
    public class MessageRuleRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            }, userIdOption, mailFolderIdOption, messageRuleIdOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// The collection of rules that apply to the user's Inbox folder.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string userId, string mailFolderId, string messageRuleId, string[] select, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
            ...
            }, userIdOption, mailFolderIdOption, messageRuleIdOption, selectOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// The collection of rules that apply to the user's Inbox folder.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string userId, string mailFolderId, string messageRuleId, string body, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                ...
                await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                console.WriteLine("Success");
            }, userIdOption, mailFolderIdOption, messageRuleIdOption, bodyOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
