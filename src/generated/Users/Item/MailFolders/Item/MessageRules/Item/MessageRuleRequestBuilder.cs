...
namespace ApiSdk.Users.Item.MailFolders.Item.MessageRules.Item {
    ...
    public class MessageRuleRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            var messageRuleIdOption = new Option<string>("--messagerule-id", description: "key: id of messageRule") {
            };
            messageRuleIdOption.IsRequired = true;
            command.AddOption(messageRuleIdOption);
            command.SetHandler(async (string userId, string mailFolderId, string messageRuleId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, userIdOption, mailFolderIdOption, messageRuleIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The collection of rules that apply to the user's Inbox folder.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string userId, string mailFolderId, string messageRuleId, string[] select, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, userIdOption, mailFolderIdOption, messageRuleIdOption, selectOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The collection of rules that apply to the user's Inbox folder.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string userId, string mailFolderId, string messageRuleId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, userIdOption, mailFolderIdOption, messageRuleIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
