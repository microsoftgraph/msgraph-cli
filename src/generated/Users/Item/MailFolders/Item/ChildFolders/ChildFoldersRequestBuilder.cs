...
namespace ApiSdk.Users.Item.MailFolders.Item.ChildFolders {
    ...
    public class ChildFoldersRequestBuilder {
        ...
        public Command BuildListCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, int?, int?, string, bool?, string[], string[], string[]>(async (userId, mailFolderId, top, skip, filter, count, orderby, select, expand) => {
