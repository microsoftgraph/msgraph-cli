    ...
    public class ReplyAllRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Users.Item.MailFolders.Item.ChildFolders.Item.Messages.Item.ReplyAll.ReplyAllRequestBody>(ApiSdk.Users.Item.MailFolders.Item.ChildFolders.Item.Messages.Item.ReplyAll.ReplyAllRequestBody.CreateFromDiscriminatorValue);
        ...
        public ReplyAllRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/users/{user_id}/mailFolders/{mailFolder_id}/childFolders/{mailFolder_id1}/messages/{message_id}/microsoft.graph.replyAll";
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ApiSdk.Users.Item.MailFolders.Item.ChildFolders.Item.Messages.Item.ReplyAll.ReplyAllRequestBody body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
