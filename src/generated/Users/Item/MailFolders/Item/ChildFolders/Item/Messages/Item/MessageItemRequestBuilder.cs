...
namespace ApiSdk.Users.Item.MailFolders.Item.ChildFolders.Item.Messages.Item {
    ...
    public class MessageItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public MessageItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/users/{user%2Did}/mailFolders/{mailFolder%2Did}/childFolders/{mailFolder%2Did1}/messages/{message%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Delete navigation property messages for users
        /// </summary>
