...
namespace ApiSdk.Users.Item.MailFolders.Item.ChildFolders.Item.Move {
    ...
    public class MoveRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (string userId, string mailFolderId, string mailFolderId1, string body, FormatterType output, IOutputFormatterFactory outputFormatterFactory, CancellationToken cancellationToken) => {
            ...
            }, userIdOption, mailFolderIdOption, mailFolderId1Option, bodyOption, outputOption);
            return command;
        }
        /// <summary>
