...
namespace ApiSdk.Users.Item.MailFolders.Item.ChildFolders.Item {
    ...
    public class MailFolderRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            }, userIdOption, mailFolderIdOption, mailFolderId1Option, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// The collection of child folders in the mailFolder.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string userId, string mailFolderId, string mailFolderId1, string[] select, string[] expand, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
            ...
            }, userIdOption, mailFolderIdOption, mailFolderId1Option, selectOption, expandOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string userId, string mailFolderId, string mailFolderId1, string body, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                ...
                await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                console.WriteLine("Success");
            }, userIdOption, mailFolderIdOption, mailFolderId1Option, bodyOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
