...
namespace ApiSdk.Users.Item.MailFolders.Item.ChildFolders.Item {
    ...
    public class MailFolderRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string userId, string mailFolderId, string mailFolderId1, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, userIdOption, mailFolderIdOption, mailFolderId1Option, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The collection of child folders in the mailFolder.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string userId, string mailFolderId, string mailFolderId1, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, userIdOption, mailFolderIdOption, mailFolderId1Option, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string userId, string mailFolderId, string mailFolderId1, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, userIdOption, mailFolderIdOption, mailFolderId1Option, bodyOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
