    ...
    public class MessageRuleItemRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                PathParameters.Add("messageRule_id", messageRuleId);
            ...
            }, new CollectionBinding(userIdOption, mailFolderIdOption, mailFolderId1Option, messageRuleIdOption, new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
