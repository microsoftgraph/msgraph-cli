...
namespace ApiSdk.Users.Item.MailFolders.Item.ChildFolders.Item.Messages.Item.Reply {
    ...
    public class ReplyRequestBody : IAdditionalDataHolder, IParsable {
        ...
        /// </summary>
        public static ApiSdk.Users.Item.MailFolders.Item.ChildFolders.Item.Messages.Item.Reply.ReplyRequestBody CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"message", (o,n) => { (o as ReplyRequestBody).Message = n.GetObjectValue<ApiSdk.Models.Microsoft.Graph.Message>(ApiSdk.Models.Microsoft.Graph.Message.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
