...
namespace ApiSdk.Users.Item.MailFolders.Item.MultiValueExtendedProperties {
    ...
    public class MultiValueExtendedPropertiesRequestBuilder {
        ...
        public Command BuildCreateCommand() {
            ...
            command.SetHandler(async (string userId, string mailFolderId, string body, FormatterType output, IConsole console) => {
        ...
        public Command BuildListCommand() {
            ...
            command.AddOption(outputOption);
            command.SetHandler(async (string userId, string mailFolderId, int? top, int? skip, string search, string filter, bool? count, string[] orderby, string[] select, string[] expand, FormatterType output, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
