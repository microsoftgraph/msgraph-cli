...
namespace ApiSdk.Users.Item.Calendars.Item.AllowedCalendarSharingRolesWithUser {
    ...
    public class AllowedCalendarSharingRolesWithUserRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string userId, string calendarId, string User, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, userIdOption, calendarIdOption, UserOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
