...
namespace ApiSdk.Users.Item.Calendars.Item.Events.Item.Instances.Item {
    ...
    public class EventRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string, string>(async (userId, calendarId, eventId, eventId1) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string, string, string[]>(async (userId, calendarId, eventId, eventId1, select) => {
        ...
        public Command BuildPatchCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string, string, string>(async (userId, calendarId, eventId, eventId1, body) => {
