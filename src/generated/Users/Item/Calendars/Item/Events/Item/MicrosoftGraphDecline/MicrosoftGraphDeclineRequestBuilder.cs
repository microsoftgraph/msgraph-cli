...
namespace ApiSdk.Users.Item.Calendars.Item.Events.Item.MicrosoftGraphDecline {
    /// <summary>
    ...
    public class MicrosoftGraphDeclineRequestBuilder {
        ...
        public MicrosoftGraphDeclineRequestBuilder(Dictionary<string, object> pathParameters) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            UrlTemplate = "{+baseurl}/users/{user%2Did}/calendars/{calendar%2Did}/events/{event%2Did}/microsoft.graph.decline";
