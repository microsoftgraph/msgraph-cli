...
using ApiSdk.Users.Item.Calendars.Item.Events.Item.Instances.Item.SingleValueExtendedProperties.Count;
using ApiSdk.Users.Item.Calendars.Item.Events.Item.Instances.Item.SingleValueExtendedProperties.Item;
...
namespace ApiSdk.Users.Item.Calendars.Item.Events.Item.Instances.Item.SingleValueExtendedProperties {
    /// <summary>
    ...
    public class SingleValueExtendedPropertiesRequestBuilder : BaseCliRequestBuilder {
        ...
        public SingleValueExtendedPropertiesRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/users/{user%2Did}/calendars/{calendar%2Did}/events/{event%2Did}/instances/{event%2Did1}/singleValueExtendedProperties{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// The collection of single-value extended properties defined for the event. Read-only. Nullable.
        /// </summary>
