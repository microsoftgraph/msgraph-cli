    ...
    public class GetScheduleRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string, string>(async (userId, calendarId, eventId, body) => {
                ...
                var result = await RequestAdapter.SendCollectionAsync<ApiSdk.Users.Item.Calendars.Item.Events.Item.Calendar.GetSchedule.GetSchedule>(requestInfo);
        ...
        /// </summary>
        public async Task<IEnumerable<ApiSdk.Users.Item.Calendars.Item.Events.Item.Calendar.GetSchedule.GetSchedule>> PostAsync(GetScheduleRequestBody model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = model ?? throw new ArgumentNullException(nameof(model));
            var requestInfo = CreatePostRequestInformation(model, h, o);
            return await RequestAdapter.SendCollectionAsync<ApiSdk.Users.Item.Calendars.Item.Events.Item.Calendar.GetSchedule.GetSchedule>(requestInfo, responseHandler, cancellationToken);
        }
    }
}
