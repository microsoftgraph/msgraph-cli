...
namespace ApiSdk.Users.Item.Calendars.Item.Events.Item.Extensions.Item {
    ...
    public class ExtensionRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string userId, string calendarId, string eventId, string extensionId, IConsole console) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string userId, string calendarId, string eventId, string extensionId, string[] select, string[] expand, FormatterType output, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string userId, string calendarId, string eventId, string extensionId, string body, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
