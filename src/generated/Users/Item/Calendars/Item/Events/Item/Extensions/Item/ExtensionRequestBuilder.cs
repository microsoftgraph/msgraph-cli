...
namespace ApiSdk.Users.Item.Calendars.Item.Events.Item.Extensions.Item {
    ...
    public class ExtensionRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string userId, string calendarId, string eventId, string extensionId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, userIdOption, calendarIdOption, eventIdOption, extensionIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The collection of open extensions defined for the event. Nullable.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string userId, string calendarId, string eventId, string extensionId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, userIdOption, calendarIdOption, eventIdOption, extensionIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The collection of open extensions defined for the event. Nullable.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string userId, string calendarId, string eventId, string extensionId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, userIdOption, calendarIdOption, eventIdOption, extensionIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
