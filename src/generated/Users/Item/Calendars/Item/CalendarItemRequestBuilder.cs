...
namespace ApiSdk.Users.Item.Calendars.Item
{
    ...
    public class CalendarItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildAllowedCalendarSharingRolesWithUserRbCommand()
        {
            ...
            var builder = new ApiSdk.Users.Item.Calendars.Item.AllowedCalendarSharingRolesWithUser.AllowedCalendarSharingRolesWithUserRequestBuilder(PathParameters);
        ...
        public Command BuildCalendarPermissionsNavCommand()
        {
            ...
            var builder = new ApiSdk.Users.Item.Calendars.Item.CalendarPermissions.CalendarPermissionsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildCalendarViewNavCommand()
        {
            ...
            var builder = new ApiSdk.Users.Item.Calendars.Item.CalendarView.CalendarViewRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
        ...
        public Command BuildEventsNavCommand()
        {
            ...
            var builder = new ApiSdk.Users.Item.Calendars.Item.Events.EventsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildGetScheduleNavCommand()
        {
            ...
            var builder = new ApiSdk.Users.Item.Calendars.Item.GetSchedule.GetScheduleRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Users.Item.Calendars.Item.CalendarItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Users.Item.Calendars.Item.CalendarItemRequestBuilder.CalendarItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Users.Item.Calendars.Item.CalendarItemRequestBuilder.CalendarItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
