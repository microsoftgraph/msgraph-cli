...
namespace ApiSdk.Users.Item.Calendars.Item.CalendarView {
    ...
    public class CalendarViewRequestBuilder {
        ...
        public Command BuildListCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string, string, int?, int?, string, bool?, object, object>(async (userId, calendarId, startDateTime, endDateTime, top, skip, filter, count, orderby, select) => {
