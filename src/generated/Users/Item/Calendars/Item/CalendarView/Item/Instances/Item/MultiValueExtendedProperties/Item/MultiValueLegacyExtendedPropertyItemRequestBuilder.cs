...
namespace ApiSdk.Users.Item.Calendars.Item.CalendarView.Item.Instances.Item.MultiValueExtendedProperties.Item {
    ...
    public class MultiValueLegacyExtendedPropertyItemRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            }, new CollectionBinding(userIdOption, calendarIdOption, eventIdOption, eventId1Option, multiValueLegacyExtendedPropertyIdOption, new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
