...
namespace ApiSdk.Users.Item.Calendars.Item.CalendarView.Item.Extensions {
    ...
    public class ExtensionsRequestBuilder {
        ...
        public Command BuildListCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string, int?, int?, string, bool?, object, object, object>(async (userId, calendarId, eventId, top, skip, filter, count, orderby, select, expand) => {
