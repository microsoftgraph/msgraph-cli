...
namespace ApiSdk.Users.Item.Calendars.Item.CalendarView.Item.Instances.Item.DismissReminder {
    ...
    public class DismissReminderRequestBuilder {
        ...
        public DismissReminderRequestBuilder(Dictionary<string, object> pathParameters) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            UrlTemplate = "{+baseurl}/users/{user%2Did}/calendars/{calendar%2Did}/calendarView/{event%2Did}/instances/{event%2Did1}/dismissReminder";
