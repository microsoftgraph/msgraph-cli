...
namespace ApiSdk.Users.Item.DeviceManagementTroubleshootingEvents.Item {
    ...
    public class DeviceManagementTroubleshootingEventRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string userId, string deviceManagementTroubleshootingEventId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, userIdOption, deviceManagementTroubleshootingEventIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The list of troubleshooting events for this user.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string userId, string deviceManagementTroubleshootingEventId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, userIdOption, deviceManagementTroubleshootingEventIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The list of troubleshooting events for this user.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string userId, string deviceManagementTroubleshootingEventId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, userIdOption, deviceManagementTroubleshootingEventIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
