    ...
    public class TasksRequestBuilder {
        ...
        public List<Command> BuildCommand() {
            ...
            var commands = new List<Command> { 
                ...
                builder.BuildLinkedResourcesCommand(),
        ...
        public Command BuildCreateCommand() {
            ...
            command.SetHandler(async (string userId, string todoTaskListId, string body) => {
            ...
            }, userIdOption, todoTaskListIdOption, bodyOption);
            return command;
        }
        /// <summary>
        /// The tasks in this task list. Read-only. Nullable.
        ...
        public Command BuildListCommand() {
            ...
            command.SetHandler(async (string userId, string todoTaskListId, int? top, int? skip, string search, string filter, bool? count, string[] orderby, string[] select, string[] expand) => {
                ...
                var strContent = await reader.ReadToEndAsync();
                Console.Write(strContent + "\n");
            }, userIdOption, todoTaskListIdOption, topOption, skipOption, searchOption, filterOption, countOption, orderbyOption, selectOption, expandOption);
            return command;
        }
        /// <summary>
