...
namespace ApiSdk.Users.Item.Todo.Lists.Item.Tasks.Item.Extensions.Item {
    ...
    public class ExtensionRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string userId, string todoTaskListId, string todoTaskId, string extensionId) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string userId, string todoTaskListId, string todoTaskId, string extensionId, string[] select, string[] expand) => {
            ...
            }, userIdOption, todoTaskListIdOption, todoTaskIdOption, extensionIdOption, selectOption, expandOption);
            return command;
        }
        /// <summary>
        /// The collection of open extensions defined for the task. Nullable.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string userId, string todoTaskListId, string todoTaskId, string extensionId, string body) => {
