...
namespace ApiSdk.Users.Item.Todo.Lists.Item.Tasks.Item.Extensions.Item {
    ...
    public class ExtensionRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            }, userIdOption, todoTaskListIdOption, todoTaskIdOption, extensionIdOption);
            return command;
        }
        /// <summary>
        /// The collection of open extensions defined for the task. Nullable.
        ...
        public Command BuildGetCommand() {
            ...
            }, userIdOption, todoTaskListIdOption, todoTaskIdOption, extensionIdOption, selectOption, expandOption, outputOption);
            return command;
        }
        /// <summary>
        /// The collection of open extensions defined for the task. Nullable.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string userId, string todoTaskListId, string todoTaskId, string extensionId, string body, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                ...
                await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                console.WriteLine("Success");
            }, userIdOption, todoTaskListIdOption, todoTaskIdOption, extensionIdOption, bodyOption);
            return command;
        }
        /// <summary>
