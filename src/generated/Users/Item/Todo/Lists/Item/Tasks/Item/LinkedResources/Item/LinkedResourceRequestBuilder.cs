...
namespace ApiSdk.Users.Item.Todo.Lists.Item.Tasks.Item.LinkedResources.Item {
    ...
    public class LinkedResourceRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string userId, string todoTaskListId, string todoTaskId, string linkedResourceId, IConsole console) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string userId, string todoTaskListId, string todoTaskId, string linkedResourceId, string[] select, string[] expand, FormatterType output, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string userId, string todoTaskListId, string todoTaskId, string linkedResourceId, string body, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
