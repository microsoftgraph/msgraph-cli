...
namespace ApiSdk.Users.Item.RegisteredDevices {
    ...
    public class RegisteredDevicesRequestBuilder : BaseCliRequestBuilder {
        ...
        public RegisteredDevicesRequestBuilder(string rawUrl) : base("{+baseurl}/users/{user%2Did}/registeredDevices{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Devices that are registered for the user. Read-only. Nullable. Supports $expand and returns up to 100 objects.
        /// </summary>
