    ...
    public class RegisteredDevicesRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.Handler = CommandHandler.Create<string, int?, int?, string, string, bool?, object, object, object>(async (userId, top, skip, search, filter, count, orderby, select, expand) => {
                ...
                var result = await RequestAdapter.SendAsync<RegisteredDevicesResponse>(requestInfo);
        ...
        public Command BuildRefCommand() {
            ...
            var builder = new ApiSdk.Users.Item.RegisteredDevices.@Ref.RefRequestBuilder(PathParameters, RequestAdapter);
