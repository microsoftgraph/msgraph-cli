...
namespace ApiSdk.Users.Item.Teamwork.InstalledApps.Item {
    ...
    public class UserScopeTeamsAppInstallationRequestBuilder {
        ...
        public Command BuildChatCommand() {
            ...
            var builder = new ApiSdk.Users.Item.Teamwork.InstalledApps.Item.Chat.ChatRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string userId, string userScopeTeamsAppInstallationId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, userIdOption, userScopeTeamsAppInstallationIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The apps installed in the personal scope of this user.
