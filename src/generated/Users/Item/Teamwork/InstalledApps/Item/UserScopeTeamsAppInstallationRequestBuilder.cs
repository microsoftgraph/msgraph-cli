...
namespace ApiSdk.Users.Item.Teamwork.InstalledApps.Item {
    ...
    public class UserScopeTeamsAppInstallationRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string userId, string userScopeTeamsAppInstallationId, string[] select, string[] expand, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
            ...
            }, userIdOption, userScopeTeamsAppInstallationIdOption, selectOption, expandOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// The apps installed in the personal scope of this user.
