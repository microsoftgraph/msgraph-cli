...
namespace ApiSdk.Users {
    ...
    public class UsersRequestBuilder : BaseCliRequestBuilder {
        ...
        /// Find more info here <see href="https://docs.microsoft.com/graph/api/intune-mam-user-create?view=graph-rest-1.0" />
        /// </summary>
        public Command BuildCreateCommand() {
            var command = new Command("create");
            command.Description = "Create a new user object.\n\nFind more info here:\n  https://docs.microsoft.com/graph/api/intune-mam-user-create?view=graph-rest-1.0";
