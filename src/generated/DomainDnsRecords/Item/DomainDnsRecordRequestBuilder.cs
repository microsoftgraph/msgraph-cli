...
namespace ApiSdk.DomainDnsRecords.Item {
    ...
    public class DomainDnsRecordRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string domainDnsRecordId, IConsole console) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string domainDnsRecordId, string[] select, string[] expand, FormatterType output, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string domainDnsRecordId, string body, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
