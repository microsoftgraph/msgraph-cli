...
namespace ApiSdk.GroupSettings.Item {
    ...
    public class GroupSettingItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.Description = "Delete a tenant-level or group-specific groupSetting object. This API is available in the following national cloud deployments.\n\nFind more info here:\n  https://learn.microsoft.com/graph/api/groupsetting-delete?view=graph-rest-1.0";
        ...
        public GroupSettingItemRequestBuilder(string rawUrl) : base("{+baseurl}/groupSettings/{groupSetting%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Delete a tenant-level or group-specific groupSetting object. This API is available in the following national cloud deployments.
        /// </summary>
