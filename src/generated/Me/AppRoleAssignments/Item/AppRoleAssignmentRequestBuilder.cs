...
namespace ApiSdk.Me.AppRoleAssignments.Item {
    ...
    public class AppRoleAssignmentRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string appRoleAssignmentId) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string appRoleAssignmentId, string[] select, string[] expand) => {
            ...
            }, appRoleAssignmentIdOption, selectOption, expandOption);
            return command;
        }
        /// <summary>
        /// Represents the app roles a user has been granted for an application. Supports $expand.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string appRoleAssignmentId, string body) => {
