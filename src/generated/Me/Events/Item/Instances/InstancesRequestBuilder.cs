using ApiSdk.Me.Events.Item.Instances.Count;
...
namespace ApiSdk.Me.Events.Item.Instances {
    ...
    public class InstancesRequestBuilder {
        ...
        public List<Command> BuildCommand() {
            var builder = new ApiSdk.Me.Events.Item.Instances.Item.EventItemRequestBuilder(PathParameters, RequestAdapter);
        ...
        public InstancesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/events/{event%2Did}/instances{?%24top,%24skip,%24filter,%24count,%24orderby,%24select}";
