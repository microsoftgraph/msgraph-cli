    ...
    public class CancelRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Me.Events.Item.Instances.Item.Cancel.CancelRequestBody>(ApiSdk.Me.Events.Item.Instances.Item.Cancel.CancelRequestBody.CreateFromDiscriminatorValue);
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ApiSdk.Me.Events.Item.Instances.Item.Cancel.CancelRequestBody body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
