...
namespace ApiSdk.Me.Events.Item.Calendar.AllowedCalendarSharingRolesWithUser {
    ...
    public class AllowedCalendarSharingRolesWithUserRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string eventId, string User, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, eventIdOption, UserOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
