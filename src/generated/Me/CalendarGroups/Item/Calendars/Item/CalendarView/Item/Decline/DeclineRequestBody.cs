...
namespace ApiSdk.Me.CalendarGroups.Item.Calendars.Item.CalendarView.Item.Decline {
    ...
    public class DeclineRequestBody : IAdditionalDataHolder, IParsable {
        ...
        /// </summary>
        public static ApiSdk.Me.CalendarGroups.Item.Calendars.Item.CalendarView.Item.Decline.DeclineRequestBody CreateFromDiscriminatorValue(IParseNode parseNode) {
