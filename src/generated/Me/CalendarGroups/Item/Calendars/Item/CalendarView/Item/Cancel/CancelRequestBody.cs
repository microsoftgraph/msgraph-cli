...
namespace ApiSdk.Me.CalendarGroups.Item.Calendars.Item.CalendarView.Item.Cancel {
    ...
    public class CancelRequestBody : IAdditionalDataHolder, IParsable {
        ...
        /// </summary>
        public static ApiSdk.Me.CalendarGroups.Item.Calendars.Item.CalendarView.Item.Cancel.CancelRequestBody CreateFromDiscriminatorValue(IParseNode parseNode) {
