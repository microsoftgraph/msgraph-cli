...
namespace ApiSdk.Me.CalendarGroups.Item.Calendars.Item.CalendarView.Item.Forward {
    ...
    public class ForwardRequestBody : IAdditionalDataHolder, IParsable {
        ...
        /// </summary>
        public static ApiSdk.Me.CalendarGroups.Item.Calendars.Item.CalendarView.Item.Forward.ForwardRequestBody CreateFromDiscriminatorValue(IParseNode parseNode) {
