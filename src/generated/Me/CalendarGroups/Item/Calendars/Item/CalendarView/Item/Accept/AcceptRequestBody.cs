...
namespace ApiSdk.Me.CalendarGroups.Item.Calendars.Item.CalendarView.Item.Accept {
    ...
    public class AcceptRequestBody : IAdditionalDataHolder, IParsable {
        ...
        /// </summary>
        public static ApiSdk.Me.CalendarGroups.Item.Calendars.Item.CalendarView.Item.Accept.AcceptRequestBody CreateFromDiscriminatorValue(IParseNode parseNode) {
