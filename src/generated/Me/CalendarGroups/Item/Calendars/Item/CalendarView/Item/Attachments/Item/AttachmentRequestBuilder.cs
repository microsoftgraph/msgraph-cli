...
namespace ApiSdk.Me.CalendarGroups.Item.Calendars.Item.CalendarView.Item.Attachments.Item {
    ...
    public class AttachmentRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string calendarGroupId, string calendarId, string eventId, string attachmentId) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string calendarGroupId, string calendarId, string eventId, string attachmentId, string[] select, string[] expand) => {
            ...
            }, calendarGroupIdOption, calendarIdOption, eventIdOption, attachmentIdOption, selectOption, expandOption);
            return command;
        }
        /// <summary>
        /// The collection of FileAttachment, ItemAttachment, and referenceAttachment attachments for the event. Navigation property. Read-only. Nullable.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string calendarGroupId, string calendarId, string eventId, string attachmentId, string body) => {
