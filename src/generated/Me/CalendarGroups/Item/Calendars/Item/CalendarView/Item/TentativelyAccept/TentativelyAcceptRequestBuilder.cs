    ...
    public class TentativelyAcceptRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Me.CalendarGroups.Item.Calendars.Item.CalendarView.Item.TentativelyAccept.TentativelyAcceptRequestBody>(ApiSdk.Me.CalendarGroups.Item.Calendars.Item.CalendarView.Item.TentativelyAccept.TentativelyAcceptRequestBody.CreateFromDiscriminatorValue);
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ApiSdk.Me.CalendarGroups.Item.Calendars.Item.CalendarView.Item.TentativelyAccept.TentativelyAcceptRequestBody body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
