    ...
    public class CancelRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Me.CalendarGroups.Item.Calendars.Item.Events.Item.Cancel.CancelRequestBody>(ApiSdk.Me.CalendarGroups.Item.Calendars.Item.Events.Item.Cancel.CancelRequestBody.CreateFromDiscriminatorValue);
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ApiSdk.Me.CalendarGroups.Item.Calendars.Item.Events.Item.Cancel.CancelRequestBody body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
