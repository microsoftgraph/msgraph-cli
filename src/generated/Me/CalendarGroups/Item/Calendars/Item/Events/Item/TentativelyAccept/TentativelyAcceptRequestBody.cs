...
namespace ApiSdk.Me.CalendarGroups.Item.Calendars.Item.Events.Item.TentativelyAccept {
    ...
    public class TentativelyAcceptRequestBody : IAdditionalDataHolder, IParsable {
        ...
        /// </summary>
        public static ApiSdk.Me.CalendarGroups.Item.Calendars.Item.Events.Item.TentativelyAccept.TentativelyAcceptRequestBody CreateFromDiscriminatorValue(IParseNode parseNode) {
