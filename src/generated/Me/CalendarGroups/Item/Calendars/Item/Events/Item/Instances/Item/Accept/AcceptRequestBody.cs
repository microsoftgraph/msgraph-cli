...
namespace ApiSdk.Me.CalendarGroups.Item.Calendars.Item.Events.Item.Instances.Item.Accept {
    ...
    public class AcceptRequestBody : IAdditionalDataHolder, IParsable {
        ...
        /// </summary>
        public static ApiSdk.Me.CalendarGroups.Item.Calendars.Item.Events.Item.Instances.Item.Accept.AcceptRequestBody CreateFromDiscriminatorValue(IParseNode parseNode) {
