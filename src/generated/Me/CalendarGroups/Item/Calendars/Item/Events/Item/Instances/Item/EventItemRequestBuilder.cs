using ApiSdk.Me.CalendarGroups.Item.Calendars.Item.Events.Item.Instances.Item.Attachments;
using ApiSdk.Me.CalendarGroups.Item.Calendars.Item.Events.Item.Instances.Item.Calendar;
using ApiSdk.Me.CalendarGroups.Item.Calendars.Item.Events.Item.Instances.Item.Extensions;
using ApiSdk.Me.CalendarGroups.Item.Calendars.Item.Events.Item.Instances.Item.MicrosoftGraphAccept;
using ApiSdk.Me.CalendarGroups.Item.Calendars.Item.Events.Item.Instances.Item.MicrosoftGraphCancel;
using ApiSdk.Me.CalendarGroups.Item.Calendars.Item.Events.Item.Instances.Item.MicrosoftGraphDecline;
using ApiSdk.Me.CalendarGroups.Item.Calendars.Item.Events.Item.Instances.Item.MicrosoftGraphDismissReminder;
using ApiSdk.Me.CalendarGroups.Item.Calendars.Item.Events.Item.Instances.Item.MicrosoftGraphForward;
using ApiSdk.Me.CalendarGroups.Item.Calendars.Item.Events.Item.Instances.Item.MicrosoftGraphSnoozeReminder;
using ApiSdk.Me.CalendarGroups.Item.Calendars.Item.Events.Item.Instances.Item.MicrosoftGraphTentativelyAccept;
using ApiSdk.Me.CalendarGroups.Item.Calendars.Item.Events.Item.Instances.Item.MultiValueExtendedProperties;
using ApiSdk.Me.CalendarGroups.Item.Calendars.Item.Events.Item.Instances.Item.SingleValueExtendedProperties;
using ApiSdk.Models;
