...
namespace ApiSdk.Me.CalendarGroups.Item.Calendars.Item.Events.Item.Instances {
    ...
    public class InstancesRequestBuilder {
        ...
        public Command BuildListCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string, int?, int?, string, bool?, object, object>(async (calendarGroupId, calendarId, eventId, top, skip, filter, count, orderby, select) => {
