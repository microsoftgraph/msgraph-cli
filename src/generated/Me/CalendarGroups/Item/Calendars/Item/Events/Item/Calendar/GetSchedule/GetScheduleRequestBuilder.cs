...
namespace ApiSdk.Me.CalendarGroups.Item.Calendars.Item.Events.Item.Calendar.GetSchedule {
    ...
    public class GetScheduleRequestBuilder {
        ...
        public async Task<IEnumerable<ApiSdk.Me.CalendarGroups.Item.Calendars.Item.Events.Item.Calendar.GetSchedule.GetSchedule>> PostAsync(GetScheduleRequestBody model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            ...
            return await RequestAdapter.SendCollectionAsync<ApiSdk.Me.CalendarGroups.Item.Calendars.Item.Events.Item.Calendar.GetSchedule.GetSchedule>(requestInfo, responseHandler, cancellationToken);
        }
    }
}
