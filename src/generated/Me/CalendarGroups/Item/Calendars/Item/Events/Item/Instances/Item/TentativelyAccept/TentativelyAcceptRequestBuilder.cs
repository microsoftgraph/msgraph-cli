...
namespace ApiSdk.Me.CalendarGroups.Item.Calendars.Item.Events.Item.Instances.Item.TentativelyAccept {
    ...
    public class TentativelyAcceptRequestBuilder {
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ApiSdk.Me.CalendarGroups.Item.Calendars.Item.Events.Item.Instances.Item.TentativelyAccept.TentativelyAcceptRequestBody body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
