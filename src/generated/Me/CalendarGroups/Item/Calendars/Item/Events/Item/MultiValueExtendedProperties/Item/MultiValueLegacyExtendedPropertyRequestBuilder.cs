...
namespace ApiSdk.Me.CalendarGroups.Item.Calendars.Item.Events.Item.MultiValueExtendedProperties.Item {
    ...
    public class MultiValueLegacyExtendedPropertyRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string calendarGroupId, string calendarId, string eventId, string multiValueLegacyExtendedPropertyId, IConsole console) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string calendarGroupId, string calendarId, string eventId, string multiValueLegacyExtendedPropertyId, string[] select, string[] expand, FormatterType output, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string calendarGroupId, string calendarId, string eventId, string multiValueLegacyExtendedPropertyId, string body, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
