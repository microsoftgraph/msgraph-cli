...
namespace ApiSdk.Me.CalendarGroups.Item.Calendars.Item.Events.Item.Instances.Item.Decline {
    ...
    public class DeclineRequestBody : IAdditionalDataHolder, IParsable {
        ...
        /// </summary>
        public static ApiSdk.Me.CalendarGroups.Item.Calendars.Item.Events.Item.Instances.Item.Decline.DeclineRequestBody CreateFromDiscriminatorValue(IParseNode parseNode) {
