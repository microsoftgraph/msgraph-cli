...
namespace ApiSdk.Me.CalendarGroups.Item.Calendars.Item.CalendarPermissions.Item {
    ...
    public class CalendarPermissionRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string calendarGroupId, string calendarId, string calendarPermissionId, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                var requestInfo = CreateDeleteRequestInformation(q => {
                });
                await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                console.WriteLine("Success");
            }, calendarGroupIdOption, calendarIdOption, calendarPermissionIdOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// The permissions of the users with whom the calendar is shared.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string calendarGroupId, string calendarId, string calendarPermissionId, string[] select, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
            ...
            }, calendarGroupIdOption, calendarIdOption, calendarPermissionIdOption, selectOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// The permissions of the users with whom the calendar is shared.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string calendarGroupId, string calendarId, string calendarPermissionId, string body, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                ...
                await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                console.WriteLine("Success");
            }, calendarGroupIdOption, calendarIdOption, calendarPermissionIdOption, bodyOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
