    ...
    public class GetScheduleRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Me.CalendarGroups.Item.Calendars.Item.GetSchedule.GetScheduleRequestBody>(ApiSdk.Me.CalendarGroups.Item.Calendars.Item.GetSchedule.GetScheduleRequestBody.CreateFromDiscriminatorValue);
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ApiSdk.Me.CalendarGroups.Item.Calendars.Item.GetSchedule.GetScheduleRequestBody body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
