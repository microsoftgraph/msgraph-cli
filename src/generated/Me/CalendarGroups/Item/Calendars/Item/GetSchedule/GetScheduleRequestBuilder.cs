    ...
    public class GetScheduleRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string>(async (calendarGroupId, calendarId, body) => {
                ...
                var result = await RequestAdapter.SendCollectionAsync<ApiSdk.Me.CalendarGroups.Item.Calendars.Item.GetSchedule.GetSchedule>(requestInfo);
        ...
        /// </summary>
        public async Task<IEnumerable<ApiSdk.Me.CalendarGroups.Item.Calendars.Item.GetSchedule.GetSchedule>> PostAsync(GetScheduleRequestBody model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
