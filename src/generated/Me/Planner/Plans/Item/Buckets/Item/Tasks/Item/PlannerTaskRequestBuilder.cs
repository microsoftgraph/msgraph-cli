...
namespace ApiSdk.Me.Planner.Plans.Item.Buckets.Item.Tasks.Item {
    ...
    public class PlannerTaskRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string plannerPlanId, string plannerBucketId, string plannerTaskId, IConsole console) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string plannerPlanId, string plannerBucketId, string plannerTaskId, string[] select, string[] expand, FormatterType output, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string plannerPlanId, string plannerBucketId, string plannerTaskId, string body, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
