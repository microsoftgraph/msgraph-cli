...
namespace ApiSdk.Me.Planner.Plans.Item.Buckets.Item {
    ...
    public class PlannerBucketRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string plannerPlanId, string plannerBucketId, IConsole console) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string plannerPlanId, string plannerBucketId, string[] select, string[] expand, FormatterType output, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string plannerPlanId, string plannerBucketId, string body, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
