...
namespace ApiSdk.Me.ReminderViewWithStartDateTimeWithEndDateTime {
    ...
    public class ReminderViewWithStartDateTimeWithEndDateTimeRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(StartDateTimeOption, EndDateTimeOption, outputOption, outputFilterOption, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
