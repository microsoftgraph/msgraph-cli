...
namespace ApiSdk.Me.ExportDeviceAndAppManagementData {
    /// <summary>
    ...
    public class ExportDeviceAndAppManagementDataRequestBuilder {
        ...
        public ExportDeviceAndAppManagementDataRequestBuilder(Dictionary<string, object> pathParameters) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            UrlTemplate = "{+baseurl}/me/exportDeviceAndAppManagementData()";
