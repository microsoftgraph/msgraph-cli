...
namespace ApiSdk.Me.ManagedDevices.Item.UpdateWindowsDeviceAccount {
    ...
    public class UpdateWindowsDeviceAccountRequestBody : IAdditionalDataHolder, IParsable {
        ...
        /// </summary>
        public static ApiSdk.Me.ManagedDevices.Item.UpdateWindowsDeviceAccount.UpdateWindowsDeviceAccountRequestBody CreateFromDiscriminatorValue(IParseNode parseNode) {
