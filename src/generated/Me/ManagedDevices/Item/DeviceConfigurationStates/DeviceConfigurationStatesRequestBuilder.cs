using ApiSdk.Me.ManagedDevices.Item.DeviceConfigurationStates.Count;
...
namespace ApiSdk.Me.ManagedDevices.Item.DeviceConfigurationStates {
    ...
    public class DeviceConfigurationStatesRequestBuilder {
        ...
        public List<Command> BuildCommand() {
            var builder = new DeviceConfigurationStateItemRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildCreateCommand() {
            ...
            command.Description = "Create new navigation property to deviceConfigurationStates for me";
            ...
            }, new CollectionBinding(managedDeviceIdOption, bodyOption, outputOption, queryOption, jsonNoIndentOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        ...
        public DeviceConfigurationStatesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/managedDevices/{managedDevice%2Did}/deviceConfigurationStates{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
