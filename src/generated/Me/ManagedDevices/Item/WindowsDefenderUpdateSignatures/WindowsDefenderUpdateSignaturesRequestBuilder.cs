...
namespace ApiSdk.Me.ManagedDevices.Item.WindowsDefenderUpdateSignatures {
    ...
    public class WindowsDefenderUpdateSignaturesRequestBuilder {
        ...
        public WindowsDefenderUpdateSignaturesRequestBuilder(Dictionary<string, object> pathParameters) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            UrlTemplate = "{+baseurl}/me/managedDevices/{managedDevice%2Did}/windowsDefenderUpdateSignatures";
