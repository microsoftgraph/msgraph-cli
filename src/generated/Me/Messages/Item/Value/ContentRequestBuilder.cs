...
namespace ApiSdk.Me.Messages.Item.Value {
    ...
    public class ContentRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string messageId, FileInfo file, FormatterType output, IConsole console) => {
        ...
        public Command BuildPutCommand() {
            ...
            command.SetHandler(async (string messageId, FileInfo file, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
