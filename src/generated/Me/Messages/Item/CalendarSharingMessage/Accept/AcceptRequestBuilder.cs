...
namespace ApiSdk.Me.Messages.Item.CalendarSharingMessage.Accept {
    ...
    public class AcceptRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (string messageId, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, messageIdOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
