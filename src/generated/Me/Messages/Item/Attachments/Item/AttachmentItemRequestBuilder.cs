...
namespace ApiSdk.Me.Messages.Item.Attachments.Item {
    ...
    public class AttachmentItemRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(messageIdOption, attachmentIdOption, selectOption, expandOption, outputOption, outputFilterOption, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// The fileAttachment and itemAttachment attachments for the message.
