using ApiSdk.Me.Drives.Item.Bundles;
using ApiSdk.Me.Drives.Item.Following;
using ApiSdk.Me.Drives.Item.Items;
using ApiSdk.Me.Drives.Item.List;
using ApiSdk.Me.Drives.Item.Root;
using ApiSdk.Me.Drives.Item.Special;
...
namespace ApiSdk.Me.Drives.Item {
    ...
    public class DriveItemRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.Description = "Delete navigation property drives for me";
        ...
        public Command BuildPatchCommand() {
            ...
            command.Description = "Update the navigation property drives in me";
            // Create options for all the parameters
            var driveIdOption = new Option<string>("--drive-id", description: "key: id of drive") {
            };
            driveIdOption.IsRequired = true;
