using ApiSdk.Me.Drives.Item.Special.Item.Content;
using ApiSdk.Models;
...
namespace ApiSdk.Me.Drives.Item.Special.Item {
    ...
    public class DriveItemItemRequestBuilder {
        ...
        public DriveItemItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/drives/{drive%2Did}/special/{driveItem%2Did}{?%24select,%24expand}";
