...
namespace ApiSdk.Me.Drives.Item.List.Items.Item.DocumentSetVersions.Item.Restore {
    /// <summary>
    ...
    public class RestoreRequestBuilder {
        ...
        public RestoreRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/drives/{drive%2Did}/list/items/{listItem%2Did}/documentSetVersions/{documentSetVersion%2Did}/microsoft.graph.restore";
