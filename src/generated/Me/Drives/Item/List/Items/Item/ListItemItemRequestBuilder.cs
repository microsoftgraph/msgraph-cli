...
namespace ApiSdk.Me.Drives.Item.List.Items.Item {
    ...
    public class ListItemItemRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            }, new CollectionBinding(driveIdOption, listItemIdOption, new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        ...
        public ListItemItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/drives/{drive_id}/list/items/{listItem_id}{?select,expand}";
