...
namespace ApiSdk.Me.Drives.Item.List.ContentTypes.AddCopy {
    ...
    public class AddCopyRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Me.Drives.Item.List.ContentTypes.AddCopy.AddCopyRequestBody>(ApiSdk.Me.Drives.Item.List.ContentTypes.AddCopy.AddCopyRequestBody.CreateFromDiscriminatorValue);
        ...
        public AddCopyRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/drives/{drive_id}/list/contentTypes/microsoft.graph.addCopy";
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ApiSdk.Me.Drives.Item.List.ContentTypes.AddCopy.AddCopyRequestBody body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
