using ApiSdk.Me.Drives.Item.List.ContentTypes.Item.BaseTypes.Count;
using ApiSdk.Me.Drives.Item.List.ContentTypes.Item.BaseTypes.Item;
...
namespace ApiSdk.Me.Drives.Item.List.ContentTypes.Item.BaseTypes {
    ...
    public class BaseTypesRequestBuilder {
        ...
        public List<Command> BuildCommand() {
            var builder = new ApiSdk.Me.Drives.Item.List.ContentTypes.Item.BaseTypes.Item.ContentTypeItemRequestBuilder(PathParameters, RequestAdapter);
