using ApiSdk.Me.Drives.Item.List.ContentTypes.Item.ColumnLinks.Count;
using ApiSdk.Me.Drives.Item.List.ContentTypes.Item.ColumnLinks.Item;
using ApiSdk.Models;
...
namespace ApiSdk.Me.Drives.Item.List.ContentTypes.Item.ColumnLinks {
    ...
    public class ColumnLinksRequestBuilder {
        ...
        public Command BuildCreateCommand() {
            ...
            command.Description = "Create new navigation property to columnLinks for me";
            ...
            }, new CollectionBinding(driveIdOption, contentTypeIdOption, bodyOption, outputOption, queryOption, jsonNoIndentOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
