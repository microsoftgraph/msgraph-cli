...
using System.IO;
using System.Linq;
namespace ApiSdk.Me.Drives.Item.List.ContentTypes.Item.AssociateWithHubSites {
    ...
    public class AssociateWithHubSitesRequestBody : IAdditionalDataHolder, IParsable {
        ...
        /// </summary>
        public static ApiSdk.Me.Drives.Item.List.ContentTypes.Item.AssociateWithHubSites.AssociateWithHubSitesRequestBody CreateFromDiscriminatorValue(IParseNode parseNode) {
