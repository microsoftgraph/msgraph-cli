using ApiSdk.Me.Drives.Item.List.ContentTypes.Item.AssociateWithHubSites;
using ApiSdk.Me.Drives.Item.List.ContentTypes.Item.Base;
using ApiSdk.Me.Drives.Item.List.ContentTypes.Item.BaseTypes;
using ApiSdk.Me.Drives.Item.List.ContentTypes.Item.ColumnLinks;
using ApiSdk.Me.Drives.Item.List.ContentTypes.Item.ColumnPositions;
using ApiSdk.Me.Drives.Item.List.ContentTypes.Item.Columns;
using ApiSdk.Me.Drives.Item.List.ContentTypes.Item.CopyToDefaultContentLocation;
using ApiSdk.Me.Drives.Item.List.ContentTypes.Item.IsPublished;
using ApiSdk.Me.Drives.Item.List.ContentTypes.Item.Publish;
using ApiSdk.Me.Drives.Item.List.ContentTypes.Item.Unpublish;
using ApiSdk.Models;
...
namespace ApiSdk.Me.Drives.Item.List.ContentTypes.Item {
    ...
    public class ContentTypeItemRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.Description = "Delete navigation property contentTypes for me";
            ...
            }, new CollectionBinding(driveIdOption, contentTypeIdOption, ifMatchOption, new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        ...
        public Command BuildPatchCommand() {
            ...
            command.Description = "Update the navigation property contentTypes in me";
            // Create options for all the parameters
            var driveIdOption = new Option<string>("--drive-id", description: "key: id of drive") {
            };
            driveIdOption.IsRequired = true;
