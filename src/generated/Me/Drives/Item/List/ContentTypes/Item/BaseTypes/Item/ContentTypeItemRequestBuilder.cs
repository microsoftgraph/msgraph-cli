...
namespace ApiSdk.Me.Drives.Item.List.ContentTypes.Item.BaseTypes.Item {
    ...
    public class ContentTypeItemRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                var contentTypeId1 = (string) parameters[2];
            ...
            }, new CollectionBinding(driveIdOption, contentTypeIdOption, contentTypeId1Option, selectOption, expandOption, outputOption, queryOption, jsonNoIndentOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
