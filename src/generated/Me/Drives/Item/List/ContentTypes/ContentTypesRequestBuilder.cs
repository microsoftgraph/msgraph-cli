using ApiSdk.Me.Drives.Item.List.ContentTypes.AddCopy;
using ApiSdk.Me.Drives.Item.List.ContentTypes.AddCopyFromContentTypeHub;
using ApiSdk.Me.Drives.Item.List.ContentTypes.Count;
using ApiSdk.Me.Drives.Item.List.ContentTypes.GetCompatibleHubContentTypes;
using ApiSdk.Me.Drives.Item.List.ContentTypes.Item;
using ApiSdk.Models;
...
namespace ApiSdk.Me.Drives.Item.List.ContentTypes {
    /// <summary>
    ...
    public class ContentTypesRequestBuilder {
        ...
        public Command BuildCreateCommand() {
            ...
            command.Description = "Create new navigation property to contentTypes for me";
