using ApiSdk.Me.Drives.Item.List.Columns;
using ApiSdk.Me.Drives.Item.List.ContentTypes;
using ApiSdk.Me.Drives.Item.List.Drive;
using ApiSdk.Me.Drives.Item.List.Items;
using ApiSdk.Me.Drives.Item.List.Operations;
using ApiSdk.Me.Drives.Item.List.Subscriptions;
using ApiSdk.Models;
...
namespace ApiSdk.Me.Drives.Item.List {
    ...
    public class ListRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.Description = "Delete navigation property list for me";
        ...
        public Command BuildPatchCommand() {
            ...
            command.Description = "Update the navigation property list in me";
            // Create options for all the parameters
            var driveIdOption = new Option<string>("--drive-id", description: "key: id of drive") {
            };
            driveIdOption.IsRequired = true;
