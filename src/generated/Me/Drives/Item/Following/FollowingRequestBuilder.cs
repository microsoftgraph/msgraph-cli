using ApiSdk.Me.Drives.Item.Following.Count;
using ApiSdk.Me.Drives.Item.Following.Item;
using ApiSdk.Models;
...
namespace ApiSdk.Me.Drives.Item.Following {
    ...
    public class FollowingRequestBuilder {
        ...
        public FollowingRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/drives/{drive%2Did}/following{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
