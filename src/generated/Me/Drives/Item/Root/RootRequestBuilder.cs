using ApiSdk.Me.Drives.Item.Root.Analytics;
using ApiSdk.Me.Drives.Item.Root.Checkin;
using ApiSdk.Me.Drives.Item.Root.Checkout;
using ApiSdk.Me.Drives.Item.Root.Children;
using ApiSdk.Me.Drives.Item.Root.Content;
using ApiSdk.Me.Drives.Item.Root.Copy;
using ApiSdk.Me.Drives.Item.Root.CreateLink;
using ApiSdk.Me.Drives.Item.Root.CreateUploadSession;
using ApiSdk.Me.Drives.Item.Root.Delta;
using ApiSdk.Me.Drives.Item.Root.DeltaWithToken;
using ApiSdk.Me.Drives.Item.Root.Follow;
using ApiSdk.Me.Drives.Item.Root.GetActivitiesByInterval;
using ApiSdk.Me.Drives.Item.Root.GetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithInterval;
using ApiSdk.Me.Drives.Item.Root.Invite;
using ApiSdk.Me.Drives.Item.Root.ListItem;
using ApiSdk.Me.Drives.Item.Root.Permissions;
using ApiSdk.Me.Drives.Item.Root.Preview;
using ApiSdk.Me.Drives.Item.Root.Restore;
using ApiSdk.Me.Drives.Item.Root.SearchWithQ;
using ApiSdk.Me.Drives.Item.Root.Subscriptions;
using ApiSdk.Me.Drives.Item.Root.Thumbnails;
using ApiSdk.Me.Drives.Item.Root.Unfollow;
using ApiSdk.Me.Drives.Item.Root.ValidatePermission;
using ApiSdk.Me.Drives.Item.Root.Versions;
using ApiSdk.Models;
...
namespace ApiSdk.Me.Drives.Item.Root {
    /// <summary>
    ...
    public class RootRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.Description = "Delete navigation property root for me";
        ...
        public Command BuildPatchCommand() {
            ...
            command.Description = "Update the navigation property root in me";
            // Create options for all the parameters
            var driveIdOption = new Option<string>("--drive-id", description: "key: id of drive") {
            };
            driveIdOption.IsRequired = true;
