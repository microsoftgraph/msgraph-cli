...
namespace ApiSdk.Me.Drives.Item.Items.Item.Versions.Item.RestoreVersion {
    ...
    public class RestoreVersionRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            }, new CollectionBinding(driveIdOption, driveItemIdOption, driveItemVersionIdOption, new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
