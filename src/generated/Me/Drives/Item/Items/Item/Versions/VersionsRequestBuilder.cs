using ApiSdk.Me.Drives.Item.Items.Item.Versions.Count;
using ApiSdk.Me.Drives.Item.Items.Item.Versions.Item;
using ApiSdk.Models;
...
namespace ApiSdk.Me.Drives.Item.Items.Item.Versions {
    ...
    public class VersionsRequestBuilder {
        ...
        public List<Command> BuildCommand() {
            var builder = new DriveItemVersionItemRequestBuilder(PathParameters, RequestAdapter);
