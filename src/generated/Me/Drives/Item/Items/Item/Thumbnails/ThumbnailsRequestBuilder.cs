using ApiSdk.Me.Drives.Item.Items.Item.Thumbnails.Count;
using ApiSdk.Me.Drives.Item.Items.Item.Thumbnails.Item;
using ApiSdk.Models;
...
namespace ApiSdk.Me.Drives.Item.Items.Item.Thumbnails {
    /// <summary>
