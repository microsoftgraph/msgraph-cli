using ApiSdk.Me.Drives.Item.Items.Item.ListItem.DocumentSetVersions.Item.Restore;
using ApiSdk.Models;
...
namespace ApiSdk.Me.Drives.Item.Items.Item.ListItem.DocumentSetVersions.Item {
    ...
    public class DocumentSetVersionItemRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.Description = "Delete navigation property documentSetVersions for me";
        ...
        public Command BuildPatchCommand() {
            ...
            command.Description = "Update the navigation property documentSetVersions in me";
            // Create options for all the parameters
            var driveIdOption = new Option<string>("--drive-id", description: "key: id of drive") {
            };
            driveIdOption.IsRequired = true;
