using ApiSdk.Me.Drives.Item.Items.Item.ListItem.Versions.Count;
using ApiSdk.Me.Drives.Item.Items.Item.ListItem.Versions.Item;
using ApiSdk.Models;
...
namespace ApiSdk.Me.Drives.Item.Items.Item.ListItem.Versions {
    ...
    public class VersionsRequestBuilder {
        ...
        public Command BuildCreateCommand() {
            ...
            command.Description = "Create new navigation property to versions for me";
            ...
            }, new CollectionBinding(driveIdOption, driveItemIdOption, bodyOption, outputOption, queryOption, jsonNoIndentOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        ...
        public VersionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/drives/{drive%2Did}/items/{driveItem%2Did}/listItem/versions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
