using ApiSdk.Me.Drives.Item.Items.Item.ListItem.Analytics;
using ApiSdk.Me.Drives.Item.Items.Item.ListItem.DocumentSetVersions;
using ApiSdk.Me.Drives.Item.Items.Item.ListItem.DriveItem;
using ApiSdk.Me.Drives.Item.Items.Item.ListItem.Fields;
...
namespace ApiSdk.Me.Drives.Item.Items.Item.ListItem {
    /// <summary>
    ...
    public class ListItemRequestBuilder {
        ...
        public Command BuildDriveItemCommand() {
            ...
            var builder = new ApiSdk.Me.Drives.Item.Items.Item.ListItem.DriveItem.DriveItemRequestBuilder(PathParameters, RequestAdapter);
