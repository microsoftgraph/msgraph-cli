using ApiSdk.Me.Drives.Item.Items.Item.Children.Item.Content;
using ApiSdk.Models;
...
namespace ApiSdk.Me.Drives.Item.Items.Item.Children.Item {
    ...
    public class DriveItemItemRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                var driveItemId1 = (string) parameters[2];
            ...
            }, new CollectionBinding(driveIdOption, driveItemIdOption, driveItemId1Option, selectOption, expandOption, outputOption, queryOption, jsonNoIndentOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
