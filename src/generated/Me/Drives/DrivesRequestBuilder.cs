...
namespace ApiSdk.Me.Drives {
    ...
    public class DrivesRequestBuilder {
        ...
        public List<Command> BuildCommand() {
            ...
            commands.Add(builder.BuildBundlesCommand());
            commands.Add(builder.BuildDeleteCommand());
            commands.Add(builder.BuildFollowingCommand());
            commands.Add(builder.BuildGetCommand());
            commands.Add(builder.BuildItemsCommand());
            commands.Add(builder.BuildListCommand());
            commands.Add(builder.BuildPatchCommand());
            commands.Add(builder.BuildRootCommand());
            commands.Add(builder.BuildSpecialCommand());
            return commands;
        }
        ...
        public Command BuildCreateCommand() {
            ...
            command.Description = "Create new navigation property to drives for me";
        ...
        /// <param name="options">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ApiSdk.Models.Microsoft.Graph.Drive body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
