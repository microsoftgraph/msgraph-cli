...
namespace ApiSdk.Me.InferenceClassification {
    ...
    public class InferenceClassificationRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.Description = "Delete navigation property inferenceClassification for me";
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(selectOption, outputOption, queryOption, jsonNoIndentOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        public Command BuildOverridesCommand() {
            var command = new Command("overrides");
            var builder = new OverridesRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildPatchCommand() {
            ...
            command.Description = "Update the navigation property inferenceClassification in me";
            // Create options for all the parameters
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Models.Microsoft.Graph.InferenceClassification>(ApiSdk.Models.Microsoft.Graph.InferenceClassification.CreateFromDiscriminatorValue);
        ...
        /// <param name="options">Request options</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(ApiSdk.Models.Microsoft.Graph.InferenceClassification body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
