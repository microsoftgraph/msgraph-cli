...
namespace ApiSdk.Me.InferenceClassification.Overrides.Item {
    ...
    public class InferenceClassificationOverrideRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string inferenceClassificationOverrideId, string[] select, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string inferenceClassificationOverrideId, string body, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
