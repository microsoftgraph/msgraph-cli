...
namespace ApiSdk.Me.InferenceClassification.Overrides.Item {
    ...
    public class InferenceClassificationOverrideRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string inferenceClassificationOverrideId, IConsole console) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string inferenceClassificationOverrideId, string[] select, FormatterType output, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string inferenceClassificationOverrideId, string body, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
