...
namespace ApiSdk.Me.ContactFolders.Item.ChildFolders.Item {
    ...
    public class ContactFolderRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string contactFolderId, string contactFolderId1, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                var requestInfo = CreateDeleteRequestInformation(q => {
                });
                await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                console.WriteLine("Success");
            }, contactFolderIdOption, contactFolderId1Option, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// The collection of child folders in the folder. Navigation property. Read-only. Nullable.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string contactFolderId, string contactFolderId1, string[] select, string[] expand, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
            ...
            }, contactFolderIdOption, contactFolderId1Option, selectOption, expandOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// The collection of child folders in the folder. Navigation property. Read-only. Nullable.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string contactFolderId, string contactFolderId1, string body, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                ...
                await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                console.WriteLine("Success");
            }, contactFolderIdOption, contactFolderId1Option, bodyOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
