...
namespace ApiSdk.Me.ContactFolders.Item.ChildFolders.Item {
    ...
    public class ContactFolderRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string contactFolderId, string contactFolderId1, IConsole console) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string contactFolderId, string contactFolderId1, string[] select, string[] expand, FormatterType output, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string contactFolderId, string contactFolderId1, string body, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
