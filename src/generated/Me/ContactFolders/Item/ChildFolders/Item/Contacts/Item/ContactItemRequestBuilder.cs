using ApiSdk.Me.ContactFolders.Item.ChildFolders.Item.Contacts.Item.Extensions;
using ApiSdk.Me.ContactFolders.Item.ChildFolders.Item.Contacts.Item.MultiValueExtendedProperties;
using ApiSdk.Me.ContactFolders.Item.ChildFolders.Item.Contacts.Item.Photo;
using ApiSdk.Me.ContactFolders.Item.ChildFolders.Item.Contacts.Item.SingleValueExtendedProperties;
using ApiSdk.Models;
...
namespace ApiSdk.Me.ContactFolders.Item.ChildFolders.Item.Contacts.Item {
    ...
    public class ContactItemRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            }, new CollectionBinding(contactFolderIdOption, contactFolderId1Option, contactIdOption, ifMatchOption, new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(contactFolderIdOption, contactFolderId1Option, contactIdOption, selectOption, expandOption, outputOption, queryOption, jsonNoIndentOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                await RequestAdapter.SendNoContentAsync(requestInfo, errorMapping: errorMapping, cancellationToken: cancellationToken);
                Console.WriteLine("Success");
            }, new CollectionBinding(contactFolderIdOption, contactFolderId1Option, contactIdOption, bodyOption, new TypeBinding(typeof(CancellationToken))));
            return command;
        }
