using ApiSdk.Me.ContactFolders.Item.ChildFolders.Item.MultiValueExtendedProperties.Count;
using ApiSdk.Me.ContactFolders.Item.ChildFolders.Item.MultiValueExtendedProperties.Item;
using ApiSdk.Models;
...
namespace ApiSdk.Me.ContactFolders.Item.ChildFolders.Item.MultiValueExtendedProperties {
    ...
    public class MultiValueExtendedPropertiesRequestBuilder {
        ...
        public Command BuildCreateCommand() {
            ...
            }, new CollectionBinding(contactFolderIdOption, contactFolderId1Option, bodyOption, outputOption, queryOption, jsonNoIndentOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        ...
        public MultiValueExtendedPropertiesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/contactFolders/{contactFolder%2Did}/childFolders/{contactFolder%2Did1}/multiValueExtendedProperties{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
