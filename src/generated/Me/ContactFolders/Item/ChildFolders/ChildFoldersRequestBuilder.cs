...
namespace ApiSdk.Me.ContactFolders.Item.ChildFolders {
    ...
    public class ChildFoldersRequestBuilder {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<ContactFolder> PostAsync(ContactFolder model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
