...
namespace ApiSdk.Me.ContactFolders.Item.MultiValueExtendedProperties.Item {
    ...
    public class MultiValueLegacyExtendedPropertyRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string contactFolderId, string multiValueLegacyExtendedPropertyId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, contactFolderIdOption, multiValueLegacyExtendedPropertyIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The collection of multi-value extended properties defined for the contactFolder. Read-only. Nullable.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string contactFolderId, string multiValueLegacyExtendedPropertyId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, contactFolderIdOption, multiValueLegacyExtendedPropertyIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The collection of multi-value extended properties defined for the contactFolder. Read-only. Nullable.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string contactFolderId, string multiValueLegacyExtendedPropertyId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, contactFolderIdOption, multiValueLegacyExtendedPropertyIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
