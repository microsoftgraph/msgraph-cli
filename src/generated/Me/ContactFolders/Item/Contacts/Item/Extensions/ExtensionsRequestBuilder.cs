...
namespace ApiSdk.Me.ContactFolders.Item.Contacts.Item.Extensions {
    ...
    public class ExtensionsRequestBuilder {
        ...
        public Command BuildListCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, int?, int?, string, bool?, string[], string[], string[]>(async (contactFolderId, contactId, top, skip, filter, count, orderby, select, expand) => {
