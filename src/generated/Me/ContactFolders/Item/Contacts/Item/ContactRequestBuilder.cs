...
namespace ApiSdk.Me.ContactFolders.Item.Contacts.Item {
    ...
    public class ContactRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string contactFolderId, string contactId, string[] select, string[] expand, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string contactFolderId, string contactId, string body, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
