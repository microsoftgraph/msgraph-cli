...
namespace ApiSdk.Me.ContactFolders.Item.Contacts.Item.SingleValueExtendedProperties.Item {
    ...
    public class SingleValueLegacyExtendedPropertyRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string, string[], string[]>(async (contactFolderId, contactId, singleValueLegacyExtendedPropertyId, select, expand) => {
