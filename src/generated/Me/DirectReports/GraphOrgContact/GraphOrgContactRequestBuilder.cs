using ApiSdk.Me.DirectReports.GraphOrgContact.Count;
using ApiSdk.Models;
...
namespace ApiSdk.Me.DirectReports.GraphOrgContact {
    /// <summary>
    ...
    public class GraphOrgContactRequestBuilder {
        ...
        public GraphOrgContactRequestBuilder(Dictionary<string, object> pathParameters) {
            ...
            UrlTemplate = "{+baseurl}/me/directReports/graph.orgContact{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
