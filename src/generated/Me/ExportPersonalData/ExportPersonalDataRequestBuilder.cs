    ...
    public class ExportPersonalDataRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Me.ExportPersonalData.ExportPersonalDataRequestBody>(ApiSdk.Me.ExportPersonalData.ExportPersonalDataRequestBody.CreateFromDiscriminatorValue);
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ApiSdk.Me.ExportPersonalData.ExportPersonalDataRequestBody body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
