    ...
    public class TranslateExchangeIdsRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Me.TranslateExchangeIds.TranslateExchangeIdsRequestBody>(ApiSdk.Me.TranslateExchangeIds.TranslateExchangeIdsRequestBody.CreateFromDiscriminatorValue);
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ApiSdk.Me.TranslateExchangeIds.TranslateExchangeIdsRequestBody body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
