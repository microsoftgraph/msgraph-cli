...
namespace ApiSdk.Me.LicenseDetails {
    public class LicenseDetailsResponse : IAdditionalDataHolder, IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as LicenseDetailsResponse).Value = n.GetCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.LicenseDetails>(ApiSdk.Models.Microsoft.Graph.LicenseDetails.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
