using ApiSdk.Me.LicenseDetails.Count;
using ApiSdk.Me.LicenseDetails.Item;
...
namespace ApiSdk.Me.LicenseDetails {
    ...
    public class LicenseDetailsRequestBuilder {
        ...
        public Command BuildCreateCommand() {
            ...
            command.Description = "Create new navigation property to licenseDetails for me";
        ...
        /// <param name="options">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ApiSdk.Models.Microsoft.Graph.LicenseDetails body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
