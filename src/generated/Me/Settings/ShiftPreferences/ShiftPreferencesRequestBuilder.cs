...
namespace ApiSdk.Me.Settings.ShiftPreferences {
    ...
    public class ShiftPreferencesRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.Description = "Delete navigation property shiftPreferences for me";
        ...
        public Command BuildPatchCommand() {
            ...
            command.Description = "Update the navigation property shiftPreferences in me";
            // Create options for all the parameters
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Models.Microsoft.Graph.ShiftPreferences>(ApiSdk.Models.Microsoft.Graph.ShiftPreferences.CreateFromDiscriminatorValue);
        ...
        /// <param name="options">Request options</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(ApiSdk.Models.Microsoft.Graph.ShiftPreferences body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
