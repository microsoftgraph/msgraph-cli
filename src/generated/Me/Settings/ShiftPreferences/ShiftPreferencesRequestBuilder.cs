...
namespace ApiSdk.Me.Settings.ShiftPreferences {
    ...
    public class ShiftPreferencesRequestBuilder {
        ...
        public ShiftPreferencesRequestBuilder(Dictionary<string, object> pathParameters) {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.ShiftPreferences body, Action<ShiftPreferencesRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.ShiftPreferences body, Action<ShiftPreferencesRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
