...
namespace ApiSdk.Me.Settings.ShiftPreferences {
    ...
    public class ShiftPreferencesRequestBuilder {
        ...
        public ShiftPreferencesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/settings/shiftPreferences{?%24select,%24expand}";
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(ApiSdk.Models.ShiftPreferences body, Action<ShiftPreferencesRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
