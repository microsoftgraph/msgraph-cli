...
namespace ApiSdk.Me.Settings {
    ...
    public class SettingsRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.Description = "Delete navigation property settings for me";
        ...
        public Command BuildGetCommand() {
            ...
            command.Description = "Get settings from me";
            // Create options for all the parameters
        ...
        public Command BuildPatchCommand() {
            ...
            command.Description = "Update the navigation property settings in me";
            // Create options for all the parameters
        ...
        public Command BuildShiftPreferencesCommand() {
            ...
            var builder = new ShiftPreferencesRequestBuilder(PathParameters, RequestAdapter);
