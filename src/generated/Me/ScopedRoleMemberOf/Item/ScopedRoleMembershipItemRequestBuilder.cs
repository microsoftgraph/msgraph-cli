...
namespace ApiSdk.Me.ScopedRoleMemberOf.Item {
    ...
    public class ScopedRoleMembershipItemRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.Description = "Delete navigation property scopedRoleMemberOf for me";
            ...
            command.SetHandler(async (object[] parameters) => {
                var scopedRoleMembershipId = (string) parameters[0];
            ...
            }, new CollectionBinding(scopedRoleMembershipIdOption, ifMatchOption, new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(scopedRoleMembershipIdOption, selectOption, expandOption, outputOption, queryOption, jsonNoIndentOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        ...
        public Command BuildPatchCommand() {
            ...
            command.Description = "Update the navigation property scopedRoleMemberOf in me";
            // Create options for all the parameters
            var scopedRoleMembershipIdOption = new Option<string>("--scoped-role-membership-id", description: "key: id of scopedRoleMembership") {
            };
            scopedRoleMembershipIdOption.IsRequired = true;
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                await RequestAdapter.SendNoContentAsync(requestInfo, errorMapping: errorMapping, cancellationToken: cancellationToken);
                Console.WriteLine("Success");
            }, new CollectionBinding(scopedRoleMembershipIdOption, bodyOption, new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
