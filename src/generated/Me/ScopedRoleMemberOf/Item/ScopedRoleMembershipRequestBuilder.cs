...
namespace ApiSdk.Me.ScopedRoleMemberOf.Item {
    ...
    public class ScopedRoleMembershipRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string scopedRoleMembershipId) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string scopedRoleMembershipId, string[] select, string[] expand) => {
            ...
            }, scopedRoleMembershipIdOption, selectOption, expandOption);
            return command;
        }
        /// <summary>
        /// The scoped-role administrative unit memberships for this user. Read-only. Nullable.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string scopedRoleMembershipId, string body) => {
