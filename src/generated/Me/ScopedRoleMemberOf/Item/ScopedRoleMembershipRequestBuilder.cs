...
namespace ApiSdk.Me.ScopedRoleMemberOf.Item {
    ...
    public class ScopedRoleMembershipRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string scopedRoleMembershipId, IConsole console) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string scopedRoleMembershipId, string[] select, string[] expand, FormatterType output, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string scopedRoleMembershipId, string body, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
