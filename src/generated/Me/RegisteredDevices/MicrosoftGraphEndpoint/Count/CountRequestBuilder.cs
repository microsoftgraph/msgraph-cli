...
namespace ApiSdk.Me.RegisteredDevices.MicrosoftGraphEndpoint.Count {
    /// <summary>
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters) {
            ...
            UrlTemplate = "{+baseurl}/me/registeredDevices/microsoft.graph.endpoint/$count{?%24search,%24filter}";
