...
namespace ApiSdk.Me.Calendars.Item {
    ...
    public class CalendarRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string calendarId, IConsole console) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string calendarId, string[] select, FormatterType output, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string calendarId, string body, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
