...
namespace ApiSdk.Me.Calendars.Item.CalendarPermissions.Item {
    ...
    public class CalendarPermissionRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string>(async (calendarId, calendarPermissionId) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, object>(async (calendarId, calendarPermissionId, select) => {
        ...
        public Command BuildPatchCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string>(async (calendarId, calendarPermissionId, body) => {
