...
namespace ApiSdk.Me.Calendars.Item.SingleValueExtendedProperties.Item {
    ...
    public class SingleValueLegacyExtendedPropertyRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string calendarId, string singleValueLegacyExtendedPropertyId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, calendarIdOption, singleValueLegacyExtendedPropertyIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The collection of single-value extended properties defined for the calendar. Read-only. Nullable.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string calendarId, string singleValueLegacyExtendedPropertyId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, calendarIdOption, singleValueLegacyExtendedPropertyIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The collection of single-value extended properties defined for the calendar. Read-only. Nullable.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string calendarId, string singleValueLegacyExtendedPropertyId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, calendarIdOption, singleValueLegacyExtendedPropertyIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
