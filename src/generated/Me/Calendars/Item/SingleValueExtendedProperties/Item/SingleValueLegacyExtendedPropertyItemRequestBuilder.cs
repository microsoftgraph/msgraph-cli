...
namespace ApiSdk.Me.Calendars.Item.SingleValueExtendedProperties.Item {
    ...
    public class SingleValueLegacyExtendedPropertyItemRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            }, new CollectionBinding(calendarIdOption, singleValueLegacyExtendedPropertyIdOption, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// The collection of single-value extended properties defined for the calendar. Read-only. Nullable.
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(calendarIdOption, singleValueLegacyExtendedPropertyIdOption, selectOption, expandOption, outputOption, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// The collection of single-value extended properties defined for the calendar. Read-only. Nullable.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                await RequestAdapter.SendNoContentAsync(requestInfo, errorMapping: default, cancellationToken: cancellationToken);
                Console.WriteLine("Success");
            }, new CollectionBinding(calendarIdOption, singleValueLegacyExtendedPropertyIdOption, bodyOption, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
