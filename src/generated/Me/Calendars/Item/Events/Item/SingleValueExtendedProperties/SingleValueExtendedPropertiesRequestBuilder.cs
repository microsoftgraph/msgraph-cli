...
namespace ApiSdk.Me.Calendars.Item.Events.Item.SingleValueExtendedProperties {
    ...
    public class SingleValueExtendedPropertiesRequestBuilder {
        ...
        public Command BuildListCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, int?, int?, string, string, bool?, object, object, object>(async (calendarId, eventId, top, skip, search, filter, count, orderby, select, expand) => {
