...
namespace ApiSdk.Me.Calendars.Item.Events.Item.Calendar.AllowedCalendarSharingRolesWithUser {
    ...
    public class AllowedCalendarSharingRolesWithUserRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string calendarId, string eventId, string User, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, calendarIdOption, eventIdOption, UserOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
