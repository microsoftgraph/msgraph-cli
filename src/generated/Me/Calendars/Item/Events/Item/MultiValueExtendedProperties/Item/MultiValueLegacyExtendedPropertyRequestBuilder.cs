...
namespace ApiSdk.Me.Calendars.Item.Events.Item.MultiValueExtendedProperties.Item {
    ...
    public class MultiValueLegacyExtendedPropertyRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string>(async (calendarId, eventId, multiValueLegacyExtendedPropertyId) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string, object, object>(async (calendarId, eventId, multiValueLegacyExtendedPropertyId, select, expand) => {
        ...
        public Command BuildPatchCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string, string>(async (calendarId, eventId, multiValueLegacyExtendedPropertyId, body) => {
