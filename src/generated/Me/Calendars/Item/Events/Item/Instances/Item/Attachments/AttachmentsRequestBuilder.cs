using ApiSdk.Me.Calendars.Item.Events.Item.Instances.Item.Attachments.Count;
using ApiSdk.Me.Calendars.Item.Events.Item.Instances.Item.Attachments.CreateUploadSession;
using ApiSdk.Me.Calendars.Item.Events.Item.Instances.Item.Attachments.Item;
...
namespace ApiSdk.Me.Calendars.Item.Events.Item.Instances.Item.Attachments {
    ...
    public class AttachmentsRequestBuilder {
        ...
        public AttachmentsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/calendars/{calendar_id}/events/{event_id}/instances/{event_id1}/attachments{?top,skip,filter,count,orderby,select,expand}";
