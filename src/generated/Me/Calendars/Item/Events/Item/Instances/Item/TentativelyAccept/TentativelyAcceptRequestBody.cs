...
namespace ApiSdk.Me.Calendars.Item.Events.Item.Instances.Item.TentativelyAccept {
    ...
    public class TentativelyAcceptRequestBody : IAdditionalDataHolder, IParsable {
        ...
        /// </summary>
        public static ApiSdk.Me.Calendars.Item.Events.Item.Instances.Item.TentativelyAccept.TentativelyAcceptRequestBody CreateFromDiscriminatorValue(IParseNode parseNode) {
