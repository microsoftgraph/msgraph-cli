using ApiSdk.Me.Calendars.Item.Events.Item.Instances.Item.Attachments;
using ApiSdk.Me.Calendars.Item.Events.Item.Instances.Item.Calendar;
using ApiSdk.Me.Calendars.Item.Events.Item.Instances.Item.Extensions;
using ApiSdk.Me.Calendars.Item.Events.Item.Instances.Item.MicrosoftGraphAccept;
using ApiSdk.Me.Calendars.Item.Events.Item.Instances.Item.MicrosoftGraphCancel;
using ApiSdk.Me.Calendars.Item.Events.Item.Instances.Item.MicrosoftGraphDecline;
using ApiSdk.Me.Calendars.Item.Events.Item.Instances.Item.MicrosoftGraphDismissReminder;
using ApiSdk.Me.Calendars.Item.Events.Item.Instances.Item.MicrosoftGraphForward;
using ApiSdk.Me.Calendars.Item.Events.Item.Instances.Item.MicrosoftGraphSnoozeReminder;
using ApiSdk.Me.Calendars.Item.Events.Item.Instances.Item.MicrosoftGraphTentativelyAccept;
using ApiSdk.Me.Calendars.Item.Events.Item.Instances.Item.MultiValueExtendedProperties;
using ApiSdk.Me.Calendars.Item.Events.Item.Instances.Item.SingleValueExtendedProperties;
using ApiSdk.Models;
...
namespace ApiSdk.Me.Calendars.Item.Events.Item.Instances.Item {
    ...
    public class EventItemRequestBuilder {
        ...
        public EventItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/calendars/{calendar%2Did}/events/{event%2Did}/instances/{event%2Did1}{?%24select}";
