using ApiSdk.Me.Calendars.Item.Events.Item.Instances.Count;
using ApiSdk.Me.Calendars.Item.Events.Item.Instances.Item;
using ApiSdk.Me.Calendars.Item.Events.Item.Instances.MicrosoftGraphDelta;
using ApiSdk.Models;
...
namespace ApiSdk.Me.Calendars.Item.Events.Item.Instances {
    ...
    public class InstancesRequestBuilder {
        ...
        public Command BuildCommand() {
            ...
            var builder = new ApiSdk.Me.Calendars.Item.Events.Item.Instances.Item.EventItemRequestBuilder(PathParameters, RequestAdapter);
