    ...
    public class ForwardRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Me.Calendars.Item.Events.Item.Forward.ForwardRequestBody>(ApiSdk.Me.Calendars.Item.Events.Item.Forward.ForwardRequestBody.CreateFromDiscriminatorValue);
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ApiSdk.Me.Calendars.Item.Events.Item.Forward.ForwardRequestBody body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
