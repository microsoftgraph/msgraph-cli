...
namespace ApiSdk.Me.Calendars.Item.Events.Item.Attachments.MicrosoftGraphCreateUploadSession {
    /// <summary>
    ...
    public class MicrosoftGraphCreateUploadSessionRequestBuilder {
        ...
        public MicrosoftGraphCreateUploadSessionRequestBuilder(Dictionary<string, object> pathParameters) {
            ...
            UrlTemplate = "{+baseurl}/me/calendars/{calendar%2Did}/events/{event%2Did}/attachments/microsoft.graph.createUploadSession";
