...
namespace ApiSdk.Me.Calendars.Item.Events.Item.Extensions {
    ...
    public class ExtensionsRequestBuilder {
        ...
        public Command BuildListCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, int?, int?, string, bool?, string[], string[], string[]>(async (calendarId, eventId, top, skip, filter, count, orderby, select, expand) => {
