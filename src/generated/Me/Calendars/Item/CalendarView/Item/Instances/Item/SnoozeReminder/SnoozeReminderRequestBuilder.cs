    ...
    public class SnoozeReminderRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Me.Calendars.Item.CalendarView.Item.Instances.Item.SnoozeReminder.SnoozeReminderRequestBody>(ApiSdk.Me.Calendars.Item.CalendarView.Item.Instances.Item.SnoozeReminder.SnoozeReminderRequestBody.CreateFromDiscriminatorValue);
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ApiSdk.Me.Calendars.Item.CalendarView.Item.Instances.Item.SnoozeReminder.SnoozeReminderRequestBody body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
