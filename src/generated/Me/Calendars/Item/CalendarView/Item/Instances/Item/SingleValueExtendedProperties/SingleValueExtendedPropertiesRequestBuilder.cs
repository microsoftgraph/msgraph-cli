using ApiSdk.Me.Calendars.Item.CalendarView.Item.Instances.Item.SingleValueExtendedProperties.Count;
using ApiSdk.Me.Calendars.Item.CalendarView.Item.Instances.Item.SingleValueExtendedProperties.Item;
using ApiSdk.Models;
...
namespace ApiSdk.Me.Calendars.Item.CalendarView.Item.Instances.Item.SingleValueExtendedProperties {
    /// <summary>
    ...
    public class SingleValueExtendedPropertiesRequestBuilder {
        ...
        public SingleValueExtendedPropertiesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/calendars/{calendar%2Did}/calendarView/{event%2Did}/instances/{event%2Did1}/singleValueExtendedProperties{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
