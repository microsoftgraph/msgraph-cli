...
namespace ApiSdk.Me.Calendars.Item.CalendarView.Item.MultiValueExtendedProperties.Item {
    ...
    public class MultiValueLegacyExtendedPropertyRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string calendarId, string eventId, string multiValueLegacyExtendedPropertyId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, calendarIdOption, eventIdOption, multiValueLegacyExtendedPropertyIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The collection of multi-value extended properties defined for the event. Read-only. Nullable.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string calendarId, string eventId, string multiValueLegacyExtendedPropertyId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, calendarIdOption, eventIdOption, multiValueLegacyExtendedPropertyIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The collection of multi-value extended properties defined for the event. Read-only. Nullable.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string calendarId, string eventId, string multiValueLegacyExtendedPropertyId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, calendarIdOption, eventIdOption, multiValueLegacyExtendedPropertyIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
