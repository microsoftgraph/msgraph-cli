...
namespace ApiSdk.Me.Calendars.Item.CalendarView.Item {
    ...
    public class EventRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string, string, object>(async (calendarId, eventId, startDateTime, endDateTime, select) => {
        ...
        public Command BuildPatchCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string>(async (calendarId, eventId, body) => {
