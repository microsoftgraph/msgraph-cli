...
namespace ApiSdk.Me.Teamwork.InstalledApps {
    ...
    public class InstalledAppsRequestBuilder {
        ...
        public List<Command> BuildCommand() {
            var builder = new UserScopeTeamsAppInstallationRequestBuilder(PathParameters, RequestAdapter);
            var commands = new List<Command>();
            commands.Add(builder.BuildChatCommand());
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<UserScopeTeamsAppInstallation> PostAsync(UserScopeTeamsAppInstallation model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
