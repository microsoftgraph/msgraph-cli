using ApiSdk.Me.Teamwork.InstalledApps.Count;
...
namespace ApiSdk.Me.Teamwork.InstalledApps {
    ...
    public class InstalledAppsRequestBuilder {
        ...
        public Command BuildCommand() {
            ...
            var builder = new UserScopeTeamsAppInstallationItemRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildChatCommand());
