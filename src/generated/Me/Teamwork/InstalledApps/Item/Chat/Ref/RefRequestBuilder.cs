...
namespace ApiSdk.Me.Teamwork.InstalledApps.Item.Chat.Ref {
    ...
    public class RefRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string userScopeTeamsAppInstallationId, FormatterType output, IOutputFormatterFactory outputFormatterFactory, CancellationToken cancellationToken) => {
