...
namespace ApiSdk.Me.Teamwork.InstalledApps.Item.Chat.Ref {
    ...
    public class RefRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string userScopeTeamsAppInstallationId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, userScopeTeamsAppInstallationIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The chat between the user and Teams app.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string userScopeTeamsAppInstallationId, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, userScopeTeamsAppInstallationIdOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The chat between the user and Teams app.
        ...
        public Command BuildPutCommand() {
            ...
            command.SetHandler(async (string userScopeTeamsAppInstallationId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, userScopeTeamsAppInstallationIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PutAsync(ApiSdk.Me.Teamwork.InstalledApps.Item.Chat.Ref.Ref model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
