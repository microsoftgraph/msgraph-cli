...
namespace ApiSdk.Me.Teamwork.InstalledApps.Item.Chat.Ref {
    ...
    public class RefRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string userScopeTeamsAppInstallationId, IConsole console) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string userScopeTeamsAppInstallationId, FormatterType output, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
        ...
        public Command BuildPutCommand() {
            ...
            command.SetHandler(async (string userScopeTeamsAppInstallationId, string body, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
