...
namespace ApiSdk.Me.Contacts.Item.Extensions.Item {
    ...
    public class ExtensionRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string contactId, string extensionId, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                var requestInfo = CreateDeleteRequestInformation(q => {
                });
                await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                console.WriteLine("Success");
            }, contactIdOption, extensionIdOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// The collection of open extensions defined for the contact. Nullable.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string contactId, string extensionId, string[] select, string[] expand, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
            ...
            }, contactIdOption, extensionIdOption, selectOption, expandOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// The collection of open extensions defined for the contact. Nullable.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string contactId, string extensionId, string body, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                ...
                await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                console.WriteLine("Success");
            }, contactIdOption, extensionIdOption, bodyOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
