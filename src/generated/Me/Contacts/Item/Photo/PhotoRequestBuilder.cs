...
namespace ApiSdk.Me.Contacts.Item.Photo {
    ...
    public class PhotoRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string contactId, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                var requestInfo = CreateDeleteRequestInformation(q => {
                });
                await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                console.WriteLine("Success");
            }, contactIdOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// Optional contact picture. You can get or set a photo for a contact.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string contactId, string[] select, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
            ...
            }, contactIdOption, selectOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// Optional contact picture. You can get or set a photo for a contact.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string contactId, string body, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                ...
                await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                console.WriteLine("Success");
            }, contactIdOption, bodyOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
