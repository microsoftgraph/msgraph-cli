...
namespace ApiSdk.Me.Contacts.Item {
    ...
    public class ContactItemRequestBuilder {
        ...
        public Command BuildExtensionsCommand() {
            ...
            var builder = new ApiSdk.Me.Contacts.Item.Extensions.ExtensionsRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(contactIdOption, selectOption, outputOption, queryOption, jsonNoIndentOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        public Command BuildMultiValueExtendedPropertiesCommand() {
            var command = new Command("multi-value-extended-properties");
            var builder = new ApiSdk.Me.Contacts.Item.MultiValueExtendedProperties.MultiValueExtendedPropertiesRequestBuilder(PathParameters, RequestAdapter);
            foreach (var cmd in builder.BuildCommand()) {
                command.AddCommand(cmd);
            }
            command.AddCommand(builder.BuildCreateCommand());
        ...
        public Command BuildPhotoCommand() {
            ...
            var builder = new ApiSdk.Me.Contacts.Item.Photo.PhotoRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildSingleValueExtendedPropertiesCommand() {
            ...
            var builder = new ApiSdk.Me.Contacts.Item.SingleValueExtendedProperties.SingleValueExtendedPropertiesRequestBuilder(PathParameters, RequestAdapter);
            foreach (var cmd in builder.BuildCommand()) {
                command.AddCommand(cmd);
            }
            command.AddCommand(builder.BuildCreateCommand());
