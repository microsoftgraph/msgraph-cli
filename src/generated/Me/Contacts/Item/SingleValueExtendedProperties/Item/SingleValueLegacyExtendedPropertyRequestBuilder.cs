...
namespace ApiSdk.Me.Contacts.Item.SingleValueExtendedProperties.Item {
    ...
    public class SingleValueLegacyExtendedPropertyRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string>(async (contactId, singleValueLegacyExtendedPropertyId) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, object, object>(async (contactId, singleValueLegacyExtendedPropertyId, select, expand) => {
        ...
        public Command BuildPatchCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string>(async (contactId, singleValueLegacyExtendedPropertyId, body) => {
