...
namespace ApiSdk.Me.Photos.Item {
    ...
    public class ProfilePhotoRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string profilePhotoId, IConsole console) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string profilePhotoId, string[] select, FormatterType output, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string profilePhotoId, string body, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
