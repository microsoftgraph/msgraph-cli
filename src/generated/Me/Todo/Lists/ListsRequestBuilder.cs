using ApiSdk.Me.Todo.Lists.Count;
using ApiSdk.Me.Todo.Lists.Item;
using ApiSdk.Me.Todo.Lists.MicrosoftGraphDelta;
using ApiSdk.Models;
...
namespace ApiSdk.Me.Todo.Lists {
    ...
    public class ListsRequestBuilder {
        ...
        public Command BuildCommand() {
            ...
            var builder = new TodoTaskListItemRequestBuilder(PathParameters, RequestAdapter);
