...
namespace ApiSdk.Me.Todo.Lists.Item.Tasks.Item.LinkedResources {
    ...
    public class LinkedResourcesRequestBuilder {
        ...
        public Command BuildCreateCommand() {
            ...
            command.SetHandler(async (string todoTaskListId, string todoTaskId, string body) => {
        ...
        public Command BuildListCommand() {
            ...
            command.SetHandler(async (string todoTaskListId, string todoTaskId, int? top, int? skip, string search, string filter, bool? count, string[] orderby, string[] select, string[] expand) => {
                ...
                var strContent = await reader.ReadToEndAsync();
                Console.Write(strContent + "\n");
            }, todoTaskListIdOption, todoTaskIdOption, topOption, skipOption, searchOption, filterOption, countOption, orderbyOption, selectOption, expandOption);
            return command;
        }
        /// <summary>
