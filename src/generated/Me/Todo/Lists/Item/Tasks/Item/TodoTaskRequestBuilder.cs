...
namespace ApiSdk.Me.Todo.Lists.Item.Tasks.Item {
    ...
    public class TodoTaskRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string todoTaskListId, string todoTaskId) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string todoTaskListId, string todoTaskId, string[] select, string[] expand) => {
            ...
            }, todoTaskListIdOption, todoTaskIdOption, selectOption, expandOption);
            return command;
        }
