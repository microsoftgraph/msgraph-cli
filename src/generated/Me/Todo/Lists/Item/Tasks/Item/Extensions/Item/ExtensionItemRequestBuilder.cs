...
namespace ApiSdk.Me.Todo.Lists.Item.Tasks.Item.Extensions.Item {
    ...
    public class ExtensionItemRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(todoTaskListIdOption, todoTaskIdOption, extensionIdOption, selectOption, expandOption, outputOption, outputFilterOption, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// The collection of open extensions defined for the task. Nullable.
