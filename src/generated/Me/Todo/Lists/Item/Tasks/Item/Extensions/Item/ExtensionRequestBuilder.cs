...
namespace ApiSdk.Me.Todo.Lists.Item.Tasks.Item.Extensions.Item {
    ...
    public class ExtensionRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string todoTaskListId, string todoTaskId, string extensionId, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                var requestInfo = CreateDeleteRequestInformation(q => {
                });
                await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                console.WriteLine("Success");
            }, todoTaskListIdOption, todoTaskIdOption, extensionIdOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// The collection of open extensions defined for the task. Nullable.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string todoTaskListId, string todoTaskId, string extensionId, string[] select, string[] expand, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
            ...
            }, todoTaskListIdOption, todoTaskIdOption, extensionIdOption, selectOption, expandOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// The collection of open extensions defined for the task. Nullable.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string todoTaskListId, string todoTaskId, string extensionId, string body, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                ...
                await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                console.WriteLine("Success");
            }, todoTaskListIdOption, todoTaskIdOption, extensionIdOption, bodyOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
