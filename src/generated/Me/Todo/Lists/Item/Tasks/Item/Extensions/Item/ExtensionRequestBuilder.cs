...
namespace ApiSdk.Me.Todo.Lists.Item.Tasks.Item.Extensions.Item {
    ...
    public class ExtensionRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string todoTaskListId, string todoTaskId, string extensionId, IConsole console) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string todoTaskListId, string todoTaskId, string extensionId, string[] select, string[] expand, FormatterType output, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string todoTaskListId, string todoTaskId, string extensionId, string body, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
