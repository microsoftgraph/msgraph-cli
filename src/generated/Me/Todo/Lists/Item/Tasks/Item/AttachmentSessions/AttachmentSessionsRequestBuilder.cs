using ApiSdk.Me.Todo.Lists.Item.Tasks.Item.AttachmentSessions.Count;
using ApiSdk.Me.Todo.Lists.Item.Tasks.Item.AttachmentSessions.Item;
using ApiSdk.Models;
...
namespace ApiSdk.Me.Todo.Lists.Item.Tasks.Item.AttachmentSessions {
    ...
    public class AttachmentSessionsRequestBuilder {
        ...
        public Command BuildCommand() {
            ...
            var builder = new AttachmentSessionItemRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildCreateCommand() {
            ...
            command.Description = "Create new navigation property to attachmentSessions for me";
        ...
        public Command BuildListCommand() {
            ...
            command.Description = "Get attachmentSessions from me";
            // Create options for all the parameters
            var todoTaskListIdOption = new Option<string>("--todo-task-list-id", description: "key: id of todoTaskList") {
            };
            todoTaskListIdOption.IsRequired = true;
