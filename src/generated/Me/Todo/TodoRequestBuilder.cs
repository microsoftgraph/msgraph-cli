    ...
    public class TodoRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.Handler = CommandHandler.Create<object, object>(async (select, expand) => {
                ...
                var result = await RequestAdapter.SendAsync<ApiSdk.Models.Microsoft.Graph.Todo>(requestInfo);
                // Print request output. What if the request has no return?
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(ApiSdk.Models.Microsoft.Graph.Todo model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
