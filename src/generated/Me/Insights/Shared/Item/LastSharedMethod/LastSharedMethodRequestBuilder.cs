...
namespace ApiSdk.Me.Insights.Shared.Item.LastSharedMethod {
    ...
    public class LastSharedMethodRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string sharedInsightId, string[] select, string[] expand, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
