...
namespace ApiSdk.Me.Insights.Shared.Item.LastSharedMethod.WorkbookRange.ResizedRangeWithDeltaRowsWithDeltaColumns {
    ...
    public class ResizedRangeWithDeltaRowsWithDeltaColumnsRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string sharedInsightId, int? deltaRows, int? deltaColumns, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, sharedInsightIdOption, deltaRowsOption, deltaColumnsOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
