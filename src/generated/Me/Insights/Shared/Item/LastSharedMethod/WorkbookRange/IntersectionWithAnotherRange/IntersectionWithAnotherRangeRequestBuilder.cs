...
namespace ApiSdk.Me.Insights.Shared.Item.LastSharedMethod.WorkbookRange.IntersectionWithAnotherRange {
    ...
    public class IntersectionWithAnotherRangeRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string sharedInsightId, string anotherRange, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, sharedInsightIdOption, anotherRangeOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
