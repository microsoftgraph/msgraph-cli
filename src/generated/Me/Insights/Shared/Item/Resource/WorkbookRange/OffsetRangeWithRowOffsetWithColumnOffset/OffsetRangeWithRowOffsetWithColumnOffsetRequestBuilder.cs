...
namespace ApiSdk.Me.Insights.Shared.Item.Resource.WorkbookRange.OffsetRangeWithRowOffsetWithColumnOffset {
    ...
    public class OffsetRangeWithRowOffsetWithColumnOffsetRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string sharedInsightId, int? rowOffset, int? columnOffset, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, sharedInsightIdOption, rowOffsetOption, columnOffsetOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
