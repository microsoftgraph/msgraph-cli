...
namespace ApiSdk.Me.Insights.Shared.Item.Resource.WorkbookRange.IntersectionWithAnotherRange {
    ...
    public class IntersectionWithAnotherRangeRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(sharedInsightIdOption, anotherRangeOption, outputOption, queryOption, jsonNoIndentOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
