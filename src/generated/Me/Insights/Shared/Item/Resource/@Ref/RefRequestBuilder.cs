    ...
    public class RefRequestBuilder {
        ...
        public Command BuildPutCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string>(async (sharedInsightId, body) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Me.Insights.Shared.Item.Resource.@Ref.@Ref>();
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PutAsync(ApiSdk.Me.Insights.Shared.Item.Resource.@Ref.@Ref model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
