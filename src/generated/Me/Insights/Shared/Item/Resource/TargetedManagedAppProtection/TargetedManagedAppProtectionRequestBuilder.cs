...
using ApiSdk.Me.Insights.Shared.Item.Resource.TargetedManagedAppProtection.TargetApps;
...
namespace ApiSdk.Me.Insights.Shared.Item.Resource.TargetedManagedAppProtection {
    ...
    public class TargetedManagedAppProtectionRequestBuilder {
        ...
        public Command BuildAssignCommand() {
            ...
            var builder = new ApiSdk.Me.Insights.Shared.Item.Resource.TargetedManagedAppProtection.Assign.AssignRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildPostCommand());
            return command;
        }
        public Command BuildTargetAppsCommand() {
            var command = new Command("target-apps");
            var builder = new ApiSdk.Me.Insights.Shared.Item.Resource.TargetedManagedAppProtection.TargetApps.TargetAppsRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildPostCommand());
            return command;
        }
        /// <summary>
