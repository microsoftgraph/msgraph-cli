...
namespace ApiSdk.Me.Insights.Used.Item.Resource.MobileAppContentFile {
    ...
    public class MobileAppContentFileRequestBuilder {
        ...
        public Command BuildCommitCommand() {
            ...
            var builder = new ApiSdk.Me.Insights.Used.Item.Resource.MobileAppContentFile.Commit.CommitRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildPostCommand());
            return command;
        }
        public Command BuildRenewUploadCommand() {
            var command = new Command("renew-upload");
            var builder = new ApiSdk.Me.Insights.Used.Item.Resource.MobileAppContentFile.RenewUpload.RenewUploadRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildPostCommand());
            return command;
        }
        /// <summary>
