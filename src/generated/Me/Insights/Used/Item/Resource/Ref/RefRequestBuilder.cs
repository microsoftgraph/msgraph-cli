...
namespace ApiSdk.Me.Insights.Used.Item.Resource.Ref {
    ...
    public class RefRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string usedInsightId, IConsole console) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string usedInsightId, FormatterType output, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
        ...
        public Command BuildPutCommand() {
            ...
            command.SetHandler(async (string usedInsightId, string body, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
