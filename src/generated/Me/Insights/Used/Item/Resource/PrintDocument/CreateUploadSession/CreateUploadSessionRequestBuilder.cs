...
namespace ApiSdk.Me.Insights.Used.Item.Resource.PrintDocument.CreateUploadSession {
    ...
    public class CreateUploadSessionRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (string usedInsightId, string body, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, usedInsightIdOption, bodyOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
