...
namespace ApiSdk.Me.Insights.Used.Item.Resource.PrintDocument.CreateUploadSession {
    ...
    public class CreateUploadSessionRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (string usedInsightId, string body, FormatterType output, IOutputFormatterFactory outputFormatterFactory, CancellationToken cancellationToken) => {
            ...
            }, usedInsightIdOption, bodyOption, outputOption);
            return command;
        }
        /// <summary>
