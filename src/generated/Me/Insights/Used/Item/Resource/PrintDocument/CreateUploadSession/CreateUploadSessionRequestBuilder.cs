...
namespace ApiSdk.Me.Insights.Used.Item.Resource.PrintDocument.CreateUploadSession {
    ...
    public class CreateUploadSessionRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            }, new CollectionBinding(usedInsightIdOption, bodyOption, outputOption, queryOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
