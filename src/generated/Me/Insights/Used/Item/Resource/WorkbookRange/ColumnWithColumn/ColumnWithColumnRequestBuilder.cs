...
namespace ApiSdk.Me.Insights.Used.Item.Resource.WorkbookRange.ColumnWithColumn {
    ...
    public class ColumnWithColumnRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string usedInsightId, int? column, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, usedInsightIdOption, columnOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
