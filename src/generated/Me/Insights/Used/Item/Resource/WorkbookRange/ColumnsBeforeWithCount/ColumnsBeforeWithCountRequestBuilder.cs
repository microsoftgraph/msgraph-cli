...
namespace ApiSdk.Me.Insights.Used.Item.Resource.WorkbookRange.ColumnsBeforeWithCount {
    ...
    public class ColumnsBeforeWithCountRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string usedInsightId, int? count, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, usedInsightIdOption, countOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
