...
namespace ApiSdk.Me.Insights.Used.Item.Resource.WorkbookRange.IntersectionWithAnotherRange {
    ...
    public class IntersectionWithAnotherRangeRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(usedInsightIdOption, anotherRangeOption, outputOption, queryOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
