...
namespace ApiSdk.Me.Insights.Used.Item.Resource.WorkbookRange.IntersectionWithAnotherRange {
    ...
    public class IntersectionWithAnotherRangeRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string usedInsightId, string anotherRange, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, usedInsightIdOption, anotherRangeOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
