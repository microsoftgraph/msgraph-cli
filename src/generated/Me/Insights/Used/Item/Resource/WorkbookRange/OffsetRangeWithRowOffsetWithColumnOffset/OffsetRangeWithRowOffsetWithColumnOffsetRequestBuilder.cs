...
namespace ApiSdk.Me.Insights.Used.Item.Resource.WorkbookRange.OffsetRangeWithRowOffsetWithColumnOffset {
    ...
    public class OffsetRangeWithRowOffsetWithColumnOffsetRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string usedInsightId, int? rowOffset, int? columnOffset, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, usedInsightIdOption, rowOffsetOption, columnOffsetOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
