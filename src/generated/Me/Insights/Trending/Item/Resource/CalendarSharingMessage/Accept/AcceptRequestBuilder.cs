...
namespace ApiSdk.Me.Insights.Trending.Item.Resource.CalendarSharingMessage.Accept {
    /// <summary>Builds and executes requests for operations under \me\insights\trending\{trendingItem-Id}\resource\microsoft.graph.calendarSharingMessage\microsoft.graph.accept</summary>
    public class AcceptRequestBuilder {
        ...
        public AcceptRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/insights/trending/{trendingItem_Id}/resource/microsoft.graph.calendarSharingMessage/microsoft.graph.accept";
