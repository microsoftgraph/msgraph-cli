...
namespace ApiSdk.Me.Insights.Trending.Item.Resource.WindowsInformationProtection {
    /// <summary>Builds and executes requests for operations under \me\insights\trending\{trendingItem-Id}\resource\microsoft.graph.windowsInformationProtection</summary>
    public class WindowsInformationProtectionRequestBuilder {
        ...
        public Command BuildAssignCommand() {
            ...
            var builder = new ApiSdk.Me.Insights.Trending.Item.Resource.WindowsInformationProtection.Assign.AssignRequestBuilder(PathParameters, RequestAdapter);
        ...
        public WindowsInformationProtectionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/insights/trending/{trendingItem_Id}/resource/microsoft.graph.windowsInformationProtection";
