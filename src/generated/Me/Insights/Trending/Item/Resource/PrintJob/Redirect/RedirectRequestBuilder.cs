...
namespace ApiSdk.Me.Insights.Trending.Item.Resource.PrintJob.Redirect {
    /// <summary>Builds and executes requests for operations under \me\insights\trending\{trendingItem-Id}\resource\microsoft.graph.printJob\microsoft.graph.redirect</summary>
    public class RedirectRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                var model = parseNode.GetObjectValue<RedirectRequestBody>(RedirectRequestBody.CreateFromDiscriminatorValue);
            ...
            }, new CollectionBinding(trendingItemIdOption, bodyOption, outputOption, queryOption, jsonNoIndentOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        ...
        public RedirectRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/insights/trending/{trendingItem_Id}/resource/microsoft.graph.printJob/microsoft.graph.redirect";
        ...
        public class RedirectResponse : IAdditionalDataHolder, IParsable {
            ...
            public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
                return new Dictionary<string, Action<T, IParseNode>> {
                    {"printJob", (o,n) => { (o as RedirectResponse).PrintJob = n.GetObjectValue<ApiSdk.Models.Microsoft.Graph.PrintJob>(ApiSdk.Models.Microsoft.Graph.PrintJob.CreateFromDiscriminatorValue); } },
                };
            }
            /// <summary>
