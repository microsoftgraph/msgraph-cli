...
namespace ApiSdk.Me.Insights.Trending.Item.Resource.PrintJob.Redirect {
    ...
    public class RedirectRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (string trendingItemId, string body, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, trendingItemIdOption, bodyOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
