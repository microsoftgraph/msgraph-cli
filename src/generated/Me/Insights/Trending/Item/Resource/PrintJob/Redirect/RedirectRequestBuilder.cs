...
namespace ApiSdk.Me.Insights.Trending.Item.Resource.PrintJob.Redirect {
    ...
    public class RedirectRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (string trendingItemId, string body, FormatterType output, IOutputFormatterFactory outputFormatterFactory, CancellationToken cancellationToken) => {
            ...
            }, trendingItemIdOption, bodyOption, outputOption);
            return command;
        }
        /// <summary>
