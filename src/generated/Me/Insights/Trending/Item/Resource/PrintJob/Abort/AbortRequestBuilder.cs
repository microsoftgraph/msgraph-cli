...
namespace ApiSdk.Me.Insights.Trending.Item.Resource.PrintJob.Abort {
    /// <summary>Builds and executes requests for operations under \me\insights\trending\{trendingItem-Id}\resource\microsoft.graph.printJob\microsoft.graph.abort</summary>
    public class AbortRequestBuilder {
        ...
        public AbortRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/insights/trending/{trendingItem_Id}/resource/microsoft.graph.printJob/microsoft.graph.abort";
