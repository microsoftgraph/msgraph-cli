...
namespace ApiSdk.Me.Insights.Trending.Item.Resource.WorkbookRangeFill.Clear {
    /// <summary>Builds and executes requests for operations under \me\insights\trending\{trendingItem-Id}\resource\microsoft.graph.workbookRangeFill\microsoft.graph.clear</summary>
    public class ClearRequestBuilder {
        ...
        public ClearRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/insights/trending/{trendingItem_Id}/resource/microsoft.graph.workbookRangeFill/microsoft.graph.clear";
