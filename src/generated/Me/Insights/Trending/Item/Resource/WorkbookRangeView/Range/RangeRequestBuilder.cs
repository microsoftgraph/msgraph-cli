...
namespace ApiSdk.Me.Insights.Trending.Item.Resource.WorkbookRangeView.Range {
    /// <summary>Builds and executes requests for operations under \me\insights\trending\{trendingItem-Id}\resource\microsoft.graph.workbookRangeView\microsoft.graph.range()</summary>
    public class RangeRequestBuilder {
        ...
        public RangeRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/insights/trending/{trendingItem_Id}/resource/microsoft.graph.workbookRangeView/microsoft.graph.range()";
