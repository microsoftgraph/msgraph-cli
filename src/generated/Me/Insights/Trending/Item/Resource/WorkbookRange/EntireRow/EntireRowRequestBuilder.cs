...
namespace ApiSdk.Me.Insights.Trending.Item.Resource.WorkbookRange.EntireRow {
    /// <summary>Builds and executes requests for operations under \me\insights\trending\{trendingItem-Id}\resource\microsoft.graph.workbookRange\microsoft.graph.entireRow()</summary>
    public class EntireRowRequestBuilder {
        ...
        public EntireRowRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/insights/trending/{trendingItem_Id}/resource/microsoft.graph.workbookRange/microsoft.graph.entireRow()";
