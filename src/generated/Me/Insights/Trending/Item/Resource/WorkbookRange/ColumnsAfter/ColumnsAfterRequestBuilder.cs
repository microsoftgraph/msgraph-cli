...
namespace ApiSdk.Me.Insights.Trending.Item.Resource.WorkbookRange.ColumnsAfter {
    /// <summary>Builds and executes requests for operations under \me\insights\trending\{trendingItem-Id}\resource\microsoft.graph.workbookRange\microsoft.graph.columnsAfter()</summary>
    public class ColumnsAfterRequestBuilder {
        ...
        public ColumnsAfterRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/insights/trending/{trendingItem_Id}/resource/microsoft.graph.workbookRange/microsoft.graph.columnsAfter()";
