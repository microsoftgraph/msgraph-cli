...
namespace ApiSdk.Me.Insights.Trending.Item.Resource.WorkbookRange.UsedRangeWithValuesOnly {
    ...
    public class UsedRangeWithValuesOnlyRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string trendingItemId, bool? valuesOnly, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, trendingItemIdOption, valuesOnlyOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
