...
namespace ApiSdk.Me.Insights.Trending.Item.Resource.WorkbookRange.OffsetRangeWithRowOffsetWithColumnOffset {
    ...
    public class OffsetRangeWithRowOffsetWithColumnOffsetRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string trendingItemId, int? rowOffset, int? columnOffset, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, trendingItemIdOption, rowOffsetOption, columnOffsetOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
