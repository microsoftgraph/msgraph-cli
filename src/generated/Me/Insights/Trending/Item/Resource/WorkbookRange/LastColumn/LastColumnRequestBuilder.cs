...
namespace ApiSdk.Me.Insights.Trending.Item.Resource.WorkbookRange.LastColumn {
    /// <summary>Builds and executes requests for operations under \me\insights\trending\{trendingItem-Id}\resource\microsoft.graph.workbookRange\microsoft.graph.lastColumn()</summary>
    public class LastColumnRequestBuilder {
        ...
        public LastColumnRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/insights/trending/{trendingItem_Id}/resource/microsoft.graph.workbookRange/microsoft.graph.lastColumn()";
