...
namespace ApiSdk.Me.Insights.Trending.Item.Resource.WorkbookRange.CellWithRowWithColumn {
    ...
    public class CellWithRowWithColumnRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string trendingItemId, int? row, int? column, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, trendingItemIdOption, rowOption, columnOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
