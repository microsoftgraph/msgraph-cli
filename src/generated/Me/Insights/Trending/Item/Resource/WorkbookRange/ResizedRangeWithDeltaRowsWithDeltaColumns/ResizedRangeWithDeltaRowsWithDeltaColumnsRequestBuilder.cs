...
namespace ApiSdk.Me.Insights.Trending.Item.Resource.WorkbookRange.ResizedRangeWithDeltaRowsWithDeltaColumns {
    ...
    public class ResizedRangeWithDeltaRowsWithDeltaColumnsRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(trendingItemIdOption, deltaRowsOption, deltaColumnsOption, outputOption, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
