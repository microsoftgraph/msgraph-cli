...
namespace ApiSdk.Me.Insights.Trending.Item.Resource.WorkbookRange.UsedRange {
    /// <summary>Builds and executes requests for operations under \me\insights\trending\{trendingItem-Id}\resource\microsoft.graph.workbookRange\microsoft.graph.usedRange()</summary>
    public class UsedRangeRequestBuilder {
        ...
        public UsedRangeRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/insights/trending/{trendingItem_Id}/resource/microsoft.graph.workbookRange/microsoft.graph.usedRange()";
