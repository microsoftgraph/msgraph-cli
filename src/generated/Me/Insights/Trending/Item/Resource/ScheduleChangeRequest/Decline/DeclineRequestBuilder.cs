...
namespace ApiSdk.Me.Insights.Trending.Item.Resource.ScheduleChangeRequest.Decline {
    /// <summary>Builds and executes requests for operations under \me\insights\trending\{trendingItem-Id}\resource\microsoft.graph.scheduleChangeRequest\microsoft.graph.decline</summary>
    public class DeclineRequestBuilder {
        ...
        public DeclineRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/insights/trending/{trendingItem_Id}/resource/microsoft.graph.scheduleChangeRequest/microsoft.graph.decline";
