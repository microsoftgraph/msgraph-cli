...
namespace ApiSdk.Me.Insights.Trending.Item.Resource.ScheduleChangeRequest {
    ...
    public class ScheduleChangeRequestRequestBuilder {
        ...
        public Command BuildApproveCommand() {
            ...
            var builder = new ApiSdk.Me.Insights.Trending.Item.Resource.ScheduleChangeRequest.Approve.ApproveRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildPostCommand());
            return command;
        }
        public Command BuildDeclineCommand() {
            var command = new Command("decline");
            var builder = new ApiSdk.Me.Insights.Trending.Item.Resource.ScheduleChangeRequest.Decline.DeclineRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildPostCommand());
            return command;
        }
        /// <summary>
