...
namespace ApiSdk.Me.Insights.Trending.Item {
    /// <summary>Builds and executes requests for operations under \me\insights\trending\{trendingItem-Id}</summary>
    public class TrendingItemRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string trendingItemId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, trendingItemIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// Access this property from the derived type itemInsights.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string trendingItemId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, trendingItemIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        public Command BuildResourceCommand() {
            var command = new Command("resource");
            var builder = new ApiSdk.Me.Insights.Trending.Item.Resource.ResourceRequestBuilder(PathParameters, RequestAdapter);
        ...
        public TrendingItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/insights/trending/{trendingItem_Id}{?select,expand}";
