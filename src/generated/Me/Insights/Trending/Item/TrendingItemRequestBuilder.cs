...
namespace ApiSdk.Me.Insights.Trending.Item {
    ...
    public class TrendingItemRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            }, trendingItemIdOption, selectOption, expandOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// Access this property from the derived type itemInsights.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string trendingItemId, string body, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
