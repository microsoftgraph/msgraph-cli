...
namespace ApiSdk.Me.Insights.Trending.Item {
    ...
    public class TrendingItemRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.Description = "Delete navigation property trending for me";
            ...
            }, new CollectionBinding(trendingIdOption, new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        ...
        public Command BuildPatchCommand() {
            ...
            command.Description = "Update the navigation property trending in me";
            // Create options for all the parameters
            var trendingIdOption = new Option<string>("--trending-id", description: "key: id of trending") {
            };
            trendingIdOption.IsRequired = true;
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                await RequestAdapter.SendNoContentAsync(requestInfo, errorMapping: errorMapping, cancellationToken: cancellationToken);
                Console.WriteLine("Success");
            }, new CollectionBinding(trendingIdOption, bodyOption, new TypeBinding(typeof(CancellationToken))));
            return command;
        }
