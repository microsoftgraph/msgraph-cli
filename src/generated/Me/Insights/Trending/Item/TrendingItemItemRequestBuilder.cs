...
namespace ApiSdk.Me.Insights.Trending.Item {
    ...
    public class TrendingItemItemRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            }, new CollectionBinding(trendingItemIdOption, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// Access this property from the derived type itemInsights.
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(trendingItemIdOption, selectOption, expandOption, outputOption, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// Access this property from the derived type itemInsights.
