using ApiSdk.Me.Insights.Trending.Count;
using ApiSdk.Me.Insights.Trending.Item;
...
namespace ApiSdk.Me.Insights.Trending {
    ...
    public class TrendingRequestBuilder {
        ...
        public Command BuildCreateCommand() {
            ...
            command.Description = "Create new navigation property to trending for me";
        ...
        /// <param name="options">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ApiSdk.Models.Microsoft.Graph.Trending body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
