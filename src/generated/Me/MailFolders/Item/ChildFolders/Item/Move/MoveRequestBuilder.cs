...
namespace ApiSdk.Me.MailFolders.Item.ChildFolders.Item.Move {
    ...
    public class MoveRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (string mailFolderId, string mailFolderId1, string body, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
            ...
            }, mailFolderIdOption, mailFolderId1Option, bodyOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
