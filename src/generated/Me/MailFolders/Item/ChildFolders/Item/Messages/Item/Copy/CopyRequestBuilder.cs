...
namespace ApiSdk.Me.MailFolders.Item.ChildFolders.Item.Messages.Item.Copy {
    ...
    public class CopyRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Me.MailFolders.Item.ChildFolders.Item.Messages.Item.Copy.CopyRequestBody>(ApiSdk.Me.MailFolders.Item.ChildFolders.Item.Messages.Item.Copy.CopyRequestBody.CreateFromDiscriminatorValue);
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ApiSdk.Me.MailFolders.Item.ChildFolders.Item.Messages.Item.Copy.CopyRequestBody body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
