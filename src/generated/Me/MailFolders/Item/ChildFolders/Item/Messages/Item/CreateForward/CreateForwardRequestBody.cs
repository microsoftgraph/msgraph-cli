...
using System.IO;
using System.Linq;
namespace ApiSdk.Me.MailFolders.Item.ChildFolders.Item.Messages.Item.CreateForward {
    ...
    public class CreateForwardRequestBody : IAdditionalDataHolder, IParsable {
        ...
        /// </summary>
        public static ApiSdk.Me.MailFolders.Item.ChildFolders.Item.Messages.Item.CreateForward.CreateForwardRequestBody CreateFromDiscriminatorValue(IParseNode parseNode) {
