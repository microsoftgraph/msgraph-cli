...
using System.IO;
using System.Linq;
namespace ApiSdk.Me.MailFolders.Item.ChildFolders.Item.Messages.Item.Move {
    ...
    public class MoveRequestBody : IAdditionalDataHolder, IParsable {
        ...
        /// </summary>
        public static ApiSdk.Me.MailFolders.Item.ChildFolders.Item.Messages.Item.Move.MoveRequestBody CreateFromDiscriminatorValue(IParseNode parseNode) {
