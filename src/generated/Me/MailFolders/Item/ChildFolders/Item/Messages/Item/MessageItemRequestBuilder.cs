using ApiSdk.Me.MailFolders.Item.ChildFolders.Item.Messages.Item.Attachments;
using ApiSdk.Me.MailFolders.Item.ChildFolders.Item.Messages.Item.CalendarSharingMessage;
using ApiSdk.Me.MailFolders.Item.ChildFolders.Item.Messages.Item.Copy;
using ApiSdk.Me.MailFolders.Item.ChildFolders.Item.Messages.Item.CreateForward;
using ApiSdk.Me.MailFolders.Item.ChildFolders.Item.Messages.Item.CreateReply;
using ApiSdk.Me.MailFolders.Item.ChildFolders.Item.Messages.Item.CreateReplyAll;
using ApiSdk.Me.MailFolders.Item.ChildFolders.Item.Messages.Item.Extensions;
using ApiSdk.Me.MailFolders.Item.ChildFolders.Item.Messages.Item.Forward;
using ApiSdk.Me.MailFolders.Item.ChildFolders.Item.Messages.Item.Move;
using ApiSdk.Me.MailFolders.Item.ChildFolders.Item.Messages.Item.MultiValueExtendedProperties;
using ApiSdk.Me.MailFolders.Item.ChildFolders.Item.Messages.Item.Reply;
using ApiSdk.Me.MailFolders.Item.ChildFolders.Item.Messages.Item.ReplyAll;
using ApiSdk.Me.MailFolders.Item.ChildFolders.Item.Messages.Item.Send;
using ApiSdk.Me.MailFolders.Item.ChildFolders.Item.Messages.Item.SingleValueExtendedProperties;
using ApiSdk.Me.MailFolders.Item.ChildFolders.Item.Messages.Item.Value;
using ApiSdk.Models;
...
namespace ApiSdk.Me.MailFolders.Item.ChildFolders.Item.Messages.Item {
    ...
    public class MessageItemRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            }, new CollectionBinding(mailFolderIdOption, mailFolderId1Option, messageIdOption, ifMatchOption, new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(mailFolderIdOption, mailFolderId1Option, messageIdOption, selectOption, expandOption, outputOption, queryOption, jsonNoIndentOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
