...
using System.IO;
using System.Linq;
namespace ApiSdk.Me.MailFolders.Item.ChildFolders.Item.Messages.Item.ReplyAll {
    ...
    public class ReplyAllRequestBody : IAdditionalDataHolder, IParsable {
        ...
        /// </summary>
        public static ApiSdk.Me.MailFolders.Item.ChildFolders.Item.Messages.Item.ReplyAll.ReplyAllRequestBody CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"message", (o,n) => { (o as ReplyAllRequestBody).Message = n.GetObjectValue<ApiSdk.Models.Microsoft.Graph.Message>(ApiSdk.Models.Microsoft.Graph.Message.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
