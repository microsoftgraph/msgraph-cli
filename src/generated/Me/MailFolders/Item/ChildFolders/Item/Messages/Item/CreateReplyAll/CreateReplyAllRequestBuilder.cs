...
namespace ApiSdk.Me.MailFolders.Item.ChildFolders.Item.Messages.Item.CreateReplyAll {
    ...
    public class CreateReplyAllRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Me.MailFolders.Item.ChildFolders.Item.Messages.Item.CreateReplyAll.CreateReplyAllRequestBody>(ApiSdk.Me.MailFolders.Item.ChildFolders.Item.Messages.Item.CreateReplyAll.CreateReplyAllRequestBody.CreateFromDiscriminatorValue);
        ...
        public CreateReplyAllRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/mailFolders/{mailFolder_id}/childFolders/{mailFolder_id1}/messages/{message_id}/microsoft.graph.createReplyAll";
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ApiSdk.Me.MailFolders.Item.ChildFolders.Item.Messages.Item.CreateReplyAll.CreateReplyAllRequestBody body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
