...
namespace ApiSdk.Me.MailFolders.Item.ChildFolders.Item.Messages.Item.MicrosoftGraphReply {
    /// <summary>
    ...
    public class MicrosoftGraphReplyRequestBuilder {
        ...
        public MicrosoftGraphReplyRequestBuilder(Dictionary<string, object> pathParameters) {
            ...
            UrlTemplate = "{+baseurl}/me/mailFolders/{mailFolder%2Did}/childFolders/{mailFolder%2Did1}/messages/{message%2Did}/microsoft.graph.reply";
