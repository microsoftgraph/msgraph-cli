...
namespace ApiSdk.Me.MailFolders.Item.ChildFolders.Item.Messages.Item.Forward {
    ...
    public class ForwardRequestBuilder {
        ...
        public ForwardRequestBuilder(Dictionary<string, object> pathParameters) {
            ...
            UrlTemplate = "{+baseurl}/me/mailFolders/{mailFolder%2Did}/childFolders/{mailFolder%2Did1}/messages/{message%2Did}/forward";
