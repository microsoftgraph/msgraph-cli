...
namespace ApiSdk.Me.MailFolders.Item.ChildFolders.Item.Messages.Item.Forward {
    ...
    public class ForwardRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Me.MailFolders.Item.ChildFolders.Item.Messages.Item.Forward.ForwardRequestBody>(ApiSdk.Me.MailFolders.Item.ChildFolders.Item.Messages.Item.Forward.ForwardRequestBody.CreateFromDiscriminatorValue);
        ...
        public ForwardRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/mailFolders/{mailFolder_id}/childFolders/{mailFolder_id1}/messages/{message_id}/microsoft.graph.forward";
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ApiSdk.Me.MailFolders.Item.ChildFolders.Item.Messages.Item.Forward.ForwardRequestBody body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
