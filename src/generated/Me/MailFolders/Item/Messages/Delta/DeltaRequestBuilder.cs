...
namespace ApiSdk.Me.MailFolders.Item.Messages.Delta {
    ...
    public class DeltaRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string mailFolderId, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, mailFolderIdOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        ...
        /// </summary>
        public async Task<IEnumerable<ApiSdk.Me.MailFolders.Item.Messages.Delta.Delta>> GetAsync(Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            var requestInfo = CreateGetRequestInformation(h, o);
            return await RequestAdapter.SendCollectionAsync<ApiSdk.Me.MailFolders.Item.Messages.Delta.Delta>(requestInfo, responseHandler, cancellationToken);
        }
    }
}
