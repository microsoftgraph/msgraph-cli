    ...
    public class ReplyRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Me.MailFolders.Item.Messages.Item.Reply.ReplyRequestBody>(ApiSdk.Me.MailFolders.Item.Messages.Item.Reply.ReplyRequestBody.CreateFromDiscriminatorValue);
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ApiSdk.Me.MailFolders.Item.Messages.Item.Reply.ReplyRequestBody body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
