...
namespace ApiSdk.Me.MailFolders.Item.Messages.Item.CreateReply {
    ...
    public class CreateReplyRequestBuilder {
        ...
        public CreateReplyRequestBuilder(Dictionary<string, object> pathParameters) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            UrlTemplate = "{+baseurl}/me/mailFolders/{mailFolder%2Did}/messages/{message%2Did}/createReply";
