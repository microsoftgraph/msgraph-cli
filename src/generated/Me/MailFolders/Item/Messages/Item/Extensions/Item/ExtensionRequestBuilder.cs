...
namespace ApiSdk.Me.MailFolders.Item.Messages.Item.Extensions.Item {
    ...
    public class ExtensionRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string mailFolderId, string messageId, string extensionId) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string mailFolderId, string messageId, string extensionId, string[] select, string[] expand) => {
            ...
            }, mailFolderIdOption, messageIdOption, extensionIdOption, selectOption, expandOption);
            return command;
        }
        /// <summary>
        /// The collection of open extensions defined for the message. Nullable.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string mailFolderId, string messageId, string extensionId, string body) => {
