...
namespace ApiSdk.Me.MailFolders.Item.Messages.Item.Extensions.Item {
    ...
    public class ExtensionRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string mailFolderId, string messageId, string extensionId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, mailFolderIdOption, messageIdOption, extensionIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The collection of open extensions defined for the message. Nullable.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string mailFolderId, string messageId, string extensionId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, mailFolderIdOption, messageIdOption, extensionIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The collection of open extensions defined for the message. Nullable.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string mailFolderId, string messageId, string extensionId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, mailFolderIdOption, messageIdOption, extensionIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
