...
namespace ApiSdk.Me.MailFolders.Item.Messages.Item.CalendarSharingMessage.Accept {
    ...
    public class AcceptRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (string mailFolderId, string messageId, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, mailFolderIdOption, messageIdOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
