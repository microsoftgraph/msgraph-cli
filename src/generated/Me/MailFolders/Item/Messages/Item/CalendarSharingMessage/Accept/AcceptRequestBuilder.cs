...
namespace ApiSdk.Me.MailFolders.Item.Messages.Item.CalendarSharingMessage.Accept {
    ...
    public class AcceptRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            }, new CollectionBinding(mailFolderIdOption, messageIdOption, outputOption, queryOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
