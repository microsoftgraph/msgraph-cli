...
namespace ApiSdk.Me.MailFolders.Item.Messages.Item.Attachments.Item {
    ...
    public class AttachmentRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string mailFolderId, string messageId, string attachmentId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, mailFolderIdOption, messageIdOption, attachmentIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The fileAttachment and itemAttachment attachments for the message.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string mailFolderId, string messageId, string attachmentId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, mailFolderIdOption, messageIdOption, attachmentIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The fileAttachment and itemAttachment attachments for the message.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string mailFolderId, string messageId, string attachmentId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, mailFolderIdOption, messageIdOption, attachmentIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
