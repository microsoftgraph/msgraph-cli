...
namespace ApiSdk.Me.WipeManagedAppRegistrationsByDeviceTag {
    ...
    public class WipeManagedAppRegistrationsByDeviceTagRequestBuilder {
        ...
        public WipeManagedAppRegistrationsByDeviceTagRequestBuilder(Dictionary<string, object> pathParameters) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            UrlTemplate = "{+baseurl}/me/wipeManagedAppRegistrationsByDeviceTag";
