...
namespace ApiSdk.Me.OnlineMeetings.Item {
    ...
    public class OnlineMeetingRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string onlineMeetingId, IOutputFormatterFactory outputFormatterFactory, CancellationToken cancellationToken) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string onlineMeetingId, string[] select, string[] expand, FormatterType output, IOutputFormatterFactory outputFormatterFactory, CancellationToken cancellationToken) => {
            ...
            }, onlineMeetingIdOption, selectOption, expandOption, outputOption);
            return command;
        }
        /// <summary>
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string onlineMeetingId, string body, IOutputFormatterFactory outputFormatterFactory, CancellationToken cancellationToken) => {
