...
namespace ApiSdk.Me.OnlineMeetings.Item.AttendanceReports.Item.AttendanceRecords {
    ...
    public class AttendanceRecordsRequestBuilder {
        ...
        public Command BuildListCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, int?, int?, string, string, bool?, string[], string[], string[]>(async (onlineMeetingId, meetingAttendanceReportId, top, skip, search, filter, count, orderby, select, expand) => {
