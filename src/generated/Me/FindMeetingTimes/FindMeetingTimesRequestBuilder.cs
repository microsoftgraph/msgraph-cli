    ...
    public class FindMeetingTimesRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (string body) => {
                ...
                var model = parseNode.GetObjectValue<FindMeetingTimesRequestBody>();
                var requestInfo = CreatePostRequestInformation(model, q => {
                });
                var result = await RequestAdapter.SendAsync<FindMeetingTimesResponse>(requestInfo);
        ...
        /// </summary>
        public async Task<FindMeetingTimesResponse> PostAsync(FindMeetingTimesRequestBody model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
