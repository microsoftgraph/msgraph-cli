using ApiSdk.Me.Authentication.WindowsHelloForBusinessMethods.Item.Device.TransitiveMemberOf.User.Count;
using ApiSdk.Models;
...
namespace ApiSdk.Me.Authentication.WindowsHelloForBusinessMethods.Item.Device.TransitiveMemberOf.User {
    /// <summary>
    ...
    public class UserRequestBuilder {
        ...
        public UserRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/authentication/windowsHelloForBusinessMethods/{windowsHelloForBusinessAuthenticationMethod%2Did}/device/transitiveMemberOf/microsoft.graph.user{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
