using ApiSdk.Me.Authentication.WindowsHelloForBusinessMethods.Item.Device.TransitiveMemberOf.Application;
using ApiSdk.Me.Authentication.WindowsHelloForBusinessMethods.Item.Device.TransitiveMemberOf.Count;
using ApiSdk.Me.Authentication.WindowsHelloForBusinessMethods.Item.Device.TransitiveMemberOf.Device;
using ApiSdk.Me.Authentication.WindowsHelloForBusinessMethods.Item.Device.TransitiveMemberOf.Group;
using ApiSdk.Me.Authentication.WindowsHelloForBusinessMethods.Item.Device.TransitiveMemberOf.Item;
using ApiSdk.Me.Authentication.WindowsHelloForBusinessMethods.Item.Device.TransitiveMemberOf.OrgContact;
using ApiSdk.Me.Authentication.WindowsHelloForBusinessMethods.Item.Device.TransitiveMemberOf.ServicePrincipal;
using ApiSdk.Me.Authentication.WindowsHelloForBusinessMethods.Item.Device.TransitiveMemberOf.User;
using ApiSdk.Models;
...
namespace ApiSdk.Me.Authentication.WindowsHelloForBusinessMethods.Item.Device.TransitiveMemberOf {
    /// <summary>
    ...
    public class TransitiveMemberOfRequestBuilder {
        ...
        public Command BuildDeviceCommand() {
            ...
            var builder = new ApiSdk.Me.Authentication.WindowsHelloForBusinessMethods.Item.Device.TransitiveMemberOf.Device.DeviceRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildCountCommand());
            command.AddCommand(builder.BuildGetCommand());
            return command;
        }
        ...
        public TransitiveMemberOfRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/authentication/windowsHelloForBusinessMethods/{windowsHelloForBusinessAuthenticationMethod%2Did}/device/transitiveMemberOf{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
