...
namespace ApiSdk.Me.Authentication.WindowsHelloForBusinessMethods.Item.Device.TransitiveMemberOf.Item.OrgContact {
    ...
    public class OrgContactRequestBuilder {
        ...
        public OrgContactRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/authentication/windowsHelloForBusinessMethods/{windowsHelloForBusinessAuthenticationMethod%2Did}/device/transitiveMemberOf/{directoryObject%2Did}/microsoft.graph.orgContact{?%24select,%24expand}";
