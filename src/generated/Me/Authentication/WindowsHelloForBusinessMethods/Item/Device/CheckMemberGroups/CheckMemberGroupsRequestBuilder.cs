...
namespace ApiSdk.Me.Authentication.WindowsHelloForBusinessMethods.Item.Device.CheckMemberGroups {
    ...
    public class CheckMemberGroupsRequestBuilder {
        ...
        public CheckMemberGroupsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/authentication/windowsHelloForBusinessMethods/{windowsHelloForBusinessAuthenticationMethod%2Did}/device/microsoft.graph.checkMemberGroups";
