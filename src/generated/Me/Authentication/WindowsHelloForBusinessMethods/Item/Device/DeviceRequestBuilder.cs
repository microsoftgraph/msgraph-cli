...
namespace ApiSdk.Me.Authentication.WindowsHelloForBusinessMethods.Item.Device {
    ...
    public class DeviceRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string windowsHelloForBusinessAuthenticationMethodId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, windowsHelloForBusinessAuthenticationMethodIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The registered device on which this Windows Hello for Business key resides.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string windowsHelloForBusinessAuthenticationMethodId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, windowsHelloForBusinessAuthenticationMethodIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The registered device on which this Windows Hello for Business key resides.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string windowsHelloForBusinessAuthenticationMethodId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, windowsHelloForBusinessAuthenticationMethodIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
