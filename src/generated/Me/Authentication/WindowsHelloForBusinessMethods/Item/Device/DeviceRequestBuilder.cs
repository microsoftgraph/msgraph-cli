...
namespace ApiSdk.Me.Authentication.WindowsHelloForBusinessMethods.Item.Device {
    ...
    public class DeviceRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            }, windowsHelloForBusinessAuthenticationMethodIdOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// The registered device on which this Windows Hello for Business key resides.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string windowsHelloForBusinessAuthenticationMethodId, string[] select, string[] expand, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
            ...
            }, windowsHelloForBusinessAuthenticationMethodIdOption, selectOption, expandOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// The registered device on which this Windows Hello for Business key resides.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string windowsHelloForBusinessAuthenticationMethodId, string body, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                ...
                await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                console.WriteLine("Success");
            }, windowsHelloForBusinessAuthenticationMethodIdOption, bodyOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
