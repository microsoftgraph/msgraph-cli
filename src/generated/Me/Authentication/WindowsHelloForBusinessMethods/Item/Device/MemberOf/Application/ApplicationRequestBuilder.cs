using ApiSdk.Me.Authentication.WindowsHelloForBusinessMethods.Item.Device.MemberOf.Application.Count;
using ApiSdk.Models;
...
namespace ApiSdk.Me.Authentication.WindowsHelloForBusinessMethods.Item.Device.MemberOf.Application {
    /// <summary>
    ...
    public class ApplicationRequestBuilder {
        ...
        public ApplicationRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/authentication/windowsHelloForBusinessMethods/{windowsHelloForBusinessAuthenticationMethod%2Did}/device/memberOf/microsoft.graph.application{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
