...
namespace ApiSdk.Me.Authentication.WindowsHelloForBusinessMethods.Item.Device.MemberOf.Item.Application {
    ...
    public class ApplicationRequestBuilder {
        ...
        public ApplicationRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/authentication/windowsHelloForBusinessMethods/{windowsHelloForBusinessAuthenticationMethod%2Did}/device/memberOf/{directoryObject%2Did}/microsoft.graph.application{?%24select,%24expand}";
