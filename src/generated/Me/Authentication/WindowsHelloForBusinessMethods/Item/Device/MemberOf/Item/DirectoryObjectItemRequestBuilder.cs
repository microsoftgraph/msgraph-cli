using ApiSdk.Me.Authentication.WindowsHelloForBusinessMethods.Item.Device.MemberOf.Item.Application;
using ApiSdk.Me.Authentication.WindowsHelloForBusinessMethods.Item.Device.MemberOf.Item.Device;
using ApiSdk.Me.Authentication.WindowsHelloForBusinessMethods.Item.Device.MemberOf.Item.Group;
using ApiSdk.Me.Authentication.WindowsHelloForBusinessMethods.Item.Device.MemberOf.Item.OrgContact;
using ApiSdk.Me.Authentication.WindowsHelloForBusinessMethods.Item.Device.MemberOf.Item.ServicePrincipal;
using ApiSdk.Me.Authentication.WindowsHelloForBusinessMethods.Item.Device.MemberOf.Item.User;
using ApiSdk.Models;
...
namespace ApiSdk.Me.Authentication.WindowsHelloForBusinessMethods.Item.Device.MemberOf.Item {
    /// <summary>
    ...
    public class DirectoryObjectItemRequestBuilder {
        ...
        public Command BuildDeviceCommand() {
            ...
            var builder = new ApiSdk.Me.Authentication.WindowsHelloForBusinessMethods.Item.Device.MemberOf.Item.Device.DeviceRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildGetCommand());
            return command;
        }
        /// <summary>
