using ApiSdk.Me.Authentication.WindowsHelloForBusinessMethods.Item.Device.Extensions.Count;
using ApiSdk.Me.Authentication.WindowsHelloForBusinessMethods.Item.Device.Extensions.Item;
using ApiSdk.Models;
...
namespace ApiSdk.Me.Authentication.WindowsHelloForBusinessMethods.Item.Device.Extensions {
    ...
    public class ExtensionsRequestBuilder {
        ...
        public Command BuildCreateCommand() {
            ...
            }, new CollectionBinding(windowsHelloForBusinessAuthenticationMethodIdOption, bodyOption, outputOption, queryOption, jsonNoIndentOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
