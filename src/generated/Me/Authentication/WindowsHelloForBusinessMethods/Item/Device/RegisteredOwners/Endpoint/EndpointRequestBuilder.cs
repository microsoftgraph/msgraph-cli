using ApiSdk.Me.Authentication.WindowsHelloForBusinessMethods.Item.Device.RegisteredOwners.Endpoint.Count;
using ApiSdk.Models;
...
namespace ApiSdk.Me.Authentication.WindowsHelloForBusinessMethods.Item.Device.RegisteredOwners.Endpoint {
    /// <summary>
    ...
    public class EndpointRequestBuilder {
        ...
        public EndpointRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/authentication/windowsHelloForBusinessMethods/{windowsHelloForBusinessAuthenticationMethod%2Did}/device/registeredOwners/microsoft.graph.endpoint{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
