...
namespace ApiSdk.Me.Authentication.WindowsHelloForBusinessMethods.Item {
    ...
    public class WindowsHelloForBusinessAuthenticationMethodItemRequestBuilder {
        ...
        public WindowsHelloForBusinessAuthenticationMethodItemRequestBuilder(Dictionary<string, object> pathParameters) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            UrlTemplate = "{+baseurl}/me/authentication/windowsHelloForBusinessMethods/{windowsHelloForBusinessAuthenticationMethod%2Did}{?%24select,%24expand}";
