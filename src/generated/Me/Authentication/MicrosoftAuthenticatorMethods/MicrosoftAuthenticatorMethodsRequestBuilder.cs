...
namespace ApiSdk.Me.Authentication.MicrosoftAuthenticatorMethods {
    ...
    public class MicrosoftAuthenticatorMethodsRequestBuilder {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<MicrosoftAuthenticatorAuthenticationMethod> PostAsync(MicrosoftAuthenticatorAuthenticationMethod model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
