using ApiSdk.Me.Authentication.MicrosoftAuthenticatorMethods.Item.Device.MemberOf.Application;
using ApiSdk.Me.Authentication.MicrosoftAuthenticatorMethods.Item.Device.MemberOf.Count;
using ApiSdk.Me.Authentication.MicrosoftAuthenticatorMethods.Item.Device.MemberOf.Device;
using ApiSdk.Me.Authentication.MicrosoftAuthenticatorMethods.Item.Device.MemberOf.Group;
using ApiSdk.Me.Authentication.MicrosoftAuthenticatorMethods.Item.Device.MemberOf.Item;
using ApiSdk.Me.Authentication.MicrosoftAuthenticatorMethods.Item.Device.MemberOf.OrgContact;
using ApiSdk.Me.Authentication.MicrosoftAuthenticatorMethods.Item.Device.MemberOf.ServicePrincipal;
using ApiSdk.Me.Authentication.MicrosoftAuthenticatorMethods.Item.Device.MemberOf.User;
using ApiSdk.Models;
...
namespace ApiSdk.Me.Authentication.MicrosoftAuthenticatorMethods.Item.Device.MemberOf {
    ...
    public class MemberOfRequestBuilder {
        ...
        public Command BuildDeviceCommand() {
            ...
            var builder = new ApiSdk.Me.Authentication.MicrosoftAuthenticatorMethods.Item.Device.MemberOf.Device.DeviceRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildCountCommand());
            command.AddCommand(builder.BuildGetCommand());
            return command;
        }
