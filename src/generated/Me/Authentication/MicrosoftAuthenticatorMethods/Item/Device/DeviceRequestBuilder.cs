...
namespace ApiSdk.Me.Authentication.MicrosoftAuthenticatorMethods.Item.Device {
    ...
    public class DeviceRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string microsoftAuthenticatorAuthenticationMethodId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, microsoftAuthenticatorAuthenticationMethodIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The registered device on which Microsoft Authenticator resides. This property is null if the device is not registered for passwordless Phone Sign-In.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string microsoftAuthenticatorAuthenticationMethodId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, microsoftAuthenticatorAuthenticationMethodIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The registered device on which Microsoft Authenticator resides. This property is null if the device is not registered for passwordless Phone Sign-In.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string microsoftAuthenticatorAuthenticationMethodId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, microsoftAuthenticatorAuthenticationMethodIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
