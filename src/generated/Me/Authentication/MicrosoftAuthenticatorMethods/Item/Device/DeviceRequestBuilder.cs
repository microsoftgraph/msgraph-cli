...
namespace ApiSdk.Me.Authentication.MicrosoftAuthenticatorMethods.Item.Device {
    ...
    public class DeviceRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string microsoftAuthenticatorAuthenticationMethodId, IConsole console) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string microsoftAuthenticatorAuthenticationMethodId, string[] select, string[] expand, FormatterType output, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string microsoftAuthenticatorAuthenticationMethodId, string body, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
