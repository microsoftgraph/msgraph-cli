...
namespace ApiSdk.Me.Authentication.MicrosoftAuthenticatorMethods.Item.Device.RegisteredOwners.Ref {
    ...
    public class RefRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.Description = "Create new navigation property ref to registeredOwners for me";
            // Create options for all the parameters
            var microsoftAuthenticatorAuthenticationMethodIdOption = new Option<string>("--microsoft-authenticator-authentication-method-id", description: "key: id of microsoftAuthenticatorAuthenticationMethod") {
            };
            microsoftAuthenticatorAuthenticationMethodIdOption.IsRequired = true;
        ...
        public RefRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/authentication/microsoftAuthenticatorMethods/{microsoftAuthenticatorAuthenticationMethod%2Did}/device/registeredOwners/$ref{?%24top,%24skip,%24search,%24filter,%24count,%24orderby}";
