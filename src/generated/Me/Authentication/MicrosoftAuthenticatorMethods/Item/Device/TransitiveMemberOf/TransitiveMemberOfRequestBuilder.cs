using ApiSdk.Me.Authentication.MicrosoftAuthenticatorMethods.Item.Device.TransitiveMemberOf.Application;
using ApiSdk.Me.Authentication.MicrosoftAuthenticatorMethods.Item.Device.TransitiveMemberOf.Count;
using ApiSdk.Me.Authentication.MicrosoftAuthenticatorMethods.Item.Device.TransitiveMemberOf.Device;
using ApiSdk.Me.Authentication.MicrosoftAuthenticatorMethods.Item.Device.TransitiveMemberOf.Group;
using ApiSdk.Me.Authentication.MicrosoftAuthenticatorMethods.Item.Device.TransitiveMemberOf.Item;
using ApiSdk.Me.Authentication.MicrosoftAuthenticatorMethods.Item.Device.TransitiveMemberOf.OrgContact;
using ApiSdk.Me.Authentication.MicrosoftAuthenticatorMethods.Item.Device.TransitiveMemberOf.ServicePrincipal;
using ApiSdk.Me.Authentication.MicrosoftAuthenticatorMethods.Item.Device.TransitiveMemberOf.User;
using ApiSdk.Models;
...
namespace ApiSdk.Me.Authentication.MicrosoftAuthenticatorMethods.Item.Device.TransitiveMemberOf {
    /// <summary>
    ...
    public class TransitiveMemberOfRequestBuilder {
        ...
        public Command BuildDeviceCommand() {
            ...
            var builder = new ApiSdk.Me.Authentication.MicrosoftAuthenticatorMethods.Item.Device.TransitiveMemberOf.Device.DeviceRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildCountCommand());
            command.AddCommand(builder.BuildGetCommand());
            return command;
        }
