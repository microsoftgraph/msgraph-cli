...
namespace ApiSdk.Me.Authentication.MicrosoftAuthenticatorMethods.Item {
    ...
    public class MicrosoftAuthenticatorAuthenticationMethodItemRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(microsoftAuthenticatorAuthenticationMethodIdOption, selectOption, expandOption, outputOption, queryOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
