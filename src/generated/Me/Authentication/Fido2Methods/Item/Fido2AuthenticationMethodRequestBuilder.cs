...
namespace ApiSdk.Me.Authentication.Fido2Methods.Item {
    ...
    public class Fido2AuthenticationMethodRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string fido2AuthenticationMethodId, IConsole console) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string fido2AuthenticationMethodId, string[] select, string[] expand, FormatterType output, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string fido2AuthenticationMethodId, string body, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
