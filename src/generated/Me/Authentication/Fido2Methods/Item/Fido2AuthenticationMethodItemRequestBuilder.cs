...
namespace ApiSdk.Me.Authentication.Fido2Methods.Item {
    ...
    public class Fido2AuthenticationMethodItemRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(fido2AuthenticationMethodIdOption, selectOption, expandOption, outputOption, outputFilterOption, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
