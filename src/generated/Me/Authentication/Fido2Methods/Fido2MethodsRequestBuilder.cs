...
namespace ApiSdk.Me.Authentication.Fido2Methods {
    ...
    public class Fido2MethodsRequestBuilder {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<Fido2AuthenticationMethod> PostAsync(Fido2AuthenticationMethod model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
