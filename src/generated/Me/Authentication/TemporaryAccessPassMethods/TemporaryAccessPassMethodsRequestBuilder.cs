using ApiSdk.Me.Authentication.TemporaryAccessPassMethods.Count;
using ApiSdk.Me.Authentication.TemporaryAccessPassMethods.Item;
using ApiSdk.Models;
...
namespace ApiSdk.Me.Authentication.TemporaryAccessPassMethods {
    ...
    public class TemporaryAccessPassMethodsRequestBuilder {
        ...
        public Command BuildCommand() {
            ...
            var builder = new TemporaryAccessPassAuthenticationMethodItemRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildCreateCommand() {
            ...
            command.Description = "Create new navigation property to temporaryAccessPassMethods for me";
