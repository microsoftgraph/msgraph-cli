...
namespace ApiSdk.Me.Authentication {
    ...
    public class AuthenticationRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.Description = "Delete navigation property authentication for me";
        ...
        public Command BuildPatchCommand() {
            ...
            command.Description = "Update the navigation property authentication in me";
            // Create options for all the parameters
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Models.Microsoft.Graph.Authentication>(ApiSdk.Models.Microsoft.Graph.Authentication.CreateFromDiscriminatorValue);
        ...
        /// <param name="options">Request options</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(ApiSdk.Models.Microsoft.Graph.Authentication body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
