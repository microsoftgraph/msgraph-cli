...
namespace ApiSdk.Me.Authentication.PhoneMethods.Item.DisableSmsSignIn {
    ...
    public class DisableSmsSignInRequestBuilder {
        ...
        public DisableSmsSignInRequestBuilder(Dictionary<string, object> pathParameters) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            UrlTemplate = "{+baseurl}/me/authentication/phoneMethods/{phoneAuthenticationMethod%2Did}/disableSmsSignIn";
