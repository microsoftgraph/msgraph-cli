...
namespace ApiSdk.Me.Authentication.PasswordMethods.Item {
    ...
    public class PasswordAuthenticationMethodItemRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.Description = "Delete navigation property passwordMethods for me";
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                requestInfo.PathParameters.Add("passwordAuthenticationMethod%2Did", passwordAuthenticationMethodId);
        ...
        public Command BuildPatchCommand() {
            ...
            command.Description = "Update the navigation property passwordMethods in me";
            // Create options for all the parameters
            var passwordAuthenticationMethodIdOption = new Option<string>("--password-authentication-method-id", description: "key: id of passwordAuthenticationMethod") {
            };
            passwordAuthenticationMethodIdOption.IsRequired = true;
