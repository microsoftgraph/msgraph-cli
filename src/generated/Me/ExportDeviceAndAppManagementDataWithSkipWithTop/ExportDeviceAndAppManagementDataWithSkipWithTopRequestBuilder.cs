...
namespace ApiSdk.Me.ExportDeviceAndAppManagementDataWithSkipWithTop {
    /// <summary>
    ...
    public class ExportDeviceAndAppManagementDataWithSkipWithTopRequestBuilder {
        ...
        public ExportDeviceAndAppManagementDataWithSkipWithTopRequestBuilder(Dictionary<string, object> pathParameters, int? skip = default, int? top = default) {
