using ApiSdk.Me.Calendar.Events.Item.Instances.Item.Extensions.Count;
using ApiSdk.Me.Calendar.Events.Item.Instances.Item.Extensions.Item;
using ApiSdk.Models;
...
namespace ApiSdk.Me.Calendar.Events.Item.Instances.Item.Extensions {
    ...
    public class ExtensionsRequestBuilder {
        ...
        public ExtensionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/calendar/events/{event%2Did}/instances/{event%2Did1}/extensions{?%24top,%24skip,%24filter,%24count,%24orderby,%24select,%24expand}";
