...
using ApiSdk.Me.Calendar.Events.Item.MicrosoftGraphAccept;
using ApiSdk.Me.Calendar.Events.Item.MicrosoftGraphCancel;
using ApiSdk.Me.Calendar.Events.Item.MicrosoftGraphDecline;
using ApiSdk.Me.Calendar.Events.Item.MicrosoftGraphDismissReminder;
using ApiSdk.Me.Calendar.Events.Item.MicrosoftGraphForward;
using ApiSdk.Me.Calendar.Events.Item.MicrosoftGraphSnoozeReminder;
using ApiSdk.Me.Calendar.Events.Item.MicrosoftGraphTentativelyAccept;
...
namespace ApiSdk.Me.Calendar.Events.Item {
    ...
    public class EventItemRequestBuilder {
        ...
        public EventItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/calendar/events/{event%2Did}{?%24select}";
