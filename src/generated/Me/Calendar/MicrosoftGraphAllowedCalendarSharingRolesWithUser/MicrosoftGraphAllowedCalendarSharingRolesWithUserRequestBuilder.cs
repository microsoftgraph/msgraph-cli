...
namespace ApiSdk.Me.Calendar.MicrosoftGraphAllowedCalendarSharingRolesWithUser {
    /// <summary>
    ...
    public class MicrosoftGraphAllowedCalendarSharingRolesWithUserRequestBuilder {
        ...
        public MicrosoftGraphAllowedCalendarSharingRolesWithUserRequestBuilder(Dictionary<string, object> pathParameters, string user = "") {
            ...
            UrlTemplate = "{+baseurl}/me/calendar/microsoft.graph.allowedCalendarSharingRoles(User='{User}'){?%24top,%24skip,%24search,%24filter,%24count}";
