...
namespace ApiSdk.Me.Calendar.CalendarView.Item.Attachments.Item {
    ...
    public class AttachmentRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string eventId, string attachmentId) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string eventId, string attachmentId, string[] select, string[] expand) => {
            ...
            }, eventIdOption, attachmentIdOption, selectOption, expandOption);
            return command;
        }
        /// <summary>
        /// The collection of FileAttachment, ItemAttachment, and referenceAttachment attachments for the event. Navigation property. Read-only. Nullable.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string eventId, string attachmentId, string body) => {
