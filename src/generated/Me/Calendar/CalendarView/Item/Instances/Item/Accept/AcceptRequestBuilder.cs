    ...
    public class AcceptRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Me.Calendar.CalendarView.Item.Instances.Item.Accept.AcceptRequestBody>(ApiSdk.Me.Calendar.CalendarView.Item.Instances.Item.Accept.AcceptRequestBody.CreateFromDiscriminatorValue);
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ApiSdk.Me.Calendar.CalendarView.Item.Instances.Item.Accept.AcceptRequestBody body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
