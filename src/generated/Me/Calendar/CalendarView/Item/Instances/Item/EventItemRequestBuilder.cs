using ApiSdk.Me.Calendar.CalendarView.Item.Instances.Item.Attachments;
using ApiSdk.Me.Calendar.CalendarView.Item.Instances.Item.Calendar;
using ApiSdk.Me.Calendar.CalendarView.Item.Instances.Item.Extensions;
using ApiSdk.Me.Calendar.CalendarView.Item.Instances.Item.MicrosoftGraphAccept;
using ApiSdk.Me.Calendar.CalendarView.Item.Instances.Item.MicrosoftGraphCancel;
using ApiSdk.Me.Calendar.CalendarView.Item.Instances.Item.MicrosoftGraphDecline;
using ApiSdk.Me.Calendar.CalendarView.Item.Instances.Item.MicrosoftGraphDismissReminder;
using ApiSdk.Me.Calendar.CalendarView.Item.Instances.Item.MicrosoftGraphForward;
using ApiSdk.Me.Calendar.CalendarView.Item.Instances.Item.MicrosoftGraphSnoozeReminder;
using ApiSdk.Me.Calendar.CalendarView.Item.Instances.Item.MicrosoftGraphTentativelyAccept;
using ApiSdk.Me.Calendar.CalendarView.Item.Instances.Item.MultiValueExtendedProperties;
using ApiSdk.Me.Calendar.CalendarView.Item.Instances.Item.SingleValueExtendedProperties;
using ApiSdk.Models;
...
namespace ApiSdk.Me.Calendar.CalendarView.Item.Instances.Item {
    ...
    public class EventItemRequestBuilder {
        ...
        public Command BuildCalendarCommand() {
            ...
            var builder = new ApiSdk.Me.Calendar.CalendarView.Item.Instances.Item.Calendar.CalendarRequestBuilder(PathParameters, RequestAdapter);
        ...
        public EventItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/calendar/calendarView/{event%2Did}/instances/{event%2Did1}{?%24select}";
