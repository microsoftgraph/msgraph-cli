...
namespace ApiSdk.Me.Calendar.CalendarView.Item.MultiValueExtendedProperties.Count {
    /// <summary>
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters) {
            ...
            UrlTemplate = "{+baseurl}/me/calendar/calendarView/{event%2Did}/multiValueExtendedProperties/$count{?%24search,%24filter}";
