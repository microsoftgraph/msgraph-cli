...
namespace ApiSdk.Me.Calendar.CalendarView.Item {
    ...
    public class EventRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string eventId, IConsole console) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string eventId, string startDateTime, string endDateTime, string[] select, FormatterType output, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string eventId, string body, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
