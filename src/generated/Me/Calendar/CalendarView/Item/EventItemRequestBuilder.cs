...
using ApiSdk.Me.Calendar.CalendarView.Item.MicrosoftGraphAccept;
using ApiSdk.Me.Calendar.CalendarView.Item.MicrosoftGraphCancel;
using ApiSdk.Me.Calendar.CalendarView.Item.MicrosoftGraphDecline;
using ApiSdk.Me.Calendar.CalendarView.Item.MicrosoftGraphDismissReminder;
using ApiSdk.Me.Calendar.CalendarView.Item.MicrosoftGraphForward;
using ApiSdk.Me.Calendar.CalendarView.Item.MicrosoftGraphSnoozeReminder;
using ApiSdk.Me.Calendar.CalendarView.Item.MicrosoftGraphTentativelyAccept;
...
namespace ApiSdk.Me.Calendar.CalendarView.Item {
    ...
    public class EventItemRequestBuilder {
        ...
        public Command BuildCalendarCommand() {
            ...
            var builder = new ApiSdk.Me.Calendar.CalendarView.Item.Calendar.CalendarRequestBuilder(PathParameters);
