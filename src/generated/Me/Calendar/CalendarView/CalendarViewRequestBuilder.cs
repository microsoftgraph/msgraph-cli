...
namespace ApiSdk.Me.Calendar.CalendarView {
    ...
    public class CalendarViewRequestBuilder {
        ...
        public Command BuildListCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, int?, int?, string, bool?, object, object>(async (startDateTime, endDateTime, top, skip, filter, count, orderby, select) => {
