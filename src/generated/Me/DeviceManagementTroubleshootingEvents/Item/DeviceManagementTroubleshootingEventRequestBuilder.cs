...
namespace ApiSdk.Me.DeviceManagementTroubleshootingEvents.Item {
    ...
    public class DeviceManagementTroubleshootingEventRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string deviceManagementTroubleshootingEventId, IConsole console) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string deviceManagementTroubleshootingEventId, string[] select, string[] expand, FormatterType output, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string deviceManagementTroubleshootingEventId, string body, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
