...
namespace ApiSdk.Me.DeviceManagementTroubleshootingEvents.Item {
    ...
    public class DeviceManagementTroubleshootingEventRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            }, deviceManagementTroubleshootingEventIdOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// The list of troubleshooting events for this user.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string deviceManagementTroubleshootingEventId, string[] select, string[] expand, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
            ...
            }, deviceManagementTroubleshootingEventIdOption, selectOption, expandOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// The list of troubleshooting events for this user.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string deviceManagementTroubleshootingEventId, string body, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                ...
                await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                console.WriteLine("Success");
            }, deviceManagementTroubleshootingEventIdOption, bodyOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
