...
namespace ApiSdk.Me.Chats.Item.Members.Item {
    ...
    public class ConversationMemberItemRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            }, new CollectionBinding(chatIdOption, conversationMemberIdOption, new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        ...
        public ConversationMemberItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/chats/{chat_id}/members/{conversationMember_id}{?select,expand}";
