using ApiSdk.Me.Chats.Item.PinnedMessages.Item.Message;
using ApiSdk.Models;
...
namespace ApiSdk.Me.Chats.Item.PinnedMessages.Item {
    /// <summary>
    ...
    public class PinnedChatMessageInfoItemRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.Description = "Delete navigation property pinnedMessages for me";
        ...
        public Command BuildPatchCommand() {
            ...
            command.Description = "Update the navigation property pinnedMessages in me";
            // Create options for all the parameters
            var chatIdOption = new Option<string>("--chat-id", description: "The unique identifier of chat") {
            };
            chatIdOption.IsRequired = true;
        ...
        public PinnedChatMessageInfoItemRequestBuilder(Dictionary<string, object> pathParameters) {
