...
namespace ApiSdk.Me.Chats {
    ...
    public class ChatsRequestBuilder {
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ApiSdk.Models.Chat body, Action<ChatsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
