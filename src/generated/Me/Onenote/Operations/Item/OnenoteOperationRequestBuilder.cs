...
namespace ApiSdk.Me.Onenote.Operations.Item {
    ...
    public class OnenoteOperationRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string onenoteOperationId, IConsole console) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string onenoteOperationId, string[] select, string[] expand, FormatterType output, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string onenoteOperationId, string body, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
