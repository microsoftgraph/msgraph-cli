...
namespace ApiSdk.Me.Onenote.Operations.Item {
    ...
    public class OnenoteOperationRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string onenoteOperationId) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string onenoteOperationId, string[] select, string[] expand) => {
            ...
            }, onenoteOperationIdOption, selectOption, expandOption);
            return command;
        }
        /// <summary>
        /// The status of OneNote operations. Getting an operations collection is not supported, but you can get the status of long-running operations if the Operation-Location header is returned in the response. Read-only. Nullable.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string onenoteOperationId, string body) => {
