...
namespace ApiSdk.Me.Onenote.SectionGroups.Item.Sections.Item.ParentNotebook.Sections.Item {
    ...
    public class OnenoteSectionRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string sectionGroupId, string onenoteSectionId, string onenoteSectionId1) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string sectionGroupId, string onenoteSectionId, string onenoteSectionId1, string[] select, string[] expand) => {
            ...
            }, sectionGroupIdOption, onenoteSectionIdOption, onenoteSectionId1Option, selectOption, expandOption);
            return command;
        }
        /// <summary>
        /// The sections in the notebook. Read-only. Nullable.
