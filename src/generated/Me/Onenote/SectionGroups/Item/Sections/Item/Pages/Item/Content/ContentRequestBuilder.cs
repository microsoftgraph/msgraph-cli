...
namespace ApiSdk.Me.Onenote.SectionGroups.Item.Sections.Item.Pages.Item.Content {
    ...
    public class ContentRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string sectionGroupId, string onenoteSectionId, string onenotePageId, FileInfo output) => {
            ...
            }, sectionGroupIdOption, onenoteSectionIdOption, onenotePageIdOption, outputOption);
            return command;
        }
        /// <summary>
        ...
        public Command BuildPutCommand() {
            ...
            command.SetHandler(async (string sectionGroupId, string onenoteSectionId, string onenotePageId, FileInfo file) => {
