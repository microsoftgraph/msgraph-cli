...
namespace ApiSdk.Me.Onenote.SectionGroups.Item.ParentNotebook.Sections.Item.Pages.Item {
    ...
    public class OnenotePageRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string>(async (sectionGroupId, onenoteSectionId, onenotePageId) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string, object, object>(async (sectionGroupId, onenoteSectionId, onenotePageId, select, expand) => {
        ...
        public Command BuildPatchCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string, string>(async (sectionGroupId, onenoteSectionId, onenotePageId, body) => {
