...
namespace ApiSdk.Me.Onenote.Notebooks.GetRecentNotebooksWithIncludePersonalNotebooks {
    ...
    public class GetRecentNotebooksWithIncludePersonalNotebooksRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (bool? includePersonalNotebooks, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, includePersonalNotebooksOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
