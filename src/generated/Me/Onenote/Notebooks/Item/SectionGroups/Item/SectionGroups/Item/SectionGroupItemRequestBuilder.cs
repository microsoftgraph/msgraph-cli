...
namespace ApiSdk.Me.Onenote.Notebooks.Item.SectionGroups.Item.SectionGroups.Item {
    ...
    public class SectionGroupItemRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(notebookIdOption, sectionGroupIdOption, sectionGroupId1Option, selectOption, expandOption, outputOption, queryOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// The section groups in the section. Read-only. Nullable.
