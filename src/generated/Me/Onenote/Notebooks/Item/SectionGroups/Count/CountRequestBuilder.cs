...
namespace ApiSdk.Me.Onenote.Notebooks.Item.SectionGroups.Count {
    /// <summary>
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters) {
            ...
            UrlTemplate = "{+baseurl}/me/onenote/notebooks/{notebook%2Did}/sectionGroups/$count{?%24search,%24filter}";
