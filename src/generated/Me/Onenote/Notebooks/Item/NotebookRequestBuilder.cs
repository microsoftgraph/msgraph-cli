...
namespace ApiSdk.Me.Onenote.Notebooks.Item {
    ...
    public class NotebookRequestBuilder {
        ...
        public Command BuildCopyNotebookCommand() {
            ...
            var builder = new ApiSdk.Me.Onenote.Notebooks.Item.CopyNotebook.CopyNotebookRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string notebookId, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                var requestInfo = CreateDeleteRequestInformation(q => {
                });
                await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                console.WriteLine("Success");
            }, notebookIdOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// The collection of OneNote notebooks that are owned by the user or group. Read-only. Nullable.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string notebookId, string[] select, string[] expand, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
            ...
            }, notebookIdOption, selectOption, expandOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// The collection of OneNote notebooks that are owned by the user or group. Read-only. Nullable.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string notebookId, string body, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                ...
                await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                console.WriteLine("Success");
            }, notebookIdOption, bodyOption, new OutputFormatterFactoryBinder());
            return command;
        }
        public Command BuildSectionGroupsCommand() {
            var command = new Command("section-groups");
            var builder = new ApiSdk.Me.Onenote.Notebooks.Item.SectionGroups.SectionGroupsRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildSectionsCommand() {
            ...
            var builder = new ApiSdk.Me.Onenote.Notebooks.Item.Sections.SectionsRequestBuilder(PathParameters, RequestAdapter);
            foreach (var cmd in builder.BuildCommand()) {
                command.AddCommand(cmd);
            }
            command.AddCommand(builder.BuildCreateCommand());
