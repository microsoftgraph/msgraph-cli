...
namespace ApiSdk.Me.Onenote.Notebooks.Item.Sections.Item.ParentSectionGroup.SectionGroups {
    ...
    public class SectionGroupsRequestBuilder {
        ...
        public Command BuildCreateCommand() {
            ...
            }, new CollectionBinding(notebookIdOption, onenoteSectionIdOption, bodyOption, outputOption, outputFilterOption, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// The section groups in the section. Read-only. Nullable.
        ...
        public Command BuildListCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                var formatter = outputFormatterFactory.GetFormatter(output);
                formatter.WriteOutput(response);
            }, new CollectionBinding(notebookIdOption, onenoteSectionIdOption, topOption, skipOption, searchOption, filterOption, countOption, orderbyOption, selectOption, expandOption, outputOption, outputFilterOption, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
