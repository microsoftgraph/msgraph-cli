...
namespace ApiSdk.Me.Onenote.Notebooks.Item.Sections.Item.Pages.Item {
    ...
    public class OnenotePageRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string notebookId, string onenoteSectionId, string onenotePageId, string[] select, string[] expand) => {
            ...
            }, notebookIdOption, onenoteSectionIdOption, onenotePageIdOption, selectOption, expandOption);
            return command;
        }
