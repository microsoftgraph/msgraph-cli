...
namespace ApiSdk.Me.Onenote.Notebooks.Item.Sections.Item.ParentSectionGroup.SectionGroups.Item {
    ...
    public class SectionGroupRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string>(async (notebookId, onenoteSectionId, sectionGroupId) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string, string[], string[]>(async (notebookId, onenoteSectionId, sectionGroupId, select, expand) => {
        ...
        public Command BuildPatchCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string, string>(async (notebookId, onenoteSectionId, sectionGroupId, body) => {
