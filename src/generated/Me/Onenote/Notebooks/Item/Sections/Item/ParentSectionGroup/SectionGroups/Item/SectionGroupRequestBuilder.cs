...
namespace ApiSdk.Me.Onenote.Notebooks.Item.Sections.Item.ParentSectionGroup.SectionGroups.Item {
    ...
    public class SectionGroupRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string notebookId, string onenoteSectionId, string sectionGroupId) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string notebookId, string onenoteSectionId, string sectionGroupId, string[] select, string[] expand) => {
            ...
            }, notebookIdOption, onenoteSectionIdOption, sectionGroupIdOption, selectOption, expandOption);
            return command;
        }
        /// <summary>
        /// The section groups in the section. Read-only. Nullable.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string notebookId, string onenoteSectionId, string sectionGroupId, string body) => {
