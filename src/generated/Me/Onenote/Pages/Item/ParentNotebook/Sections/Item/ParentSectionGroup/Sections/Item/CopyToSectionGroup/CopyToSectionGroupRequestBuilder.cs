...
namespace ApiSdk.Me.Onenote.Pages.Item.ParentNotebook.Sections.Item.ParentSectionGroup.Sections.Item.CopyToSectionGroup {
    ...
    public class CopyToSectionGroupRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (string onenotePageId, string onenoteSectionId, string onenoteSectionId1, string body, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, onenotePageIdOption, onenoteSectionIdOption, onenoteSectionId1Option, bodyOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
