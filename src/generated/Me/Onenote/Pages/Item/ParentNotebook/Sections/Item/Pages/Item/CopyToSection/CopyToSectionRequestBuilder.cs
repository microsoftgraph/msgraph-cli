...
namespace ApiSdk.Me.Onenote.Pages.Item.ParentNotebook.Sections.Item.Pages.Item.CopyToSection {
    ...
    public class CopyToSectionRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (string onenotePageId, string onenoteSectionId, string onenotePageId1, string body, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, onenotePageIdOption, onenoteSectionIdOption, onenotePageId1Option, bodyOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
