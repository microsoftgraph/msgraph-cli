...
namespace ApiSdk.Me.Onenote.Pages.Item.ParentNotebook.Sections.Item.Pages.Item.CopyToSection {
    ...
    public class CopyToSectionRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (string onenotePageId, string onenoteSectionId, string onenotePageId1, string body, FormatterType output, IOutputFormatterFactory outputFormatterFactory, CancellationToken cancellationToken) => {
            ...
            }, onenotePageIdOption, onenoteSectionIdOption, onenotePageId1Option, bodyOption, outputOption);
            return command;
        }
        /// <summary>
