...
namespace ApiSdk.Me.Onenote.Pages.Item.ParentNotebook.Sections.Item.ParentSectionGroup.SectionGroups.Item {
    ...
    public class SectionGroupRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string>(async (onenotePageId, onenoteSectionId, sectionGroupId) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string, object, object>(async (onenotePageId, onenoteSectionId, sectionGroupId, select, expand) => {
        ...
        public Command BuildPatchCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string, string>(async (onenotePageId, onenoteSectionId, sectionGroupId, body) => {
