...
namespace ApiSdk.Me.Onenote.Pages.Item.ParentSection.Pages.Item {
    ...
    public class OnenotePageRequestBuilder {
        ...
        public Command BuildContentCommand() {
            ...
            var builder = new ApiSdk.Me.Onenote.Pages.Item.ParentSection.Pages.Item.Content.ContentRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildCopyToSectionCommand() {
            ...
            var builder = new ApiSdk.Me.Onenote.Pages.Item.ParentSection.Pages.Item.CopyToSection.CopyToSectionRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string onenotePageId, string onenotePageId1, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                var requestInfo = CreateDeleteRequestInformation(q => {
                });
                await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                console.WriteLine("Success");
            }, onenotePageIdOption, onenotePageId1Option, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// The collection of pages in the section.  Read-only. Nullable.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string onenotePageId, string onenotePageId1, string[] select, string[] expand, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
            ...
            }, onenotePageIdOption, onenotePageId1Option, selectOption, expandOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        public Command BuildOnenotePatchContentCommand() {
            var command = new Command("onenote-patch-content");
            var builder = new ApiSdk.Me.Onenote.Pages.Item.ParentSection.Pages.Item.OnenotePatchContent.OnenotePatchContentRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildPostCommand());
            return command;
        }
        /// <summary>
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string onenotePageId, string onenotePageId1, string body, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                ...
                await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                console.WriteLine("Success");
            }, onenotePageIdOption, onenotePageId1Option, bodyOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
