...
namespace ApiSdk.Me.Onenote.Pages.Item.ParentSection.Pages.Item.Content {
    ...
    public class ContentRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string onenotePageId, string onenotePageId1, FileInfo file, FormatterType output, IConsole console) => {
        ...
        public Command BuildPutCommand() {
            ...
            command.SetHandler(async (string onenotePageId, string onenotePageId1, FileInfo file, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
