...
namespace ApiSdk.Me.Onenote.Pages.Item.ParentSection {
    ...
    public class ParentSectionRequestBuilder {
        ...
        public Command BuildCopyToNotebookCommand() {
            ...
            var builder = new ApiSdk.Me.Onenote.Pages.Item.ParentSection.CopyToNotebook.CopyToNotebookRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildPostCommand());
            return command;
        }
        public Command BuildCopyToSectionGroupCommand() {
            var command = new Command("copy-to-section-group");
            var builder = new ApiSdk.Me.Onenote.Pages.Item.ParentSection.CopyToSectionGroup.CopyToSectionGroupRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildPostCommand());
            return command;
        }
        /// <summary>
        ...
        public Command BuildPagesCommand() {
            ...
            var builder = new ApiSdk.Me.Onenote.Pages.Item.ParentSection.Pages.PagesRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildParentNotebookCommand() {
            ...
            var builder = new ApiSdk.Me.Onenote.Pages.Item.ParentSection.ParentNotebook.ParentNotebookRequestBuilder(PathParameters, RequestAdapter);
