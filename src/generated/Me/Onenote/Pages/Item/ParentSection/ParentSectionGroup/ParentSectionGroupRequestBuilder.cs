...
namespace ApiSdk.Me.Onenote.Pages.Item.ParentSection.ParentSectionGroup {
    ...
    public class ParentSectionGroupRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string onenotePageId) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string onenotePageId, string[] select, string[] expand) => {
            ...
            }, onenotePageIdOption, selectOption, expandOption);
            return command;
        }
        ...
        public Command BuildParentSectionGroupCommand() {
            ...
            var builder = new ApiSdk.Me.Onenote.Pages.Item.ParentSection.ParentSectionGroup.ParentSectionGroupRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildDeleteCommand());
            command.AddCommand(builder.BuildGetCommand());
