...
namespace ApiSdk.Me.Onenote.Pages.Item.Preview {
    ...
    public class PreviewRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string onenotePageId, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, onenotePageIdOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
