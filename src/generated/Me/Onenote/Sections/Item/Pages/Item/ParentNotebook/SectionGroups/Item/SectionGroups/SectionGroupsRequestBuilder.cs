...
namespace ApiSdk.Me.Onenote.Sections.Item.Pages.Item.ParentNotebook.SectionGroups.Item.SectionGroups {
    ...
    public class SectionGroupsRequestBuilder {
        ...
        public Command BuildListCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string, int?, int?, string, string, bool?, object, object, object>(async (onenoteSectionId, onenotePageId, sectionGroupId, top, skip, search, filter, count, orderby, select, expand) => {
