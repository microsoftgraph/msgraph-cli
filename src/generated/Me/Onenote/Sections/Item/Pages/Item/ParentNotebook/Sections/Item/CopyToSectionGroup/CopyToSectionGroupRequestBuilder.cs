...
namespace ApiSdk.Me.Onenote.Sections.Item.Pages.Item.ParentNotebook.Sections.Item.CopyToSectionGroup {
    ...
    public class CopyToSectionGroupRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (string onenoteSectionId, string onenotePageId, string onenoteSectionId1, string body, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
            ...
            }, onenoteSectionIdOption, onenotePageIdOption, onenoteSectionId1Option, bodyOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
