...
namespace ApiSdk.Me.Onenote.Sections.Item.Pages.Item.Content {
    ...
    public class ContentRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, FileInfo>(async (onenoteSectionId, onenotePageId, output) => {
        ...
        public Command BuildPutCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, FileInfo>(async (onenoteSectionId, onenotePageId, file) => {
