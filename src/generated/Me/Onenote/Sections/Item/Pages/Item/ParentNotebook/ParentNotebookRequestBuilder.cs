...
namespace ApiSdk.Me.Onenote.Sections.Item.Pages.Item.ParentNotebook {
    ...
    public class ParentNotebookRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string onenoteSectionId, string onenotePageId, IConsole console) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string onenoteSectionId, string onenotePageId, string[] select, string[] expand, FormatterType output, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string onenoteSectionId, string onenotePageId, string body, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
