...
namespace ApiSdk.Me.Onenote.Sections.Item.ParentNotebook.SectionGroups.Item.SectionGroups {
    ...
    public class SectionGroupsRequestBuilder {
        ...
        public Command BuildCreateCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string>(async (onenoteSectionId, sectionGroupId, body) => {
        ...
        public Command BuildListCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, int?, int?, string, string, bool?, object, object, object>(async (onenoteSectionId, sectionGroupId, top, skip, search, filter, count, orderby, select, expand) => {
