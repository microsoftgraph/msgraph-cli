...
namespace ApiSdk.Me.Outlook.MasterCategories.Item {
    ...
    public class OutlookCategoryRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string outlookCategoryId, IOutputFormatterFactory outputFormatterFactory, CancellationToken cancellationToken) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string outlookCategoryId, string[] select, FormatterType output, IOutputFormatterFactory outputFormatterFactory, CancellationToken cancellationToken) => {
            ...
            }, outlookCategoryIdOption, selectOption, outputOption);
            return command;
        }
        /// <summary>
        /// A list of categories defined for the user.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string outlookCategoryId, string body, IOutputFormatterFactory outputFormatterFactory, CancellationToken cancellationToken) => {
