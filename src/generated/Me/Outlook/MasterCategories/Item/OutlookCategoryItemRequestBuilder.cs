...
namespace ApiSdk.Me.Outlook.MasterCategories.Item {
    ...
    public class OutlookCategoryItemRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            }, new CollectionBinding(outlookCategoryIdOption, new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// A list of categories defined for the user.
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(outlookCategoryIdOption, selectOption, outputOption, queryOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// A list of categories defined for the user.
