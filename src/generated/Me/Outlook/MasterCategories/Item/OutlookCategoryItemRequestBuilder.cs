...
namespace ApiSdk.Me.Outlook.MasterCategories.Item {
    ...
    public class OutlookCategoryItemRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(outlookCategoryIdOption, selectOption, outputOption, outputFilterOption, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// A list of categories defined for the user.
