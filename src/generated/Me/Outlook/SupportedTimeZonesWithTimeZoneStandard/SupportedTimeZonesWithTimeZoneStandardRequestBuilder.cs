...
namespace ApiSdk.Me.Outlook.SupportedTimeZonesWithTimeZoneStandard {
    ...
    public class SupportedTimeZonesWithTimeZoneStandardRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (object TimeZoneStandard, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, TimeZoneStandardOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
