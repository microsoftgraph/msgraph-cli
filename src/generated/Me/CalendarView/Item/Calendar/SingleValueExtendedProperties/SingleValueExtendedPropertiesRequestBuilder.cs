...
namespace ApiSdk.Me.CalendarView.Item.Calendar.SingleValueExtendedProperties {
    ...
    public class SingleValueExtendedPropertiesRequestBuilder {
        ...
        public Command BuildListCommand() {
            ...
            command.Handler = CommandHandler.Create<string, int?, int?, string, string, bool?, string[], string[], string[]>(async (eventId, top, skip, search, filter, count, orderby, select, expand) => {
