...
namespace ApiSdk.Me.CalendarView.Item.Calendar.CalendarPermissions.Item {
    ...
    public class CalendarPermissionRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string eventId, string calendarPermissionId, IConsole console) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string eventId, string calendarPermissionId, string[] select, FormatterType output, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string eventId, string calendarPermissionId, string body, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
