...
namespace ApiSdk.Me.CalendarView.Item.Attachments.CreateUploadSession {
    ...
    public class CreateUploadSessionRequestBody : IAdditionalDataHolder, IParsable {
        ...
        /// </summary>
        public static ApiSdk.Me.CalendarView.Item.Attachments.CreateUploadSession.CreateUploadSessionRequestBody CreateFromDiscriminatorValue(IParseNode parseNode) {
