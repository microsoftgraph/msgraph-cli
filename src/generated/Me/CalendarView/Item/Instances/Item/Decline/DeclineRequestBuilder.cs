    ...
    public class DeclineRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Me.CalendarView.Item.Instances.Item.Decline.DeclineRequestBody>(ApiSdk.Me.CalendarView.Item.Instances.Item.Decline.DeclineRequestBody.CreateFromDiscriminatorValue);
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ApiSdk.Me.CalendarView.Item.Instances.Item.Decline.DeclineRequestBody body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
