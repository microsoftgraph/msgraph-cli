...
namespace ApiSdk.Me.Presence.SetUserPreferredPresence {
    /// <summary>
    ...
    public class SetUserPreferredPresenceRequestBuilder {
        ...
        public SetUserPreferredPresenceRequestBuilder(Dictionary<string, object> pathParameters) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            UrlTemplate = "{+baseurl}/me/presence/setUserPreferredPresence";
