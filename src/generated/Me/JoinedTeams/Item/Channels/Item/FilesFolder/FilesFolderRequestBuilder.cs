using ApiSdk.Me.JoinedTeams.Item.Channels.Item.FilesFolder.Content;
using ApiSdk.Models;
...
namespace ApiSdk.Me.JoinedTeams.Item.Channels.Item.FilesFolder {
    /// <summary>
    ...
    public class FilesFolderRequestBuilder {
        ...
        public FilesFolderRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedTeams/{team%2Did}/channels/{channel%2Did}/filesFolder{?%24select,%24expand}";
