using ApiSdk.Me.JoinedTeams.Item.Channels.Item.SharedWithTeams.Count;
using ApiSdk.Me.JoinedTeams.Item.Channels.Item.SharedWithTeams.Item;
using ApiSdk.Models;
...
namespace ApiSdk.Me.JoinedTeams.Item.Channels.Item.SharedWithTeams {
    /// <summary>
    ...
    public class SharedWithTeamsRequestBuilder {
        ...
        public Command BuildCommand() {
            ...
            var builder = new SharedWithChannelTeamInfoItemRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildAllowedMembersCommand());
        ...
        public Command BuildCreateCommand() {
            ...
            command.Description = "Create new navigation property to sharedWithTeams for me";
        ...
        public SharedWithTeamsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedTeams/{team%2Did}/channels/{channel%2Did}/sharedWithTeams{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
