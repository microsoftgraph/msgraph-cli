using ApiSdk.Me.JoinedTeams.Item.Channels.Item.SharedWithTeams.Item.AllowedMembers;
using ApiSdk.Models;
...
namespace ApiSdk.Me.JoinedTeams.Item.Channels.Item.SharedWithTeams.Item {
    /// <summary>
    ...
    public class SharedWithChannelTeamInfoItemRequestBuilder {
        ...
        public Command BuildAllowedMembersCommand() {
            ...
            var builder = new AllowedMembersRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildDeleteCommand() {
            ...
            command.Description = "Delete navigation property sharedWithTeams for me";
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                requestInfo.PathParameters.Add("sharedWithChannelTeamInfo%2Did", sharedWithChannelTeamInfoId);
        ...
        public Command BuildPatchCommand() {
            ...
            command.Description = "Update the navigation property sharedWithTeams in me";
            // Create options for all the parameters
            var teamIdOption = new Option<string>("--team-id", description: "key: id of team") {
            };
            teamIdOption.IsRequired = true;
