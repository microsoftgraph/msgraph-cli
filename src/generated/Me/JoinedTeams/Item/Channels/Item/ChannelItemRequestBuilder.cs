using ApiSdk.Me.JoinedTeams.Item.Channels.Item.FilesFolder;
using ApiSdk.Me.JoinedTeams.Item.Channels.Item.Members;
using ApiSdk.Me.JoinedTeams.Item.Channels.Item.Messages;
using ApiSdk.Me.JoinedTeams.Item.Channels.Item.MicrosoftGraphCompleteMigration;
using ApiSdk.Me.JoinedTeams.Item.Channels.Item.MicrosoftGraphDoesUserHaveAccessuserIdUserIdTenantIdTenantIdUserPrincipalNameUserPrincipalName;
using ApiSdk.Me.JoinedTeams.Item.Channels.Item.MicrosoftGraphProvisionEmail;
using ApiSdk.Me.JoinedTeams.Item.Channels.Item.MicrosoftGraphRemoveEmail;
using ApiSdk.Me.JoinedTeams.Item.Channels.Item.SharedWithTeams;
using ApiSdk.Me.JoinedTeams.Item.Channels.Item.Tabs;
using ApiSdk.Models;
...
namespace ApiSdk.Me.JoinedTeams.Item.Channels.Item {
    /// <summary>
    ...
    public class ChannelItemRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.Description = "Delete navigation property channels for me";
        ...
        public Command BuildPatchCommand() {
            ...
            command.Description = "Update the navigation property channels in me";
            // Create options for all the parameters
            var teamIdOption = new Option<string>("--team-id", description: "key: id of team") {
            };
            teamIdOption.IsRequired = true;
