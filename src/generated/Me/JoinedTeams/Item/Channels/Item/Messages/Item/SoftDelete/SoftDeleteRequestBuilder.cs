...
namespace ApiSdk.Me.JoinedTeams.Item.Channels.Item.Messages.Item.SoftDelete {
    /// <summary>
    ...
    public class SoftDeleteRequestBuilder {
        ...
        public SoftDeleteRequestBuilder(Dictionary<string, object> pathParameters) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedTeams/{team%2Did}/channels/{channel%2Did}/messages/{chatMessage%2Did}/softDelete";
