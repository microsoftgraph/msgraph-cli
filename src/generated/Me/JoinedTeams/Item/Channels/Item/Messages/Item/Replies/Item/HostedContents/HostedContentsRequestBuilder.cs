using ApiSdk.Me.JoinedTeams.Item.Channels.Item.Messages.Item.Replies.Item.HostedContents.Count;
using ApiSdk.Me.JoinedTeams.Item.Channels.Item.Messages.Item.Replies.Item.HostedContents.Item;
...
namespace ApiSdk.Me.JoinedTeams.Item.Channels.Item.Messages.Item.Replies.Item.HostedContents {
    ...
    public class HostedContentsRequestBuilder {
        ...
        public Command BuildCreateCommand() {
            ...
            }, new CollectionBinding(teamIdOption, channelIdOption, chatMessageIdOption, chatMessageId1Option, bodyOption, outputOption, queryOption, jsonNoIndentOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
