using ApiSdk.Me.JoinedTeams.Item.Channels.Item.Messages.Count;
using ApiSdk.Me.JoinedTeams.Item.Channels.Item.Messages.Delta;
using ApiSdk.Me.JoinedTeams.Item.Channels.Item.Messages.Item;
...
namespace ApiSdk.Me.JoinedTeams.Item.Channels.Item.Messages {
    ...
    public class MessagesRequestBuilder {
        ...
        public Command BuildCreateCommand() {
            ...
            }, new CollectionBinding(teamIdOption, channelIdOption, bodyOption, outputOption, queryOption, jsonNoIndentOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
