using ApiSdk.Me.JoinedTeams.Item.Channels.Item.Tabs.Item.TeamsApp;
using ApiSdk.Models;
...
namespace ApiSdk.Me.JoinedTeams.Item.Channels.Item.Tabs.Item {
    ...
    public class TeamsTabItemRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.Description = "Delete navigation property tabs for me";
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                requestInfo.PathParameters.Add("teamsTab%2Did", teamsTabId);
            ...
            }, new CollectionBinding(teamIdOption, channelIdOption, teamsTabIdOption, ifMatchOption, new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(teamIdOption, channelIdOption, teamsTabIdOption, selectOption, expandOption, outputOption, queryOption, jsonNoIndentOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        ...
        public Command BuildPatchCommand() {
            ...
            command.Description = "Update the navigation property tabs in me";
            // Create options for all the parameters
            var teamIdOption = new Option<string>("--team-id", description: "key: id of team") {
            };
            teamIdOption.IsRequired = true;
        ...
        public Command BuildTeamsAppCommand() {
            ...
            var builder = new TeamsAppRequestBuilder(PathParameters, RequestAdapter);
        ...
        public TeamsTabItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedTeams/{team%2Did}/channels/{channel%2Did}/tabs/{teamsTab%2Did}{?%24select,%24expand}";
