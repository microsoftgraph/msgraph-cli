using ApiSdk.Me.JoinedTeams.Item.AllChannels.Count;
using ApiSdk.Me.JoinedTeams.Item.AllChannels.Item;
using ApiSdk.Models;
...
namespace ApiSdk.Me.JoinedTeams.Item.AllChannels {
    /// <summary>
    ...
    public class AllChannelsRequestBuilder {
        ...
        public AllChannelsRequestBuilder(Dictionary<string, object> pathParameters) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            UrlTemplate = "{+baseurl}/me/joinedTeams/{team%2Did}/allChannels{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
