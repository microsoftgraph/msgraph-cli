using ApiSdk.Me.JoinedTeams.Item.Operations.Count;
using ApiSdk.Me.JoinedTeams.Item.Operations.Item;
using ApiSdk.Models;
...
namespace ApiSdk.Me.JoinedTeams.Item.Operations {
    ...
    public class OperationsRequestBuilder {
        ...
        public Command BuildCommand() {
            ...
            var builder = new TeamsAsyncOperationItemRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildCreateCommand() {
            ...
            command.Description = "Create new navigation property to operations for me";
