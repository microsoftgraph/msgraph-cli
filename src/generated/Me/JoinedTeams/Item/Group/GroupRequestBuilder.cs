...
namespace ApiSdk.Me.JoinedTeams.Item.Group {
    /// <summary>
    ...
    public class GroupRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.Description = "Get group from me";
        ...
        public GroupRequestBuilder(Dictionary<string, object> pathParameters) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            UrlTemplate = "{+baseurl}/me/joinedTeams/{team%2Did}/group{?%24select,%24expand}";
