using ApiSdk.Me.JoinedTeams.Item.PrimaryChannel.SharedWithTeams.Count;
using ApiSdk.Me.JoinedTeams.Item.PrimaryChannel.SharedWithTeams.Item;
using ApiSdk.Models;
...
namespace ApiSdk.Me.JoinedTeams.Item.PrimaryChannel.SharedWithTeams {
    /// <summary>
