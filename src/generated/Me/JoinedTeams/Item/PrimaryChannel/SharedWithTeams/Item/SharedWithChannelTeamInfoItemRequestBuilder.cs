using ApiSdk.Me.JoinedTeams.Item.PrimaryChannel.SharedWithTeams.Item.AllowedMembers;
using ApiSdk.Models;
...
namespace ApiSdk.Me.JoinedTeams.Item.PrimaryChannel.SharedWithTeams.Item {
    /// <summary>
