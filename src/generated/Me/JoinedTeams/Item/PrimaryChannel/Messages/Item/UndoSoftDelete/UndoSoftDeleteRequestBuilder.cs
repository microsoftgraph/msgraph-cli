...
namespace ApiSdk.Me.JoinedTeams.Item.PrimaryChannel.Messages.Item.UndoSoftDelete {
    /// <summary>
    ...
    public class UndoSoftDeleteRequestBuilder {
        ...
        public UndoSoftDeleteRequestBuilder(Dictionary<string, object> pathParameters) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedTeams/{team%2Did}/primaryChannel/messages/{chatMessage%2Did}/undoSoftDelete";
