using ApiSdk.Me.JoinedTeams.Item.PrimaryChannel.Messages.Item.Replies.Count;
using ApiSdk.Me.JoinedTeams.Item.PrimaryChannel.Messages.Item.Replies.Delta;
using ApiSdk.Me.JoinedTeams.Item.PrimaryChannel.Messages.Item.Replies.Item;
...
namespace ApiSdk.Me.JoinedTeams.Item.PrimaryChannel.Messages.Item.Replies {
    ...
    public class RepliesRequestBuilder {
        ...
        public List<Command> BuildCommand() {
            var builder = new ApiSdk.Me.JoinedTeams.Item.PrimaryChannel.Messages.Item.Replies.Item.ChatMessageItemRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildCreateCommand() {
            ...
            command.Description = "Create new navigation property to replies for me";
        ...
        public RepliesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedTeams/{team_id}/primaryChannel/messages/{chatMessage_id}/replies{?top,skip,search,filter,count,orderby,select,expand}";
