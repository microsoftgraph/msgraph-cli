...
namespace ApiSdk.Me.JoinedTeams.Item.PrimaryChannel.Messages.Item.Replies.Item {
    ...
    public class ChatMessageItemRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            }, new CollectionBinding(teamIdOption, chatMessageIdOption, chatMessageId1Option, new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        ...
        public ChatMessageItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedTeams/{team_id}/primaryChannel/messages/{chatMessage_id}/replies/{chatMessage_id1}{?select,expand}";
