using ApiSdk.Me.JoinedTeams.Item.PrimaryChannel.Messages.Count;
using ApiSdk.Me.JoinedTeams.Item.PrimaryChannel.Messages.Delta;
using ApiSdk.Me.JoinedTeams.Item.PrimaryChannel.Messages.Item;
using ApiSdk.Models;
...
namespace ApiSdk.Me.JoinedTeams.Item.PrimaryChannel.Messages {
    ...
    public class MessagesRequestBuilder {
        ...
        public List<Command> BuildCommand() {
            var builder = new ChatMessageItemRequestBuilder(PathParameters, RequestAdapter);
        ...
        public MessagesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedTeams/{team%2Did}/primaryChannel/messages{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
