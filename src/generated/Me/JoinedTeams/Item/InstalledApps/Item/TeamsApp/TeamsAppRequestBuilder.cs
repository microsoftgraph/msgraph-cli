...
namespace ApiSdk.Me.JoinedTeams.Item.InstalledApps.Item.TeamsApp {
    /// <summary>
    ...
    public class TeamsAppRequestBuilder {
        ...
        public TeamsAppRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedTeams/{team%2Did}/installedApps/{teamsAppInstallation%2Did}/teamsApp{?%24select,%24expand}";
