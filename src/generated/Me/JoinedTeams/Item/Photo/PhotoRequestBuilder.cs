using ApiSdk.Me.JoinedTeams.Item.Photo.Value;
using ApiSdk.Models;
...
namespace ApiSdk.Me.JoinedTeams.Item.Photo {
    /// <summary>
    ...
    public class PhotoRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.Description = "Delete navigation property photo for me";
        ...
        public PhotoRequestBuilder(Dictionary<string, object> pathParameters) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            UrlTemplate = "{+baseurl}/me/joinedTeams/{team%2Did}/photo{?%24select,%24expand}";
