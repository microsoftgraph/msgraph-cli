using ApiSdk.Me.JoinedTeams.Item.Schedule.SwapShiftsChangeRequests.Count;
using ApiSdk.Me.JoinedTeams.Item.Schedule.SwapShiftsChangeRequests.Item;
using ApiSdk.Models;
...
namespace ApiSdk.Me.JoinedTeams.Item.Schedule.SwapShiftsChangeRequests {
    ...
    public class SwapShiftsChangeRequestsRequestBuilder {
        ...
        public List<Command> BuildCommand() {
            var builder = new SwapShiftsChangeRequestItemRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildCreateCommand() {
            ...
            command.Description = "Create new navigation property to swapShiftsChangeRequests for me";
        ...
        public Command BuildListCommand() {
            ...
            command.Description = "Get swapShiftsChangeRequests from me";
            // Create options for all the parameters
            var teamIdOption = new Option<string>("--team-id", description: "key: id of team") {
            };
            teamIdOption.IsRequired = true;
        ...
        public SwapShiftsChangeRequestsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedTeams/{team%2Did}/schedule/swapShiftsChangeRequests{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
