using ApiSdk.Me.JoinedTeams.Item.Schedule.TimesOff.Count;
using ApiSdk.Me.JoinedTeams.Item.Schedule.TimesOff.Item;
using ApiSdk.Models;
...
namespace ApiSdk.Me.JoinedTeams.Item.Schedule.TimesOff {
    ...
    public class TimesOffRequestBuilder {
        ...
        public Command BuildCommand() {
            ...
            var builder = new TimeOffItemRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildCreateCommand() {
            ...
            command.Description = "Create new navigation property to timesOff for me";
