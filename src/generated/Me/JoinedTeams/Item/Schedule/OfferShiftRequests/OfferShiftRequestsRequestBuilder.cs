using ApiSdk.Me.JoinedTeams.Item.Schedule.OfferShiftRequests.Count;
using ApiSdk.Me.JoinedTeams.Item.Schedule.OfferShiftRequests.Item;
using ApiSdk.Models;
...
namespace ApiSdk.Me.JoinedTeams.Item.Schedule.OfferShiftRequests {
    ...
    public class OfferShiftRequestsRequestBuilder {
        ...
        public List<Command> BuildCommand() {
            var builder = new OfferShiftRequestItemRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildCreateCommand() {
            ...
            command.Description = "Create new navigation property to offerShiftRequests for me";
        ...
        public Command BuildListCommand() {
            ...
            command.Description = "Get offerShiftRequests from me";
            // Create options for all the parameters
            var teamIdOption = new Option<string>("--team-id", description: "key: id of team") {
            };
            teamIdOption.IsRequired = true;
