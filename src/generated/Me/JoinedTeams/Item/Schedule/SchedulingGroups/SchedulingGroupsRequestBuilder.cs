using ApiSdk.Me.JoinedTeams.Item.Schedule.SchedulingGroups.Count;
using ApiSdk.Me.JoinedTeams.Item.Schedule.SchedulingGroups.Item;
using ApiSdk.Models;
...
namespace ApiSdk.Me.JoinedTeams.Item.Schedule.SchedulingGroups {
    ...
    public class SchedulingGroupsRequestBuilder {
        ...
        public List<Command> BuildCommand() {
            var builder = new SchedulingGroupItemRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildCreateCommand() {
            ...
            command.Description = "Create new navigation property to schedulingGroups for me";
            ...
            }, new CollectionBinding(teamIdOption, bodyOption, outputOption, queryOption, jsonNoIndentOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        ...
        public Command BuildListCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                var formatter = outputFormatterFactory.GetFormatter(output);
                await formatter.WriteOutputAsync(response, formatterOptions, cancellationToken);
            }, new CollectionBinding(teamIdOption, topOption, skipOption, searchOption, filterOption, countOption, orderbyOption, selectOption, outputOption, queryOption, jsonNoIndentOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
