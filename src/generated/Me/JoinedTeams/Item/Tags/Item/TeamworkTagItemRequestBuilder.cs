using ApiSdk.Me.JoinedTeams.Item.Tags.Item.Members;
using ApiSdk.Models;
...
namespace ApiSdk.Me.JoinedTeams.Item.Tags.Item {
    /// <summary>
    ...
    public class TeamworkTagItemRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.Description = "Delete navigation property tags for me";
        ...
        public Command BuildPatchCommand() {
            ...
            command.Description = "Update the navigation property tags in me";
            // Create options for all the parameters
            var teamIdOption = new Option<string>("--team-id", description: "The unique identifier of team") {
            };
            teamIdOption.IsRequired = true;
        ...
        public TeamworkTagItemRequestBuilder(Dictionary<string, object> pathParameters) {
