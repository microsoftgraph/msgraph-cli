using ApiSdk.Me.JoinedTeams.Item.Tags.Item.Members.Count;
using ApiSdk.Me.JoinedTeams.Item.Tags.Item.Members.Item;
using ApiSdk.Models;
...
namespace ApiSdk.Me.JoinedTeams.Item.Tags.Item.Members {
    ...
    public class MembersRequestBuilder {
        ...
        public Command BuildCommand() {
            ...
            var builder = new TeamworkTagMemberItemRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildListCommand() {
            ...
            command.Description = "Get members from me";
            // Create options for all the parameters
            var teamIdOption = new Option<string>("--team-id", description: "key: id of team") {
            };
            teamIdOption.IsRequired = true;
        ...
        public MembersRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/joinedTeams/{team%2Did}/tags/{teamworkTag%2Did}/members{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
