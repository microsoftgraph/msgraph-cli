using ApiSdk.Me.MemberOf.MicrosoftGraphOrgContact.Count;
using ApiSdk.Models;
...
namespace ApiSdk.Me.MemberOf.MicrosoftGraphOrgContact {
    /// <summary>
    ...
    public class OrgContactRequestBuilder {
        ...
        public OrgContactRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/memberOf/microsoft.graph.orgContact{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
