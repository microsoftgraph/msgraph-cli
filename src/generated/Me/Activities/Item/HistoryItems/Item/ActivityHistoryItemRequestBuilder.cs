...
namespace ApiSdk.Me.Activities.Item.HistoryItems.Item {
    ...
    public class ActivityHistoryItemRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            }, userActivityIdOption, activityHistoryItemIdOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// Optional. NavigationProperty/Containment; navigation property to the activity's historyItems.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string userActivityId, string activityHistoryItemId, string[] select, string[] expand, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
            ...
            }, userActivityIdOption, activityHistoryItemIdOption, selectOption, expandOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// Optional. NavigationProperty/Containment; navigation property to the activity's historyItems.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string userActivityId, string activityHistoryItemId, string body, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                ...
                await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                console.WriteLine("Success");
            }, userActivityIdOption, activityHistoryItemIdOption, bodyOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
