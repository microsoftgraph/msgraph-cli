using ApiSdk.Me.OwnedDevices.GraphAppRoleAssignment.Count;
using ApiSdk.Models;
...
namespace ApiSdk.Me.OwnedDevices.GraphAppRoleAssignment {
    /// <summary>
    ...
    public class GraphAppRoleAssignmentRequestBuilder {
        ...
        public GraphAppRoleAssignmentRequestBuilder(Dictionary<string, object> pathParameters) {
            ...
            UrlTemplate = "{+baseurl}/me/ownedDevices/graph.appRoleAssignment{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
