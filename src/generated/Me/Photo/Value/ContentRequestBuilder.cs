...
namespace ApiSdk.Me.Photo.Value {
    ...
    public class ContentRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (FileInfo file, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
            ...
            }, fileOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// The user's profile photo. Read-only.
        ...
        public Command BuildPutCommand() {
            ...
            command.SetHandler(async (FileInfo file, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
