using ApiSdk.Me.OwnedObjects.GraphGroup.Count;
using ApiSdk.Models;
...
namespace ApiSdk.Me.OwnedObjects.GraphGroup {
    /// <summary>
    ...
    public class GraphGroupRequestBuilder {
        ...
        public GraphGroupRequestBuilder(Dictionary<string, object> pathParameters) {
            ...
            UrlTemplate = "{+baseurl}/me/ownedObjects/graph.group{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
