...
namespace ApiSdk.Me.Extensions.Item {
    ...
    public class ExtensionRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string extensionId) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string extensionId, string[] select, string[] expand) => {
            ...
            }, extensionIdOption, selectOption, expandOption);
            return command;
        }
        /// <summary>
        /// The collection of open extensions defined for the user. Nullable.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string extensionId, string body) => {
