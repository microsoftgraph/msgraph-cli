using ApiSdk.Me.CreatedObjects.GraphServicePrincipal.Count;
using ApiSdk.Models;
...
namespace ApiSdk.Me.CreatedObjects.GraphServicePrincipal {
    /// <summary>
    ...
    public class GraphServicePrincipalRequestBuilder {
        ...
        public GraphServicePrincipalRequestBuilder(Dictionary<string, object> pathParameters) {
            ...
            UrlTemplate = "{+baseurl}/me/createdObjects/graph.servicePrincipal{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
