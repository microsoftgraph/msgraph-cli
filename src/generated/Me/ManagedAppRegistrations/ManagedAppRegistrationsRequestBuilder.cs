using ApiSdk.Me.ManagedAppRegistrations.Count;
using ApiSdk.Me.ManagedAppRegistrations.Item;
using ApiSdk.Models;
...
namespace ApiSdk.Me.ManagedAppRegistrations {
    ...
    public class ManagedAppRegistrationsRequestBuilder {
        ...
        public ManagedAppRegistrationsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/me/managedAppRegistrations{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
        ...
        /// </summary>
        public RequestInformation CreateGetRequestInformation(Action<ManagedAppRegistrationsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
