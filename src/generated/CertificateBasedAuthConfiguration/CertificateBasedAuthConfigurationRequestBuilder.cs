...
namespace ApiSdk.CertificateBasedAuthConfiguration {
    ...
    public class CertificateBasedAuthConfigurationRequestBuilder {
        ...
        public CertificateBasedAuthConfigurationRequestBuilder(Dictionary<string, object> pathParameters) {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(ApiSdk.Models.CertificateBasedAuthConfiguration body, Action<CertificateBasedAuthConfigurationRequestBuilderPostRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(ApiSdk.Models.CertificateBasedAuthConfiguration body, Action<CertificateBasedAuthConfigurationRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
#endif
