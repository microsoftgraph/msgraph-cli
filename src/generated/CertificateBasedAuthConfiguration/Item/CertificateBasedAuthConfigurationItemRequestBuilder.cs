...
namespace ApiSdk.CertificateBasedAuthConfiguration.Item {
    ...
    public class CertificateBasedAuthConfigurationItemRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            var certificateBasedAuthConfigurationItemIdOption = new Option<string>("--certificatebasedauthconfigurationitem-id", description: "key: id of certificateBasedAuthConfiguration") {
            };
            ...
            command.SetHandler(async (string certificateBasedAuthConfigurationItemId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, certificateBasedAuthConfigurationItemIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string certificateBasedAuthConfigurationItemId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, certificateBasedAuthConfigurationItemIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string certificateBasedAuthConfigurationItemId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, certificateBasedAuthConfigurationItemIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
