...
namespace ApiSdk.CertificateBasedAuthConfiguration.Item {
    ...
    public class CertificateBasedAuthConfigurationItemRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            }, new CollectionBinding(certificateBasedAuthConfigurationIdOption, new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        ...
        /// <param name="options">Request options</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(ApiSdk.Models.Microsoft.Graph.CertificateBasedAuthConfiguration body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
