...
namespace ApiSdk.CertificateBasedAuthConfiguration.Item {
    ...
    public class CertificateBasedAuthConfigurationItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public CertificateBasedAuthConfigurationItemRequestBuilder(string rawUrl) : base("{+baseurl}/certificateBasedAuthConfiguration/{certificateBasedAuthConfiguration%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Delete entity from certificateBasedAuthConfiguration
        /// </summary>
