...
namespace ApiSdk.Organization.GetAvailableExtensionProperties {
    ...
    public class GetAvailableExtensionPropertiesRequestBody : IAdditionalDataHolder, IParsable {
        ...
        /// </summary>
        public static ApiSdk.Organization.GetAvailableExtensionProperties.GetAvailableExtensionPropertiesRequestBody CreateFromDiscriminatorValue(IParseNode parseNode) {
