...
namespace ApiSdk.Organization.Item.Restore {
    ...
    public class RestoreRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (string organizationItemId, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, organizationItemIdOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
