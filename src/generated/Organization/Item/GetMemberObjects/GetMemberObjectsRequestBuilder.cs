    ...
    public class GetMemberObjectsRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Organization.Item.GetMemberObjects.GetMemberObjectsRequestBody>(ApiSdk.Organization.Item.GetMemberObjects.GetMemberObjectsRequestBody.CreateFromDiscriminatorValue);
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ApiSdk.Organization.Item.GetMemberObjects.GetMemberObjectsRequestBody body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
