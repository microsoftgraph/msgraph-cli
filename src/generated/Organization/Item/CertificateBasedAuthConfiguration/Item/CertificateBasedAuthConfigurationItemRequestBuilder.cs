    ...
    public class CertificateBasedAuthConfigurationItemRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                var certificateBasedAuthConfigurationId = (string) parameters[1];
                ...
                PathParameters.Add("certificateBasedAuthConfiguration_id", certificateBasedAuthConfigurationId);
            ...
            }, new CollectionBinding(organizationIdOption, certificateBasedAuthConfigurationIdOption, selectOption, expandOption, outputOption, queryOption, jsonNoIndentOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
