...
namespace ApiSdk.Organization.Item.CheckMemberObjects {
    ...
    public class CheckMemberObjectsRequestBuilder : BaseCliRequestBuilder {
        ...
        public CheckMemberObjectsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/organization/{organization%2Did}/checkMemberObjects", pathParameters) {
        }
        /// <summary>
        /// Invoke action checkMemberObjects
        /// </summary>
