...
namespace ApiSdk.Organization.Item.SetMobileDeviceManagementAuthority {
    ...
    public class SetMobileDeviceManagementAuthorityResponse : IAdditionalDataHolder, IParsable {
        ...
        /// </summary>
        public static ApiSdk.Organization.Item.SetMobileDeviceManagementAuthority.SetMobileDeviceManagementAuthorityResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
