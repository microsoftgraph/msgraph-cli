    ...
    public class GetMemberGroupsRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Organization.Item.GetMemberGroups.GetMemberGroupsRequestBody>(ApiSdk.Organization.Item.GetMemberGroups.GetMemberGroupsRequestBody.CreateFromDiscriminatorValue);
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ApiSdk.Organization.Item.GetMemberGroups.GetMemberGroupsRequestBody body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
