...
namespace ApiSdk.Organization.Item.Branding.HeaderLogo
{
    ...
    public partial class HeaderLogoRequestBuilder : BaseCliRequestBuilder
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Organization.Item.Branding.HeaderLogo.HeaderLogoRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        public HeaderLogoRequestBuilder(string rawUrl) : base("{+baseurl}/organization/{organization%2Did}/branding/headerLogo", rawUrl)
        {
        }
        /// <summary>
        /// A company logo that appears in the header of the sign-in page. The allowed types are PNG or JPEG not larger than 36 × 245 pixels. We recommend using a transparent image with no padding around the logo.
