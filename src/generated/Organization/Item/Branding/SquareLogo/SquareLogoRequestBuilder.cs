...
namespace ApiSdk.Organization.Item.Branding.SquareLogo
{
    ...
    public partial class SquareLogoRequestBuilder : BaseCliRequestBuilder
    {
        /// <summary>
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Organization.Item.Branding.SquareLogo.SquareLogoRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        public SquareLogoRequestBuilder(string rawUrl) : base("{+baseurl}/organization/{organization%2Did}/branding/squareLogo", rawUrl)
        {
        }
        /// <summary>
        /// A square version of your company logo that appears in Windows 10 out-of-box experiences (OOBE) and when Windows Autopilot is enabled for deployment. Allowed types are PNG or JPEG not larger than 240 x 240 pixels and not more than 10 KB in size. We recommend using a transparent image with no padding around the logo.
