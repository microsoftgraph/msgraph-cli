...
using System;
namespace ApiSdk.Organization.Item.Branding.Localizations.Item.SquareLogoDark {
    /// <summary>
    ...
    public class SquareLogoDarkRequestBuilder : BaseCliRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.Description = "Get squareLogoDark for the navigation property localizations from organization\n\nFind more info here:\n  https://docs.microsoft.com/graph/api/organizationalbranding-list-localizations?view=graph-rest-1.0";
        ...
        public Command BuildPutCommand() {
            ...
            command.Description = "Update squareLogoDark for the navigation property localizations in organization";
            var organizationIdOption = new Option<string>("--organization-id", description: "The unique identifier of organization") {
            };
            organizationIdOption.IsRequired = true;
            command.AddOption(organizationIdOption);
