...
using System;
namespace ApiSdk.Organization.Item.Branding.CustomCSS {
    /// <summary>
    ...
    public class CustomCSSRequestBuilder : BaseCliRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.Description = "Get customCSS for the navigation property branding from organization\n\nFind more info here:\n  https://docs.microsoft.com/graph/api/organizationalbranding-get?view=graph-rest-1.0";
        ...
        public Command BuildPutCommand() {
            ...
            command.Description = "Update customCSS for the navigation property branding in organization";
            var organizationIdOption = new Option<string>("--organization-id", description: "The unique identifier of organization") {
            };
            organizationIdOption.IsRequired = true;
            command.AddOption(organizationIdOption);
