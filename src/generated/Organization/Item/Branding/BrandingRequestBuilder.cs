...
namespace ApiSdk.Organization.Item.Branding {
    ...
    public class BrandingRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string organizationItemId, string[] select, string[] expand, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string organizationItemId, string body, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
