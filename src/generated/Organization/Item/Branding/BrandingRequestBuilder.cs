...
namespace ApiSdk.Organization.Item.Branding {
    /// <summary>Builds and executes requests for operations under \organization\{organizationItem-Id}\branding</summary>
    public class BrandingRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string organizationItemId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, organizationItemIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        ...
        public Command BuildGetCommand() {
            ...
            command.Description = "Get branding from organization";
            // Create options for all the parameters
            var organizationItemIdOption = new Option<string>("--organizationitem-id", description: "key: id of organization") {
            };
            organizationItemIdOption.IsRequired = true;
            ...
            command.SetHandler(async (string organizationItemId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, organizationItemIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string organizationItemId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, organizationItemIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        ...
        public BrandingRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/organization/{organizationItem_Id}/branding{?select,expand}";
