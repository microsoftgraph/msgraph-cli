...
using System;
namespace ApiSdk.Organization.Item.Branding.SquareLogoDark {
    /// <summary>
    ...
    public class SquareLogoDarkRequestBuilder : BaseCliRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.Description = "Get squareLogoDark for the navigation property branding from organization\n\nFind more info here:\n  https://docs.microsoft.com/graph/api/organizationalbranding-get?view=graph-rest-1.0";
        ...
        public Command BuildPutCommand() {
            ...
            command.Description = "Update squareLogoDark for the navigation property branding in organization";
            var organizationIdOption = new Option<string>("--organization-id", description: "The unique identifier of organization") {
            };
            organizationIdOption.IsRequired = true;
            command.AddOption(organizationIdOption);
        ...
        public SquareLogoDarkRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/organization/{organization%2Did}/branding/squareLogoDark", pathParameters) {
        }
        /// <summary>
        /// Get squareLogoDark for the navigation property branding from organization
        /// </summary>
