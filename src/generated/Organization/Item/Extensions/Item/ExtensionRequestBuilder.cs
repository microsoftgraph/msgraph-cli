...
namespace ApiSdk.Organization.Item.Extensions.Item {
    ...
    public class ExtensionRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string organizationItemId, string extensionId, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                var requestInfo = CreateDeleteRequestInformation(q => {
                });
                await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                console.WriteLine("Success");
            }, organizationItemIdOption, extensionIdOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// The collection of open extensions defined for the organization resource. Nullable.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string organizationItemId, string extensionId, string[] select, string[] expand, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
            ...
            }, organizationItemIdOption, extensionIdOption, selectOption, expandOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// The collection of open extensions defined for the organization resource. Nullable.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string organizationItemId, string extensionId, string body, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                ...
                await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                console.WriteLine("Success");
            }, organizationItemIdOption, extensionIdOption, bodyOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
