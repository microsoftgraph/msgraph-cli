...
namespace ApiSdk.Organization.Item.Extensions {
    ...
    public class ExtensionsRequestBuilder {
        ...
        public Command BuildListCommand() {
            ...
            command.Handler = CommandHandler.Create<string, int?, int?, string, string, bool?, string[], string[], string[]>(async (organizationId, top, skip, search, filter, count, orderby, select, expand) => {
