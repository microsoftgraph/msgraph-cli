...
namespace ApiSdk.Organization.Item.CheckMemberGroups {
    /// <summary>Builds and executes requests for operations under \organization\{organizationItem-Id}\microsoft.graph.checkMemberGroups</summary>
    public class CheckMemberGroupsRequestBuilder {
        ...
        public CheckMemberGroupsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/organization/{organizationItem_Id}/microsoft.graph.checkMemberGroups";
        ...
        /// </summary>
        public async Task<IEnumerable<string>> PostAsync(CheckMemberGroupsRequestBody model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
