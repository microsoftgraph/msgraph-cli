    ...
    public class CheckMemberGroupsRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Organization.Item.CheckMemberGroups.CheckMemberGroupsRequestBody>(ApiSdk.Organization.Item.CheckMemberGroups.CheckMemberGroupsRequestBody.CreateFromDiscriminatorValue);
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ApiSdk.Organization.Item.CheckMemberGroups.CheckMemberGroupsRequestBody body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
