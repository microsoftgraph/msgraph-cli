...
namespace ApiSdk.Organization.Item {
    ...
    public class OrganizationItemRequestBuilder {
        ...
        public Command BuildMicrosoftGraphSetMobileDeviceManagementAuthorityCommand() {
            ...
            var builder = new MicrosoftGraphSetMobileDeviceManagementAuthorityRequestBuilder(PathParameters);
            command.AddCommand(builder.BuildPostCommand());
            return command;
        }
        /// <summary>
        ...
        public OrganizationItemRequestBuilder(Dictionary<string, object> pathParameters) {
