...
namespace ApiSdk.Organization {
    ...
    public class OrganizationRequestBuilder {
        ...
        public List<Command> BuildCommand() {
            var builder = new OrganizationItemItemRequestBuilder(PathParameters, RequestAdapter);
            var commands = new List<Command>();
            commands.Add(builder.BuildBrandingCommand());
            commands.Add(builder.BuildCertificateBasedAuthConfigurationCommand());
            ...
            commands.Add(builder.BuildSetMobileDeviceManagementAuthorityCommand());
            return commands;
        }
        /// <summary>
        ...
        public Command BuildCreateCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Models.Microsoft.Graph.Organization>(ApiSdk.Models.Microsoft.Graph.Organization.CreateFromDiscriminatorValue);
        ...
        public Command BuildGetAvailableExtensionPropertiesCommand() {
            ...
            var builder = new ApiSdk.Organization.GetAvailableExtensionProperties.GetAvailableExtensionPropertiesRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildPostCommand());
            return command;
        }
        public Command BuildGetByIdsCommand() {
            var command = new Command("get-by-ids");
            var builder = new ApiSdk.Organization.GetByIds.GetByIdsRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildPostCommand());
            return command;
        }
        /// <summary>
        ...
        public Command BuildListCommand() {
            ...
            command.Description = "Get entities from organization";
            // Create options for all the parameters
        ...
        public Command BuildValidatePropertiesCommand() {
            ...
            var builder = new ApiSdk.Organization.ValidateProperties.ValidatePropertiesRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildPostCommand());
            return command;
        }
        /// <summary>
