...
namespace ApiSdk.Organization {
    ...
    public class OrganizationRequestBuilder {
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ApiSdk.Models.Organization body, Action<OrganizationRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
