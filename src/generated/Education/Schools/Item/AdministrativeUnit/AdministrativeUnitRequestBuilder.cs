...
namespace ApiSdk.Education.Schools.Item.AdministrativeUnit {
    ...
    public class AdministrativeUnitRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(educationSchoolIdOption, selectOption, expandOption, outputOption, queryOption, jsonNoIndentOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        public Command BuildRefCommand() {
            var command = new Command("ref");
            var builder = new ApiSdk.Education.Schools.Item.AdministrativeUnit.Ref.RefRequestBuilder(PathParameters, RequestAdapter);
