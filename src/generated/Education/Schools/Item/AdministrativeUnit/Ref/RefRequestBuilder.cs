...
namespace ApiSdk.Education.Schools.Item.AdministrativeUnit.Ref {
    ...
    public class RefRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string educationSchoolId, IConsole console) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string educationSchoolId, FormatterType output, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
            ...
            }, educationSchoolIdOption, outputOption);
            return command;
        }
        /// <summary>
        /// The underlying administrativeUnit for this school.
        ...
        public Command BuildPutCommand() {
            ...
            command.SetHandler(async (string educationSchoolId, string body, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
