...
namespace ApiSdk.Education.Schools.Item.AdministrativeUnit.Ref {
    ...
    public class RefRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            }, educationSchoolIdOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// The underlying administrativeUnit for this school.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string educationSchoolId, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                var requestInfo = CreateGetRequestInformation(q => {
                });
                var response = await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                var formatter = outputFormatterFactory.GetFormatter(output);
                formatter.WriteOutput(response, console);
            }, educationSchoolIdOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// The underlying administrativeUnit for this school.
        ...
        public Command BuildPutCommand() {
            ...
            command.SetHandler(async (string educationSchoolId, string body, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                ...
                await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                console.WriteLine("Success");
            }, educationSchoolIdOption, bodyOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
