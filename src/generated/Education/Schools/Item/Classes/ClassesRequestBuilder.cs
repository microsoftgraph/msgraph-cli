...
namespace ApiSdk.Education.Schools.Item.Classes {
    ...
    public class ClassesRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.Handler = CommandHandler.Create<string, int?, int?, string, string, bool?, object, object, object>(async (educationSchoolId, top, skip, search, filter, count, orderby, select, expand) => {
