...
namespace ApiSdk.Education.Me {
    ...
    public class MeRequestBuilder {
        ...
        public Command BuildAssignmentsCommand() {
            ...
            var builder = new ApiSdk.Education.Me.Assignments.AssignmentsRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildClassesCommand() {
            ...
            var builder = new ApiSdk.Education.Me.Classes.ClassesRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildSchoolsCommand() {
            ...
            var builder = new ApiSdk.Education.Me.Schools.SchoolsRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildGetCommand());
            command.AddCommand(builder.BuildRefCommand());
            return command;
        }
        public Command BuildTaughtClassesCommand() {
            ...
            var builder = new ApiSdk.Education.Me.TaughtClasses.TaughtClassesRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildGetCommand());
            command.AddCommand(builder.BuildRefCommand());
            return command;
        }
        public Command BuildUserCommand() {
            ...
            var builder = new ApiSdk.Education.Me.User.UserRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildGetCommand());
            command.AddCommand(builder.BuildRefCommand());
            return command;
        }
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(EducationUser model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
