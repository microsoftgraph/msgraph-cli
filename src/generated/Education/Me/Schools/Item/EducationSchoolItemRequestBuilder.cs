...
namespace ApiSdk.Education.Me.Schools.Item {
    ...
    public class EducationSchoolItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public EducationSchoolItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/education/me/schools/{educationSchool%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Schools to which the user belongs. Nullable.
        /// </summary>
