...
namespace ApiSdk.Education.Me.Assignments.Item {
    ...
    public class EducationAssignmentRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string[], string[]>(async (educationAssignmentId, select, expand) => {
        ...
        public Command BuildPatchCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string>(async (educationAssignmentId, body) => {
