...
namespace ApiSdk.Education.Me.Assignments.Item.SetUpResourcesFolder {
    ...
    public class SetUpResourcesFolderRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (string educationAssignmentId, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                var requestInfo = CreatePostRequestInformation(q => {
                });
                var response = await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                var formatter = outputFormatterFactory.GetFormatter(output);
                formatter.WriteOutput(response, console);
            }, educationAssignmentIdOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
