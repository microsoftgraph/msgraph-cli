...
namespace ApiSdk.Education.Me.Assignments.Item.SetUpResourcesFolder {
    ...
    public class SetUpResourcesFolderRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (string educationAssignmentId, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, educationAssignmentIdOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
