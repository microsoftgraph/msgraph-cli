...
namespace ApiSdk.Education.Me.Assignments.Item.Submissions.Item.Resources.Item {
    ...
    public class EducationSubmissionResourceItemRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            }, new CollectionBinding(educationAssignmentIdOption, educationSubmissionIdOption, educationSubmissionResourceIdOption, new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// Nullable.
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(educationAssignmentIdOption, educationSubmissionIdOption, educationSubmissionResourceIdOption, selectOption, expandOption, outputOption, queryOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// Nullable.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                await RequestAdapter.SendNoContentAsync(requestInfo, errorMapping: default, cancellationToken: cancellationToken);
                Console.WriteLine("Success");
            }, new CollectionBinding(educationAssignmentIdOption, educationSubmissionIdOption, educationSubmissionResourceIdOption, bodyOption, new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
