...
namespace ApiSdk.Education.Me.Assignments.Item.Submissions.Item.Return {
    ...
    public class ReturnRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (string educationAssignmentId, string educationSubmissionId, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, educationAssignmentIdOption, educationSubmissionIdOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
