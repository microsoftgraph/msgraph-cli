...
namespace ApiSdk.Education.Me.Assignments.Item.Submissions.Item.Resources {
    ...
    public class ResourcesRequestBuilder {
        ...
        public Command BuildCreateCommand() {
            ...
            }, new CollectionBinding(educationAssignmentIdOption, educationSubmissionIdOption, bodyOption, outputOption, queryOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// Nullable.
