...
namespace ApiSdk.Education.Me.Assignments.Item.Submissions.Item.Resources.Item {
    ...
    public class EducationSubmissionResourceRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string>(async (educationAssignmentId, educationSubmissionId, educationSubmissionResourceId) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string, string[], string[]>(async (educationAssignmentId, educationSubmissionId, educationSubmissionResourceId, select, expand) => {
        ...
        public Command BuildPatchCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string, string>(async (educationAssignmentId, educationSubmissionId, educationSubmissionResourceId, body) => {
