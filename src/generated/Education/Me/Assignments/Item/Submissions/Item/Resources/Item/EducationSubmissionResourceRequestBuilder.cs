...
namespace ApiSdk.Education.Me.Assignments.Item.Submissions.Item.Resources.Item {
    ...
    public class EducationSubmissionResourceRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string educationAssignmentId, string educationSubmissionId, string educationSubmissionResourceId, IConsole console) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string educationAssignmentId, string educationSubmissionId, string educationSubmissionResourceId, string[] select, string[] expand, FormatterType output, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string educationAssignmentId, string educationSubmissionId, string educationSubmissionResourceId, string body, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
