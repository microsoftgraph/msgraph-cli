...
namespace ApiSdk.Education.Me.Assignments.Item.Categories.Item {
    ...
    public class EducationCategoryItemRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(educationAssignmentIdOption, educationCategoryIdOption, selectOption, expandOption, outputOption, outputFilterOption, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// When set, enables users to easily find assignments of a given type.  Read-only. Nullable.
