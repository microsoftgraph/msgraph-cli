...
namespace ApiSdk.Education.Me.Assignments.Item.Categories.Item {
    ...
    public class EducationCategoryRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string educationAssignmentId, string educationCategoryId, IConsole console) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string educationAssignmentId, string educationCategoryId, string[] select, string[] expand, FormatterType output, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string educationAssignmentId, string educationCategoryId, string body, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
