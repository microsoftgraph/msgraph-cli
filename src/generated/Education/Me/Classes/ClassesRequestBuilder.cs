    ...
    public class ClassesRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.Handler = CommandHandler.Create<int?, int?, string, string, bool?, object, object, object>(async (top, skip, search, filter, count, orderby, select, expand) => {
                ...
                var result = await RequestAdapter.SendAsync<ClassesResponse>(requestInfo);
        ...
        public Command BuildRefCommand() {
            ...
            var builder = new ApiSdk.Education.Me.Classes.@Ref.RefRequestBuilder(PathParameters, RequestAdapter);
