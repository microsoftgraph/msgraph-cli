...
namespace ApiSdk.Education.Me.Rubrics.Item {
    ...
    public class EducationRubricRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string educationRubricId) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string educationRubricId, string[] select, string[] expand) => {
            ...
            }, educationRubricIdOption, selectOption, expandOption);
            return command;
        }
        /// <summary>
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string educationRubricId, string body) => {
