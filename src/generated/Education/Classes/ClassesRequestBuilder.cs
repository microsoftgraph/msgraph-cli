...
namespace ApiSdk.Education.Classes {
    ...
    public class ClassesRequestBuilder {
        ...
        public List<Command> BuildCommand() {
            var builder = new EducationClassRequestBuilder(PathParameters, RequestAdapter);
            var commands = new List<Command>();
            commands.Add(builder.BuildAssignmentCategoriesCommand());
            commands.Add(builder.BuildAssignmentDefaultsCommand());
            commands.Add(builder.BuildAssignmentsCommand());
            commands.Add(builder.BuildAssignmentSettingsCommand());
            ...
            commands.Add(builder.BuildTeachersCommand());
            return commands;
        }
        /// <summary>
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<EducationClass> PostAsync(EducationClass model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
