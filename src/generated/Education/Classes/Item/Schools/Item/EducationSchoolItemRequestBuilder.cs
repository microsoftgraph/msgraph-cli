...
namespace ApiSdk.Education.Classes.Item.Schools.Item {
    ...
    public class EducationSchoolItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public EducationSchoolItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/education/classes/{educationClass%2Did}/schools/{educationSchool%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// All schools that this class is associated with. Nullable.
        /// </summary>
