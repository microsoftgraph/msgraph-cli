...
namespace ApiSdk.Education.Classes.Item.Members.Item.Ref {
    ...
    public class RefRequestBuilder : BaseCliRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.Description = "Remove an educationUser from an educationClass. This API is available in the following national cloud deployments.\n\nFind more info here:\n  https://learn.microsoft.com/graph/api/educationclass-delete-members?view=graph-rest-1.0";
        ...
        public RefRequestBuilder(string rawUrl) : base("{+baseurl}/education/classes/{educationClass%2Did}/members/{educationUser%2Did}/$ref{?%40id*}", rawUrl) {
        }
        /// <summary>
        /// Remove an educationUser from an educationClass. This API is available in the following national cloud deployments.
        /// </summary>
