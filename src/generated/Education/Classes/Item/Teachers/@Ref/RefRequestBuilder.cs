...
namespace ApiSdk.Education.Classes.Item.Teachers.@Ref {
    ...
    public class RefRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string educationClassId, int? top, int? skip, string search, string filter, bool? count, string[] orderby) => {
            ...
            }, educationClassIdOption, topOption, skipOption, searchOption, filterOption, countOption, orderbyOption);
            return command;
        }
        /// <summary>
        /// All teachers in the class. Nullable.
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<ApiSdk.Education.Classes.Item.Teachers.@Ref.@Ref> PostAsync(ApiSdk.Education.Classes.Item.Teachers.@Ref.@Ref model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = model ?? throw new ArgumentNullException(nameof(model));
            var requestInfo = CreatePostRequestInformation(model, h, o);
            return await RequestAdapter.SendAsync<ApiSdk.Education.Classes.Item.Teachers.@Ref.@Ref>(requestInfo, responseHandler, cancellationToken);
        }
