...
namespace ApiSdk.Education.Classes.Item.Teachers {
    ...
    public class TeachersRequestBuilder : BaseCliRequestBuilder {
        ...
        public Command BuildRefNavCommand() {
            var educationUserIndexer = new EducationUserItemRequestBuilder(PathParameters);
            var command = educationUserIndexer.BuildRefNavCommand();
...
#nullable restore
        ...
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<TeachersRequestBuilderGetQueryParameters>> requestConfiguration = default) {
            ...
            if (requestConfiguration != null) {
                var requestConfig = new RequestConfiguration<TeachersRequestBuilderGetQueryParameters>();
