...
namespace ApiSdk.Education.Classes.Item.Teachers {
    ...
    public class TeachersRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.Handler = CommandHandler.Create<string, int?, int?, string, string, bool?, object, object, object>(async (educationClassId, top, skip, search, filter, count, orderby, select, expand) => {
