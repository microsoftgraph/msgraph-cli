...
namespace ApiSdk.Education.Classes.Item.Assignments.Item.Submissions.Item.Outcomes {
    ...
    public class OutcomesRequestBuilder {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<EducationOutcome> PostAsync(EducationOutcome model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
