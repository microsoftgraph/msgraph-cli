...
namespace ApiSdk.Education.Classes.Item.Assignments.Item.Submissions.Item.Submit {
    ...
    public class SubmitRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (string educationClassId, string educationAssignmentId, string educationSubmissionId, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                var requestInfo = CreatePostRequestInformation(q => {
                });
                var response = await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                var formatter = outputFormatterFactory.GetFormatter(output);
                formatter.WriteOutput(response, console);
            }, educationClassIdOption, educationAssignmentIdOption, educationSubmissionIdOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
