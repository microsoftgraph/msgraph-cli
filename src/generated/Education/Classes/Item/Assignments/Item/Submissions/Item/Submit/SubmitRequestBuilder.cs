...
namespace ApiSdk.Education.Classes.Item.Assignments.Item.Submissions.Item.Submit {
    ...
    public class SubmitRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (string educationClassId, string educationAssignmentId, string educationSubmissionId, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, educationClassIdOption, educationAssignmentIdOption, educationSubmissionIdOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
