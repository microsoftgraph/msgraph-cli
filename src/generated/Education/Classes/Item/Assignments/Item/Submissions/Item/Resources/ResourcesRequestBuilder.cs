...
namespace ApiSdk.Education.Classes.Item.Assignments.Item.Submissions.Item.Resources {
    ...
    public class ResourcesRequestBuilder {
        ...
        public Command BuildListCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string, int?, int?, string, string, bool?, object, object, object>(async (educationClassId, educationAssignmentId, educationSubmissionId, top, skip, search, filter, count, orderby, select, expand) => {
