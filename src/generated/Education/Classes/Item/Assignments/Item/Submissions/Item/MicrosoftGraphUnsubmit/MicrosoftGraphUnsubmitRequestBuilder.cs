...
namespace ApiSdk.Education.Classes.Item.Assignments.Item.Submissions.Item.MicrosoftGraphUnsubmit {
    /// <summary>
    ...
    public class MicrosoftGraphUnsubmitRequestBuilder {
        ...
        public MicrosoftGraphUnsubmitRequestBuilder(Dictionary<string, object> pathParameters) {
