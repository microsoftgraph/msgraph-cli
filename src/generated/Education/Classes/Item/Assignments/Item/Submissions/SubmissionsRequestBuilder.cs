...
namespace ApiSdk.Education.Classes.Item.Assignments.Item.Submissions {
    ...
    public class SubmissionsRequestBuilder {
        ...
        public Command BuildListCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, int?, int?, string, string, bool?, string[], string[], string[]>(async (educationClassId, educationAssignmentId, top, skip, search, filter, count, orderby, select, expand) => {
