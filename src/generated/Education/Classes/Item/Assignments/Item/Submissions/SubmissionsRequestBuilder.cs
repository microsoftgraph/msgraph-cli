...
namespace ApiSdk.Education.Classes.Item.Assignments.Item.Submissions {
    ...
    public class SubmissionsRequestBuilder {
        ...
        public List<Command> BuildCommand() {
            ...
            commands.Add(builder.BuildOutcomesCommand());
            commands.Add(builder.BuildPatchCommand());
            commands.Add(builder.BuildReassignCommand());
            commands.Add(builder.BuildResourcesCommand());
            commands.Add(builder.BuildReturnCommand());
            commands.Add(builder.BuildSetUpResourcesFolderCommand());
            commands.Add(builder.BuildSubmitCommand());
            commands.Add(builder.BuildSubmittedResourcesCommand());
            commands.Add(builder.BuildUnsubmitCommand());
            return commands;
        }
        /// <summary>
        ...
        public Command BuildCreateCommand() {
            ...
            command.SetHandler(async (string educationClassId, string educationAssignmentId, string body, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
            ...
            }, educationClassIdOption, educationAssignmentIdOption, bodyOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// Once published, there is a submission object for each student representing their work and grade.  Read-only. Nullable.
        ...
        public Command BuildListCommand() {
            ...
            command.AddOption(outputOption);
            command.SetHandler(async (string educationClassId, string educationAssignmentId, int? top, int? skip, string search, string filter, bool? count, string[] orderby, string[] select, string[] expand, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                ...
                var formatter = outputFormatterFactory.GetFormatter(output);
                formatter.WriteOutput(response, console);
            }, educationClassIdOption, educationAssignmentIdOption, topOption, skipOption, searchOption, filterOption, countOption, orderbyOption, selectOption, expandOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
