...
namespace ApiSdk.Education.Classes.Item.Assignments.Item.Submissions.Item.Return {
    ...
    public class ReturnRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            }, new CollectionBinding(educationClassIdOption, educationAssignmentIdOption, educationSubmissionIdOption, outputOption, queryOption, jsonNoIndentOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        ...
        public class ReturnResponse : IAdditionalDataHolder, IParsable {
            ...
            public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
                return new Dictionary<string, Action<T, IParseNode>> {
                    {"educationSubmission", (o,n) => { (o as ReturnResponse).EducationSubmission = n.GetObjectValue<ApiSdk.Models.Microsoft.Graph.EducationSubmission>(ApiSdk.Models.Microsoft.Graph.EducationSubmission.CreateFromDiscriminatorValue); } },
                };
            }
            /// <summary>
