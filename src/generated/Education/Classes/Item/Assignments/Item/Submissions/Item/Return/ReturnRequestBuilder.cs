...
namespace ApiSdk.Education.Classes.Item.Assignments.Item.Submissions.Item.Return {
    ...
    public class ReturnRequestBuilder {
        ...
        public ReturnRequestBuilder(Dictionary<string, object> pathParameters) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            UrlTemplate = "{+baseurl}/education/classes/{educationClass%2Did}/assignments/{educationAssignment%2Did}/submissions/{educationSubmission%2Did}/return";
