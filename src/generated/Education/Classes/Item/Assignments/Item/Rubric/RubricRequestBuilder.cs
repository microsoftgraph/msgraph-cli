...
namespace ApiSdk.Education.Classes.Item.Assignments.Item.Rubric {
    ...
    public class RubricRequestBuilder : BaseCliRequestBuilder {
        ...
        public RubricRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/education/classes/{educationClass%2Did}/assignments/{educationAssignment%2Did}/rubric{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Delete navigation property rubric for education
        /// </summary>
