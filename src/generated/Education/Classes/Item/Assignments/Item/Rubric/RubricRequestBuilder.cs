...
namespace ApiSdk.Education.Classes.Item.Assignments.Item.Rubric {
    ...
    public class RubricRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(educationClassIdOption, educationAssignmentIdOption, selectOption, expandOption, outputOption, outputFilterOption, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// When set, the grading rubric attached to this assignment.
