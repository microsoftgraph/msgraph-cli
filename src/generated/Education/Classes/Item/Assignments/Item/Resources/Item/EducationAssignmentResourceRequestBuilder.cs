...
namespace ApiSdk.Education.Classes.Item.Assignments.Item.Resources.Item {
    ...
    public class EducationAssignmentResourceRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string educationClassId, string educationAssignmentId, string educationAssignmentResourceId, IConsole console) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string educationClassId, string educationAssignmentId, string educationAssignmentResourceId, string[] select, string[] expand, FormatterType output, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string educationClassId, string educationAssignmentId, string educationAssignmentResourceId, string body, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
