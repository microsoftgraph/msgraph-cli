...
namespace ApiSdk.Education.Classes.Item.Assignments.Item.Resources.Item {
    ...
    public class EducationAssignmentResourceRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string, string[], string[]>(async (educationClassId, educationAssignmentId, educationAssignmentResourceId, select, expand) => {
