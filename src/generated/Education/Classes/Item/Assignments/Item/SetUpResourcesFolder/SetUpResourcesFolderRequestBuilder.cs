...
namespace ApiSdk.Education.Classes.Item.Assignments.Item.SetUpResourcesFolder {
    ...
    public class SetUpResourcesFolderRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            }, new CollectionBinding(educationClassIdOption, educationAssignmentIdOption, outputOption, outputFilterOption, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
