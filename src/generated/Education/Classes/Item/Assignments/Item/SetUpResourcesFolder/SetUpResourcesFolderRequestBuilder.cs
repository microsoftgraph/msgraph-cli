...
namespace ApiSdk.Education.Classes.Item.Assignments.Item.SetUpResourcesFolder {
    ...
    public class SetUpResourcesFolderRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (string educationClassId, string educationAssignmentId, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, educationClassIdOption, educationAssignmentIdOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
