...
namespace ApiSdk.Education.Users.Item.TaughtClasses.Item {
    ...
    public class EducationClassItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public EducationClassItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/education/users/{educationUser%2Did}/taughtClasses/{educationClass%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Classes for which the user is a teacher.
        /// </summary>
