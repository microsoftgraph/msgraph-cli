...
namespace ApiSdk.Education.Users.Item.TaughtClasses {
    ...
    public class TaughtClassesRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.Handler = CommandHandler.Create<string, int?, int?, string, string, bool?, object, object, object>(async (educationUserId, top, skip, search, filter, count, orderby, select, expand) => {
