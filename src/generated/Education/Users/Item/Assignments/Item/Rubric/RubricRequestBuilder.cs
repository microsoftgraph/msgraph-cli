...
namespace ApiSdk.Education.Users.Item.Assignments.Item.Rubric {
    ...
    public class RubricRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string educationUserId, string educationAssignmentId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, educationUserIdOption, educationAssignmentIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// When set, the grading rubric attached to this assignment.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string educationUserId, string educationAssignmentId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, educationUserIdOption, educationAssignmentIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// When set, the grading rubric attached to this assignment.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string educationUserId, string educationAssignmentId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, educationUserIdOption, educationAssignmentIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
