...
namespace ApiSdk.Education.Users.Item.Assignments.Item.Rubric {
    ...
    public class RubricRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string educationUserId, string educationAssignmentId) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string educationUserId, string educationAssignmentId, string[] select, string[] expand) => {
            ...
            }, educationUserIdOption, educationAssignmentIdOption, selectOption, expandOption);
            return command;
        }
        /// <summary>
        /// When set, the grading rubric attached to this assignment.
