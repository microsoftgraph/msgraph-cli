...
namespace ApiSdk.Education.Users.Item.Assignments.Item.Categories.Item {
    ...
    public class EducationCategoryRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string educationUserId, string educationAssignmentId, string educationCategoryId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, educationUserIdOption, educationAssignmentIdOption, educationCategoryIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// When set, enables users to easily find assignments of a given type.  Read-only. Nullable.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string educationUserId, string educationAssignmentId, string educationCategoryId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, educationUserIdOption, educationAssignmentIdOption, educationCategoryIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// When set, enables users to easily find assignments of a given type.  Read-only. Nullable.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string educationUserId, string educationAssignmentId, string educationCategoryId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, educationUserIdOption, educationAssignmentIdOption, educationCategoryIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
