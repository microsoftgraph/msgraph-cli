...
namespace ApiSdk.Education.Users.Item.Assignments.Item.Categories.Item {
    ...
    public class EducationCategoryRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string>(async (educationUserId, educationAssignmentId, educationCategoryId) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string, string[], string[]>(async (educationUserId, educationAssignmentId, educationCategoryId, select, expand) => {
        ...
        public Command BuildPatchCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string, string>(async (educationUserId, educationAssignmentId, educationCategoryId, body) => {
