...
namespace ApiSdk.Education.Users.Item.Assignments.Item.Submissions.Item.Unsubmit {
    ...
    public class UnsubmitRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            }, new CollectionBinding(educationUserIdOption, educationAssignmentIdOption, educationSubmissionIdOption, outputOption, queryOption, jsonNoIndentOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        ...
        public class UnsubmitResponse : IAdditionalDataHolder, IParsable {
            ...
            public ApiSdk.Models.Microsoft.Graph.EducationSubmission EducationSubmission { get; set; }
            /// <summary>
            ...
            public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
                return new Dictionary<string, Action<T, IParseNode>> {
                    {"educationSubmission", (o,n) => { (o as UnsubmitResponse).EducationSubmission = n.GetObjectValue<ApiSdk.Models.Microsoft.Graph.EducationSubmission>(ApiSdk.Models.Microsoft.Graph.EducationSubmission.CreateFromDiscriminatorValue); } },
                };
            }
            /// <summary>
            ...
            public void Serialize(ISerializationWriter writer) {
                ...
                writer.WriteObjectValue<ApiSdk.Models.Microsoft.Graph.EducationSubmission>("educationSubmission", EducationSubmission);
