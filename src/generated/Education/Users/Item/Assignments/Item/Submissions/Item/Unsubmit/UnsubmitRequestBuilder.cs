...
namespace ApiSdk.Education.Users.Item.Assignments.Item.Submissions.Item.Unsubmit {
    ...
    public class UnsubmitRequestBuilder {
        ...
        public UnsubmitRequestBuilder(Dictionary<string, object> pathParameters) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            UrlTemplate = "{+baseurl}/education/users/{educationUser%2Did}/assignments/{educationAssignment%2Did}/submissions/{educationSubmission%2Did}/unsubmit";
