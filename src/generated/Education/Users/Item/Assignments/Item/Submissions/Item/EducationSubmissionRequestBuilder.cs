...
namespace ApiSdk.Education.Users.Item.Assignments.Item.Submissions.Item {
    ...
    public class EducationSubmissionRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string educationUserId, string educationAssignmentId, string educationSubmissionId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, educationUserIdOption, educationAssignmentIdOption, educationSubmissionIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// Once published, there is a submission object for each student representing their work and grade.  Read-only. Nullable.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string educationUserId, string educationAssignmentId, string educationSubmissionId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, educationUserIdOption, educationAssignmentIdOption, educationSubmissionIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        public Command BuildOutcomesCommand() {
            var command = new Command("outcomes");
            var builder = new ApiSdk.Education.Users.Item.Assignments.Item.Submissions.Item.Outcomes.OutcomesRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string educationUserId, string educationAssignmentId, string educationSubmissionId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, educationUserIdOption, educationAssignmentIdOption, educationSubmissionIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        public Command BuildReassignCommand() {
            var command = new Command("reassign");
            var builder = new ApiSdk.Education.Users.Item.Assignments.Item.Submissions.Item.Reassign.ReassignRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildPostCommand());
            return command;
        }
        public Command BuildResourcesCommand() {
            var command = new Command("resources");
            var builder = new ApiSdk.Education.Users.Item.Assignments.Item.Submissions.Item.Resources.ResourcesRequestBuilder(PathParameters, RequestAdapter);
            foreach (var cmd in builder.BuildCommand()) {
                command.AddCommand(cmd);
            }
            command.AddCommand(builder.BuildCreateCommand());
        ...
        public Command BuildReturnCommand() {
            ...
            var builder = new ApiSdk.Education.Users.Item.Assignments.Item.Submissions.Item.Return.ReturnRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildPostCommand());
            return command;
        }
        public Command BuildSetUpResourcesFolderCommand() {
            var command = new Command("set-up-resources-folder");
            var builder = new ApiSdk.Education.Users.Item.Assignments.Item.Submissions.Item.SetUpResourcesFolder.SetUpResourcesFolderRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildPostCommand());
            return command;
        }
        public Command BuildSubmitCommand() {
            var command = new Command("submit");
            var builder = new ApiSdk.Education.Users.Item.Assignments.Item.Submissions.Item.Submit.SubmitRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildPostCommand());
            return command;
        }
        public Command BuildSubmittedResourcesCommand() {
            var command = new Command("submitted-resources");
            var builder = new ApiSdk.Education.Users.Item.Assignments.Item.Submissions.Item.SubmittedResources.SubmittedResourcesRequestBuilder(PathParameters, RequestAdapter);
            foreach (var cmd in builder.BuildCommand()) {
                command.AddCommand(cmd);
            }
            command.AddCommand(builder.BuildCreateCommand());
        ...
        public Command BuildUnsubmitCommand() {
            ...
            var builder = new ApiSdk.Education.Users.Item.Assignments.Item.Submissions.Item.Unsubmit.UnsubmitRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildPostCommand());
            return command;
        }
        /// <summary>
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(EducationSubmission model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
