...
namespace ApiSdk.Education.Users.Item.Assignments.Item.Submissions.Item.SubmittedResources.Item {
    ...
    public class EducationSubmissionResourceRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string educationUserId, string educationAssignmentId, string educationSubmissionId, string educationSubmissionResourceId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, educationUserIdOption, educationAssignmentIdOption, educationSubmissionIdOption, educationSubmissionResourceIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// Read-only. Nullable.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string educationUserId, string educationAssignmentId, string educationSubmissionId, string educationSubmissionResourceId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, educationUserIdOption, educationAssignmentIdOption, educationSubmissionIdOption, educationSubmissionResourceIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// Read-only. Nullable.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string educationUserId, string educationAssignmentId, string educationSubmissionId, string educationSubmissionResourceId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, educationUserIdOption, educationAssignmentIdOption, educationSubmissionIdOption, educationSubmissionResourceIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
