...
using System;
namespace ApiSdk.Education.Users.Item.Assignments.Item.Resources.Count {
    /// <summary>
    ...
    public class CountRequestBuilder : BaseCliRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/education/users/{educationUser%2Did}/assignments/{educationAssignment%2Did}/resources/$count{?%24search,%24filter}", pathParameters) {
        }
        /// <summary>
        /// Get the number of the resource
        /// </summary>
