...
namespace ApiSdk.Education.Users.Item.Assignments.Item.SetUpResourcesFolder {
    ...
    public class SetUpResourcesFolderRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            }, new CollectionBinding(educationUserIdOption, educationAssignmentIdOption, outputOption, outputFilterOption, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
