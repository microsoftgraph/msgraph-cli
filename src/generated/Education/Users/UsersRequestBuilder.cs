...
namespace ApiSdk.Education.Users {
    ...
    public class UsersRequestBuilder {
        ...
        public List<Command> BuildCommand() {
            ...
            commands.Add(builder.BuildClassesCommand());
            commands.Add(builder.BuildDeleteCommand());
            commands.Add(builder.BuildGetCommand());
            commands.Add(builder.BuildPatchCommand());
            commands.Add(builder.BuildRubricsCommand());
            commands.Add(builder.BuildSchoolsCommand());
            commands.Add(builder.BuildTaughtClassesCommand());
            commands.Add(builder.BuildUserCommand());
            return commands;
        }
        /// <summary>
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<EducationUser> PostAsync(EducationUser model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
