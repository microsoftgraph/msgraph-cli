...
namespace ApiSdk.Applications.Item.SetVerifiedPublisher {
    ...
    public class SetVerifiedPublisherRequestBuilder {
        ...
        public SetVerifiedPublisherRequestBuilder(Dictionary<string, object> pathParameters) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            UrlTemplate = "{+baseurl}/applications/{application%2Did}/setVerifiedPublisher";
