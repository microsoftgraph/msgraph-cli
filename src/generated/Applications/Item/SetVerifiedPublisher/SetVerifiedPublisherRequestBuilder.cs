...
namespace ApiSdk.Applications.Item.SetVerifiedPublisher {
    ...
    public class SetVerifiedPublisherRequestBuilder {
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(SetVerifiedPublisherPostRequestBody body, Action<SetVerifiedPublisherRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
