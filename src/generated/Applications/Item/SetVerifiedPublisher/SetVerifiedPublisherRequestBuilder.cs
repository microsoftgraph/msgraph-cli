...
namespace ApiSdk.Applications.Item.SetVerifiedPublisher {
    ...
    public class SetVerifiedPublisherRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(SetVerifiedPublisherRequestBody model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
