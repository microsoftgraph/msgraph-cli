...
namespace ApiSdk.Applications.Item.SetVerifiedPublisher {
    ...
    public class SetVerifiedPublisherRequestBuilder {
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(SetVerifiedPublisherRequestBody body, Action<SetVerifiedPublisherRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
