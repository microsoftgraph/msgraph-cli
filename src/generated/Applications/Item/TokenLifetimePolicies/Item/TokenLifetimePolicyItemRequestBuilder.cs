...
namespace ApiSdk.Applications.Item.TokenLifetimePolicies.Item
{
    ...
    public class TokenLifetimePolicyItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildRefByIdNavCommand()
        {
            ...
            var builder = new ApiSdk.Applications.Item.TokenLifetimePolicies.Item.Ref.RefRequestBuilder(PathParameters);
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Applications.Item.TokenLifetimePolicies.Item.TokenLifetimePolicyItemRequestBuilder"/> and sets the default values.
        /// </summary>
