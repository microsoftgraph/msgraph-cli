...
namespace ApiSdk.Applications.Item.Synchronization.Jobs.Item.Schema.FilterOperators {
    ...
    public class FilterOperatorsRequestBuilder : BaseCliRequestBuilder {
        ...
        public FilterOperatorsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/applications/{application%2Did}/synchronization/jobs/{synchronizationJob%2Did}/schema/filterOperators(){?%24count,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new FilterOperatorsRequestBuilder and sets the default values.
        /// </summary>
