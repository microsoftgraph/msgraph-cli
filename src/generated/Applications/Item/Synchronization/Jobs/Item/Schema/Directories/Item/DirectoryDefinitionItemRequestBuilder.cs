using ApiSdk.Applications.Item.Synchronization.Jobs.Item.Schema.Directories.Item.Discover;
...
using System;
namespace ApiSdk.Applications.Item.Synchronization.Jobs.Item.Schema.Directories.Item {
    /// <summary>
    ...
    public class DirectoryDefinitionItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public DirectoryDefinitionItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/applications/{application%2Did}/synchronization/jobs/{synchronizationJob%2Did}/schema/directories/{directoryDefinition%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Delete navigation property directories for applications
        /// </summary>
