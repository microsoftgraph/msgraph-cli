...
namespace ApiSdk.Applications.Item.Synchronization.Jobs.Item.Schema.Functions {
    ...
    public class FunctionsRequestBuilder : BaseCliRequestBuilder {
        ...
        public FunctionsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/applications/{application%2Did}/synchronization/jobs/{synchronizationJob%2Did}/schema/functions(){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}", pathParameters) {
        }
        /// <summary>
        /// Invoke function functions
        /// </summary>
