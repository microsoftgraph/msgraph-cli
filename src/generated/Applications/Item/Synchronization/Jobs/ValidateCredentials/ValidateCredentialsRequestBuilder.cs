...
namespace ApiSdk.Applications.Item.Synchronization.Jobs.ValidateCredentials {
    ...
    public class ValidateCredentialsRequestBuilder : BaseCliRequestBuilder {
        ...
        public ValidateCredentialsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/applications/{application%2Did}/synchronization/jobs/validateCredentials", pathParameters) {
        }
        /// <summary>
        /// Invoke action validateCredentials
        /// </summary>
