using ApiSdk.Applications.Item.Synchronization.Jobs.Count;
using ApiSdk.Applications.Item.Synchronization.Jobs.Item;
using ApiSdk.Applications.Item.Synchronization.Jobs.ValidateCredentials;
...
using System;
namespace ApiSdk.Applications.Item.Synchronization.Jobs {
    /// <summary>
    ...
    public class JobsRequestBuilder : BaseCliRequestBuilder {
        ...
        public Command BuildCreateCommand() {
            ...
            command.Description = "Create new navigation property to jobs for applications";
        ...
        public JobsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/applications/{application%2Did}/synchronization/jobs{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Get jobs from applications
        /// </summary>
