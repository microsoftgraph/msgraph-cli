...
namespace ApiSdk.Applications.Item.Synchronization.Templates {
    ...
    public class TemplatesRequestBuilder : BaseCliRequestBuilder {
        ...
        public TemplatesRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/applications/{application%2Did}/synchronization/templates{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Get templates from applications
        /// </summary>
