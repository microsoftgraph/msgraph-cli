using ApiSdk.Applications.Item.Synchronization.Templates.Item.Schema.Directories;
using ApiSdk.Applications.Item.Synchronization.Templates.Item.Schema.FilterOperators;
using ApiSdk.Applications.Item.Synchronization.Templates.Item.Schema.Functions;
using ApiSdk.Applications.Item.Synchronization.Templates.Item.Schema.ParseExpression;
...
using System;
namespace ApiSdk.Applications.Item.Synchronization.Templates.Item.Schema {
    /// <summary>
    ...
    public class SchemaRequestBuilder : BaseCliRequestBuilder {
        ...
        public SchemaRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/applications/{application%2Did}/synchronization/templates/{synchronizationTemplate%2Did}/schema{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Delete navigation property schema for applications
        /// </summary>
