...
namespace ApiSdk.Applications.Item.Synchronization.Templates.Item.Schema.Directories.Item
{
    ...
    public class DirectoryDefinitionItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildDiscoverNavCommand()
        {
            ...
            var builder = new ApiSdk.Applications.Item.Synchronization.Templates.Item.Schema.Directories.Item.Discover.DiscoverRequestBuilder(PathParameters);
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Applications.Item.Synchronization.Templates.Item.Schema.Directories.Item.DirectoryDefinitionItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Applications.Item.Synchronization.Templates.Item.Schema.Directories.Item.DirectoryDefinitionItemRequestBuilder.DirectoryDefinitionItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Applications.Item.Synchronization.Templates.Item.Schema.Directories.Item.DirectoryDefinitionItemRequestBuilder.DirectoryDefinitionItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
