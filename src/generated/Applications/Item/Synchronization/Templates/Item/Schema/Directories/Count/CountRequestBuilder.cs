...
namespace ApiSdk.Applications.Item.Synchronization.Templates.Item.Schema.Directories.Count
{
    ...
    public class CountRequestBuilder : BaseCliRequestBuilder
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Applications.Item.Synchronization.Templates.Item.Schema.Directories.Count.CountRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Applications.Item.Synchronization.Templates.Item.Schema.Directories.Count.CountRequestBuilder.CountRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Applications.Item.Synchronization.Templates.Item.Schema.Directories.Count.CountRequestBuilder.CountRequestBuilderGetQueryParameters>> requestConfiguration = default)
