...
namespace ApiSdk.Applications.Item.CreatedOnBehalfOf {
    ...
    public class CreatedOnBehalfOfRequestBuilder : BaseCliRequestBuilder {
        ...
        public CreatedOnBehalfOfRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/applications/{application%2Did}/createdOnBehalfOf{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Supports $filter (/$count eq 0, /$count ne 0). Read-only.
        /// </summary>
...
#nullable restore
        ...
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<CreatedOnBehalfOfRequestBuilderGetQueryParameters>> requestConfiguration = default) {
            ...
            if (requestConfiguration != null) {
                var requestConfig = new RequestConfiguration<CreatedOnBehalfOfRequestBuilderGetQueryParameters>();
