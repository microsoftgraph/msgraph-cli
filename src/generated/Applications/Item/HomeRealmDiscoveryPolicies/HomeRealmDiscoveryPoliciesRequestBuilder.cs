using ApiSdk.Applications.Item.HomeRealmDiscoveryPolicies.Count;
using ApiSdk.Applications.Item.HomeRealmDiscoveryPolicies.Item;
using ApiSdk.Models;
...
namespace ApiSdk.Applications.Item.HomeRealmDiscoveryPolicies {
    ...
    public class HomeRealmDiscoveryPoliciesRequestBuilder {
        ...
        public List<Command> BuildCommand() {
            var builder = new HomeRealmDiscoveryPolicyItemRequestBuilder(PathParameters, RequestAdapter);
