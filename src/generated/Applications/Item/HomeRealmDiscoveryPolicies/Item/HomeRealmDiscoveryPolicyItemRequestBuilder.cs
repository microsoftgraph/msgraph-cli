...
namespace ApiSdk.Applications.Item.HomeRealmDiscoveryPolicies.Item {
    ...
    public class HomeRealmDiscoveryPolicyItemRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(applicationIdOption, homeRealmDiscoveryPolicyIdOption, selectOption, expandOption, outputOption, queryOption, jsonNoIndentOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
