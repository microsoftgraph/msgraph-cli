...
namespace ApiSdk.Applications.Item.CheckMemberObjects {
    ...
    public class CheckMemberObjectsRequestBuilder : BaseCliRequestBuilder {
        ...
        public CheckMemberObjectsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/applications/{application%2Did}/checkMemberObjects", pathParameters) {
        }
        /// <summary>
        /// Invoke action checkMemberObjects
        /// </summary>
