...
namespace ApiSdk.Applications.Item.Logo {
    ...
    public class LogoRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string applicationId, FileInfo file, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
            ...
            }, applicationIdOption, fileOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// The main logo for the application. Not nullable.
        ...
        public Command BuildPutCommand() {
            ...
            command.SetHandler(async (string applicationId, FileInfo file, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
