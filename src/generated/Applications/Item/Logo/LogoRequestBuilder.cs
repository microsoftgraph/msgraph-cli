...
namespace ApiSdk.Applications.Item.Logo {
    ...
    public class LogoRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string applicationId, FileInfo file, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, applicationIdOption, fileOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The main logo for the application. Not nullable.
        ...
        public Command BuildPutCommand() {
            ...
            command.SetHandler(async (string applicationId, FileInfo file, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
