...
namespace ApiSdk.Applications.Item.RemovePassword {
    ...
    public class RemovePasswordRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(RemovePasswordRequestBody model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
