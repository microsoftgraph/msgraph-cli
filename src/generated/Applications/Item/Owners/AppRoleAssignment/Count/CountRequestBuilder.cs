...
namespace ApiSdk.Applications.Item.Owners.AppRoleAssignment.Count {
    /// <summary>
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/applications/{application%2Did}/owners/microsoft.graph.appRoleAssignment/$count{?%24search,%24filter}";
