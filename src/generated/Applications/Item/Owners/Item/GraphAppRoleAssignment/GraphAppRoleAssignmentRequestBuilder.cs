...
namespace ApiSdk.Applications.Item.Owners.Item.GraphAppRoleAssignment {
    /// <summary>
    ...
    public class GraphAppRoleAssignmentRequestBuilder : BaseCliRequestBuilder {
        ...
        public GraphAppRoleAssignmentRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/applications/{application%2Did}/owners/{directoryObject%2Did}/graph.appRoleAssignment{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Get the item of type microsoft.graph.directoryObject as microsoft.graph.appRoleAssignment
        /// </summary>
