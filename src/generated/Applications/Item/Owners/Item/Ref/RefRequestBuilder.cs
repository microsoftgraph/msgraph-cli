...
namespace ApiSdk.Applications.Item.Owners.Item.Ref {
    ...
    public class RefRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.Description = "Delete ref of navigation property owners for applications";
        ...
        public RefRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/applications/{application%2Did}/owners/{directoryObject%2Did}/$ref{?%40id}";
        ...
        /// <summary>Delete ref of navigation property owners for applications</summary>
