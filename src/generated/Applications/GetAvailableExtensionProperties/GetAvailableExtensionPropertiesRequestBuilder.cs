...
namespace ApiSdk.Applications.GetAvailableExtensionProperties {
    ...
    public class GetAvailableExtensionPropertiesRequestBuilder : BaseCliRequestBuilder {
        ...
        public GetAvailableExtensionPropertiesRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/applications/getAvailableExtensionProperties", pathParameters) {
        }
        /// <summary>
        /// Invoke action getAvailableExtensionProperties
        /// </summary>
