...
namespace ApiSdk.Applications.Delta {
    ...
    public class DeltaRequestBuilder : BaseCliRequestBuilder 
    {
        ...
        public Command BuildGetCommand()
        {
            ...
            command.Description = "Get newly created, updated, or deleted applications without performing a full read of the entire resource collection. For details, see Using delta query.\n\nFind more info here:\n  https://learn.microsoft.com/graph/api/application-delta?view=graph-rest-1.0";
