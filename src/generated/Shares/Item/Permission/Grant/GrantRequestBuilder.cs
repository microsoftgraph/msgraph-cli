    ...
    public class GrantRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string>(async (sharedDriveItemId, body) => {
                ...
                var result = await RequestAdapter.SendCollectionAsync<ApiSdk.Shares.Item.Permission.Grant.Grant>(requestInfo);
        ...
        /// </summary>
        public async Task<IEnumerable<ApiSdk.Shares.Item.Permission.Grant.Grant>> PostAsync(GrantRequestBody model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            _ = model ?? throw new ArgumentNullException(nameof(model));
            var requestInfo = CreatePostRequestInformation(model, h, o);
            return await RequestAdapter.SendCollectionAsync<ApiSdk.Shares.Item.Permission.Grant.Grant>(requestInfo, responseHandler, cancellationToken);
        }
    }
}
