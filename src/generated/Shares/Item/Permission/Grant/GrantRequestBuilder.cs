...
namespace ApiSdk.Shares.Item.Permission.Grant {
    ...
    public class GrantRequestBuilder {
        ...
        /// </summary>
        public async Task<IEnumerable<ApiSdk.Shares.Item.Permission.Grant.Grant>> PostAsync(GrantRequestBody model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
