...
namespace ApiSdk.Shares.Item.ListItem.Versions.Item.Fields {
    ...
    public class FieldsRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string sharedDriveItemId, string listItemVersionId, string[] select, string[] expand) => {
            ...
            }, sharedDriveItemIdOption, listItemVersionIdOption, selectOption, expandOption);
            return command;
        }
        /// <summary>
        /// A collection of the fields and values for this version of the list item.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string sharedDriveItemId, string listItemVersionId, string body) => {
