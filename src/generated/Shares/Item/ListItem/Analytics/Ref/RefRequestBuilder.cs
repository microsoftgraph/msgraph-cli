...
namespace ApiSdk.Shares.Item.ListItem.Analytics.Ref {
    ...
    public class RefRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string sharedDriveItemId, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, sharedDriveItemIdOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// Analytics about the view activities that took place on this item.
