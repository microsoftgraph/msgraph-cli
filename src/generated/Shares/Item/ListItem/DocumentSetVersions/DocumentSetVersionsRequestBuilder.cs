...
using ApiSdk.Shares.Item.ListItem.DocumentSetVersions.Count;
using ApiSdk.Shares.Item.ListItem.DocumentSetVersions.Item;
...
namespace ApiSdk.Shares.Item.ListItem.DocumentSetVersions {
    /// <summary>
