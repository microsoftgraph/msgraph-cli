...
namespace ApiSdk.Shares.Item.Items.Item {
    ...
    public class DriveItemRequestBuilder {
        ...
        public Command BuildContentCommand() {
            ...
            var builder = new ApiSdk.Shares.Item.Items.Item.Content.ContentRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string sharedDriveItemId, string driveItemId, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                var requestInfo = CreateDeleteRequestInformation(q => {
                });
                await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                console.WriteLine("Success");
            }, sharedDriveItemIdOption, driveItemIdOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// All driveItems contained in the sharing root. This collection cannot be enumerated.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string sharedDriveItemId, string driveItemId, string[] select, string[] expand, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
            ...
            }, sharedDriveItemIdOption, driveItemIdOption, selectOption, expandOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// All driveItems contained in the sharing root. This collection cannot be enumerated.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string sharedDriveItemId, string driveItemId, string body, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
