...
namespace ApiSdk.Shares.Item.Items.Item {
    ...
    public class DriveItemRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string sharedDriveItemId, string driveItemId) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string sharedDriveItemId, string driveItemId, string[] select, string[] expand) => {
            ...
            }, sharedDriveItemIdOption, driveItemIdOption, selectOption, expandOption);
            return command;
        }
        /// <summary>
        /// All driveItems contained in the sharing root. This collection cannot be enumerated.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string sharedDriveItemId, string driveItemId, string body) => {
