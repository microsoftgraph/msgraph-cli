...
namespace ApiSdk.Shares.Item.Items.Item.Content {
    ...
    public class ContentRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string sharedDriveItemId, string driveItemId, FileInfo file, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
            ...
            }, sharedDriveItemIdOption, driveItemIdOption, fileOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        ...
        public Command BuildPutCommand() {
            ...
            command.SetHandler(async (string sharedDriveItemId, string driveItemId, FileInfo file, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                using var stream = file.OpenRead();
                var requestInfo = CreatePutRequestInformation(stream, q => {
                });
                await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                console.WriteLine("Success");
            }, sharedDriveItemIdOption, driveItemIdOption, bodyOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
