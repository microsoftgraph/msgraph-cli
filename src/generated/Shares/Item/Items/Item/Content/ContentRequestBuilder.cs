...
namespace ApiSdk.Shares.Item.Items.Item.Content {
    ...
    public class ContentRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, FileInfo>(async (sharedDriveItemId, driveItemId, output) => {
        ...
        public Command BuildPutCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, FileInfo>(async (sharedDriveItemId, driveItemId, file) => {
