...
namespace ApiSdk.Shares.Item.List.Drive {
    ...
    public class DriveRequestBuilder : BaseCliRequestBuilder {
        ...
        public DriveRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/shares/{sharedDriveItem%2Did}/list/drive{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Only present on document libraries. Allows access to the list as a [drive][] resource with [driveItems][driveItem].
        /// </summary>
