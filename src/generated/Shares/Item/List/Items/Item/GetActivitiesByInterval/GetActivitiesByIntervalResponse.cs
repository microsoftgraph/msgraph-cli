...
namespace ApiSdk.Shares.Item.List.Items.Item.GetActivitiesByInterval {
    ...
    public class GetActivitiesByIntervalResponse : IAdditionalDataHolder, IParsable {
        ...
        /// </summary>
        public static ApiSdk.Shares.Item.List.Items.Item.GetActivitiesByInterval.GetActivitiesByIntervalResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
