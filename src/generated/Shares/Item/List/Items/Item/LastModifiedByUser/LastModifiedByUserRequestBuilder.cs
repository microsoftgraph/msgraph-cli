...
namespace ApiSdk.Shares.Item.List.Items.Item.LastModifiedByUser {
    ...
    public class LastModifiedByUserRequestBuilder : BaseCliRequestBuilder {
        ...
        public LastModifiedByUserRequestBuilder(string rawUrl) : base("{+baseurl}/shares/{sharedDriveItem%2Did}/list/items/{listItem%2Did}/lastModifiedByUser{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Identity of the user who last modified the item. Read-only.
        /// </summary>
