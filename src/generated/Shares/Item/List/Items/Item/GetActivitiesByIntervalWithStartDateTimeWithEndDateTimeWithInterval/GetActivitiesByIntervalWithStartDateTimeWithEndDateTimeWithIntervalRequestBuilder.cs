...
namespace ApiSdk.Shares.Item.List.Items.Item.GetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithInterval {
    ...
    public class GetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithIntervalRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string sharedDriveItemId, string listItemId, string startDateTime, string endDateTime, string interval, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, sharedDriveItemIdOption, listItemIdOption, startDateTimeOption, endDateTimeOption, intervalOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
