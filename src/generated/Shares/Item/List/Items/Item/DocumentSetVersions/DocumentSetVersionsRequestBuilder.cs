...
using ApiSdk.Models;
using ApiSdk.Shares.Item.List.Items.Item.DocumentSetVersions.Count;
using ApiSdk.Shares.Item.List.Items.Item.DocumentSetVersions.Item;
...
namespace ApiSdk.Shares.Item.List.Items.Item.DocumentSetVersions {
    ...
    public class DocumentSetVersionsRequestBuilder : BaseCliRequestBuilder {
        ...
        public DocumentSetVersionsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/shares/{sharedDriveItem%2Did}/list/items/{listItem%2Did}/documentSetVersions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Version information for a document set version created by a user.
        /// </summary>
