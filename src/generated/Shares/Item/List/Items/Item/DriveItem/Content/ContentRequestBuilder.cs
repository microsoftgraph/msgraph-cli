...
namespace ApiSdk.Shares.Item.List.Items.Item.DriveItem.Content {
    ...
    public class ContentRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string sharedDriveItemId, string listItemId, FileInfo file, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
            ...
            }, sharedDriveItemIdOption, listItemIdOption, fileOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        ...
        public Command BuildPutCommand() {
            ...
            command.SetHandler(async (string sharedDriveItemId, string listItemId, FileInfo file, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
