...
namespace ApiSdk.Shares.Item.List.Items.Item.Versions.Item {
    ...
    public class ListItemVersionRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string sharedDriveItemId, string listItemId, string listItemVersionId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, sharedDriveItemIdOption, listItemIdOption, listItemVersionIdOption, new ServiceProviderBinder());
            return command;
        }
        public Command BuildFieldsCommand() {
            var command = new Command("fields");
            var builder = new ApiSdk.Shares.Item.List.Items.Item.Versions.Item.Fields.FieldsRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string sharedDriveItemId, string listItemId, string listItemVersionId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, sharedDriveItemIdOption, listItemIdOption, listItemVersionIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The list of previous versions of the list item.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string sharedDriveItemId, string listItemId, string listItemVersionId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, sharedDriveItemIdOption, listItemIdOption, listItemVersionIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        public Command BuildRestoreVersionCommand() {
            var command = new Command("restore-version");
            var builder = new ApiSdk.Shares.Item.List.Items.Item.Versions.Item.RestoreVersion.RestoreVersionRequestBuilder(PathParameters, RequestAdapter);
