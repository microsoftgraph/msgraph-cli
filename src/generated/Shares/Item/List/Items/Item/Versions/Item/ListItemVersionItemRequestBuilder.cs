...
namespace ApiSdk.Shares.Item.List.Items.Item.Versions.Item
{
    ...
    public class ListItemVersionItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildFieldsNavCommand()
        {
            ...
            var builder = new ApiSdk.Shares.Item.List.Items.Item.Versions.Item.Fields.FieldsRequestBuilder(PathParameters);
        ...
        public Command BuildRestoreVersionNavCommand()
        {
            ...
            var builder = new ApiSdk.Shares.Item.List.Items.Item.Versions.Item.RestoreVersion.RestoreVersionRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Shares.Item.List.Items.Item.Versions.Item.ListItemVersionItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Shares.Item.List.Items.Item.Versions.Item.ListItemVersionItemRequestBuilder.ListItemVersionItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Shares.Item.List.Items.Item.Versions.Item.ListItemVersionItemRequestBuilder.ListItemVersionItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
