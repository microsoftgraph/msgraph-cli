...
namespace ApiSdk.Shares.Item.List.Subscriptions.Item {
    ...
    public class SubscriptionRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string sharedDriveItemId, string subscriptionId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, sharedDriveItemIdOption, subscriptionIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The set of subscriptions on the list.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string sharedDriveItemId, string subscriptionId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, sharedDriveItemIdOption, subscriptionIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The set of subscriptions on the list.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string sharedDriveItemId, string subscriptionId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, sharedDriveItemIdOption, subscriptionIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
