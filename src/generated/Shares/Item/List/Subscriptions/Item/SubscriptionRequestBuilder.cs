...
namespace ApiSdk.Shares.Item.List.Subscriptions.Item {
    ...
    public class SubscriptionRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string sharedDriveItemId, string subscriptionId, IConsole console) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string sharedDriveItemId, string subscriptionId, string[] select, string[] expand, FormatterType output, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string sharedDriveItemId, string subscriptionId, string body, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
