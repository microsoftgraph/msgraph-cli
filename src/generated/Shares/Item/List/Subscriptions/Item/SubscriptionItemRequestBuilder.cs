...
namespace ApiSdk.Shares.Item.List.Subscriptions.Item
{
    ...
    public class SubscriptionItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildReauthorizeNavCommand()
        {
            ...
            var builder = new ApiSdk.Shares.Item.List.Subscriptions.Item.Reauthorize.ReauthorizeRequestBuilder(PathParameters);
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Shares.Item.List.Subscriptions.Item.SubscriptionItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Shares.Item.List.Subscriptions.Item.SubscriptionItemRequestBuilder.SubscriptionItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Shares.Item.List.Subscriptions.Item.SubscriptionItemRequestBuilder.SubscriptionItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
