...
namespace ApiSdk.Shares.Item.List.Subscriptions {
    ...
    public class SubscriptionsRequestBuilder : BaseCliRequestBuilder {
        ...
        public SubscriptionsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/shares/{sharedDriveItem%2Did}/list/subscriptions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// The set of subscriptions on the list.
        /// </summary>
