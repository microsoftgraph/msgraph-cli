...
namespace ApiSdk.Shares.Item.List.ContentTypes.GetCompatibleHubContentTypes {
    ...
    public class GetCompatibleHubContentTypesRequestBuilder : BaseCliRequestBuilder {
        ...
        public GetCompatibleHubContentTypesRequestBuilder(string rawUrl) : base("{+baseurl}/shares/{sharedDriveItem%2Did}/list/contentTypes/getCompatibleHubContentTypes(){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}", rawUrl) {
        }
        /// <summary>
        /// Invoke function getCompatibleHubContentTypes
        /// </summary>
