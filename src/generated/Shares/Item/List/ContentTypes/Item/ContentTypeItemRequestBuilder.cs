...
namespace ApiSdk.Shares.Item.List.ContentTypes.Item
{
    ...
    public partial class ContentTypeItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildAssociateWithHubSitesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Shares.Item.List.ContentTypes.Item.AssociateWithHubSites.AssociateWithHubSitesRequestBuilder(PathParameters);
        ...
        public Command BuildBaseNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Shares.Item.List.ContentTypes.Item.Base.BaseRequestBuilderEscaped(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildBaseTypesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Shares.Item.List.ContentTypes.Item.BaseTypes.BaseTypesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildColumnLinksNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Shares.Item.List.ContentTypes.Item.ColumnLinks.ColumnLinksRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
        ...
        public Command BuildColumnPositionsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Shares.Item.List.ContentTypes.Item.ColumnPositions.ColumnPositionsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildListCommand());
        ...
        public Command BuildColumnsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Shares.Item.List.ContentTypes.Item.Columns.ColumnsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildCopyToDefaultContentLocationNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Shares.Item.List.ContentTypes.Item.CopyToDefaultContentLocation.CopyToDefaultContentLocationRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildIsPublishedNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Shares.Item.List.ContentTypes.Item.IsPublished.IsPublishedRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildPublishNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Shares.Item.List.ContentTypes.Item.Publish.PublishRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildUnpublishNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Shares.Item.List.ContentTypes.Item.Unpublish.UnpublishRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Shares.Item.List.ContentTypes.Item.ContentTypeItemRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public ContentTypeItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/shares/{sharedDriveItem%2Did}/list/contentTypes/{contentType%2Did}{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Shares.Item.List.ContentTypes.Item.ContentTypeItemRequestBuilder"/> and sets the default values.
        ...
        public ContentTypeItemRequestBuilder(string rawUrl) : base("{+baseurl}/shares/{sharedDriveItem%2Did}/list/contentTypes/{contentType%2Did}{?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
        /// Delete navigation property contentTypes for shares
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Shares.Item.List.ContentTypes.Item.ContentTypeItemRequestBuilder.ContentTypeItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Shares.Item.List.ContentTypes.Item.ContentTypeItemRequestBuilder.ContentTypeItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
