...
using ApiSdk.Models;
using ApiSdk.Shares.Item.List.ContentTypes.Item.BaseTypes.Count;
using ApiSdk.Shares.Item.List.ContentTypes.Item.BaseTypes.Item;
...
namespace ApiSdk.Shares.Item.List.ContentTypes.Item.BaseTypes {
    ...
    public class BaseTypesRequestBuilder : BaseCliRequestBuilder {
        ...
        public Tuple<List<Command>, List<Command>> BuildCommand() {
            ...
            var builder = new ApiSdk.Shares.Item.List.ContentTypes.Item.BaseTypes.Item.ContentTypeItemRequestBuilder(PathParameters);
        ...
        public BaseTypesRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/shares/{sharedDriveItem%2Did}/list/contentTypes/{contentType%2Did}/baseTypes{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// The collection of content types that are ancestors of this content type.
        /// </summary>
