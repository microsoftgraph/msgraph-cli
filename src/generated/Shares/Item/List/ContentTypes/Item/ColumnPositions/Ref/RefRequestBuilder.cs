    ...
    public class RefRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (string sharedDriveItemId, string contentTypeId, string body, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Shares.Item.List.ContentTypes.Item.ColumnPositions.Ref.Ref>();
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ApiSdk.Shares.Item.List.ContentTypes.Item.ColumnPositions.Ref.Ref body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
