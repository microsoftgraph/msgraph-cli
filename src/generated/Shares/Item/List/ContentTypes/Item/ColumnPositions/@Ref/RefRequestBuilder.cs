...
namespace ApiSdk.Shares.Item.List.ContentTypes.Item.ColumnPositions.@Ref {
    ...
    public class RefRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string sharedDriveItemId, string contentTypeId, int? top, int? skip, string search, string filter, bool? count, string[] orderby) => {
            ...
            }, sharedDriveItemIdOption, contentTypeIdOption, topOption, skipOption, searchOption, filterOption, countOption, orderbyOption);
            return command;
        }
        /// <summary>
        /// Column order information in a content type.
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (string sharedDriveItemId, string contentTypeId, string body) => {
                ...
                var result = await RequestAdapter.SendAsync<ApiSdk.Shares.Item.List.ContentTypes.Item.ColumnPositions.@Ref.@Ref>(requestInfo);
                // Print request output. What if the request has no return?
                using var serializer = RequestAdapter.SerializationWriterFactory.GetSerializationWriter("application/json");
                serializer.WriteObjectValue(null, result);
                using var content = serializer.GetSerializedContent();
