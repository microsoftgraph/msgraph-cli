...
namespace ApiSdk.Shares.Item.List.ContentTypes.Item.ColumnPositions.@Ref {
    ...
    public class RefRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, int?, int?, string, string, bool?, string[]>(async (sharedDriveItemId, contentTypeId, top, skip, search, filter, count, orderby) => {
