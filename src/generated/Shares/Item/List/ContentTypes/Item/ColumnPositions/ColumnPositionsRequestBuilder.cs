...
using ApiSdk.Models;
using ApiSdk.Shares.Item.List.ContentTypes.Item.ColumnPositions.Count;
using ApiSdk.Shares.Item.List.ContentTypes.Item.ColumnPositions.Item;
...
namespace ApiSdk.Shares.Item.List.ContentTypes.Item.ColumnPositions {
    ...
    public class ColumnPositionsRequestBuilder : BaseCliRequestBuilder {
        ...
        public ColumnPositionsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/shares/{sharedDriveItem%2Did}/list/contentTypes/{contentType%2Did}/columnPositions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Column order information in a content type.
        /// </summary>
