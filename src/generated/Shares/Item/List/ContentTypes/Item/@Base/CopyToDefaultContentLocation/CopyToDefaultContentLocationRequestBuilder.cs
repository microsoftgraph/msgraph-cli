...
namespace ApiSdk.Shares.Item.List.ContentTypes.Item.@Base.CopyToDefaultContentLocation {
    ...
    public class CopyToDefaultContentLocationRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(CopyToDefaultContentLocationRequestBody model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
