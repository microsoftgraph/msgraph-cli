...
namespace ApiSdk.Shares.Item.List.ContentTypes.Item.Base {
    ...
    public class BaseRequestBuilderEscaped : BaseCliRequestBuilder {
        ...
        public BaseRequestBuilderEscaped(Dictionary<string, object> pathParameters) : base("{+baseurl}/shares/{sharedDriveItem%2Did}/list/contentTypes/{contentType%2Did}/base{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Parent contentType from which this content type is derived.
        /// </summary>
