...
namespace ApiSdk.Shares.Item.List.ContentTypes.Item.Columns.Item {
    ...
    public class ColumnDefinitionRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string sharedDriveItemId, string contentTypeId, string columnDefinitionId, IOutputFormatterFactory outputFormatterFactory, CancellationToken cancellationToken) => {
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string sharedDriveItemId, string contentTypeId, string columnDefinitionId, string body, IOutputFormatterFactory outputFormatterFactory, CancellationToken cancellationToken) => {
