...
namespace ApiSdk.Shares.Item.List.ContentTypes.Item.Columns {
    ...
    public class ColumnsRequestBuilder {
        ...
        public Command BuildListCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, int?, int?, string, string, bool?, object, object, object>(async (sharedDriveItemId, contentTypeId, top, skip, search, filter, count, orderby, select, expand) => {
