...
namespace ApiSdk.Shares.Item.List.Columns.Item.SourceColumn.Ref {
    ...
    public class RefRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string sharedDriveItemId, string columnDefinitionId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, sharedDriveItemIdOption, columnDefinitionIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The source column for content type column.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string sharedDriveItemId, string columnDefinitionId, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, sharedDriveItemIdOption, columnDefinitionIdOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The source column for content type column.
        ...
        public Command BuildPutCommand() {
            ...
            command.SetHandler(async (string sharedDriveItemId, string columnDefinitionId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, sharedDriveItemIdOption, columnDefinitionIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
