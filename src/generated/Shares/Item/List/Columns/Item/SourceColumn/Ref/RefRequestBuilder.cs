...
namespace ApiSdk.Shares.Item.List.Columns.Item.SourceColumn.Ref {
    ...
    public class RefRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            }, sharedDriveItemIdOption, columnDefinitionIdOption);
            return command;
        }
        /// <summary>
        /// The source column for content type column.
        ...
        public Command BuildGetCommand() {
            ...
            }, sharedDriveItemIdOption, columnDefinitionIdOption, outputOption);
            return command;
        }
        /// <summary>
        /// The source column for content type column.
        ...
        public Command BuildPutCommand() {
            ...
            command.SetHandler(async (string sharedDriveItemId, string columnDefinitionId, string body, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                ...
                await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                console.WriteLine("Success");
            }, sharedDriveItemIdOption, columnDefinitionIdOption, bodyOption);
            return command;
        }
        /// <summary>
