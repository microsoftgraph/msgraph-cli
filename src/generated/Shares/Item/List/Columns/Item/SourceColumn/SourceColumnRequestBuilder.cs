...
namespace ApiSdk.Shares.Item.List.Columns.Item.SourceColumn {
    ...
    public class SourceColumnRequestBuilder : BaseCliRequestBuilder {
        ...
        public SourceColumnRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/shares/{sharedDriveItem%2Did}/list/columns/{columnDefinition%2Did}/sourceColumn{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// The source column for the content type column.
        /// </summary>
