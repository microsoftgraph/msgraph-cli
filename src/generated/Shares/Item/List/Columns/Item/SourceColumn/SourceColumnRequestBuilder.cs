...
namespace ApiSdk.Shares.Item.List.Columns.Item.SourceColumn {
    ...
    public class SourceColumnRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string sharedDriveItemId, string columnDefinitionId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, sharedDriveItemIdOption, columnDefinitionIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
