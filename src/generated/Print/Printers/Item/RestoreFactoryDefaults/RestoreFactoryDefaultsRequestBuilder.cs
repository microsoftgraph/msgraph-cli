...
namespace ApiSdk.Print.Printers.Item.RestoreFactoryDefaults {
    ...
    public class RestoreFactoryDefaultsRequestBuilder {
        ...
        public RestoreFactoryDefaultsRequestBuilder(Dictionary<string, object> pathParameters) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            UrlTemplate = "{+baseurl}/print/printers/{printer%2Did}/restoreFactoryDefaults";
