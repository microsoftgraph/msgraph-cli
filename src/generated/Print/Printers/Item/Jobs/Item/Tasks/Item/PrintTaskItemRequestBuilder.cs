...
using ApiSdk.Models;
using ApiSdk.Print.Printers.Item.Jobs.Item.Tasks.Item.Definition;
using ApiSdk.Print.Printers.Item.Jobs.Item.Tasks.Item.Trigger;
...
using System;
namespace ApiSdk.Print.Printers.Item.Jobs.Item.Tasks.Item {
    /// <summary>
