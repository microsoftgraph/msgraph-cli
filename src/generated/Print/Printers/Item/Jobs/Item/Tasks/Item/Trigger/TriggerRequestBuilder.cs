...
namespace ApiSdk.Print.Printers.Item.Jobs.Item.Tasks.Item.Trigger {
    ...
    public class TriggerRequestBuilder : BaseCliRequestBuilder {
        ...
        public TriggerRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/print/printers/{printer%2Did}/jobs/{printJob%2Did}/tasks/{printTask%2Did}/trigger{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// The printTaskTrigger that triggered this task&apos;s execution. Read-only.
        /// </summary>
