...
using ApiSdk.Models;
using ApiSdk.Print.Printers.Item.Jobs.Item.Tasks.Count;
using ApiSdk.Print.Printers.Item.Jobs.Item.Tasks.Item;
...
using System;
namespace ApiSdk.Print.Printers.Item.Jobs.Item.Tasks {
    /// <summary>
    ...
    public class TasksRequestBuilder : BaseCliRequestBuilder {
        ...
        public TasksRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/print/printers/{printer%2Did}/jobs/{printJob%2Did}/tasks{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// A list of printTasks that were triggered by this print job.
        /// </summary>
