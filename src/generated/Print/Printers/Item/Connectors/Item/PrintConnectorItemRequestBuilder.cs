...
namespace ApiSdk.Print.Printers.Item.Connectors.Item {
    ...
    public class PrintConnectorItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public PrintConnectorItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/print/printers/{printer%2Did}/connectors/{printConnector%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// The connectors that are associated with the printer.
        /// </summary>
...
#nullable restore
        ...
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<PrintConnectorItemRequestBuilderGetQueryParameters>> requestConfiguration = default) {
            ...
            if (requestConfiguration != null) {
                var requestConfig = new RequestConfiguration<PrintConnectorItemRequestBuilderGetQueryParameters>();
