...
namespace ApiSdk.Print.Printers.Item.Connectors.Item {
    ...
    public class PrintConnectorItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public PrintConnectorItemRequestBuilder(string rawUrl) : base("{+baseurl}/print/printers/{printer%2Did}/connectors/{printConnector%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// The connectors that are associated with the printer.
        /// </summary>
