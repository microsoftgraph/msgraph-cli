...
namespace ApiSdk.Print.Printers.Item.Shares {
    ...
    public class SharesRequestBuilder : BaseCliRequestBuilder {
        ...
        public SharesRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/print/printers/{printer%2Did}/shares{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Retrieve a list of printer shares associated with the printer.
        /// </summary>
