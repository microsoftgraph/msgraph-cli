...
namespace ApiSdk.Print.Printers.Item.Shares {
    ...
    public class SharesRequestBuilder : BaseCliRequestBuilder {
        ...
        public Command BuildListCommand() {
            ...
            command.Description = "Retrieve a list of printer shares associated with the printer. This API is available in the following national cloud deployments.\n\nFind more info here:\n  https://learn.microsoft.com/graph/api/printer-list-shares?view=graph-rest-1.0";
        ...
        public SharesRequestBuilder(string rawUrl) : base("{+baseurl}/print/printers/{printer%2Did}/shares{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Retrieve a list of printer shares associated with the printer. This API is available in the following national cloud deployments.
        /// </summary>
