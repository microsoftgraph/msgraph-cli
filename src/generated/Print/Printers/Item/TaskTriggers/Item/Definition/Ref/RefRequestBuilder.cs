...
namespace ApiSdk.Print.Printers.Item.TaskTriggers.Item.Definition.Ref {
    ...
    public class RefRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string printerId, string printTaskTriggerId, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, printerIdOption, printTaskTriggerIdOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// An abstract definition that will be used to create a printTask when triggered by a print event. Read-only.
