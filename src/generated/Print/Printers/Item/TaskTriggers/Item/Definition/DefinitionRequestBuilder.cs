...
namespace ApiSdk.Print.Printers.Item.TaskTriggers.Item.Definition {
    ...
    public class DefinitionRequestBuilder : BaseCliRequestBuilder {
        ...
        public DefinitionRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/print/printers/{printer%2Did}/taskTriggers/{printTaskTrigger%2Did}/definition{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// An abstract definition that will be used to create a printTask when triggered by a print event. Read-only.
        /// </summary>
