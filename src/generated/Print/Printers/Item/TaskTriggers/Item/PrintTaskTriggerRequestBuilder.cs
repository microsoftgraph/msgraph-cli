...
namespace ApiSdk.Print.Printers.Item.TaskTriggers.Item {
    ...
    public class PrintTaskTriggerRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string printerId, string printTaskTriggerId, IConsole console) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string printerId, string printTaskTriggerId, string[] select, string[] expand, FormatterType output, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string printerId, string printTaskTriggerId, string body, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
