...
namespace ApiSdk.Print.Printers.Item.TaskTriggers.Item {
    ...
    public class PrintTaskTriggerRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string printerId, string printTaskTriggerId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, printerIdOption, printTaskTriggerIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// A list of task triggers that are associated with the printer.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string printerId, string printTaskTriggerId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, printerIdOption, printTaskTriggerIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// A list of task triggers that are associated with the printer.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string printerId, string printTaskTriggerId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, printerIdOption, printTaskTriggerIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
