...
namespace ApiSdk.Print.Printers.Item.TaskTriggers.Item {
    ...
    public class PrintTaskTriggerRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string printerId, string printTaskTriggerId, string[] select, string[] expand, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
            ...
            }, printerIdOption, printTaskTriggerIdOption, selectOption, expandOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// A list of task triggers that are associated with the printer.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string printerId, string printTaskTriggerId, string body, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
