...
namespace ApiSdk.Print.Printers.Item.TaskTriggers {
    ...
    public class TaskTriggersRequestBuilder {
        ...
        public Command BuildListCommand() {
            ...
            command.Handler = CommandHandler.Create<string, int?, int?, string, string, bool?, object, object, object>(async (printerId, top, skip, search, filter, count, orderby, select, expand) => {
