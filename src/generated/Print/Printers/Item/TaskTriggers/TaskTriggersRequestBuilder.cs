...
namespace ApiSdk.Print.Printers.Item.TaskTriggers {
    ...
    public class TaskTriggersRequestBuilder {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<PrintTaskTrigger> PostAsync(PrintTaskTrigger model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
