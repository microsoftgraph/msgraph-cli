...
namespace ApiSdk.Print.Shares.Item {
    ...
    public class PrinterShareRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string printerShareId, IConsole console) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string printerShareId, string[] select, string[] expand, FormatterType output, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string printerShareId, string body, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
