...
namespace ApiSdk.Print.Shares.Item {
    ...
    public class PrinterShareRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string printerShareId, string[] select, string[] expand, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string printerShareId, string body, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
