...
namespace ApiSdk.Print.Shares.Item.AllowedUsers {
    ...
    public class AllowedUsersRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(printerShareIdOption, topOption, skipOption, searchOption, filterOption, countOption, orderbyOption, selectOption, expandOption, outputOption, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
