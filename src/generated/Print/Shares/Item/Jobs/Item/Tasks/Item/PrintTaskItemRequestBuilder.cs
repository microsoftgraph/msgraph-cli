...
using ApiSdk.Models;
using ApiSdk.Print.Shares.Item.Jobs.Item.Tasks.Item.Definition;
using ApiSdk.Print.Shares.Item.Jobs.Item.Tasks.Item.Trigger;
...
namespace ApiSdk.Print.Shares.Item.Jobs.Item.Tasks.Item {
    ...
    public class PrintTaskItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public PrintTaskItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/print/shares/{printerShare%2Did}/jobs/{printJob%2Did}/tasks/{printTask%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Delete navigation property tasks for print
        /// </summary>
