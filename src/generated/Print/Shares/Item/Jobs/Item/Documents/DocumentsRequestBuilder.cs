...
using ApiSdk.Models;
using ApiSdk.Print.Shares.Item.Jobs.Item.Documents.Count;
using ApiSdk.Print.Shares.Item.Jobs.Item.Documents.Item;
...
using System;
namespace ApiSdk.Print.Shares.Item.Jobs.Item.Documents {
    /// <summary>
    ...
    public class DocumentsRequestBuilder : BaseCliRequestBuilder {
        ...
        public DocumentsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/print/shares/{printerShare%2Did}/jobs/{printJob%2Did}/documents{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Get documents from print
        /// </summary>
...
#nullable restore
        ...
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<DocumentsRequestBuilderGetQueryParameters>> requestConfiguration = default) {
            ...
            if (requestConfiguration != null) {
                var requestConfig = new RequestConfiguration<DocumentsRequestBuilderGetQueryParameters>();
