...
using System;
namespace ApiSdk.Print.Shares.Item.Jobs.Item.Documents.Item.Value {
    /// <summary>
    ...
    public class ContentRequestBuilder : BaseCliRequestBuilder {
        ...
        public ContentRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/print/shares/{printerShare%2Did}/jobs/{printJob%2Did}/documents/{printDocument%2Did}/$value", pathParameters) {
        }
        /// <summary>
        /// Get media content for the navigation property documents from print
        /// </summary>
