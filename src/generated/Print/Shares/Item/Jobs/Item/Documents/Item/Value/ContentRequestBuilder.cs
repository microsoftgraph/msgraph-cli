...
namespace ApiSdk.Print.Shares.Item.Jobs.Item.Documents.Item.Value
{
    ...
    public partial class ContentRequestBuilder : BaseCliRequestBuilder
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Print.Shares.Item.Jobs.Item.Documents.Item.Value.ContentRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        public ContentRequestBuilder(string rawUrl) : base("{+baseurl}/print/shares/{printerShare%2Did}/jobs/{printJob%2Did}/documents/{printDocument%2Did}/$value", rawUrl)
        {
        }
        /// <summary>
        /// The unique identifier for an entity. Read-only.
