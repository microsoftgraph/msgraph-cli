...
namespace ApiSdk.Print.Shares {
    ...
    public class SharesRequestBuilder {
        ...
        public Command BuildCommand() {
            ...
            var builder = new PrinterShareItemRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildAllowedGroupsCommand());
            command.AddCommand(builder.BuildAllowedUsersCommand());
            command.AddCommand(builder.BuildDeleteCommand());
            command.AddCommand(builder.BuildGetCommand());
            command.AddCommand(builder.BuildPatchCommand());
            command.AddCommand(builder.BuildPrinterCommand());
            return command;
        }
        /// <summary>
