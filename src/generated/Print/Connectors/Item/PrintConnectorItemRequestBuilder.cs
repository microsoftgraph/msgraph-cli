...
namespace ApiSdk.Print.Connectors.Item {
    ...
    public class PrintConnectorItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.Description = "Delete (unregister) a printConnector. This API is available in the following national cloud deployments.\n\nFind more info here:\n  https://learn.microsoft.com/graph/api/printconnector-delete?view=graph-rest-1.0";
        ...
        public Command BuildGetCommand() {
            ...
            command.Description = "Retrieve the properties and relationships of a printConnector object. This API is available in the following national cloud deployments.\n\nFind more info here:\n  https://learn.microsoft.com/graph/api/printconnector-get?view=graph-rest-1.0";
            var printConnectorIdOption = new Option<string>("--print-connector-id", description: "The unique identifier of printConnector") {
            };
            printConnectorIdOption.IsRequired = true;
            command.AddOption(printConnectorIdOption);
        ...
        public Command BuildPatchCommand() {
            ...
            command.Description = "Update the properties of a printConnector object. This API is available in the following national cloud deployments.\n\nFind more info here:\n  https://learn.microsoft.com/graph/api/printconnector-update?view=graph-rest-1.0";
            var printConnectorIdOption = new Option<string>("--print-connector-id", description: "The unique identifier of printConnector") {
            };
            printConnectorIdOption.IsRequired = true;
            command.AddOption(printConnectorIdOption);
        ...
        public PrintConnectorItemRequestBuilder(string rawUrl) : base("{+baseurl}/print/connectors/{printConnector%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Delete (unregister) a printConnector. This API is available in the following national cloud deployments.
        /// </summary>
