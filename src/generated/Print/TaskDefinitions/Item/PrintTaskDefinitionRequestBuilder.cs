...
namespace ApiSdk.Print.TaskDefinitions.Item {
    ...
    public class PrintTaskDefinitionRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string printTaskDefinitionId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, printTaskDefinitionIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// List of abstract definition for a task that can be triggered when various events occur within Universal Print.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string printTaskDefinitionId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, printTaskDefinitionIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// List of abstract definition for a task that can be triggered when various events occur within Universal Print.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string printTaskDefinitionId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, printTaskDefinitionIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
