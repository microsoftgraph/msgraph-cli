...
namespace ApiSdk.Print.TaskDefinitions.Item {
    ...
    public class PrintTaskDefinitionRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string printTaskDefinitionId, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                var requestInfo = CreateDeleteRequestInformation(q => {
                });
                await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                console.WriteLine("Success");
            }, printTaskDefinitionIdOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// List of abstract definition for a task that can be triggered when various events occur within Universal Print.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string printTaskDefinitionId, string[] select, string[] expand, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
            ...
            }, printTaskDefinitionIdOption, selectOption, expandOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// List of abstract definition for a task that can be triggered when various events occur within Universal Print.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string printTaskDefinitionId, string body, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                ...
                await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                console.WriteLine("Success");
            }, printTaskDefinitionIdOption, bodyOption, new OutputFormatterFactoryBinder());
            return command;
        }
        public Command BuildTasksCommand() {
            var command = new Command("tasks");
            var builder = new ApiSdk.Print.TaskDefinitions.Item.Tasks.TasksRequestBuilder(PathParameters, RequestAdapter);
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(PrintTaskDefinition model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
