...
namespace ApiSdk.Print.TaskDefinitions.Item {
    ...
    public class PrintTaskDefinitionItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.Description = "Delete a taskDefinition. For details about how to use this API to add pull printing support to Universal Print, see Extending Universal Print to support pull printing. This API is available in the following national cloud deployments.\n\nFind more info here:\n  https://learn.microsoft.com/graph/api/print-delete-taskdefinition?view=graph-rest-1.0";
        ...
        public Command BuildGetCommand() {
            ...
            command.Description = "Get details about a task definition. For details about how to use this API to add pull printing support to Universal Print, see Extending Universal Print to support pull printing. This API is available in the following national cloud deployments.\n\nFind more info here:\n  https://learn.microsoft.com/graph/api/printtaskdefinition-get?view=graph-rest-1.0";
            var printTaskDefinitionIdOption = new Option<string>("--print-task-definition-id", description: "The unique identifier of printTaskDefinition") {
            };
            printTaskDefinitionIdOption.IsRequired = true;
            command.AddOption(printTaskDefinitionIdOption);
        ...
        public Command BuildPatchCommand() {
            ...
            command.Description = "Update a task definition. For details about how to use this API to add pull printing support to Universal Print, see Extending Universal Print to support pull printing. This API is available in the following national cloud deployments.\n\nFind more info here:\n  https://learn.microsoft.com/graph/api/print-update-taskdefinition?view=graph-rest-1.0";
            var printTaskDefinitionIdOption = new Option<string>("--print-task-definition-id", description: "The unique identifier of printTaskDefinition") {
            };
            printTaskDefinitionIdOption.IsRequired = true;
            command.AddOption(printTaskDefinitionIdOption);
        ...
        public PrintTaskDefinitionItemRequestBuilder(string rawUrl) : base("{+baseurl}/print/taskDefinitions/{printTaskDefinition%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Delete a taskDefinition. For details about how to use this API to add pull printing support to Universal Print, see Extending Universal Print to support pull printing. This API is available in the following national cloud deployments.
        /// </summary>
