...
namespace ApiSdk.Print.TaskDefinitions.Item.Tasks.Item {
    ...
    public class PrintTaskRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string printTaskDefinitionId, string printTaskId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, printTaskDefinitionIdOption, printTaskIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// A list of tasks that have been created based on this definition. The list includes currently running tasks and recently completed tasks. Read-only.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string printTaskDefinitionId, string printTaskId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, printTaskDefinitionIdOption, printTaskIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// A list of tasks that have been created based on this definition. The list includes currently running tasks and recently completed tasks. Read-only.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string printTaskDefinitionId, string printTaskId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, printTaskDefinitionIdOption, printTaskIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
