...
namespace ApiSdk.Print.TaskDefinitions.Item.Tasks.Item {
    ...
    public class PrintTaskRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string printTaskDefinitionId, string printTaskId, IConsole console) => {
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string printTaskDefinitionId, string printTaskId, string body, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
