...
namespace ApiSdk.Print.TaskDefinitions.Item.Tasks.Item.Trigger.Ref {
    ...
    public class RefRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(printTaskDefinitionIdOption, printTaskIdOption, outputOption, queryOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// The printTaskTrigger that triggered this task's execution. Read-only.
