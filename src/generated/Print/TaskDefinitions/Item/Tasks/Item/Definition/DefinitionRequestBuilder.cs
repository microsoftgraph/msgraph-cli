...
namespace ApiSdk.Print.TaskDefinitions.Item.Tasks.Item.Definition {
    ...
    public class DefinitionRequestBuilder : BaseCliRequestBuilder {
        ...
        public DefinitionRequestBuilder(string rawUrl) : base("{+baseurl}/print/taskDefinitions/{printTaskDefinition%2Did}/tasks/{printTask%2Did}/definition{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// The printTaskDefinition that was used to create this task. Read-only.
        /// </summary>
