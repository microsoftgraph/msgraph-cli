...
namespace ApiSdk.Print.Services {
    ...
    public class ServicesRequestBuilder {
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(PrintService body, Action<ServicesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
