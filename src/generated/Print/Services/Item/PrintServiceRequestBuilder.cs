...
namespace ApiSdk.Print.Services.Item {
    ...
    public class PrintServiceRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            }, printServiceIdOption, new OutputFormatterFactoryBinder());
            return command;
        }
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string printServiceId, string[] select, string[] expand, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
            ...
            }, printServiceIdOption, selectOption, expandOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// The list of available Universal Print service endpoints.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string printServiceId, string body, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                ...
                await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                console.WriteLine("Success");
            }, printServiceIdOption, bodyOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
