...
namespace ApiSdk.Print.Services.Item {
    ...
    public class PrintServiceRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string printServiceId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, printServiceIdOption, new ServiceProviderBinder());
            return command;
        }
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string printServiceId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, printServiceIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The list of available Universal Print service endpoints.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string printServiceId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, printServiceIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
