...
namespace ApiSdk.Print.Services.Item {
    ...
    public class PrintServiceRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string printServiceId, IConsole console) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string printServiceId, string[] select, string[] expand, FormatterType output, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string printServiceId, string body, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
