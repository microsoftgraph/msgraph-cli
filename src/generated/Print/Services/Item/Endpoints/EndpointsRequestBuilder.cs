...
namespace ApiSdk.Print.Services.Item.Endpoints {
    ...
    public class EndpointsRequestBuilder {
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(PrintServiceEndpoint body, Action<EndpointsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
