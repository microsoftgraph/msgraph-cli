...
namespace ApiSdk.Print.Services.Item.Endpoints {
    ...
    public class EndpointsRequestBuilder {
        ...
        public Command BuildListCommand() {
            ...
            command.Handler = CommandHandler.Create<string, int?, int?, string, string, bool?, object, object, object>(async (printServiceId, top, skip, search, filter, count, orderby, select, expand) => {
