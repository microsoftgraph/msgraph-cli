...
namespace ApiSdk.Print.Services.Item.Endpoints {
    ...
    public class EndpointsRequestBuilder : BaseCliRequestBuilder {
        ...
        public EndpointsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/print/services/{printService%2Did}/endpoints{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Retrieve a list of endpoints exposed by a print service.
        /// </summary>
