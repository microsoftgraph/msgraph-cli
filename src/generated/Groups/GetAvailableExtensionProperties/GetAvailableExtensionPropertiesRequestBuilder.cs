    ...
    public class GetAvailableExtensionPropertiesRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Groups.GetAvailableExtensionProperties.GetAvailableExtensionPropertiesRequestBody>(ApiSdk.Groups.GetAvailableExtensionProperties.GetAvailableExtensionPropertiesRequestBody.CreateFromDiscriminatorValue);
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ApiSdk.Groups.GetAvailableExtensionProperties.GetAvailableExtensionPropertiesRequestBody body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
