...
using ApiSdk.Groups.Item.Events.Item.Instances.MicrosoftGraphDelta;
using ApiSdk.Models;
...
namespace ApiSdk.Groups.Item.Events.Item.Instances {
    ...
    public class InstancesRequestBuilder {
        ...
        public Command BuildCommand() {
            ...
            var builder = new ApiSdk.Groups.Item.Events.Item.Instances.Item.EventItemRequestBuilder(PathParameters, RequestAdapter);
