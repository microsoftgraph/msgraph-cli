    ...
    public class GetScheduleRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string>(async (groupId, eventId, body) => {
                ...
                var result = await RequestAdapter.SendCollectionAsync<ApiSdk.Groups.Item.Events.Item.Calendar.GetSchedule.GetSchedule>(requestInfo);
        ...
        /// </summary>
        public async Task<IEnumerable<ApiSdk.Groups.Item.Events.Item.Calendar.GetSchedule.GetSchedule>> PostAsync(GetScheduleRequestBody model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
