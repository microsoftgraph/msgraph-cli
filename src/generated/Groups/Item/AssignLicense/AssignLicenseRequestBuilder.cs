...
namespace ApiSdk.Groups.Item.AssignLicense {
    ...
    public class AssignLicenseRequestBuilder {
        ...
        /// </summary>
        public async Task<AssignLicenseResponse> PostAsync(AssignLicenseRequestBody model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
