...
namespace ApiSdk.Groups.Item.Calendar.Events.Item.Attachments.CreateUploadSession {
    ...
    public class CreateUploadSessionRequestBody : IAdditionalDataHolder, IParsable {
        ...
        /// </summary>
        public static ApiSdk.Groups.Item.Calendar.Events.Item.Attachments.CreateUploadSession.CreateUploadSessionRequestBody CreateFromDiscriminatorValue(IParseNode parseNode) {
