...
namespace ApiSdk.Groups.Item.Calendar.Events.Item.Calendar.AllowedCalendarSharingRolesWithUser {
    ...
    public class AllowedCalendarSharingRolesWithUserRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string groupId, string eventId, string User, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, groupIdOption, eventIdOption, UserOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
