...
namespace ApiSdk.Groups.Item.Calendar.Events.Item.Instances.Item.MicrosoftGraphTentativelyAccept {
    /// <summary>
    ...
    public class MicrosoftGraphTentativelyAcceptRequestBuilder {
        ...
        public MicrosoftGraphTentativelyAcceptRequestBuilder(Dictionary<string, object> pathParameters) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/calendar/events/{event%2Did}/instances/{event%2Did1}/microsoft.graph.tentativelyAccept";
