using ApiSdk.Groups.Item.Calendar.Events.Item.Instances.Item.Extensions.Count;
using ApiSdk.Groups.Item.Calendar.Events.Item.Instances.Item.Extensions.Item;
...
using System;
namespace ApiSdk.Groups.Item.Calendar.Events.Item.Instances.Item.Extensions {
    /// <summary>
    ...
    public class ExtensionsRequestBuilder : BaseCliRequestBuilder {
        ...
        public ExtensionsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/groups/{group%2Did}/calendar/events/{event%2Did}/instances/{event%2Did1}/extensions{?%24top,%24skip,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// The collection of open extensions defined for the event. Nullable.
        /// </summary>
