...
namespace ApiSdk.Groups.Item.Calendar.MicrosoftGraphAllowedCalendarSharingRolesWithUser {
    /// <summary>
    ...
    public class MicrosoftGraphAllowedCalendarSharingRolesWithUserRequestBuilder {
        ...
        public MicrosoftGraphAllowedCalendarSharingRolesWithUserRequestBuilder(Dictionary<string, object> pathParameters, string user = "") {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/calendar/microsoft.graph.allowedCalendarSharingRoles(User='{User}'){?%24top,%24skip,%24search,%24filter,%24count}";
