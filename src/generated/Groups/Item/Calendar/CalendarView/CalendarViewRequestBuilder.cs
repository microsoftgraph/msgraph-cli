...
namespace ApiSdk.Groups.Item.Calendar.CalendarView {
    ...
    public class CalendarViewRequestBuilder {
        ...
        public Command BuildListCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string, int?, int?, string, bool?, string[], string[]>(async (groupId, startDateTime, endDateTime, top, skip, filter, count, orderby, select) => {
