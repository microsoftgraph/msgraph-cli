...
namespace ApiSdk.Groups.Item.Calendar.CalendarView.Item.MicrosoftGraphTentativelyAccept {
    /// <summary>
    ...
    public class TentativelyAcceptRequestBuilder {
        ...
        public TentativelyAcceptRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/calendar/calendarView/{event%2Did}/microsoft.graph.tentativelyAccept";
