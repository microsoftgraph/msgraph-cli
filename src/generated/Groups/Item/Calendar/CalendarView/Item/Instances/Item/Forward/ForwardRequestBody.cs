...
namespace ApiSdk.Groups.Item.Calendar.CalendarView.Item.Instances.Item.Forward {
    ...
    public class ForwardRequestBody : IAdditionalDataHolder, IParsable {
        ...
        /// </summary>
        public static ApiSdk.Groups.Item.Calendar.CalendarView.Item.Instances.Item.Forward.ForwardRequestBody CreateFromDiscriminatorValue(IParseNode parseNode) {
