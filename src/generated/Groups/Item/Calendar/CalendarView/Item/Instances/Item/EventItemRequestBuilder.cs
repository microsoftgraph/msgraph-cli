...
using ApiSdk.Groups.Item.Calendar.CalendarView.Item.Instances.Item.MicrosoftGraphAccept;
using ApiSdk.Groups.Item.Calendar.CalendarView.Item.Instances.Item.MicrosoftGraphCancel;
using ApiSdk.Groups.Item.Calendar.CalendarView.Item.Instances.Item.MicrosoftGraphDecline;
using ApiSdk.Groups.Item.Calendar.CalendarView.Item.Instances.Item.MicrosoftGraphDismissReminder;
using ApiSdk.Groups.Item.Calendar.CalendarView.Item.Instances.Item.MicrosoftGraphForward;
using ApiSdk.Groups.Item.Calendar.CalendarView.Item.Instances.Item.MicrosoftGraphSnoozeReminder;
using ApiSdk.Groups.Item.Calendar.CalendarView.Item.Instances.Item.MicrosoftGraphTentativelyAccept;
using ApiSdk.Groups.Item.Calendar.CalendarView.Item.Instances.Item.MultiValueExtendedProperties;
using ApiSdk.Groups.Item.Calendar.CalendarView.Item.Instances.Item.SingleValueExtendedProperties;
using ApiSdk.Models;
...
namespace ApiSdk.Groups.Item.Calendar.CalendarView.Item.Instances.Item {
    ...
    public class EventItemRequestBuilder {
        ...
        public Command BuildCalendarCommand() {
            ...
            var builder = new ApiSdk.Groups.Item.Calendar.CalendarView.Item.Instances.Item.Calendar.CalendarRequestBuilder(PathParameters, RequestAdapter);
        ...
        public EventItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/calendar/calendarView/{event%2Did}/instances/{event%2Did1}{?%24select}";
