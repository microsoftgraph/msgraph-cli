...
namespace ApiSdk.Groups.Item.Calendar.CalendarView.Item.Instances.Item.Decline {
    ...
    public class DeclineRequestBody : IAdditionalDataHolder, IParsable {
        ...
        /// </summary>
        public static ApiSdk.Groups.Item.Calendar.CalendarView.Item.Instances.Item.Decline.DeclineRequestBody CreateFromDiscriminatorValue(IParseNode parseNode) {
