...
namespace ApiSdk.Groups.Item.Calendar.CalendarView.Item.Instances.Item.TentativelyAccept {
    ...
    public class TentativelyAcceptRequestBody : IAdditionalDataHolder, IParsable {
        ...
        /// </summary>
        public static ApiSdk.Groups.Item.Calendar.CalendarView.Item.Instances.Item.TentativelyAccept.TentativelyAcceptRequestBody CreateFromDiscriminatorValue(IParseNode parseNode) {
