...
namespace ApiSdk.Groups.Item.Calendar.CalendarView.Item.Attachments {
    ...
    public class AttachmentsRequestBuilder {
        ...
        public Command BuildCreateUploadSessionCommand() {
            ...
            var builder = new ApiSdk.Groups.Item.Calendar.CalendarView.Item.Attachments.CreateUploadSession.CreateUploadSessionRequestBuilder(PathParameters, RequestAdapter);
