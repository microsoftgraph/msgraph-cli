...
namespace ApiSdk.Groups.Item.Calendar {
    ...
    public class CalendarRequestBuilder {
        ...
        public Command BuildCalendarPermissionsCommand() {
            ...
            var builder = new ApiSdk.Groups.Item.Calendar.CalendarPermissions.CalendarPermissionsRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildCalendarViewCommand() {
            ...
            var builder = new ApiSdk.Groups.Item.Calendar.CalendarView.CalendarViewRequestBuilder(PathParameters, RequestAdapter);
            foreach (var cmd in builder.BuildCommand()) {
                command.AddCommand(cmd);
            }
            command.AddCommand(builder.BuildCreateCommand());
        ...
        public Command BuildEventsCommand() {
            ...
            var builder = new ApiSdk.Groups.Item.Calendar.Events.EventsRequestBuilder(PathParameters, RequestAdapter);
            foreach (var cmd in builder.BuildCommand()) {
                command.AddCommand(cmd);
            }
            command.AddCommand(builder.BuildCreateCommand());
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(groupIdOption, selectOption, outputOption, queryOption, jsonNoIndentOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        public Command BuildGetScheduleCommand() {
            var command = new Command("get-schedule");
            var builder = new ApiSdk.Groups.Item.Calendar.GetSchedule.GetScheduleRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildPostCommand());
            return command;
        }
        public Command BuildMultiValueExtendedPropertiesCommand() {
            var command = new Command("multi-value-extended-properties");
            var builder = new ApiSdk.Groups.Item.Calendar.MultiValueExtendedProperties.MultiValueExtendedPropertiesRequestBuilder(PathParameters, RequestAdapter);
            foreach (var cmd in builder.BuildCommand()) {
                command.AddCommand(cmd);
            }
            command.AddCommand(builder.BuildCreateCommand());
        ...
        public Command BuildSingleValueExtendedPropertiesCommand() {
            ...
            var builder = new ApiSdk.Groups.Item.Calendar.SingleValueExtendedProperties.SingleValueExtendedPropertiesRequestBuilder(PathParameters, RequestAdapter);
            foreach (var cmd in builder.BuildCommand()) {
                command.AddCommand(cmd);
            }
            command.AddCommand(builder.BuildCreateCommand());
