...
namespace ApiSdk.Groups.Item.Calendar {
    ...
    public class CalendarRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string groupId, string[] select, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
            ...
            }, groupIdOption, selectOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
