using ApiSdk.Groups.Item.CalendarView.Item.Instances.Item.Extensions.Count;
using ApiSdk.Groups.Item.CalendarView.Item.Instances.Item.Extensions.Item;
using ApiSdk.Models;
...
namespace ApiSdk.Groups.Item.CalendarView.Item.Instances.Item.Extensions {
    ...
    public class ExtensionsRequestBuilder {
        ...
        public ExtensionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/calendarView/{event%2Did}/instances/{event%2Did1}/extensions{?%24top,%24skip,%24filter,%24count,%24orderby,%24select,%24expand}";
