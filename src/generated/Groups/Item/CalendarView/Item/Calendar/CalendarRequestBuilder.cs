...
namespace ApiSdk.Groups.Item.CalendarView.Item.Calendar {
    ...
    public class CalendarRequestBuilder {
        ...
        public Command BuildCalendarPermissionsCommand() {
            ...
            var builder = new ApiSdk.Groups.Item.CalendarView.Item.Calendar.CalendarPermissions.CalendarPermissionsRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildCalendarViewCommand() {
            ...
            var builder = new ApiSdk.Groups.Item.CalendarView.Item.Calendar.CalendarView.CalendarViewRequestBuilder(PathParameters, RequestAdapter);
            foreach (var cmd in builder.BuildCommand()) {
                command.AddCommand(cmd);
            }
            command.AddCommand(builder.BuildCreateCommand());
        ...
        public Command BuildEventsCommand() {
            ...
            var builder = new ApiSdk.Groups.Item.CalendarView.Item.Calendar.Events.EventsRequestBuilder(PathParameters, RequestAdapter);
            foreach (var cmd in builder.BuildCommand()) {
                command.AddCommand(cmd);
            }
            command.AddCommand(builder.BuildCreateCommand());
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string groupId, string eventId, string[] select, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, groupIdOption, eventIdOption, selectOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        public Command BuildGetScheduleCommand() {
            var command = new Command("get-schedule");
            var builder = new ApiSdk.Groups.Item.CalendarView.Item.Calendar.GetSchedule.GetScheduleRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildPostCommand());
            return command;
        }
        public Command BuildMultiValueExtendedPropertiesCommand() {
            var command = new Command("multi-value-extended-properties");
            var builder = new ApiSdk.Groups.Item.CalendarView.Item.Calendar.MultiValueExtendedProperties.MultiValueExtendedPropertiesRequestBuilder(PathParameters, RequestAdapter);
            foreach (var cmd in builder.BuildCommand()) {
                command.AddCommand(cmd);
            }
            command.AddCommand(builder.BuildCreateCommand());
        ...
        public Command BuildSingleValueExtendedPropertiesCommand() {
            ...
            var builder = new ApiSdk.Groups.Item.CalendarView.Item.Calendar.SingleValueExtendedProperties.SingleValueExtendedPropertiesRequestBuilder(PathParameters, RequestAdapter);
            foreach (var cmd in builder.BuildCommand()) {
                command.AddCommand(cmd);
            }
            command.AddCommand(builder.BuildCreateCommand());
