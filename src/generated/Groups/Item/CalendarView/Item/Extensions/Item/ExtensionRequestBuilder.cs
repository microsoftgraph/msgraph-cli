...
namespace ApiSdk.Groups.Item.CalendarView.Item.Extensions.Item {
    ...
    public class ExtensionRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string groupId, string eventId, string extensionId) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string groupId, string eventId, string extensionId, string[] select, string[] expand) => {
            ...
            }, groupIdOption, eventIdOption, extensionIdOption, selectOption, expandOption);
            return command;
        }
        /// <summary>
        /// The collection of open extensions defined for the event. Nullable.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string groupId, string eventId, string extensionId, string body) => {
