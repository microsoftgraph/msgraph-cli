...
namespace ApiSdk.Groups.Item.Threads.Item {
    ...
    public class ConversationThreadRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string groupId, string conversationThreadId, IOutputFormatterFactory outputFormatterFactory, CancellationToken cancellationToken) => {
                var requestInfo = CreateDeleteRequestInformation(q => {
                });
                await RequestAdapter.SendNoContentAsync(requestInfo, errorMapping: default, cancellationToken: cancellationToken);
                Console.WriteLine("Success");
            }, groupIdOption, conversationThreadIdOption);
            return command;
        }
        /// <summary>
        /// The group's conversation threads. Nullable.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string groupId, string conversationThreadId, string[] select, FormatterType output, IOutputFormatterFactory outputFormatterFactory, CancellationToken cancellationToken) => {
            ...
            }, groupIdOption, conversationThreadIdOption, selectOption, outputOption);
            return command;
        }
        /// <summary>
        /// The group's conversation threads. Nullable.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string groupId, string conversationThreadId, string body, IOutputFormatterFactory outputFormatterFactory, CancellationToken cancellationToken) => {
