...
namespace ApiSdk.Groups.Item.Threads.Item {
    ...
    public class ConversationThreadRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string groupId, string conversationThreadId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, groupIdOption, conversationThreadIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The group's conversation threads. Nullable.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string groupId, string conversationThreadId, string[] select, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, groupIdOption, conversationThreadIdOption, selectOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The group's conversation threads. Nullable.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string groupId, string conversationThreadId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, groupIdOption, conversationThreadIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
