    ...
    public class CreateUploadSessionRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Groups.Item.Threads.Item.Posts.Item.InReplyTo.Attachments.CreateUploadSession.CreateUploadSessionRequestBody>(ApiSdk.Groups.Item.Threads.Item.Posts.Item.InReplyTo.Attachments.CreateUploadSession.CreateUploadSessionRequestBody.CreateFromDiscriminatorValue);
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ApiSdk.Groups.Item.Threads.Item.Posts.Item.InReplyTo.Attachments.CreateUploadSession.CreateUploadSessionRequestBody body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
