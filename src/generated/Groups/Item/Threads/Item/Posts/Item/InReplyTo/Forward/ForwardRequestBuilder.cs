    ...
    public class ForwardRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Groups.Item.Threads.Item.Posts.Item.InReplyTo.Forward.ForwardRequestBody>(ApiSdk.Groups.Item.Threads.Item.Posts.Item.InReplyTo.Forward.ForwardRequestBody.CreateFromDiscriminatorValue);
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ApiSdk.Groups.Item.Threads.Item.Posts.Item.InReplyTo.Forward.ForwardRequestBody body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
