using ApiSdk.Groups.Item.Threads.Item.Posts.Item.InReplyTo.Extensions.Count;
using ApiSdk.Groups.Item.Threads.Item.Posts.Item.InReplyTo.Extensions.Item;
...
using System;
namespace ApiSdk.Groups.Item.Threads.Item.Posts.Item.InReplyTo.Extensions {
    /// <summary>
    ...
    public class ExtensionsRequestBuilder : BaseCliRequestBuilder {
        ...
        public ExtensionsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/groups/{group%2Did}/threads/{conversationThread%2Did}/posts/{post%2Did}/inReplyTo/extensions{?%24top,%24skip,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// The collection of open extensions defined for the post. Read-only. Nullable. Supports $expand.
        /// </summary>
