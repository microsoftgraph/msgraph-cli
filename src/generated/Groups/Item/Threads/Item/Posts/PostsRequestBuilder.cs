...
namespace ApiSdk.Groups.Item.Threads.Item.Posts {
    ...
    public class PostsRequestBuilder {
        ...
        public Command BuildListCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, int?, int?, string, bool?, object, object, object>(async (groupId, conversationThreadId, top, skip, filter, count, orderby, select, expand) => {
