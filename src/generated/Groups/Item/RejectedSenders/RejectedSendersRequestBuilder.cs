    ...
    public class RejectedSendersRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.Handler = CommandHandler.Create<string, int?, int?, string, bool?, string[], string[]>(async (groupId, top, skip, filter, count, orderby, select) => {
                ...
                var result = await RequestAdapter.SendAsync<RejectedSendersResponse>(requestInfo);
        ...
        public Command BuildRefCommand() {
            ...
            var builder = new ApiSdk.Groups.Item.RejectedSenders.@Ref.RefRequestBuilder(PathParameters, RequestAdapter);
