...
namespace ApiSdk.Groups.Item.Photos.Item {
    ...
    public class ProfilePhotoItemRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(groupIdOption, profilePhotoIdOption, selectOption, outputOption, queryOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// The profile photos owned by the group. Read-only. Nullable.
