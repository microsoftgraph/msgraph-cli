...
namespace ApiSdk.Groups.Item.GroupLifecyclePolicies.Item {
    ...
    public class GroupLifecyclePolicyItemRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(groupIdOption, groupLifecyclePolicyIdOption, selectOption, expandOption, outputOption, outputFilterOption, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// The collection of lifecycle policies for this group. Read-only. Nullable.
