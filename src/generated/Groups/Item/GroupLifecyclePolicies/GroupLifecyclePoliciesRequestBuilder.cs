...
namespace ApiSdk.Groups.Item.GroupLifecyclePolicies {
    ...
    public class GroupLifecyclePoliciesRequestBuilder : BaseCliRequestBuilder {
        ...
        public Command BuildListCommand() {
            ...
            command.Description = "Retrieves a list of groupLifecyclePolicy objects to which a group belongs. This API is available in the following national cloud deployments.\n\nFind more info here:\n  https://learn.microsoft.com/graph/api/group-list-grouplifecyclepolicies?view=graph-rest-1.0";
            var groupIdOption = new Option<string>("--group-id", description: "The unique identifier of group") {
            };
            groupIdOption.IsRequired = true;
            command.AddOption(groupIdOption);
        ...
        public GroupLifecyclePoliciesRequestBuilder(string rawUrl) : base("{+baseurl}/groups/{group%2Did}/groupLifecyclePolicies{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Retrieves a list of groupLifecyclePolicy objects to which a group belongs. This API is available in the following national cloud deployments.
        /// </summary>
