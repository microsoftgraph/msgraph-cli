...
namespace ApiSdk.Groups.Item.GroupLifecyclePolicies {
    ...
    public class GroupLifecyclePoliciesRequestBuilder : BaseCliRequestBuilder {
        ...
        public GroupLifecyclePoliciesRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/groups/{group%2Did}/groupLifecyclePolicies{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// The collection of lifecycle policies for this group. Read-only. Nullable.
        /// </summary>
...
#nullable restore
        ...
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<GroupLifecyclePoliciesRequestBuilderGetQueryParameters>> requestConfiguration = default) {
            ...
            if (requestConfiguration != null) {
                var requestConfig = new RequestConfiguration<GroupLifecyclePoliciesRequestBuilderGetQueryParameters>();
