using ApiSdk.Groups.Item.TransitiveMembers.MicrosoftGraphServicePrincipal.Count;
using ApiSdk.Models;
...
namespace ApiSdk.Groups.Item.TransitiveMembers.MicrosoftGraphServicePrincipal {
    /// <summary>
