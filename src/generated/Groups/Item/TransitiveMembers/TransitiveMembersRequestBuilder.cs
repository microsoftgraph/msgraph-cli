...
using ApiSdk.Groups.Item.TransitiveMembers.MicrosoftGraphApplication;
using ApiSdk.Groups.Item.TransitiveMembers.MicrosoftGraphDevice;
using ApiSdk.Groups.Item.TransitiveMembers.MicrosoftGraphGroup;
using ApiSdk.Groups.Item.TransitiveMembers.MicrosoftGraphOrgContact;
using ApiSdk.Groups.Item.TransitiveMembers.MicrosoftGraphServicePrincipal;
using ApiSdk.Groups.Item.TransitiveMembers.MicrosoftGraphUser;
using ApiSdk.Models;
...
namespace ApiSdk.Groups.Item.TransitiveMembers {
    ...
    public class TransitiveMembersRequestBuilder {
        ...
        public TransitiveMembersRequestBuilder(Dictionary<string, object> pathParameters) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/transitiveMembers{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
