using ApiSdk.Groups.Item.TransitiveMembers.Device.Count;
using ApiSdk.Models;
...
namespace ApiSdk.Groups.Item.TransitiveMembers.Device {
    /// <summary>
    ...
    public class DeviceRequestBuilder {
        ...
        public DeviceRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/transitiveMembers/microsoft.graph.device{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
