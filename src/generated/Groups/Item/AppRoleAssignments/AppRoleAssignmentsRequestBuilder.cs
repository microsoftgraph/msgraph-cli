...
namespace ApiSdk.Groups.Item.AppRoleAssignments {
    ...
    public class AppRoleAssignmentsRequestBuilder : BaseCliRequestBuilder {
        ...
        public AppRoleAssignmentsRequestBuilder(string rawUrl) : base("{+baseurl}/groups/{group%2Did}/appRoleAssignments{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Represents the app roles a group has been granted for an application. Supports $expand.
        /// </summary>
