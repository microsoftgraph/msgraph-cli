...
namespace ApiSdk.Groups.Item.Members.Item.GraphApplication {
    ...
    public class GraphApplicationRequestBuilder : BaseCliRequestBuilder {
        ...
        public GraphApplicationRequestBuilder(string rawUrl) : base("{+baseurl}/groups/{group%2Did}/members/{directoryObject%2Did}/graph.application{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Get the item of type microsoft.graph.directoryObject as microsoft.graph.application
        /// </summary>
