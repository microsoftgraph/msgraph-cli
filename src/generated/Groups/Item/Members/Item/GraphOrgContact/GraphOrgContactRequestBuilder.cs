...
namespace ApiSdk.Groups.Item.Members.Item.GraphOrgContact {
    ...
    public class GraphOrgContactRequestBuilder : BaseCliRequestBuilder {
        ...
        public GraphOrgContactRequestBuilder(string rawUrl) : base("{+baseurl}/groups/{group%2Did}/members/{directoryObject%2Did}/graph.orgContact{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Get the item of type microsoft.graph.directoryObject as microsoft.graph.orgContact
        /// </summary>
