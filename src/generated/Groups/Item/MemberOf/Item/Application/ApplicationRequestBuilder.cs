...
namespace ApiSdk.Groups.Item.MemberOf.Item.Application {
    /// <summary>
    ...
    public class ApplicationRequestBuilder {
        ...
        public ApplicationRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/memberOf/{directoryObject%2Did}/microsoft.graph.application{?%24select,%24expand}";
