...
namespace ApiSdk.Groups.Item.PermissionGrants {
    ...
    public class PermissionGrantsRequestBuilder {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<ResourceSpecificPermissionGrant> PostAsync(ResourceSpecificPermissionGrant model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
