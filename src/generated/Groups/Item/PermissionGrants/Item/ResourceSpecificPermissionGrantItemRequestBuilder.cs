...
namespace ApiSdk.Groups.Item.PermissionGrants.Item {
    ...
    public class ResourceSpecificPermissionGrantItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public ResourceSpecificPermissionGrantItemRequestBuilder(string rawUrl) : base("{+baseurl}/groups/{group%2Did}/permissionGrants/{resourceSpecificPermissionGrant%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Delete navigation property permissionGrants for groups
        /// </summary>
