...
namespace ApiSdk.Groups.Item.PermissionGrants.Item.MicrosoftGraphCheckMemberObjects {
    /// <summary>
    ...
    public class CheckMemberObjectsRequestBuilder {
        ...
        public CheckMemberObjectsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/permissionGrants/{resourceSpecificPermissionGrant%2Did}/microsoft.graph.checkMemberObjects";
