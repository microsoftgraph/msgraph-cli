...
namespace ApiSdk.Groups.Item.PermissionGrants.Item {
    ...
    public class ResourceSpecificPermissionGrantRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            }, groupIdOption, resourceSpecificPermissionGrantIdOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// The permissions that have been granted for a group to a specific application. Supports $expand.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string groupId, string resourceSpecificPermissionGrantId, string[] select, string[] expand, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
            ...
            }, groupIdOption, resourceSpecificPermissionGrantIdOption, selectOption, expandOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// The permissions that have been granted for a group to a specific application. Supports $expand.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string groupId, string resourceSpecificPermissionGrantId, string body, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                ...
                await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                console.WriteLine("Success");
            }, groupIdOption, resourceSpecificPermissionGrantIdOption, bodyOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
