...
namespace ApiSdk.Groups.Item.PermissionGrants.Item {
    ...
    public class ResourceSpecificPermissionGrantRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string groupId, string resourceSpecificPermissionGrantId) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string groupId, string resourceSpecificPermissionGrantId, string[] select, string[] expand) => {
            ...
            }, groupIdOption, resourceSpecificPermissionGrantIdOption, selectOption, expandOption);
            return command;
        }
        /// <summary>
        /// The permissions that have been granted for a group to a specific application. Supports $expand.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string groupId, string resourceSpecificPermissionGrantId, string body) => {
