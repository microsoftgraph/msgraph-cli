...
namespace ApiSdk.Groups.Item.Onenote.SectionGroups.Item.ParentNotebook.Sections.Item.Pages.Item.ParentSection {
    ...
    public class ParentSectionRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string, string>(async (groupId, sectionGroupId, onenoteSectionId, onenotePageId) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string, string, object, object>(async (groupId, sectionGroupId, onenoteSectionId, onenotePageId, select, expand) => {
        ...
        public Command BuildPatchCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string, string, string>(async (groupId, sectionGroupId, onenoteSectionId, onenotePageId, body) => {
