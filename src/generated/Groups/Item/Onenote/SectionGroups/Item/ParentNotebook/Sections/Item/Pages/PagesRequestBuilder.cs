...
namespace ApiSdk.Groups.Item.Onenote.SectionGroups.Item.ParentNotebook.Sections.Item.Pages {
    ...
    public class PagesRequestBuilder {
        ...
        public Command BuildListCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string, int?, int?, string, string, bool?, object, object, object>(async (groupId, sectionGroupId, onenoteSectionId, top, skip, search, filter, count, orderby, select, expand) => {
