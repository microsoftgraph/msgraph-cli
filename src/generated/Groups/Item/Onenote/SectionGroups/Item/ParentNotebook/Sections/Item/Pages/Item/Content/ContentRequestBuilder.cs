...
namespace ApiSdk.Groups.Item.Onenote.SectionGroups.Item.ParentNotebook.Sections.Item.Pages.Item.Content {
    ...
    public class ContentRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string groupId, string sectionGroupId, string onenoteSectionId, string onenotePageId, FileInfo file, FormatterType output, IConsole console) => {
        ...
        public Command BuildPutCommand() {
            ...
            command.SetHandler(async (string groupId, string sectionGroupId, string onenoteSectionId, string onenotePageId, FileInfo file, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
