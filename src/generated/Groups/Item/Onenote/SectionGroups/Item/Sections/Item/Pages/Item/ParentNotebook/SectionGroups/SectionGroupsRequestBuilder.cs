...
namespace ApiSdk.Groups.Item.Onenote.SectionGroups.Item.Sections.Item.Pages.Item.ParentNotebook.SectionGroups {
    ...
    public class SectionGroupsRequestBuilder {
        ...
        public Command BuildListCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string, string, int?, int?, string, string, bool?, object, object, object>(async (groupId, sectionGroupId, onenoteSectionId, onenotePageId, top, skip, search, filter, count, orderby, select, expand) => {
