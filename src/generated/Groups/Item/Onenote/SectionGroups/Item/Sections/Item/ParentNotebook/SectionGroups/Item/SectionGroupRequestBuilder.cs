...
namespace ApiSdk.Groups.Item.Onenote.SectionGroups.Item.Sections.Item.ParentNotebook.SectionGroups.Item {
    ...
    public class SectionGroupRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string, string, string[], string[]>(async (groupId, sectionGroupId, onenoteSectionId, sectionGroupId1, select, expand) => {
