...
namespace ApiSdk.Groups.Item.Onenote.SectionGroups.Item.Sections.Item.ParentNotebook.SectionGroups.Item {
    ...
    public class SectionGroupRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string groupId, string sectionGroupId, string onenoteSectionId, string sectionGroupId1) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string groupId, string sectionGroupId, string onenoteSectionId, string sectionGroupId1, string[] select, string[] expand) => {
            ...
            }, groupIdOption, sectionGroupIdOption, onenoteSectionIdOption, sectionGroupId1Option, selectOption, expandOption);
            return command;
        }
        /// <summary>
        /// The section groups in the notebook. Read-only. Nullable.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string groupId, string sectionGroupId, string onenoteSectionId, string sectionGroupId1, string body) => {
