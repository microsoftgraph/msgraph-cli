    ...
    public class CopyToNotebookRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string, string, string, string>(async (groupId, sectionGroupId, onenoteSectionId, onenotePageId, onenoteSectionId1, body) => {
                ...
                var result = await RequestAdapter.SendAsync<CopyToNotebookResponse>(requestInfo);
        ...
        /// </summary>
        public async Task<CopyToNotebookResponse> PostAsync(CopyToNotebookRequestBody model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
