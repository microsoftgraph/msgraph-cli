...
namespace ApiSdk.Groups.Item.Onenote.SectionGroups.Item.SectionGroups.Item {
    ...
    public class SectionGroupRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string>(async (groupId, sectionGroupId, sectionGroupId1) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string, object, object>(async (groupId, sectionGroupId, sectionGroupId1, select, expand) => {
        ...
        public Command BuildPatchCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string, string>(async (groupId, sectionGroupId, sectionGroupId1, body) => {
