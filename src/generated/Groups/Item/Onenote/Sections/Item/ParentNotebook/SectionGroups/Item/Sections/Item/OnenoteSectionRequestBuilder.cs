...
namespace ApiSdk.Groups.Item.Onenote.Sections.Item.ParentNotebook.SectionGroups.Item.Sections.Item {
    ...
    public class OnenoteSectionRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string, string, string[], string[]>(async (groupId, onenoteSectionId, sectionGroupId, onenoteSectionId1, select, expand) => {
