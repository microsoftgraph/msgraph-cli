...
namespace ApiSdk.Groups.Item.Onenote.Sections.Item.ParentNotebook.SectionGroups.Item.Sections {
    ...
    public class SectionsRequestBuilder {
        ...
        public Command BuildCreateCommand() {
            ...
            command.SetHandler(async (string groupId, string onenoteSectionId, string sectionGroupId, string body, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, groupIdOption, onenoteSectionIdOption, sectionGroupIdOption, bodyOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The sections in the section group. Read-only. Nullable.
        ...
        public Command BuildListCommand() {
            ...
            command.AddOption(outputOption);
            command.SetHandler(async (string groupId, string onenoteSectionId, string sectionGroupId, int? top, int? skip, string search, string filter, bool? count, string[] orderby, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, groupIdOption, onenoteSectionIdOption, sectionGroupIdOption, topOption, skipOption, searchOption, filterOption, countOption, orderbyOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
