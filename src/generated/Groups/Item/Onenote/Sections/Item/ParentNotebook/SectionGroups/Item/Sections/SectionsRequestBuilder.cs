...
namespace ApiSdk.Groups.Item.Onenote.Sections.Item.ParentNotebook.SectionGroups.Item.Sections {
    ...
    public class SectionsRequestBuilder {
        ...
        public Command BuildListCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string, int?, int?, string, string, bool?, string[], string[], string[]>(async (groupId, onenoteSectionId, sectionGroupId, top, skip, search, filter, count, orderby, select, expand) => {
