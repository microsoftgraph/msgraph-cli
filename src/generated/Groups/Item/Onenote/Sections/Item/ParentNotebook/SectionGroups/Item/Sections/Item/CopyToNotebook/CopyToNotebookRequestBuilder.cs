...
namespace ApiSdk.Groups.Item.Onenote.Sections.Item.ParentNotebook.SectionGroups.Item.Sections.Item.CopyToNotebook {
    ...
    public class CopyToNotebookRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (string groupId, string onenoteSectionId, string sectionGroupId, string onenoteSectionId1, string body) => {
            ...
            }, groupIdOption, onenoteSectionIdOption, sectionGroupIdOption, onenoteSectionId1Option, bodyOption);
            return command;
        }
        /// <summary>
