...
namespace ApiSdk.Groups.Item.Onenote.Sections.Item.Pages.Item.ParentNotebook.SectionGroups.Item.Sections.Item {
    ...
    public class OnenoteSectionRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string, string, string>(async (groupId, onenoteSectionId, onenotePageId, sectionGroupId, onenoteSectionId1) => {
                ...
                if (!String.IsNullOrEmpty(onenoteSectionId1)) requestInfo.PathParameters.Add("onenoteSection_id1", onenoteSectionId1);
        ...
        public Command BuildGetCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string, string, string, object, object>(async (groupId, onenoteSectionId, onenotePageId, sectionGroupId, onenoteSectionId1, select, expand) => {
        ...
        public Command BuildPatchCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string, string, string, string>(async (groupId, onenoteSectionId, onenotePageId, sectionGroupId, onenoteSectionId1, body) => {
