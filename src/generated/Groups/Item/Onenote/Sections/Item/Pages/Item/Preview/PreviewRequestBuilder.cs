...
namespace ApiSdk.Groups.Item.Onenote.Sections.Item.Pages.Item.Preview {
    ...
    public class PreviewRequestBuilder : BaseCliRequestBuilder {
        ...
        public PreviewRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/groups/{group%2Did}/onenote/sections/{onenoteSection%2Did}/pages/{onenotePage%2Did}/preview()", pathParameters) {
        }
        /// <summary>
        /// Invoke function preview
        /// </summary>
