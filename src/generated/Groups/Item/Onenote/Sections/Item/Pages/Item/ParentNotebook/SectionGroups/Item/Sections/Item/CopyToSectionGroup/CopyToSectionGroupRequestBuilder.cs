...
namespace ApiSdk.Groups.Item.Onenote.Sections.Item.Pages.Item.ParentNotebook.SectionGroups.Item.Sections.Item.CopyToSectionGroup {
    ...
    public class CopyToSectionGroupRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (string groupId, string onenoteSectionId, string onenotePageId, string sectionGroupId, string onenoteSectionId1, string body, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, groupIdOption, onenoteSectionIdOption, onenotePageIdOption, sectionGroupIdOption, onenoteSectionId1Option, bodyOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
