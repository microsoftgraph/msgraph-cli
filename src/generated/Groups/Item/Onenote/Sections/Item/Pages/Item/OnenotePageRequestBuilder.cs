...
namespace ApiSdk.Groups.Item.Onenote.Sections.Item.Pages.Item {
    ...
    public class OnenotePageRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string groupId, string onenoteSectionId, string onenotePageId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, groupIdOption, onenoteSectionIdOption, onenotePageIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The collection of pages in the section.  Read-only. Nullable.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string groupId, string onenoteSectionId, string onenotePageId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, groupIdOption, onenoteSectionIdOption, onenotePageIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string groupId, string onenoteSectionId, string onenotePageId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, groupIdOption, onenoteSectionIdOption, onenotePageIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
