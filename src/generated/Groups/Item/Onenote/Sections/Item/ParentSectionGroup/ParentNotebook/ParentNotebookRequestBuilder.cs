...
namespace ApiSdk.Groups.Item.Onenote.Sections.Item.ParentSectionGroup.ParentNotebook {
    ...
    public class ParentNotebookRequestBuilder {
        ...
        public Command BuildCopyNotebookCommand() {
            ...
            var builder = new ApiSdk.Groups.Item.Onenote.Sections.Item.ParentSectionGroup.ParentNotebook.CopyNotebook.CopyNotebookRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildSectionGroupsCommand() {
            ...
            var builder = new ApiSdk.Groups.Item.Onenote.Sections.Item.ParentSectionGroup.ParentNotebook.SectionGroups.SectionGroupsRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildSectionsCommand() {
            ...
            var builder = new ApiSdk.Groups.Item.Onenote.Sections.Item.ParentSectionGroup.ParentNotebook.Sections.SectionsRequestBuilder(PathParameters, RequestAdapter);
            foreach (var cmd in builder.BuildCommand()) {
                command.AddCommand(cmd);
            }
            command.AddCommand(builder.BuildCreateCommand());
