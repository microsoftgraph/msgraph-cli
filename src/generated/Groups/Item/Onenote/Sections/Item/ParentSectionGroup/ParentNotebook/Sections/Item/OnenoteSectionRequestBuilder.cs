...
namespace ApiSdk.Groups.Item.Onenote.Sections.Item.ParentSectionGroup.ParentNotebook.Sections.Item {
    ...
    public class OnenoteSectionRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string groupId, string onenoteSectionId, string onenoteSectionId1, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, groupIdOption, onenoteSectionIdOption, onenoteSectionId1Option, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The sections in the notebook. Read-only. Nullable.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string groupId, string onenoteSectionId, string onenoteSectionId1, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, groupIdOption, onenoteSectionIdOption, onenoteSectionId1Option, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The sections in the notebook. Read-only. Nullable.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string groupId, string onenoteSectionId, string onenoteSectionId1, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, groupIdOption, onenoteSectionIdOption, onenoteSectionId1Option, bodyOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
