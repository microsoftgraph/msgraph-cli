...
namespace ApiSdk.Groups.Item.Onenote.Operations.Item {
    ...
    public class OnenoteOperationItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public OnenoteOperationItemRequestBuilder(string rawUrl) : base("{+baseurl}/groups/{group%2Did}/onenote/operations/{onenoteOperation%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Delete navigation property operations for groups
        /// </summary>
