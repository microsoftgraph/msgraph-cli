...
using ApiSdk.Groups.Item.Onenote.Notebooks.MicrosoftGraphGetNotebookFromWebUrl;
using ApiSdk.Groups.Item.Onenote.Notebooks.MicrosoftGraphGetRecentNotebooksWithIncludePersonalNotebooks;
using ApiSdk.Models;
