...
namespace ApiSdk.Groups.Item.Onenote.Notebooks {
    ...
    public class NotebooksRequestBuilder : BaseCliRequestBuilder {
        ...
        public NotebooksRequestBuilder(string rawUrl) : base("{+baseurl}/groups/{group%2Did}/onenote/notebooks{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Retrieve a list of notebook objects. This API is available in the following national cloud deployments.
        /// </summary>
