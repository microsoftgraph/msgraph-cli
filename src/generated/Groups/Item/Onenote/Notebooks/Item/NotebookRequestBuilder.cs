...
namespace ApiSdk.Groups.Item.Onenote.Notebooks.Item {
    ...
    public class NotebookRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string groupId, string notebookId) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string groupId, string notebookId, string[] select, string[] expand) => {
            ...
            }, groupIdOption, notebookIdOption, selectOption, expandOption);
            return command;
        }
        /// <summary>
        /// The collection of OneNote notebooks that are owned by the user or group. Read-only. Nullable.
