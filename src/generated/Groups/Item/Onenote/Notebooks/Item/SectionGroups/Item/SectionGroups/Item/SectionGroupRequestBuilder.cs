...
namespace ApiSdk.Groups.Item.Onenote.Notebooks.Item.SectionGroups.Item.SectionGroups.Item {
    ...
    public class SectionGroupRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string groupId, string notebookId, string sectionGroupId, string sectionGroupId1) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string groupId, string notebookId, string sectionGroupId, string sectionGroupId1, string[] select, string[] expand) => {
            ...
            }, groupIdOption, notebookIdOption, sectionGroupIdOption, sectionGroupId1Option, selectOption, expandOption);
            return command;
        }
        /// <summary>
        /// The section groups in the section. Read-only. Nullable.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string groupId, string notebookId, string sectionGroupId, string sectionGroupId1, string body) => {
