...
namespace ApiSdk.Groups.Item.Onenote.Notebooks.Item.SectionGroups {
    ...
    public class SectionGroupsRequestBuilder {
        ...
        public Command BuildListCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, int?, int?, string, string, bool?, string[], string[], string[]>(async (groupId, notebookId, top, skip, search, filter, count, orderby, select, expand) => {
