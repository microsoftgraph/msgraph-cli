...
namespace ApiSdk.Groups.Item.Onenote.Notebooks.Item.SectionGroups.Item.Sections.Item
{
    ...
    public class OnenoteSectionItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildCopyToNotebookNavCommand()
        {
            ...
            var builder = new ApiSdk.Groups.Item.Onenote.Notebooks.Item.SectionGroups.Item.Sections.Item.CopyToNotebook.CopyToNotebookRequestBuilder(PathParameters);
        ...
        public Command BuildCopyToSectionGroupNavCommand()
        {
            ...
            var builder = new ApiSdk.Groups.Item.Onenote.Notebooks.Item.SectionGroups.Item.Sections.Item.CopyToSectionGroup.CopyToSectionGroupRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildPagesNavCommand()
        {
            ...
            var builder = new ApiSdk.Groups.Item.Onenote.Notebooks.Item.SectionGroups.Item.Sections.Item.Pages.PagesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildParentNotebookNavCommand()
        {
            ...
            var builder = new ApiSdk.Groups.Item.Onenote.Notebooks.Item.SectionGroups.Item.Sections.Item.ParentNotebook.ParentNotebookRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildParentSectionGroupNavCommand()
        {
            ...
            var builder = new ApiSdk.Groups.Item.Onenote.Notebooks.Item.SectionGroups.Item.Sections.Item.ParentSectionGroup.ParentSectionGroupRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Groups.Item.Onenote.Notebooks.Item.SectionGroups.Item.Sections.Item.OnenoteSectionItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Groups.Item.Onenote.Notebooks.Item.SectionGroups.Item.Sections.Item.OnenoteSectionItemRequestBuilder.OnenoteSectionItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Groups.Item.Onenote.Notebooks.Item.SectionGroups.Item.Sections.Item.OnenoteSectionItemRequestBuilder.OnenoteSectionItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
