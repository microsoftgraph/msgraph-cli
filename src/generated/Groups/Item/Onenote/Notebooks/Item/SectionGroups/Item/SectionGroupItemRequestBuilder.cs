...
namespace ApiSdk.Groups.Item.Onenote.Notebooks.Item.SectionGroups.Item {
    ...
    public class SectionGroupItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public Command BuildSectionGroupsNavCommand() {
            ...
            var builder = new ApiSdk.Groups.Item.Onenote.Notebooks.Item.SectionGroups.Item.SectionGroups.SectionGroupsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public SectionGroupItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/groups/{group%2Did}/onenote/notebooks/{notebook%2Did}/sectionGroups/{sectionGroup%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Delete navigation property sectionGroups for groups
        /// </summary>
