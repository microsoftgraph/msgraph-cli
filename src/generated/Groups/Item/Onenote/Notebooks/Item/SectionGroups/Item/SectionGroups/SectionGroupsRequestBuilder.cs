...
namespace ApiSdk.Groups.Item.Onenote.Notebooks.Item.SectionGroups.Item.SectionGroups {
    ...
    public class SectionGroupsRequestBuilder {
        ...
        public List<Command> BuildCommand() {
            var builder = new ApiSdk.Groups.Item.Onenote.Notebooks.Item.SectionGroups.Item.SectionGroups.Item.SectionGroupItemRequestBuilder(PathParameters, RequestAdapter);
