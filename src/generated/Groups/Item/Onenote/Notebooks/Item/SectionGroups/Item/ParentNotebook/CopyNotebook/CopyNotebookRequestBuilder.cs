...
namespace ApiSdk.Groups.Item.Onenote.Notebooks.Item.SectionGroups.Item.ParentNotebook.CopyNotebook {
    ...
    public class CopyNotebookRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            }, new CollectionBinding(groupIdOption, notebookIdOption, sectionGroupIdOption, bodyOption, outputOption, outputFilterOption, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
