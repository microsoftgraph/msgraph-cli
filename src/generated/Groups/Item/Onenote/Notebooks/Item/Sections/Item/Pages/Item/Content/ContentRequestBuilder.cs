...
namespace ApiSdk.Groups.Item.Onenote.Notebooks.Item.Sections.Item.Pages.Item.Content {
    ...
    public class ContentRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string groupId, string notebookId, string onenoteSectionId, string onenotePageId, FileInfo output) => {
            ...
            }, groupIdOption, notebookIdOption, onenoteSectionIdOption, onenotePageIdOption, outputOption);
            return command;
        }
        /// <summary>
        ...
        public Command BuildPutCommand() {
            ...
            command.SetHandler(async (string groupId, string notebookId, string onenoteSectionId, string onenotePageId, FileInfo file) => {
