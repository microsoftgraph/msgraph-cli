...
namespace ApiSdk.Groups.Item.Onenote.Pages.Item.ParentSection.ParentNotebook.SectionGroups.Item.ParentNotebook {
    ...
    public class ParentNotebookRequestBuilder {
        ...
        public Command BuildCopyNotebookCommand() {
            ...
            var builder = new ApiSdk.Groups.Item.Onenote.Pages.Item.ParentSection.ParentNotebook.SectionGroups.Item.ParentNotebook.CopyNotebook.CopyNotebookRequestBuilder(PathParameters, RequestAdapter);
