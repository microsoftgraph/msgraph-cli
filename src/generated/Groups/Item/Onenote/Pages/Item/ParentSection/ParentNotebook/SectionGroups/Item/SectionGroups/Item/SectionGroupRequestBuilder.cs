...
namespace ApiSdk.Groups.Item.Onenote.Pages.Item.ParentSection.ParentNotebook.SectionGroups.Item.SectionGroups.Item {
    ...
    public class SectionGroupRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string, string, string[], string[]>(async (groupId, onenotePageId, sectionGroupId, sectionGroupId1, select, expand) => {
