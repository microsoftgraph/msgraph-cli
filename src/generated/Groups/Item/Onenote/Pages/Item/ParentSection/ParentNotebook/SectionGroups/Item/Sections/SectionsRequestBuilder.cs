...
namespace ApiSdk.Groups.Item.Onenote.Pages.Item.ParentSection.ParentNotebook.SectionGroups.Item.Sections {
    ...
    public class SectionsRequestBuilder {
        ...
        public Command BuildListCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string, int?, int?, string, string, bool?, object, object, object>(async (groupId, onenotePageId, sectionGroupId, top, skip, search, filter, count, orderby, select, expand) => {
