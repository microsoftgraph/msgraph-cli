...
namespace ApiSdk.Groups.Item.Onenote.Pages.Item.ParentSection.Pages.Item {
    ...
    public class OnenotePageRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string groupId, string onenotePageId, string onenotePageId1) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string groupId, string onenotePageId, string onenotePageId1, string[] select, string[] expand) => {
            ...
            }, groupIdOption, onenotePageIdOption, onenotePageId1Option, selectOption, expandOption);
            return command;
        }
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string groupId, string onenotePageId, string onenotePageId1, string body) => {
