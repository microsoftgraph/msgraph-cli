...
namespace ApiSdk.Groups.Item.Onenote.Pages.Item.ParentSection.Pages.Item {
    ...
    public class OnenotePageRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string>(async (groupId, onenotePageId, onenotePageId1) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string, string[], string[]>(async (groupId, onenotePageId, onenotePageId1, select, expand) => {
        ...
        public Command BuildPatchCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string, string>(async (groupId, onenotePageId, onenotePageId1, body) => {
