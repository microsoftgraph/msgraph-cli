...
namespace ApiSdk.Groups.Item.Onenote.Pages.Item.ParentSection.ParentNotebook.Sections.Item.CopyToSectionGroup {
    ...
    public class CopyToSectionGroupRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (string groupId, string onenotePageId, string onenoteSectionId, string body, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, groupIdOption, onenotePageIdOption, onenoteSectionIdOption, bodyOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
