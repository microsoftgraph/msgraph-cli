...
namespace ApiSdk.Groups.Item.Onenote.Pages.Item.ParentNotebook.SectionGroups.Item.Sections.Item.ParentNotebook {
    ...
    public class ParentNotebookRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string groupId, string onenotePageId, string sectionGroupId, string onenoteSectionId, string[] select, string[] expand) => {
            ...
            }, groupIdOption, onenotePageIdOption, sectionGroupIdOption, onenoteSectionIdOption, selectOption, expandOption);
            return command;
        }
        /// <summary>
        /// The notebook that contains the section.  Read-only.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string groupId, string onenotePageId, string sectionGroupId, string onenoteSectionId, string body) => {
