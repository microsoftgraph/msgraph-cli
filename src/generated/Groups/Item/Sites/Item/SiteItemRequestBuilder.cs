...
namespace ApiSdk.Groups.Item.Sites.Item
{
    ...
    public partial class SiteItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildGetActivitiesByIntervalNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Sites.Item.GetActivitiesByInterval.GetActivitiesByIntervalRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildTermStoresNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.Sites.Item.TermStores.TermStoresRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
