...
namespace ApiSdk.Groups.Item.Sites.Item.TermStores.Item.Sets.Item.ParentGroup.Sets.Item.Children.Item.Children.Item {
    ...
    public class TermItemRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            }, new CollectionBinding(groupIdOption, siteIdOption, storeIdOption, setIdOption, setId1Option, termIdOption, termId1Option, new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        ...
        public TermItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group_id}/sites/{site_id}/termStores/{store_id}/sets/{set_id}/parentGroup/sets/{set_id1}/children/{term_id}/children/{term_id1}{?select,expand}";
