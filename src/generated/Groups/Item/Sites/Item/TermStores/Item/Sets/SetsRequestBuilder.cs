using ApiSdk.Groups.Item.Sites.Item.TermStores.Item.Sets.Count;
using ApiSdk.Groups.Item.Sites.Item.TermStores.Item.Sets.Item;
...
namespace ApiSdk.Groups.Item.Sites.Item.TermStores.Item.Sets {
    ...
    public class SetsRequestBuilder {
        ...
        public SetsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/termStores/{store%2Did}/sets{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
