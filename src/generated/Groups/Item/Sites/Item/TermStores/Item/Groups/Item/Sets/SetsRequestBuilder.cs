using ApiSdk.Groups.Item.Sites.Item.TermStores.Item.Groups.Item.Sets.Count;
using ApiSdk.Groups.Item.Sites.Item.TermStores.Item.Groups.Item.Sets.Item;
...
namespace ApiSdk.Groups.Item.Sites.Item.TermStores.Item.Groups.Item.Sets {
    ...
    public class SetsRequestBuilder {
        ...
        public Command BuildCreateCommand() {
            ...
            }, new CollectionBinding(groupIdOption, siteIdOption, storeIdOption, groupId1Option, bodyOption, outputOption, queryOption, jsonNoIndentOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
