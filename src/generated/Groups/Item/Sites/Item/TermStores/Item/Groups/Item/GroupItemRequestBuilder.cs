...
namespace ApiSdk.Groups.Item.Sites.Item.TermStores.Item.Groups.Item {
    ...
    public class GroupItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public GroupItemRequestBuilder(string rawUrl) : base("{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/termStores/{store%2Did}/groups/{group%2Did1}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Delete a group object in a term store]. This API is available in the following [national cloud deployments.
        /// </summary>
