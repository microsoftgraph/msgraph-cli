...
namespace ApiSdk.Groups.Item.Sites.Item.TermStores.Item.Sets.Item.Terms.Item.Children.Item {
    ...
    public class TermItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public TermItemRequestBuilder(string rawUrl) : base("{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/termStores/{store%2Did}/sets/{set%2Did}/terms/{term%2Did}/children/{term%2Did1}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Delete navigation property children for groups
        /// </summary>
