using ApiSdk.Groups.Item.Sites.Item.TermStores.Item.Groups;
using ApiSdk.Groups.Item.Sites.Item.TermStores.Item.Sets;
...
namespace ApiSdk.Groups.Item.Sites.Item.TermStores.Item {
    ...
    public class StoreItemRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            }, new CollectionBinding(groupIdOption, siteIdOption, storeIdOption, ifMatchOption, new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(groupIdOption, siteIdOption, storeIdOption, selectOption, expandOption, outputOption, queryOption, jsonNoIndentOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        public Command BuildGroupsCommand() {
            var command = new Command("groups");
            var builder = new ApiSdk.Groups.Item.Sites.Item.TermStores.Item.Groups.GroupsRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                await RequestAdapter.SendNoContentAsync(requestInfo, errorMapping: errorMapping, cancellationToken: cancellationToken);
                Console.WriteLine("Success");
            }, new CollectionBinding(groupIdOption, siteIdOption, storeIdOption, bodyOption, new TypeBinding(typeof(CancellationToken))));
            return command;
        }
