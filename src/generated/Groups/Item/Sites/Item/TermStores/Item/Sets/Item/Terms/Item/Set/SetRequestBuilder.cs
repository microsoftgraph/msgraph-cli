...
namespace ApiSdk.Groups.Item.Sites.Item.TermStores.Item.Sets.Item.Terms.Item.Set {
    ...
    public class SetRequestBuilder : BaseCliRequestBuilder {
        ...
        public SetRequestBuilder(string rawUrl) : base("{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/termStores/{store%2Did}/sets/{set%2Did}/terms/{term%2Did}/set{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// The [set] in which the term is created.
        /// </summary>
