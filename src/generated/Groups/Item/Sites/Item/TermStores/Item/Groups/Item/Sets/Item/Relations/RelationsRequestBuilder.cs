using ApiSdk.Groups.Item.Sites.Item.TermStores.Item.Groups.Item.Sets.Item.Relations.Count;
using ApiSdk.Groups.Item.Sites.Item.TermStores.Item.Groups.Item.Sets.Item.Relations.Item;
...
namespace ApiSdk.Groups.Item.Sites.Item.TermStores.Item.Groups.Item.Sets.Item.Relations {
    /// <summary>
    ...
    public class RelationsRequestBuilder : BaseCliRequestBuilder {
        ...
        public RelationsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/termStores/{store%2Did}/groups/{group%2Did1}/sets/{set%2Did}/relations{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Get the different relation of a [term] or [set] from the relations navigation property.
        /// </summary>
