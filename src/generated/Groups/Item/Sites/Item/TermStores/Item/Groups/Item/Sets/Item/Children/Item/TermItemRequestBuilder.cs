using ApiSdk.Groups.Item.Sites.Item.TermStores.Item.Groups.Item.Sets.Item.Children.Item.Children;
using ApiSdk.Groups.Item.Sites.Item.TermStores.Item.Groups.Item.Sets.Item.Children.Item.Relations;
using ApiSdk.Groups.Item.Sites.Item.TermStores.Item.Groups.Item.Sets.Item.Children.Item.Set;
...
namespace ApiSdk.Groups.Item.Sites.Item.TermStores.Item.Groups.Item.Sets.Item.Children.Item {
    ...
    public class TermItemRequestBuilder {
        ...
        public Command BuildChildrenCommand() {
            ...
            var builder = new ApiSdk.Groups.Item.Sites.Item.TermStores.Item.Groups.Item.Sets.Item.Children.Item.Children.ChildrenRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildDeleteCommand() {
            ...
            }, new CollectionBinding(groupIdOption, siteIdOption, storeIdOption, groupId1Option, setIdOption, termIdOption, ifMatchOption, new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(groupIdOption, siteIdOption, storeIdOption, groupId1Option, setIdOption, termIdOption, selectOption, expandOption, outputOption, queryOption, jsonNoIndentOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                await RequestAdapter.SendNoContentAsync(requestInfo, errorMapping: errorMapping, cancellationToken: cancellationToken);
                Console.WriteLine("Success");
            }, new CollectionBinding(groupIdOption, siteIdOption, storeIdOption, groupId1Option, setIdOption, termIdOption, bodyOption, new TypeBinding(typeof(CancellationToken))));
            return command;
        }
