using ApiSdk.Groups.Item.Sites.Item.TermStores.Count;
using ApiSdk.Groups.Item.Sites.Item.TermStores.Item;
...
namespace ApiSdk.Groups.Item.Sites.Item.TermStores {
    /// <summary>
    ...
    public class TermStoresRequestBuilder : BaseCliRequestBuilder {
        ...
        public TermStoresRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/termStores{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// The collection of termStores under this site.
        /// </summary>
