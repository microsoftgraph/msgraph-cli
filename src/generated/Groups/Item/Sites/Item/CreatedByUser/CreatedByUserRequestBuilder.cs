...
namespace ApiSdk.Groups.Item.Sites.Item.CreatedByUser {
    ...
    public class CreatedByUserRequestBuilder : BaseCliRequestBuilder {
        ...
        public CreatedByUserRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/createdByUser{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Identity of the user who created the item. Read-only.
        /// </summary>
