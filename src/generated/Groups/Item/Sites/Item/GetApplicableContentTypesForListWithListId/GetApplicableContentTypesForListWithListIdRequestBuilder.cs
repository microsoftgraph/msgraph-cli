...
namespace ApiSdk.Groups.Item.Sites.Item.GetApplicableContentTypesForListWithListId {
    ...
    public class GetApplicableContentTypesForListWithListIdRequestBuilder {
        ...
        public GetApplicableContentTypesForListWithListIdRequestBuilder(Dictionary<string, object> pathParameters, string listId = "") {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/getApplicableContentTypesForList(listId='{listId}'){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}";
