...
namespace ApiSdk.Groups.Item.Sites.Item.Drive {
    /// <summary>
    ...
    public class DriveRequestBuilder : BaseCliRequestBuilder {
        ...
        public DriveRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/drive{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Retrieve the properties and relationships of a Drive resource. A Drive is the top-level container for a file system, such as OneDrive or SharePoint document libraries.
        /// </summary>
