...
using System;
namespace ApiSdk.Groups.Item.Sites.Item.Sites.Remove {
    /// <summary>
    ...
    public class RemoveRequestBuilder : BaseCliRequestBuilder {
        ...
        public RemoveRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/sites/remove", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new <see cref="RemoveRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public RemoveRequestBuilder(string rawUrl) : base("{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/sites/remove", rawUrl) {
        }
        /// <summary>
        /// Unfollow a user&apos;s site or multiple sites.
        /// </summary>
