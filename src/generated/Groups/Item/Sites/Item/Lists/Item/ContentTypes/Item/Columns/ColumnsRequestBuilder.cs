...
namespace ApiSdk.Groups.Item.Sites.Item.Lists.Item.ContentTypes.Item.Columns {
    ...
    public class ColumnsRequestBuilder : BaseCliRequestBuilder {
        ...
        public ColumnsRequestBuilder(string rawUrl) : base("{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/lists/{list%2Did}/contentTypes/{contentType%2Did}/columns{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Get the collection of columns represented as [columnDefinition][columnDefinition] resources in a [content type][contentType].
        /// </summary>
