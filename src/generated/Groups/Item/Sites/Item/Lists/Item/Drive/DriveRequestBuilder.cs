...
namespace ApiSdk.Groups.Item.Sites.Item.Lists.Item.Drive {
    ...
    public class DriveRequestBuilder : BaseCliRequestBuilder {
        ...
        public DriveRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/lists/{list%2Did}/drive{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Only present on document libraries. Allows access to the list as a [drive][] resource with [driveItems][driveItem].
        /// </summary>
