...
using ApiSdk.Groups.Item.Sites.Item.Lists.Item.Items.Item.Versions.Item.MicrosoftGraphRestoreVersion;
using ApiSdk.Models;
...
namespace ApiSdk.Groups.Item.Sites.Item.Lists.Item.Items.Item.Versions.Item {
    ...
    public class ListItemVersionItemRequestBuilder {
        ...
        public ListItemVersionItemRequestBuilder(Dictionary<string, object> pathParameters) {
