...
namespace ApiSdk.Groups.Item.Sites.Item.Lists.Item.ContentTypes.Item.Base {
    ...
    public class BaseRequestBuilderEscaped : BaseCliRequestBuilder {
        ...
        public BaseRequestBuilderEscaped(Dictionary<string, object> pathParameters) : base("{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/lists/{list%2Did}/contentTypes/{contentType%2Did}/base{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Parent contentType from which this content type is derived.
        /// </summary>
