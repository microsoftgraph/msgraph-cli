...
namespace ApiSdk.Groups.Item.Sites.Item.Lists.Item.Items.Item.CreatedByUser {
    ...
    public class CreatedByUserRequestBuilder : BaseCliRequestBuilder {
        ...
        public CreatedByUserRequestBuilder(string rawUrl) : base("{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/lists/{list%2Did}/items/{listItem%2Did}/createdByUser{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Identity of the user who created the item. Read-only.
        /// </summary>
