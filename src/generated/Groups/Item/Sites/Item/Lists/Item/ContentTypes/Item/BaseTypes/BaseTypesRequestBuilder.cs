using ApiSdk.Groups.Item.Sites.Item.Lists.Item.ContentTypes.Item.BaseTypes.Count;
using ApiSdk.Groups.Item.Sites.Item.Lists.Item.ContentTypes.Item.BaseTypes.Item;
using ApiSdk.Models;
...
namespace ApiSdk.Groups.Item.Sites.Item.Lists.Item.ContentTypes.Item.BaseTypes {
    /// <summary>
    ...
    public class BaseTypesRequestBuilder : BaseCliRequestBuilder {
        ...
        public Tuple<List<Command>, List<Command>> BuildCommand() {
            ...
            var builder = new ApiSdk.Groups.Item.Sites.Item.Lists.Item.ContentTypes.Item.BaseTypes.Item.ContentTypeItemRequestBuilder(PathParameters);
        ...
        public BaseTypesRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/lists/{list%2Did}/contentTypes/{contentType%2Did}/baseTypes{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// The collection of content types that are ancestors of this content type.
        /// </summary>
...
#nullable restore
        ...
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<BaseTypesRequestBuilderGetQueryParameters>> requestConfiguration = default) {
            ...
            if (requestConfiguration != null) {
                var requestConfig = new RequestConfiguration<BaseTypesRequestBuilderGetQueryParameters>();
