...
namespace ApiSdk.Groups.Item.Sites.Item.Lists.Item.ContentTypes {
    ...
    public class ContentTypesRequestBuilder : BaseCliRequestBuilder {
        ...
        public ContentTypesRequestBuilder(string rawUrl) : base("{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/lists/{list%2Did}/contentTypes{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Get the collection of [contentType][contentType] resources in a [list][].
        /// </summary>
