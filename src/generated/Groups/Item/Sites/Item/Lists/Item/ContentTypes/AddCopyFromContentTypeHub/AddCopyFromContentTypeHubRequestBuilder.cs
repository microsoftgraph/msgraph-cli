...
namespace ApiSdk.Groups.Item.Sites.Item.Lists.Item.ContentTypes.AddCopyFromContentTypeHub {
    ...
    public class AddCopyFromContentTypeHubRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.Description = "Invoke action addCopyFromContentTypeHub";
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                var model = parseNode.GetObjectValue<AddCopyFromContentTypeHubRequestBody>(AddCopyFromContentTypeHubRequestBody.CreateFromDiscriminatorValue);
        ...
        public AddCopyFromContentTypeHubRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/lists/{list%2Did}/contentTypes/microsoft.graph.addCopyFromContentTypeHub";
