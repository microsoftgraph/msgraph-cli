...
using System;
namespace ApiSdk.Groups.Item.Sites.Item.Lists.Item.Items.Item.Analytics {
    /// <summary>
    ...
    public class AnalyticsRequestBuilder : BaseCliRequestBuilder {
        ...
        public AnalyticsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/lists/{list%2Did}/items/{listItem%2Did}/analytics{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Analytics about the view activities that took place on this item.
        /// </summary>
