...
namespace ApiSdk.Groups.Item.Sites.Item.Lists.Item.Subscriptions.Item {
    ...
    public class SubscriptionItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public SubscriptionItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/lists/{list%2Did}/subscriptions/{subscription%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Delete navigation property subscriptions for groups
        /// </summary>
