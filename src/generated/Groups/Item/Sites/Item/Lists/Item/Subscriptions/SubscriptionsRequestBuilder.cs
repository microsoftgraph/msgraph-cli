using ApiSdk.Groups.Item.Sites.Item.Lists.Item.Subscriptions.Count;
using ApiSdk.Groups.Item.Sites.Item.Lists.Item.Subscriptions.Item;
using ApiSdk.Models;
...
namespace ApiSdk.Groups.Item.Sites.Item.Lists.Item.Subscriptions {
    /// <summary>
    ...
    public class SubscriptionsRequestBuilder : BaseCliRequestBuilder {
        ...
        public SubscriptionsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/lists/{list%2Did}/subscriptions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// The set of subscriptions on the list.
        /// </summary>
