using ApiSdk.Groups.Item.Sites.Item.Lists.Item.Operations.Count;
using ApiSdk.Groups.Item.Sites.Item.Lists.Item.Operations.Item;
using ApiSdk.Models;
...
namespace ApiSdk.Groups.Item.Sites.Item.Lists.Item.Operations {
    ...
    public class OperationsRequestBuilder {
        ...
        public Command BuildCommand() {
            ...
            var builder = new RichLongRunningOperationItemRequestBuilder(PathParameters, RequestAdapter);
