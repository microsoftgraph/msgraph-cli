...
namespace ApiSdk.Groups.Item.Sites.Item.Lists.Item.Items.Item.Fields {
    /// <summary>
    ...
    public class FieldsRequestBuilder : BaseCliRequestBuilder {
        ...
        public FieldsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/lists/{list%2Did}/items/{listItem%2Did}/fields{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Delete navigation property fields for groups
        /// </summary>
