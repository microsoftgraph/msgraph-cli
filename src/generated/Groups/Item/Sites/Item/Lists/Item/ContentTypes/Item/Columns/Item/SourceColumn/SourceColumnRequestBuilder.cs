...
namespace ApiSdk.Groups.Item.Sites.Item.Lists.Item.ContentTypes.Item.Columns.Item.SourceColumn {
    ...
    public class SourceColumnRequestBuilder : BaseCliRequestBuilder {
        ...
        public SourceColumnRequestBuilder(string rawUrl) : base("{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/lists/{list%2Did}/contentTypes/{contentType%2Did}/columns/{columnDefinition%2Did}/sourceColumn{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// The source column for the content type column.
        /// </summary>
