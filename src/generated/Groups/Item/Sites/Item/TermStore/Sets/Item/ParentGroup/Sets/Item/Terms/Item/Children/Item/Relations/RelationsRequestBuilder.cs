using ApiSdk.Groups.Item.Sites.Item.TermStore.Sets.Item.ParentGroup.Sets.Item.Terms.Item.Children.Item.Relations.Count;
using ApiSdk.Groups.Item.Sites.Item.TermStore.Sets.Item.ParentGroup.Sets.Item.Terms.Item.Children.Item.Relations.Item;
...
namespace ApiSdk.Groups.Item.Sites.Item.TermStore.Sets.Item.ParentGroup.Sets.Item.Terms.Item.Children.Item.Relations {
    ...
    public class RelationsRequestBuilder {
        ...
        public List<Command> BuildCommand() {
            var builder = new RelationItemRequestBuilder(PathParameters, RequestAdapter);
            var commands = new List<Command>();
            commands.Add(builder.BuildDeleteCommand());
            commands.Add(builder.BuildFromTermCommand());
            commands.Add(builder.BuildGetCommand());
            commands.Add(builder.BuildPatchCommand());
            commands.Add(builder.BuildSetCommand());
            commands.Add(builder.BuildToTermCommand());
            return commands;
        }
        ...
        public Command BuildCreateCommand() {
            ...
            command.Description = "Create new navigation property to relations for groups";
            ...
            }, new CollectionBinding(groupIdOption, siteIdOption, setIdOption, setId1Option, termIdOption, termId1Option, bodyOption, outputOption, queryOption, jsonNoIndentOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        ...
        public Command BuildListCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                var termId = (string) parameters[4];
                var termId1 = (string) parameters[5];
                var top = (int?) parameters[6];
                var skip = (int?) parameters[7];
                var search = (string) parameters[8];
                var filter = (string) parameters[9];
                var count = (bool?) parameters[10];
                var orderby = (string[]) parameters[11];
                var select = (string[]) parameters[12];
                var expand = (string[]) parameters[13];
                var output = (FormatterType) parameters[14];
                var query = (string) parameters[15];
                var jsonNoIndent = (bool) parameters[16];
                var outputFilter = (IOutputFilter) parameters[17];
                var outputFormatterFactory = (IOutputFormatterFactory) parameters[18];
                var cancellationToken = (CancellationToken) parameters[19];
        ...
        public RelationsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/termStore/sets/{set%2Did}/parentGroup/sets/{set%2Did1}/terms/{term%2Did}/children/{term%2Did1}/relations{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
