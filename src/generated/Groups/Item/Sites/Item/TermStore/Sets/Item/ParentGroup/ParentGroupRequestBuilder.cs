using ApiSdk.Groups.Item.Sites.Item.TermStore.Sets.Item.ParentGroup.Sets;
...
namespace ApiSdk.Groups.Item.Sites.Item.TermStore.Sets.Item.ParentGroup {
    /// <summary>
    ...
    public class ParentGroupRequestBuilder : BaseCliRequestBuilder {
        ...
        public Command BuildSetsNavCommand() {
            ...
            var builder = new ApiSdk.Groups.Item.Sites.Item.TermStore.Sets.Item.ParentGroup.Sets.SetsRequestBuilder(PathParameters);
        ...
        public ParentGroupRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/termStore/sets/{set%2Did}/parentGroup{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Delete navigation property parentGroup for groups
        /// </summary>
