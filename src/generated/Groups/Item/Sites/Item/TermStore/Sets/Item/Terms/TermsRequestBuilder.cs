using ApiSdk.Groups.Item.Sites.Item.TermStore.Sets.Item.Terms.Count;
using ApiSdk.Groups.Item.Sites.Item.TermStore.Sets.Item.Terms.Item;
...
namespace ApiSdk.Groups.Item.Sites.Item.TermStore.Sets.Item.Terms {
    ...
    public class TermsRequestBuilder {
        ...
        public Command BuildCreateCommand() {
            ...
            }, new CollectionBinding(groupIdOption, siteIdOption, setIdOption, bodyOption, outputOption, queryOption, jsonNoIndentOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
