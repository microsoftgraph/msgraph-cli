...
namespace ApiSdk.Groups.Item.Sites.Item.TermStore.Sets.Item.Children.Item.Children {
    ...
    public class ChildrenRequestBuilder : BaseCliRequestBuilder {
        ...
        public Tuple<List<Command>, List<Command>> BuildCommand() {
            ...
            var builder = new ApiSdk.Groups.Item.Sites.Item.TermStore.Sets.Item.Children.Item.Children.Item.TermItemRequestBuilder(PathParameters);
        ...
        public ChildrenRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/termStore/sets/{set%2Did}/children/{term%2Did}/children{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Children of current term.
        /// </summary>
