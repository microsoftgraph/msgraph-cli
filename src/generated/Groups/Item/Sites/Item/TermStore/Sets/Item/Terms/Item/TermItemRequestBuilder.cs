...
namespace ApiSdk.Groups.Item.Sites.Item.TermStore.Sets.Item.Terms.Item {
    ...
    public class TermItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public TermItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/termStore/sets/{set%2Did}/terms/{term%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Delete a term object.
        /// </summary>
