...
using System;
namespace ApiSdk.Groups.Item.Sites.Item.TermStore.Sets.Item.Relations.Item.ToTerm {
    /// <summary>
    ...
    public class ToTermRequestBuilder : BaseCliRequestBuilder {
        ...
        public ToTermRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/termStore/sets/{set%2Did}/relations/{relation%2Did}/toTerm{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// The to [term] of the relation. The term to which the relationship is defined.
        /// </summary>
