...
namespace ApiSdk.Groups.Item.Sites.Item.TermStore.Groups {
    ...
    public class GroupsRequestBuilder : BaseCliRequestBuilder {
        ...
        public GroupsRequestBuilder(string rawUrl) : base("{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/termStore/groups{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Get a list of group objects in a term store.
        /// </summary>
