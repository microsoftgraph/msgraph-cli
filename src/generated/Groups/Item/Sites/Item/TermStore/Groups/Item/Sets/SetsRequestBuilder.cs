using ApiSdk.Groups.Item.Sites.Item.TermStore.Groups.Item.Sets.Count;
using ApiSdk.Groups.Item.Sites.Item.TermStore.Groups.Item.Sets.Item;
...
namespace ApiSdk.Groups.Item.Sites.Item.TermStore.Groups.Item.Sets {
    ...
    public class SetsRequestBuilder {
        ...
        public List<Command> BuildCommand() {
            var builder = new SetItemRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildCreateCommand() {
            ...
            }, new CollectionBinding(groupIdOption, siteIdOption, groupId1Option, bodyOption, outputOption, queryOption, jsonNoIndentOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        ...
        public SetsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group_id}/sites/{site_id}/termStore/groups/{group_id1}/sets{?top,skip,search,filter,count,orderby,select,expand}";
