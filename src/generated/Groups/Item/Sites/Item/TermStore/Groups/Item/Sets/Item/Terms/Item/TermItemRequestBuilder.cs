...
namespace ApiSdk.Groups.Item.Sites.Item.TermStore.Groups.Item.Sets.Item.Terms.Item {
    ...
    public class TermItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public TermItemRequestBuilder(string rawUrl) : base("{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/termStore/groups/{group%2Did1}/sets/{set%2Did}/terms/{term%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Delete a term object. This API is available in the following national cloud deployments.
        /// </summary>
