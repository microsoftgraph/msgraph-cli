using ApiSdk.Groups.Item.Sites.Item.TermStore.Groups.Item.Sets.Item.Children;
using ApiSdk.Groups.Item.Sites.Item.TermStore.Groups.Item.Sets.Item.ParentGroup;
using ApiSdk.Groups.Item.Sites.Item.TermStore.Groups.Item.Sets.Item.Relations;
using ApiSdk.Groups.Item.Sites.Item.TermStore.Groups.Item.Sets.Item.Terms;
...
namespace ApiSdk.Groups.Item.Sites.Item.TermStore.Groups.Item.Sets.Item {
    ...
    public class SetItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public SetItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/termStore/groups/{group%2Did1}/sets/{set%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Delete navigation property sets for groups
        /// </summary>
