...
namespace ApiSdk.Groups.Item.Sites.Item.Onenote.SectionGroups {
    ...
    public class SectionGroupsRequestBuilder : BaseCliRequestBuilder {
        ...
        public SectionGroupsRequestBuilder(string rawUrl) : base("{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/onenote/sectionGroups{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Retrieve a list of sectionGroup objects. This API is available in the following national cloud deployments.
        /// </summary>
