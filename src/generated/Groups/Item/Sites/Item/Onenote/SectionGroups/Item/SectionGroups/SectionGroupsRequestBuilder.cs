using ApiSdk.Groups.Item.Sites.Item.Onenote.SectionGroups.Item.SectionGroups.Count;
using ApiSdk.Groups.Item.Sites.Item.Onenote.SectionGroups.Item.SectionGroups.Item;
...
using System;
namespace ApiSdk.Groups.Item.Sites.Item.Onenote.SectionGroups.Item.SectionGroups {
    /// <summary>
    ...
    public class SectionGroupsRequestBuilder : BaseCliRequestBuilder {
        ...
        public Tuple<List<Command>, List<Command>> BuildCommand() {
            ...
            var builder = new ApiSdk.Groups.Item.Sites.Item.Onenote.SectionGroups.Item.SectionGroups.Item.SectionGroupItemRequestBuilder(PathParameters);
        ...
        public SectionGroupsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/onenote/sectionGroups/{sectionGroup%2Did}/sectionGroups{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Retrieve a list of section groups from the specified section group.
        /// </summary>
