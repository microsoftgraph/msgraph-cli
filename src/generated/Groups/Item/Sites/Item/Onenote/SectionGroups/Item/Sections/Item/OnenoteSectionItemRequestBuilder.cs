using ApiSdk.Groups.Item.Sites.Item.Onenote.SectionGroups.Item.Sections.Item.CopyToNotebook;
using ApiSdk.Groups.Item.Sites.Item.Onenote.SectionGroups.Item.Sections.Item.CopyToSectionGroup;
using ApiSdk.Groups.Item.Sites.Item.Onenote.SectionGroups.Item.Sections.Item.Pages;
using ApiSdk.Groups.Item.Sites.Item.Onenote.SectionGroups.Item.Sections.Item.ParentNotebook;
using ApiSdk.Groups.Item.Sites.Item.Onenote.SectionGroups.Item.Sections.Item.ParentSectionGroup;
using ApiSdk.Models;
...
namespace ApiSdk.Groups.Item.Sites.Item.Onenote.SectionGroups.Item.Sections.Item {
    ...
    public class OnenoteSectionItemRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            }, new CollectionBinding(groupIdOption, siteIdOption, sectionGroupIdOption, onenoteSectionIdOption, ifMatchOption, new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(groupIdOption, siteIdOption, sectionGroupIdOption, onenoteSectionIdOption, selectOption, expandOption, outputOption, queryOption, jsonNoIndentOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                await RequestAdapter.SendNoContentAsync(requestInfo, errorMapping: errorMapping, cancellationToken: cancellationToken);
                Console.WriteLine("Success");
            }, new CollectionBinding(groupIdOption, siteIdOption, sectionGroupIdOption, onenoteSectionIdOption, bodyOption, new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
