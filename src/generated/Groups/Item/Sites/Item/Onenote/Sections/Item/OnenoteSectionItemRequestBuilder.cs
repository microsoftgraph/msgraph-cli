...
namespace ApiSdk.Groups.Item.Sites.Item.Onenote.Sections.Item
{
    ...
    public class OnenoteSectionItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildCopyToNotebookNavCommand()
        {
            ...
            var builder = new ApiSdk.Groups.Item.Sites.Item.Onenote.Sections.Item.CopyToNotebook.CopyToNotebookRequestBuilder(PathParameters);
        ...
        public Command BuildCopyToSectionGroupNavCommand()
        {
            ...
            var builder = new ApiSdk.Groups.Item.Sites.Item.Onenote.Sections.Item.CopyToSectionGroup.CopyToSectionGroupRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildPagesNavCommand()
        {
            ...
            var builder = new ApiSdk.Groups.Item.Sites.Item.Onenote.Sections.Item.Pages.PagesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildParentNotebookNavCommand()
        {
            ...
            var builder = new ApiSdk.Groups.Item.Sites.Item.Onenote.Sections.Item.ParentNotebook.ParentNotebookRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildParentSectionGroupNavCommand()
        {
            ...
            var builder = new ApiSdk.Groups.Item.Sites.Item.Onenote.Sections.Item.ParentSectionGroup.ParentSectionGroupRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Groups.Item.Sites.Item.Onenote.Sections.Item.OnenoteSectionItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Groups.Item.Sites.Item.Onenote.Sections.Item.OnenoteSectionItemRequestBuilder.OnenoteSectionItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Groups.Item.Sites.Item.Onenote.Sections.Item.OnenoteSectionItemRequestBuilder.OnenoteSectionItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
