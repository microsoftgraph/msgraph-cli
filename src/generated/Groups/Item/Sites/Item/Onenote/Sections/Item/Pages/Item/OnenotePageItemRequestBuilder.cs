using ApiSdk.Groups.Item.Sites.Item.Onenote.Sections.Item.Pages.Item.Content;
using ApiSdk.Groups.Item.Sites.Item.Onenote.Sections.Item.Pages.Item.CopyToSection;
using ApiSdk.Groups.Item.Sites.Item.Onenote.Sections.Item.Pages.Item.OnenotePatchContent;
using ApiSdk.Groups.Item.Sites.Item.Onenote.Sections.Item.Pages.Item.ParentNotebook;
using ApiSdk.Groups.Item.Sites.Item.Onenote.Sections.Item.Pages.Item.ParentSection;
using ApiSdk.Groups.Item.Sites.Item.Onenote.Sections.Item.Pages.Item.Preview;
...
using System;
namespace ApiSdk.Groups.Item.Sites.Item.Onenote.Sections.Item.Pages.Item {
    /// <summary>
    ...
    public class OnenotePageItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public OnenotePageItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/onenote/sections/{onenoteSection%2Did}/pages/{onenotePage%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Delete navigation property pages for groups
        /// </summary>
