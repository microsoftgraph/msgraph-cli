using ApiSdk.Groups.Item.Sites.Item.Onenote.Resources.Item.Content;
using ApiSdk.Models;
...
namespace ApiSdk.Groups.Item.Sites.Item.Onenote.Resources.Item {
    /// <summary>
    ...
    public class OnenoteResourceItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public OnenoteResourceItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/onenote/resources/{onenoteResource%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Delete navigation property resources for groups
        /// </summary>
