...
namespace ApiSdk.Groups.Item.Sites.Item.Onenote.Pages.Item.CopyToSection {
    ...
    public class CopyToSectionRequestBody : IAdditionalDataHolder, IParsable {
        ...
        /// </summary>
        public static ApiSdk.Groups.Item.Sites.Item.Onenote.Pages.Item.CopyToSection.CopyToSectionRequestBody CreateFromDiscriminatorValue(IParseNode parseNode) {
