using ApiSdk.Groups.Item.Sites.Item.Onenote.Notebooks.Item.MicrosoftGraphCopyNotebook;
...
namespace ApiSdk.Groups.Item.Sites.Item.Onenote.Notebooks.Item {
    ...
    public class NotebookItemRequestBuilder {
        ...
        public NotebookItemRequestBuilder(Dictionary<string, object> pathParameters) {
