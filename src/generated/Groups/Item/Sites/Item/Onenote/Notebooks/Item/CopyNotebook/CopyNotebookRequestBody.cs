...
namespace ApiSdk.Groups.Item.Sites.Item.Onenote.Notebooks.Item.CopyNotebook {
    ...
    public class CopyNotebookRequestBody : IAdditionalDataHolder, IParsable {
        ...
        /// </summary>
        public static ApiSdk.Groups.Item.Sites.Item.Onenote.Notebooks.Item.CopyNotebook.CopyNotebookRequestBody CreateFromDiscriminatorValue(IParseNode parseNode) {
