...
namespace ApiSdk.Groups.Item.Sites.Item.ContentTypes.Item.BaseTypes {
    ...
    public class BaseTypesRequestBuilder {
        ...
        public List<Command> BuildCommand() {
            var builder = new ApiSdk.Groups.Item.Sites.Item.ContentTypes.Item.BaseTypes.Item.ContentTypeItemRequestBuilder(PathParameters, RequestAdapter);
