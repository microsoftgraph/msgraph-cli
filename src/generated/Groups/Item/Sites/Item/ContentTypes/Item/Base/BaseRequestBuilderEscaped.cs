...
namespace ApiSdk.Groups.Item.Sites.Item.ContentTypes.Item.Base {
    ...
    public class BaseRequestBuilderEscaped : BaseCliRequestBuilder {
        ...
        public BaseRequestBuilderEscaped(Dictionary<string, object> pathParameters) : base("{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/contentTypes/{contentType%2Did}/base{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Parent contentType from which this content type is derived.
        /// </summary>
...
#nullable restore
        ...
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<BaseRequestBuilderGetQueryParameters>> requestConfiguration = default) {
            ...
            if (requestConfiguration != null) {
                var requestConfig = new RequestConfiguration<BaseRequestBuilderGetQueryParameters>();
