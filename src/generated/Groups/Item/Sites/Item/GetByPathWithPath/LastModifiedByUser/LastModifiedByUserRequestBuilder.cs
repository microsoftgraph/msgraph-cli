...
namespace ApiSdk.Groups.Item.Sites.Item.GetByPathWithPath.LastModifiedByUser {
    ...
    public class LastModifiedByUserRequestBuilder : BaseCliRequestBuilder {
        ...
        public LastModifiedByUserRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/getByPath(path='{path}')/lastModifiedByUser{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new LastModifiedByUserRequestBuilder and sets the default values.
        /// </summary>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public LastModifiedByUserRequestBuilder(string rawUrl) : base("{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/getByPath(path='{path}')/lastModifiedByUser{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Identity of the user who last modified the item. Read-only.
        /// </summary>
