...
namespace ApiSdk.Groups.Item.Sites.Item.GetByPathWithPath.Onenote {
    ...
    public class OnenoteRequestBuilder : BaseCliRequestBuilder {
        ...
        public OnenoteRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/getByPath(path='{path}')/onenote{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new OnenoteRequestBuilder and sets the default values.
        /// </summary>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public OnenoteRequestBuilder(string rawUrl) : base("{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/getByPath(path='{path}')/onenote{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Delete navigation property onenote for groups
        /// </summary>
