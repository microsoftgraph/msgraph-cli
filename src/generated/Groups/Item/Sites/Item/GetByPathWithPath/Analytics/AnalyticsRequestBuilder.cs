...
namespace ApiSdk.Groups.Item.Sites.Item.GetByPathWithPath.Analytics {
    ...
    public class AnalyticsRequestBuilder : BaseCliRequestBuilder {
        ...
        public AnalyticsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/getByPath(path='{path}')/analytics{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new AnalyticsRequestBuilder and sets the default values.
        /// </summary>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public AnalyticsRequestBuilder(string rawUrl) : base("{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/getByPath(path='{path}')/analytics{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Delete navigation property analytics for groups
        /// </summary>
