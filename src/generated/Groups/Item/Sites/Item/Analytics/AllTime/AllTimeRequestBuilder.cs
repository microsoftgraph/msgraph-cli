...
using System;
namespace ApiSdk.Groups.Item.Sites.Item.Analytics.AllTime {
    /// <summary>
    ...
    public class AllTimeRequestBuilder : BaseCliRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.Description = "Get allTime from groups";
        ...
        public AllTimeRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/analytics/allTime{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Get allTime from groups
        /// </summary>
