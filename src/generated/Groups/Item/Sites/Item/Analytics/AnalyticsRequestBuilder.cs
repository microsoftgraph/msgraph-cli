...
namespace ApiSdk.Groups.Item.Sites.Item.Analytics
{
    ...
    public class AnalyticsRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildAllTimeNavCommand()
        {
            ...
            var builder = new ApiSdk.Groups.Item.Sites.Item.Analytics.AllTime.AllTimeRequestBuilder(PathParameters);
        ...
        public Command BuildItemActivityStatsNavCommand()
        {
            ...
            var builder = new ApiSdk.Groups.Item.Sites.Item.Analytics.ItemActivityStats.ItemActivityStatsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildLastSevenDaysNavCommand()
        {
            ...
            var builder = new ApiSdk.Groups.Item.Sites.Item.Analytics.LastSevenDays.LastSevenDaysRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Groups.Item.Sites.Item.Analytics.AnalyticsRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Groups.Item.Sites.Item.Analytics.AnalyticsRequestBuilder.AnalyticsRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Groups.Item.Sites.Item.Analytics.AnalyticsRequestBuilder.AnalyticsRequestBuilderGetQueryParameters>> requestConfiguration = default)
