using ApiSdk.Groups.Item.Sites.Item.Analytics.AllTime;
using ApiSdk.Groups.Item.Sites.Item.Analytics.ItemActivityStats;
using ApiSdk.Groups.Item.Sites.Item.Analytics.LastSevenDays;
...
using System;
namespace ApiSdk.Groups.Item.Sites.Item.Analytics {
    /// <summary>
    ...
    public class AnalyticsRequestBuilder : BaseCliRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.Description = "Delete navigation property analytics for groups";
        ...
        public Command BuildPatchCommand() {
            ...
            command.Description = "Update the navigation property analytics in groups";
            var groupIdOption = new Option<string>("--group-id", description: "The unique identifier of group") {
            };
            groupIdOption.IsRequired = true;
            command.AddOption(groupIdOption);
        ...
        public AnalyticsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/analytics{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Delete navigation property analytics for groups
        /// </summary>
