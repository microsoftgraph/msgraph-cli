...
namespace ApiSdk.Groups.Item.Settings.Item {
    ...
    public class GroupSettingItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public GroupSettingItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/groups/{group%2Did}/settings/{groupSetting%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Delete navigation property settings for groups
        /// </summary>
