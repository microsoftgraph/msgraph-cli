...
namespace ApiSdk.Groups.Item.Settings {
    ...
    public class SettingsRequestBuilder {
        ...
        public Command BuildCommand() {
            ...
            var builder = new GroupSettingItemRequestBuilder(PathParameters, RequestAdapter);
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(GroupSetting body, Action<SettingsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
