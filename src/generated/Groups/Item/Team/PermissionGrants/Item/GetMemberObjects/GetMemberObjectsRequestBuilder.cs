...
namespace ApiSdk.Groups.Item.Team.PermissionGrants.Item.GetMemberObjects {
    ...
    public class GetMemberObjectsRequestBuilder : BaseCliRequestBuilder {
        ...
        public GetMemberObjectsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/groups/{group%2Did}/team/permissionGrants/{resourceSpecificPermissionGrant%2Did}/getMemberObjects", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new GetMemberObjectsRequestBuilder and sets the default values.
        /// </summary>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public GetMemberObjectsRequestBuilder(string rawUrl) : base("{+baseurl}/groups/{group%2Did}/team/permissionGrants/{resourceSpecificPermissionGrant%2Did}/getMemberObjects", rawUrl) {
        }
        /// <summary>
        /// Return all IDs for the groups, administrative units, and directory roles that a user, group, service principal, organizational contact, device, or directory object is a member of. This function is transitive. Note: Only users and role-enabled groups can be members of directory roles.
        /// </summary>
