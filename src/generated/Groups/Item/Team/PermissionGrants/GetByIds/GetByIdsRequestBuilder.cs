...
using System;
namespace ApiSdk.Groups.Item.Team.PermissionGrants.GetByIds {
    /// <summary>
    ...
    public class GetByIdsRequestBuilder : BaseCliRequestBuilder {
        ...
        public GetByIdsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/groups/{group%2Did}/team/permissionGrants/getByIds", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new GetByIdsRequestBuilder and sets the default values.
        /// </summary>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public GetByIdsRequestBuilder(string rawUrl) : base("{+baseurl}/groups/{group%2Did}/team/permissionGrants/getByIds", rawUrl) {
        }
        /// <summary>
        /// Return the directory objects specified in a list of IDs. Only a subset of user properties are returned by default in v1.0. Some common uses for this function are to:
        /// </summary>
