...
using ApiSdk.Groups.Item.Team.PermissionGrants.Delta;
using ApiSdk.Groups.Item.Team.PermissionGrants.GetAvailableExtensionProperties;
using ApiSdk.Groups.Item.Team.PermissionGrants.GetByIds;
using ApiSdk.Groups.Item.Team.PermissionGrants.Item;
using ApiSdk.Groups.Item.Team.PermissionGrants.ValidateProperties;
...
namespace ApiSdk.Groups.Item.Team.PermissionGrants {
    ...
    public class PermissionGrantsRequestBuilder : BaseCliRequestBuilder {
        ...
        public PermissionGrantsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/groups/{group%2Did}/team/permissionGrants{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new PermissionGrantsRequestBuilder and sets the default values.
        /// </summary>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public PermissionGrantsRequestBuilder(string rawUrl) : base("{+baseurl}/groups/{group%2Did}/team/permissionGrants{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// List all resource-specific permission grants on the team. This list specifies the Azure AD apps that have access to the team, along with each app&apos;s corresponding type of resource-specific access.
        /// </summary>
