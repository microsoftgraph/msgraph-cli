...
namespace ApiSdk.Groups.Item.Team.PrimaryChannel.FilesFolder {
    ...
    public class FilesFolderRequestBuilder {
        ...
        public FilesFolderRequestBuilder(Dictionary<string, object> pathParameters) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/team/primaryChannel/filesFolder{?%24select,%24expand}";
