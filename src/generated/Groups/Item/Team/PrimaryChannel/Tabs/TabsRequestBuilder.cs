...
namespace ApiSdk.Groups.Item.Team.PrimaryChannel.Tabs {
    ...
    public class TabsRequestBuilder : BaseCliRequestBuilder {
        ...
        public TabsRequestBuilder(string rawUrl) : base("{+baseurl}/groups/{group%2Did}/team/primaryChannel/tabs{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Retrieve the list of tabs in the specified channel within a team. 
        /// </summary>
