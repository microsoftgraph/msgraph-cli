...
namespace ApiSdk.Groups.Item.Team.PrimaryChannel.Tabs.Item.TeamsApp {
    ...
    public class TeamsAppRequestBuilder : BaseCliRequestBuilder {
        ...
        public TeamsAppRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/groups/{group%2Did}/team/primaryChannel/tabs/{teamsTab%2Did}/teamsApp{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// The application that is linked to the tab. This cannot be changed after tab creation.
        /// </summary>
