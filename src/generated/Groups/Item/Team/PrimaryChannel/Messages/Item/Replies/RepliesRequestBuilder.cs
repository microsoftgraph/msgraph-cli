...
namespace ApiSdk.Groups.Item.Team.PrimaryChannel.Messages.Item.Replies {
    ...
    public class RepliesRequestBuilder {
        ...
        public List<Command> BuildCommand() {
            var builder = new ApiSdk.Groups.Item.Team.PrimaryChannel.Messages.Item.Replies.Item.ChatMessageItemRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildCreateCommand() {
            ...
            }, new CollectionBinding(groupIdOption, chatMessageIdOption, bodyOption, outputOption, queryOption, jsonNoIndentOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        ...
        public RepliesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group_id}/team/primaryChannel/messages/{chatMessage_id}/replies{?top,skip,search,filter,count,orderby,select,expand}";
