using ApiSdk.Groups.Item.Team.PrimaryChannel.Messages.Item.HostedContents.Count;
using ApiSdk.Groups.Item.Team.PrimaryChannel.Messages.Item.HostedContents.Item;
using ApiSdk.Models;
...
namespace ApiSdk.Groups.Item.Team.PrimaryChannel.Messages.Item.HostedContents {
    /// <summary>
    ...
    public class HostedContentsRequestBuilder : BaseCliRequestBuilder {
        ...
        public HostedContentsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/groups/{group%2Did}/team/primaryChannel/messages/{chatMessage%2Did}/hostedContents{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Retrieve the list of chatMessageHostedContent objects from a message. This API only lists the hosted content objects. To get the content bytes, see get chatmessage hosted content
        /// </summary>
...
#nullable restore
        ...
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<HostedContentsRequestBuilderGetQueryParameters>> requestConfiguration = default) {
            ...
            if (requestConfiguration != null) {
                var requestConfig = new RequestConfiguration<HostedContentsRequestBuilderGetQueryParameters>();
