...
using ApiSdk.Groups.Item.Team.PrimaryChannel.Messages.Item.Replies.Item.SoftDelete;
using ApiSdk.Groups.Item.Team.PrimaryChannel.Messages.Item.Replies.Item.UndoSoftDelete;
...
namespace ApiSdk.Groups.Item.Team.PrimaryChannel.Messages.Item.Replies.Item {
    ...
    public class ChatMessageItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public ChatMessageItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/groups/{group%2Did}/team/primaryChannel/messages/{chatMessage%2Did}/replies/{chatMessage%2Did1}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Delete navigation property replies for groups
        /// </summary>
