...
using System;
namespace ApiSdk.Groups.Item.Team.PrimaryChannel.SharedWithTeams.Item.Team {
    /// <summary>
    ...
    public class TeamRequestBuilder : BaseCliRequestBuilder {
        ...
        public TeamRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/groups/{group%2Did}/team/primaryChannel/sharedWithTeams/{sharedWithChannelTeamInfo%2Did}/team{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Get team from groups
        /// </summary>
