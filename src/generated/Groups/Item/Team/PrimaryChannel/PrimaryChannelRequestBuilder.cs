...
namespace ApiSdk.Groups.Item.Team.PrimaryChannel {
    ...
    public class PrimaryChannelRequestBuilder : BaseCliRequestBuilder {
        ...
        public PrimaryChannelRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/groups/{group%2Did}/team/primaryChannel{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Delete navigation property primaryChannel for groups
        /// </summary>
