...
namespace ApiSdk.Groups.Item.Team.PrimaryChannel.Members {
    ...
    public class MembersRequestBuilder : BaseCliRequestBuilder {
        ...
        public Command BuildCreateCommand() {
            ...
            command.Description = "Add a conversationMember to a channel. This API is available in the following national cloud deployments.\n\nFind more info here:\n  https://learn.microsoft.com/graph/api/conversationmember-add?view=graph-rest-1.0";
        ...
        public MembersRequestBuilder(string rawUrl) : base("{+baseurl}/groups/{group%2Did}/team/primaryChannel/members{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Retrieve a list of conversationMembers from a channel. This method supports federation. Only a user who is a member of the shared channel can retrieve the channel member list. This API is available in the following national cloud deployments.
        /// </summary>
