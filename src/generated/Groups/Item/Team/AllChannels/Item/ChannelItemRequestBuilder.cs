...
using System;
namespace ApiSdk.Groups.Item.Team.AllChannels.Item {
    /// <summary>
    ...
    public class ChannelItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public ChannelItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/groups/{group%2Did}/team/allChannels/{channel%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// List of channels either hosted in or shared with the team (incoming channels).
        /// </summary>
