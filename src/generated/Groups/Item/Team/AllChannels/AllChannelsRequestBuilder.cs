...
namespace ApiSdk.Groups.Item.Team.AllChannels {
    ...
    public class AllChannelsRequestBuilder : BaseCliRequestBuilder {
        ...
        public AllChannelsRequestBuilder(string rawUrl) : base("{+baseurl}/groups/{group%2Did}/team/allChannels{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Get the list of channels either in this team or shared with this team (incoming channels). This API is available in the following national cloud deployments.
        /// </summary>
