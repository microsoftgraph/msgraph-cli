...
using System;
namespace ApiSdk.Groups.Item.Team.InstalledApps.Item.TeamsAppDefinition {
    /// <summary>
    ...
    public class TeamsAppDefinitionRequestBuilder : BaseCliRequestBuilder {
        ...
        public TeamsAppDefinitionRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/groups/{group%2Did}/team/installedApps/{teamsAppInstallation%2Did}/teamsAppDefinition{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// The details of this version of the app.
        /// </summary>
