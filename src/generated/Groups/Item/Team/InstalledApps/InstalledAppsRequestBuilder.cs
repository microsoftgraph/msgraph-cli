...
namespace ApiSdk.Groups.Item.Team.InstalledApps {
    ...
    public class InstalledAppsRequestBuilder : BaseCliRequestBuilder {
        ...
        public InstalledAppsRequestBuilder(string rawUrl) : base("{+baseurl}/groups/{group%2Did}/team/installedApps{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Retrieve a list of apps installed in the specified team. This API is available in the following national cloud deployments.
        /// </summary>
