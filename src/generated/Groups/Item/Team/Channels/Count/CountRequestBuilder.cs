...
namespace ApiSdk.Groups.Item.Team.Channels.Count {
    /// <summary>
    ...
    public class CountRequestBuilder : BaseCliRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/groups/{group%2Did}/team/channels/$count{?%24search,%24filter}", pathParameters) {
        }
        /// <summary>
        /// Get the number of the resource
        /// </summary>
