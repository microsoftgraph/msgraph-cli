...
namespace ApiSdk.Groups.Item.Team.Channels.Item.FilesFolder.Content {
    ...
    public class ContentRequestBuilder : BaseCliRequestBuilder {
        ...
        public ContentRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/groups/{group%2Did}/team/channels/{channel%2Did}/filesFolder/content", pathParameters) {
        }
        /// <summary>
        /// The content stream, if the item represents a file.
        /// </summary>
