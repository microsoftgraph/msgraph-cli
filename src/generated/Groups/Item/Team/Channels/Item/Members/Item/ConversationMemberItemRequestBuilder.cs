...
namespace ApiSdk.Groups.Item.Team.Channels.Item.Members.Item {
    ...
    public class ConversationMemberItemRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            }, new CollectionBinding(groupIdOption, channelIdOption, conversationMemberIdOption, new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        ...
        public ConversationMemberItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group_id}/team/channels/{channel_id}/members/{conversationMember_id}{?select,expand}";
