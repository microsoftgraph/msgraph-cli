...
namespace ApiSdk.Groups.Item.Team.Channels.Item.Messages.Item.Replies.Item
{
    ...
    public class ChatMessageItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildHostedContentsNavCommand()
        {
            ...
            var builder = new ApiSdk.Groups.Item.Team.Channels.Item.Messages.Item.Replies.Item.HostedContents.HostedContentsRequestBuilder(PathParameters);
        ...
        public Command BuildSetReactionNavCommand()
        {
            ...
            var builder = new ApiSdk.Groups.Item.Team.Channels.Item.Messages.Item.Replies.Item.SetReaction.SetReactionRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildSoftDeleteNavCommand()
        {
            ...
            var builder = new ApiSdk.Groups.Item.Team.Channels.Item.Messages.Item.Replies.Item.SoftDelete.SoftDeleteRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildUndoSoftDeleteNavCommand()
        {
            ...
            var builder = new ApiSdk.Groups.Item.Team.Channels.Item.Messages.Item.Replies.Item.UndoSoftDelete.UndoSoftDeleteRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildUnsetReactionNavCommand()
        {
            ...
            var builder = new ApiSdk.Groups.Item.Team.Channels.Item.Messages.Item.Replies.Item.UnsetReaction.UnsetReactionRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Groups.Item.Team.Channels.Item.Messages.Item.Replies.Item.ChatMessageItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Groups.Item.Team.Channels.Item.Messages.Item.Replies.Item.ChatMessageItemRequestBuilder.ChatMessageItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Groups.Item.Team.Channels.Item.Messages.Item.Replies.Item.ChatMessageItemRequestBuilder.ChatMessageItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
