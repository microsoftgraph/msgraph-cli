using ApiSdk.Groups.Item.Team.Channels.Item.Messages.Item.HostedContents.Count;
using ApiSdk.Groups.Item.Team.Channels.Item.Messages.Item.HostedContents.Item;
using ApiSdk.Models;
...
namespace ApiSdk.Groups.Item.Team.Channels.Item.Messages.Item.HostedContents {
    ...
    public class HostedContentsRequestBuilder {
        ...
        public Command BuildCreateCommand() {
            ...
            }, new CollectionBinding(groupIdOption, channelIdOption, chatMessageIdOption, bodyOption, outputOption, queryOption, jsonNoIndentOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
