using ApiSdk.Groups.Item.Team.Channels.Item.SharedWithTeams.Count;
using ApiSdk.Groups.Item.Team.Channels.Item.SharedWithTeams.Item;
using ApiSdk.Models;
...
namespace ApiSdk.Groups.Item.Team.Channels.Item.SharedWithTeams {
    /// <summary>
    ...
    public class SharedWithTeamsRequestBuilder : BaseCliRequestBuilder {
        ...
        public Command BuildCreateCommand() {
            ...
            command.Description = "Create new navigation property to sharedWithTeams for groups";
        ...
        public SharedWithTeamsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/groups/{group%2Did}/team/channels/{channel%2Did}/sharedWithTeams{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Get the list of teams that has been shared a specified channel. This operation is allowed only for channels with a **membershipType** value of `shared`.
        /// </summary>
...
#nullable restore
        ...
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<SharedWithTeamsRequestBuilderGetQueryParameters>> requestConfiguration = default) {
            ...
            if (requestConfiguration != null) {
                var requestConfig = new RequestConfiguration<SharedWithTeamsRequestBuilderGetQueryParameters>();
