...
namespace ApiSdk.Groups.Item.Team.Channels.Item.Tabs.Item {
    ...
    public class TeamsTabItemRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            }, new CollectionBinding(groupIdOption, channelIdOption, teamsTabIdOption, ifMatchOption, new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                await RequestAdapter.SendNoContentAsync(requestInfo, errorMapping: errorMapping, cancellationToken: cancellationToken);
                Console.WriteLine("Success");
            }, new CollectionBinding(groupIdOption, channelIdOption, teamsTabIdOption, bodyOption, new TypeBinding(typeof(CancellationToken))));
            return command;
        }
