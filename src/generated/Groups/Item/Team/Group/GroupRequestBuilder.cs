...
using System;
namespace ApiSdk.Groups.Item.Team.Group {
    /// <summary>
    ...
    public class GroupRequestBuilder : BaseCliRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.Description = "Get group from groups";
        ...
        public GroupRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/groups/{group%2Did}/team/group{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Get group from groups
        /// </summary>
