...
namespace ApiSdk.Groups.Item.Team.Schedule.SwapShiftsChangeRequests {
    ...
    public class SwapShiftsChangeRequestsRequestBuilder : BaseCliRequestBuilder {
        ...
        public SwapShiftsChangeRequestsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/groups/{group%2Did}/team/schedule/swapShiftsChangeRequests{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Retrieve a list of swapShiftsChangeRequest objects in the team.
        /// </summary>
...
#nullable restore
        ...
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<SwapShiftsChangeRequestsRequestBuilderGetQueryParameters>> requestConfiguration = default) {
            ...
            if (requestConfiguration != null) {
                var requestConfig = new RequestConfiguration<SwapShiftsChangeRequestsRequestBuilderGetQueryParameters>();
