...
namespace ApiSdk.Groups.Item.Team.Schedule.TimeOffReasons.Item {
    ...
    public class TimeOffReasonItemRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            }, new CollectionBinding(groupIdOption, timeOffReasonIdOption, new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        ...
        public TimeOffReasonItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group_id}/team/schedule/timeOffReasons/{timeOffReason_id}{?select}";
