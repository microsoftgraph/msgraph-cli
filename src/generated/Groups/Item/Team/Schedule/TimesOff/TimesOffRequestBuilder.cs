...
namespace ApiSdk.Groups.Item.Team.Schedule.TimesOff {
    ...
    public class TimesOffRequestBuilder : BaseCliRequestBuilder {
        ...
        public TimesOffRequestBuilder(string rawUrl) : base("{+baseurl}/groups/{group%2Did}/team/schedule/timesOff{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select}", rawUrl) {
        }
        /// <summary>
        /// Get the list of timeOff instances in a schedule. This API is available in the following national cloud deployments.
        /// </summary>
