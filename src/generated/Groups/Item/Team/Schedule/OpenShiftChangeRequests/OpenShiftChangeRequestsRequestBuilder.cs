using ApiSdk.Groups.Item.Team.Schedule.OpenShiftChangeRequests.Count;
using ApiSdk.Groups.Item.Team.Schedule.OpenShiftChangeRequests.Item;
using ApiSdk.Models;
...
namespace ApiSdk.Groups.Item.Team.Schedule.OpenShiftChangeRequests {
    ...
    public class OpenShiftChangeRequestsRequestBuilder {
        ...
        public Command BuildListCommand() {
            ...
            command.Description = "Get openShiftChangeRequests from groups";
            // Create options for all the parameters
            var groupIdOption = new Option<string>("--group-id", description: "key: id of group") {
            };
            groupIdOption.IsRequired = true;
