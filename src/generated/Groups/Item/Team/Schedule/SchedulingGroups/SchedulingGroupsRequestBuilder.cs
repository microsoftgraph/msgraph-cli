...
namespace ApiSdk.Groups.Item.Team.Schedule.SchedulingGroups {
    ...
    public class SchedulingGroupsRequestBuilder : BaseCliRequestBuilder {
        ...
        public Command BuildCreateCommand() {
            ...
            command.Description = "Create a new schedulingGroup. This API is available in the following national cloud deployments.\n\nFind more info here:\n  https://learn.microsoft.com/graph/api/schedule-post-schedulinggroups?view=graph-rest-1.0";
        ...
        public Command BuildListCommand() {
            ...
            command.Description = "Get the list of schedulingGroups in this schedule. This API is available in the following national cloud deployments.\n\nFind more info here:\n  https://learn.microsoft.com/graph/api/schedule-list-schedulinggroups?view=graph-rest-1.0";
            var groupIdOption = new Option<string>("--group-id", description: "The unique identifier of group") {
            };
            groupIdOption.IsRequired = true;
            command.AddOption(groupIdOption);
        ...
        public SchedulingGroupsRequestBuilder(string rawUrl) : base("{+baseurl}/groups/{group%2Did}/team/schedule/schedulingGroups{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select}", rawUrl) {
        }
        /// <summary>
        /// Get the list of schedulingGroups in this schedule. This API is available in the following national cloud deployments.
        /// </summary>
