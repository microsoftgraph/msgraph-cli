using ApiSdk.Groups.Item.Team.Schedule.SchedulingGroups.Count;
using ApiSdk.Groups.Item.Team.Schedule.SchedulingGroups.Item;
...
using System;
namespace ApiSdk.Groups.Item.Team.Schedule.SchedulingGroups {
    /// <summary>
    ...
    public class SchedulingGroupsRequestBuilder : BaseCliRequestBuilder {
        ...
        public SchedulingGroupsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/groups/{group%2Did}/team/schedule/schedulingGroups{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select}", pathParameters) {
        }
        /// <summary>
        /// Get the list of schedulingGroups in this schedule.
        /// </summary>
...
#nullable restore
        ...
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<SchedulingGroupsRequestBuilderGetQueryParameters>> requestConfiguration = default) {
            ...
            if (requestConfiguration != null) {
                var requestConfig = new RequestConfiguration<SchedulingGroupsRequestBuilderGetQueryParameters>();
