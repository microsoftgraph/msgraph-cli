...
namespace ApiSdk.Groups.Item.Photo.Value {
    ...
    public class ContentRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string groupId, FileInfo file, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
            ...
            }, groupIdOption, fileOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// The group's profile photo.
        ...
        public Command BuildPutCommand() {
            ...
            command.SetHandler(async (string groupId, FileInfo file, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
