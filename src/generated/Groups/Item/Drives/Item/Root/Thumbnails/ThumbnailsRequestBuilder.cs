using ApiSdk.Groups.Item.Drives.Item.Root.Thumbnails.Count;
using ApiSdk.Groups.Item.Drives.Item.Root.Thumbnails.Item;
using ApiSdk.Models;
...
namespace ApiSdk.Groups.Item.Drives.Item.Root.Thumbnails {
    /// <summary>
