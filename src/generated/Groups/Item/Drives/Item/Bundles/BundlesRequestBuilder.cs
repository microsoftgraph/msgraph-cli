using ApiSdk.Groups.Item.Drives.Item.Bundles.Count;
using ApiSdk.Groups.Item.Drives.Item.Bundles.Item;
using ApiSdk.Models;
...
namespace ApiSdk.Groups.Item.Drives.Item.Bundles {
    ...
    public class BundlesRequestBuilder {
        ...
        public BundlesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/drives/{drive%2Did}/bundles{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
