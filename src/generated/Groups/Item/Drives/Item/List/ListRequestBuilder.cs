using ApiSdk.Groups.Item.Drives.Item.List.Columns;
using ApiSdk.Groups.Item.Drives.Item.List.ContentTypes;
using ApiSdk.Groups.Item.Drives.Item.List.Drive;
using ApiSdk.Groups.Item.Drives.Item.List.Items;
using ApiSdk.Groups.Item.Drives.Item.List.Operations;
using ApiSdk.Groups.Item.Drives.Item.List.Subscriptions;
using ApiSdk.Models;
...
namespace ApiSdk.Groups.Item.Drives.Item.List {
    ...
    public class ListRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.Description = "Delete navigation property list for groups";
            ...
            }, new CollectionBinding(groupIdOption, driveIdOption, ifMatchOption, new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(groupIdOption, driveIdOption, selectOption, expandOption, outputOption, queryOption, jsonNoIndentOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        ...
        public Command BuildPatchCommand() {
            ...
            command.Description = "Update the navigation property list in groups";
            // Create options for all the parameters
            var groupIdOption = new Option<string>("--group-id", description: "key: id of group") {
            };
            groupIdOption.IsRequired = true;
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                await RequestAdapter.SendNoContentAsync(requestInfo, errorMapping: errorMapping, cancellationToken: cancellationToken);
                Console.WriteLine("Success");
            }, new CollectionBinding(groupIdOption, driveIdOption, bodyOption, new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        ...
        public ListRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/drives/{drive%2Did}/list{?%24select,%24expand}";
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(ApiSdk.Models.List body, Action<ListRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
