using ApiSdk.Groups.Item.Drives.Item.List.Items.Item.Analytics;
using ApiSdk.Groups.Item.Drives.Item.List.Items.Item.DocumentSetVersions;
using ApiSdk.Groups.Item.Drives.Item.List.Items.Item.DriveItem;
using ApiSdk.Groups.Item.Drives.Item.List.Items.Item.Fields;
...
namespace ApiSdk.Groups.Item.Drives.Item.List.Items.Item {
    ...
    public class ListItemItemRequestBuilder {
        ...
        public Command BuildDriveItemCommand() {
            ...
            var builder = new ApiSdk.Groups.Item.Drives.Item.List.Items.Item.DriveItem.DriveItemRequestBuilder(PathParameters, RequestAdapter);
