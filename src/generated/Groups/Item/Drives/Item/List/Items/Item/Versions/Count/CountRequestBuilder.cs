...
namespace ApiSdk.Groups.Item.Drives.Item.List.Items.Item.Versions.Count {
    ...
    public class CountRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(groupIdOption, driveIdOption, listItemIdOption, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
