using ApiSdk.Groups.Item.Drives.Item.List.Items.Item.Versions.Count;
using ApiSdk.Groups.Item.Drives.Item.List.Items.Item.Versions.Item;
using ApiSdk.Models;
...
namespace ApiSdk.Groups.Item.Drives.Item.List.Items.Item.Versions {
    ...
    public class VersionsRequestBuilder {
        ...
        public Command BuildCreateCommand() {
            ...
            }, new CollectionBinding(groupIdOption, driveIdOption, listItemIdOption, bodyOption, outputOption, queryOption, jsonNoIndentOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
