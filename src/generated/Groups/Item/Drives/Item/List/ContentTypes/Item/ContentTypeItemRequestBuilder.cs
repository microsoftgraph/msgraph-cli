using ApiSdk.Groups.Item.Drives.Item.List.ContentTypes.Item.AssociateWithHubSites;
using ApiSdk.Groups.Item.Drives.Item.List.ContentTypes.Item.Base;
using ApiSdk.Groups.Item.Drives.Item.List.ContentTypes.Item.BaseTypes;
using ApiSdk.Groups.Item.Drives.Item.List.ContentTypes.Item.ColumnLinks;
using ApiSdk.Groups.Item.Drives.Item.List.ContentTypes.Item.ColumnPositions;
using ApiSdk.Groups.Item.Drives.Item.List.ContentTypes.Item.Columns;
using ApiSdk.Groups.Item.Drives.Item.List.ContentTypes.Item.CopyToDefaultContentLocation;
using ApiSdk.Groups.Item.Drives.Item.List.ContentTypes.Item.IsPublished;
using ApiSdk.Groups.Item.Drives.Item.List.ContentTypes.Item.Publish;
using ApiSdk.Groups.Item.Drives.Item.List.ContentTypes.Item.Unpublish;
using ApiSdk.Models;
...
namespace ApiSdk.Groups.Item.Drives.Item.List.ContentTypes.Item {
    ...
    public class ContentTypeItemRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            }, new CollectionBinding(groupIdOption, driveIdOption, contentTypeIdOption, ifMatchOption, new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(groupIdOption, driveIdOption, contentTypeIdOption, selectOption, expandOption, outputOption, queryOption, jsonNoIndentOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
