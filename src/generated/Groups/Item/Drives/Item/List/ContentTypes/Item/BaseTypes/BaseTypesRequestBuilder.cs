using ApiSdk.Groups.Item.Drives.Item.List.ContentTypes.Item.BaseTypes.Count;
using ApiSdk.Groups.Item.Drives.Item.List.ContentTypes.Item.BaseTypes.Item;
...
namespace ApiSdk.Groups.Item.Drives.Item.List.ContentTypes.Item.BaseTypes {
    ...
    public class BaseTypesRequestBuilder {
        ...
        public List<Command> BuildCommand() {
            var builder = new ApiSdk.Groups.Item.Drives.Item.List.ContentTypes.Item.BaseTypes.Item.ContentTypeItemRequestBuilder(PathParameters, RequestAdapter);
