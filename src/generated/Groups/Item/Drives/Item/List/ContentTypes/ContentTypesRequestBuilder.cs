using ApiSdk.Groups.Item.Drives.Item.List.ContentTypes.AddCopy;
using ApiSdk.Groups.Item.Drives.Item.List.ContentTypes.AddCopyFromContentTypeHub;
using ApiSdk.Groups.Item.Drives.Item.List.ContentTypes.Count;
using ApiSdk.Groups.Item.Drives.Item.List.ContentTypes.GetCompatibleHubContentTypes;
using ApiSdk.Groups.Item.Drives.Item.List.ContentTypes.Item;
using ApiSdk.Models;
...
namespace ApiSdk.Groups.Item.Drives.Item.List.ContentTypes {
    ...
    public class ContentTypesRequestBuilder {
        ...
        public ContentTypesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/drives/{drive%2Did}/list/contentTypes{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
