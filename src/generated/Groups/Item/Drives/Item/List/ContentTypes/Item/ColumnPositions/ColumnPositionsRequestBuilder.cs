using ApiSdk.Groups.Item.Drives.Item.List.ContentTypes.Item.ColumnPositions.Count;
using ApiSdk.Groups.Item.Drives.Item.List.ContentTypes.Item.ColumnPositions.Item;
using ApiSdk.Models;
...
namespace ApiSdk.Groups.Item.Drives.Item.List.ContentTypes.Item.ColumnPositions {
    ...
    public class ColumnPositionsRequestBuilder {
        ...
        public ColumnPositionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/drives/{drive%2Did}/list/contentTypes/{contentType%2Did}/columnPositions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
