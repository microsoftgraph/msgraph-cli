using ApiSdk.Groups.Item.Drives.Item.Following.Item.Content;
using ApiSdk.Models;
...
namespace ApiSdk.Groups.Item.Drives.Item.Following.Item {
    /// <summary>
    ...
    public class DriveItemItemRequestBuilder {
        ...
        public DriveItemItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/drives/{drive%2Did}/following/{driveItem%2Did}{?%24select,%24expand}";
