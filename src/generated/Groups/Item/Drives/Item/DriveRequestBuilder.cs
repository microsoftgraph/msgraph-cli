...
namespace ApiSdk.Groups.Item.Drives.Item {
    ...
    public class DriveRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string groupId, string driveId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, groupIdOption, driveIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The group's drives. Read-only.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string groupId, string driveId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, groupIdOption, driveIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The group's drives. Read-only.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string groupId, string driveId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, groupIdOption, driveIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
