using ApiSdk.Groups.Item.Drives.Item.Items.Item.Thumbnails.Count;
using ApiSdk.Groups.Item.Drives.Item.Items.Item.Thumbnails.Item;
using ApiSdk.Models;
...
namespace ApiSdk.Groups.Item.Drives.Item.Items.Item.Thumbnails {
    ...
    public class ThumbnailsRequestBuilder {
        ...
        public Command BuildCommand() {
            ...
            var builder = new ThumbnailSetItemRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildCreateCommand() {
            ...
            command.Description = "Create new navigation property to thumbnails for groups";
        ...
        public ThumbnailsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/drives/{drive%2Did}/items/{driveItem%2Did}/thumbnails{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
