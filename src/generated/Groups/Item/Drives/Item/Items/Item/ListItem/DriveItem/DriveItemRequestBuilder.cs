using ApiSdk.Groups.Item.Drives.Item.Items.Item.ListItem.DriveItem.Content;
using ApiSdk.Models;
...
namespace ApiSdk.Groups.Item.Drives.Item.Items.Item.ListItem.DriveItem {
    ...
    public class DriveItemRequestBuilder {
        ...
        public DriveItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/drives/{drive%2Did}/items/{driveItem%2Did}/listItem/driveItem{?%24select,%24expand}";
