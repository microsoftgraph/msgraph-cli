...
namespace ApiSdk.Groups.Item.Drives.Item.Items.Item.Children.Item.Content {
    ...
    public class ContentRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(groupIdOption, driveIdOption, driveItemIdOption, driveItemId1Option, fileOption, new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// The content stream, if the item represents a file.
        ...
        public Command BuildPutCommand() {
            ...
            }, new CollectionBinding(groupIdOption, driveIdOption, driveItemIdOption, driveItemId1Option, bodyOption, new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
