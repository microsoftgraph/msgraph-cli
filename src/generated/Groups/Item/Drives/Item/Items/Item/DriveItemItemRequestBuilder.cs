using ApiSdk.Groups.Item.Drives.Item.Items.Item.Analytics;
using ApiSdk.Groups.Item.Drives.Item.Items.Item.Checkin;
using ApiSdk.Groups.Item.Drives.Item.Items.Item.Checkout;
using ApiSdk.Groups.Item.Drives.Item.Items.Item.Children;
using ApiSdk.Groups.Item.Drives.Item.Items.Item.Content;
using ApiSdk.Groups.Item.Drives.Item.Items.Item.Copy;
using ApiSdk.Groups.Item.Drives.Item.Items.Item.CreateLink;
using ApiSdk.Groups.Item.Drives.Item.Items.Item.CreateUploadSession;
using ApiSdk.Groups.Item.Drives.Item.Items.Item.Delta;
using ApiSdk.Groups.Item.Drives.Item.Items.Item.DeltaWithToken;
using ApiSdk.Groups.Item.Drives.Item.Items.Item.Follow;
using ApiSdk.Groups.Item.Drives.Item.Items.Item.GetActivitiesByInterval;
using ApiSdk.Groups.Item.Drives.Item.Items.Item.GetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithInterval;
using ApiSdk.Groups.Item.Drives.Item.Items.Item.Invite;
using ApiSdk.Groups.Item.Drives.Item.Items.Item.ListItem;
using ApiSdk.Groups.Item.Drives.Item.Items.Item.Permissions;
using ApiSdk.Groups.Item.Drives.Item.Items.Item.Preview;
using ApiSdk.Groups.Item.Drives.Item.Items.Item.Restore;
using ApiSdk.Groups.Item.Drives.Item.Items.Item.SearchWithQ;
using ApiSdk.Groups.Item.Drives.Item.Items.Item.Subscriptions;
using ApiSdk.Groups.Item.Drives.Item.Items.Item.Thumbnails;
using ApiSdk.Groups.Item.Drives.Item.Items.Item.Unfollow;
using ApiSdk.Groups.Item.Drives.Item.Items.Item.ValidatePermission;
using ApiSdk.Groups.Item.Drives.Item.Items.Item.Versions;
using ApiSdk.Models;
...
namespace ApiSdk.Groups.Item.Drives.Item.Items.Item {
    /// <summary>
