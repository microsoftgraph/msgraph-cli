...
namespace ApiSdk.Groups.Item.Drives.Item.Items.Item.ListItem.GetActivitiesByInterval {
    ...
    public class GetActivitiesByIntervalResponse : IAdditionalDataHolder, IParsable {
        ...
        /// </summary>
        public static ApiSdk.Groups.Item.Drives.Item.Items.Item.ListItem.GetActivitiesByInterval.GetActivitiesByIntervalResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
