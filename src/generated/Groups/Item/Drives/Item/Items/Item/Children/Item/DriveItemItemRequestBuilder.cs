using ApiSdk.Groups.Item.Drives.Item.Items.Item.Children.Item.Content;
using ApiSdk.Models;
...
namespace ApiSdk.Groups.Item.Drives.Item.Items.Item.Children.Item {
    ...
    public class DriveItemItemRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                var driveItemId1 = (string) parameters[3];
                ...
                requestInfo.PathParameters.Add("driveItem%2Did1", driveItemId1);
            ...
            }, new CollectionBinding(groupIdOption, driveIdOption, driveItemIdOption, driveItemId1Option, selectOption, expandOption, outputOption, queryOption, jsonNoIndentOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        ...
        public DriveItemItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/drives/{drive%2Did}/items/{driveItem%2Did}/children/{driveItem%2Did1}{?%24select,%24expand}";
