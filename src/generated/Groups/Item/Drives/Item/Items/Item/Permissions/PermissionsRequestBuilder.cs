...
namespace ApiSdk.Groups.Item.Drives.Item.Items.Item.Permissions {
    ...
    public class PermissionsRequestBuilder {
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ApiSdk.Models.Permission body, Action<PermissionsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
