using ApiSdk.Groups.Item.Drives.Item.Items.Item.Permissions.Count;
using ApiSdk.Groups.Item.Drives.Item.Items.Item.Permissions.Item;
...
namespace ApiSdk.Groups.Item.Drives.Item.Items.Item.Permissions {
    ...
    public class PermissionsRequestBuilder {
        ...
        public List<Command> BuildCommand() {
            var builder = new PermissionItemRequestBuilder(PathParameters, RequestAdapter);
            var commands = new List<Command>();
            commands.Add(builder.BuildDeleteCommand());
            commands.Add(builder.BuildGetCommand());
            commands.Add(builder.BuildGrantCommand());
        ...
        public Command BuildCreateCommand() {
            ...
            }, new CollectionBinding(groupIdOption, driveIdOption, driveItemIdOption, bodyOption, outputOption, queryOption, jsonNoIndentOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        ...
        /// <param name="options">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ApiSdk.Models.Microsoft.Graph.Permission body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
