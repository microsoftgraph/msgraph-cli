using ApiSdk.Groups.Item.Drives.Item.Items.Item.ListItem.Versions.Item.Fields;
using ApiSdk.Groups.Item.Drives.Item.Items.Item.ListItem.Versions.Item.RestoreVersion;
using ApiSdk.Models;
...
namespace ApiSdk.Groups.Item.Drives.Item.Items.Item.ListItem.Versions.Item {
    ...
    public class ListItemVersionItemRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            }, new CollectionBinding(groupIdOption, driveIdOption, driveItemIdOption, listItemVersionIdOption, ifMatchOption, new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(groupIdOption, driveIdOption, driveItemIdOption, listItemVersionIdOption, selectOption, expandOption, outputOption, queryOption, jsonNoIndentOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
