using ApiSdk.Groups.Item.Drives.Item.Items.Item.ListItem.DocumentSetVersions.Item.Restore;
using ApiSdk.Models;
...
namespace ApiSdk.Groups.Item.Drives.Item.Items.Item.ListItem.DocumentSetVersions.Item {
    /// <summary>
    ...
    public class DocumentSetVersionItemRequestBuilder {
        ...
        public Command BuildPatchCommand() {
            ...
            command.Description = "Update the navigation property documentSetVersions in groups";
            // Create options for all the parameters
            var groupIdOption = new Option<string>("--group-id", description: "key: id of group") {
            };
            groupIdOption.IsRequired = true;
