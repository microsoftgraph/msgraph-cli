using ApiSdk.Groups.Item.Drives.Item.Items.Item.Children.Count;
using ApiSdk.Groups.Item.Drives.Item.Items.Item.Children.Item;
using ApiSdk.Models;
...
namespace ApiSdk.Groups.Item.Drives.Item.Items.Item.Children {
    ...
    public class ChildrenRequestBuilder {
        ...
        public List<Command> BuildCommand() {
            var builder = new ApiSdk.Groups.Item.Drives.Item.Items.Item.Children.Item.DriveItemItemRequestBuilder(PathParameters, RequestAdapter);
