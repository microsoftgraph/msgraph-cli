...
namespace ApiSdk.Groups.Item.Drives {
    ...
    public class DrivesRequestBuilder : BaseCliRequestBuilder {
        ...
        public DrivesRequestBuilder(string rawUrl) : base("{+baseurl}/groups/{group%2Did}/drives{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// The group&apos;s drives. Read-only.
        /// </summary>
