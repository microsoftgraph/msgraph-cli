using ApiSdk.Groups.Item.Drives.Count;
...
namespace ApiSdk.Groups.Item.Drives {
    ...
    public class DrivesRequestBuilder : BaseCliRequestBuilder {
        ...
        public DrivesRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/groups/{group%2Did}/drives{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Retrieve the list of Drive resources available for a target User, Group, or Site.
        /// </summary>
