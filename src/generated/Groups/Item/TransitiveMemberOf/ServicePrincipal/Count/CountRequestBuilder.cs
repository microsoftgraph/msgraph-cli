...
namespace ApiSdk.Groups.Item.TransitiveMemberOf.ServicePrincipal.Count {
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/transitiveMemberOf/microsoft.graph.servicePrincipal/$count";
