...
namespace ApiSdk.Groups.Item.TransitiveMemberOf.Item.MicrosoftGraphApplication {
    /// <summary>
    ...
    public class MicrosoftGraphApplicationRequestBuilder {
        ...
        public MicrosoftGraphApplicationRequestBuilder(Dictionary<string, object> pathParameters) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/transitiveMemberOf/{directoryObject%2Did}/microsoft.graph.application{?%24select,%24expand}";
