...
namespace ApiSdk.Groups.Item.AcceptedSenders.Item
{
    ...
    public partial class DirectoryObjectItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildRefByIdNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.AcceptedSenders.Item.Ref.RefRequestBuilder(PathParameters);
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Groups.Item.AcceptedSenders.Item.DirectoryObjectItemRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        public DirectoryObjectItemRequestBuilder(string rawUrl) : base("{+baseurl}/groups/{group%2Did}/acceptedSenders/{directoryObject%2Did}", rawUrl)
        {
        }
    }
}
