...
namespace ApiSdk.Groups.Item.AcceptedSenders.Item
{
    ...
    public class DirectoryObjectItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildRefByIdNavCommand()
        {
            ...
            var builder = new ApiSdk.Groups.Item.AcceptedSenders.Item.Ref.RefRequestBuilder(PathParameters);
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Groups.Item.AcceptedSenders.Item.DirectoryObjectItemRequestBuilder"/> and sets the default values.
        /// </summary>
