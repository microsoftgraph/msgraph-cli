    ...
    public class ReplyRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Groups.Item.Conversations.Item.Threads.Item.Posts.Item.InReplyTo.Reply.ReplyRequestBody>(ApiSdk.Groups.Item.Conversations.Item.Threads.Item.Posts.Item.InReplyTo.Reply.ReplyRequestBody.CreateFromDiscriminatorValue);
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ApiSdk.Groups.Item.Conversations.Item.Threads.Item.Posts.Item.InReplyTo.Reply.ReplyRequestBody body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
