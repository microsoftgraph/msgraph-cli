...
namespace ApiSdk.Groups.Item.Conversations.Item.Threads.Item.MicrosoftGraphReply {
    /// <summary>
    ...
    public class MicrosoftGraphReplyRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.Description = "Reply to a thread in a group conversation and add a new post to it. You can specify the parent conversation in the request, or, you can specify just the thread without the parent conversation.\n\nFind more info here:\n  https://docs.microsoft.com/graph/api/conversationthread-reply?view=graph-rest-1.0";
        ...
        public MicrosoftGraphReplyRequestBuilder(Dictionary<string, object> pathParameters) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/conversations/{conversation%2Did}/threads/{conversationThread%2Did}/microsoft.graph.reply";
