...
namespace ApiSdk.Groups.Item.Conversations.Item.Threads.Item.Posts.Item.Attachments.Item {
    ...
    public class AttachmentRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string groupId, string conversationId, string conversationThreadId, string postId, string attachmentId, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                var requestInfo = CreateDeleteRequestInformation(q => {
                });
                await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                console.WriteLine("Success");
            }, groupIdOption, conversationIdOption, conversationThreadIdOption, postIdOption, attachmentIdOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// The collection of fileAttachment, itemAttachment, and referenceAttachment attachments for the post. Read-only. Nullable. Supports $expand.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string groupId, string conversationId, string conversationThreadId, string postId, string attachmentId, string[] select, string[] expand, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
            ...
            }, groupIdOption, conversationIdOption, conversationThreadIdOption, postIdOption, attachmentIdOption, selectOption, expandOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// The collection of fileAttachment, itemAttachment, and referenceAttachment attachments for the post. Read-only. Nullable. Supports $expand.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string groupId, string conversationId, string conversationThreadId, string postId, string attachmentId, string body, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                ...
                await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                console.WriteLine("Success");
            }, groupIdOption, conversationIdOption, conversationThreadIdOption, postIdOption, attachmentIdOption, bodyOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
