...
namespace ApiSdk.Groups.Item.Conversations.Item.Threads.Item.Posts.Item.Extensions.Item {
    ...
    public class ExtensionRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string, string, string, string[], string[]>(async (groupId, conversationId, conversationThreadId, postId, extensionId, select, expand) => {
