...
namespace ApiSdk.Groups.Item.Conversations.Item.Threads.Item.Posts.Item.Forward {
    ...
    public class ForwardRequestBody : IAdditionalDataHolder, IParsable {
        ...
        /// </summary>
        public static ApiSdk.Groups.Item.Conversations.Item.Threads.Item.Posts.Item.Forward.ForwardRequestBody CreateFromDiscriminatorValue(IParseNode parseNode) {
