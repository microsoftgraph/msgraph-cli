...
namespace ApiSdk.Groups.Item.Conversations.Item.Threads.Item.Posts.Item.InReplyTo.SingleValueExtendedProperties.Item {
    ...
    public class SingleValueLegacyExtendedPropertyItemRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            }, new CollectionBinding(groupIdOption, conversationIdOption, conversationThreadIdOption, postIdOption, singleValueLegacyExtendedPropertyIdOption, new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
