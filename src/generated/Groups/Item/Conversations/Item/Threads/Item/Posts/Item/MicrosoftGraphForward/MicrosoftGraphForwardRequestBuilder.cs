...
namespace ApiSdk.Groups.Item.Conversations.Item.Threads.Item.Posts.Item.MicrosoftGraphForward {
    /// <summary>
    ...
    public class MicrosoftGraphForwardRequestBuilder {
        ...
        public MicrosoftGraphForwardRequestBuilder(Dictionary<string, object> pathParameters) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/conversations/{conversation%2Did}/threads/{conversationThread%2Did}/posts/{post%2Did}/microsoft.graph.forward";
