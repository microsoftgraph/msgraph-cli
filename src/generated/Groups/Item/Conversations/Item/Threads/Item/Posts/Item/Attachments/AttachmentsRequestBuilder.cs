...
namespace ApiSdk.Groups.Item.Conversations.Item.Threads.Item.Posts.Item.Attachments {
    ...
    public class AttachmentsRequestBuilder {
        ...
        public Command BuildListCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string, string, int?, int?, string, bool?, string[], string[], string[]>(async (groupId, conversationId, conversationThreadId, postId, top, skip, filter, count, orderby, select, expand) => {
