...
namespace ApiSdk.Groups.Item.Conversations.Item.Threads.Item.Posts {
    ...
    public class PostsRequestBuilder {
        ...
        public Command BuildCreateCommand() {
            ...
            command.SetHandler(async (string groupId, string conversationId, string conversationThreadId, string body, FormatterType output, IOutputFormatterFactory outputFormatterFactory, CancellationToken cancellationToken) => {
            ...
            }, groupIdOption, conversationIdOption, conversationThreadIdOption, bodyOption, outputOption);
            return command;
        }
        /// <summary>
        /// Read-only. Nullable.
        ...
        public Command BuildListCommand() {
            ...
            command.AddOption(outputOption);
            command.SetHandler(async (string groupId, string conversationId, string conversationThreadId, int? top, int? skip, string filter, bool? count, string[] orderby, string[] select, string[] expand, FormatterType output, IOutputFormatterFactory outputFormatterFactory, CancellationToken cancellationToken) => {
                ...
                var formatter = outputFormatterFactory.GetFormatter(output);
                formatter.WriteOutput(response);
            }, groupIdOption, conversationIdOption, conversationThreadIdOption, topOption, skipOption, filterOption, countOption, orderbyOption, selectOption, expandOption, outputOption);
            return command;
        }
        /// <summary>
