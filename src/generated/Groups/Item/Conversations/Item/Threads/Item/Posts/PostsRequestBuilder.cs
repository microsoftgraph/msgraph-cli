...
namespace ApiSdk.Groups.Item.Conversations.Item.Threads.Item.Posts {
    ...
    public class PostsRequestBuilder {
        ...
        public Command BuildListCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string, int?, int?, string, bool?, string[], string[], string[]>(async (groupId, conversationId, conversationThreadId, top, skip, filter, count, orderby, select, expand) => {
