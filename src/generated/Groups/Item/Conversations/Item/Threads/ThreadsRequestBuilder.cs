...
namespace ApiSdk.Groups.Item.Conversations.Item.Threads {
    ...
    public class ThreadsRequestBuilder {
        ...
        public Command BuildListCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, int?, int?, string, bool?, object, object, object>(async (groupId, conversationId, top, skip, filter, count, orderby, select, expand) => {
