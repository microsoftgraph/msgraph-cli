...
namespace ApiSdk.Groups.Item.Owners.Item.MicrosoftGraphUser {
    /// <summary>
    ...
    public class UserRequestBuilder {
        ...
        public UserRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/owners/{directoryObject%2Did}/microsoft.graph.user{?%24select,%24expand}";
