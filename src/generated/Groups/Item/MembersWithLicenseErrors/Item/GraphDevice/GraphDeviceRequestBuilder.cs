...
namespace ApiSdk.Groups.Item.MembersWithLicenseErrors.Item.GraphDevice {
    ...
    public class GraphDeviceRequestBuilder : BaseCliRequestBuilder {
        ...
        public GraphDeviceRequestBuilder(string rawUrl) : base("{+baseurl}/groups/{group%2Did}/membersWithLicenseErrors/{directoryObject%2Did}/graph.device{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Get the item of type microsoft.graph.directoryObject as microsoft.graph.device
        /// </summary>
