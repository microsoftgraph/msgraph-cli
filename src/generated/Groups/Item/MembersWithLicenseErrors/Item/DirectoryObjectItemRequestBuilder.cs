using ApiSdk.Groups.Item.MembersWithLicenseErrors.Item.GraphApplication;
using ApiSdk.Groups.Item.MembersWithLicenseErrors.Item.GraphDevice;
using ApiSdk.Groups.Item.MembersWithLicenseErrors.Item.GraphGroup;
...
namespace ApiSdk.Groups.Item.MembersWithLicenseErrors.Item {
    ...
    public class DirectoryObjectItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public DirectoryObjectItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/groups/{group%2Did}/membersWithLicenseErrors/{directoryObject%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// A list of group members with license errors from this group-based license assignment. Read-only.
        /// </summary>
