...
namespace ApiSdk.Groups.Item.MembersWithLicenseErrors
{
    ...
    public partial class MembersWithLicenseErrorsRequestBuilder : BaseCliRequestBuilder
    {
        /// <summary>
        /// Provides operations to manage the membersWithLicenseErrors property of the microsoft.graph.group entity.
        /// </summary>
        ...
        public Tuple<List<Command>, List<Command>> BuildCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.MembersWithLicenseErrors.Item.DirectoryObjectItemRequestBuilder(PathParameters);
        ...
        public Command BuildCountNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.MembersWithLicenseErrors.Count.CountRequestBuilder(PathParameters);
        ...
        public Command BuildGraphApplicationNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.MembersWithLicenseErrors.GraphApplication.GraphApplicationRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildGraphDeviceNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.MembersWithLicenseErrors.GraphDevice.GraphDeviceRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildGetCommand());
        ...
        public Command BuildGraphGroupNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.MembersWithLicenseErrors.GraphGroup.GraphGroupRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildGetCommand());
        ...
        public Command BuildGraphOrgContactNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.MembersWithLicenseErrors.GraphOrgContact.GraphOrgContactRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildGetCommand());
        ...
        public Command BuildGraphServicePrincipalNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.MembersWithLicenseErrors.GraphServicePrincipal.GraphServicePrincipalRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildGetCommand());
        ...
        public Command BuildGraphUserNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Groups.Item.MembersWithLicenseErrors.GraphUser.GraphUserRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildGetCommand());
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Groups.Item.MembersWithLicenseErrors.MembersWithLicenseErrorsRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Groups.Item.MembersWithLicenseErrors.MembersWithLicenseErrorsRequestBuilder.MembersWithLicenseErrorsRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Groups.Item.MembersWithLicenseErrors.MembersWithLicenseErrorsRequestBuilder.MembersWithLicenseErrorsRequestBuilderGetQueryParameters>> requestConfiguration = default)
