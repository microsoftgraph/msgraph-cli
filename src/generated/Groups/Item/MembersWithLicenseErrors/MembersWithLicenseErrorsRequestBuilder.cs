    ...
    public class MembersWithLicenseErrorsRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.Handler = CommandHandler.Create<string, int?, int?, string, string, bool?, object, object, object>(async (groupId, top, skip, search, filter, count, orderby, select, expand) => {
                ...
                var result = await RequestAdapter.SendAsync<MembersWithLicenseErrorsResponse>(requestInfo);
        ...
        public Command BuildRefCommand() {
            ...
            var builder = new ApiSdk.Groups.Item.MembersWithLicenseErrors.@Ref.RefRequestBuilder(PathParameters, RequestAdapter);
