using ApiSdk.Groups.Item.MembersWithLicenseErrors.MicrosoftGraphServicePrincipal.Count;
using ApiSdk.Models;
...
namespace ApiSdk.Groups.Item.MembersWithLicenseErrors.MicrosoftGraphServicePrincipal {
    /// <summary>
    ...
    public class ServicePrincipalRequestBuilder {
        ...
        public ServicePrincipalRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/groups/{group%2Did}/membersWithLicenseErrors/microsoft.graph.servicePrincipal{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
