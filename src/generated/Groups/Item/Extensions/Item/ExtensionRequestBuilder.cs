...
namespace ApiSdk.Groups.Item.Extensions.Item {
    ...
    public class ExtensionRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string groupId, string extensionId) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string groupId, string extensionId, string[] select, string[] expand) => {
            ...
            }, groupIdOption, extensionIdOption, selectOption, expandOption);
            return command;
        }
        /// <summary>
        /// The collection of open extensions defined for the group. Read-only. Nullable.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string groupId, string extensionId, string body) => {
