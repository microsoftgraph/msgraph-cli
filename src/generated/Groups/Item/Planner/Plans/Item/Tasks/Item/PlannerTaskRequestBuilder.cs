...
namespace ApiSdk.Groups.Item.Planner.Plans.Item.Tasks.Item {
    ...
    public class PlannerTaskRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string groupId, string plannerPlanId, string plannerTaskId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, groupIdOption, plannerPlanIdOption, plannerTaskIdOption, new ServiceProviderBinder());
            return command;
        }
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string groupId, string plannerPlanId, string plannerTaskId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, groupIdOption, plannerPlanIdOption, plannerTaskIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// Collection of tasks in the plan. Read-only. Nullable.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string groupId, string plannerPlanId, string plannerTaskId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, groupIdOption, plannerPlanIdOption, plannerTaskIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
