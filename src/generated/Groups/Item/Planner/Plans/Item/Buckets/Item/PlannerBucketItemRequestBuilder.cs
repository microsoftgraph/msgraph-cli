...
namespace ApiSdk.Groups.Item.Planner.Plans.Item.Buckets.Item {
    ...
    public class PlannerBucketItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public PlannerBucketItemRequestBuilder(string rawUrl) : base("{+baseurl}/groups/{group%2Did}/planner/plans/{plannerPlan%2Did}/buckets/{plannerBucket%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Delete navigation property buckets for groups
        /// </summary>
