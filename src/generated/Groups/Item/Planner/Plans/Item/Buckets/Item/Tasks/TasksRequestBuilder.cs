...
namespace ApiSdk.Groups.Item.Planner.Plans.Item.Buckets.Item.Tasks {
    ...
    public class TasksRequestBuilder {
        ...
        public Command BuildListCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string, int?, int?, string, string, bool?, object, object, object>(async (groupId, plannerPlanId, plannerBucketId, top, skip, search, filter, count, orderby, select, expand) => {
