...
namespace ApiSdk.Groups.Item.Planner.Plans.Item.Buckets.Item {
    ...
    public class PlannerBucketRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            }, groupIdOption, plannerPlanIdOption, plannerBucketIdOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// Collection of buckets in the plan. Read-only. Nullable.
        ...
        public Command BuildGetCommand() {
            ...
            }, groupIdOption, plannerPlanIdOption, plannerBucketIdOption, selectOption, expandOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// Collection of buckets in the plan. Read-only. Nullable.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string groupId, string plannerPlanId, string plannerBucketId, string body, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                ...
                await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                console.WriteLine("Success");
            }, groupIdOption, plannerPlanIdOption, plannerBucketIdOption, bodyOption, new OutputFormatterFactoryBinder());
            return command;
        }
