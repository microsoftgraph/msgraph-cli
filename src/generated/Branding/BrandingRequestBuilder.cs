using ApiSdk.Branding.BackgroundImage;
using ApiSdk.Branding.BannerLogo;
using ApiSdk.Branding.Localizations;
using ApiSdk.Branding.SquareLogo;
...
namespace ApiSdk.Branding {
    ...
    public class BrandingRequestBuilder : BaseCliRequestBuilder {
        ...
        public BrandingRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/branding{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Get branding
        /// </summary>
