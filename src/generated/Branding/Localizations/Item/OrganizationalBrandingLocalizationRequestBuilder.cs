...
namespace ApiSdk.Branding.Localizations.Item {
    ...
    public class OrganizationalBrandingLocalizationRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string organizationalBrandingLocalizationId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, organizationalBrandingLocalizationIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// Add different branding based on a locale.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string organizationalBrandingLocalizationId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, organizationalBrandingLocalizationIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// Add different branding based on a locale.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string organizationalBrandingLocalizationId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, organizationalBrandingLocalizationIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
