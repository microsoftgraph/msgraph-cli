...
namespace ApiSdk.Branding.Localizations.Item {
    ...
    public class OrganizationalBrandingLocalizationRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string organizationalBrandingLocalizationId, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                var requestInfo = CreateDeleteRequestInformation(q => {
                });
                await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                console.WriteLine("Success");
            }, organizationalBrandingLocalizationIdOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// Add different branding based on a locale.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string organizationalBrandingLocalizationId, string[] select, string[] expand, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
            ...
            }, organizationalBrandingLocalizationIdOption, selectOption, expandOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// Add different branding based on a locale.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string organizationalBrandingLocalizationId, string body, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                ...
                await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                console.WriteLine("Success");
            }, organizationalBrandingLocalizationIdOption, bodyOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(OrganizationalBrandingLocalization model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
