using ApiSdk.Branding.Localizations.Item.BackgroundImage;
using ApiSdk.Branding.Localizations.Item.BannerLogo;
using ApiSdk.Branding.Localizations.Item.SquareLogo;
using ApiSdk.Models;
...
namespace ApiSdk.Branding.Localizations.Item {
    ...
    public class OrganizationalBrandingLocalizationItemRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            }, new CollectionBinding(organizationalBrandingLocalizationIdOption, ifMatchOption, new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(organizationalBrandingLocalizationIdOption, selectOption, expandOption, outputOption, queryOption, jsonNoIndentOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
