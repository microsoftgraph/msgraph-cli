...
namespace ApiSdk.Teamwork.DeletedTeams {
    ...
    public class DeletedTeamsRequestBuilder : BaseCliRequestBuilder {
        ...
        public Command BuildListCommand() {
            ...
            command.Description = "Get a list of the deletedTeam objects and their properties.\n\nFind more info here:\n  https://docs.microsoft.com/graph/api/teamwork-list-deletedteams?view=graph-rest-1.0";
...
#nullable restore
        ...
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<DeletedTeamsRequestBuilderGetQueryParameters>> requestConfiguration = default) {
            ...
            if (requestConfiguration != null) {
                var requestConfig = new RequestConfiguration<DeletedTeamsRequestBuilderGetQueryParameters>();
