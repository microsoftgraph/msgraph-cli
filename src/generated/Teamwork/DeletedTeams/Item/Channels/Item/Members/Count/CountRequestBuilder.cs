...
namespace ApiSdk.Teamwork.DeletedTeams.Item.Channels.Item.Members.Count {
    ...
    public class CountRequestBuilder : BaseCliRequestBuilder {
        ...
        public CountRequestBuilder(string rawUrl) : base("{+baseurl}/teamwork/deletedTeams/{deletedTeam%2Did}/channels/{channel%2Did}/members/$count{?%24search,%24filter}", rawUrl) {
        }
        /// <summary>
        /// Get the number of the resource
        /// </summary>
