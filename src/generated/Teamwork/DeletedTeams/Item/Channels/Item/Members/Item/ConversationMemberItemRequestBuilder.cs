...
using System;
namespace ApiSdk.Teamwork.DeletedTeams.Item.Channels.Item.Members.Item {
    /// <summary>
    ...
    public class ConversationMemberItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.Description = "Delete a conversationMember from a channel.\n\nFind more info here:\n  https://docs.microsoft.com/graph/api/conversationmember-delete?view=graph-rest-1.0";
        ...
        public ConversationMemberItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/teamwork/deletedTeams/{deletedTeam%2Did}/channels/{channel%2Did}/members/{conversationMember%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Delete a conversationMember from a channel.
        /// </summary>
