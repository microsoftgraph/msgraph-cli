...
using ApiSdk.Models;
using ApiSdk.Teamwork.DeletedTeams.Item.Channels.Item.SharedWithTeams.Item.AllowedMembers.Count;
using ApiSdk.Teamwork.DeletedTeams.Item.Channels.Item.SharedWithTeams.Item.AllowedMembers.Item;
...
using System;
namespace ApiSdk.Teamwork.DeletedTeams.Item.Channels.Item.SharedWithTeams.Item.AllowedMembers {
    /// <summary>
    ...
    public class AllowedMembersRequestBuilder : BaseCliRequestBuilder {
        ...
        public AllowedMembersRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/teamwork/deletedTeams/{deletedTeam%2Did}/channels/{channel%2Did}/sharedWithTeams/{sharedWithChannelTeamInfo%2Did}/allowedMembers{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// A collection of team members who have access to the shared channel.
        /// </summary>
...
#nullable restore
        ...
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<AllowedMembersRequestBuilderGetQueryParameters>> requestConfiguration = default) {
            ...
            if (requestConfiguration != null) {
                var requestConfig = new RequestConfiguration<AllowedMembersRequestBuilderGetQueryParameters>();
