...
using ApiSdk.Teamwork.DeletedTeams.Item.Channels.Item.SharedWithTeams.Count;
using ApiSdk.Teamwork.DeletedTeams.Item.Channels.Item.SharedWithTeams.Item;
...
namespace ApiSdk.Teamwork.DeletedTeams.Item.Channels.Item.SharedWithTeams {
    ...
    public class SharedWithTeamsRequestBuilder : BaseCliRequestBuilder {
        ...
        public SharedWithTeamsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/teamwork/deletedTeams/{deletedTeam%2Did}/channels/{channel%2Did}/sharedWithTeams{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Get the list of teams that has been shared a specified channel. This operation is allowed only for channels with a **membershipType** value of `shared`.
        /// </summary>
