    ...
    public class TeamworkRequestBuilder {
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Models.Microsoft.Graph.Teamwork>(ApiSdk.Models.Microsoft.Graph.Teamwork.CreateFromDiscriminatorValue);
        ...
        public Command BuildWorkforceIntegrationsCommand() {
            ...
            var builder = new WorkforceIntegrationsRequestBuilder(PathParameters, RequestAdapter);
        ...
        /// <param name="options">Request options</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(ApiSdk.Models.Microsoft.Graph.Teamwork body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
