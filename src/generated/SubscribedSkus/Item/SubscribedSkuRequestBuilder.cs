...
namespace ApiSdk.SubscribedSkus.Item {
    ...
    public class SubscribedSkuRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string subscribedSkuId, IConsole console) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string subscribedSkuId, string[] select, FormatterType output, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string subscribedSkuId, string body, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
