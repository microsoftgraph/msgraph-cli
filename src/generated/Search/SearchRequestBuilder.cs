...
using ApiSdk.Models;
using ApiSdk.Search.Acronyms;
using ApiSdk.Search.Bookmarks;
using ApiSdk.Search.Qnas;
...
namespace ApiSdk.Search
{
    ...
    public partial class SearchRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildAcronymsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Search.Acronyms.AcronymsRequestBuilder(PathParameters);
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildBookmarksNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Search.Bookmarks.BookmarksRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<global::ApiSdk.Models.SearchEntity>(global::ApiSdk.Models.SearchEntity.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        /// </summary>
        /// <returns>A <see cref="Command"/></returns>
        public Command BuildQnasNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Search.Qnas.QnasRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildQueryNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Search.Query.QueryRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.SearchEntity body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.SearchEntity body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
