...
namespace ApiSdk.Search.Query {
    ...
    public class QueryRequestBuilder {
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(QueryRequestBody body, Action<QueryRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
