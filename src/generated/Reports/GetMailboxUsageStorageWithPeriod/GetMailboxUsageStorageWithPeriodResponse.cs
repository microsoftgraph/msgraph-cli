...
namespace ApiSdk.Reports.GetMailboxUsageStorageWithPeriod {
    ...
    public class GetMailboxUsageStorageWithPeriodResponse : IAdditionalDataHolder, IParsable {
        ...
        /// </summary>
        public static ApiSdk.Reports.GetMailboxUsageStorageWithPeriod.GetMailboxUsageStorageWithPeriodResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
