...
namespace ApiSdk.Reports.GetYammerActivityUserDetailWithDate {
    ...
    public class GetYammerActivityUserDetailWithDateRequestBuilder : BaseCliRequestBuilder {
        ...
        public GetYammerActivityUserDetailWithDateRequestBuilder(Dictionary<string, object> pathParameters, Date? date = default) : base("{+baseurl}/reports/getYammerActivityUserDetail(date={date})", pathParameters) {
