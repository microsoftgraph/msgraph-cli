...
namespace ApiSdk.Reports.GetTeamsUserActivityUserDetailWithDate {
    ...
    public class GetTeamsUserActivityUserDetailWithDateRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string date, FileInfo file, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
            ...
            }, dateOption, fileOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
