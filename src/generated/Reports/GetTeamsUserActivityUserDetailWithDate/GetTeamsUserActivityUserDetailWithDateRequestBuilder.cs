...
namespace ApiSdk.Reports.GetTeamsUserActivityUserDetailWithDate {
    ...
    public class GetTeamsUserActivityUserDetailWithDateRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string date, FileInfo file, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, dateOption, fileOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
