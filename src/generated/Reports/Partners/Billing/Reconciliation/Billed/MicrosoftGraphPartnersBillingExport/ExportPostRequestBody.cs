...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Reports.Partners.Billing.Reconciliation.Billed.MicrosoftGraphPartnersBillingExport.ExportPostRequestBody"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Reports.Partners.Billing.Reconciliation.Billed.MicrosoftGraphPartnersBillingExport.ExportPostRequestBody"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static ApiSdk.Reports.Partners.Billing.Reconciliation.Billed.MicrosoftGraphPartnersBillingExport.ExportPostRequestBody CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Reports.Partners.Billing.Reconciliation.Billed.MicrosoftGraphPartnersBillingExport.ExportPostRequestBody();
        }
        /// <summary>
