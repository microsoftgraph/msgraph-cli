...
namespace ApiSdk.Reports.Partners.Billing.Usage.Billed
{
    ...
    public class BilledRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildMicrosoftGraphPartnersBillingExportNavCommand()
        {
            ...
            var builder = new ApiSdk.Reports.Partners.Billing.Usage.Billed.MicrosoftGraphPartnersBillingExport.MicrosoftGraphPartnersBillingExportRequestBuilder(PathParameters);
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Models.Partners.Billing.BilledUsage>(ApiSdk.Models.Partners.Billing.BilledUsage.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Reports.Partners.Billing.Usage.Billed.BilledRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Reports.Partners.Billing.Usage.Billed.BilledRequestBuilder.BilledRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Reports.Partners.Billing.Usage.Billed.BilledRequestBuilder.BilledRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.Partners.Billing.BilledUsage body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.Partners.Billing.BilledUsage body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
