...
using ApiSdk.Reports.Partners.Billing.Usage.Billed;
using ApiSdk.Reports.Partners.Billing.Usage.Unbilled;
...
namespace ApiSdk.Reports.Partners.Billing.Usage
{
    ...
    public partial class UsageRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildBilledNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Reports.Partners.Billing.Usage.Billed.BilledRequestBuilder(PathParameters);
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<global::ApiSdk.Models.Partners.Billing.AzureUsage>(global::ApiSdk.Models.Partners.Billing.AzureUsage.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        public Command BuildUnbilledNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Reports.Partners.Billing.Usage.Unbilled.UnbilledRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            execCommands.Add(builder.BuildDeleteCommand());
            execCommands.Add(builder.BuildGetCommand());
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Reports.Partners.Billing.Usage.UsageRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Reports.Partners.Billing.Usage.UsageRequestBuilder.UsageRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Reports.Partners.Billing.Usage.UsageRequestBuilder.UsageRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.Partners.Billing.AzureUsage body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.Partners.Billing.AzureUsage body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
