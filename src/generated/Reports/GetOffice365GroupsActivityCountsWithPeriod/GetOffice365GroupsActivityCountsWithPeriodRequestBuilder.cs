...
namespace ApiSdk.Reports.GetOffice365GroupsActivityCountsWithPeriod {
    ...
    public class GetOffice365GroupsActivityCountsWithPeriodRequestBuilder {
        ...
        public GetOffice365GroupsActivityCountsWithPeriodRequestBuilder(Dictionary<string, object> pathParameters, string period = "") {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            UrlTemplate = "{+baseurl}/reports/getOffice365GroupsActivityCounts(period='{period}')";
