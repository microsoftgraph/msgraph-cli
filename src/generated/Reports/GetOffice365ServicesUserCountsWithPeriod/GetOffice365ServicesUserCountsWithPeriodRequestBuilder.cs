...
namespace ApiSdk.Reports.GetOffice365ServicesUserCountsWithPeriod {
    ...
    public class GetOffice365ServicesUserCountsWithPeriodRequestBuilder {
        ...
        public GetOffice365ServicesUserCountsWithPeriodRequestBuilder(Dictionary<string, object> pathParameters, string period = "") {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            UrlTemplate = "{+baseurl}/reports/getOffice365ServicesUserCounts(period='{period}')";
