...
namespace ApiSdk.Reports.GetSkypeForBusinessOrganizerActivityUserCountsWithPeriod {
    ...
    public class GetSkypeForBusinessOrganizerActivityUserCountsWithPeriodRequestBuilder : BaseCliRequestBuilder {
        ...
        public GetSkypeForBusinessOrganizerActivityUserCountsWithPeriodRequestBuilder(Dictionary<string, object> pathParameters, string period = "") : base("{+baseurl}/reports/getSkypeForBusinessOrganizerActivityUserCounts(period='{period}')", pathParameters) {
