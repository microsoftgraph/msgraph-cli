...
namespace ApiSdk.Reports.GetOffice365GroupsActivityStorageWithPeriod {
    ...
    public class GetOffice365GroupsActivityStorageWithPeriodRequestBuilder {
        ...
        public GetOffice365GroupsActivityStorageWithPeriodRequestBuilder(Dictionary<string, object> pathParameters, string period = "") {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            UrlTemplate = "{+baseurl}/reports/getOffice365GroupsActivityStorage(period='{period}')";
