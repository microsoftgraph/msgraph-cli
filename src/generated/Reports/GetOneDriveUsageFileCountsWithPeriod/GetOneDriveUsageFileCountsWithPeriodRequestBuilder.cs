...
namespace ApiSdk.Reports.GetOneDriveUsageFileCountsWithPeriod {
    ...
    public class GetOneDriveUsageFileCountsWithPeriodRequestBuilder : BaseCliRequestBuilder {
        ...
        public GetOneDriveUsageFileCountsWithPeriodRequestBuilder(Dictionary<string, object> pathParameters, string period = "") : base("{+baseurl}/reports/getOneDriveUsageFileCounts(period='{period}')", pathParameters) {
