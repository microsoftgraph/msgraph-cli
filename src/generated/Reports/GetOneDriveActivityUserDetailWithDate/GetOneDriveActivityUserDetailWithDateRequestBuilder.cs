...
namespace ApiSdk.Reports.GetOneDriveActivityUserDetailWithDate {
    ...
    public class GetOneDriveActivityUserDetailWithDateRequestBuilder {
        ...
        public GetOneDriveActivityUserDetailWithDateRequestBuilder(Dictionary<string, object> pathParameters, Date? date = default) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            UrlTemplate = "{+baseurl}/reports/getOneDriveActivityUserDetail(date={date})";
