...
namespace ApiSdk.Reports.GetOneDriveActivityUserDetailWithDate {
    ...
    public class GetOneDriveActivityUserDetailWithDateRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(dateOption, outputOption, queryOption, jsonNoIndentOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        ...
        /// </summary>
        public RequestInformation CreateGetRequestInformation(Action<GetOneDriveActivityUserDetailWithDateRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
