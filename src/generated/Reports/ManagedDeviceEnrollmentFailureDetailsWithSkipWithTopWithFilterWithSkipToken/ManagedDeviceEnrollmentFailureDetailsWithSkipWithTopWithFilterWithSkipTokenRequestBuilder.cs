...
namespace ApiSdk.Reports.ManagedDeviceEnrollmentFailureDetailsWithSkipWithTopWithFilterWithSkipToken {
    ...
    public class ManagedDeviceEnrollmentFailureDetailsWithSkipWithTopWithFilterWithSkipTokenRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (int? skip, int? top, string filter, string skipToken, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, skipOption, topOption, filterOption, skipTokenOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
