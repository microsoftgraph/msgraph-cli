...
namespace ApiSdk.Reports.ManagedDeviceEnrollmentFailureDetailsWithSkipWithTopWithFilterWithSkipToken {
    ...
    public class ManagedDeviceEnrollmentFailureDetailsWithSkipWithTopWithFilterWithSkipTokenRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (int? skip, int? top, string filter, string skipToken, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                var requestInfo = CreateGetRequestInformation(q => {
                });
                var response = await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                var formatter = outputFormatterFactory.GetFormatter(output);
                formatter.WriteOutput(response, console);
            }, skipOption, topOption, filterOption, skipTokenOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
