...
namespace ApiSdk.Reports.GetMailboxUsageDetailWithPeriod {
    ...
    public class GetMailboxUsageDetailWithPeriodRequestBuilder : BaseCliRequestBuilder {
        ...
        public GetMailboxUsageDetailWithPeriodRequestBuilder(Dictionary<string, object> pathParameters, string period = "") : base("{+baseurl}/reports/getMailboxUsageDetail(period='{period}')", pathParameters) {
