...
namespace ApiSdk.Reports.GetMailboxUsageDetailWithPeriod {
    ...
    public class GetMailboxUsageDetailWithPeriodResponse : IAdditionalDataHolder, IParsable {
        ...
        /// </summary>
        public static ApiSdk.Reports.GetMailboxUsageDetailWithPeriod.GetMailboxUsageDetailWithPeriodResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"value", (o,n) => { (o as GetMailboxUsageDetailWithPeriodResponse).Value = n.GetByteArrayValue(); } },
            };
        }
        /// <summary>
