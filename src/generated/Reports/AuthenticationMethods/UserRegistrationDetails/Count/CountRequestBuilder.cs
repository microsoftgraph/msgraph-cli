...
using System;
namespace ApiSdk.Reports.AuthenticationMethods.UserRegistrationDetails.Count {
    /// <summary>
    ...
    public class CountRequestBuilder : BaseCliRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/reports/authenticationMethods/userRegistrationDetails/$count{?%24search,%24filter}", pathParameters) {
        }
        /// <summary>
        /// Get the number of the resource
        /// </summary>
