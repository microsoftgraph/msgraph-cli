...
namespace ApiSdk.Reports.GetSkypeForBusinessParticipantActivityCountsWithPeriod {
    ...
    public class GetSkypeForBusinessParticipantActivityCountsWithPeriodRequestBuilder : BaseCliRequestBuilder {
        ...
        public GetSkypeForBusinessParticipantActivityCountsWithPeriodRequestBuilder(Dictionary<string, object> pathParameters, string period = "") : base("{+baseurl}/reports/getSkypeForBusinessParticipantActivityCounts(period='{period}')", pathParameters) {
