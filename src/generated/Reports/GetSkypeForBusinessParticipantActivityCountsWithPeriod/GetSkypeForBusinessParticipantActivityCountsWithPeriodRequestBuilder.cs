...
namespace ApiSdk.Reports.GetSkypeForBusinessParticipantActivityCountsWithPeriod {
    ...
    public class GetSkypeForBusinessParticipantActivityCountsWithPeriodRequestBuilder {
        ...
        public GetSkypeForBusinessParticipantActivityCountsWithPeriodRequestBuilder(Dictionary<string, object> pathParameters, string period = "") {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            UrlTemplate = "{+baseurl}/reports/getSkypeForBusinessParticipantActivityCounts(period='{period}')";
