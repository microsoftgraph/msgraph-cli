...
namespace ApiSdk.Reports.GetEmailAppUsageUserCountsWithPeriod {
    ...
    public class GetEmailAppUsageUserCountsWithPeriodRequestBuilder {
        ...
        public GetEmailAppUsageUserCountsWithPeriodRequestBuilder(Dictionary<string, object> pathParameters, string period = "") {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            UrlTemplate = "{+baseurl}/reports/getEmailAppUsageUserCounts(period='{period}')";
