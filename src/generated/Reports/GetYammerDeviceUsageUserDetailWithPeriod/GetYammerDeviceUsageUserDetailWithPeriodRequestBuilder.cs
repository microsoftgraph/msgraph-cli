...
namespace ApiSdk.Reports.GetYammerDeviceUsageUserDetailWithPeriod {
    ...
    public class GetYammerDeviceUsageUserDetailWithPeriodRequestBuilder {
        ...
        public GetYammerDeviceUsageUserDetailWithPeriodRequestBuilder(Dictionary<string, object> pathParameters, string period = "") {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            UrlTemplate = "{+baseurl}/reports/getYammerDeviceUsageUserDetail(period='{period}')";
