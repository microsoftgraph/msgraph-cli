...
namespace ApiSdk.Reports.GetMailboxUsageMailboxCountsWithPeriod {
    ...
    public class GetMailboxUsageMailboxCountsWithPeriodResponse : IAdditionalDataHolder, IParsable {
        ...
        /// </summary>
        public static ApiSdk.Reports.GetMailboxUsageMailboxCountsWithPeriod.GetMailboxUsageMailboxCountsWithPeriodResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
