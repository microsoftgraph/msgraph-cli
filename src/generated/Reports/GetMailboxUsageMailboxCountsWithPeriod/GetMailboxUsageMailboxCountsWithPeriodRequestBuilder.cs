...
namespace ApiSdk.Reports.GetMailboxUsageMailboxCountsWithPeriod {
    ...
    public class GetMailboxUsageMailboxCountsWithPeriodRequestBuilder : BaseCliRequestBuilder {
        ...
        public GetMailboxUsageMailboxCountsWithPeriodRequestBuilder(Dictionary<string, object> pathParameters, string period = "") : base("{+baseurl}/reports/getMailboxUsageMailboxCounts(period='{period}')", pathParameters) {
