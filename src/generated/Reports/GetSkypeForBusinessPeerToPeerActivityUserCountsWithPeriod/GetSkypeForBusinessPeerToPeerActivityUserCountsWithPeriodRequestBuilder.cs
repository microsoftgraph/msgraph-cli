...
namespace ApiSdk.Reports.GetSkypeForBusinessPeerToPeerActivityUserCountsWithPeriod {
    ...
    public class GetSkypeForBusinessPeerToPeerActivityUserCountsWithPeriodRequestBuilder {
        ...
        public GetSkypeForBusinessPeerToPeerActivityUserCountsWithPeriodRequestBuilder(Dictionary<string, object> pathParameters, string period = "") {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            UrlTemplate = "{+baseurl}/reports/getSkypeForBusinessPeerToPeerActivityUserCounts(period='{period}')";
