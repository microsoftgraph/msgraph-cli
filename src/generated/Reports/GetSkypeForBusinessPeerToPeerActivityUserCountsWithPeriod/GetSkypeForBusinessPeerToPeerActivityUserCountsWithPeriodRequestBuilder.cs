...
namespace ApiSdk.Reports.GetSkypeForBusinessPeerToPeerActivityUserCountsWithPeriod {
    ...
    public class GetSkypeForBusinessPeerToPeerActivityUserCountsWithPeriodRequestBuilder : BaseCliRequestBuilder {
        ...
        public GetSkypeForBusinessPeerToPeerActivityUserCountsWithPeriodRequestBuilder(Dictionary<string, object> pathParameters, string period = "") : base("{+baseurl}/reports/getSkypeForBusinessPeerToPeerActivityUserCounts(period='{period}')", pathParameters) {
