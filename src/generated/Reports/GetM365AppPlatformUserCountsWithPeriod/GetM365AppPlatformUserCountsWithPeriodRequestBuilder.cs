...
namespace ApiSdk.Reports.GetM365AppPlatformUserCountsWithPeriod {
    ...
    public class GetM365AppPlatformUserCountsWithPeriodRequestBuilder : BaseCliRequestBuilder {
        ...
        public GetM365AppPlatformUserCountsWithPeriodRequestBuilder(Dictionary<string, object> pathParameters, string period = "") : base("{+baseurl}/reports/getM365AppPlatformUserCounts(period='{period}')", pathParameters) {
