...
namespace ApiSdk.Reports.GetYammerDeviceUsageDistributionUserCountsWithPeriod {
    ...
    public class GetYammerDeviceUsageDistributionUserCountsWithPeriodRequestBuilder {
        ...
        public GetYammerDeviceUsageDistributionUserCountsWithPeriodRequestBuilder(Dictionary<string, object> pathParameters, string period = "") {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            UrlTemplate = "{+baseurl}/reports/getYammerDeviceUsageDistributionUserCounts(period='{period}')";
