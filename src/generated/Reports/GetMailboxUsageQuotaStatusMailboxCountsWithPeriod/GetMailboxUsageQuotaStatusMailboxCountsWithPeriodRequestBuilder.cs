...
namespace ApiSdk.Reports.GetMailboxUsageQuotaStatusMailboxCountsWithPeriod {
    ...
    public class GetMailboxUsageQuotaStatusMailboxCountsWithPeriodRequestBuilder : BaseCliRequestBuilder {
        ...
        public GetMailboxUsageQuotaStatusMailboxCountsWithPeriodRequestBuilder(Dictionary<string, object> pathParameters, string period = "") : base("{+baseurl}/reports/getMailboxUsageQuotaStatusMailboxCounts(period='{period}')", pathParameters) {
