...
namespace ApiSdk.Reports.MicrosoftGraphGetYammerDeviceUsageDistributionUserCountsWithPeriod {
    /// <summary>
    ...
    public class GetYammerDeviceUsageDistributionUserCountsWithPeriodRequestBuilder {
        ...
        public GetYammerDeviceUsageDistributionUserCountsWithPeriodRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string period = "") {
