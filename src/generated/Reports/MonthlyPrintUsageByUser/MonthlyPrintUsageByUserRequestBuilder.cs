...
namespace ApiSdk.Reports.MonthlyPrintUsageByUser {
    ...
    public class MonthlyPrintUsageByUserRequestBuilder : BaseCliRequestBuilder {
        ...
        public Command BuildListCommand() {
            ...
            command.Description = "Retrieve a list of monthly print usage summaries, grouped by user. This API is available in the following national cloud deployments.\n\nFind more info here:\n  https://learn.microsoft.com/graph/api/reportroot-list-monthlyprintusagebyuser?view=graph-rest-1.0";
