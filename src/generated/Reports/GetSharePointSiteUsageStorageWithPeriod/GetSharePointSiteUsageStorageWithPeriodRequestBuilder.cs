...
namespace ApiSdk.Reports.GetSharePointSiteUsageStorageWithPeriod {
    ...
    public class GetSharePointSiteUsageStorageWithPeriodRequestBuilder : BaseCliRequestBuilder {
        ...
        public GetSharePointSiteUsageStorageWithPeriodRequestBuilder(Dictionary<string, object> pathParameters, string period = "") : base("{+baseurl}/reports/getSharePointSiteUsageStorage(period='{period}')", pathParameters) {
