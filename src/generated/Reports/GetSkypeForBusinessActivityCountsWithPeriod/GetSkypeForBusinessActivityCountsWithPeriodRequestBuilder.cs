...
namespace ApiSdk.Reports.GetSkypeForBusinessActivityCountsWithPeriod {
    ...
    public class GetSkypeForBusinessActivityCountsWithPeriodRequestBuilder : BaseCliRequestBuilder {
        ...
        public GetSkypeForBusinessActivityCountsWithPeriodRequestBuilder(Dictionary<string, object> pathParameters, string period = "") : base("{+baseurl}/reports/getSkypeForBusinessActivityCounts(period='{period}')", pathParameters) {
