...
namespace ApiSdk.Reports.GetOneDriveUsageAccountCountsWithPeriod {
    ...
    public class GetOneDriveUsageAccountCountsWithPeriodRequestBuilder {
        ...
        public GetOneDriveUsageAccountCountsWithPeriodRequestBuilder(Dictionary<string, object> pathParameters, string period = "") {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            UrlTemplate = "{+baseurl}/reports/getOneDriveUsageAccountCounts(period='{period}')";
