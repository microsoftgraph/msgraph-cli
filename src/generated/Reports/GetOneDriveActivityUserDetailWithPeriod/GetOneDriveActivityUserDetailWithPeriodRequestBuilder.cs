...
namespace ApiSdk.Reports.GetOneDriveActivityUserDetailWithPeriod {
    ...
    public class GetOneDriveActivityUserDetailWithPeriodRequestBuilder : BaseCliRequestBuilder {
        ...
        public GetOneDriveActivityUserDetailWithPeriodRequestBuilder(Dictionary<string, object> pathParameters, string period = "") : base("{+baseurl}/reports/getOneDriveActivityUserDetail(period='{period}')", pathParameters) {
