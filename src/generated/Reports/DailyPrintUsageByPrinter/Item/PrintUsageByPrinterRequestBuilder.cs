...
namespace ApiSdk.Reports.DailyPrintUsageByPrinter.Item {
    ...
    public class PrintUsageByPrinterRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string printUsageByPrinterId, IConsole console) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string printUsageByPrinterId, string[] select, string[] expand, FormatterType output, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string printUsageByPrinterId, string body, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
