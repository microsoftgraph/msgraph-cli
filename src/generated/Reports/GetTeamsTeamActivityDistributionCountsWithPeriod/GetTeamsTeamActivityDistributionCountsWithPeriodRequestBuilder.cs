...
namespace ApiSdk.Reports.GetTeamsTeamActivityDistributionCountsWithPeriod {
    ...
    public class GetTeamsTeamActivityDistributionCountsWithPeriodRequestBuilder : BaseCliRequestBuilder {
        ...
        public GetTeamsTeamActivityDistributionCountsWithPeriodRequestBuilder(Dictionary<string, object> pathParameters, string period = "") : base("{+baseurl}/reports/getTeamsTeamActivityDistributionCounts(period='{period}')", pathParameters) {
