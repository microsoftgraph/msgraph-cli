...
namespace ApiSdk.Reports.GetEmailAppUsageVersionsUserCountsWithPeriod {
    ...
    public class GetEmailAppUsageVersionsUserCountsWithPeriodRequestBuilder {
        ...
        public GetEmailAppUsageVersionsUserCountsWithPeriodRequestBuilder(Dictionary<string, object> pathParameters, string period = "") {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            UrlTemplate = "{+baseurl}/reports/getEmailAppUsageVersionsUserCounts(period='{period}')";
