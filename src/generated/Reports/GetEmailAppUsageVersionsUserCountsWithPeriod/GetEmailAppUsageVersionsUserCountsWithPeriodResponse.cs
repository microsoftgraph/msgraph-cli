...
namespace ApiSdk.Reports.GetEmailAppUsageVersionsUserCountsWithPeriod {
    ...
    public class GetEmailAppUsageVersionsUserCountsWithPeriodResponse : IAdditionalDataHolder, IParsable {
        ...
        /// </summary>
        public static ApiSdk.Reports.GetEmailAppUsageVersionsUserCountsWithPeriod.GetEmailAppUsageVersionsUserCountsWithPeriodResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
