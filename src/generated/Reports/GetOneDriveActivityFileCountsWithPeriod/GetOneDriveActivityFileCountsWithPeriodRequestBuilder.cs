...
namespace ApiSdk.Reports.GetOneDriveActivityFileCountsWithPeriod {
    ...
    public class GetOneDriveActivityFileCountsWithPeriodRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(periodOption, outputOption, outputFilterOption, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
