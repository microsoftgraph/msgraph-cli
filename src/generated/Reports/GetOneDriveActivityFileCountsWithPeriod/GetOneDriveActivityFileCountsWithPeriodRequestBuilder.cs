...
namespace ApiSdk.Reports.GetOneDriveActivityFileCountsWithPeriod {
    ...
    public class GetOneDriveActivityFileCountsWithPeriodRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string period, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                var requestInfo = CreateGetRequestInformation(q => {
                });
                var response = await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                var formatter = outputFormatterFactory.GetFormatter(output);
                formatter.WriteOutput(response, console);
            }, periodOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
