...
namespace ApiSdk.Reports.GetSkypeForBusinessActivityUserDetailWithDate {
    ...
    public class GetSkypeForBusinessActivityUserDetailWithDateRequestBuilder : BaseCliRequestBuilder {
        ...
        public GetSkypeForBusinessActivityUserDetailWithDateRequestBuilder(Dictionary<string, object> pathParameters, Date? date = default) : base("{+baseurl}/reports/getSkypeForBusinessActivityUserDetail(date={date})", pathParameters) {
