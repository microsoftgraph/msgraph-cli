...
namespace ApiSdk.Reports.GetSkypeForBusinessPeerToPeerActivityCountsWithPeriod {
    ...
    public class GetSkypeForBusinessPeerToPeerActivityCountsWithPeriodRequestBuilder : BaseCliRequestBuilder {
        ...
        public GetSkypeForBusinessPeerToPeerActivityCountsWithPeriodRequestBuilder(Dictionary<string, object> pathParameters, string period = "") : base("{+baseurl}/reports/getSkypeForBusinessPeerToPeerActivityCounts(period='{period}')", pathParameters) {
