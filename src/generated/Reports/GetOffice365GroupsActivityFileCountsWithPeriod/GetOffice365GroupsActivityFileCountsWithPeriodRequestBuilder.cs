...
namespace ApiSdk.Reports.GetOffice365GroupsActivityFileCountsWithPeriod {
    ...
    public class GetOffice365GroupsActivityFileCountsWithPeriodRequestBuilder {
        ...
        public GetOffice365GroupsActivityFileCountsWithPeriodRequestBuilder(Dictionary<string, object> pathParameters, string period = "") {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            UrlTemplate = "{+baseurl}/reports/getOffice365GroupsActivityFileCounts(period='{period}')";
