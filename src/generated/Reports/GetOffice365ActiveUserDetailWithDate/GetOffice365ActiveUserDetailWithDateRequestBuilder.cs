...
namespace ApiSdk.Reports.GetOffice365ActiveUserDetailWithDate {
    ...
    public class GetOffice365ActiveUserDetailWithDateRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string date, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, dateOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
