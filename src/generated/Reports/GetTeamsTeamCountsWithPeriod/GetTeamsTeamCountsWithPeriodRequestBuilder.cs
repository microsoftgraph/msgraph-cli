...
namespace ApiSdk.Reports.GetTeamsTeamCountsWithPeriod {
    ...
    public class GetTeamsTeamCountsWithPeriodRequestBuilder : BaseCliRequestBuilder {
        ...
        public GetTeamsTeamCountsWithPeriodRequestBuilder(Dictionary<string, object> pathParameters, string period = "") : base("{+baseurl}/reports/getTeamsTeamCounts(period='{period}')", pathParameters) {
