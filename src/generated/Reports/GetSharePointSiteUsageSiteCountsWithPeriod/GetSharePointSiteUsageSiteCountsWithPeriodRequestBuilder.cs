...
namespace ApiSdk.Reports.GetSharePointSiteUsageSiteCountsWithPeriod {
    ...
    public class GetSharePointSiteUsageSiteCountsWithPeriodRequestBuilder : BaseCliRequestBuilder {
        ...
        public GetSharePointSiteUsageSiteCountsWithPeriodRequestBuilder(Dictionary<string, object> pathParameters, string period = "") : base("{+baseurl}/reports/getSharePointSiteUsageSiteCounts(period='{period}')", pathParameters) {
