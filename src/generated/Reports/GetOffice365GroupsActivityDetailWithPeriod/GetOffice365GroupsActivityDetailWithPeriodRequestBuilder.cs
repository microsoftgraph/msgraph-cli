...
namespace ApiSdk.Reports.GetOffice365GroupsActivityDetailWithPeriod {
    ...
    public class GetOffice365GroupsActivityDetailWithPeriodRequestBuilder {
        ...
        public GetOffice365GroupsActivityDetailWithPeriodRequestBuilder(Dictionary<string, object> pathParameters, string period = "") {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            UrlTemplate = "{+baseurl}/reports/getOffice365GroupsActivityDetail(period='{period}')";
