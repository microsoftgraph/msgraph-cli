...
namespace ApiSdk.Reports.Security.GetAttackSimulationTrainingUserCoverage {
    ...
    public class GetAttackSimulationTrainingUserCoverageRequestBuilder : BaseCliRequestBuilder {
        ...
        public GetAttackSimulationTrainingUserCoverageRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/reports/security/getAttackSimulationTrainingUserCoverage(){?%24top,%24skip,%24search,%24filter,%24count}", pathParameters) {
        }
        /// <summary>
        /// Invoke function getAttackSimulationTrainingUserCoverage
        /// </summary>
...
#nullable restore
        ...
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<GetAttackSimulationTrainingUserCoverageRequestBuilderGetQueryParameters>> requestConfiguration = default) {
            ...
            if (requestConfiguration != null) {
                var requestConfig = new RequestConfiguration<GetAttackSimulationTrainingUserCoverageRequestBuilderGetQueryParameters>();
