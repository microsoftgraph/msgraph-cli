...
namespace ApiSdk.Reports.ManagedDeviceEnrollmentTopFailuresWithPeriod {
    ...
    public class ManagedDeviceEnrollmentTopFailuresWithPeriodRequestBuilder {
        ...
        public ManagedDeviceEnrollmentTopFailuresWithPeriodRequestBuilder(Dictionary<string, object> pathParameters, string period = "") {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            UrlTemplate = "{+baseurl}/reports/managedDeviceEnrollmentTopFailures(period='{period}')";
