...
namespace ApiSdk.Reports.ManagedDeviceEnrollmentTopFailuresWithPeriod {
    ...
    public class ManagedDeviceEnrollmentTopFailuresWithPeriodRequestBuilder : BaseCliRequestBuilder {
        ...
        public ManagedDeviceEnrollmentTopFailuresWithPeriodRequestBuilder(Dictionary<string, object> pathParameters, string period = "") : base("{+baseurl}/reports/managedDeviceEnrollmentTopFailures(period='{period}')", pathParameters) {
