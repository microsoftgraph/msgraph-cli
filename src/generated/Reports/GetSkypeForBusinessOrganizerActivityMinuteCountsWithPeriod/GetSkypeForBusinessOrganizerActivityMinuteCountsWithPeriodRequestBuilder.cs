...
namespace ApiSdk.Reports.GetSkypeForBusinessOrganizerActivityMinuteCountsWithPeriod {
    ...
    public class GetSkypeForBusinessOrganizerActivityMinuteCountsWithPeriodRequestBuilder : BaseCliRequestBuilder {
        ...
        public GetSkypeForBusinessOrganizerActivityMinuteCountsWithPeriodRequestBuilder(Dictionary<string, object> pathParameters, string period = "") : base("{+baseurl}/reports/getSkypeForBusinessOrganizerActivityMinuteCounts(period='{period}')", pathParameters) {
