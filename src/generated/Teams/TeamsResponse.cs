...
namespace ApiSdk.Teams {
    public class TeamsResponse : IAdditionalDataHolder, IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as TeamsResponse).Value = n.GetCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.Team>(ApiSdk.Models.Microsoft.Graph.Team.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
