...
namespace ApiSdk.Teams.Item.Channels.Item {
    ...
    public class ChannelRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string teamId, string channelId, string[] select, string[] expand, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string teamId, string channelId, string body, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
