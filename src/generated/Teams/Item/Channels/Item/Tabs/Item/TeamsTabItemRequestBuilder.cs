...
namespace ApiSdk.Teams.Item.Channels.Item.Tabs.Item {
    ...
    public class TeamsTabItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public TeamsTabItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/teams/{team%2Did}/channels/{channel%2Did}/tabs/{teamsTab%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Removes (unpins) a tab from the specified channel within a team. 
        /// </summary>
