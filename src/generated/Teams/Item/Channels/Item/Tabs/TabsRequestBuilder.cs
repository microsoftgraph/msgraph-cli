...
namespace ApiSdk.Teams.Item.Channels.Item.Tabs {
    ...
    public class TabsRequestBuilder : BaseCliRequestBuilder {
        ...
        public TabsRequestBuilder(string rawUrl) : base("{+baseurl}/teams/{team%2Did}/channels/{channel%2Did}/tabs{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Retrieve the list of tabs in the specified channel within a team.  This API is available in the following national cloud deployments.
        /// </summary>
