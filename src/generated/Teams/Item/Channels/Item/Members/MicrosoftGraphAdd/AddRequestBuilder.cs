...
namespace ApiSdk.Teams.Item.Channels.Item.Members.MicrosoftGraphAdd {
    /// <summary>
    ...
    public class AddRequestBuilder {
        ...
        public AddRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/teams/{team%2Did}/channels/{channel%2Did}/members/microsoft.graph.add";
