...
namespace ApiSdk.Teams.Item.Channels.Item.Members.Item {
    ...
    public class ConversationMemberRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string teamId, string channelId, string conversationMemberId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, teamIdOption, channelIdOption, conversationMemberIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// A collection of membership records associated with the channel.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string teamId, string channelId, string conversationMemberId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, teamIdOption, channelIdOption, conversationMemberIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// A collection of membership records associated with the channel.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string teamId, string channelId, string conversationMemberId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, teamIdOption, channelIdOption, conversationMemberIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
