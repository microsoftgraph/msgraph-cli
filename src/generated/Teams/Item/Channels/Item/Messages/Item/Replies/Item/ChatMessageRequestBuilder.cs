...
namespace ApiSdk.Teams.Item.Channels.Item.Messages.Item.Replies.Item {
    ...
    public class ChatMessageRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string teamId, string channelId, string chatMessageId, string chatMessageId1, IConsole console) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string teamId, string channelId, string chatMessageId, string chatMessageId1, string[] select, string[] expand, FormatterType output, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string teamId, string channelId, string chatMessageId, string chatMessageId1, string body, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
