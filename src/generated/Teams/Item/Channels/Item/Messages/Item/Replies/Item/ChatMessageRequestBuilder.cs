...
namespace ApiSdk.Teams.Item.Channels.Item.Messages.Item.Replies.Item {
    ...
    public class ChatMessageRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string teamId, string channelId, string chatMessageId, string chatMessageId1) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string teamId, string channelId, string chatMessageId, string chatMessageId1, string[] select, string[] expand) => {
            ...
            }, teamIdOption, channelIdOption, chatMessageIdOption, chatMessageId1Option, selectOption, expandOption);
            return command;
        }
        /// <summary>
        /// Replies for a specified message.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string teamId, string channelId, string chatMessageId, string chatMessageId1, string body) => {
