...
namespace ApiSdk.Teams.Item.Channels.Item.Messages.Item.Replies.Delta {
    ...
    public class DeltaRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string teamId, string channelId, string chatMessageId, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, teamIdOption, channelIdOption, chatMessageIdOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
