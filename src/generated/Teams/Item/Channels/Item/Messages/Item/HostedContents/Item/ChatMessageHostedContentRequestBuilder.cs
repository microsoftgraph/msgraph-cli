...
namespace ApiSdk.Teams.Item.Channels.Item.Messages.Item.HostedContents.Item {
    ...
    public class ChatMessageHostedContentRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string teamId, string channelId, string chatMessageId, string chatMessageHostedContentId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, teamIdOption, channelIdOption, chatMessageIdOption, chatMessageHostedContentIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// Content in a message hosted by Microsoft Teams - for example, images or code snippets.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string teamId, string channelId, string chatMessageId, string chatMessageHostedContentId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, teamIdOption, channelIdOption, chatMessageIdOption, chatMessageHostedContentIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// Content in a message hosted by Microsoft Teams - for example, images or code snippets.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string teamId, string channelId, string chatMessageId, string chatMessageHostedContentId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, teamIdOption, channelIdOption, chatMessageIdOption, chatMessageHostedContentIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
