...
namespace ApiSdk.Teams.Item.Channels.Item.FilesFolder.Content {
    ...
    public class ContentRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string teamId, string channelId, FileInfo file, FormatterType output, IConsole console) => {
        ...
        public Command BuildPutCommand() {
            ...
            command.SetHandler(async (string teamId, string channelId, FileInfo file, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
