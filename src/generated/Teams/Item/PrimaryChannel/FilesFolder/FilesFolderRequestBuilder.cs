...
namespace ApiSdk.Teams.Item.PrimaryChannel.FilesFolder {
    ...
    public class FilesFolderRequestBuilder : BaseCliRequestBuilder {
        ...
        public FilesFolderRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/teams/{team%2Did}/primaryChannel/filesFolder{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Metadata for the location where the channel&apos;s files are stored.
        /// </summary>
