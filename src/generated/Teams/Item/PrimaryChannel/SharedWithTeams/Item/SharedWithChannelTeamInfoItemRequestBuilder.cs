...
namespace ApiSdk.Teams.Item.PrimaryChannel.SharedWithTeams.Item
{
    ...
    public class SharedWithChannelTeamInfoItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildAllowedMembersNavCommand()
        {
            ...
            var builder = new ApiSdk.Teams.Item.PrimaryChannel.SharedWithTeams.Item.AllowedMembers.AllowedMembersRequestBuilder(PathParameters);
        ...
        public Command BuildTeamNavCommand()
        {
            ...
            var builder = new ApiSdk.Teams.Item.PrimaryChannel.SharedWithTeams.Item.Team.TeamRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Teams.Item.PrimaryChannel.SharedWithTeams.Item.SharedWithChannelTeamInfoItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Teams.Item.PrimaryChannel.SharedWithTeams.Item.SharedWithChannelTeamInfoItemRequestBuilder.SharedWithChannelTeamInfoItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Teams.Item.PrimaryChannel.SharedWithTeams.Item.SharedWithChannelTeamInfoItemRequestBuilder.SharedWithChannelTeamInfoItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
