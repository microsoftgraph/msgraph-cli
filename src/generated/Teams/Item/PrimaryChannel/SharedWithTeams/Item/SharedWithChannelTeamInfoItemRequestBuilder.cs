...
namespace ApiSdk.Teams.Item.PrimaryChannel.SharedWithTeams.Item {
    ...
    public class SharedWithChannelTeamInfoItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public SharedWithChannelTeamInfoItemRequestBuilder(string rawUrl) : base("{+baseurl}/teams/{team%2Did}/primaryChannel/sharedWithTeams/{sharedWithChannelTeamInfo%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Unshare a channel with a team by deleting the corresponding sharedWithChannelTeamInfo resource. This operation is allowed only for channels with a membershipType value of shared. This API is available in the following national cloud deployments.
        /// </summary>
