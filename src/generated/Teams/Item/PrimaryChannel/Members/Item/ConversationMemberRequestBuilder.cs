...
namespace ApiSdk.Teams.Item.PrimaryChannel.Members.Item {
    ...
    public class ConversationMemberRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string teamId, string conversationMemberId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, teamIdOption, conversationMemberIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// A collection of membership records associated with the channel.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string teamId, string conversationMemberId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, teamIdOption, conversationMemberIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// A collection of membership records associated with the channel.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string teamId, string conversationMemberId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, teamIdOption, conversationMemberIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
