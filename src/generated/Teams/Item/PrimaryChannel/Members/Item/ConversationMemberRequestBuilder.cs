...
namespace ApiSdk.Teams.Item.PrimaryChannel.Members.Item {
    ...
    public class ConversationMemberRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            }, teamIdOption, conversationMemberIdOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// A collection of membership records associated with the channel.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string teamId, string conversationMemberId, string[] select, string[] expand, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
            ...
            }, teamIdOption, conversationMemberIdOption, selectOption, expandOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// A collection of membership records associated with the channel.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string teamId, string conversationMemberId, string body, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                ...
                await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                console.WriteLine("Success");
            }, teamIdOption, conversationMemberIdOption, bodyOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
