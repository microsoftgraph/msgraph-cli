...
using ApiSdk.Teams.Item.PrimaryChannel.Messages.Item.Replies.Item.SoftDelete;
using ApiSdk.Teams.Item.PrimaryChannel.Messages.Item.Replies.Item.UndoSoftDelete;
...
namespace ApiSdk.Teams.Item.PrimaryChannel.Messages.Item.Replies.Item {
    ...
    public class ChatMessageItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public ChatMessageItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/teams/{team%2Did}/primaryChannel/messages/{chatMessage%2Did}/replies/{chatMessage%2Did1}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Delete navigation property replies for teams
        /// </summary>
