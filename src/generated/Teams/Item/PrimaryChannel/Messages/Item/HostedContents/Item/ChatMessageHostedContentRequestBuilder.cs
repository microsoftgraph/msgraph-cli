...
namespace ApiSdk.Teams.Item.PrimaryChannel.Messages.Item.HostedContents.Item {
    ...
    public class ChatMessageHostedContentRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            }, teamIdOption, chatMessageIdOption, chatMessageHostedContentIdOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// Content in a message hosted by Microsoft Teams - for example, images or code snippets.
        ...
        public Command BuildGetCommand() {
            ...
            }, teamIdOption, chatMessageIdOption, chatMessageHostedContentIdOption, selectOption, expandOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// Content in a message hosted by Microsoft Teams - for example, images or code snippets.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string teamId, string chatMessageId, string chatMessageHostedContentId, string body, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                ...
                await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                console.WriteLine("Success");
            }, teamIdOption, chatMessageIdOption, chatMessageHostedContentIdOption, bodyOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
