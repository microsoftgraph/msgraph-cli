...
namespace ApiSdk.Teams.Item.PrimaryChannel.Messages.Item {
    ...
    public class ChatMessageRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string teamId, string chatMessageId, IConsole console) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string teamId, string chatMessageId, string[] select, string[] expand, FormatterType output, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string teamId, string chatMessageId, string body, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
