...
namespace ApiSdk.Teams.Item.PrimaryChannel.Tabs.Item {
    ...
    public class TeamsTabRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string teamId, string teamsTabId) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string teamId, string teamsTabId, string[] select, string[] expand) => {
            ...
            }, teamIdOption, teamsTabIdOption, selectOption, expandOption);
            return command;
        }
        /// <summary>
        /// A collection of all the tabs in the channel. A navigation property.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string teamId, string teamsTabId, string body) => {
