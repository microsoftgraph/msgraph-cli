...
namespace ApiSdk.Teams.Item.PrimaryChannel.Tabs.Item {
    ...
    public class TeamsTabItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public TeamsTabItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/teams/{team%2Did}/primaryChannel/tabs/{teamsTab%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Removes (unpins) a tab from the specified channel within a team. 
        /// </summary>
