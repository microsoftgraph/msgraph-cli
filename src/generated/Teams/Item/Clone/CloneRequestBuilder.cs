    ...
    public class CloneRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                var model = parseNode.GetObjectValue<CloneRequestBody>(CloneRequestBody.CreateFromDiscriminatorValue);
        ...
        public CloneRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/teams/{team%2Did}/microsoft.graph.clone";
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(CloneRequestBody body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
