...
namespace ApiSdk.Teams.Item.Clone {
    ...
    public class CloneRequestBuilder {
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(CloneRequestBody body, Action<CloneRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
