...
namespace ApiSdk.Teams.Item.Archive {
    ...
    public class ArchiveRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(ArchiveRequestBody model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
