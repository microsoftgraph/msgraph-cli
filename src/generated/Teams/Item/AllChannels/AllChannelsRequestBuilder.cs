...
namespace ApiSdk.Teams.Item.AllChannels {
    ...
    public class AllChannelsRequestBuilder : BaseCliRequestBuilder {
        ...
        public AllChannelsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/teams/{team%2Did}/allChannels{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// List of channels either hosted in or shared with the team (incoming channels).
        /// </summary>
...
#nullable restore
        ...
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<AllChannelsRequestBuilderGetQueryParameters>> requestConfiguration = default) {
            ...
            if (requestConfiguration != null) {
                var requestConfig = new RequestConfiguration<AllChannelsRequestBuilderGetQueryParameters>();
