...
namespace ApiSdk.Teams.Item.Schedule.OpenShiftChangeRequests {
    ...
    public class OpenShiftChangeRequestsRequestBuilder {
        ...
        public Command BuildListCommand() {
            ...
            command.Handler = CommandHandler.Create<string, int?, int?, string, string, bool?, object, object, object>(async (teamId, top, skip, search, filter, count, orderby, select, expand) => {
