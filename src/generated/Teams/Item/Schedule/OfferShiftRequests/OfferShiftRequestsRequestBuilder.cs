...
namespace ApiSdk.Teams.Item.Schedule.OfferShiftRequests {
    ...
    public class OfferShiftRequestsRequestBuilder {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<OfferShiftRequest> PostAsync(OfferShiftRequest model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
