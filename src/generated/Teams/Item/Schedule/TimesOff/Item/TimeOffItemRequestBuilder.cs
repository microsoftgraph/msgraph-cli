...
namespace ApiSdk.Teams.Item.Schedule.TimesOff.Item {
    ...
    public class TimeOffItemRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(teamIdOption, timeOffIdOption, selectOption, outputOption, queryOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// The instances of times off in the schedule.
