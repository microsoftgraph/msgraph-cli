...
namespace ApiSdk.Teams.Item.Schedule.SchedulingGroups.Item {
    ...
    public class SchedulingGroupRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string teamId, string schedulingGroupId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, teamIdOption, schedulingGroupIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The logical grouping of users in the schedule (usually by role).
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string teamId, string schedulingGroupId, string[] select, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, teamIdOption, schedulingGroupIdOption, selectOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The logical grouping of users in the schedule (usually by role).
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string teamId, string schedulingGroupId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, teamIdOption, schedulingGroupIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
