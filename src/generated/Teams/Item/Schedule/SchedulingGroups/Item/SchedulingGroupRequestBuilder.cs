...
namespace ApiSdk.Teams.Item.Schedule.SchedulingGroups.Item {
    ...
    public class SchedulingGroupRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            var schedulingGroupIdOption = new Option<string>("--schedulinggroup-id", description: "key: id of schedulingGroup") {
            };
            schedulingGroupIdOption.IsRequired = true;
            command.AddOption(schedulingGroupIdOption);
            command.SetHandler(async (string teamId, string schedulingGroupId, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                var requestInfo = CreateDeleteRequestInformation(q => {
                });
                await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                console.WriteLine("Success");
            }, teamIdOption, schedulingGroupIdOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// The logical grouping of users in the schedule (usually by role).
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string teamId, string schedulingGroupId, string[] select, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
            ...
            }, teamIdOption, schedulingGroupIdOption, selectOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// The logical grouping of users in the schedule (usually by role).
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string teamId, string schedulingGroupId, string body, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                ...
                await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                console.WriteLine("Success");
            }, teamIdOption, schedulingGroupIdOption, bodyOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
