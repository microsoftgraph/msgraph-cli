...
namespace ApiSdk.Teams.Item.Schedule.SchedulingGroups.Item {
    ...
    public class SchedulingGroupItemRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(teamIdOption, schedulingGroupIdOption, selectOption, outputOption, queryOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// The logical grouping of users in the schedule (usually by role).
