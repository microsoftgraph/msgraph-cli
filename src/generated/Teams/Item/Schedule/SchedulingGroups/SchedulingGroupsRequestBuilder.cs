...
namespace ApiSdk.Teams.Item.Schedule.SchedulingGroups {
    ...
    public class SchedulingGroupsRequestBuilder : BaseCliRequestBuilder {
        ...
        public SchedulingGroupsRequestBuilder(string rawUrl) : base("{+baseurl}/teams/{team%2Did}/schedule/schedulingGroups{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select}", rawUrl) {
        }
        /// <summary>
        /// Get the list of schedulingGroups in this schedule. This API is available in the following national cloud deployments.
        /// </summary>
