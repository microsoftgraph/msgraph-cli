...
namespace ApiSdk.Teams.Item.Schedule.Share {
    ...
    public class ShareRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(ShareRequestBody model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
