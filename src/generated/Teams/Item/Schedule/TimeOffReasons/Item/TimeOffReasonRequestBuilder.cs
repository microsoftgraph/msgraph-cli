...
namespace ApiSdk.Teams.Item.Schedule.TimeOffReasons.Item {
    ...
    public class TimeOffReasonRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string teamId, string timeOffReasonId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, teamIdOption, timeOffReasonIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The set of reasons for a time off in the schedule.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string teamId, string timeOffReasonId, string[] select, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, teamIdOption, timeOffReasonIdOption, selectOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The set of reasons for a time off in the schedule.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string teamId, string timeOffReasonId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, teamIdOption, timeOffReasonIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
