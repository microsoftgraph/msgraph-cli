...
namespace ApiSdk.Teams.Item.Schedule.TimeOffReasons.Item {
    ...
    public class TimeOffReasonRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string teamId, string timeOffReasonId, IConsole console) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string teamId, string timeOffReasonId, string[] select, FormatterType output, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string teamId, string timeOffReasonId, string body, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
