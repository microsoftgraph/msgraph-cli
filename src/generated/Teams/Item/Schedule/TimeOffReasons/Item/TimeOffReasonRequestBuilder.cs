...
namespace ApiSdk.Teams.Item.Schedule.TimeOffReasons.Item {
    ...
    public class TimeOffReasonRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            }, teamIdOption, timeOffReasonIdOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// The set of reasons for a time off in the schedule.
        ...
        public Command BuildGetCommand() {
            ...
            }, teamIdOption, timeOffReasonIdOption, selectOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// The set of reasons for a time off in the schedule.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string teamId, string timeOffReasonId, string body, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                ...
                await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                console.WriteLine("Success");
            }, teamIdOption, timeOffReasonIdOption, bodyOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
