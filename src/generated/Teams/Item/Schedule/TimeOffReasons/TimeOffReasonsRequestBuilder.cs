...
namespace ApiSdk.Teams.Item.Schedule.TimeOffReasons {
    ...
    public class TimeOffReasonsRequestBuilder : BaseCliRequestBuilder {
        ...
        public TimeOffReasonsRequestBuilder(string rawUrl) : base("{+baseurl}/teams/{team%2Did}/schedule/timeOffReasons{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select}", rawUrl) {
        }
        /// <summary>
        /// Get the list of timeOffReasons in a schedule.
        /// </summary>
