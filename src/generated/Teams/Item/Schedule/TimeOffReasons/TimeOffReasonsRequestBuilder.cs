...
namespace ApiSdk.Teams.Item.Schedule.TimeOffReasons {
    ...
    public class TimeOffReasonsRequestBuilder : BaseCliRequestBuilder {
        ...
        public TimeOffReasonsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/teams/{team%2Did}/schedule/timeOffReasons{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select}", pathParameters) {
        }
        /// <summary>
        /// Get the list of timeOffReasons in a schedule.
        /// </summary>
...
#nullable restore
        ...
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<TimeOffReasonsRequestBuilderGetQueryParameters>> requestConfiguration = default) {
            ...
            if (requestConfiguration != null) {
                var requestConfig = new RequestConfiguration<TimeOffReasonsRequestBuilderGetQueryParameters>();
