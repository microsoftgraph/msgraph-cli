...
namespace ApiSdk.Teams.Item.Schedule.Shifts {
    ...
    public class ShiftsRequestBuilder {
        ...
        public List<Command> BuildCommand() {
            var builder = new ShiftItemRequestBuilder(PathParameters, RequestAdapter);
        ...
        public ShiftsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/teams/{team%2Did}/schedule/shifts{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select}";
