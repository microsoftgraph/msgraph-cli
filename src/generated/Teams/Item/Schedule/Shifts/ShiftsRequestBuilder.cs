...
namespace ApiSdk.Teams.Item.Schedule.Shifts {
    ...
    public class ShiftsRequestBuilder : BaseCliRequestBuilder {
        ...
        public ShiftsRequestBuilder(string rawUrl) : base("{+baseurl}/teams/{team%2Did}/schedule/shifts{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select}", rawUrl) {
        }
        /// <summary>
        /// Get the list of shift instances in a schedule.
        /// </summary>
