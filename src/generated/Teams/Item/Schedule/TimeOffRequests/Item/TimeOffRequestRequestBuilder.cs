...
namespace ApiSdk.Teams.Item.Schedule.TimeOffRequests.Item {
    ...
    public class TimeOffRequestRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string teamId, string timeOffRequestId, IConsole console) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string teamId, string timeOffRequestId, string[] select, FormatterType output, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string teamId, string timeOffRequestId, string body, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
