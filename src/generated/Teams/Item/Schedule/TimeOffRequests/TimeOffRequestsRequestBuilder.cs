...
namespace ApiSdk.Teams.Item.Schedule.TimeOffRequests {
    ...
    public class TimeOffRequestsRequestBuilder : BaseCliRequestBuilder {
        ...
        public TimeOffRequestsRequestBuilder(string rawUrl) : base("{+baseurl}/teams/{team%2Did}/schedule/timeOffRequests{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select}", rawUrl) {
        }
        /// <summary>
        /// Retrieve a list of timeOffRequest objects in the team.
        /// </summary>
