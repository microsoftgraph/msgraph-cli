...
namespace ApiSdk.Agreements.Item.File {
    ...
    public class FileRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(agreementIdOption, selectOption, expandOption, outputOption, outputFilterOption, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
