...
namespace ApiSdk.Agreements.Item.File.Localizations.Item {
    ...
    public class AgreementFileLocalizationItemRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            }, new CollectionBinding(agreementIdOption, agreementFileLocalizationIdOption, new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// The localized version of the terms of use agreement files attached to the agreement.
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(agreementIdOption, agreementFileLocalizationIdOption, selectOption, expandOption, outputOption, queryOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// The localized version of the terms of use agreement files attached to the agreement.
