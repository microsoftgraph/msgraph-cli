...
namespace ApiSdk.Agreements.Item.File.Localizations.Item.Versions.Item {
    ...
    public class AgreementFileVersionRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string agreementId, string agreementFileLocalizationId, string agreementFileVersionId, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string agreementId, string agreementFileLocalizationId, string agreementFileVersionId, string[] select, string[] expand, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string agreementId, string agreementFileLocalizationId, string agreementFileVersionId, string body, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
