...
namespace ApiSdk.Agreements.Item.File.Localizations.Item.Versions {
    ...
    public class VersionsRequestBuilder {
        ...
        public Command BuildCreateCommand() {
            ...
            }, agreementIdOption, agreementFileLocalizationIdOption, bodyOption, outputOption);
            return command;
        }
        /// <summary>
        /// Read-only. Customized versions of the terms of use agreement in the Azure AD tenant.
        ...
        public Command BuildListCommand() {
            ...
            command.SetHandler(async (string agreementId, string agreementFileLocalizationId, int? top, int? skip, string search, string filter, bool? count, string[] orderby, string[] select, string[] expand, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                ...
                var formatter = outputFormatterFactory.GetFormatter(output);
                formatter.WriteOutput(response, console);
            }, agreementIdOption, agreementFileLocalizationIdOption, topOption, skipOption, searchOption, filterOption, countOption, orderbyOption, selectOption, expandOption, outputOption);
            return command;
        }
        /// <summary>
