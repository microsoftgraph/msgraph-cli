...
namespace ApiSdk.Agreements.Item.File.Localizations.Item.Versions {
    ...
    public class VersionsRequestBuilder {
        ...
        public Command BuildListCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, int?, int?, string, string, bool?, object, object, object>(async (agreementId, agreementFileLocalizationId, top, skip, search, filter, count, orderby, select, expand) => {
