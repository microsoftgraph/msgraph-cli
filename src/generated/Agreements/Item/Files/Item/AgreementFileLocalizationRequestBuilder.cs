...
namespace ApiSdk.Agreements.Item.Files.Item {
    ...
    public class AgreementFileLocalizationRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            }, agreementIdOption, agreementFileLocalizationIdOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// PDFs linked to this agreement. Note: This property is in the process of being deprecated. Use the  file property instead.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string agreementId, string agreementFileLocalizationId, string[] select, string[] expand, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
            ...
            }, agreementIdOption, agreementFileLocalizationIdOption, selectOption, expandOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// PDFs linked to this agreement. Note: This property is in the process of being deprecated. Use the  file property instead.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string agreementId, string agreementFileLocalizationId, string body, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                ...
                await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                console.WriteLine("Success");
            }, agreementIdOption, agreementFileLocalizationIdOption, bodyOption, new OutputFormatterFactoryBinder());
            return command;
        }
