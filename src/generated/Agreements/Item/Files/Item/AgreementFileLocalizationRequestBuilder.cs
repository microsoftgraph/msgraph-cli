...
namespace ApiSdk.Agreements.Item.Files.Item {
    ...
    public class AgreementFileLocalizationRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string agreementId, string agreementFileLocalizationId, IConsole console) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string agreementId, string agreementFileLocalizationId, string[] select, string[] expand, FormatterType output, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
            ...
            }, agreementIdOption, agreementFileLocalizationIdOption, selectOption, expandOption, outputOption);
            return command;
        }
        /// <summary>
        /// PDFs linked to this agreement. Note: This property is in the process of being deprecated. Use the  file property instead.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string agreementId, string agreementFileLocalizationId, string body, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
