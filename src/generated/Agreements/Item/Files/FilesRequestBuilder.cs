...
namespace ApiSdk.Agreements.Item.Files {
    ...
    public class FilesRequestBuilder {
        ...
        public Command BuildCreateCommand() {
            ...
            }, agreementIdOption, bodyOption, outputOption);
            return command;
        }
        /// <summary>
        /// PDFs linked to this agreement. Note: This property is in the process of being deprecated. Use the  file property instead.
        ...
        public Command BuildListCommand() {
            ...
            command.SetHandler(async (string agreementId, int? top, int? skip, string search, string filter, bool? count, string[] orderby, string[] select, string[] expand, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                ...
                var formatter = outputFormatterFactory.GetFormatter(output);
                formatter.WriteOutput(response, console);
            }, agreementIdOption, topOption, skipOption, searchOption, filterOption, countOption, orderbyOption, selectOption, expandOption, outputOption);
            return command;
        }
        /// <summary>
