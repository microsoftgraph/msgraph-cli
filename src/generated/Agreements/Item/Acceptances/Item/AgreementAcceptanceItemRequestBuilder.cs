...
namespace ApiSdk.Agreements.Item.Acceptances.Item {
    ...
    public class AgreementAcceptanceItemRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(agreementIdOption, agreementAcceptanceIdOption, selectOption, expandOption, outputOption, outputFilterOption, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// Read-only. Information about acceptances of this agreement.
