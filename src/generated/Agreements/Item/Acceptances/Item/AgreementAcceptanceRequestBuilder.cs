...
namespace ApiSdk.Agreements.Item.Acceptances.Item {
    ...
    public class AgreementAcceptanceRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string agreementId, string agreementAcceptanceId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, agreementIdOption, agreementAcceptanceIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// Read-only. Information about acceptances of this agreement.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string agreementId, string agreementAcceptanceId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, agreementIdOption, agreementAcceptanceIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// Read-only. Information about acceptances of this agreement.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string agreementId, string agreementAcceptanceId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, agreementIdOption, agreementAcceptanceIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
