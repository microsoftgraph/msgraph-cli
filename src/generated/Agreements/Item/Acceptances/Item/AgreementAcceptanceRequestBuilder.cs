...
namespace ApiSdk.Agreements.Item.Acceptances.Item {
    ...
    public class AgreementAcceptanceRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string agreementId, string agreementAcceptanceId, IConsole console) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string agreementId, string agreementAcceptanceId, string[] select, string[] expand, FormatterType output, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string agreementId, string agreementAcceptanceId, string body, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
