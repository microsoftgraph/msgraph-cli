...
namespace ApiSdk.Agreements.Item {
    ...
    public class AgreementRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string agreementId, string[] select, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string agreementId, string body, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
