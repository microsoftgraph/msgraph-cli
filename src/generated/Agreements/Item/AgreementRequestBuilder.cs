...
namespace ApiSdk.Agreements.Item {
    ...
    public class AgreementRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string agreementId, IConsole console) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string agreementId, string[] select, FormatterType output, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string agreementId, string body, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
