using ApiSdk.Agreements.Item.FileNamespace.Localizations.Item.Versions;
...
using System;
namespace ApiSdk.Agreements.Item.FileNamespace.Localizations.Item {
    /// <summary>
    ...
    public class AgreementFileLocalizationItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public AgreementFileLocalizationItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/agreements/{agreement%2Did}/file/localizations/{agreementFileLocalization%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Delete navigation property localizations for agreements
        /// </summary>
...
#nullable restore
        ...
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<AgreementFileLocalizationItemRequestBuilderGetQueryParameters>> requestConfiguration = default) {
            ...
            if (requestConfiguration != null) {
                var requestConfig = new RequestConfiguration<AgreementFileLocalizationItemRequestBuilderGetQueryParameters>();
                requestConfiguration.Invoke(requestConfig);
                requestInfo.AddQueryParameters(requestConfig.QueryParameters);
                requestInfo.AddRequestOptions(requestConfig.Options);
                requestInfo.AddHeaders(requestConfig.Headers);
