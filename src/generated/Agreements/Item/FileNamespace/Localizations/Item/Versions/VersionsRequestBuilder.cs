using ApiSdk.Agreements.Item.FileNamespace.Localizations.Item.Versions.Count;
using ApiSdk.Agreements.Item.FileNamespace.Localizations.Item.Versions.Item;
using ApiSdk.Models;
...
namespace ApiSdk.Agreements.Item.FileNamespace.Localizations.Item.Versions {
    ...
    public class VersionsRequestBuilder : BaseCliRequestBuilder {
        ...
        public VersionsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/agreements/{agreement%2Did}/file/localizations/{agreementFileLocalization%2Did}/versions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Read-only. Customized versions of the terms of use agreement in the Azure AD tenant.
        /// </summary>
