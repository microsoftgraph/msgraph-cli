...
namespace ApiSdk.Agreements.Item.FileNamespace.Localizations.Item.Versions.Item {
    ...
    public class AgreementFileVersionItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public AgreementFileVersionItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/agreements/{agreement%2Did}/file/localizations/{agreementFileLocalization%2Did}/versions/{agreementFileVersion%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Delete navigation property versions for agreements
        /// </summary>
