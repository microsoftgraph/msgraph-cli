...
namespace ApiSdk.SchemaExtensions {
    ...
    public class SchemaExtensionsRequestBuilder {
        ...
        public List<Command> BuildCommand() {
            var builder = new SchemaExtensionRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildCreateCommand() {
            ...
            command.Description = "Add new entity to schemaExtensions";
        ...
        public Command BuildListCommand() {
            ...
            command.Description = "Get entities from schemaExtensions";
            // Create options for all the parameters
            ...
            command.SetHandler(async (int? top, int? skip, string search, string filter, bool? count, string[] orderby, string[] select, string[] expand) => {
                ...
                var result = await RequestAdapter.SendAsync<SchemaExtensionsResponse>(requestInfo);
                // Print request output. What if the request has no return?
                using var serializer = RequestAdapter.SerializationWriterFactory.GetSerializationWriter("application/json");
                serializer.WriteObjectValue(null, result);
                using var content = serializer.GetSerializedContent();
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<SchemaExtension> PostAsync(SchemaExtension model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
