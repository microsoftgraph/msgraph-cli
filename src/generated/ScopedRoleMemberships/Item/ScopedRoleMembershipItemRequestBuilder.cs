...
namespace ApiSdk.ScopedRoleMemberships.Item {
    ...
    public class ScopedRoleMembershipItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public ScopedRoleMembershipItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/scopedRoleMemberships/{scopedRoleMembership%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Delete entity from scopedRoleMemberships
        /// </summary>
