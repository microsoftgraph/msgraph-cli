    ...
    public class GetByIdsRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.PermissionGrants.GetByIds.GetByIdsRequestBody>(ApiSdk.PermissionGrants.GetByIds.GetByIdsRequestBody.CreateFromDiscriminatorValue);
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ApiSdk.PermissionGrants.GetByIds.GetByIdsRequestBody body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
