...
namespace ApiSdk.PermissionGrants.Item.GetMemberObjects {
    ...
    public class GetMemberObjectsRequestBuilder {
        ...
        /// </summary>
        public async Task<IEnumerable<string>> PostAsync(GetMemberObjectsRequestBody model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
