...
namespace ApiSdk.PermissionGrants.Item.GetMemberObjects {
    ...
    public class GetMemberObjectsRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            }, new CollectionBinding(resourceSpecificPermissionGrantIdOption, bodyOption, outputOption, queryOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
