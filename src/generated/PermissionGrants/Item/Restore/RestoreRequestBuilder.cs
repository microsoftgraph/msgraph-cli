...
namespace ApiSdk.PermissionGrants.Item.Restore {
    ...
    public class RestoreRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (string resourceSpecificPermissionGrantId, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, resourceSpecificPermissionGrantIdOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
