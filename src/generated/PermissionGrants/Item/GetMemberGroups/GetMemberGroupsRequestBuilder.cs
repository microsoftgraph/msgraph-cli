...
namespace ApiSdk.PermissionGrants.Item.GetMemberGroups {
    ...
    public class GetMemberGroupsRequestBuilder {
        ...
        public GetMemberGroupsRequestBuilder(Dictionary<string, object> pathParameters) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            UrlTemplate = "{+baseurl}/permissionGrants/{resourceSpecificPermissionGrant%2Did}/getMemberGroups";
