...
namespace ApiSdk.PermissionGrants {
    ...
    public class PermissionGrantsRequestBuilder {
        ...
        public Command BuildListCommand() {
            ...
            command.AddOption(outputOption);
            command.SetHandler(async (string search, string filter, string[] orderby, string[] select, string[] expand, FormatterType output, IOutputFormatterFactory outputFormatterFactory, CancellationToken cancellationToken) => {
                ...
                var formatter = outputFormatterFactory.GetFormatter(output);
                formatter.WriteOutput(response);
            }, searchOption, filterOption, orderbyOption, selectOption, expandOption, outputOption);
            return command;
        }
