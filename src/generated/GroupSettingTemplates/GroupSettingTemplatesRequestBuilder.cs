...
namespace ApiSdk.GroupSettingTemplates {
    ...
    public class GroupSettingTemplatesRequestBuilder {
        ...
        public List<Command> BuildCommand() {
            var builder = new GroupSettingTemplateItemRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildCreateCommand() {
            ...
            command.Description = "Add new entity to groupSettingTemplates";
        ...
        public Command BuildGetAvailableExtensionPropertiesCommand() {
            ...
            var builder = new ApiSdk.GroupSettingTemplates.GetAvailableExtensionProperties.GetAvailableExtensionPropertiesRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildPostCommand());
            return command;
        }
        public Command BuildGetByIdsCommand() {
            var command = new Command("get-by-ids");
            var builder = new ApiSdk.GroupSettingTemplates.GetByIds.GetByIdsRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildPostCommand());
            return command;
        }
        /// <summary>
        ...
        public Command BuildListCommand() {
            ...
            command.Description = "Get entities from groupSettingTemplates";
            // Create options for all the parameters
        ...
        public Command BuildValidatePropertiesCommand() {
            ...
            var builder = new ApiSdk.GroupSettingTemplates.ValidateProperties.ValidatePropertiesRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildPostCommand());
            return command;
        }
        /// <summary>
