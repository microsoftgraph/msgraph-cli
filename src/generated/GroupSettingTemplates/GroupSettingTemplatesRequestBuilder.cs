...
using ApiSdk.GroupSettingTemplates.MicrosoftGraphGetAvailableExtensionProperties;
using ApiSdk.GroupSettingTemplates.MicrosoftGraphGetByIds;
using ApiSdk.GroupSettingTemplates.MicrosoftGraphValidateProperties;
using ApiSdk.Models;
...
namespace ApiSdk.GroupSettingTemplates {
    ...
    public class GroupSettingTemplatesRequestBuilder {
        ...
        public GroupSettingTemplatesRequestBuilder(Dictionary<string, object> pathParameters) {
