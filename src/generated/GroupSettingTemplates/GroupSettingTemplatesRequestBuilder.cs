using ApiSdk.GroupSettingTemplates.Count;
using ApiSdk.GroupSettingTemplates.Delta;
...
namespace ApiSdk.GroupSettingTemplates {
    ...
    public class GroupSettingTemplatesRequestBuilder : BaseCliRequestBuilder {
        ...
        public Tuple<List<Command>, List<Command>> BuildCommand() {
            ...
            var builder = new GroupSettingTemplateItemRequestBuilder(PathParameters);
        ...
        public GroupSettingTemplatesRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/groupSettingTemplates{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Group setting templates represents a set of templates from which group settings may be created and used within a tenant. This operation retrieves the list of available groupSettingTemplates objects.
        /// </summary>
...
#nullable restore
        ...
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<GroupSettingTemplatesRequestBuilderGetQueryParameters>> requestConfiguration = default) {
            ...
            if (requestConfiguration != null) {
                var requestConfig = new RequestConfiguration<GroupSettingTemplatesRequestBuilderGetQueryParameters>();
