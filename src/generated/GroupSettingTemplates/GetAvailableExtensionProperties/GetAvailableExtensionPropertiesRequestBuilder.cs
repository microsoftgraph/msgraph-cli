    ...
    public class GetAvailableExtensionPropertiesRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.GroupSettingTemplates.GetAvailableExtensionProperties.GetAvailableExtensionPropertiesRequestBody>(ApiSdk.GroupSettingTemplates.GetAvailableExtensionProperties.GetAvailableExtensionPropertiesRequestBody.CreateFromDiscriminatorValue);
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ApiSdk.GroupSettingTemplates.GetAvailableExtensionProperties.GetAvailableExtensionPropertiesRequestBody body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
