...
namespace ApiSdk.GroupSettingTemplates.Item.CheckMemberObjects {
    ...
    public class CheckMemberObjectsRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (string groupSettingTemplateId, string body, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, groupSettingTemplateIdOption, bodyOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
