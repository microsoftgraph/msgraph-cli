...
namespace ApiSdk.GroupSettingTemplates.Item.CheckMemberObjects {
    ...
    public class CheckMemberObjectsRequestBuilder {
        ...
        public CheckMemberObjectsRequestBuilder(Dictionary<string, object> pathParameters) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            UrlTemplate = "{+baseurl}/groupSettingTemplates/{groupSettingTemplate%2Did}/checkMemberObjects";
