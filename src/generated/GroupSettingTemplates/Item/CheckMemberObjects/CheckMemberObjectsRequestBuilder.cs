    ...
    public class CheckMemberObjectsRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildPostCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.GroupSettingTemplates.Item.CheckMemberObjects.CheckMemberObjectsPostRequestBody>(ApiSdk.GroupSettingTemplates.Item.CheckMemberObjects.CheckMemberObjectsPostRequestBody.CreateFromDiscriminatorValue);
                if (model is null) {
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.GroupSettingTemplates.Item.CheckMemberObjects.CheckMemberObjectsRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public RequestInformation ToPostRequestInformation(ApiSdk.GroupSettingTemplates.Item.CheckMemberObjects.CheckMemberObjectsPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(ApiSdk.GroupSettingTemplates.Item.CheckMemberObjects.CheckMemberObjectsPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
