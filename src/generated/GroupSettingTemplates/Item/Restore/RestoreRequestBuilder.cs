...
namespace ApiSdk.GroupSettingTemplates.Item.Restore {
    ...
    public class RestoreRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (string groupSettingTemplateId, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, groupSettingTemplateIdOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
