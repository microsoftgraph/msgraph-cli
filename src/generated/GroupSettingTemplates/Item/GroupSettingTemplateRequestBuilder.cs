...
namespace ApiSdk.GroupSettingTemplates.Item {
    ...
    public class GroupSettingTemplateRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string groupSettingTemplateId, IConsole console) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string groupSettingTemplateId, string[] select, string[] expand, FormatterType output, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string groupSettingTemplateId, string body, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
