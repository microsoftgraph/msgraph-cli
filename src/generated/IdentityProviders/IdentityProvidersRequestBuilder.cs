...
namespace ApiSdk.IdentityProviders {
    ...
    public class IdentityProvidersRequestBuilder {
        ...
        public Command BuildListCommand() {
            ...
            command.Description = "Get entities from identityProviders";
            // Create options for all the parameters
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<IdentityProvider> PostAsync(IdentityProvider model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
