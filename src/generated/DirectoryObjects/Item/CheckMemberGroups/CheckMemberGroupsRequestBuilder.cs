...
namespace ApiSdk.DirectoryObjects.Item.CheckMemberGroups {
    ...
    public class CheckMemberGroupsRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (string directoryObjectId, string body, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, directoryObjectIdOption, bodyOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
