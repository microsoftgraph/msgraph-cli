...
namespace ApiSdk.DirectoryObjects.Item.GetMemberObjects {
    ...
    public class GetMemberObjectsRequestBuilder {
        ...
        public GetMemberObjectsRequestBuilder(Dictionary<string, object> pathParameters) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            UrlTemplate = "{+baseurl}/directoryObjects/{directoryObject%2Did}/getMemberObjects";
