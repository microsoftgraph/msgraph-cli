...
namespace ApiSdk.DirectoryObjects.Item.Restore {
    ...
    public class RestoreRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (string directoryObjectId, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, directoryObjectIdOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
