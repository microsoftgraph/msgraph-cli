...
namespace ApiSdk.DirectoryObjects.Item.CheckMemberObjects {
    ...
    public class CheckMemberObjectsRequestBuilder : BaseCliRequestBuilder {
        ...
        public CheckMemberObjectsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/directoryObjects/{directoryObject%2Did}/checkMemberObjects", pathParameters) {
        }
        /// <summary>
        /// Invoke action checkMemberObjects
        /// </summary>
