...
namespace ApiSdk.DirectoryObjects.Item {
    ...
    public class DirectoryObjectRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string directoryObjectId, IConsole console) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string directoryObjectId, string[] select, string[] expand, FormatterType output, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string directoryObjectId, string body, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
