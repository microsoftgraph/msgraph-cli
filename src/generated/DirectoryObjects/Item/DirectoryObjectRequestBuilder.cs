...
namespace ApiSdk.DirectoryObjects.Item {
    ...
    public class DirectoryObjectRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string directoryObjectId, string[] select, string[] expand, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string directoryObjectId, string body, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
