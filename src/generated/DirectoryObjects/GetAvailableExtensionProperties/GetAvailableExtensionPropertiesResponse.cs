...
namespace ApiSdk.DirectoryObjects.GetAvailableExtensionProperties {
    ...
    public class GetAvailableExtensionPropertiesResponse : IAdditionalDataHolder, IParsable {
        ...
        /// </summary>
        public static ApiSdk.DirectoryObjects.GetAvailableExtensionProperties.GetAvailableExtensionPropertiesResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
