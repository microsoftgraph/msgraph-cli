...
namespace ApiSdk.Domains.Item.VerificationDnsRecords.Item
{
    ...
    public class DomainDnsRecordItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildGetCommand()
        {
            ...
            command.Description = "DNS records that the customer adds to the DNS zone file of the domain before the customer can complete domain ownership verification with Microsoft Entra ID. Read-only, Nullable. Supports $expand.";
            var domainIdOption = new Option<string>("--domain-id", description: "The unique identifier of domain") {
            };
            domainIdOption.IsRequired = true;
            command.AddOption(domainIdOption);
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Domains.Item.VerificationDnsRecords.Item.DomainDnsRecordItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Domains.Item.VerificationDnsRecords.Item.DomainDnsRecordItemRequestBuilder.DomainDnsRecordItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Domains.Item.VerificationDnsRecords.Item.DomainDnsRecordItemRequestBuilder.DomainDnsRecordItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.DomainDnsRecord body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.DomainDnsRecord body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
