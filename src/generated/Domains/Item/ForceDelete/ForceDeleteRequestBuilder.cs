...
namespace ApiSdk.Domains.Item.ForceDelete {
    ...
    public class ForceDeleteRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(ForceDeleteRequestBody model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
