...
namespace ApiSdk.Domains.Item.ForceDelete {
    ...
    public class ForceDeleteRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (string domainId, string body, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, domainIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        ...
        /// </summary>
        public async Task PostAsync(ForceDeleteRequestBody model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
