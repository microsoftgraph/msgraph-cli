...
namespace ApiSdk.Domains.Item.ServiceConfigurationRecords.Item {
    ...
    public class DomainDnsRecordRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string domainId, string domainDnsRecordId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, domainIdOption, domainDnsRecordIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// DNS records the customer adds to the DNS zone file of the domain before the domain can be used by Microsoft Online services. Read-only, Nullable
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string domainId, string domainDnsRecordId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, domainIdOption, domainDnsRecordIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// DNS records the customer adds to the DNS zone file of the domain before the domain can be used by Microsoft Online services. Read-only, Nullable
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string domainId, string domainDnsRecordId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, domainIdOption, domainDnsRecordIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
