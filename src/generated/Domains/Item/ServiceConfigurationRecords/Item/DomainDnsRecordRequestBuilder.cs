...
namespace ApiSdk.Domains.Item.ServiceConfigurationRecords.Item {
    ...
    public class DomainDnsRecordRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string domainId, string domainDnsRecordId, IConsole console) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string domainId, string domainDnsRecordId, string[] select, string[] expand, FormatterType output, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string domainId, string domainDnsRecordId, string body, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
