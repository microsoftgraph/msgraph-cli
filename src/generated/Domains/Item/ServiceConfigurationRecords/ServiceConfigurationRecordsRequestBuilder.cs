...
namespace ApiSdk.Domains.Item.ServiceConfigurationRecords {
    ...
    public class ServiceConfigurationRecordsRequestBuilder {
        ...
        public Command BuildListCommand() {
            ...
            command.SetHandler(async (string domainId, int? top, int? skip, string search, string filter, bool? count, string[] orderby, string[] select, string[] expand) => {
                ...
                var result = await RequestAdapter.SendAsync<ServiceConfigurationRecordsResponse>(requestInfo);
                // Print request output. What if the request has no return?
                using var serializer = RequestAdapter.SerializationWriterFactory.GetSerializationWriter("application/json");
                serializer.WriteObjectValue(null, result);
                using var content = serializer.GetSerializedContent();
                ...
                var strContent = await reader.ReadToEndAsync();
                Console.Write(strContent + "\n");
            }, domainIdOption, topOption, skipOption, searchOption, filterOption, countOption, orderbyOption, selectOption, expandOption);
            return command;
        }
        /// <summary>
