...
namespace ApiSdk.Domains.Item.Verify {
    ...
    public class VerifyRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            }, new CollectionBinding(domainIdOption, outputOption, outputFilterOption, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
