...
namespace ApiSdk.Domains.Item.Verify {
    ...
    public class VerifyRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (string domainId, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, domainIdOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
