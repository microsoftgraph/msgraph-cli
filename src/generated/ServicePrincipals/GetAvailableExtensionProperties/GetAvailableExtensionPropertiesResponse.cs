...
namespace ApiSdk.ServicePrincipals.GetAvailableExtensionProperties {
    ...
    public class GetAvailableExtensionPropertiesResponse : IAdditionalDataHolder, IParsable {
        ...
        /// </summary>
        public static ApiSdk.ServicePrincipals.GetAvailableExtensionProperties.GetAvailableExtensionPropertiesResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
