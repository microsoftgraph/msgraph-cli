...
using ApiSdk.ServicePrincipals.MicrosoftGraphDelta;
using ApiSdk.ServicePrincipals.MicrosoftGraphGetAvailableExtensionProperties;
using ApiSdk.ServicePrincipals.MicrosoftGraphGetByIds;
using ApiSdk.ServicePrincipals.MicrosoftGraphValidateProperties;
...
namespace ApiSdk.ServicePrincipals {
    ...
    public class ServicePrincipalsRequestBuilder {
        ...
        public Command BuildCommand() {
            ...
            var builder = new ServicePrincipalItemRequestBuilder(PathParameters, RequestAdapter);
            ...
            command.AddCommand(builder.BuildMicrosoftGraphAddKeyCommand());
            command.AddCommand(builder.BuildMicrosoftGraphAddPasswordCommand());
            command.AddCommand(builder.BuildMicrosoftGraphAddTokenSigningCertificateCommand());
            ...
            command.AddCommand(builder.BuildMicrosoftGraphRemoveKeyCommand());
            command.AddCommand(builder.BuildMicrosoftGraphRemovePasswordCommand());
