...
namespace ApiSdk.ServicePrincipals.Item.TokenIssuancePolicies.Item {
    ...
    public class TokenIssuancePolicyItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public TokenIssuancePolicyItemRequestBuilder(string rawUrl) : base("{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/tokenIssuancePolicies/{tokenIssuancePolicy%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// The tokenIssuancePolicies assigned to this service principal.
        /// </summary>
