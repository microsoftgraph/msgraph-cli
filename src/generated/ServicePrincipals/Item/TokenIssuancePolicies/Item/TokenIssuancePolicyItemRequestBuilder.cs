...
namespace ApiSdk.ServicePrincipals.Item.TokenIssuancePolicies.Item {
    ...
    public class TokenIssuancePolicyItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public TokenIssuancePolicyItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/tokenIssuancePolicies/{tokenIssuancePolicy%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// The tokenIssuancePolicies assigned to this service principal.
        /// </summary>
...
#nullable restore
        ...
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<TokenIssuancePolicyItemRequestBuilderGetQueryParameters>> requestConfiguration = default) {
            ...
            if (requestConfiguration != null) {
                var requestConfig = new RequestConfiguration<TokenIssuancePolicyItemRequestBuilderGetQueryParameters>();
