...
using ApiSdk.Models;
using ApiSdk.ServicePrincipals.Item.Synchronization.Templates.Item.Schema.Directories.Count;
using ApiSdk.ServicePrincipals.Item.Synchronization.Templates.Item.Schema.Directories.Item;
...
using System;
namespace ApiSdk.ServicePrincipals.Item.Synchronization.Templates.Item.Schema.Directories {
    /// <summary>
