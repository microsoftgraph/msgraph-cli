...
namespace ApiSdk.ServicePrincipals.Item.Synchronization.Templates.Item.Schema.Directories.Item {
    ...
    public class DirectoryDefinitionItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public DirectoryDefinitionItemRequestBuilder(string rawUrl) : base("{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/synchronization/templates/{synchronizationTemplate%2Did}/schema/directories/{directoryDefinition%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Delete navigation property directories for servicePrincipals
        /// </summary>
