...
namespace ApiSdk.ServicePrincipals.Item.Synchronization.Templates.Item.Schema.Functions {
    ...
    public class FunctionsRequestBuilder : BaseCliRequestBuilder {
        ...
        public FunctionsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/synchronization/templates/{synchronizationTemplate%2Did}/schema/functions(){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}", pathParameters) {
        }
        /// <summary>
        /// Invoke function functions
        /// </summary>
