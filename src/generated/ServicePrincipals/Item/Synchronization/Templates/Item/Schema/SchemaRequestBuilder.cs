...
namespace ApiSdk.ServicePrincipals.Item.Synchronization.Templates.Item.Schema {
    ...
    public class SchemaRequestBuilder : BaseCliRequestBuilder {
        ...
        public SchemaRequestBuilder(string rawUrl) : base("{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/synchronization/templates/{synchronizationTemplate%2Did}/schema{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Delete navigation property schema for servicePrincipals
        /// </summary>
