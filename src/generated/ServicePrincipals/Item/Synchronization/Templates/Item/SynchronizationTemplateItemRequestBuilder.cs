...
namespace ApiSdk.ServicePrincipals.Item.Synchronization.Templates.Item {
    ...
    public class SynchronizationTemplateItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public SynchronizationTemplateItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/synchronization/templates/{synchronizationTemplate%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Delete navigation property templates for servicePrincipals
        /// </summary>
