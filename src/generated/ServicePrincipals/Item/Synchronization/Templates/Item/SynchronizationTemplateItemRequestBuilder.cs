...
namespace ApiSdk.ServicePrincipals.Item.Synchronization.Templates.Item {
    ...
    public class SynchronizationTemplateItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public SynchronizationTemplateItemRequestBuilder(string rawUrl) : base("{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/synchronization/templates/{synchronizationTemplate%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Delete navigation property templates for servicePrincipals
        /// </summary>
