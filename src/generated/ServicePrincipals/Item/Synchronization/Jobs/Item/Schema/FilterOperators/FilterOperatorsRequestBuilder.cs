...
namespace ApiSdk.ServicePrincipals.Item.Synchronization.Jobs.Item.Schema.FilterOperators {
    ...
    public class FilterOperatorsRequestBuilder : BaseCliRequestBuilder {
        ...
        public FilterOperatorsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/synchronization/jobs/{synchronizationJob%2Did}/schema/filterOperators(){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}", pathParameters) {
        }
        /// <summary>
        /// Invoke function filterOperators
        /// </summary>
...
#nullable restore
        ...
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<FilterOperatorsRequestBuilderGetQueryParameters>> requestConfiguration = default) {
            ...
            if (requestConfiguration != null) {
                var requestConfig = new RequestConfiguration<FilterOperatorsRequestBuilderGetQueryParameters>();
