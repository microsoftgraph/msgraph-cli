...
using ApiSdk.Models;
using ApiSdk.ServicePrincipals.Item.Synchronization.Jobs.Item.Schema.Directories.Item.Discover;
...
using System;
namespace ApiSdk.ServicePrincipals.Item.Synchronization.Jobs.Item.Schema.Directories.Item {
    /// <summary>
    ...
    public class DirectoryDefinitionItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public DirectoryDefinitionItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/synchronization/jobs/{synchronizationJob%2Did}/schema/directories/{directoryDefinition%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Delete navigation property directories for servicePrincipals
        /// </summary>
