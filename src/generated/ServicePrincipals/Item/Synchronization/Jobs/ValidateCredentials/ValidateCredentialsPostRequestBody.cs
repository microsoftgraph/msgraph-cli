...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.ServicePrincipals.Item.Synchronization.Jobs.ValidateCredentials.ValidateCredentialsPostRequestBody"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.ServicePrincipals.Item.Synchronization.Jobs.ValidateCredentials.ValidateCredentialsPostRequestBody"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static ApiSdk.ServicePrincipals.Item.Synchronization.Jobs.ValidateCredentials.ValidateCredentialsPostRequestBody CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.ServicePrincipals.Item.Synchronization.Jobs.ValidateCredentials.ValidateCredentialsPostRequestBody();
        }
        /// <summary>
