...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.ServicePrincipals.Item.Synchronization.AcquireAccessToken.AcquireAccessTokenPostRequestBody"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.ServicePrincipals.Item.Synchronization.AcquireAccessToken.AcquireAccessTokenPostRequestBody"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static ApiSdk.ServicePrincipals.Item.Synchronization.AcquireAccessToken.AcquireAccessTokenPostRequestBody CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.ServicePrincipals.Item.Synchronization.AcquireAccessToken.AcquireAccessTokenPostRequestBody();
        }
        /// <summary>
