...
using ApiSdk.Models;
using ApiSdk.ServicePrincipals.Item.MemberOf.GraphAdministrativeUnit.Count;
...
using System;
namespace ApiSdk.ServicePrincipals.Item.MemberOf.GraphAdministrativeUnit {
    /// <summary>
    ...
    public class GraphAdministrativeUnitRequestBuilder : BaseCliRequestBuilder {
        ...
        public GraphAdministrativeUnitRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/memberOf/graph.administrativeUnit{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Get the items of type microsoft.graph.administrativeUnit in the microsoft.graph.directoryObject collection
        /// </summary>
