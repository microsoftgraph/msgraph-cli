...
using System;
namespace ApiSdk.ServicePrincipals.Item.MemberOf.Item.GraphDirectoryRole {
    /// <summary>
    ...
    public class GraphDirectoryRoleRequestBuilder : BaseCliRequestBuilder {
        ...
        public GraphDirectoryRoleRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/memberOf/{directoryObject%2Did}/graph.directoryRole{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Get the item of type microsoft.graph.directoryObject as microsoft.graph.directoryRole
        /// </summary>
