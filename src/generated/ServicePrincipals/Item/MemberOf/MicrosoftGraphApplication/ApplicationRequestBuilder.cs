...
using ApiSdk.ServicePrincipals.Item.MemberOf.MicrosoftGraphApplication.Count;
...
namespace ApiSdk.ServicePrincipals.Item.MemberOf.MicrosoftGraphApplication {
    /// <summary>
