...
namespace ApiSdk.ServicePrincipals.Item.OwnedObjects {
    ...
    public class OwnedObjectsRequestBuilder : BaseCliRequestBuilder {
        ...
        public OwnedObjectsRequestBuilder(string rawUrl) : base("{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/ownedObjects{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Directory objects that are owned by this service principal. Read-only. Nullable. Supports $expand, $select nested in $expand, and $filter (/$count eq 0, /$count ne 0, /$count eq 1, /$count ne 1).
        /// </summary>
