...
using ApiSdk.ServicePrincipals.Item.OwnedObjects.GraphAppRoleAssignment.Count;
...
namespace ApiSdk.ServicePrincipals.Item.OwnedObjects.GraphAppRoleAssignment {
    /// <summary>
    ...
    public class GraphAppRoleAssignmentRequestBuilder : BaseCliRequestBuilder {
        ...
        public GraphAppRoleAssignmentRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/ownedObjects/graph.appRoleAssignment{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Get the items of type microsoft.graph.appRoleAssignment in the microsoft.graph.directoryObject collection
        /// </summary>
