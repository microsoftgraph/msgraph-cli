...
using ApiSdk.ServicePrincipals.Item.OwnedObjects.MicrosoftGraphAppRoleAssignment.Count;
...
namespace ApiSdk.ServicePrincipals.Item.OwnedObjects.MicrosoftGraphAppRoleAssignment {
    /// <summary>
