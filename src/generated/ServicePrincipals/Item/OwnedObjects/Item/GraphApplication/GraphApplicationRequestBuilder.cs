...
namespace ApiSdk.ServicePrincipals.Item.OwnedObjects.Item.GraphApplication {
    /// <summary>
    ...
    public class GraphApplicationRequestBuilder : BaseCliRequestBuilder {
        ...
        public GraphApplicationRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/ownedObjects/{directoryObject%2Did}/graph.application{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Get the item of type microsoft.graph.directoryObject as microsoft.graph.application
        /// </summary>
