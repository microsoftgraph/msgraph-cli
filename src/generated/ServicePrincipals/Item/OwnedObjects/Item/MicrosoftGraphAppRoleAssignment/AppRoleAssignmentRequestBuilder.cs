...
namespace ApiSdk.ServicePrincipals.Item.OwnedObjects.Item.MicrosoftGraphAppRoleAssignment {
    /// <summary>
    ...
    public class AppRoleAssignmentRequestBuilder {
        ...
        public AppRoleAssignmentRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/ownedObjects/{directoryObject%2Did}/microsoft.graph.appRoleAssignment{?%24select,%24expand}";
