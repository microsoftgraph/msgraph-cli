...
namespace ApiSdk.ServicePrincipals.Item.DelegatedPermissionClassifications.Item {
    ...
    public class DelegatedPermissionClassificationRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string servicePrincipalId, string delegatedPermissionClassificationId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, servicePrincipalIdOption, delegatedPermissionClassificationIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The permission classifications for delegated permissions exposed by the app that this service principal represents. Supports $expand.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string servicePrincipalId, string delegatedPermissionClassificationId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, servicePrincipalIdOption, delegatedPermissionClassificationIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The permission classifications for delegated permissions exposed by the app that this service principal represents. Supports $expand.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string servicePrincipalId, string delegatedPermissionClassificationId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, servicePrincipalIdOption, delegatedPermissionClassificationIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
