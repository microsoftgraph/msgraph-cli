...
namespace ApiSdk.ServicePrincipals.Item.DelegatedPermissionClassifications.Item {
    ...
    public class DelegatedPermissionClassificationRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string servicePrincipalId, string delegatedPermissionClassificationId, IConsole console) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string servicePrincipalId, string delegatedPermissionClassificationId, string[] select, string[] expand, FormatterType output, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string servicePrincipalId, string delegatedPermissionClassificationId, string body, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
