...
namespace ApiSdk.ServicePrincipals.Item.DelegatedPermissionClassifications.Item {
    ...
    public class DelegatedPermissionClassificationItemRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(servicePrincipalIdOption, delegatedPermissionClassificationIdOption, selectOption, expandOption, outputOption, queryOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// The permission classifications for delegated permissions exposed by the app that this service principal represents. Supports $expand.
