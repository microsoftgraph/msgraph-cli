...
namespace ApiSdk.ServicePrincipals.Item.Restore {
    ...
    public class RestoreRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (string servicePrincipalId, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, servicePrincipalIdOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
