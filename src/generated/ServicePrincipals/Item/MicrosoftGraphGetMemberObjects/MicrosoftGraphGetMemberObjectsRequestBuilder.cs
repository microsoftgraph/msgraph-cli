...
namespace ApiSdk.ServicePrincipals.Item.MicrosoftGraphGetMemberObjects {
    /// <summary>
    ...
    public class MicrosoftGraphGetMemberObjectsRequestBuilder {
        ...
        public MicrosoftGraphGetMemberObjectsRequestBuilder(Dictionary<string, object> pathParameters) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            UrlTemplate = "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/microsoft.graph.getMemberObjects";
