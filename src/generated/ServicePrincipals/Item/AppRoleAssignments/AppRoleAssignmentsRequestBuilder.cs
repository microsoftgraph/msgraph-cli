...
namespace ApiSdk.ServicePrincipals.Item.AppRoleAssignments {
    ...
    public class AppRoleAssignmentsRequestBuilder {
        ...
        public Command BuildCommand() {
            ...
            var builder = new AppRoleAssignmentItemRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildCreateCommand() {
            ...
            command.Description = "Create new navigation property to appRoleAssignments for servicePrincipals";
            ...
            }, new CollectionBinding(servicePrincipalIdOption, bodyOption, outputOption, queryOption, jsonNoIndentOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        ...
        public AppRoleAssignmentsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/appRoleAssignments{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
