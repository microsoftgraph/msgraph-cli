    ...
    public class RemoveKeyRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.ServicePrincipals.Item.RemoveKey.RemoveKeyRequestBody>(ApiSdk.ServicePrincipals.Item.RemoveKey.RemoveKeyRequestBody.CreateFromDiscriminatorValue);
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ApiSdk.ServicePrincipals.Item.RemoveKey.RemoveKeyRequestBody body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
