...
using ApiSdk.Models;
using ApiSdk.ServicePrincipals.Item.Owners.GraphEndpoint.Count;
...
using System;
namespace ApiSdk.ServicePrincipals.Item.Owners.GraphEndpoint {
    /// <summary>
    ...
    public class GraphEndpointRequestBuilder : BaseCliRequestBuilder {
        ...
        public GraphEndpointRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/owners/graph.endpoint{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Get the items of type microsoft.graph.endpoint in the microsoft.graph.directoryObject collection
        /// </summary>
...
#nullable restore
        ...
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<GraphEndpointRequestBuilderGetQueryParameters>> requestConfiguration = default) {
            ...
            if (requestConfiguration != null) {
                var requestConfig = new RequestConfiguration<GraphEndpointRequestBuilderGetQueryParameters>();
