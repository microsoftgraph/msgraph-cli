...
namespace ApiSdk.ServicePrincipals.Item.Owners.GraphEndpoint {
    ...
    public class GraphEndpointRequestBuilder {
        ...
        public GraphEndpointRequestBuilder(Dictionary<string, object> pathParameters) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            UrlTemplate = "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/owners/graph.endpoint{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
