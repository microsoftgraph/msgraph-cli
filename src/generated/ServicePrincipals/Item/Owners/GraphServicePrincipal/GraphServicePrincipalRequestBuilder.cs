...
namespace ApiSdk.ServicePrincipals.Item.Owners.GraphServicePrincipal {
    ...
    public class GraphServicePrincipalRequestBuilder {
        ...
        public GraphServicePrincipalRequestBuilder(Dictionary<string, object> pathParameters) {
            ...
            UrlTemplate = "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/owners/graph.servicePrincipal{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
