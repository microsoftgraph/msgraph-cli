...
namespace ApiSdk.ServicePrincipals.Item.Owners.GraphAppRoleAssignment.Count {
    ...
    public class CountRequestBuilder : BaseCliRequestBuilder {
        ...
        public CountRequestBuilder(string rawUrl) : base("{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/owners/graph.appRoleAssignment/$count{?%24search,%24filter}", rawUrl) {
        }
        /// <summary>
        /// Get the number of the resource
        /// </summary>
