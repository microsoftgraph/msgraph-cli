...
namespace ApiSdk.ServicePrincipals.Item.Endpoints.Item {
    ...
    public class EndpointRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string servicePrincipalId, string endpointId, IConsole console) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string servicePrincipalId, string endpointId, string[] select, string[] expand, FormatterType output, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string servicePrincipalId, string endpointId, string body, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
