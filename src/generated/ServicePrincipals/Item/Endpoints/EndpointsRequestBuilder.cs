...
namespace ApiSdk.ServicePrincipals.Item.Endpoints {
    ...
    public class EndpointsRequestBuilder {
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ApiSdk.Models.Endpoint body, Action<EndpointsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
