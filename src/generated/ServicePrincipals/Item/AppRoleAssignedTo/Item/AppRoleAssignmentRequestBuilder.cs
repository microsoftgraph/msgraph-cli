...
namespace ApiSdk.ServicePrincipals.Item.AppRoleAssignedTo.Item {
    ...
    public class AppRoleAssignmentRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string servicePrincipalId, string appRoleAssignmentId, IConsole console) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string servicePrincipalId, string appRoleAssignmentId, string[] select, string[] expand, FormatterType output, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string servicePrincipalId, string appRoleAssignmentId, string body, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
