...
namespace ApiSdk.ServicePrincipals.Item.AppRoleAssignedTo.Item {
    ...
    public class AppRoleAssignmentRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            }, servicePrincipalIdOption, appRoleAssignmentIdOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// App role assignments for this app or service, granted to users, groups, and other service principals.Supports $expand.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string servicePrincipalId, string appRoleAssignmentId, string[] select, string[] expand, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
            ...
            }, servicePrincipalIdOption, appRoleAssignmentIdOption, selectOption, expandOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// App role assignments for this app or service, granted to users, groups, and other service principals.Supports $expand.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string servicePrincipalId, string appRoleAssignmentId, string body, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                ...
                await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                console.WriteLine("Success");
            }, servicePrincipalIdOption, appRoleAssignmentIdOption, bodyOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
