...
using ApiSdk.ServicePrincipals.Item.TransitiveMemberOf.ServicePrincipal.Count;
...
namespace ApiSdk.ServicePrincipals.Item.TransitiveMemberOf.ServicePrincipal {
    /// <summary>
