...
using ApiSdk.ServicePrincipals.Item.TransitiveMemberOf.MicrosoftGraphDevice.Count;
...
namespace ApiSdk.ServicePrincipals.Item.TransitiveMemberOf.MicrosoftGraphDevice {
    /// <summary>
