...
namespace ApiSdk.ServicePrincipals.Item.TransitiveMemberOf {
    ...
    public class TransitiveMemberOfRequestBuilder : BaseCliRequestBuilder {
        ...
        public TransitiveMemberOfRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/transitiveMemberOf{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Get transitiveMemberOf from servicePrincipals
        /// </summary>
