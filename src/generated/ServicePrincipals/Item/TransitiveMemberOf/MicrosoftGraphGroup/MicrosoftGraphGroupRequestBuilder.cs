...
using ApiSdk.ServicePrincipals.Item.TransitiveMemberOf.MicrosoftGraphGroup.Count;
...
namespace ApiSdk.ServicePrincipals.Item.TransitiveMemberOf.MicrosoftGraphGroup {
    /// <summary>
