...
using ApiSdk.Models;
using ApiSdk.ServicePrincipals.Item.TransitiveMemberOf.Item.GraphAdministrativeUnit;
using ApiSdk.ServicePrincipals.Item.TransitiveMemberOf.Item.GraphDirectoryRole;
using ApiSdk.ServicePrincipals.Item.TransitiveMemberOf.Item.GraphGroup;
...
namespace ApiSdk.ServicePrincipals.Item.TransitiveMemberOf.Item {
    ...
    public class DirectoryObjectItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public DirectoryObjectItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/transitiveMemberOf/{directoryObject%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Get transitiveMemberOf from servicePrincipals
        /// </summary>
