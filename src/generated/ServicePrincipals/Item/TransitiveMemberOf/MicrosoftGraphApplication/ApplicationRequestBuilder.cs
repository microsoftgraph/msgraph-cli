...
using ApiSdk.ServicePrincipals.Item.TransitiveMemberOf.MicrosoftGraphApplication.Count;
...
namespace ApiSdk.ServicePrincipals.Item.TransitiveMemberOf.MicrosoftGraphApplication {
    /// <summary>
