...
namespace ApiSdk.ServicePrincipals.Item.FederatedIdentityCredentials {
    ...
    public class FederatedIdentityCredentialsRequestBuilder {
        ...
        public Command BuildCommand() {
            ...
            var builder = new FederatedIdentityCredentialItemRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildListCommand() {
            ...
            command.Description = "Federated identities for a specific type of service principal - managed identity. Supports $expand and $filter (eq when counting empty collections).";
            // Create options for all the parameters
            var servicePrincipalIdOption = new Option<string>("--service-principal-id", description: "key: id of servicePrincipal") {
            };
            servicePrincipalIdOption.IsRequired = true;
        ...
        public FederatedIdentityCredentialsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/federatedIdentityCredentials{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
