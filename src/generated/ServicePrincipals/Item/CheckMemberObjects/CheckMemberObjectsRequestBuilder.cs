...
namespace ApiSdk.ServicePrincipals.Item.CheckMemberObjects {
    ...
    public class CheckMemberObjectsRequestBuilder : BaseCliRequestBuilder {
        ...
        public CheckMemberObjectsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/checkMemberObjects", pathParameters) {
        }
        /// <summary>
        /// Invoke action checkMemberObjects
        /// </summary>
