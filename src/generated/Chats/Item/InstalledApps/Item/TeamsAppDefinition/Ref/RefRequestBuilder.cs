...
namespace ApiSdk.Chats.Item.InstalledApps.Item.TeamsAppDefinition.Ref {
    ...
    public class RefRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            }, chatIdOption, teamsAppInstallationIdOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// The details of this version of the app.
        ...
        public Command BuildGetCommand() {
            ...
            }, chatIdOption, teamsAppInstallationIdOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// The details of this version of the app.
        ...
        public Command BuildPutCommand() {
            ...
            command.SetHandler(async (string chatId, string teamsAppInstallationId, string body, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                ...
                await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                console.WriteLine("Success");
            }, chatIdOption, teamsAppInstallationIdOption, bodyOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
