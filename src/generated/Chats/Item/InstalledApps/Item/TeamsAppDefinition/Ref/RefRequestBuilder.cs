...
namespace ApiSdk.Chats.Item.InstalledApps.Item.TeamsAppDefinition.Ref {
    ...
    public class RefRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string chatId, string teamsAppInstallationId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, chatIdOption, teamsAppInstallationIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The details of this version of the app.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string chatId, string teamsAppInstallationId, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, chatIdOption, teamsAppInstallationIdOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The details of this version of the app.
        ...
        public Command BuildPutCommand() {
            ...
            command.SetHandler(async (string chatId, string teamsAppInstallationId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, chatIdOption, teamsAppInstallationIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
