...
namespace ApiSdk.Chats.Item.InstalledApps.Item.TeamsAppDefinition.Ref {
    ...
    public class RefRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string chatId, string teamsAppInstallationId, FormatterType output, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
        ...
        public Command BuildPutCommand() {
            ...
            command.SetHandler(async (string chatId, string teamsAppInstallationId, string body, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
