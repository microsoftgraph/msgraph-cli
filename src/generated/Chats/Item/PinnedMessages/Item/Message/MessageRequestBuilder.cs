...
namespace ApiSdk.Chats.Item.PinnedMessages.Item.Message {
    ...
    public class MessageRequestBuilder : BaseCliRequestBuilder {
        ...
        public MessageRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/chats/{chat%2Did}/pinnedMessages/{pinnedChatMessageInfo%2Did}/message{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Represents details about the chat message that is pinned.
        /// </summary>
