...
using ApiSdk.Chats.Item.PermissionGrants.Delta;
using ApiSdk.Chats.Item.PermissionGrants.GetAvailableExtensionProperties;
using ApiSdk.Chats.Item.PermissionGrants.GetByIds;
using ApiSdk.Chats.Item.PermissionGrants.Item;
using ApiSdk.Chats.Item.PermissionGrants.ValidateProperties;
...
namespace ApiSdk.Chats.Item.PermissionGrants {
    ...
    public class PermissionGrantsRequestBuilder : BaseCliRequestBuilder {
        ...
        public Command BuildListCommand() {
            ...
            command.Description = "List all resource-specific permission grants on the chat. This list specifies the Azure AD apps that have access to the chat, along with the corresponding kind of resource-specific access that each app has.\n\nFind more info here:\n  https://learn.microsoft.com/graph/api/chat-list-permissiongrants?view=graph-rest-1.0";
            var chatIdOption = new Option<string>("--chat-id", description: "The unique identifier of chat") {
            };
            chatIdOption.IsRequired = true;
            command.AddOption(chatIdOption);
        ...
        public PermissionGrantsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/chats/{chat%2Did}/permissionGrants{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new PermissionGrantsRequestBuilder and sets the default values.
        /// </summary>
