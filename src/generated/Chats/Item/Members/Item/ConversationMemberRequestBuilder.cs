...
namespace ApiSdk.Chats.Item.Members.Item {
    ...
    public class ConversationMemberRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string chatId, string conversationMemberId, IConsole console) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string chatId, string conversationMemberId, string[] select, string[] expand, FormatterType output, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string chatId, string conversationMemberId, string body, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
