...
namespace ApiSdk.Chats.Item.Members.Item {
    ...
    public class ConversationMemberRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string chatId, string conversationMemberId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, chatIdOption, conversationMemberIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// A collection of all the members in the chat. Nullable.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string chatId, string conversationMemberId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, chatIdOption, conversationMemberIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// A collection of all the members in the chat. Nullable.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string chatId, string conversationMemberId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, chatIdOption, conversationMemberIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
