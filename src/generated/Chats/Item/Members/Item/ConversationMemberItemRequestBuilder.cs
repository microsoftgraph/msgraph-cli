...
namespace ApiSdk.Chats.Item.Members.Item {
    ...
    public class ConversationMemberItemRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(chatIdOption, conversationMemberIdOption, selectOption, expandOption, outputOption, outputFilterOption, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// A collection of all the members in the chat. Nullable.
