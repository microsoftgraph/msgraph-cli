...
namespace ApiSdk.Chats.Item.Messages {
    ...
    public class MessagesRequestBuilder {
        ...
        public Command BuildListCommand() {
            ...
            command.Handler = CommandHandler.Create<string, int?, int?, string, string, bool?, string[], string[], string[]>(async (chatId, top, skip, search, filter, count, orderby, select, expand) => {
