...
namespace ApiSdk.Chats.Item.Messages.Delta {
    ...
    public class DeltaRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string chatId, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, chatIdOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
