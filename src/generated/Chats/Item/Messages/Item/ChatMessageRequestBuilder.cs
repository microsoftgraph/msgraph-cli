...
namespace ApiSdk.Chats.Item.Messages.Item {
    ...
    public class ChatMessageRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string chatId, string chatMessageId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, chatIdOption, chatMessageIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// A collection of all the messages in the chat. Nullable.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string chatId, string chatMessageId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, chatIdOption, chatMessageIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string chatId, string chatMessageId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, chatIdOption, chatMessageIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
