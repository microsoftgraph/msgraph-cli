...
namespace ApiSdk.Chats.Item.Messages.Item {
    ...
    public class ChatMessageRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            }, chatIdOption, chatMessageIdOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// A collection of all the messages in the chat. Nullable.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string chatId, string chatMessageId, string[] select, string[] expand, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
            ...
            }, chatIdOption, chatMessageIdOption, selectOption, expandOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string chatId, string chatMessageId, string body, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                ...
                await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                console.WriteLine("Success");
            }, chatIdOption, chatMessageIdOption, bodyOption, new OutputFormatterFactoryBinder());
            return command;
        }
