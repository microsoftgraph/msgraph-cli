...
namespace ApiSdk.Chats.Item.Messages.Item.HostedContents.Item {
    ...
    public class ChatMessageHostedContentRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string chatId, string chatMessageId, string chatMessageHostedContentId) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string chatId, string chatMessageId, string chatMessageHostedContentId, string[] select, string[] expand) => {
            ...
            }, chatIdOption, chatMessageIdOption, chatMessageHostedContentIdOption, selectOption, expandOption);
            return command;
        }
        /// <summary>
        /// Content in a message hosted by Microsoft Teams - for example, images or code snippets.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string chatId, string chatMessageId, string chatMessageHostedContentId, string body) => {
