...
using ApiSdk.Chats.Item.Messages.Item.Replies.Item.MicrosoftGraphSoftDelete;
using ApiSdk.Chats.Item.Messages.Item.Replies.Item.MicrosoftGraphUndoSoftDelete;
using ApiSdk.Models;
...
namespace ApiSdk.Chats.Item.Messages.Item.Replies.Item {
    ...
    public class ChatMessageItemRequestBuilder {
        ...
        public ChatMessageItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/chats/{chat%2Did}/messages/{chatMessage%2Did}/replies/{chatMessage%2Did1}{?%24select,%24expand}";
