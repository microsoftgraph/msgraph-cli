...
using ApiSdk.Chats.Item.Messages.Item.Replies.MicrosoftGraphDelta;
using ApiSdk.Models;
...
namespace ApiSdk.Chats.Item.Messages.Item.Replies {
    ...
    public class RepliesRequestBuilder {
        ...
        public Command BuildCommand() {
            ...
            var builder = new ApiSdk.Chats.Item.Messages.Item.Replies.Item.ChatMessageItemRequestBuilder(PathParameters, RequestAdapter);
