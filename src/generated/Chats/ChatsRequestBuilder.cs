...
namespace ApiSdk.Chats {
    ...
    public class ChatsRequestBuilder : BaseCliRequestBuilder {
        ...
        public Command BuildCreateCommand() {
            ...
            command.Description = "Create a new chat object.\n\nFind more info here:\n  https://docs.microsoft.com/graph/api/chat-post?view=graph-rest-1.0";
        ...
        public ChatsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/chats{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Retrieve the list of chats that the user is part of. This method supports federation. When a user ID is provided, the calling application must belong to the same tenant that the user belongs to.
        /// </summary>
...
#nullable restore
        ...
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ChatsRequestBuilderGetQueryParameters>> requestConfiguration = default) {
            ...
            if (requestConfiguration != null) {
                var requestConfig = new RequestConfiguration<ChatsRequestBuilderGetQueryParameters>();
