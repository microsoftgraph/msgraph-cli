    ...
    public class GetAvailableExtensionPropertiesRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (string body) => {
                ...
                var result = await RequestAdapter.SendCollectionAsync<ApiSdk.DirectoryRoleTemplates.GetAvailableExtensionProperties.GetAvailableExtensionProperties>(requestInfo);
