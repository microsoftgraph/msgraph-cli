    ...
    public class GetAvailableExtensionPropertiesRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildPostCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.DirectoryRoleTemplates.GetAvailableExtensionProperties.GetAvailableExtensionPropertiesPostRequestBody>(ApiSdk.DirectoryRoleTemplates.GetAvailableExtensionProperties.GetAvailableExtensionPropertiesPostRequestBody.CreateFromDiscriminatorValue);
                if (model is null) {
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.DirectoryRoleTemplates.GetAvailableExtensionProperties.GetAvailableExtensionPropertiesRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public RequestInformation ToPostRequestInformation(ApiSdk.DirectoryRoleTemplates.GetAvailableExtensionProperties.GetAvailableExtensionPropertiesPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(ApiSdk.DirectoryRoleTemplates.GetAvailableExtensionProperties.GetAvailableExtensionPropertiesPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
