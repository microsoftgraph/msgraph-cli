...
namespace ApiSdk.DirectoryRoleTemplates.Item.CheckMemberGroups {
    ...
    public class CheckMemberGroupsRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            }, new CollectionBinding(directoryRoleTemplateIdOption, bodyOption, outputOption, outputFilterOption, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
