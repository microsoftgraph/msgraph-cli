...
namespace ApiSdk.DirectoryRoleTemplates.Item.Restore {
    ...
    public class RestoreRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            }, new CollectionBinding(directoryRoleTemplateIdOption, outputOption, outputFilterOption, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
