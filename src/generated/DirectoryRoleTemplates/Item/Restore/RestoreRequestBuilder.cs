...
namespace ApiSdk.DirectoryRoleTemplates.Item.Restore {
    ...
    public class RestoreRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (string directoryRoleTemplateId, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, directoryRoleTemplateIdOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
