...
namespace ApiSdk.DirectoryRoleTemplates.Item.Restore {
    ...
    public class RestoreRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (string directoryRoleTemplateId, FormatterType output, IOutputFormatterFactory outputFormatterFactory, CancellationToken cancellationToken) => {
                var requestInfo = CreatePostRequestInformation(q => {
                });
                var response = await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo, errorMapping: default, cancellationToken: cancellationToken);
                var formatter = outputFormatterFactory.GetFormatter(output);
                formatter.WriteOutput(response);
            }, directoryRoleTemplateIdOption, outputOption);
            return command;
        }
        /// <summary>
