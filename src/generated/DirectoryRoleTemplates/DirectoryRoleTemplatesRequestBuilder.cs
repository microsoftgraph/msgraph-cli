...
using ApiSdk.DirectoryRoleTemplates.MicrosoftGraphGetAvailableExtensionProperties;
using ApiSdk.DirectoryRoleTemplates.MicrosoftGraphGetByIds;
using ApiSdk.DirectoryRoleTemplates.MicrosoftGraphValidateProperties;
using ApiSdk.Models;
