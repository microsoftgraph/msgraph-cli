...
namespace ApiSdk.DirectoryRoleTemplates {
    ...
    public class DirectoryRoleTemplatesRequestBuilder {
        ...
        public List<Command> BuildCommand() {
            var builder = new DirectoryRoleTemplateRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildGetAvailableExtensionPropertiesCommand() {
            ...
            var builder = new ApiSdk.DirectoryRoleTemplates.GetAvailableExtensionProperties.GetAvailableExtensionPropertiesRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildPostCommand());
            return command;
        }
        public Command BuildGetByIdsCommand() {
            var command = new Command("get-by-ids");
            var builder = new ApiSdk.DirectoryRoleTemplates.GetByIds.GetByIdsRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildPostCommand());
            return command;
        }
        /// <summary>
        ...
        public Command BuildListCommand() {
            ...
            command.Description = "Get entities from directoryRoleTemplates";
            // Create options for all the parameters
            ...
            command.Handler = CommandHandler.Create<int?, string, string, bool?, string[], string[], string[]>(async (skip, search, filter, count, orderby, select, expand) => {
                ...
                var result = await RequestAdapter.SendAsync<DirectoryRoleTemplatesResponse>(requestInfo);
                // Print request output. What if the request has no return?
                using var serializer = RequestAdapter.SerializationWriterFactory.GetSerializationWriter("application/json");
                serializer.WriteObjectValue(null, result);
                using var content = serializer.GetSerializedContent();
        ...
        public Command BuildValidatePropertiesCommand() {
            ...
            var builder = new ApiSdk.DirectoryRoleTemplates.ValidateProperties.ValidatePropertiesRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildPostCommand());
            return command;
        }
        /// <summary>
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<DirectoryRoleTemplate> PostAsync(DirectoryRoleTemplate model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
