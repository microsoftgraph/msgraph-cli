...
namespace ApiSdk.Workbooks.Item.ListItem.Versions.Item {
    ...
    public class ListItemVersionRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string driveItemId, string listItemVersionId, IConsole console) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string driveItemId, string listItemVersionId, string[] select, string[] expand, FormatterType output, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string driveItemId, string listItemVersionId, string body, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
