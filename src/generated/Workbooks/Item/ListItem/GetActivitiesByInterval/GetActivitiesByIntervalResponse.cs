...
namespace ApiSdk.Workbooks.Item.ListItem.GetActivitiesByInterval {
    ...
    public class GetActivitiesByIntervalResponse : IAdditionalDataHolder, IParsable {
        ...
        /// </summary>
        public static ApiSdk.Workbooks.Item.ListItem.GetActivitiesByInterval.GetActivitiesByIntervalResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
