...
namespace ApiSdk.Workbooks.Item.ListItem.GetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithInterval {
    ...
    public class GetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithIntervalRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string driveItemId, string startDateTime, string endDateTime, string interval, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, driveItemIdOption, startDateTimeOption, endDateTimeOption, intervalOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
