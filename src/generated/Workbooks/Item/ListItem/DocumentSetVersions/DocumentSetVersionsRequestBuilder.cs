...
using ApiSdk.Workbooks.Item.ListItem.DocumentSetVersions.Count;
using ApiSdk.Workbooks.Item.ListItem.DocumentSetVersions.Item;
...
namespace ApiSdk.Workbooks.Item.ListItem.DocumentSetVersions {
    ...
    public class DocumentSetVersionsRequestBuilder {
        ...
        public Command BuildCreateCommand() {
            ...
            command.Description = "Create new navigation property to documentSetVersions for workbooks";
