...
namespace ApiSdk.Workbooks.Item.DeltaWithToken {
    ...
    public class DeltaWithTokenRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string driveItemId, string token, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, driveItemIdOption, tokenOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
