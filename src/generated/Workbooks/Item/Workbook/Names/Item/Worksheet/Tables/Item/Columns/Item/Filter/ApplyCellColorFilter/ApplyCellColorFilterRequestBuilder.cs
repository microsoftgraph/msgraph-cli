...
namespace ApiSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.Tables.Item.Columns.Item.Filter.ApplyCellColorFilter {
    ...
    public class ApplyCellColorFilterRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(ApplyCellColorFilterRequestBody model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
