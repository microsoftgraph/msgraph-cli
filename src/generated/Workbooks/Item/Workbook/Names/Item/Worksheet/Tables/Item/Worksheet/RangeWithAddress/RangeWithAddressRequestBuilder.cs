...
namespace ApiSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.Tables.Item.Worksheet.RangeWithAddress {
    ...
    public class RangeWithAddressRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string driveItemId, string workbookNamedItemId, string workbookTableId, string address) => {
            ...
            }, driveItemIdOption, workbookNamedItemIdOption, workbookTableIdOption, addressOption);
            return command;
        }
        /// <summary>
