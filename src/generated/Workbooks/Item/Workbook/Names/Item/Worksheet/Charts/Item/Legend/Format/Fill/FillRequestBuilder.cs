...
namespace ApiSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.Charts.Item.Legend.Format.Fill {
    ...
    public class FillRequestBuilder {
        ...
        public Command BuildClearCommand() {
            ...
            var builder = new ApiSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.Charts.Item.Legend.Format.Fill.Clear.ClearRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildSetSolidColorCommand() {
            ...
            var builder = new ApiSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.Charts.Item.Legend.Format.Fill.SetSolidColor.SetSolidColorRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildPostCommand());
            return command;
        }
        /// <summary>
