...
namespace ApiSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.Charts.ItemWithName {
    ...
    public class ItemWithNameRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string driveItemId, string workbookNamedItemId, string name, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, driveItemIdOption, workbookNamedItemIdOption, nameOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
