...
namespace ApiSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.Tables.Item.Columns.Item.Filter.ApplyTopPercentFilter {
    ...
    public class ApplyTopPercentFilterRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(ApplyTopPercentFilterRequestBody model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
