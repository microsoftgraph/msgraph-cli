...
namespace ApiSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.Tables.Item.Rows.Item {
    ...
    public class WorkbookTableRowRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string, string, string[], string[]>(async (driveItemId, workbookNamedItemId, workbookTableId, workbookTableRowId, select, expand) => {
