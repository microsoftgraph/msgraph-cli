...
namespace ApiSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.Charts.Item.Image {
    ...
    public class ImageRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(driveItemIdOption, workbookNamedItemIdOption, workbookChartIdOption, outputOption, queryOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
