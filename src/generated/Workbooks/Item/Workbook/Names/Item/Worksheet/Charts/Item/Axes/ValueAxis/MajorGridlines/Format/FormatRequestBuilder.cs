...
namespace ApiSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.Charts.Item.Axes.ValueAxis.MajorGridlines.Format {
    ...
    public class FormatRequestBuilder {
        ...
        public Command BuildLineCommand() {
            ...
            var builder = new ApiSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.Charts.Item.Axes.ValueAxis.MajorGridlines.Format.Line.LineRequestBuilder(PathParameters, RequestAdapter);
