...
namespace ApiSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.Tables.Item.Worksheet.UsedRangeWithValuesOnly {
    ...
    public class UsedRangeWithValuesOnlyRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string driveItemId, string workbookNamedItemId, string workbookTableId, bool? valuesOnly) => {
            ...
            }, driveItemIdOption, workbookNamedItemIdOption, workbookTableIdOption, valuesOnlyOption);
            return command;
        }
        /// <summary>
