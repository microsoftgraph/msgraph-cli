...
namespace ApiSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.Charts.Item.Series {
    ...
    public class SeriesRequestBuilder {
        ...
        public Command BuildListCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string, int?, int?, string, string, bool?, string[], string[], string[]>(async (driveItemId, workbookNamedItemId, workbookChartId, top, skip, search, filter, count, orderby, select, expand) => {
