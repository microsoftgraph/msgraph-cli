...
namespace ApiSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.Charts.Item.Worksheet.UsedRangeWithValuesOnly {
    ...
    public class UsedRangeWithValuesOnlyRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string driveItemId, string workbookNamedItemId, string workbookChartId, bool? valuesOnly) => {
            ...
            }, driveItemIdOption, workbookNamedItemIdOption, workbookChartIdOption, valuesOnlyOption);
            return command;
        }
        /// <summary>
