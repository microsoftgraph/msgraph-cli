...
namespace ApiSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.Tables.Item.Columns {
    ...
    public class ColumnsRequestBuilder {
        ...
        public Command BuildListCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string, int?, int?, string, string, bool?, string[], string[], string[]>(async (driveItemId, workbookNamedItemId, workbookTableId, top, skip, search, filter, count, orderby, select, expand) => {
