...
namespace ApiSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.Names.Item {
    ...
    public class WorkbookNamedItemItemRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(driveItemIdOption, workbookNamedItemIdOption, workbookNamedItemId1Option, selectOption, expandOption, outputOption, outputFilterOption, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// Returns collection of names that are associated with the worksheet. Read-only.
