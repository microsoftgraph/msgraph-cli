...
namespace ApiSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.Charts.Item.Series.Item {
    ...
    public class WorkbookChartSeriesRequestBuilder {
        ...
        public Command BuildFormatCommand() {
            ...
            var builder = new ApiSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.Charts.Item.Series.Item.Format.FormatRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildPointsCommand() {
            ...
            var builder = new ApiSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.Charts.Item.Series.Item.Points.PointsRequestBuilder(PathParameters, RequestAdapter);
