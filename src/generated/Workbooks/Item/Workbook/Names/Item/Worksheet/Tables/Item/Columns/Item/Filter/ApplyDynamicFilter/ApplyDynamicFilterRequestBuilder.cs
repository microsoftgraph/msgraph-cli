...
namespace ApiSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.Tables.Item.Columns.Item.Filter.ApplyDynamicFilter {
    ...
    public class ApplyDynamicFilterRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(ApplyDynamicFilterRequestBody model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
