...
namespace ApiSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.RangeWithAddress {
    ...
    public class RangeWithAddressRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string driveItemId, string workbookNamedItemId, string address, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                var requestInfo = CreateGetRequestInformation(q => {
                });
                var response = await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                var formatter = outputFormatterFactory.GetFormatter(output);
                formatter.WriteOutput(response, console);
            }, driveItemIdOption, workbookNamedItemIdOption, addressOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
