...
namespace ApiSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.Tables.Item.Columns.Item.Filter.ApplyCustomFilter {
    ...
    public class ApplyCustomFilterRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(ApplyCustomFilterRequestBody model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
