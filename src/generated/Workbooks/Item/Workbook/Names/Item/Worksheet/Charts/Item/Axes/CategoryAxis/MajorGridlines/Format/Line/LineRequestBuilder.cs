...
namespace ApiSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.Charts.Item.Axes.CategoryAxis.MajorGridlines.Format.Line {
    ...
    public class LineRequestBuilder {
        ...
        public Command BuildClearCommand() {
            ...
            var builder = new ApiSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.Charts.Item.Axes.CategoryAxis.MajorGridlines.Format.Line.Clear.ClearRequestBuilder(PathParameters, RequestAdapter);
