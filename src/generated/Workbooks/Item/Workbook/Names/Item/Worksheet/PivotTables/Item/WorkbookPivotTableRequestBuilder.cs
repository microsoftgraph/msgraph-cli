...
namespace ApiSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.PivotTables.Item {
    ...
    public class WorkbookPivotTableRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string driveItemId, string workbookNamedItemId, string workbookPivotTableId) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string driveItemId, string workbookNamedItemId, string workbookPivotTableId, string[] select, string[] expand) => {
            ...
            }, driveItemIdOption, workbookNamedItemIdOption, workbookPivotTableIdOption, selectOption, expandOption);
            return command;
        }
        /// <summary>
        /// Collection of PivotTables that are part of the worksheet.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string driveItemId, string workbookNamedItemId, string workbookPivotTableId, string body) => {
