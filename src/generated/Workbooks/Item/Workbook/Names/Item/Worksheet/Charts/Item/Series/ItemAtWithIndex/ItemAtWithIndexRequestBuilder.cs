...
namespace ApiSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.Charts.Item.Series.ItemAtWithIndex {
    ...
    public class ItemAtWithIndexRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(driveItemIdOption, workbookNamedItemIdOption, workbookChartIdOption, indexOption, outputOption, queryOption, jsonNoIndentOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        ...
        public class ItemAtWithIndexResponse : IAdditionalDataHolder, IParsable {
            ...
            public ApiSdk.Models.Microsoft.Graph.WorkbookChartSeries WorkbookChartSeries { get; set; }
            /// <summary>
            ...
            public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
                return new Dictionary<string, Action<T, IParseNode>> {
                    {"workbookChartSeries", (o,n) => { (o as ItemAtWithIndexResponse).WorkbookChartSeries = n.GetObjectValue<ApiSdk.Models.Microsoft.Graph.WorkbookChartSeries>(ApiSdk.Models.Microsoft.Graph.WorkbookChartSeries.CreateFromDiscriminatorValue); } },
                };
            }
            /// <summary>
            ...
            public void Serialize(ISerializationWriter writer) {
                ...
                writer.WriteObjectValue<ApiSdk.Models.Microsoft.Graph.WorkbookChartSeries>("workbookChartSeries", WorkbookChartSeries);
