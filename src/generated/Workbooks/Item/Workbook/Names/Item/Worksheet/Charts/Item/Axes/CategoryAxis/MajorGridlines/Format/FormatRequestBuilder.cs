...
namespace ApiSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.Charts.Item.Axes.CategoryAxis.MajorGridlines.Format {
    ...
    public class FormatRequestBuilder {
        ...
        public Command BuildLineCommand() {
            ...
            var builder = new ApiSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.Charts.Item.Axes.CategoryAxis.MajorGridlines.Format.Line.LineRequestBuilder(PathParameters, RequestAdapter);
