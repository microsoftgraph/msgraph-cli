...
namespace ApiSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.Protection {
    ...
    public class ProtectionRequestBuilder {
        ...
        public Command BuildProtectCommand() {
            ...
            var builder = new ApiSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.Protection.Protect.ProtectRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildPostCommand());
            return command;
        }
        public Command BuildUnprotectCommand() {
            var command = new Command("unprotect");
            var builder = new ApiSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.Protection.Unprotect.UnprotectRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildPostCommand());
            return command;
        }
        /// <summary>
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(WorkbookWorksheetProtection model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
