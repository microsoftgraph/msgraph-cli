...
namespace ApiSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.Tables.Item.Columns.Item.Filter.ApplyIconFilter {
    ...
    public class ApplyIconFilterRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(ApplyIconFilterRequestBody model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
