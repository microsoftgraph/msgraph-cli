...
namespace ApiSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.Tables.Count {
    ...
    public class CountRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string driveItemId, string workbookNamedItemId, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, driveItemIdOption, workbookNamedItemIdOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
