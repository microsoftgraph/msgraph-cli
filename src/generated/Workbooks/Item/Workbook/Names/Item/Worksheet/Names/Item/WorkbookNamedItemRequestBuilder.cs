...
namespace ApiSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.Names.Item {
    ...
    public class WorkbookNamedItemRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string, object, object>(async (driveItemId, workbookNamedItemId, workbookNamedItemId1, select, expand) => {
        ...
        public Command BuildPatchCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string, string>(async (driveItemId, workbookNamedItemId, workbookNamedItemId1, body) => {
