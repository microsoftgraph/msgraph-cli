...
namespace ApiSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.Charts.Item.Worksheet.CellWithRowWithColumn {
    ...
    public class CellWithRowWithColumnRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(driveItemIdOption, workbookNamedItemIdOption, workbookChartIdOption, rowOption, columnOption, outputOption, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
