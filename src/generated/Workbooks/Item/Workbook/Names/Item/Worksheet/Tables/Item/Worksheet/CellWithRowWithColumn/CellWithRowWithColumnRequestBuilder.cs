...
namespace ApiSdk.Workbooks.Item.Workbook.Names.Item.Worksheet.Tables.Item.Worksheet.CellWithRowWithColumn {
    ...
    public class CellWithRowWithColumnRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string driveItemId, string workbookNamedItemId, string workbookTableId, int? row, int? column) => {
            ...
            }, driveItemIdOption, workbookNamedItemIdOption, workbookTableIdOption, rowOption, columnOption);
            return command;
        }
        /// <summary>
