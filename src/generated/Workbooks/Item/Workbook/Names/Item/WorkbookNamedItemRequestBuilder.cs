...
namespace ApiSdk.Workbooks.Item.Workbook.Names.Item {
    ...
    public class WorkbookNamedItemRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string driveItemId, string workbookNamedItemId, string[] select, string[] expand, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string driveItemId, string workbookNamedItemId, string body, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
