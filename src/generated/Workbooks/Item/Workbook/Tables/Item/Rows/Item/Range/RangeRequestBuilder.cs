...
namespace ApiSdk.Workbooks.Item.Workbook.Tables.Item.Rows.Item.Range {
    ...
    public class RangeRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string driveItemId, string workbookTableId, string workbookTableRowId, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, driveItemIdOption, workbookTableIdOption, workbookTableRowIdOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
