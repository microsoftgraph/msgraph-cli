...
namespace ApiSdk.Workbooks.Item.Workbook.Tables.Item.Worksheet.Charts.Item.Axes.CategoryAxis.MinorGridlines.Format {
    ...
    public class FormatRequestBuilder {
        ...
        public Command BuildLineCommand() {
            ...
            var builder = new ApiSdk.Workbooks.Item.Workbook.Tables.Item.Worksheet.Charts.Item.Axes.CategoryAxis.MinorGridlines.Format.Line.LineRequestBuilder(PathParameters, RequestAdapter);
