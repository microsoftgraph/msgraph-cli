...
namespace ApiSdk.Workbooks.Item.Workbook.Tables.Item.Worksheet.PivotTables.Item.Worksheet.RangeWithAddress {
    ...
    public class RangeWithAddressRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string driveItemId, string workbookTableId, string workbookPivotTableId, string address, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, driveItemIdOption, workbookTableIdOption, workbookPivotTableIdOption, addressOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
