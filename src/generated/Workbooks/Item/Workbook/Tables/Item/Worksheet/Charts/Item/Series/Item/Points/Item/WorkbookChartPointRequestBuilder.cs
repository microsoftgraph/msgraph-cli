...
namespace ApiSdk.Workbooks.Item.Workbook.Tables.Item.Worksheet.Charts.Item.Series.Item.Points.Item {
    ...
    public class WorkbookChartPointRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string, string, string>(async (driveItemId, workbookTableId, workbookChartId, workbookChartSeriesId, workbookChartPointId) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string, string, string, object, object>(async (driveItemId, workbookTableId, workbookChartId, workbookChartSeriesId, workbookChartPointId, select, expand) => {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(WorkbookChartPoint model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
