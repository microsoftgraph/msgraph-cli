...
namespace ApiSdk.Workbooks.Item.Workbook.Tables.Item.Worksheet.Charts.Item.Axes.CategoryAxis.Format {
    ...
    public class FormatRequestBuilder {
        ...
        public Command BuildFontCommand() {
            ...
            var builder = new ApiSdk.Workbooks.Item.Workbook.Tables.Item.Worksheet.Charts.Item.Axes.CategoryAxis.Format.Font.FontRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildLineCommand() {
            ...
            var builder = new ApiSdk.Workbooks.Item.Workbook.Tables.Item.Worksheet.Charts.Item.Axes.CategoryAxis.Format.Line.LineRequestBuilder(PathParameters, RequestAdapter);
