        ...
        public class ItemAtWithIndexResponse : IAdditionalDataHolder, IParsable {
            ...
            public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
                return new Dictionary<string, Action<T, IParseNode>> {
                    {"workbookChart", (o,n) => { (o as ItemAtWithIndexResponse).WorkbookChart = n.GetObjectValue<ApiSdk.Models.Microsoft.Graph.WorkbookChart>(ApiSdk.Models.Microsoft.Graph.WorkbookChart.CreateFromDiscriminatorValue); } },
                };
            }
            /// <summary>
