...
namespace ApiSdk.Workbooks.Item.Workbook.Tables.Item.Worksheet.Charts.Item.Axes.SeriesAxis.MinorGridlines.Format.Line {
    ...
    public class LineRequestBuilder {
        ...
        public Command BuildClearCommand() {
            ...
            var builder = new ApiSdk.Workbooks.Item.Workbook.Tables.Item.Worksheet.Charts.Item.Axes.SeriesAxis.MinorGridlines.Format.Line.Clear.ClearRequestBuilder(PathParameters, RequestAdapter);
