...
namespace ApiSdk.Workbooks.Item.Workbook.Tables.Item.Worksheet.Charts.Item.Axes.CategoryAxis.MajorGridlines.Format {
    ...
    public class FormatRequestBuilder {
        ...
        public Command BuildLineCommand() {
            ...
            var builder = new ApiSdk.Workbooks.Item.Workbook.Tables.Item.Worksheet.Charts.Item.Axes.CategoryAxis.MajorGridlines.Format.Line.LineRequestBuilder(PathParameters, RequestAdapter);
