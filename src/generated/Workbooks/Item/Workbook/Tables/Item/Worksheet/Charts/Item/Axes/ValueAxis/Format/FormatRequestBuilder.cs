...
namespace ApiSdk.Workbooks.Item.Workbook.Tables.Item.Worksheet.Charts.Item.Axes.ValueAxis.Format {
    ...
    public class FormatRequestBuilder {
        ...
        public Command BuildFontCommand() {
            ...
            var builder = new ApiSdk.Workbooks.Item.Workbook.Tables.Item.Worksheet.Charts.Item.Axes.ValueAxis.Format.Font.FontRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildLineCommand() {
            ...
            var builder = new ApiSdk.Workbooks.Item.Workbook.Tables.Item.Worksheet.Charts.Item.Axes.ValueAxis.Format.Line.LineRequestBuilder(PathParameters, RequestAdapter);
