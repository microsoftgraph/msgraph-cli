...
namespace ApiSdk.Workbooks.Item.Workbook.Tables.Item.Worksheet.RangeWithAddress {
    ...
    public class RangeWithAddressRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string driveItemId, string workbookTableId, string address, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, driveItemIdOption, workbookTableIdOption, addressOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
