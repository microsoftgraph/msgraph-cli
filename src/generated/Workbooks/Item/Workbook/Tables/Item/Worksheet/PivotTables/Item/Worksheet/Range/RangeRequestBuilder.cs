...
namespace ApiSdk.Workbooks.Item.Workbook.Tables.Item.Worksheet.PivotTables.Item.Worksheet.Range {
    ...
    public class RangeRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(driveItemIdOption, workbookTableIdOption, workbookPivotTableIdOption, outputOption, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
