...
namespace ApiSdk.Workbooks.Item.Workbook.Tables.Item.Worksheet.Charts.Item.Series.Item.Format.Fill {
    ...
    public class FillRequestBuilder {
        ...
        public Command BuildClearCommand() {
            ...
            var builder = new ApiSdk.Workbooks.Item.Workbook.Tables.Item.Worksheet.Charts.Item.Series.Item.Format.Fill.Clear.ClearRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildSetSolidColorCommand() {
            ...
            var builder = new ApiSdk.Workbooks.Item.Workbook.Tables.Item.Worksheet.Charts.Item.Series.Item.Format.Fill.SetSolidColor.SetSolidColorRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildPostCommand());
            return command;
        }
        /// <summary>
