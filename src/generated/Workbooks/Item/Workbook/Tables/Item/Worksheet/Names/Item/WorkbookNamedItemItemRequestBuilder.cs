...
namespace ApiSdk.Workbooks.Item.Workbook.Tables.Item.Worksheet.Names.Item {
    ...
    public class WorkbookNamedItemItemRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(driveItemIdOption, workbookTableIdOption, workbookNamedItemIdOption, selectOption, expandOption, outputOption, outputFilterOption, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// Returns collection of names that are associated with the worksheet. Read-only.
