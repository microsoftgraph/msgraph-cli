...
namespace ApiSdk.Workbooks.Item.Workbook.Tables.Item.Worksheet.Charts.Item.Series.Item.Points {
    ...
    public class PointsRequestBuilder {
        ...
        public Command BuildListCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string, string, int?, int?, string, string, bool?, string[], string[], string[]>(async (driveItemId, workbookTableId, workbookChartId, workbookChartSeriesId, top, skip, search, filter, count, orderby, select, expand) => {
