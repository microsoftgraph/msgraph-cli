...
namespace ApiSdk.Workbooks.Item.Workbook.Tables.Item {
    ...
    public class WorkbookTableRequestBuilder {
        ...
        public Command BuildClearFiltersCommand() {
            ...
            var builder = new ApiSdk.Workbooks.Item.Workbook.Tables.Item.ClearFilters.ClearFiltersRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildConvertToRangeCommand() {
            ...
            var builder = new ApiSdk.Workbooks.Item.Workbook.Tables.Item.ConvertToRange.ConvertToRangeRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildPostCommand());
            return command;
        }
        /// <summary>
        ...
        public Command BuildReapplyFiltersCommand() {
            ...
            var builder = new ApiSdk.Workbooks.Item.Workbook.Tables.Item.ReapplyFilters.ReapplyFiltersRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildPostCommand());
            return command;
        }
