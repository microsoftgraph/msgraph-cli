...
namespace ApiSdk.Workbooks.Item.Workbook.Tables.Item.Columns.Item.Filter.ApplyBottomItemsFilter {
    ...
    public class ApplyBottomItemsFilterRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(ApplyBottomItemsFilterRequestBody model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
