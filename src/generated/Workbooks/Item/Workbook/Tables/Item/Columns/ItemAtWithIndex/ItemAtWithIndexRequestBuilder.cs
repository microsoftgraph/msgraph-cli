...
namespace ApiSdk.Workbooks.Item.Workbook.Tables.Item.Columns.ItemAtWithIndex {
    ...
    public class ItemAtWithIndexRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(driveItemIdOption, workbookTableIdOption, indexOption, outputOption, queryOption, jsonNoIndentOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        ...
        public class ItemAtWithIndexResponse : IAdditionalDataHolder, IParsable {
            ...
            public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
                return new Dictionary<string, Action<T, IParseNode>> {
                    {"workbookTableColumn", (o,n) => { (o as ItemAtWithIndexResponse).WorkbookTableColumn = n.GetObjectValue<ApiSdk.Models.Microsoft.Graph.WorkbookTableColumn>(ApiSdk.Models.Microsoft.Graph.WorkbookTableColumn.CreateFromDiscriminatorValue); } },
                };
            }
            /// <summary>
