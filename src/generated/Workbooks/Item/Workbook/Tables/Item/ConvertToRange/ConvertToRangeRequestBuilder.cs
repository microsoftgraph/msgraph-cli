...
namespace ApiSdk.Workbooks.Item.Workbook.Tables.Item.ConvertToRange {
    ...
    public class ConvertToRangeRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (string driveItemId, string workbookTableId, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, driveItemIdOption, workbookTableIdOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
