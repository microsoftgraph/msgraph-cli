...
namespace ApiSdk.Workbooks.Item.Workbook.Tables.Item.ConvertToRange {
    ...
    public class ConvertToRangeRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            }, new CollectionBinding(driveItemIdOption, workbookTableIdOption, outputOption, queryOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
