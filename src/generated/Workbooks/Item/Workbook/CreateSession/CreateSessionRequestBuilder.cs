...
namespace ApiSdk.Workbooks.Item.Workbook.CreateSession {
    ...
    public class CreateSessionRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.Description = "Invoke action createSession";
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                var model = parseNode.GetObjectValue<CreateSessionRequestBody>(CreateSessionRequestBody.CreateFromDiscriminatorValue);
        ...
        public class CreateSessionResponse : IAdditionalDataHolder, IParsable {
            ...
            public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
                return new Dictionary<string, Action<T, IParseNode>> {
                    {"workbookSessionInfo", (o,n) => { (o as CreateSessionResponse).WorkbookSessionInfo = n.GetObjectValue<ApiSdk.Models.Microsoft.Graph.WorkbookSessionInfo>(ApiSdk.Models.Microsoft.Graph.WorkbookSessionInfo.CreateFromDiscriminatorValue); } },
                };
            }
            /// <summary>
