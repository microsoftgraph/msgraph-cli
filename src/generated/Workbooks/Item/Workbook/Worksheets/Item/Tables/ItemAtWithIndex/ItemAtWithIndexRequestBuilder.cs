...
namespace ApiSdk.Workbooks.Item.Workbook.Worksheets.Item.Tables.ItemAtWithIndex {
    ...
    public class ItemAtWithIndexRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(driveItemIdOption, workbookWorksheetIdOption, indexOption, outputOption, queryOption, jsonNoIndentOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        ...
        public class ItemAtWithIndexResponse : IAdditionalDataHolder, IParsable {
            ...
            public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
                return new Dictionary<string, Action<T, IParseNode>> {
                    {"workbookTable", (o,n) => { (o as ItemAtWithIndexResponse).WorkbookTable = n.GetObjectValue<ApiSdk.Models.Microsoft.Graph.WorkbookTable>(ApiSdk.Models.Microsoft.Graph.WorkbookTable.CreateFromDiscriminatorValue); } },
                };
            }
            /// <summary>
