...
namespace ApiSdk.Workbooks.Item.Workbook.Worksheets.Item.Tables.Item.Rows.ItemAtWithIndex {
    ...
    public class ItemAtWithIndexRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string driveItemId, string workbookWorksheetId, string workbookTableId, int? index) => {
            ...
            }, driveItemIdOption, workbookWorksheetIdOption, workbookTableIdOption, indexOption);
            return command;
        }
        /// <summary>
