...
namespace ApiSdk.Workbooks.Item.Workbook.Worksheets.Item.Tables.Item.Rows.Item.Range {
    ...
    public class RangeRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string driveItemId, string workbookWorksheetId, string workbookTableId, string workbookTableRowId, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, driveItemIdOption, workbookWorksheetIdOption, workbookTableIdOption, workbookTableRowIdOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
