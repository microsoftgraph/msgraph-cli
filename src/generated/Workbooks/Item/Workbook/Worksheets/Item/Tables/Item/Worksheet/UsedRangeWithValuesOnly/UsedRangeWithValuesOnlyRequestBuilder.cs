...
namespace ApiSdk.Workbooks.Item.Workbook.Worksheets.Item.Tables.Item.Worksheet.UsedRangeWithValuesOnly {
    ...
    public class UsedRangeWithValuesOnlyRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string driveItemId, string workbookWorksheetId, string workbookTableId, bool? valuesOnly) => {
            ...
            }, driveItemIdOption, workbookWorksheetIdOption, workbookTableIdOption, valuesOnlyOption);
            return command;
        }
        /// <summary>
