...
namespace ApiSdk.Workbooks.Item.Workbook.Worksheets.Item.Tables.Item.Rows.Item {
    ...
    public class WorkbookTableRowRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string driveItemId, string workbookWorksheetId, string workbookTableId, string workbookTableRowId, string[] select, string[] expand) => {
            ...
            }, driveItemIdOption, workbookWorksheetIdOption, workbookTableIdOption, workbookTableRowIdOption, selectOption, expandOption);
            return command;
        }
        /// <summary>
        /// Represents a collection of all the rows in the table. Read-only.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string driveItemId, string workbookWorksheetId, string workbookTableId, string workbookTableRowId, string body) => {
