...
namespace ApiSdk.Workbooks.Item.Workbook.Worksheets.Item.Tables.Item.Columns.Item.Filter.ApplyValuesFilter {
    ...
    public class ApplyValuesFilterRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(ApplyValuesFilterRequestBody model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
