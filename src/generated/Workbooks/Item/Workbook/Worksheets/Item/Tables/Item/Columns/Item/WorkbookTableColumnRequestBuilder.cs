...
namespace ApiSdk.Workbooks.Item.Workbook.Worksheets.Item.Tables.Item.Columns.Item {
    ...
    public class WorkbookTableColumnRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string, string, string[], string[]>(async (driveItemId, workbookWorksheetId, workbookTableId, workbookTableColumnId, select, expand) => {
