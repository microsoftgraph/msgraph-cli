...
namespace ApiSdk.Workbooks.Item.Workbook.Worksheets.Item.Charts.Item.Series {
    ...
    public class SeriesRequestBuilder {
        ...
        public Command BuildListCommand() {
            ...
            command.SetHandler(async (string driveItemId, string workbookWorksheetId, string workbookChartId, int? top, int? skip, string search, string filter, bool? count, string[] orderby, string[] select, string[] expand) => {
                ...
                var strContent = await reader.ReadToEndAsync();
                Console.Write(strContent + "\n");
            }, driveItemIdOption, workbookWorksheetIdOption, workbookChartIdOption, topOption, skipOption, searchOption, filterOption, countOption, orderbyOption, selectOption, expandOption);
            return command;
        }
        /// <summary>
