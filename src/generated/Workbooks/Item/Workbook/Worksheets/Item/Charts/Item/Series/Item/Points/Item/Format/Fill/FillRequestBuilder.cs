...
namespace ApiSdk.Workbooks.Item.Workbook.Worksheets.Item.Charts.Item.Series.Item.Points.Item.Format.Fill {
    ...
    public class FillRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            }, driveItemIdOption, workbookWorksheetIdOption, workbookChartIdOption, workbookChartSeriesIdOption, workbookChartPointIdOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// Represents the fill format of a chart, which includes background formating information. Read-only.
        ...
        public Command BuildGetCommand() {
            ...
            }, driveItemIdOption, workbookWorksheetIdOption, workbookChartIdOption, workbookChartSeriesIdOption, workbookChartPointIdOption, selectOption, expandOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// Represents the fill format of a chart, which includes background formating information. Read-only.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string driveItemId, string workbookWorksheetId, string workbookChartId, string workbookChartSeriesId, string workbookChartPointId, string body, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                ...
                await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                console.WriteLine("Success");
            }, driveItemIdOption, workbookWorksheetIdOption, workbookChartIdOption, workbookChartSeriesIdOption, workbookChartPointIdOption, bodyOption, new OutputFormatterFactoryBinder());
            return command;
        }
