...
namespace ApiSdk.Workbooks.Item.Workbook.Worksheets.Item.Charts.Item.Axes.ValueAxis.Title.Format {
    ...
    public class FormatRequestBuilder {
        ...
        public Command BuildFontCommand() {
            ...
            var builder = new ApiSdk.Workbooks.Item.Workbook.Worksheets.Item.Charts.Item.Axes.ValueAxis.Title.Format.Font.FontRequestBuilder(PathParameters, RequestAdapter);
