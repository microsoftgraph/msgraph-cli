...
namespace ApiSdk.Workbooks.Item.Workbook.Worksheets.Item.Charts.Item.Legend.Format {
    ...
    public class FormatRequestBuilder {
        ...
        public Command BuildFillCommand() {
            ...
            var builder = new ApiSdk.Workbooks.Item.Workbook.Worksheets.Item.Charts.Item.Legend.Format.Fill.FillRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildFontCommand() {
            ...
            var builder = new ApiSdk.Workbooks.Item.Workbook.Worksheets.Item.Charts.Item.Legend.Format.Font.FontRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildDeleteCommand());
            command.AddCommand(builder.BuildGetCommand());
            command.AddCommand(builder.BuildPatchCommand());
            return command;
