...
namespace ApiSdk.Workbooks.Item.Workbook.Worksheets.Item.Charts.Item.Series.ItemAtWithIndex {
    ...
    public class ItemAtWithIndexRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string driveItemId, string workbookWorksheetId, string workbookChartId, int? index, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                var requestInfo = CreateGetRequestInformation(q => {
                });
                var response = await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                var formatter = outputFormatterFactory.GetFormatter(output);
                formatter.WriteOutput(response, console);
            }, driveItemIdOption, workbookWorksheetIdOption, workbookChartIdOption, indexOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
