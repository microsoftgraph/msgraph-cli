...
namespace ApiSdk.Workbooks.Item.Workbook.Worksheets.Item.Charts.Item.Axes.SeriesAxis {
    ...
    public class SeriesAxisRequestBuilder {
        ...
        public Command BuildFormatCommand() {
            ...
            var builder = new ApiSdk.Workbooks.Item.Workbook.Worksheets.Item.Charts.Item.Axes.SeriesAxis.Format.FormatRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildMajorGridlinesCommand() {
            ...
            var builder = new ApiSdk.Workbooks.Item.Workbook.Worksheets.Item.Charts.Item.Axes.SeriesAxis.MajorGridlines.MajorGridlinesRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildDeleteCommand());
        ...
        public Command BuildMinorGridlinesCommand() {
            ...
            var builder = new ApiSdk.Workbooks.Item.Workbook.Worksheets.Item.Charts.Item.Axes.SeriesAxis.MinorGridlines.MinorGridlinesRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildDeleteCommand());
            command.AddCommand(builder.BuildFormatCommand());
            command.AddCommand(builder.BuildGetCommand());
            command.AddCommand(builder.BuildPatchCommand());
        ...
        public Command BuildTitleCommand() {
            ...
            var builder = new ApiSdk.Workbooks.Item.Workbook.Worksheets.Item.Charts.Item.Axes.SeriesAxis.Title.TitleRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildDeleteCommand());
            command.AddCommand(builder.BuildFormatCommand());
            command.AddCommand(builder.BuildGetCommand());
            command.AddCommand(builder.BuildPatchCommand());
