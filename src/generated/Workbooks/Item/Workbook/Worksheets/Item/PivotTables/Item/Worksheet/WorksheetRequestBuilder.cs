...
namespace ApiSdk.Workbooks.Item.Workbook.Worksheets.Item.PivotTables.Item.Worksheet {
    ...
    public class WorksheetRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string driveItemId, string workbookWorksheetId, string workbookPivotTableId) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string driveItemId, string workbookWorksheetId, string workbookPivotTableId, string[] select, string[] expand) => {
            ...
            }, driveItemIdOption, workbookWorksheetIdOption, workbookPivotTableIdOption, selectOption, expandOption);
            return command;
        }
        /// <summary>
        /// The worksheet containing the current PivotTable. Read-only.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string driveItemId, string workbookWorksheetId, string workbookPivotTableId, string body) => {
