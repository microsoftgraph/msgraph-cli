...
namespace ApiSdk.Workbooks.Item.Workbook.Worksheets.Item.Protection {
    ...
    public class ProtectionRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string driveItemId, string workbookWorksheetId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, driveItemIdOption, workbookWorksheetIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// Returns sheet protection object for a worksheet. Read-only.
        ...
        public Command BuildProtectCommand() {
            ...
            var builder = new ApiSdk.Workbooks.Item.Workbook.Worksheets.Item.Protection.Protect.ProtectRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildPostCommand());
            return command;
        }
        public Command BuildUnprotectCommand() {
            var command = new Command("unprotect");
            var builder = new ApiSdk.Workbooks.Item.Workbook.Worksheets.Item.Protection.Unprotect.UnprotectRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildPostCommand());
            return command;
        }
        /// <summary>
