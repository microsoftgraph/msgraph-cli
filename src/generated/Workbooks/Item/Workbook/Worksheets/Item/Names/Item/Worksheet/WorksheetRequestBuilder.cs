...
namespace ApiSdk.Workbooks.Item.Workbook.Worksheets.Item.Names.Item.Worksheet {
    ...
    public class WorksheetRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(driveItemIdOption, workbookWorksheetIdOption, workbookNamedItemIdOption, selectOption, expandOption, outputOption, queryOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// Returns the worksheet on which the named item is scoped to. Available only if the item is scoped to the worksheet. Read-only.
