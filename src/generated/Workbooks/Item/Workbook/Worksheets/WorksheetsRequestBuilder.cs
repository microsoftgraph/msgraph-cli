...
namespace ApiSdk.Workbooks.Item.Workbook.Worksheets {
    ...
    public class WorksheetsRequestBuilder {
        ...
        public Command BuildAddCommand() {
            ...
            var builder = new ApiSdk.Workbooks.Item.Workbook.Worksheets.Add.AddRequestBuilder(PathParameters, RequestAdapter);
        ...
        public List<Command> BuildCommand() {
            ...
            commands.Add(builder.BuildNamesCommand());
            commands.Add(builder.BuildPatchCommand());
            commands.Add(builder.BuildPivotTablesCommand());
            commands.Add(builder.BuildProtectionCommand());
            commands.Add(builder.BuildTablesCommand());
            return commands;
        }
        /// <summary>
