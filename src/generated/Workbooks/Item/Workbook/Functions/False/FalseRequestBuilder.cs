...
namespace ApiSdk.Workbooks.Item.Workbook.Functions.False {
    ...
    public class FalseRequestBuilder {
        ...
        public class FalseResponse : IAdditionalDataHolder, IParsable {
            ...
            public static FalseResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
            ...
            public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
                return new Dictionary<string, Action<T, IParseNode>> {
                    {"workbookFunctionResult", (o,n) => { (o as FalseResponse).WorkbookFunctionResult = n.GetObjectValue<ApiSdk.Models.Microsoft.Graph.WorkbookFunctionResult>(ApiSdk.Models.Microsoft.Graph.WorkbookFunctionResult.CreateFromDiscriminatorValue); } },
                };
            }
            /// <summary>
