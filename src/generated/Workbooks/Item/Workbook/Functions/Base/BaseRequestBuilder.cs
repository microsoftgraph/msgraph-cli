    ...
    public class BaseRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                var model = parseNode.GetObjectValue<BaseRequestBody>(BaseRequestBody.CreateFromDiscriminatorValue);
        ...
        public class BaseResponse : IAdditionalDataHolder, IParsable {
            ...
            public static BaseResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
            ...
            public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
                return new Dictionary<string, Action<T, IParseNode>> {
                    {"workbookFunctionResult", (o,n) => { (o as BaseResponse).WorkbookFunctionResult = n.GetObjectValue<ApiSdk.Models.Microsoft.Graph.WorkbookFunctionResult>(ApiSdk.Models.Microsoft.Graph.WorkbookFunctionResult.CreateFromDiscriminatorValue); } },
                };
            }
            /// <summary>
