...
namespace ApiSdk.Workbooks.Item.Workbook.Functions.Rand {
    ...
    public class RandRequestBuilder {
        ...
        public class RandResponse : IAdditionalDataHolder, IParsable {
            ...
            public static RandResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
            ...
            public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
                return new Dictionary<string, Action<T, IParseNode>> {
                    {"workbookFunctionResult", (o,n) => { (o as RandResponse).WorkbookFunctionResult = n.GetObjectValue<ApiSdk.Models.Microsoft.Graph.WorkbookFunctionResult>(ApiSdk.Models.Microsoft.Graph.WorkbookFunctionResult.CreateFromDiscriminatorValue); } },
                };
            }
            /// <summary>
