...
namespace ApiSdk.Workbooks.Item.Workbook.Functions.True {
    ...
    public class TrueRequestBuilder {
        ...
        public class TrueResponse : IAdditionalDataHolder, IParsable {
            ...
            public static TrueResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
            ...
            public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
                return new Dictionary<string, Action<T, IParseNode>> {
                    {"workbookFunctionResult", (o,n) => { (o as TrueResponse).WorkbookFunctionResult = n.GetObjectValue<ApiSdk.Models.Microsoft.Graph.WorkbookFunctionResult>(ApiSdk.Models.Microsoft.Graph.WorkbookFunctionResult.CreateFromDiscriminatorValue); } },
                };
            }
            /// <summary>
