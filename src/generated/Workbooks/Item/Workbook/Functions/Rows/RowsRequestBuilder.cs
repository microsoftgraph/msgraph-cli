...
namespace ApiSdk.Workbooks.Item.Workbook.Functions.Rows {
    ...
    public class RowsRequestBuilder {
        ...
        /// </summary>
        public async Task<RowsResponse> PostAsync(RowsRequestBody model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
