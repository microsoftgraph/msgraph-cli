...
namespace ApiSdk.Workbooks.Item.Workbook.Functions.@And {
    ...
    public class AndRequestBuilder {
        ...
        /// </summary>
        public async Task<AndResponse> PostAsync(AndRequestBody model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
