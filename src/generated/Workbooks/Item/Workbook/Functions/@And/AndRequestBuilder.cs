    ...
    public class AndRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (string driveItemId, string body) => {
                ...
                var result = await RequestAdapter.SendAsync<AndResponse>(requestInfo);
        ...
        /// </summary>
        public async Task<AndResponse> PostAsync(AndRequestBody model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
