...
namespace ApiSdk.Workbooks.Item.Workbook.Functions.Skew_p {
    ...
    public class Skew_pRequestBuilder {
        ...
        /// </summary>
        public async Task<Skew_pResponse> PostAsync(Skew_pRequestBody model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
