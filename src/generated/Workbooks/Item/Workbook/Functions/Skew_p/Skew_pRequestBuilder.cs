    ...
    public class Skew_pRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (string driveItemId, string body) => {
                ...
                var model = parseNode.GetObjectValue<Skew_pRequestBody>();
                var requestInfo = CreatePostRequestInformation(model, q => {
                });
                var result = await RequestAdapter.SendAsync<Skew_pResponse>(requestInfo);
        ...
        /// </summary>
        public async Task<Skew_pResponse> PostAsync(Skew_pRequestBody model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
