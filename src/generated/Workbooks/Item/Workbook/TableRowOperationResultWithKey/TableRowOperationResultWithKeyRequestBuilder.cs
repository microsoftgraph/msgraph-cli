...
namespace ApiSdk.Workbooks.Item.Workbook.TableRowOperationResultWithKey {
    ...
    public class TableRowOperationResultWithKeyRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(driveItemIdOption, keyOption, outputOption, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
