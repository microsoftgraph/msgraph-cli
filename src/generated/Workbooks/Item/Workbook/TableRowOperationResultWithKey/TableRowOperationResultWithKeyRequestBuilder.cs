...
namespace ApiSdk.Workbooks.Item.Workbook.TableRowOperationResultWithKey {
    ...
    public class TableRowOperationResultWithKeyRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string driveItemId, string key, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, driveItemIdOption, keyOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
