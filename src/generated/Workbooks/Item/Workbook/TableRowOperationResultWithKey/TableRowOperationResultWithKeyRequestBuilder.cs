...
namespace ApiSdk.Workbooks.Item.Workbook.TableRowOperationResultWithKey {
    ...
    public class TableRowOperationResultWithKeyRequestBuilder {
        ...
        public class TableRowOperationResultWithKeyResponse : IAdditionalDataHolder, IParsable {
            ...
            public static TableRowOperationResultWithKeyResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
                _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
                return new TableRowOperationResultWithKeyResponse();
            }
            /// <summary>
            ...
            public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
                return new Dictionary<string, Action<T, IParseNode>> {
                    {"workbookTableRow", (o,n) => { (o as TableRowOperationResultWithKeyResponse).WorkbookTableRow = n.GetObjectValue<ApiSdk.Models.Microsoft.Graph.WorkbookTableRow>(ApiSdk.Models.Microsoft.Graph.WorkbookTableRow.CreateFromDiscriminatorValue); } },
                };
            }
            /// <summary>
