...
namespace ApiSdk.Workbooks.Item.Invite {
    ...
    public class InviteResponse : IAdditionalDataHolder, IParsable {
        ...
        /// </summary>
        public static ApiSdk.Workbooks.Item.Invite.InviteResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"value", (o,n) => { (o as InviteResponse).Value = n.GetCollectionOfObjectValues<ApiSdk.Models.Microsoft.Graph.Permission>(ApiSdk.Models.Microsoft.Graph.Permission.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
