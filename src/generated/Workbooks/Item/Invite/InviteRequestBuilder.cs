...
namespace ApiSdk.Workbooks.Item.Invite {
    ...
    public class InviteRequestBuilder {
        ...
        /// </summary>
        public async Task<IEnumerable<ApiSdk.Workbooks.Item.Invite.Invite>> PostAsync(InviteRequestBody model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
