...
namespace ApiSdk.Workbooks.Item.Checkin {
    ...
    public class CheckinRequestBuilder {
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(CheckinRequestBody body, Action<CheckinRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
