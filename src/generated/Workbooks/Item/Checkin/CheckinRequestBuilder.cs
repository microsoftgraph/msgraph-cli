...
namespace ApiSdk.Workbooks.Item.Checkin {
    ...
    public class CheckinRequestBuilder {
        ...
        /// </summary>
        public async Task PostAsync(CheckinRequestBody model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
