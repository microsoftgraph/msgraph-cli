...
namespace ApiSdk.Workbooks.Item.Subscriptions.Item {
    ...
    public class SubscriptionRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string driveItemId, string subscriptionId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, driveItemIdOption, subscriptionIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The set of subscriptions on the item. Only supported on the root of a drive.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string driveItemId, string subscriptionId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, driveItemIdOption, subscriptionIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The set of subscriptions on the item. Only supported on the root of a drive.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string driveItemId, string subscriptionId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, driveItemIdOption, subscriptionIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
