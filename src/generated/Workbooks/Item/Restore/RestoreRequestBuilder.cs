...
namespace ApiSdk.Workbooks.Item.Restore {
    ...
    public class RestoreRequestBuilder {
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(RestoreRequestBody body, Action<RestoreRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
