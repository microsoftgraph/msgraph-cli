...
namespace ApiSdk.Workbooks.Item.Restore {
    ...
    public class RestoreRequestBuilder {
        ...
        /// </summary>
        public async Task<RestoreResponse> PostAsync(RestoreRequestBody model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
