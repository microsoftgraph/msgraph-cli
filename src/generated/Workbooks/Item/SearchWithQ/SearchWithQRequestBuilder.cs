...
namespace ApiSdk.Workbooks.Item.SearchWithQ {
    ...
    public class SearchWithQRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string driveItemId, string q, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, driveItemIdOption, qOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
