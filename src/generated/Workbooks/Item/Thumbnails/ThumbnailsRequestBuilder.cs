...
using ApiSdk.Workbooks.Item.Thumbnails.Count;
...
namespace ApiSdk.Workbooks.Item.Thumbnails {
    ...
    public class ThumbnailsRequestBuilder {
        ...
        public Command BuildCreateCommand() {
            ...
            command.Description = "Create new navigation property to thumbnails for workbooks";
        ...
        public ThumbnailsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/workbooks/{driveItem%2Did}/thumbnails{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
