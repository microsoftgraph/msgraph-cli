...
namespace ApiSdk.Workbooks.Item.Thumbnails {
    ...
    public class ThumbnailsRequestBuilder {
        ...
        public Command BuildListCommand() {
            ...
            command.Handler = CommandHandler.Create<string, int?, int?, string, string, bool?, object, object, object>(async (driveItemId, top, skip, search, filter, count, orderby, select, expand) => {
