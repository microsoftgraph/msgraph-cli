...
namespace ApiSdk.Workbooks.Item.Permissions.Item.Grant {
    ...
    public class GrantRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            }, new CollectionBinding(driveItemIdOption, permissionIdOption, bodyOption, outputOption, queryOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
