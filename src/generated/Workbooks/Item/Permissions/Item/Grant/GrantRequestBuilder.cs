...
namespace ApiSdk.Workbooks.Item.Permissions.Item.Grant {
    ...
    public class GrantRequestBuilder {
        ...
        /// </summary>
        public async Task<IEnumerable<ApiSdk.Workbooks.Item.Permissions.Item.Grant.Grant>> PostAsync(GrantRequestBody model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
