...
namespace ApiSdk.Workbooks.Item.Permissions.Item.Grant {
    ...
    public class GrantRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (string driveItemId, string permissionId, string body, FormatterType output, IOutputFormatterFactory outputFormatterFactory, CancellationToken cancellationToken) => {
