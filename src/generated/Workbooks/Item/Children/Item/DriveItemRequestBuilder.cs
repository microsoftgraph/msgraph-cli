...
namespace ApiSdk.Workbooks.Item.Children.Item {
    ...
    public class DriveItemRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string driveItemId, string driveItemId1) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string driveItemId, string driveItemId1, string[] select, string[] expand) => {
            ...
            }, driveItemIdOption, driveItemId1Option, selectOption, expandOption);
            return command;
        }
        /// <summary>
        /// Collection containing Item objects for the immediate children of Item. Only items representing folders have children. Read-only. Nullable.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string driveItemId, string driveItemId1, string body) => {
