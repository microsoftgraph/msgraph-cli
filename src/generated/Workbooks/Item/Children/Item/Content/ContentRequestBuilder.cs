...
namespace ApiSdk.Workbooks.Item.Children.Item.Content {
    ...
    public class ContentRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string driveItemId, string driveItemId1, FileInfo file, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
            ...
            }, driveItemIdOption, driveItemId1Option, fileOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// The content stream, if the item represents a file.
        ...
        public Command BuildPutCommand() {
            ...
            command.SetHandler(async (string driveItemId, string driveItemId1, FileInfo file, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
