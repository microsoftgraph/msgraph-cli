...
namespace ApiSdk.DirectoryNamespace.CustomSecurityAttributeDefinitions.Item.AllowedValues.Item {
    ...
    public class AllowedValueItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.Description = "Read the properties and relationships of an allowedValue object. This API is available in the following national cloud deployments.\n\nFind more info here:\n  https://learn.microsoft.com/graph/api/allowedvalue-get?view=graph-rest-1.0";
            var customSecurityAttributeDefinitionIdOption = new Option<string>("--custom-security-attribute-definition-id", description: "The unique identifier of customSecurityAttributeDefinition") {
            };
            customSecurityAttributeDefinitionIdOption.IsRequired = true;
            command.AddOption(customSecurityAttributeDefinitionIdOption);
        ...
        public Command BuildPatchCommand() {
            ...
            command.Description = "Update the properties of an allowedValue object. This API is available in the following national cloud deployments.\n\nFind more info here:\n  https://learn.microsoft.com/graph/api/allowedvalue-update?view=graph-rest-1.0";
            var customSecurityAttributeDefinitionIdOption = new Option<string>("--custom-security-attribute-definition-id", description: "The unique identifier of customSecurityAttributeDefinition") {
            };
            customSecurityAttributeDefinitionIdOption.IsRequired = true;
            command.AddOption(customSecurityAttributeDefinitionIdOption);
        ...
        public AllowedValueItemRequestBuilder(string rawUrl) : base("{+baseurl}/directory/customSecurityAttributeDefinitions/{customSecurityAttributeDefinition%2Did}/allowedValues/{allowedValue%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Delete navigation property allowedValues for directory
        /// </summary>
