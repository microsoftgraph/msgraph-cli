using ApiSdk.DirectoryNamespace.AdministrativeUnits.Item.Extensions.Count;
using ApiSdk.DirectoryNamespace.AdministrativeUnits.Item.Extensions.Item;
...
using System;
namespace ApiSdk.DirectoryNamespace.AdministrativeUnits.Item.Extensions {
    /// <summary>
    ...
    public class ExtensionsRequestBuilder : BaseCliRequestBuilder {
        ...
        public ExtensionsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/directory/administrativeUnits/{administrativeUnit%2Did}/extensions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// The collection of open extensions defined for this administrative unit. Nullable.
        /// </summary>
