using ApiSdk.DirectoryNamespace.AdministrativeUnits.Item.Members.Device.Count;
using ApiSdk.Models;
...
namespace ApiSdk.DirectoryNamespace.AdministrativeUnits.Item.Members.Device {
    /// <summary>
