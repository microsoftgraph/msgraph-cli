...
namespace ApiSdk.DirectoryNamespace.AdministrativeUnits.Item.Members.Item.GraphApplication {
    ...
    public class GraphApplicationRequestBuilder : BaseCliRequestBuilder {
        ...
        public GraphApplicationRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/directory/administrativeUnits/{administrativeUnit%2Did}/members/{directoryObject%2Did}/graph.application{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Get the item of type microsoft.graph.directoryObject as microsoft.graph.application
        /// </summary>
