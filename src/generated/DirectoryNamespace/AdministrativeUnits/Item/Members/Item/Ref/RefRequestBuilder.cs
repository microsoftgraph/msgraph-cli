...
namespace ApiSdk.DirectoryNamespace.AdministrativeUnits.Item.Members.Item.Ref {
    ...
    public class RefRequestBuilder : BaseCliRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.Description = "Use this API to remove a member (user, group, or device) from an administrative unit. This API is available in the following national cloud deployments.\n\nFind more info here:\n  https://learn.microsoft.com/graph/api/administrativeunit-delete-members?view=graph-rest-1.0";
