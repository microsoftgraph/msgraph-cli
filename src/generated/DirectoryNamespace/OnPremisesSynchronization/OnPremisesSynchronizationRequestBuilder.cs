using ApiSdk.DirectoryNamespace.OnPremisesSynchronization.Count;
using ApiSdk.DirectoryNamespace.OnPremisesSynchronization.Item;
...
namespace ApiSdk.DirectoryNamespace.OnPremisesSynchronization {
    ...
    public class OnPremisesSynchronizationRequestBuilder : BaseCliRequestBuilder {
        ...
        public Tuple<List<Command>, List<Command>> BuildCommand() {
            ...
            var builder = new OnPremisesDirectorySynchronizationItemRequestBuilder(PathParameters);
        ...
        public Command BuildCreateCommand() {
            ...
            command.Description = "Create new navigation property to onPremisesSynchronization for directory";
...
#nullable restore
        ...
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<OnPremisesSynchronizationRequestBuilderGetQueryParameters>> requestConfiguration = default) {
            ...
            if (requestConfiguration != null) {
                var requestConfig = new RequestConfiguration<OnPremisesSynchronizationRequestBuilderGetQueryParameters>();
