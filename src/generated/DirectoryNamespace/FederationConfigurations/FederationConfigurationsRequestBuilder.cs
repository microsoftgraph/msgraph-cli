...
namespace ApiSdk.DirectoryNamespace.FederationConfigurations {
    ...
    public class FederationConfigurationsRequestBuilder : BaseCliRequestBuilder {
        ...
        public FederationConfigurationsRequestBuilder(string rawUrl) : base("{+baseurl}/directory/federationConfigurations{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Configure domain federation with organizations whose identity provider (IdP) supports either the SAML or WS-Fed protocol.
        /// </summary>
