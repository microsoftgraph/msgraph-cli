using ApiSdk.DirectoryNamespace.FederationConfigurations.AvailableProviderTypes;
using ApiSdk.DirectoryNamespace.FederationConfigurations.Count;
using ApiSdk.DirectoryNamespace.FederationConfigurations.Item;
using ApiSdk.Models;
...
namespace ApiSdk.DirectoryNamespace.FederationConfigurations {
    /// <summary>
    /// Provides operations to manage the federationConfigurations property of the microsoft.graph.directory entity.
    /// </summary>
    public class FederationConfigurationsRequestBuilder : BaseCliRequestBuilder {
        /// <summary>
        ...
        public FederationConfigurationsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/directory/federationConfigurations{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Configure domain federation with organizations whose identity provider (IdP) supports either the SAML or WS-Fed protocol.
        /// </summary>
...
#nullable restore
        ...
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<FederationConfigurationsRequestBuilderGetQueryParameters>> requestConfiguration = default) {
            ...
            if (requestConfiguration != null) {
                var requestConfig = new RequestConfiguration<FederationConfigurationsRequestBuilderGetQueryParameters>();
