...
namespace ApiSdk.DirectoryNamespace.FederationConfigurations.Item {
    ...
    public class IdentityProviderBaseItemRequestBuilder {
        ...
        public IdentityProviderBaseItemRequestBuilder(Dictionary<string, object> pathParameters) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            UrlTemplate = "{+baseurl}/directory/federationConfigurations/{identityProviderBase%2Did}{?%24select,%24expand}";
