using ApiSdk.DirectoryNamespace.DeletedItems.GraphApplication.Count;
...
using System;
namespace ApiSdk.DirectoryNamespace.DeletedItems.GraphApplication {
    /// <summary>
    ...
    public class GraphApplicationRequestBuilder : BaseCliRequestBuilder {
        ...
        public GraphApplicationRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/directory/deletedItems/graph.application{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Get the items of type microsoft.graph.application in the microsoft.graph.directoryObject collection
        /// </summary>
