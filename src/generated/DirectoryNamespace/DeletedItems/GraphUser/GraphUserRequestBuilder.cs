...
namespace ApiSdk.DirectoryNamespace.DeletedItems.GraphUser {
    ...
    public class GraphUserRequestBuilder : BaseCliRequestBuilder {
        ...
        public GraphUserRequestBuilder(string rawUrl) : base("{+baseurl}/directory/deletedItems/graph.user{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Get the items of type microsoft.graph.user in the microsoft.graph.directoryObject collection
        /// </summary>
