...
namespace ApiSdk.DirectoryNamespace.DeletedItems.GraphServicePrincipal {
    ...
    public class GraphServicePrincipalRequestBuilder : BaseCliRequestBuilder {
        ...
        public GraphServicePrincipalRequestBuilder(string rawUrl) : base("{+baseurl}/directory/deletedItems/graph.servicePrincipal{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Get the items of type microsoft.graph.servicePrincipal in the microsoft.graph.directoryObject collection
        /// </summary>
