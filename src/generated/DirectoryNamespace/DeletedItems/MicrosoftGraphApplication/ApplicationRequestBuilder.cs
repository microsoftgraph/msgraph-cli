using ApiSdk.DirectoryNamespace.DeletedItems.MicrosoftGraphApplication.Count;
using ApiSdk.Models;
...
namespace ApiSdk.DirectoryNamespace.DeletedItems.MicrosoftGraphApplication {
    /// <summary>
