...
using System;
namespace ApiSdk.DirectoryNamespace.DeletedItems.Item.CheckMemberObjects {
    /// <summary>
    ...
    public class CheckMemberObjectsRequestBuilder : BaseCliRequestBuilder {
        ...
        public CheckMemberObjectsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/directory/deletedItems/{directoryObject%2Did}/checkMemberObjects", pathParameters) {
        }
        /// <summary>
        /// Invoke action checkMemberObjects
        /// </summary>
