...
namespace ApiSdk.Invitations {
    ...
    public class InvitationsRequestBuilder : BaseCliRequestBuilder {
        ...
        public InvitationsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/invitations{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Get entities from invitations
        /// </summary>
