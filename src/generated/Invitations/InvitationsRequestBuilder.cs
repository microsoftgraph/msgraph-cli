...
namespace ApiSdk.Invitations {
    ...
    public class InvitationsRequestBuilder {
        ...
        public Command BuildCommand() {
            ...
            var builder = new InvitationItemRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildDeleteCommand());
            command.AddCommand(builder.BuildGetCommand());
            command.AddCommand(builder.BuildInvitedUserCommand());
        ...
        public Command BuildCreateCommand() {
            ...
            command.Description = "Add new entity to invitations";
        ...
        public InvitationsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/invitations{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
        ...
        /// </summary>
        public RequestInformation CreateGetRequestInformation(Action<InvitationsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(Invitation body, Action<InvitationsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
