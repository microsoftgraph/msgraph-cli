...
namespace ApiSdk.Invitations {
    ...
    public class InvitationsRequestBuilder {
        ...
        public List<Command> BuildCommand() {
            ...
            commands.Add(builder.BuildInvitedUserCommand());
        ...
        /// <param name="options">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(Invitation body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
