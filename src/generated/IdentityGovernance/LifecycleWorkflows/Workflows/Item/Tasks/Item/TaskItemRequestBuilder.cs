...
namespace ApiSdk.IdentityGovernance.LifecycleWorkflows.Workflows.Item.Tasks.Item {
    ...
    public class TaskItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public TaskItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/identityGovernance/lifecycleWorkflows/workflows/{workflow%2Did}/tasks/{task%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Delete navigation property tasks for identityGovernance
        /// </summary>
