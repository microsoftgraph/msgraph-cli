using ApiSdk.IdentityGovernance.LifecycleWorkflows.Workflows.Item.TaskReports.Item.TaskDefinition;
using ApiSdk.IdentityGovernance.LifecycleWorkflows.Workflows.Item.TaskReports.Item.TaskNamespace;
using ApiSdk.IdentityGovernance.LifecycleWorkflows.Workflows.Item.TaskReports.Item.TaskProcessingResults;
...
namespace ApiSdk.IdentityGovernance.LifecycleWorkflows.Workflows.Item.TaskReports.Item {
    ...
    public class TaskReportItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public TaskReportItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/identityGovernance/lifecycleWorkflows/workflows/{workflow%2Did}/taskReports/{taskReport%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Represents the aggregation of task execution data for tasks within a workflow object.
        /// </summary>
