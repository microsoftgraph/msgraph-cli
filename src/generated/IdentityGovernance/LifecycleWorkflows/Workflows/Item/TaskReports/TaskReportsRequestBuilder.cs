...
namespace ApiSdk.IdentityGovernance.LifecycleWorkflows.Workflows.Item.TaskReports {
    ...
    public class TaskReportsRequestBuilder : BaseCliRequestBuilder {
        ...
        public TaskReportsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/identityGovernance/lifecycleWorkflows/workflows/{workflow%2Did}/taskReports{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Get a list of the taskReport objects and their properties.
        /// </summary>
