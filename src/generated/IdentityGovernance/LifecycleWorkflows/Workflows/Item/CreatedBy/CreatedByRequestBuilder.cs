using ApiSdk.IdentityGovernance.LifecycleWorkflows.Workflows.Item.CreatedBy.MailboxSettings;
...
using System;
namespace ApiSdk.IdentityGovernance.LifecycleWorkflows.Workflows.Item.CreatedBy {
    /// <summary>
    ...
    public class CreatedByRequestBuilder : BaseCliRequestBuilder {
        ...
        public CreatedByRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/identityGovernance/lifecycleWorkflows/workflows/{workflow%2Did}/createdBy{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// The user who created the workflow.
        /// </summary>
