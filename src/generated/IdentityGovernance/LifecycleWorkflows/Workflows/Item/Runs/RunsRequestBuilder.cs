...
namespace ApiSdk.IdentityGovernance.LifecycleWorkflows.Workflows.Item.Runs {
    ...
    public class RunsRequestBuilder : BaseCliRequestBuilder {
        ...
        public RunsRequestBuilder(string rawUrl) : base("{+baseurl}/identityGovernance/lifecycleWorkflows/workflows/{workflow%2Did}/runs{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Get a list of the run objects and their properties for a lifecycle workflow.
        /// </summary>
