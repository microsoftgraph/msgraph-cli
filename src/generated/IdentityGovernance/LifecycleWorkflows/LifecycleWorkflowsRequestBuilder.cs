...
namespace ApiSdk.IdentityGovernance.LifecycleWorkflows
{
    ...
    public partial class LifecycleWorkflowsRequestBuilder : BaseCliRequestBuilder
    {
        /// <summary>
        ...
        public Command BuildCustomTaskExtensionsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.IdentityGovernance.LifecycleWorkflows.CustomTaskExtensions.CustomTaskExtensionsRequestBuilder(PathParameters);
        ...
        public Command BuildDeletedItemsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.IdentityGovernance.LifecycleWorkflows.DeletedItems.DeletedItemsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
        ...
        public Command BuildInsightsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.IdentityGovernance.LifecycleWorkflows.Insights.InsightsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            execCommands.Add(builder.BuildDeleteCommand());
            execCommands.Add(builder.BuildGetCommand());
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<global::ApiSdk.Models.IdentityGovernance.LifecycleWorkflowsContainer>(global::ApiSdk.Models.IdentityGovernance.LifecycleWorkflowsContainer.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        public Command BuildSettingsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.IdentityGovernance.LifecycleWorkflows.Settings.SettingsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            execCommands.Add(builder.BuildPatchCommand());
            foreach (var cmd in execCommands)
        ...
        public Command BuildTaskDefinitionsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.IdentityGovernance.LifecycleWorkflows.TaskDefinitions.TaskDefinitionsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildListCommand());
        ...
        public Command BuildWorkflowsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.IdentityGovernance.LifecycleWorkflows.Workflows.WorkflowsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildWorkflowTemplatesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.IdentityGovernance.LifecycleWorkflows.WorkflowTemplates.WorkflowTemplatesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildListCommand());
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.IdentityGovernance.LifecycleWorkflows.LifecycleWorkflowsRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.IdentityGovernance.LifecycleWorkflows.LifecycleWorkflowsRequestBuilder.LifecycleWorkflowsRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.IdentityGovernance.LifecycleWorkflows.LifecycleWorkflowsRequestBuilder.LifecycleWorkflowsRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.IdentityGovernance.LifecycleWorkflowsContainer body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.IdentityGovernance.LifecycleWorkflowsContainer body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
