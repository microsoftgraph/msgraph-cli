...
namespace ApiSdk.IdentityGovernance.LifecycleWorkflows.DeletedItems.Workflows.Item.Versions.Item.Tasks.Item.TaskProcessingResults.Item {
    ...
    public class TaskProcessingResultItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public TaskProcessingResultItemRequestBuilder(string rawUrl) : base("{+baseurl}/identityGovernance/lifecycleWorkflows/deletedItems/workflows/{workflow%2Did}/versions/{workflowVersion%2DversionNumber}/tasks/{task%2Did}/taskProcessingResults/{taskProcessingResult%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// The result of processing the task.
        /// </summary>
