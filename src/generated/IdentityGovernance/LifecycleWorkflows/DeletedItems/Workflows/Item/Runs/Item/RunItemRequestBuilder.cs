...
namespace ApiSdk.IdentityGovernance.LifecycleWorkflows.DeletedItems.Workflows.Item.Runs.Item {
    ...
    public class RunItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public RunItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/identityGovernance/lifecycleWorkflows/deletedItems/workflows/{workflow%2Did}/runs/{run%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Read the properties and relationships of a run object.
        /// </summary>
