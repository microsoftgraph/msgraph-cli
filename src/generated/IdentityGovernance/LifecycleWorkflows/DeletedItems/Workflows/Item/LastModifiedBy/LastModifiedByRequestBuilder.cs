...
namespace ApiSdk.IdentityGovernance.LifecycleWorkflows.DeletedItems.Workflows.Item.LastModifiedBy {
    ...
    public class LastModifiedByRequestBuilder : BaseCliRequestBuilder {
        ...
        public LastModifiedByRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/identityGovernance/lifecycleWorkflows/deletedItems/workflows/{workflow%2Did}/lastModifiedBy{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// The unique identifier of the AAD identity that last modified the workflow.
        /// </summary>
