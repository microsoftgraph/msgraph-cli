using ApiSdk.IdentityGovernance.LifecycleWorkflows.CustomTaskExtensions.Item.CreatedBy.MailboxSettings;
...
namespace ApiSdk.IdentityGovernance.LifecycleWorkflows.CustomTaskExtensions.Item.CreatedBy {
    ...
    public class CreatedByRequestBuilder : BaseCliRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.Description = "The unique identifier of the Azure AD user that created the custom task extension.Supports $filter(eq, ne) and $expand.";
