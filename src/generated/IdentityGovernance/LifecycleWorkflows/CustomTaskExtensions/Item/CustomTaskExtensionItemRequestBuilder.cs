...
namespace ApiSdk.IdentityGovernance.LifecycleWorkflows.CustomTaskExtensions.Item {
    ...
    public class CustomTaskExtensionItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.Description = "Read the properties and relationships of a customTaskExtension object.\n\nFind more info here:\n  https://docs.microsoft.com/graph/api/identitygovernance-customtaskextension-get?view=graph-rest-1.0";
            var customTaskExtensionIdOption = new Option<string>("--custom-task-extension-id", description: "The unique identifier of customTaskExtension") {
            };
            customTaskExtensionIdOption.IsRequired = true;
            command.AddOption(customTaskExtensionIdOption);
        ...
        public Command BuildPatchCommand() {
            ...
            command.Description = "Update the properties of a customTaskExtension object.\n\nFind more info here:\n  https://docs.microsoft.com/graph/api/identitygovernance-customtaskextension-update?view=graph-rest-1.0";
            var customTaskExtensionIdOption = new Option<string>("--custom-task-extension-id", description: "The unique identifier of customTaskExtension") {
            };
            customTaskExtensionIdOption.IsRequired = true;
            command.AddOption(customTaskExtensionIdOption);
        ...
        public CustomTaskExtensionItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/identityGovernance/lifecycleWorkflows/customTaskExtensions/{customTaskExtension%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Delete a customTaskExtension object. A custom task extension  can only be deleted if it is not referenced in any task objects in a lifecycle workflow.
        /// </summary>
...
#nullable restore
        ...
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<CustomTaskExtensionItemRequestBuilderGetQueryParameters>> requestConfiguration = default) {
            ...
            if (requestConfiguration != null) {
                var requestConfig = new RequestConfiguration<CustomTaskExtensionItemRequestBuilderGetQueryParameters>();
                requestConfiguration.Invoke(requestConfig);
                requestInfo.AddQueryParameters(requestConfig.QueryParameters);
                requestInfo.AddRequestOptions(requestConfig.Options);
                requestInfo.AddHeaders(requestConfig.Headers);
