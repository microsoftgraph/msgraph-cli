...
namespace ApiSdk.IdentityGovernance.AppConsent.AppConsentRequests.Item {
    ...
    public class AppConsentRequestItemRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(appConsentRequestIdOption, selectOption, expandOption, outputOption, outputFilterOption, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// A collection of userConsentRequest objects for a specific application.
