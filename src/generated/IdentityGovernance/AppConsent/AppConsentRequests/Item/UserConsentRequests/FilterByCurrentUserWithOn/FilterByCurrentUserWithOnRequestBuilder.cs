...
namespace ApiSdk.IdentityGovernance.AppConsent.AppConsentRequests.Item.UserConsentRequests.FilterByCurrentUserWithOn {
    ...
    public class FilterByCurrentUserWithOnRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string appConsentRequestId, object on, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, appConsentRequestIdOption, onOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
