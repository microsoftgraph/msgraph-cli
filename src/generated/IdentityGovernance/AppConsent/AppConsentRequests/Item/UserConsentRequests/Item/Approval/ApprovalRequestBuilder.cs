...
namespace ApiSdk.IdentityGovernance.AppConsent.AppConsentRequests.Item.UserConsentRequests.Item.Approval
{
    ...
    public class ApprovalRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildStagesNavCommand()
        {
            ...
            var builder = new ApiSdk.IdentityGovernance.AppConsent.AppConsentRequests.Item.UserConsentRequests.Item.Approval.Stages.StagesRequestBuilder(PathParameters);
