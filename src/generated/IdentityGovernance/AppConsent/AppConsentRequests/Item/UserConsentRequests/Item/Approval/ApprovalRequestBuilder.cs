...
namespace ApiSdk.IdentityGovernance.AppConsent.AppConsentRequests.Item.UserConsentRequests.Item.Approval {
    ...
    public class ApprovalRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string appConsentRequestId, string userConsentRequestId, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                var requestInfo = CreateDeleteRequestInformation(q => {
                });
                await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                console.WriteLine("Success");
            }, appConsentRequestIdOption, userConsentRequestIdOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// Approval decisions associated with a request.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string appConsentRequestId, string userConsentRequestId, string[] select, string[] expand, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
            ...
            }, appConsentRequestIdOption, userConsentRequestIdOption, selectOption, expandOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// Approval decisions associated with a request.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string appConsentRequestId, string userConsentRequestId, string body, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                ...
                await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                console.WriteLine("Success");
            }, appConsentRequestIdOption, userConsentRequestIdOption, bodyOption, new OutputFormatterFactoryBinder());
            return command;
        }
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<ApiSdk.Models.Microsoft.Graph.Approval> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
            var requestInfo = CreateGetRequestInformation(q, h, o);
            return await RequestAdapter.SendAsync<ApiSdk.Models.Microsoft.Graph.Approval>(requestInfo, responseHandler, cancellationToken);
        }
        /// <summary>
        /// Approval decisions associated with a request.
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(ApiSdk.Models.Microsoft.Graph.Approval model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
