...
namespace ApiSdk.IdentityGovernance.AppConsent.AppConsentRequests.Item.UserConsentRequests.Item.Approval.Stages.Item {
    ...
    public class ApprovalStageRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string appConsentRequestId, string userConsentRequestId, string approvalStageId, IConsole console) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string appConsentRequestId, string userConsentRequestId, string approvalStageId, string[] select, string[] expand, FormatterType output, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string appConsentRequestId, string userConsentRequestId, string approvalStageId, string body, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
