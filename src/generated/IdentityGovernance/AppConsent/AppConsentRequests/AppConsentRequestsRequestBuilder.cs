...
using ApiSdk.IdentityGovernance.AppConsent.AppConsentRequests.MicrosoftGraphFilterByCurrentUserWithOn;
using ApiSdk.Models;
...
namespace ApiSdk.IdentityGovernance.AppConsent.AppConsentRequests {
    ...
    public class AppConsentRequestsRequestBuilder {
        ...
        public Command BuildCommand() {
            ...
            var builder = new AppConsentRequestItemRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildDeleteCommand());
            command.AddCommand(builder.BuildGetCommand());
            command.AddCommand(builder.BuildPatchCommand());
            command.AddCommand(builder.BuildUserConsentRequestsCommand());
            return command;
        }
        /// <summary>
