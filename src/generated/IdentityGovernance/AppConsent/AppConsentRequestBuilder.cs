    ...
    public class AppConsentRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.Handler = CommandHandler.Create<string[], string[]>(async (select, expand) => {
                ...
                var result = await RequestAdapter.SendAsync<AppConsentApprovalRoute>(requestInfo);
                // Print request output. What if the request has no return?
        ...
        public Command BuildPatchCommand() {
            ...
            command.Handler = CommandHandler.Create<string>(async (body) => {
                ...
                var model = parseNode.GetObjectValue<AppConsentApprovalRoute>();
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(AppConsentApprovalRoute model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
