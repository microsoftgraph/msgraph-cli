...
namespace ApiSdk.IdentityGovernance.AppConsent
{
    ...
    public class AppConsentRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildAppConsentRequestsNavCommand()
        {
            ...
            var builder = new ApiSdk.IdentityGovernance.AppConsent.AppConsentRequests.AppConsentRequestsRequestBuilder(PathParameters);
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Models.AppConsentApprovalRoute>(ApiSdk.Models.AppConsentApprovalRoute.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.IdentityGovernance.AppConsent.AppConsentRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.IdentityGovernance.AppConsent.AppConsentRequestBuilder.AppConsentRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.IdentityGovernance.AppConsent.AppConsentRequestBuilder.AppConsentRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.AppConsentApprovalRoute body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.AppConsentApprovalRoute body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
