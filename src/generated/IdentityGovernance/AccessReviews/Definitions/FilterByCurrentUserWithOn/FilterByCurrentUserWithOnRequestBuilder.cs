...
namespace ApiSdk.IdentityGovernance.AccessReviews.Definitions.FilterByCurrentUserWithOn {
    ...
    public class FilterByCurrentUserWithOnRequestBuilder : BaseCliRequestBuilder {
        ...
        public FilterByCurrentUserWithOnRequestBuilder(string rawUrl) : base("{+baseurl}/identityGovernance/accessReviews/definitions/filterByCurrentUser(on='{on}'){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}", rawUrl) {
        }
        /// <summary>
        /// Invoke function filterByCurrentUser
        /// </summary>
