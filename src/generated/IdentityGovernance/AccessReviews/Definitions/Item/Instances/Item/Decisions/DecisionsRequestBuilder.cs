...
namespace ApiSdk.IdentityGovernance.AccessReviews.Definitions.Item.Instances.Item.Decisions {
    ...
    public class DecisionsRequestBuilder {
        ...
        public Command BuildCreateCommand() {
            ...
            }, accessReviewScheduleDefinitionIdOption, accessReviewInstanceIdOption, bodyOption, outputOption);
            return command;
        }
        /// <summary>
        /// Each user reviewed in an accessReviewInstance has a decision item representing if they were approved, denied, or not yet reviewed.
        ...
        public Command BuildListCommand() {
            ...
            command.SetHandler(async (string accessReviewScheduleDefinitionId, string accessReviewInstanceId, int? top, int? skip, string search, string filter, bool? count, string[] orderby, string[] select, string[] expand, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                ...
                var formatter = outputFormatterFactory.GetFormatter(output);
                formatter.WriteOutput(response, console);
            }, accessReviewScheduleDefinitionIdOption, accessReviewInstanceIdOption, topOption, skipOption, searchOption, filterOption, countOption, orderbyOption, selectOption, expandOption, outputOption);
            return command;
        }
        /// <summary>
