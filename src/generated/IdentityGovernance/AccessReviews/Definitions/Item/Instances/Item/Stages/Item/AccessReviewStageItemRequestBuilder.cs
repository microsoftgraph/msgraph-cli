...
using ApiSdk.IdentityGovernance.AccessReviews.Definitions.Item.Instances.Item.Stages.Item.MicrosoftGraphStop;
using ApiSdk.Models;
...
namespace ApiSdk.IdentityGovernance.AccessReviews.Definitions.Item.Instances.Item.Stages.Item {
    ...
    public class AccessReviewStageItemRequestBuilder {
        ...
        public AccessReviewStageItemRequestBuilder(Dictionary<string, object> pathParameters) {
