...
namespace ApiSdk.IdentityGovernance.AccessReviews.Definitions.Item.Instances.Item.MicrosoftGraphResetDecisions {
    /// <summary>
    ...
    public class MicrosoftGraphResetDecisionsRequestBuilder {
        ...
        public MicrosoftGraphResetDecisionsRequestBuilder(Dictionary<string, object> pathParameters) {
