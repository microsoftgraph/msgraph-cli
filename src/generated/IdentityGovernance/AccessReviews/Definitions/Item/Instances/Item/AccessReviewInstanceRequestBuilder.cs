...
namespace ApiSdk.IdentityGovernance.AccessReviews.Definitions.Item.Instances.Item {
    ...
    public class AccessReviewInstanceRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            }, accessReviewScheduleDefinitionIdOption, accessReviewInstanceIdOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// Set of access reviews instances for this access review series. Access reviews that do not recur will only have one instance; otherwise, there is an instance for each recurrence.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string accessReviewScheduleDefinitionId, string accessReviewInstanceId, string[] select, string[] expand, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
            ...
            }, accessReviewScheduleDefinitionIdOption, accessReviewInstanceIdOption, selectOption, expandOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// Set of access reviews instances for this access review series. Access reviews that do not recur will only have one instance; otherwise, there is an instance for each recurrence.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string accessReviewScheduleDefinitionId, string accessReviewInstanceId, string body, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                ...
                await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                console.WriteLine("Success");
            }, accessReviewScheduleDefinitionIdOption, accessReviewInstanceIdOption, bodyOption, new OutputFormatterFactoryBinder());
            return command;
        }
