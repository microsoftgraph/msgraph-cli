...
namespace ApiSdk.IdentityGovernance.AccessReviews.Definitions.Item.Instances.FilterByCurrentUserWithOn {
    ...
    public class FilterByCurrentUserWithOnRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string accessReviewScheduleDefinitionId, object on, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, accessReviewScheduleDefinitionIdOption, onOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
