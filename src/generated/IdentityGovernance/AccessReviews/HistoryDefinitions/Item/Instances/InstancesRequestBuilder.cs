...
namespace ApiSdk.IdentityGovernance.AccessReviews.HistoryDefinitions.Item.Instances {
    ...
    public class InstancesRequestBuilder {
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(AccessReviewHistoryInstance body, Action<InstancesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
