...
namespace ApiSdk.IdentityGovernance.AccessReviews.HistoryDefinitions.Item.Instances.Item.GenerateDownloadUri {
    ...
    public class GenerateDownloadUriRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            }, new CollectionBinding(accessReviewHistoryDefinitionIdOption, accessReviewHistoryInstanceIdOption, outputOption, queryOption, jsonNoIndentOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
