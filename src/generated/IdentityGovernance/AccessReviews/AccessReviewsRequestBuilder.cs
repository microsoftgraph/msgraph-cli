    ...
    public class AccessReviewsRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string[] select, string[] expand) => {
                ...
                var result = await RequestAdapter.SendAsync<AccessReviewSet>(requestInfo);
                // Print request output. What if the request has no return?
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string body) => {
                ...
                var model = parseNode.GetObjectValue<AccessReviewSet>();
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(AccessReviewSet model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
