...
using System;
namespace ApiSdk.IdentityGovernance.EntitlementManagement.ResourceRoleScopes.Item.Role.Resource.Roles.Item {
    /// <summary>
    ...
    public class AccessPackageResourceRoleItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public AccessPackageResourceRoleItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/identityGovernance/entitlementManagement/resourceRoleScopes/{accessPackageResourceRoleScope%2Did}/role/resource/roles/{accessPackageResourceRole%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Delete navigation property roles for identityGovernance
        /// </summary>
