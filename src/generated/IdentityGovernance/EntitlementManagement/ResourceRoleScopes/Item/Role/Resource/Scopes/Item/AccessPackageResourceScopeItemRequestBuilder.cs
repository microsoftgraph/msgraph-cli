using ApiSdk.IdentityGovernance.EntitlementManagement.ResourceRoleScopes.Item.Role.Resource.Scopes.Item.Resource;
...
using System;
namespace ApiSdk.IdentityGovernance.EntitlementManagement.ResourceRoleScopes.Item.Role.Resource.Scopes.Item {
    /// <summary>
    ...
    public class AccessPackageResourceScopeItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public Command BuildResourceNavCommand() {
            ...
            var builder = new ApiSdk.IdentityGovernance.EntitlementManagement.ResourceRoleScopes.Item.Role.Resource.Scopes.Item.Resource.ResourceRequestBuilder(PathParameters);
        ...
        public AccessPackageResourceScopeItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/identityGovernance/entitlementManagement/resourceRoleScopes/{accessPackageResourceRoleScope%2Did}/role/resource/scopes/{accessPackageResourceScope%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Delete navigation property scopes for identityGovernance
        /// </summary>
