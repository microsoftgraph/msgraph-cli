using ApiSdk.IdentityGovernance.EntitlementManagement.ResourceRoleScopes.Item.Role.Resource;
...
using System;
namespace ApiSdk.IdentityGovernance.EntitlementManagement.ResourceRoleScopes.Item.Role {
    /// <summary>
    /// Provides operations to manage the role property of the microsoft.graph.accessPackageResourceRoleScope entity.
    /// </summary>
    public class RoleRequestBuilder : BaseCliRequestBuilder {
        /// <summary>
        /// Delete navigation property role for identityGovernance
        /// </summary>
        public Command BuildDeleteCommand() {
            var command = new Command("delete");
            command.Description = "Delete navigation property role for identityGovernance";
        ...
        public Command BuildGetCommand() {
            ...
            command.Description = "Get role from identityGovernance";
            var accessPackageResourceRoleScopeIdOption = new Option<string>("--access-package-resource-role-scope-id", description: "The unique identifier of accessPackageResourceRoleScope") {
            };
            accessPackageResourceRoleScopeIdOption.IsRequired = true;
            command.AddOption(accessPackageResourceRoleScopeIdOption);
        ...
        public Command BuildPatchCommand() {
            ...
            command.Description = "Update the navigation property role in identityGovernance";
            var accessPackageResourceRoleScopeIdOption = new Option<string>("--access-package-resource-role-scope-id", description: "The unique identifier of accessPackageResourceRoleScope") {
            };
            accessPackageResourceRoleScopeIdOption.IsRequired = true;
            command.AddOption(accessPackageResourceRoleScopeIdOption);
...
#nullable restore
        ...
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<RoleRequestBuilderGetQueryParameters>> requestConfiguration = default) {
            ...
            if (requestConfiguration != null) {
                var requestConfig = new RequestConfiguration<RoleRequestBuilderGetQueryParameters>();
                requestConfiguration.Invoke(requestConfig);
                requestInfo.AddQueryParameters(requestConfig.QueryParameters);
                requestInfo.AddRequestOptions(requestConfig.Options);
                requestInfo.AddHeaders(requestConfig.Headers);
