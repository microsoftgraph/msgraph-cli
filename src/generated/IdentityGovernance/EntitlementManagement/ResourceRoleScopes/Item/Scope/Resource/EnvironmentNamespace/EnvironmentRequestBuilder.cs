...
namespace ApiSdk.IdentityGovernance.EntitlementManagement.ResourceRoleScopes.Item.Scope.Resource.EnvironmentNamespace {
    ...
    public class EnvironmentRequestBuilder : BaseCliRequestBuilder {
        ...
        public EnvironmentRequestBuilder(string rawUrl) : base("{+baseurl}/identityGovernance/entitlementManagement/resourceRoleScopes/{accessPackageResourceRoleScope%2Did}/scope/resource/environment{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Contains the environment information for the resource. This can be set using either the @odata.bind annotation or the environment&apos;s originId.Supports $expand.
        /// </summary>
