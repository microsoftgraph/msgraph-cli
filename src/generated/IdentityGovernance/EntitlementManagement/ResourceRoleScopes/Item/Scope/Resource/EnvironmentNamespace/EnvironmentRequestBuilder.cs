...
using System;
namespace ApiSdk.IdentityGovernance.EntitlementManagement.ResourceRoleScopes.Item.Scope.Resource.EnvironmentNamespace {
    /// <summary>
    ...
    public class EnvironmentRequestBuilder : BaseCliRequestBuilder {
        ...
        public EnvironmentRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/identityGovernance/entitlementManagement/resourceRoleScopes/{accessPackageResourceRoleScope%2Did}/scope/resource/environment{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Get environment from identityGovernance
        /// </summary>
