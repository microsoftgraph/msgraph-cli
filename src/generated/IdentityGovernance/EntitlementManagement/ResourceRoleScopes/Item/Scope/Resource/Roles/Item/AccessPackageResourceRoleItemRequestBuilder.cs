using ApiSdk.IdentityGovernance.EntitlementManagement.ResourceRoleScopes.Item.Scope.Resource.Roles.Item.Resource;
...
using System;
namespace ApiSdk.IdentityGovernance.EntitlementManagement.ResourceRoleScopes.Item.Scope.Resource.Roles.Item {
    /// <summary>
    ...
    public class AccessPackageResourceRoleItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.Description = "Get roles from identityGovernance";
            var accessPackageResourceRoleScopeIdOption = new Option<string>("--access-package-resource-role-scope-id", description: "The unique identifier of accessPackageResourceRoleScope") {
            };
            accessPackageResourceRoleScopeIdOption.IsRequired = true;
            command.AddOption(accessPackageResourceRoleScopeIdOption);
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<AccessPackageResourceRole>(AccessPackageResourceRole.CreateFromDiscriminatorValue);
        ...
        public Command BuildResourceNavCommand() {
            ...
            var builder = new ApiSdk.IdentityGovernance.EntitlementManagement.ResourceRoleScopes.Item.Scope.Resource.Roles.Item.Resource.ResourceRequestBuilder(PathParameters);
        ...
        public AccessPackageResourceRoleItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/identityGovernance/entitlementManagement/resourceRoleScopes/{accessPackageResourceRoleScope%2Did}/scope/resource/roles/{accessPackageResourceRole%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Delete navigation property roles for identityGovernance
        /// </summary>
...
#nullable restore
        ...
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<AccessPackageResourceRoleItemRequestBuilderGetQueryParameters>> requestConfiguration = default) {
            ...
            if (requestConfiguration != null) {
                var requestConfig = new RequestConfiguration<AccessPackageResourceRoleItemRequestBuilderGetQueryParameters>();
                requestConfiguration.Invoke(requestConfig);
                requestInfo.AddQueryParameters(requestConfig.QueryParameters);
                requestInfo.AddRequestOptions(requestConfig.Options);
                requestInfo.AddHeaders(requestConfig.Headers);
