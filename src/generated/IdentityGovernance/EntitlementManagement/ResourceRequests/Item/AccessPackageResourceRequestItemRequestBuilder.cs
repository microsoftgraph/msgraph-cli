...
namespace ApiSdk.IdentityGovernance.EntitlementManagement.ResourceRequests.Item {
    ...
    public class AccessPackageResourceRequestItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public AccessPackageResourceRequestItemRequestBuilder(string rawUrl) : base("{+baseurl}/identityGovernance/entitlementManagement/resourceRequests/{accessPackageResourceRequest%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Delete navigation property resourceRequests for identityGovernance
        /// </summary>
