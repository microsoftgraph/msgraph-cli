using ApiSdk.IdentityGovernance.EntitlementManagement.ResourceRequests.Item.Resource.Scopes.Item.Resource.EnvironmentNamespace;
using ApiSdk.IdentityGovernance.EntitlementManagement.ResourceRequests.Item.Resource.Scopes.Item.Resource.Roles;
...
using System;
namespace ApiSdk.IdentityGovernance.EntitlementManagement.ResourceRequests.Item.Resource.Scopes.Item.Resource {
    /// <summary>
    ...
    public class ResourceRequestBuilder : BaseCliRequestBuilder {
        ...
        public ResourceRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/identityGovernance/entitlementManagement/resourceRequests/{accessPackageResourceRequest%2Did}/resource/scopes/{accessPackageResourceScope%2Did}/resource{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Delete navigation property resource for identityGovernance
        /// </summary>
