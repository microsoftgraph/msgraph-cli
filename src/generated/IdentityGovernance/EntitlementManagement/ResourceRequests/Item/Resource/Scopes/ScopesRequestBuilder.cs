using ApiSdk.IdentityGovernance.EntitlementManagement.ResourceRequests.Item.Resource.Scopes.Count;
using ApiSdk.IdentityGovernance.EntitlementManagement.ResourceRequests.Item.Resource.Scopes.Item;
...
using System;
namespace ApiSdk.IdentityGovernance.EntitlementManagement.ResourceRequests.Item.Resource.Scopes {
    /// <summary>
    ...
    public class ScopesRequestBuilder : BaseCliRequestBuilder {
        ...
        public ScopesRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/identityGovernance/entitlementManagement/resourceRequests/{accessPackageResourceRequest%2Did}/resource/scopes{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Get scopes from identityGovernance
        /// </summary>
