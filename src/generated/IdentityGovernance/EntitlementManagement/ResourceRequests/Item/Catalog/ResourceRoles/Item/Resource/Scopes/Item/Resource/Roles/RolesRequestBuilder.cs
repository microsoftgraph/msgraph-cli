using ApiSdk.IdentityGovernance.EntitlementManagement.ResourceRequests.Item.Catalog.ResourceRoles.Item.Resource.Scopes.Item.Resource.Roles.Count;
using ApiSdk.IdentityGovernance.EntitlementManagement.ResourceRequests.Item.Catalog.ResourceRoles.Item.Resource.Scopes.Item.Resource.Roles.Item;
...
using System;
namespace ApiSdk.IdentityGovernance.EntitlementManagement.ResourceRequests.Item.Catalog.ResourceRoles.Item.Resource.Scopes.Item.Resource.Roles {
    /// <summary>
    /// Provides operations to manage the roles property of the microsoft.graph.accessPackageResource entity.
    /// </summary>
    public class RolesRequestBuilder : BaseCliRequestBuilder {
        /// <summary>
        /// Provides operations to manage the roles property of the microsoft.graph.accessPackageResource entity.
        /// </summary>
        public Tuple<List<Command>, List<Command>> BuildCommand() {
            var executables = new List<Command>();
            var builder = new ApiSdk.IdentityGovernance.EntitlementManagement.ResourceRequests.Item.Catalog.ResourceRoles.Item.Resource.Scopes.Item.Resource.Roles.Item.AccessPackageResourceRoleItemRequestBuilder(PathParameters);
        ...
        public Command BuildCreateCommand() {
            ...
            command.Description = "Create new navigation property to roles for identityGovernance";
...
#nullable restore
        ...
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<RolesRequestBuilderGetQueryParameters>> requestConfiguration = default) {
            ...
            if (requestConfiguration != null) {
                var requestConfig = new RequestConfiguration<RolesRequestBuilderGetQueryParameters>();
