using ApiSdk.IdentityGovernance.EntitlementManagement.ResourceRequests.Item.Catalog.ResourceRoles.Item.Resource;
...
using System;
namespace ApiSdk.IdentityGovernance.EntitlementManagement.ResourceRequests.Item.Catalog.ResourceRoles.Item {
    /// <summary>
    ...
    public class AccessPackageResourceRoleItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.Description = "Delete navigation property resourceRoles for identityGovernance";
        ...
        public Command BuildGetCommand() {
            ...
            command.Description = "Get resourceRoles from identityGovernance";
            var accessPackageResourceRequestIdOption = new Option<string>("--access-package-resource-request-id", description: "The unique identifier of accessPackageResourceRequest") {
            };
            accessPackageResourceRequestIdOption.IsRequired = true;
            command.AddOption(accessPackageResourceRequestIdOption);
        ...
        public Command BuildPatchCommand() {
            ...
            command.Description = "Update the navigation property resourceRoles in identityGovernance";
            var accessPackageResourceRequestIdOption = new Option<string>("--access-package-resource-request-id", description: "The unique identifier of accessPackageResourceRequest") {
            };
            accessPackageResourceRequestIdOption.IsRequired = true;
            command.AddOption(accessPackageResourceRequestIdOption);
        ...
        public AccessPackageResourceRoleItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/identityGovernance/entitlementManagement/resourceRequests/{accessPackageResourceRequest%2Did}/catalog/resourceRoles/{accessPackageResourceRole%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Delete navigation property resourceRoles for identityGovernance
        /// </summary>
