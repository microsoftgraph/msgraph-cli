using ApiSdk.IdentityGovernance.EntitlementManagement.ResourceRequests.Item.Catalog.ResourceScopes.Item.Resource.EnvironmentNamespace;
using ApiSdk.IdentityGovernance.EntitlementManagement.ResourceRequests.Item.Catalog.ResourceScopes.Item.Resource.Roles;
using ApiSdk.IdentityGovernance.EntitlementManagement.ResourceRequests.Item.Catalog.ResourceScopes.Item.Resource.Scopes;
...
using System;
namespace ApiSdk.IdentityGovernance.EntitlementManagement.ResourceRequests.Item.Catalog.ResourceScopes.Item.Resource {
    /// <summary>
    ...
    public class ResourceRequestBuilder : BaseCliRequestBuilder {
        ...
        public ResourceRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/identityGovernance/entitlementManagement/resourceRequests/{accessPackageResourceRequest%2Did}/catalog/resourceScopes/{accessPackageResourceScope%2Did}/resource{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Delete navigation property resource for identityGovernance
        /// </summary>
