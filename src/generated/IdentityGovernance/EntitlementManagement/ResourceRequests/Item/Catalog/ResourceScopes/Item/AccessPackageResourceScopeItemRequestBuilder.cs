using ApiSdk.IdentityGovernance.EntitlementManagement.ResourceRequests.Item.Catalog.ResourceScopes.Item.Resource;
...
using System;
namespace ApiSdk.IdentityGovernance.EntitlementManagement.ResourceRequests.Item.Catalog.ResourceScopes.Item {
    /// <summary>
    ...
    public class AccessPackageResourceScopeItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.Description = "Delete navigation property resourceScopes for identityGovernance";
        ...
        public Command BuildGetCommand() {
            ...
            command.Description = "Get resourceScopes from identityGovernance";
            var accessPackageResourceRequestIdOption = new Option<string>("--access-package-resource-request-id", description: "The unique identifier of accessPackageResourceRequest") {
            };
            accessPackageResourceRequestIdOption.IsRequired = true;
            command.AddOption(accessPackageResourceRequestIdOption);
        ...
        public Command BuildPatchCommand() {
            ...
            command.Description = "Update the navigation property resourceScopes in identityGovernance";
            var accessPackageResourceRequestIdOption = new Option<string>("--access-package-resource-request-id", description: "The unique identifier of accessPackageResourceRequest") {
            };
            accessPackageResourceRequestIdOption.IsRequired = true;
            command.AddOption(accessPackageResourceRequestIdOption);
        ...
        public AccessPackageResourceScopeItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/identityGovernance/entitlementManagement/resourceRequests/{accessPackageResourceRequest%2Did}/catalog/resourceScopes/{accessPackageResourceScope%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Delete navigation property resourceScopes for identityGovernance
        /// </summary>
