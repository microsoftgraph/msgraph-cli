...
namespace ApiSdk.IdentityGovernance.EntitlementManagement.Catalogs.Item.ResourceScopes.Item.Resource
{
    ...
    public class ResourceRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildEnvironmentNavCommand()
        {
            ...
            var builder = new ApiSdk.IdentityGovernance.EntitlementManagement.Catalogs.Item.ResourceScopes.Item.Resource.EnvironmentNamespace.EnvironmentRequestBuilder(PathParameters);
        ...
        public Command BuildRolesNavCommand()
        {
            ...
            var builder = new ApiSdk.IdentityGovernance.EntitlementManagement.Catalogs.Item.ResourceScopes.Item.Resource.Roles.RolesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildScopesNavCommand()
        {
            ...
            var builder = new ApiSdk.IdentityGovernance.EntitlementManagement.Catalogs.Item.ResourceScopes.Item.Resource.Scopes.ScopesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.IdentityGovernance.EntitlementManagement.Catalogs.Item.ResourceScopes.Item.Resource.ResourceRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.IdentityGovernance.EntitlementManagement.Catalogs.Item.ResourceScopes.Item.Resource.ResourceRequestBuilder.ResourceRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.IdentityGovernance.EntitlementManagement.Catalogs.Item.ResourceScopes.Item.Resource.ResourceRequestBuilder.ResourceRequestBuilderGetQueryParameters>> requestConfiguration = default)
