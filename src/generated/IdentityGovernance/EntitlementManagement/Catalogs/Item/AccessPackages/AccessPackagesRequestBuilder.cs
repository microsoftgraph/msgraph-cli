...
namespace ApiSdk.IdentityGovernance.EntitlementManagement.Catalogs.Item.AccessPackages {
    ...
    public class AccessPackagesRequestBuilder {
        ...
        public Command BuildListCommand() {
            ...
            command.Handler = CommandHandler.Create<string, int?, int?, string, string, bool?, string[], string[], string[]>(async (accessPackageCatalogId, top, skip, search, filter, count, orderby, select, expand) => {
