...
namespace ApiSdk.IdentityGovernance.EntitlementManagement.Catalogs.Item.AccessPackages.Item {
    ...
    public class AccessPackageItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public AccessPackageItemRequestBuilder(string rawUrl) : base("{+baseurl}/identityGovernance/entitlementManagement/catalogs/{accessPackageCatalog%2Did}/accessPackages/{accessPackage%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// The access packages in this catalog. Read-only. Nullable.
        /// </summary>
