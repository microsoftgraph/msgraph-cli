...
using System;
namespace ApiSdk.IdentityGovernance.EntitlementManagement.Catalogs.Item.AccessPackages.Item.AssignmentPolicies.Item.Catalog {
    /// <summary>
    ...
    public class CatalogRequestBuilder : BaseCliRequestBuilder {
        ...
        public CatalogRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/identityGovernance/entitlementManagement/catalogs/{accessPackageCatalog%2Did}/accessPackages/{accessPackage%2Did}/assignmentPolicies/{accessPackageAssignmentPolicy%2Did}/catalog{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Catalog of the access package containing this policy. Read-only.
        /// </summary>
