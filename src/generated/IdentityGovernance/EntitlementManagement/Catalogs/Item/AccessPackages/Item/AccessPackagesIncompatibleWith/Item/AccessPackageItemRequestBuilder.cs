...
namespace ApiSdk.IdentityGovernance.EntitlementManagement.Catalogs.Item.AccessPackages.Item.AccessPackagesIncompatibleWith.Item {
    /// <summary>
    ...
    public class AccessPackageItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public AccessPackageItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/identityGovernance/entitlementManagement/catalogs/{accessPackageCatalog%2Did}/accessPackages/{accessPackage%2Did}/accessPackagesIncompatibleWith/{accessPackage%2Did1}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// The access packages that are incompatible with this package. Read-only.
        /// </summary>
...
#nullable restore
        ...
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<AccessPackageItemRequestBuilderGetQueryParameters>> requestConfiguration = default) {
            ...
            if (requestConfiguration != null) {
                var requestConfig = new RequestConfiguration<AccessPackageItemRequestBuilderGetQueryParameters>();
