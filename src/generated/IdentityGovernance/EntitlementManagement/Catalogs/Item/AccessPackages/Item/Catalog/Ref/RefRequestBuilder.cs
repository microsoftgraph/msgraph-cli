...
namespace ApiSdk.IdentityGovernance.EntitlementManagement.Catalogs.Item.AccessPackages.Item.Catalog.Ref {
    ...
    public class RefRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string accessPackageCatalogId, string accessPackageId, IConsole console) => {
        ...
        public Command BuildPutCommand() {
            ...
            command.SetHandler(async (string accessPackageCatalogId, string accessPackageId, string body, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
