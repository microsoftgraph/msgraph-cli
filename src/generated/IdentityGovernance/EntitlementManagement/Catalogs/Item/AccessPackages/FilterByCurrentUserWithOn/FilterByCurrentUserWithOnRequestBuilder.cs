...
namespace ApiSdk.IdentityGovernance.EntitlementManagement.Catalogs.Item.AccessPackages.FilterByCurrentUserWithOn {
    ...
    public class FilterByCurrentUserWithOnRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string accessPackageCatalogId, object on, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, accessPackageCatalogIdOption, onOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
