...
namespace ApiSdk.IdentityGovernance.EntitlementManagement.Catalogs.Item.ResourceRoles.Item {
    ...
    public class AccessPackageResourceRoleItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public AccessPackageResourceRoleItemRequestBuilder(string rawUrl) : base("{+baseurl}/identityGovernance/entitlementManagement/catalogs/{accessPackageCatalog%2Did}/resourceRoles/{accessPackageResourceRole%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Delete navigation property resourceRoles for identityGovernance
        /// </summary>
