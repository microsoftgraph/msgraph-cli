using ApiSdk.IdentityGovernance.EntitlementManagement.Catalogs.Item.ResourceRoles.Item.Resource.Scopes.Item.Resource.Roles.Count;
using ApiSdk.IdentityGovernance.EntitlementManagement.Catalogs.Item.ResourceRoles.Item.Resource.Scopes.Item.Resource.Roles.Item;
...
using System;
namespace ApiSdk.IdentityGovernance.EntitlementManagement.Catalogs.Item.ResourceRoles.Item.Resource.Scopes.Item.Resource.Roles {
    /// <summary>
    ...
    public class RolesRequestBuilder : BaseCliRequestBuilder {
        ...
        public Tuple<List<Command>, List<Command>> BuildCommand() {
            ...
            var builder = new ApiSdk.IdentityGovernance.EntitlementManagement.Catalogs.Item.ResourceRoles.Item.Resource.Scopes.Item.Resource.Roles.Item.AccessPackageResourceRoleItemRequestBuilder(PathParameters);
