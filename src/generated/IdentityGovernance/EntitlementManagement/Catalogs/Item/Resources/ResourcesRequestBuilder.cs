using ApiSdk.IdentityGovernance.EntitlementManagement.Catalogs.Item.Resources.Count;
using ApiSdk.IdentityGovernance.EntitlementManagement.Catalogs.Item.Resources.Item;
...
using System;
namespace ApiSdk.IdentityGovernance.EntitlementManagement.Catalogs.Item.Resources {
    /// <summary>
    ...
    public class ResourcesRequestBuilder : BaseCliRequestBuilder {
        ...
        public Tuple<List<Command>, List<Command>> BuildCommand() {
            ...
            commands.Add(builder.BuildEnvironmentNavCommand());
            executables.Add(builder.BuildGetCommand());
            executables.Add(builder.BuildPatchCommand());
            commands.Add(builder.BuildRolesNavCommand());
            commands.Add(builder.BuildScopesNavCommand());
        ...
        public Command BuildCreateCommand() {
            ...
            command.Description = "Create new navigation property to resources for identityGovernance";
        ...
        public Command BuildListCommand() {
            ...
            command.Description = "Get resources from identityGovernance";
            var accessPackageCatalogIdOption = new Option<string>("--access-package-catalog-id", description: "The unique identifier of accessPackageCatalog") {
            };
            accessPackageCatalogIdOption.IsRequired = true;
            command.AddOption(accessPackageCatalogIdOption);
        ...
        public ResourcesRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/identityGovernance/entitlementManagement/catalogs/{accessPackageCatalog%2Did}/resources{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Get resources from identityGovernance
        /// </summary>
...
#nullable restore
        ...
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ResourcesRequestBuilderGetQueryParameters>> requestConfiguration = default) {
            ...
            if (requestConfiguration != null) {
                var requestConfig = new RequestConfiguration<ResourcesRequestBuilderGetQueryParameters>();
