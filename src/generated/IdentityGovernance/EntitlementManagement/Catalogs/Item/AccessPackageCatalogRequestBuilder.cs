...
namespace ApiSdk.IdentityGovernance.EntitlementManagement.Catalogs.Item {
    ...
    public class AccessPackageCatalogRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string accessPackageCatalogId) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string accessPackageCatalogId, string[] select, string[] expand) => {
            ...
            }, accessPackageCatalogIdOption, selectOption, expandOption);
            return command;
        }
        /// <summary>
        /// Represents a group of access packages.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string accessPackageCatalogId, string body) => {
