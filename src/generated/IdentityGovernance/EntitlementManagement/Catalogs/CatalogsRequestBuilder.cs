...
namespace ApiSdk.IdentityGovernance.EntitlementManagement.Catalogs {
    ...
    public class CatalogsRequestBuilder {
        ...
        public Command[] BuildCommand() {
            var builder = new AccessPackageCatalogRequestBuilder(PathParameters, RequestAdapter);
            var commands = new List<Command> { 
                builder.BuildPatchCommand(),
                builder.BuildAccessPackagesCommand(),
        ...
        public Command BuildListCommand() {
            ...
            command.Handler = CommandHandler.Create<int?, int?, string, string, bool?, object, object, object>(async (top, skip, search, filter, count, orderby, select, expand) => {
                ...
                var result = await RequestAdapter.SendAsync<CatalogsResponse>(requestInfo);
                // Print request output. What if the request has no return?
                using var serializer = RequestAdapter.SerializationWriterFactory.GetSerializationWriter("application/json");
                serializer.WriteObjectValue(null, result);
                using var content = serializer.GetSerializedContent();
        ...
        /// </summary>
        public async Task<CatalogsResponse> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
            var requestInfo = CreateGetRequestInformation(q, h, o);
            return await RequestAdapter.SendAsync<CatalogsResponse>(requestInfo, responseHandler);
        }
        /// <summary>
        /// Create new navigation property to catalogs for identityGovernance
        /// <param name="h">Request headers</param>
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<AccessPackageCatalog> PostAsync(AccessPackageCatalog model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
