...
namespace ApiSdk.IdentityGovernance.EntitlementManagement.Assignments.FilterByCurrentUserWithOn {
    ...
    public class FilterByCurrentUserWithOnRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (object on, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, onOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
