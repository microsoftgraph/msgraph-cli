...
namespace ApiSdk.IdentityGovernance.EntitlementManagement.Assignments.Item.AccessPackage {
    ...
    public class AccessPackageRequestBuilder : BaseCliRequestBuilder {
        ...
        public AccessPackageRequestBuilder(string rawUrl) : base("{+baseurl}/identityGovernance/entitlementManagement/assignments/{accessPackageAssignment%2Did}/accessPackage{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Read-only. Nullable. Supports $filter (eq) on the id property and $expand query parameters.
        /// </summary>
