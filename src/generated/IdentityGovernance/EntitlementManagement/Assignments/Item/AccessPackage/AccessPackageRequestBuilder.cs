...
namespace ApiSdk.IdentityGovernance.EntitlementManagement.Assignments.Item.AccessPackage {
    ...
    public class AccessPackageRequestBuilder {
        ...
        public Command BuildGetApplicablePolicyRequirementsCommand() {
            ...
            var builder = new ApiSdk.IdentityGovernance.EntitlementManagement.Assignments.Item.AccessPackage.GetApplicablePolicyRequirements.GetApplicablePolicyRequirementsRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildRefCommand() {
            ...
            var builder = new ApiSdk.IdentityGovernance.EntitlementManagement.Assignments.Item.AccessPackage.@Ref.RefRequestBuilder(PathParameters, RequestAdapter);
