...
namespace ApiSdk.IdentityGovernance.EntitlementManagement.Assignments.Item.AssignmentPolicy {
    ...
    public class AssignmentPolicyRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(accessPackageAssignmentIdOption, selectOption, expandOption, outputOption, queryOption, jsonNoIndentOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        ...
        /// </summary>
        public AssignmentPolicyRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            _ = requestAdapter ?? throw new ArgumentNullException(nameof(requestAdapter));
            UrlTemplate = "{+baseurl}/identityGovernance/entitlementManagement/assignments/{accessPackageAssignment%2Did}/assignmentPolicy{?%24select,%24expand}";
        ...
        /// </summary>
        public RequestInformation CreateGetRequestInformation(Action<AssignmentPolicyRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
