...
namespace ApiSdk.IdentityGovernance.EntitlementManagement.Assignments.Item
{
    ...
    public class AccessPackageAssignmentItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildAccessPackageNavCommand()
        {
            ...
            var builder = new ApiSdk.IdentityGovernance.EntitlementManagement.Assignments.Item.AccessPackage.AccessPackageRequestBuilder(PathParameters);
        ...
        public Command BuildAssignmentPolicyNavCommand()
        {
            ...
            var builder = new ApiSdk.IdentityGovernance.EntitlementManagement.Assignments.Item.AssignmentPolicy.AssignmentPolicyRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildReprocessNavCommand()
        {
            ...
            var builder = new ApiSdk.IdentityGovernance.EntitlementManagement.Assignments.Item.Reprocess.ReprocessRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildTargetNavCommand()
        {
            ...
            var builder = new ApiSdk.IdentityGovernance.EntitlementManagement.Assignments.Item.Target.TargetRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.IdentityGovernance.EntitlementManagement.Assignments.Item.AccessPackageAssignmentItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.IdentityGovernance.EntitlementManagement.Assignments.Item.AccessPackageAssignmentItemRequestBuilder.AccessPackageAssignmentItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.IdentityGovernance.EntitlementManagement.Assignments.Item.AccessPackageAssignmentItemRequestBuilder.AccessPackageAssignmentItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
