    ...
    public class AdditionalAccessWithAccessPackageIdWithIncompatibleAccessPackageIdRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                requestInfo.PathParameters.Add("accessPackageId", accessPackageId);
                requestInfo.PathParameters.Add("incompatibleAccessPackageId", incompatibleAccessPackageId);
        ...
        public AdditionalAccessWithAccessPackageIdWithIncompatibleAccessPackageIdRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, string accessPackageId = default, string incompatibleAccessPackageId = default) {
