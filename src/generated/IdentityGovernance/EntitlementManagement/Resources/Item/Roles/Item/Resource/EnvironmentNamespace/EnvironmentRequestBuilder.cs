...
using System;
namespace ApiSdk.IdentityGovernance.EntitlementManagement.Resources.Item.Roles.Item.Resource.EnvironmentNamespace {
    /// <summary>
    ...
    public class EnvironmentRequestBuilder : BaseCliRequestBuilder {
        ...
        public EnvironmentRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/identityGovernance/entitlementManagement/resources/{accessPackageResource%2Did}/roles/{accessPackageResourceRole%2Did}/resource/environment{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Get environment from identityGovernance
        /// </summary>
