...
namespace ApiSdk.IdentityGovernance.EntitlementManagement.AssignmentRequests {
    ...
    public class AssignmentRequestsRequestBuilder {
        ...
        public Command[] BuildCommand() {
            var builder = new AccessPackageAssignmentRequestRequestBuilder(PathParameters, RequestAdapter);
            var commands = new List<Command> { 
                builder.BuildCancelCommand(),
                builder.BuildPatchCommand(),
                builder.BuildRequestorCommand(),
                builder.BuildGetCommand(),
                builder.BuildDeleteCommand(),
                builder.BuildAccessPackageCommand(),
                builder.BuildAssignmentCommand(),
            };
        ...
        public Command BuildListCommand() {
            ...
            command.Handler = CommandHandler.Create<int?, int?, string, string, bool?, object, object, object>(async (top, skip, search, filter, count, orderby, select, expand) => {
                ...
                var result = await RequestAdapter.SendAsync<AssignmentRequestsResponse>(requestInfo);
                // Print request output. What if the request has no return?
                using var serializer = RequestAdapter.SerializationWriterFactory.GetSerializationWriter("application/json");
                serializer.WriteObjectValue(null, result);
                using var content = serializer.GetSerializedContent();
        ...
        /// </summary>
        public async Task<AssignmentRequestsResponse> GetAsync(Action<GetQueryParameters> q = default, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
            var requestInfo = CreateGetRequestInformation(q, h, o);
            return await RequestAdapter.SendAsync<AssignmentRequestsResponse>(requestInfo, responseHandler);
        }
        /// <summary>
        /// Create new navigation property to assignmentRequests for identityGovernance
        /// <param name="h">Request headers</param>
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<AccessPackageAssignmentRequest> PostAsync(AccessPackageAssignmentRequest model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
            _ = model ?? throw new ArgumentNullException(nameof(model));
            var requestInfo = CreatePostRequestInformation(model, h, o);
            return await RequestAdapter.SendAsync<AccessPackageAssignmentRequest>(requestInfo, responseHandler);
        }
