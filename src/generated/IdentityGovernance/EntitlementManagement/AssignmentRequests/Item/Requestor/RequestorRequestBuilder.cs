...
namespace ApiSdk.IdentityGovernance.EntitlementManagement.AssignmentRequests.Item.Requestor {
    ...
    public class RequestorRequestBuilder {
        ...
        public RequestorRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/identityGovernance/entitlementManagement/assignmentRequests/{accessPackageAssignmentRequest%2Did}/requestor{?%24select,%24expand}";
        ...
        /// </summary>
        public RequestInformation CreateGetRequestInformation(Action<RequestorRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
