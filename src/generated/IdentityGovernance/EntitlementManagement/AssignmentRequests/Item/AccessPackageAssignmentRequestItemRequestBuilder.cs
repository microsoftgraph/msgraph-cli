...
namespace ApiSdk.IdentityGovernance.EntitlementManagement.AssignmentRequests.Item {
    ...
    public class AccessPackageAssignmentRequestItemRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(accessPackageAssignmentRequestIdOption, selectOption, expandOption, outputOption, queryOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// Represents access package assignment requests created by or on behalf of a user.
