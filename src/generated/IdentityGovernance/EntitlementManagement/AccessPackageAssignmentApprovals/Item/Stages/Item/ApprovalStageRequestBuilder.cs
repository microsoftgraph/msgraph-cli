...
namespace ApiSdk.IdentityGovernance.EntitlementManagement.AccessPackageAssignmentApprovals.Item.Stages.Item {
    ...
    public class ApprovalStageRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string approvalId, string approvalStageId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, approvalIdOption, approvalStageIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// Used for the approvalStages property of approval settings in the requestApprovalSettings property of an access package assignment policy. Specifies the primary, fallback, and escalation approvers of each stage.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string approvalId, string approvalStageId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, approvalIdOption, approvalStageIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// Used for the approvalStages property of approval settings in the requestApprovalSettings property of an access package assignment policy. Specifies the primary, fallback, and escalation approvers of each stage.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string approvalId, string approvalStageId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, approvalIdOption, approvalStageIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
