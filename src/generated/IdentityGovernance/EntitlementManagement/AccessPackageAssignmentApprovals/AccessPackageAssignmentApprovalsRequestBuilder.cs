...
namespace ApiSdk.IdentityGovernance.EntitlementManagement.AccessPackageAssignmentApprovals {
    ...
    public class AccessPackageAssignmentApprovalsRequestBuilder {
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ApiSdk.Models.Approval body, Action<AccessPackageAssignmentApprovalsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
