...
namespace ApiSdk.IdentityGovernance.EntitlementManagement.AccessPackages {
    ...
    public class AccessPackagesRequestBuilder {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<ApiSdk.Models.Microsoft.Graph.AccessPackage> PostAsync(ApiSdk.Models.Microsoft.Graph.AccessPackage model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
