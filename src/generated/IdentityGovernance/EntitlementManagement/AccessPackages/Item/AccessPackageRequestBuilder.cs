...
namespace ApiSdk.IdentityGovernance.EntitlementManagement.AccessPackages.Item {
    ...
    public class AccessPackageRequestBuilder {
        ...
        public Command BuildCatalogCommand() {
            ...
            var builder = new ApiSdk.IdentityGovernance.EntitlementManagement.AccessPackages.Item.Catalog.CatalogRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string accessPackageId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, accessPackageIdOption, new ServiceProviderBinder());
            return command;
        }
        public Command BuildGetApplicablePolicyRequirementsCommand() {
            var command = new Command("get-applicable-policy-requirements");
            var builder = new ApiSdk.IdentityGovernance.EntitlementManagement.AccessPackages.Item.GetApplicablePolicyRequirements.GetApplicablePolicyRequirementsRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string accessPackageId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, accessPackageIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// Represents access package objects.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string accessPackageId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, accessPackageIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(ApiSdk.Models.Microsoft.Graph.AccessPackage model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
