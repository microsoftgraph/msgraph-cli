...
namespace ApiSdk.IdentityGovernance.EntitlementManagement.AccessPackages.Item {
    ...
    public class AccessPackageRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string accessPackageId, IConsole console) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string accessPackageId, string[] select, string[] expand, FormatterType output, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string accessPackageId, string body, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
