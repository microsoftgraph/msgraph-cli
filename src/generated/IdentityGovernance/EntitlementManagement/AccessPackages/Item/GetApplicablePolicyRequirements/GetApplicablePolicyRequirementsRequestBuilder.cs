...
namespace ApiSdk.IdentityGovernance.EntitlementManagement.AccessPackages.Item.GetApplicablePolicyRequirements {
    ...
    public class GetApplicablePolicyRequirementsRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (string accessPackageId, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, accessPackageIdOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
