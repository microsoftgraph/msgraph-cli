...
namespace ApiSdk.IdentityGovernance.EntitlementManagement.ConnectedOrganizations.Item.InternalSponsors.Item {
    ...
    public class DirectoryObjectRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string connectedOrganizationId, string directoryObjectId, IOutputFormatterFactory outputFormatterFactory, CancellationToken cancellationToken) => {
                var requestInfo = CreateDeleteRequestInformation(q => {
                });
                await RequestAdapter.SendNoContentAsync(requestInfo, errorMapping: default, cancellationToken: cancellationToken);
                Console.WriteLine("Success");
            }, connectedOrganizationIdOption, directoryObjectIdOption);
            return command;
        }
        /// <summary>
        /// Nullable.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string connectedOrganizationId, string directoryObjectId, string[] select, string[] expand, FormatterType output, IOutputFormatterFactory outputFormatterFactory, CancellationToken cancellationToken) => {
            ...
            }, connectedOrganizationIdOption, directoryObjectIdOption, selectOption, expandOption, outputOption);
            return command;
        }
        /// <summary>
        /// Nullable.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string connectedOrganizationId, string directoryObjectId, string body, IOutputFormatterFactory outputFormatterFactory, CancellationToken cancellationToken) => {
                ...
                await RequestAdapter.SendNoContentAsync(requestInfo, errorMapping: default, cancellationToken: cancellationToken);
                Console.WriteLine("Success");
            }, connectedOrganizationIdOption, directoryObjectIdOption, bodyOption);
            return command;
        }
        /// <summary>
