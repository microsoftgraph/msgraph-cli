...
namespace ApiSdk.IdentityGovernance.EntitlementManagement.ConnectedOrganizations.Item.InternalSponsors.Item {
    ...
    public class DirectoryObjectItemRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.Description = "Delete navigation property internalSponsors for identityGovernance";
        ...
        public Command BuildPatchCommand() {
            ...
            command.Description = "Update the navigation property internalSponsors in identityGovernance";
            // Create options for all the parameters
            var connectedOrganizationIdOption = new Option<string>("--connected-organization-id", description: "key: id of connectedOrganization") {
            };
            connectedOrganizationIdOption.IsRequired = true;
