...
namespace ApiSdk.IdentityGovernance.EntitlementManagement.ConnectedOrganizations.Item.ExternalSponsors.Item {
    ...
    public class DirectoryObjectRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string connectedOrganizationId, string directoryObjectId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, connectedOrganizationIdOption, directoryObjectIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// Nullable.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string connectedOrganizationId, string directoryObjectId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, connectedOrganizationIdOption, directoryObjectIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// Nullable.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string connectedOrganizationId, string directoryObjectId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, connectedOrganizationIdOption, directoryObjectIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
