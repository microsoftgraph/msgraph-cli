...
namespace ApiSdk.IdentityGovernance.EntitlementManagement.AssignmentPolicies.Item.AccessPackage {
    /// <summary>
    ...
    public class AccessPackageRequestBuilder : BaseCliRequestBuilder {
        ...
        public AccessPackageRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/identityGovernance/entitlementManagement/assignmentPolicies/{accessPackageAssignmentPolicy%2Did}/accessPackage{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Access package containing this policy. Read-only.
        /// </summary>
