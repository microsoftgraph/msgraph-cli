using ApiSdk.IdentityGovernance.EntitlementManagement.ResourceEnvironments.Item.Resources;
...
namespace ApiSdk.IdentityGovernance.EntitlementManagement.ResourceEnvironments.Item {
    ...
    public class AccessPackageResourceEnvironmentItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.Description = "Delete navigation property resourceEnvironments for identityGovernance";
        ...
        public Command BuildPatchCommand() {
            ...
            command.Description = "Update the navigation property resourceEnvironments in identityGovernance";
            var accessPackageResourceEnvironmentIdOption = new Option<string>("--access-package-resource-environment-id", description: "The unique identifier of accessPackageResourceEnvironment") {
            };
            accessPackageResourceEnvironmentIdOption.IsRequired = true;
            command.AddOption(accessPackageResourceEnvironmentIdOption);
        ...
        public Command BuildResourcesNavCommand() {
            ...
            command.Description = "Provides operations to manage the resources property of the microsoft.graph.accessPackageResourceEnvironment entity.";
...
#nullable restore
        ...
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<AccessPackageResourceEnvironmentItemRequestBuilderGetQueryParameters>> requestConfiguration = default) {
            ...
            if (requestConfiguration != null) {
                var requestConfig = new RequestConfiguration<AccessPackageResourceEnvironmentItemRequestBuilderGetQueryParameters>();
                requestConfiguration.Invoke(requestConfig);
                requestInfo.AddQueryParameters(requestConfig.QueryParameters);
                requestInfo.AddRequestOptions(requestConfig.Options);
                requestInfo.AddHeaders(requestConfig.Headers);
