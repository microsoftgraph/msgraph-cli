...
namespace ApiSdk.IdentityGovernance.EntitlementManagement {
    ...
    public class EntitlementManagementRequestBuilder : BaseCliRequestBuilder {
        ...
        public EntitlementManagementRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/identityGovernance/entitlementManagement{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Delete navigation property entitlementManagement for identityGovernance
        /// </summary>
