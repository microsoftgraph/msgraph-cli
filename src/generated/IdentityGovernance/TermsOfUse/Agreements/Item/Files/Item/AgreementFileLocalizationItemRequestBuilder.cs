...
namespace ApiSdk.IdentityGovernance.TermsOfUse.Agreements.Item.Files.Item {
    ...
    public class AgreementFileLocalizationItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public AgreementFileLocalizationItemRequestBuilder(string rawUrl) : base("{+baseurl}/identityGovernance/termsOfUse/agreements/{agreement%2Did}/files/{agreementFileLocalization%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Delete navigation property files for identityGovernance
        /// </summary>
