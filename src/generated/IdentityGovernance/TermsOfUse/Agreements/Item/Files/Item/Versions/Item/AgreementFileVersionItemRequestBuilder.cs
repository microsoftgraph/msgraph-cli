...
namespace ApiSdk.IdentityGovernance.TermsOfUse.Agreements.Item.Files.Item.Versions.Item {
    ...
    public class AgreementFileVersionItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public AgreementFileVersionItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/identityGovernance/termsOfUse/agreements/{agreement%2Did}/files/{agreementFileLocalization%2Did}/versions/{agreementFileVersion%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Delete navigation property versions for identityGovernance
        /// </summary>
