using ApiSdk.IdentityGovernance.TermsOfUse.Agreements.Item.File.Localizations.Item.Versions.Count;
using ApiSdk.IdentityGovernance.TermsOfUse.Agreements.Item.File.Localizations.Item.Versions.Item;
using ApiSdk.Models;
...
namespace ApiSdk.IdentityGovernance.TermsOfUse.Agreements.Item.File.Localizations.Item.Versions {
    ...
    public class VersionsRequestBuilder {
        ...
        public Command BuildCommand() {
            ...
            var builder = new AgreementFileVersionItemRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildCreateCommand() {
            ...
            command.Description = "Create new navigation property to versions for identityGovernance";
            ...
            }, new CollectionBinding(agreementIdOption, agreementFileLocalizationIdOption, bodyOption, outputOption, queryOption, jsonNoIndentOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
