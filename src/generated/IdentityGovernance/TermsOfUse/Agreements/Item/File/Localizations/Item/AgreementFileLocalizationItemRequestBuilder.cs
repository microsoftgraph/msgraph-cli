using ApiSdk.IdentityGovernance.TermsOfUse.Agreements.Item.File.Localizations.Item.Versions;
using ApiSdk.Models;
...
namespace ApiSdk.IdentityGovernance.TermsOfUse.Agreements.Item.File.Localizations.Item {
