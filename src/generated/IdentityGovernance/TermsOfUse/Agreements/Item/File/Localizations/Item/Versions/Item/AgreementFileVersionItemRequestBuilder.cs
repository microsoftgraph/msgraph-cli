...
namespace ApiSdk.IdentityGovernance.TermsOfUse.Agreements.Item.File.Localizations.Item.Versions.Item {
    ...
    public class AgreementFileVersionItemRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            }, new CollectionBinding(agreementIdOption, agreementFileLocalizationIdOption, agreementFileVersionIdOption, ifMatchOption, new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(agreementIdOption, agreementFileLocalizationIdOption, agreementFileVersionIdOption, selectOption, expandOption, outputOption, queryOption, jsonNoIndentOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
