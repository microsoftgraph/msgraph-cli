using ApiSdk.IdentityGovernance.TermsOfUse.Agreements.Item.File.Localizations.Count;
using ApiSdk.IdentityGovernance.TermsOfUse.Agreements.Item.File.Localizations.Item;
using ApiSdk.Models;
...
namespace ApiSdk.IdentityGovernance.TermsOfUse.Agreements.Item.File.Localizations {
    ...
    public class LocalizationsRequestBuilder {
        ...
        public Command BuildCommand() {
            ...
            var builder = new AgreementFileLocalizationItemRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildCreateCommand() {
            ...
            }, new CollectionBinding(agreementIdOption, bodyOption, outputOption, queryOption, jsonNoIndentOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
