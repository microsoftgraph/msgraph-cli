...
namespace ApiSdk.IdentityGovernance.TermsOfUse.Agreements.Item.Acceptances {
    ...
    public class AcceptancesRequestBuilder : BaseCliRequestBuilder {
        ...
        public AcceptancesRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/identityGovernance/termsOfUse/agreements/{agreement%2Did}/acceptances{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Read-only. Information about acceptances of this agreement.
        /// </summary>
...
#nullable restore
        ...
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<AcceptancesRequestBuilderGetQueryParameters>> requestConfiguration = default) {
            ...
            if (requestConfiguration != null) {
                var requestConfig = new RequestConfiguration<AcceptancesRequestBuilderGetQueryParameters>();
