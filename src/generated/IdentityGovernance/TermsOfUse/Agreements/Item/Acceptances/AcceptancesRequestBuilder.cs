...
namespace ApiSdk.IdentityGovernance.TermsOfUse.Agreements.Item.Acceptances {
    ...
    public class AcceptancesRequestBuilder : BaseCliRequestBuilder {
        ...
        public AcceptancesRequestBuilder(string rawUrl) : base("{+baseurl}/identityGovernance/termsOfUse/agreements/{agreement%2Did}/acceptances{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Get the details about the acceptance records for a specific agreement. This API is available in the following national cloud deployments.
        /// </summary>
