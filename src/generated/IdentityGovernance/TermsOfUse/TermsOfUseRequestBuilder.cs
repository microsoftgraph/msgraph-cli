    ...
    public class TermsOfUseRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string[] select, string[] expand) => {
                ...
                var result = await RequestAdapter.SendAsync<TermsOfUseContainer>(requestInfo);
                // Print request output. What if the request has no return?
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(TermsOfUseContainer model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
