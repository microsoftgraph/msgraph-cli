...
namespace ApiSdk.IdentityGovernance.TermsOfUse.AgreementAcceptances.Item {
    ...
    public class AgreementAcceptanceRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string agreementAcceptanceId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, agreementAcceptanceIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// Represents the current status of a user's response to a company's customizable terms of use agreement.
