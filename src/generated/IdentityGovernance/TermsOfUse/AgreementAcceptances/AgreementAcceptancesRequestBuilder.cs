using ApiSdk.IdentityGovernance.TermsOfUse.AgreementAcceptances.Count;
...
namespace ApiSdk.IdentityGovernance.TermsOfUse.AgreementAcceptances {
    ...
    public class AgreementAcceptancesRequestBuilder : BaseCliRequestBuilder {
        ...
        public AgreementAcceptancesRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/identityGovernance/termsOfUse/agreementAcceptances{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Represents the current status of a user&apos;s response to a company&apos;s customizable terms of use agreement.
        /// </summary>
