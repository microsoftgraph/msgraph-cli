...
using ApiSdk.IdentityGovernance.PrivilegedAccess.Group.AssignmentApprovals;
using ApiSdk.IdentityGovernance.PrivilegedAccess.Group.AssignmentScheduleInstances;
using ApiSdk.IdentityGovernance.PrivilegedAccess.Group.AssignmentScheduleRequests;
using ApiSdk.IdentityGovernance.PrivilegedAccess.Group.AssignmentSchedules;
using ApiSdk.IdentityGovernance.PrivilegedAccess.Group.EligibilityScheduleInstances;
using ApiSdk.IdentityGovernance.PrivilegedAccess.Group.EligibilityScheduleRequests;
using ApiSdk.IdentityGovernance.PrivilegedAccess.Group.EligibilitySchedules;
...
namespace ApiSdk.IdentityGovernance.PrivilegedAccess.Group
{
    ...
    public partial class GroupRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildAssignmentApprovalsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.IdentityGovernance.PrivilegedAccess.Group.AssignmentApprovals.AssignmentApprovalsRequestBuilder(PathParameters);
        ...
        public Command BuildAssignmentScheduleInstancesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.IdentityGovernance.PrivilegedAccess.Group.AssignmentScheduleInstances.AssignmentScheduleInstancesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildAssignmentScheduleRequestsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.IdentityGovernance.PrivilegedAccess.Group.AssignmentScheduleRequests.AssignmentScheduleRequestsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildAssignmentSchedulesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.IdentityGovernance.PrivilegedAccess.Group.AssignmentSchedules.AssignmentSchedulesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildEligibilityScheduleInstancesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.IdentityGovernance.PrivilegedAccess.Group.EligibilityScheduleInstances.EligibilityScheduleInstancesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildEligibilityScheduleRequestsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.IdentityGovernance.PrivilegedAccess.Group.EligibilityScheduleRequests.EligibilityScheduleRequestsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildEligibilitySchedulesNavCommand()
        {
            ...
            var builder = new global::ApiSdk.IdentityGovernance.PrivilegedAccess.Group.EligibilitySchedules.EligibilitySchedulesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<global::ApiSdk.Models.PrivilegedAccessGroup>(global::ApiSdk.Models.PrivilegedAccessGroup.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.IdentityGovernance.PrivilegedAccess.Group.GroupRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.IdentityGovernance.PrivilegedAccess.Group.GroupRequestBuilder.GroupRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.IdentityGovernance.PrivilegedAccess.Group.GroupRequestBuilder.GroupRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.PrivilegedAccessGroup body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.PrivilegedAccessGroup body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
