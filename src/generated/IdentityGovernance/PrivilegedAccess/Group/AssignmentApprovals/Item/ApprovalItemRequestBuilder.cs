// <auto-generated/>
using ApiSdk.IdentityGovernance.PrivilegedAccess.Group.AssignmentApprovals.Item.Stages;
...
namespace ApiSdk.IdentityGovernance.PrivilegedAccess.Group.AssignmentApprovals.Item {
    ...
    public class ApprovalItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public ApprovalItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/identityGovernance/privilegedAccess/group/assignmentApprovals/{approval%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ApprovalItemRequestBuilder and sets the default values.
        /// </summary>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public ApprovalItemRequestBuilder(string rawUrl) : base("{+baseurl}/identityGovernance/privilegedAccess/group/assignmentApprovals/{approval%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Delete navigation property assignmentApprovals for identityGovernance
        /// </summary>
