...
namespace ApiSdk.IdentityProtection.RiskDetections {
    ...
    public class RiskDetectionsRequestBuilder {
        ...
        public List<Command> BuildCommand() {
            var builder = new RiskDetectionItemRequestBuilder(PathParameters, RequestAdapter);
        ...
        public RiskDetectionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/identityProtection/riskDetections{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
        ...
        /// <param name="options">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(RiskDetection body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
