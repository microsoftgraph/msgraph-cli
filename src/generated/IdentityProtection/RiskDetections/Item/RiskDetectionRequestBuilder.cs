...
namespace ApiSdk.IdentityProtection.RiskDetections.Item {
    ...
    public class RiskDetectionRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.Handler = CommandHandler.Create<string>(async (riskDetectionId) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string[], string[]>(async (riskDetectionId, select, expand) => {
        ...
        public Command BuildPatchCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string>(async (riskDetectionId, body) => {
