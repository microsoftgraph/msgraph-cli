...
namespace ApiSdk.IdentityProtection.RiskDetections.Item {
    ...
    public class RiskDetectionRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string riskDetectionId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, riskDetectionIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// Risk detection in Azure AD Identity Protection and the associated information about the detection.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string riskDetectionId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, riskDetectionIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// Risk detection in Azure AD Identity Protection and the associated information about the detection.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string riskDetectionId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, riskDetectionIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
