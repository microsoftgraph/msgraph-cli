...
namespace ApiSdk.IdentityProtection.RiskyUsers.Item.History.Item {
    ...
    public class RiskyUserHistoryItemItemRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(riskyUserIdOption, riskyUserHistoryItemIdOption, selectOption, expandOption, outputOption, outputFilterOption, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// The activity related to user risk level change
