...
namespace ApiSdk.IdentityProtection.RiskyUsers.Item {
    ...
    public class RiskyUserRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string riskyUserId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, riskyUserIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// Users that are flagged as at-risk by Azure AD Identity Protection.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string riskyUserId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, riskyUserIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string riskyUserId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, riskyUserIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
