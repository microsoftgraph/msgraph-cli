...
namespace ApiSdk.IdentityProtection.RiskyUsers.Item {
    ...
    public class RiskyUserRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            }, riskyUserIdOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// Users that are flagged as at-risk by Azure AD Identity Protection.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string riskyUserId, string[] select, string[] expand, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
            ...
            }, riskyUserIdOption, selectOption, expandOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string riskyUserId, string body, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                ...
                await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                console.WriteLine("Success");
            }, riskyUserIdOption, bodyOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
