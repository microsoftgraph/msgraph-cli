...
namespace ApiSdk.IdentityProtection.RiskyUsers {
    ...
    public class RiskyUsersRequestBuilder {
        ...
        public Command BuildConfirmCompromisedCommand() {
            ...
            var builder = new ApiSdk.IdentityProtection.RiskyUsers.ConfirmCompromised.ConfirmCompromisedRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildDismissCommand() {
            ...
            var builder = new ApiSdk.IdentityProtection.RiskyUsers.Dismiss.DismissRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildPostCommand());
            return command;
        }
        /// <summary>
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<RiskyUser> PostAsync(RiskyUser model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
