...
namespace ApiSdk.IdentityProtection {
    ...
    public class IdentityProtectionRequestBuilder {
        ...
        public Command BuildRiskDetectionsCommand() {
            ...
            var builder = new RiskDetectionsRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildServicePrincipalRiskDetectionsCommand() {
            ...
            var builder = new ServicePrincipalRiskDetectionsRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildCommand());
            command.AddCommand(builder.BuildCountCommand());
            command.AddCommand(builder.BuildCreateCommand());
            command.AddCommand(builder.BuildListCommand());
