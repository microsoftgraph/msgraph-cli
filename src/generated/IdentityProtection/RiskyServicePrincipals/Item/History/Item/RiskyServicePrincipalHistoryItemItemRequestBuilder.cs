...
namespace ApiSdk.IdentityProtection.RiskyServicePrincipals.Item.History.Item {
    ...
    public class RiskyServicePrincipalHistoryItemItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public RiskyServicePrincipalHistoryItemItemRequestBuilder(string rawUrl) : base("{+baseurl}/identityProtection/riskyServicePrincipals/{riskyServicePrincipal%2Did}/history/{riskyServicePrincipalHistoryItem%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Delete navigation property history for identityProtection
        /// </summary>
