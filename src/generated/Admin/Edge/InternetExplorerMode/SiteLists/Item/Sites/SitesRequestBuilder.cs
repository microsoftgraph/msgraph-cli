...
namespace ApiSdk.Admin.Edge.InternetExplorerMode.SiteLists.Item.Sites {
    ...
    public class SitesRequestBuilder : BaseCliRequestBuilder {
        ...
        public Command BuildCreateCommand() {
            ...
            command.Description = "Create a new browserSite object in a browserSiteList. This API is available in the following national cloud deployments.\n\nFind more info here:\n  https://learn.microsoft.com/graph/api/browsersitelist-post-sites?view=graph-rest-1.0";
        ...
        public Command BuildListCommand() {
            ...
            command.Description = "Get a list of the browserSite objects and their properties. This API is available in the following national cloud deployments.\n\nFind more info here:\n  https://learn.microsoft.com/graph/api/browsersitelist-list-sites?view=graph-rest-1.0";
            var browserSiteListIdOption = new Option<string>("--browser-site-list-id", description: "The unique identifier of browserSiteList") {
            };
            browserSiteListIdOption.IsRequired = true;
            command.AddOption(browserSiteListIdOption);
