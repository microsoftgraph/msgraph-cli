...
namespace ApiSdk.Admin.Edge.InternetExplorerMode.SiteLists {
    ...
    public class SiteListsRequestBuilder : BaseCliRequestBuilder {
        ...
        public Command BuildCreateCommand() {
            ...
            command.Description = "Create a new browserSiteList object to support Internet Explorer mode.\n\nFind more info here:\n  https://docs.microsoft.com/graph/api/internetexplorermode-post-sitelists?view=graph-rest-1.0";
        ...
        public Command BuildListCommand() {
            ...
            command.Description = "Get a list of the browserSiteList objects and their properties.\n\nFind more info here:\n  https://docs.microsoft.com/graph/api/internetexplorermode-list-sitelists?view=graph-rest-1.0";
        ...
        public SiteListsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/admin/edge/internetExplorerMode/siteLists{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Get a list of the browserSiteList objects and their properties.
        /// </summary>
...
#nullable restore
        ...
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<SiteListsRequestBuilderGetQueryParameters>> requestConfiguration = default) {
            ...
            if (requestConfiguration != null) {
                var requestConfig = new RequestConfiguration<SiteListsRequestBuilderGetQueryParameters>();
