...
namespace ApiSdk.Admin.ServiceAnnouncement {
    ...
    public class ServiceAnnouncementRequestBuilder {
        ...
        public Command BuildHealthOverviewsCommand() {
            ...
            var builder = new HealthOverviewsRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildIssuesCommand() {
            ...
            var builder = new IssuesRequestBuilder(PathParameters, RequestAdapter);
            foreach (var cmd in builder.BuildCommand()) {
                command.AddCommand(cmd);
            }
            command.AddCommand(builder.BuildCountCommand());
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Models.Microsoft.Graph.ServiceAnnouncement>(ApiSdk.Models.Microsoft.Graph.ServiceAnnouncement.CreateFromDiscriminatorValue);
        ...
        /// <param name="options">Request options</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(ApiSdk.Models.Microsoft.Graph.ServiceAnnouncement body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
