...
namespace ApiSdk.Admin.ServiceAnnouncement {
    ...
    public class ServiceAnnouncementRequestBuilder : BaseCliRequestBuilder {
        ...
        public Command BuildMessagesNavCommand() {
            ...
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
            nonExecCommands.Add(builder.BuildFavoriteNavCommand());
            execCommands.Add(builder.BuildListCommand());
            nonExecCommands.Add(builder.BuildMarkReadNavCommand());
            nonExecCommands.Add(builder.BuildMarkUnreadNavCommand());
            nonExecCommands.Add(builder.BuildUnarchiveNavCommand());
            nonExecCommands.Add(builder.BuildUnfavoriteNavCommand());
            var cmds = builder.BuildCommand();
            execCommands.AddRange(cmds.Item1);
            nonExecCommands.AddRange(cmds.Item2);
            foreach (var cmd in execCommands)
...
#nullable restore
        ...
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ServiceAnnouncementRequestBuilderGetQueryParameters>> requestConfiguration = default) {
            ...
            if (requestConfiguration != null) {
                var requestConfig = new RequestConfiguration<ServiceAnnouncementRequestBuilderGetQueryParameters>();
                requestConfiguration.Invoke(requestConfig);
                requestInfo.AddQueryParameters(requestConfig.QueryParameters);
                requestInfo.AddRequestOptions(requestConfig.Options);
                requestInfo.AddHeaders(requestConfig.Headers);
