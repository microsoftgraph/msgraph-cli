...
namespace ApiSdk.Admin.ServiceAnnouncement.Issues.Item {
    ...
    public class ServiceHealthIssueRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string serviceHealthIssueId, IConsole console) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string serviceHealthIssueId, string[] select, string[] expand, FormatterType output, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string serviceHealthIssueId, string body, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
