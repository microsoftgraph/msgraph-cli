...
namespace ApiSdk.Admin.ServiceAnnouncement.Issues.Item {
    ...
    public class ServiceHealthIssueItemRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(serviceHealthIssueIdOption, selectOption, expandOption, outputOption, outputFilterOption, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// A collection of service issues for tenant. This property is a contained navigation property, it is nullable and readonly.
