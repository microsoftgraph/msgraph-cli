...
namespace ApiSdk.Admin.ServiceAnnouncement.Issues.Item.IncidentReport {
    ...
    public class IncidentReportRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string serviceHealthIssueId, FileInfo file, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, serviceHealthIssueIdOption, fileOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
