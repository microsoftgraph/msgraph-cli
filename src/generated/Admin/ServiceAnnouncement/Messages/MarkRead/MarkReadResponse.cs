...
namespace ApiSdk.Admin.ServiceAnnouncement.Messages.MarkRead {
    ...
    public class MarkReadResponse : IAdditionalDataHolder, IParsable {
        ...
        /// </summary>
        public static ApiSdk.Admin.ServiceAnnouncement.Messages.MarkRead.MarkReadResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                {"value", (o,n) => { (o as MarkReadResponse).Value = n.GetBoolValue(); } },
            };
        }
        /// <summary>
