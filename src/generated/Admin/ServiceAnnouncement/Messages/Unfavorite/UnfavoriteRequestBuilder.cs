    ...
    public class UnfavoriteRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Admin.ServiceAnnouncement.Messages.Unfavorite.UnfavoriteRequestBody>(ApiSdk.Admin.ServiceAnnouncement.Messages.Unfavorite.UnfavoriteRequestBody.CreateFromDiscriminatorValue);
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ApiSdk.Admin.ServiceAnnouncement.Messages.Unfavorite.UnfavoriteRequestBody body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
