...
namespace ApiSdk.Admin.ServiceAnnouncement.Messages.Unarchive {
    ...
    public class UnarchiveRequestBuilder {
        ...
        /// </summary>
        public async Task<bool?> PostAsync(UnarchiveRequestBody model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
