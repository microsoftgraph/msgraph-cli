    ...
    public class UnarchiveRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Admin.ServiceAnnouncement.Messages.Unarchive.UnarchiveRequestBody>(ApiSdk.Admin.ServiceAnnouncement.Messages.Unarchive.UnarchiveRequestBody.CreateFromDiscriminatorValue);
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ApiSdk.Admin.ServiceAnnouncement.Messages.Unarchive.UnarchiveRequestBody body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
