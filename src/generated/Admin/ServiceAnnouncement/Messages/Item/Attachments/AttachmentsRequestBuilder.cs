...
namespace ApiSdk.Admin.ServiceAnnouncement.Messages.Item.Attachments {
    ...
    public class AttachmentsRequestBuilder {
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ServiceAnnouncementAttachment body, Action<AttachmentsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
