...
namespace ApiSdk.Admin.ServiceAnnouncement.Messages.Item.Attachments.Item.Content {
    ...
    public class ContentRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string serviceUpdateMessageId, string serviceAnnouncementAttachmentId, FileInfo output) => {
            ...
            }, serviceUpdateMessageIdOption, serviceAnnouncementAttachmentIdOption, outputOption);
            return command;
        }
        /// <summary>
        ...
        public Command BuildPutCommand() {
            ...
            command.SetHandler(async (string serviceUpdateMessageId, string serviceAnnouncementAttachmentId, FileInfo file) => {
