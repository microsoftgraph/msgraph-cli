...
namespace ApiSdk.Admin.ServiceAnnouncement.Messages.Item.Attachments.Item {
    ...
    public class ServiceAnnouncementAttachmentRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            }, serviceUpdateMessageIdOption, serviceAnnouncementAttachmentIdOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// A collection of serviceAnnouncementAttachments.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string serviceUpdateMessageId, string serviceAnnouncementAttachmentId, string[] select, string[] expand, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
            ...
            }, serviceUpdateMessageIdOption, serviceAnnouncementAttachmentIdOption, selectOption, expandOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// A collection of serviceAnnouncementAttachments.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string serviceUpdateMessageId, string serviceAnnouncementAttachmentId, string body, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                ...
                await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                console.WriteLine("Success");
            }, serviceUpdateMessageIdOption, serviceAnnouncementAttachmentIdOption, bodyOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
