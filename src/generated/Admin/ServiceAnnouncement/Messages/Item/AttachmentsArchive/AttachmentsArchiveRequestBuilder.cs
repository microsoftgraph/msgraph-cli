...
namespace ApiSdk.Admin.ServiceAnnouncement.Messages.Item.AttachmentsArchive {
    ...
    public class AttachmentsArchiveRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string serviceUpdateMessageId, FileInfo file, FormatterType output, IConsole console) => {
        ...
        public Command BuildPutCommand() {
            ...
            command.SetHandler(async (string serviceUpdateMessageId, FileInfo file, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
