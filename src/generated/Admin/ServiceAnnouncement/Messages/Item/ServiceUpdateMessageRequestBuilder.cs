...
namespace ApiSdk.Admin.ServiceAnnouncement.Messages.Item {
    ...
    public class ServiceUpdateMessageRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string serviceUpdateMessageId) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string serviceUpdateMessageId, string[] select, string[] expand) => {
            ...
            }, serviceUpdateMessageIdOption, selectOption, expandOption);
            return command;
        }
        /// <summary>
        /// A collection of service messages for tenant. This property is a contained navigation property, it is nullable and readonly.
