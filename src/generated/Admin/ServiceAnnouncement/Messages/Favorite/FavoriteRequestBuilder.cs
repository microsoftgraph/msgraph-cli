    ...
    public class FavoriteRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (string body, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                ...
                var model = parseNode.GetObjectValue<FavoriteRequestBody>();
        ...
        /// </summary>
        public async Task<bool?> PostAsync(FavoriteRequestBody model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
