...
namespace ApiSdk.Admin.ServiceAnnouncement.Messages.MicrosoftGraphUnarchive {
    /// <summary>
    ...
    public class MicrosoftGraphUnarchiveRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.Description = "Unarchive a list of serviceUpdateMessages for the signed in user.\n\nFind more info here:\n  https://docs.microsoft.com/graph/api/serviceupdatemessage-unarchive?view=graph-rest-1.0";
