...
namespace ApiSdk.Admin.ServiceAnnouncement.HealthOverviews.Item {
    ...
    public class ServiceHealthRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string serviceHealthId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, serviceHealthIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// A collection of service health information for tenant. This property is a contained navigation property, it is nullable and readonly.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string serviceHealthId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, serviceHealthIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string serviceHealthId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, serviceHealthIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
