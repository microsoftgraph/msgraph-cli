...
namespace ApiSdk.Admin.ServiceAnnouncement.HealthOverviews.Item.Issues.Item {
    ...
    public class ServiceHealthIssueRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string serviceHealthId, string serviceHealthIssueId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, serviceHealthIdOption, serviceHealthIssueIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// A collection of issues that happened on the service, with detailed information for each issue.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string serviceHealthId, string serviceHealthIssueId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, serviceHealthIdOption, serviceHealthIssueIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// A collection of issues that happened on the service, with detailed information for each issue.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string serviceHealthId, string serviceHealthIssueId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, serviceHealthIdOption, serviceHealthIssueIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
