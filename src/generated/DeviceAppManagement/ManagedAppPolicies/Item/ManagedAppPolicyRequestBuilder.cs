...
namespace ApiSdk.DeviceAppManagement.ManagedAppPolicies.Item {
    ...
    public class ManagedAppPolicyRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            }, managedAppPolicyIdOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// Managed app policies.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string managedAppPolicyId, string[] select, string[] expand, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
            ...
            }, managedAppPolicyIdOption, selectOption, expandOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
