...
namespace ApiSdk.DeviceAppManagement.ManagedAppPolicies.Item {
    ...
    public class ManagedAppPolicyRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string managedAppPolicyId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, managedAppPolicyIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// Managed app policies.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string managedAppPolicyId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, managedAppPolicyIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
