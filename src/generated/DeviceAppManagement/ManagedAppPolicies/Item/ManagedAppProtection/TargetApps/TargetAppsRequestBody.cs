...
namespace ApiSdk.DeviceAppManagement.ManagedAppPolicies.Item.ManagedAppProtection.TargetApps {
    ...
    public class TargetAppsRequestBody : IAdditionalDataHolder, IParsable {
        ...
        /// </summary>
        public static ApiSdk.DeviceAppManagement.ManagedAppPolicies.Item.ManagedAppProtection.TargetApps.TargetAppsRequestBody CreateFromDiscriminatorValue(IParseNode parseNode) {
