...
namespace ApiSdk.DeviceAppManagement.IosManagedAppProtections.Item.DeploymentSummary {
    ...
    public class DeploymentSummaryRequestBuilder : BaseCliRequestBuilder {
        ...
        public DeploymentSummaryRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/deviceAppManagement/iosManagedAppProtections/{iosManagedAppProtection%2Did}/deploymentSummary{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Delete navigation property deploymentSummary for deviceAppManagement
        /// </summary>
