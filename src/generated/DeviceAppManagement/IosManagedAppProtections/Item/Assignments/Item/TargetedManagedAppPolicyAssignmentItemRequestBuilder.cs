...
namespace ApiSdk.DeviceAppManagement.IosManagedAppProtections.Item.Assignments.Item {
    ...
    public class TargetedManagedAppPolicyAssignmentItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public TargetedManagedAppPolicyAssignmentItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/deviceAppManagement/iosManagedAppProtections/{iosManagedAppProtection%2Did}/assignments/{targetedManagedAppPolicyAssignment%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Delete navigation property assignments for deviceAppManagement
        /// </summary>
