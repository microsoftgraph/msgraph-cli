...
namespace ApiSdk.DeviceAppManagement.IosManagedAppProtections.Item.Apps.Item {
    ...
    public class ManagedMobileAppRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string iosManagedAppProtectionId, string managedMobileAppId, IOutputFormatterFactory outputFormatterFactory, CancellationToken cancellationToken) => {
                var requestInfo = CreateDeleteRequestInformation(q => {
                });
                await RequestAdapter.SendNoContentAsync(requestInfo, errorMapping: default, cancellationToken: cancellationToken);
                Console.WriteLine("Success");
            }, iosManagedAppProtectionIdOption, managedMobileAppIdOption);
            return command;
        }
        /// <summary>
        /// List of apps to which the policy is deployed.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string iosManagedAppProtectionId, string managedMobileAppId, string[] select, string[] expand, FormatterType output, IOutputFormatterFactory outputFormatterFactory, CancellationToken cancellationToken) => {
            ...
            }, iosManagedAppProtectionIdOption, managedMobileAppIdOption, selectOption, expandOption, outputOption);
            return command;
        }
        /// <summary>
        /// List of apps to which the policy is deployed.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string iosManagedAppProtectionId, string managedMobileAppId, string body, IOutputFormatterFactory outputFormatterFactory, CancellationToken cancellationToken) => {
                ...
                await RequestAdapter.SendNoContentAsync(requestInfo, errorMapping: default, cancellationToken: cancellationToken);
                Console.WriteLine("Success");
            }, iosManagedAppProtectionIdOption, managedMobileAppIdOption, bodyOption);
            return command;
        }
        /// <summary>
