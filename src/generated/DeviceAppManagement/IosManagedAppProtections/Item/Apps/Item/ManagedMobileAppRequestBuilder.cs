...
namespace ApiSdk.DeviceAppManagement.IosManagedAppProtections.Item.Apps.Item {
    ...
    public class ManagedMobileAppRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string iosManagedAppProtectionId, string managedMobileAppId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, iosManagedAppProtectionIdOption, managedMobileAppIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// List of apps to which the policy is deployed.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string iosManagedAppProtectionId, string managedMobileAppId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, iosManagedAppProtectionIdOption, managedMobileAppIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// List of apps to which the policy is deployed.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string iosManagedAppProtectionId, string managedMobileAppId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, iosManagedAppProtectionIdOption, managedMobileAppIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
