...
namespace ApiSdk.DeviceAppManagement.IosManagedAppProtections.Item {
    ...
    public class IosManagedAppProtectionItemRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(iosManagedAppProtectionIdOption, selectOption, expandOption, outputOption, queryOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// iOS managed app policies.
