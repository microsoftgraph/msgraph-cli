...
namespace ApiSdk.DeviceAppManagement.MdmWindowsInformationProtectionPolicies.Item {
    ...
    public class MdmWindowsInformationProtectionPolicyItemRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(mdmWindowsInformationProtectionPolicyIdOption, selectOption, expandOption, outputOption, queryOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// Windows information protection for apps running on devices which are MDM enrolled.
