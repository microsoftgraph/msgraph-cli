using ApiSdk.DeviceAppManagement.TargetedManagedAppConfigurations.Item.Apps.Count;
...
namespace ApiSdk.DeviceAppManagement.TargetedManagedAppConfigurations.Item.Apps {
    ...
    public class AppsRequestBuilder : BaseCliRequestBuilder {
        ...
        public AppsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/deviceAppManagement/targetedManagedAppConfigurations/{targetedManagedAppConfiguration%2Did}/apps{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// List of apps to which the policy is deployed.
        /// </summary>
