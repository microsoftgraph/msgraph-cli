...
namespace ApiSdk.DeviceAppManagement.TargetedManagedAppConfigurations.Item.Apps.Item {
    ...
    public class ManagedMobileAppRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string targetedManagedAppConfigurationId, string managedMobileAppId, string[] select, string[] expand) => {
            ...
            }, targetedManagedAppConfigurationIdOption, managedMobileAppIdOption, selectOption, expandOption);
            return command;
        }
        /// <summary>
        /// List of apps to which the policy is deployed.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string targetedManagedAppConfigurationId, string managedMobileAppId, string body) => {
