...
namespace ApiSdk.DeviceAppManagement.TargetedManagedAppConfigurations.Item.Apps.Item {
    ...
    public class ManagedMobileAppItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public ManagedMobileAppItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/deviceAppManagement/targetedManagedAppConfigurations/{targetedManagedAppConfiguration%2Did}/apps/{managedMobileApp%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Delete navigation property apps for deviceAppManagement
        /// </summary>
