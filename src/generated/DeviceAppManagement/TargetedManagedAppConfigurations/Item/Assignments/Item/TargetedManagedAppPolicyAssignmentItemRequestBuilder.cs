...
namespace ApiSdk.DeviceAppManagement.TargetedManagedAppConfigurations.Item.Assignments.Item {
    ...
    public class TargetedManagedAppPolicyAssignmentItemRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(targetedManagedAppConfigurationIdOption, targetedManagedAppPolicyAssignmentIdOption, selectOption, expandOption, outputOption, queryOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// Navigation property to list of inclusion and exclusion groups to which the policy is deployed.
