...
namespace ApiSdk.DeviceAppManagement.TargetedManagedAppConfigurations.Item.Assignments.Item {
    ...
    public class TargetedManagedAppPolicyAssignmentRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            }, targetedManagedAppConfigurationIdOption, targetedManagedAppPolicyAssignmentIdOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// Navigation property to list of inclusion and exclusion groups to which the policy is deployed.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string targetedManagedAppConfigurationId, string targetedManagedAppPolicyAssignmentId, string[] select, string[] expand, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
            ...
            }, targetedManagedAppConfigurationIdOption, targetedManagedAppPolicyAssignmentIdOption, selectOption, expandOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// Navigation property to list of inclusion and exclusion groups to which the policy is deployed.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string targetedManagedAppConfigurationId, string targetedManagedAppPolicyAssignmentId, string body, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                ...
                await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                console.WriteLine("Success");
            }, targetedManagedAppConfigurationIdOption, targetedManagedAppPolicyAssignmentIdOption, bodyOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
