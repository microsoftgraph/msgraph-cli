...
namespace ApiSdk.DeviceAppManagement.VppTokens.Item {
    ...
    public class VppTokenItemRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(vppTokenIdOption, selectOption, expandOption, outputOption, outputFilterOption, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// List of Vpp tokens for this organization.
