...
namespace ApiSdk.DeviceAppManagement.VppTokens.Item {
    ...
    public class VppTokenItemRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            }, new CollectionBinding(vppTokenIdOption, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// List of Vpp tokens for this organization.
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(vppTokenIdOption, selectOption, expandOption, outputOption, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// List of Vpp tokens for this organization.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                await RequestAdapter.SendNoContentAsync(requestInfo, errorMapping: default, cancellationToken: cancellationToken);
                Console.WriteLine("Success");
            }, new CollectionBinding(vppTokenIdOption, bodyOption, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        public Command BuildSyncLicensesCommand() {
            var command = new Command("sync-licenses");
            var builder = new ApiSdk.DeviceAppManagement.VppTokens.Item.SyncLicenses.SyncLicensesRequestBuilder(PathParameters, RequestAdapter);
