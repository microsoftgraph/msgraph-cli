...
namespace ApiSdk.DeviceAppManagement.VppTokens.Item {
    ...
    public class VppTokenRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string vppTokenId, IConsole console) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string vppTokenId, string[] select, string[] expand, FormatterType output, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string vppTokenId, string body, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
