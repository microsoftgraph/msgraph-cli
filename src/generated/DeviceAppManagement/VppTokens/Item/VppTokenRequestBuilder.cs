...
namespace ApiSdk.DeviceAppManagement.VppTokens.Item {
    ...
    public class VppTokenRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string vppTokenId, string[] select, string[] expand, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string vppTokenId, string body, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
