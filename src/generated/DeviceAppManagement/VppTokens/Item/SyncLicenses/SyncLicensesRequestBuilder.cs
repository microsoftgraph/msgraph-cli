...
namespace ApiSdk.DeviceAppManagement.VppTokens.Item.SyncLicenses {
    ...
    public class SyncLicensesRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (string vppTokenId, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                var requestInfo = CreatePostRequestInformation(q => {
                });
                var response = await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                var formatter = outputFormatterFactory.GetFormatter(output);
                formatter.WriteOutput(response, console);
            }, vppTokenIdOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
