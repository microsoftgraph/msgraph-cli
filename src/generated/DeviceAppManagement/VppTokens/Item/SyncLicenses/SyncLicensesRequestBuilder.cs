...
namespace ApiSdk.DeviceAppManagement.VppTokens.Item.SyncLicenses {
    ...
    public class SyncLicensesRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (string vppTokenId, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, vppTokenIdOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
