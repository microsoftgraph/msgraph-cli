...
namespace ApiSdk.DeviceAppManagement.ManagedEBooks.Item {
    ...
    public class ManagedEBookRequestBuilder {
        ...
        public Command BuildAssignCommand() {
            ...
            var builder = new ApiSdk.DeviceAppManagement.ManagedEBooks.Item.Assign.AssignRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string managedEBookId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, managedEBookIdOption, new ServiceProviderBinder());
            return command;
        }
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string managedEBookId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, managedEBookIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string managedEBookId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, managedEBookIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
