...
namespace ApiSdk.DeviceAppManagement.ManagedEBooks.Item.UserStateSummary.Item {
    ...
    public class UserInstallStateSummaryRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string managedEBookId, string userInstallStateSummaryId, string[] select, string[] expand) => {
                var requestInfo = CreateGetRequestInformation(q => {
                    q.Select = select;
                    q.Expand = expand;
                });
                var result = await RequestAdapter.SendAsync<UserInstallStateSummary>(requestInfo);
                // Print request output. What if the request has no return?
            ...
            }, managedEBookIdOption, userInstallStateSummaryIdOption, selectOption, expandOption);
            return command;
        }
        /// <summary>
        /// The list of installation states for this eBook.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string managedEBookId, string userInstallStateSummaryId, string body) => {
