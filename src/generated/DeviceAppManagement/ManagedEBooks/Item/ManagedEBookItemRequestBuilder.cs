...
namespace ApiSdk.DeviceAppManagement.ManagedEBooks.Item {
    ...
    public class ManagedEBookItemRequestBuilder {
        ...
        /// <param name="options">Request options</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(ManagedEBook body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
