...
namespace ApiSdk.DeviceAppManagement.ManagedEBooks.Item.DeviceStates.Item {
    ...
    public class DeviceInstallStateItemRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(managedEBookIdOption, deviceInstallStateIdOption, selectOption, expandOption, outputOption, outputFilterOption, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// The list of installation states for this eBook.
