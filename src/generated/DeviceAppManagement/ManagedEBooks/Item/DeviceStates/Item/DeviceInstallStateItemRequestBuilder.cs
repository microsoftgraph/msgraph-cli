    ...
    public class DeviceInstallStateItemRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                requestInfo.PathParameters.Add("deviceInstallState%2Did", deviceInstallStateId);
            ...
            }, new CollectionBinding(managedEBookIdOption, deviceInstallStateIdOption, ifMatchOption, new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        ...
        public DeviceInstallStateItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/deviceAppManagement/managedEBooks/{managedEBook%2Did}/deviceStates/{deviceInstallState%2Did}{?%24select,%24expand}";
