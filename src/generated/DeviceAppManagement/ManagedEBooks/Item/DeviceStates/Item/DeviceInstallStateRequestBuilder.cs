...
namespace ApiSdk.DeviceAppManagement.ManagedEBooks.Item.DeviceStates.Item {
    ...
    public class DeviceInstallStateRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string managedEBookId, string deviceInstallStateId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, managedEBookIdOption, deviceInstallStateIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The list of installation states for this eBook.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string managedEBookId, string deviceInstallStateId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, managedEBookIdOption, deviceInstallStateIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The list of installation states for this eBook.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string managedEBookId, string deviceInstallStateId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, managedEBookIdOption, deviceInstallStateIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
