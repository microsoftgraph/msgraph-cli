...
namespace ApiSdk.DeviceAppManagement.ManagedEBooks.Item.DeviceStates.Item {
    ...
    public class DeviceInstallStateRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string managedEBookId, string deviceInstallStateId, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                var requestInfo = CreateDeleteRequestInformation(q => {
                });
                await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                console.WriteLine("Success");
            }, managedEBookIdOption, deviceInstallStateIdOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// The list of installation states for this eBook.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string managedEBookId, string deviceInstallStateId, string[] select, string[] expand, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
            ...
            }, managedEBookIdOption, deviceInstallStateIdOption, selectOption, expandOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// The list of installation states for this eBook.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string managedEBookId, string deviceInstallStateId, string body, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                ...
                await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                console.WriteLine("Success");
            }, managedEBookIdOption, deviceInstallStateIdOption, bodyOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
