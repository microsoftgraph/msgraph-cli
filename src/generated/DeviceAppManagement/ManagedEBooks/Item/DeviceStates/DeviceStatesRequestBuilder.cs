...
namespace ApiSdk.DeviceAppManagement.ManagedEBooks.Item.DeviceStates {
    ...
    public class DeviceStatesRequestBuilder : BaseCliRequestBuilder {
        ...
        public DeviceStatesRequestBuilder(string rawUrl) : base("{+baseurl}/deviceAppManagement/managedEBooks/{managedEBook%2Did}/deviceStates{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// List properties and relationships of the deviceInstallState objects.
        /// </summary>
