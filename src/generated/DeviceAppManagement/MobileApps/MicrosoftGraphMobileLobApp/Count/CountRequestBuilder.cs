...
namespace ApiSdk.DeviceAppManagement.MobileApps.MicrosoftGraphMobileLobApp.Count {
    /// <summary>
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/deviceAppManagement/mobileApps/microsoft.graph.mobileLobApp/$count{?%24search,%24filter}";
