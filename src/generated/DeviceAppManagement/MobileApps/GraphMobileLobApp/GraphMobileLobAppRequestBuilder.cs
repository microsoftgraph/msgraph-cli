...
namespace ApiSdk.DeviceAppManagement.MobileApps.GraphMobileLobApp {
    ...
    public class GraphMobileLobAppRequestBuilder : BaseCliRequestBuilder {
        ...
        public GraphMobileLobAppRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/deviceAppManagement/mobileApps/graph.mobileLobApp{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Get the items of type microsoft.graph.mobileLobApp in the microsoft.graph.mobileApp collection
        /// </summary>
