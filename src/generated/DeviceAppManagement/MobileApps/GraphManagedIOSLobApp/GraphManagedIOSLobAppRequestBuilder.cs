...
namespace ApiSdk.DeviceAppManagement.MobileApps.GraphManagedIOSLobApp {
    ...
    public class GraphManagedIOSLobAppRequestBuilder : BaseCliRequestBuilder {
        ...
        public GraphManagedIOSLobAppRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/deviceAppManagement/mobileApps/graph.managedIOSLobApp{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new GraphManagedIOSLobAppRequestBuilder and sets the default values.
        /// </summary>
