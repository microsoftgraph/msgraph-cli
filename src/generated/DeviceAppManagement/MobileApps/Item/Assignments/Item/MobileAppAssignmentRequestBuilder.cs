...
namespace ApiSdk.DeviceAppManagement.MobileApps.Item.Assignments.Item {
    ...
    public class MobileAppAssignmentRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string mobileAppId, string mobileAppAssignmentId, IOutputFormatterFactory outputFormatterFactory, CancellationToken cancellationToken) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string mobileAppId, string mobileAppAssignmentId, string[] select, string[] expand, FormatterType output, IOutputFormatterFactory outputFormatterFactory, CancellationToken cancellationToken) => {
            ...
            }, mobileAppIdOption, mobileAppAssignmentIdOption, selectOption, expandOption, outputOption);
            return command;
        }
        /// <summary>
        /// The list of group assignments for this mobile app.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string mobileAppId, string mobileAppAssignmentId, string body, IOutputFormatterFactory outputFormatterFactory, CancellationToken cancellationToken) => {
