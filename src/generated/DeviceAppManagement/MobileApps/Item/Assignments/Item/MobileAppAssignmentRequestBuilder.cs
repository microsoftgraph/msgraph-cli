...
namespace ApiSdk.DeviceAppManagement.MobileApps.Item.Assignments.Item {
    ...
    public class MobileAppAssignmentRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string mobileAppId, string mobileAppAssignmentId, IConsole console) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string mobileAppId, string mobileAppAssignmentId, string[] select, string[] expand, FormatterType output, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string mobileAppId, string mobileAppAssignmentId, string body, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
