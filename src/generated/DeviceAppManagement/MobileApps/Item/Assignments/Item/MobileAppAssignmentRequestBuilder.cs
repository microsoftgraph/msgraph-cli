...
namespace ApiSdk.DeviceAppManagement.MobileApps.Item.Assignments.Item {
    ...
    public class MobileAppAssignmentRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string mobileAppId, string mobileAppAssignmentId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, mobileAppIdOption, mobileAppAssignmentIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The list of group assignments for this mobile app.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string mobileAppId, string mobileAppAssignmentId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, mobileAppIdOption, mobileAppAssignmentIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The list of group assignments for this mobile app.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string mobileAppId, string mobileAppAssignmentId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, mobileAppIdOption, mobileAppAssignmentIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
