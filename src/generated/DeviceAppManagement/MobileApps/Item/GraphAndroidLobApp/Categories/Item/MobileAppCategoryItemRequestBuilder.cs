...
namespace ApiSdk.DeviceAppManagement.MobileApps.Item.GraphAndroidLobApp.Categories.Item {
    ...
    public class MobileAppCategoryItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public MobileAppCategoryItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/graph.androidLobApp/categories/{mobileAppCategory%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new MobileAppCategoryItemRequestBuilder and sets the default values.
        /// </summary>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public MobileAppCategoryItemRequestBuilder(string rawUrl) : base("{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/graph.androidLobApp/categories/{mobileAppCategory%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// The list of categories for this app.
        /// </summary>
