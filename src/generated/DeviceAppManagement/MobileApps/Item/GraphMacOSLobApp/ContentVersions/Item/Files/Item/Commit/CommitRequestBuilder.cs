    ...
    public partial class CommitRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildPostCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<global::ApiSdk.DeviceAppManagement.MobileApps.Item.GraphMacOSLobApp.ContentVersions.Item.Files.Item.Commit.CommitPostRequestBody>(global::ApiSdk.DeviceAppManagement.MobileApps.Item.GraphMacOSLobApp.ContentVersions.Item.Files.Item.Commit.CommitPostRequestBody.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.DeviceAppManagement.MobileApps.Item.GraphMacOSLobApp.ContentVersions.Item.Files.Item.Commit.CommitRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public CommitRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/graph.macOSLobApp/contentVersions/{mobileAppContent%2Did}/files/{mobileAppContentFile%2Did}/commit", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.DeviceAppManagement.MobileApps.Item.GraphMacOSLobApp.ContentVersions.Item.Files.Item.Commit.CommitRequestBuilder"/> and sets the default values.
        ...
        public CommitRequestBuilder(string rawUrl) : base("{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/graph.macOSLobApp/contentVersions/{mobileAppContent%2Did}/files/{mobileAppContentFile%2Did}/commit", rawUrl)
        {
        }
        /// <summary>
        /// Commits a file of a given app.
...
#nullable enable
        public RequestInformation ToPostRequestInformation(global::ApiSdk.DeviceAppManagement.MobileApps.Item.GraphMacOSLobApp.ContentVersions.Item.Files.Item.Commit.CommitPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::ApiSdk.DeviceAppManagement.MobileApps.Item.GraphMacOSLobApp.ContentVersions.Item.Files.Item.Commit.CommitPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
