...
namespace ApiSdk.DeviceAppManagement.MobileApps.Item.Categories.Item {
    ...
    public class MobileAppCategoryItemRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                var mobileAppCategoryId = (string) parameters[1];
                ...
                requestInfo.PathParameters.Add("mobileAppCategory%2Did", mobileAppCategoryId);
            ...
            }, new CollectionBinding(mobileAppIdOption, mobileAppCategoryIdOption, selectOption, expandOption, outputOption, queryOption, jsonNoIndentOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
