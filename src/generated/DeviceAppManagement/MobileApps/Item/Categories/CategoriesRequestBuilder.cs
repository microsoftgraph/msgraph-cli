using ApiSdk.DeviceAppManagement.MobileApps.Item.Categories.Count;
using ApiSdk.DeviceAppManagement.MobileApps.Item.Categories.Item;
using ApiSdk.Models;
...
namespace ApiSdk.DeviceAppManagement.MobileApps.Item.Categories {
    ...
    public class CategoriesRequestBuilder : BaseCliRequestBuilder {
        ...
        public CategoriesRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/categories{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// The list of categories for this app.
        /// </summary>
...
#nullable restore
        ...
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<CategoriesRequestBuilderGetQueryParameters>> requestConfiguration = default) {
            ...
            if (requestConfiguration != null) {
                var requestConfig = new RequestConfiguration<CategoriesRequestBuilderGetQueryParameters>();
