...
namespace ApiSdk.DeviceAppManagement.MobileApps.Item.Categories.@Ref {
    ...
    public class RefRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.Handler = CommandHandler.Create<string, int?, int?, string, string, bool?, object>(async (mobileAppId, top, skip, search, filter, count, orderby) => {
        ...
        public Command BuildPostCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string>(async (mobileAppId, body) => {
                ...
                if (!String.IsNullOrEmpty(mobileAppId)) requestInfo.PathParameters.Add("mobileApp_id", mobileAppId);
                var result = await RequestAdapter.SendAsync<ApiSdk.DeviceAppManagement.MobileApps.Item.Categories.@Ref.@Ref>(requestInfo);
                // Print request output. What if the request has no return?
                using var serializer = RequestAdapter.SerializationWriterFactory.GetSerializationWriter("application/json");
                serializer.WriteObjectValue(null, result);
                using var content = serializer.GetSerializedContent();
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<ApiSdk.DeviceAppManagement.MobileApps.Item.Categories.@Ref.@Ref> PostAsync(ApiSdk.DeviceAppManagement.MobileApps.Item.Categories.@Ref.@Ref model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
