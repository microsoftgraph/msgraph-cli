...
namespace ApiSdk.DeviceAppManagement.MobileApps.GraphAndroidLobApp {
    ...
    public class GraphAndroidLobAppRequestBuilder : BaseCliRequestBuilder {
        ...
        public GraphAndroidLobAppRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/deviceAppManagement/mobileApps/graph.androidLobApp{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new GraphAndroidLobAppRequestBuilder and sets the default values.
        /// </summary>
