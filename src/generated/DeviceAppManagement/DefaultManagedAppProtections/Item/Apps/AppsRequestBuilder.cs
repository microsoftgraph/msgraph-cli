using ApiSdk.DeviceAppManagement.DefaultManagedAppProtections.Item.Apps.Count;
...
namespace ApiSdk.DeviceAppManagement.DefaultManagedAppProtections.Item.Apps {
    ...
    public class AppsRequestBuilder {
        ...
        public List<Command> BuildCommand() {
            var builder = new ManagedMobileAppItemRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildCreateCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                requestInfo.PathParameters.Add("defaultManagedAppProtection%2Did", defaultManagedAppProtectionId);
            ...
            }, new CollectionBinding(defaultManagedAppProtectionIdOption, bodyOption, outputOption, queryOption, jsonNoIndentOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        ...
        public AppsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/deviceAppManagement/defaultManagedAppProtections/{defaultManagedAppProtection%2Did}/apps{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
