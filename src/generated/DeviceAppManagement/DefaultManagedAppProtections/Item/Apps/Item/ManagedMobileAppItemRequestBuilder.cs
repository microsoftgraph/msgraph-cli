...
namespace ApiSdk.DeviceAppManagement.DefaultManagedAppProtections.Item.Apps.Item {
    ...
    public class ManagedMobileAppItemRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(defaultManagedAppProtectionIdOption, managedMobileAppIdOption, selectOption, expandOption, outputOption, outputFilterOption, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// List of apps to which the policy is deployed.
