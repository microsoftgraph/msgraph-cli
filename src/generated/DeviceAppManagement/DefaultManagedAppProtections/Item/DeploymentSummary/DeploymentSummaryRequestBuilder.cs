...
namespace ApiSdk.DeviceAppManagement.DefaultManagedAppProtections.Item.DeploymentSummary {
    ...
    public class DeploymentSummaryRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            }, defaultManagedAppProtectionIdOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// Navigation property to deployment summary of the configuration.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string defaultManagedAppProtectionId, string[] select, string[] expand, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
            ...
            }, defaultManagedAppProtectionIdOption, selectOption, expandOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// Navigation property to deployment summary of the configuration.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string defaultManagedAppProtectionId, string body, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                ...
                await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                console.WriteLine("Success");
            }, defaultManagedAppProtectionIdOption, bodyOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
