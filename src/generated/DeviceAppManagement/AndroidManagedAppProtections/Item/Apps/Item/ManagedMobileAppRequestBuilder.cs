...
namespace ApiSdk.DeviceAppManagement.AndroidManagedAppProtections.Item.Apps.Item {
    ...
    public class ManagedMobileAppRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string>(async (androidManagedAppProtectionId, managedMobileAppId) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, object, object>(async (androidManagedAppProtectionId, managedMobileAppId, select, expand) => {
        ...
        public Command BuildPatchCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string>(async (androidManagedAppProtectionId, managedMobileAppId, body) => {
