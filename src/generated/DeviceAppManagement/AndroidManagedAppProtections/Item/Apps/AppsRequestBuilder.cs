...
namespace ApiSdk.DeviceAppManagement.AndroidManagedAppProtections.Item.Apps {
    ...
    public class AppsRequestBuilder {
        ...
        public Command BuildCreateCommand() {
            ...
            command.SetHandler(async (string androidManagedAppProtectionId, string body, FormatterType output, IConsole console) => {
        ...
        public Command BuildListCommand() {
            ...
            command.AddOption(outputOption);
            command.SetHandler(async (string androidManagedAppProtectionId, int? top, int? skip, string search, string filter, bool? count, string[] orderby, string[] select, string[] expand, FormatterType output, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
