...
namespace ApiSdk.DeviceAppManagement.AndroidManagedAppProtections.Item.Apps {
    ...
    public class AppsRequestBuilder : BaseCliRequestBuilder {
        ...
        public AppsRequestBuilder(string rawUrl) : base("{+baseurl}/deviceAppManagement/androidManagedAppProtections/{androidManagedAppProtection%2Did}/apps{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// List of apps to which the policy is deployed.
        /// </summary>
