...
namespace ApiSdk.DeviceAppManagement.AndroidManagedAppProtections.Item.DeploymentSummary {
    ...
    public class DeploymentSummaryRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            }, new CollectionBinding(androidManagedAppProtectionIdOption, new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// Navigation property to deployment summary of the configuration.
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(androidManagedAppProtectionIdOption, selectOption, expandOption, outputOption, queryOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// Navigation property to deployment summary of the configuration.
