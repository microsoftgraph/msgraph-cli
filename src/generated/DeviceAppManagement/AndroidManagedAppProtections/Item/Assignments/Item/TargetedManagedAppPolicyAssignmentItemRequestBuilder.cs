...
namespace ApiSdk.DeviceAppManagement.AndroidManagedAppProtections.Item.Assignments.Item {
    ...
    public class TargetedManagedAppPolicyAssignmentItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public TargetedManagedAppPolicyAssignmentItemRequestBuilder(string rawUrl) : base("{+baseurl}/deviceAppManagement/androidManagedAppProtections/{androidManagedAppProtection%2Did}/assignments/{targetedManagedAppPolicyAssignment%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Delete navigation property assignments for deviceAppManagement
        /// </summary>
