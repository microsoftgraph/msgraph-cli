...
using System;
namespace ApiSdk.DeviceAppManagement.AndroidManagedAppProtections.Item.Assignments.Item {
    /// <summary>
    ...
    public class TargetedManagedAppPolicyAssignmentItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public TargetedManagedAppPolicyAssignmentItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/deviceAppManagement/androidManagedAppProtections/{androidManagedAppProtection%2Did}/assignments/{targetedManagedAppPolicyAssignment%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Delete navigation property assignments for deviceAppManagement
        /// </summary>
