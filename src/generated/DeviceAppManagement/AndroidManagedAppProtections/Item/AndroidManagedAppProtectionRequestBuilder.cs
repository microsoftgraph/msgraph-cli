...
namespace ApiSdk.DeviceAppManagement.AndroidManagedAppProtections.Item {
    ...
    public class AndroidManagedAppProtectionRequestBuilder {
        ...
        public Command BuildAppsCommand() {
            ...
            var builder = new ApiSdk.DeviceAppManagement.AndroidManagedAppProtections.Item.Apps.AppsRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string androidManagedAppProtectionId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, androidManagedAppProtectionIdOption, new ServiceProviderBinder());
            return command;
        }
        public Command BuildDeploymentSummaryCommand() {
            var command = new Command("deployment-summary");
            var builder = new ApiSdk.DeviceAppManagement.AndroidManagedAppProtections.Item.DeploymentSummary.DeploymentSummaryRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string androidManagedAppProtectionId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, androidManagedAppProtectionIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// Android managed app policies.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string androidManagedAppProtectionId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, androidManagedAppProtectionIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
