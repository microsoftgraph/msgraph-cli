...
namespace ApiSdk.DeviceAppManagement.AndroidManagedAppProtections.Item {
    ...
    public class AndroidManagedAppProtectionRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string androidManagedAppProtectionId, IConsole console) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string androidManagedAppProtectionId, string[] select, string[] expand, FormatterType output, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string androidManagedAppProtectionId, string body, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
