...
namespace ApiSdk.DeviceAppManagement.AndroidManagedAppProtections {
    ...
    public class AndroidManagedAppProtectionsRequestBuilder {
        ...
        public List<Command> BuildCommand() {
            var builder = new AndroidManagedAppProtectionRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildListCommand() {
            ...
            command.Handler = CommandHandler.Create<int?, int?, string, string, bool?, string[], string[], string[]>(async (top, skip, search, filter, count, orderby, select, expand) => {
                ...
                var result = await RequestAdapter.SendAsync<AndroidManagedAppProtectionsResponse>(requestInfo);
                // Print request output. What if the request has no return?
                using var serializer = RequestAdapter.SerializationWriterFactory.GetSerializationWriter("application/json");
                serializer.WriteObjectValue(null, result);
                using var content = serializer.GetSerializedContent();
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<AndroidManagedAppProtection> PostAsync(AndroidManagedAppProtection model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
