...
namespace ApiSdk.DeviceAppManagement.MobileAppConfigurations.Item.Assignments {
    ...
    public class AssignmentsRequestBuilder {
        ...
        public Command BuildCreateCommand() {
            ...
            }, new CollectionBinding(managedDeviceMobileAppConfigurationIdOption, bodyOption, outputOption, queryOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// The list of group assignemenets for app configration.
