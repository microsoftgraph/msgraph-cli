...
namespace ApiSdk.DeviceAppManagement.MobileAppConfigurations.Item.DeviceStatuses.Item {
    ...
    public class ManagedDeviceMobileAppConfigurationDeviceStatusItemRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            }, new CollectionBinding(managedDeviceMobileAppConfigurationIdOption, managedDeviceMobileAppConfigurationDeviceStatusIdOption, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// List of ManagedDeviceMobileAppConfigurationDeviceStatus.
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(managedDeviceMobileAppConfigurationIdOption, managedDeviceMobileAppConfigurationDeviceStatusIdOption, selectOption, expandOption, outputOption, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// List of ManagedDeviceMobileAppConfigurationDeviceStatus.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                await RequestAdapter.SendNoContentAsync(requestInfo, errorMapping: default, cancellationToken: cancellationToken);
                Console.WriteLine("Success");
            }, new CollectionBinding(managedDeviceMobileAppConfigurationIdOption, managedDeviceMobileAppConfigurationDeviceStatusIdOption, bodyOption, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
