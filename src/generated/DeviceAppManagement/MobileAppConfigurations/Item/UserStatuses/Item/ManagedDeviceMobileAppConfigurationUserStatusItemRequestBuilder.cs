    ...
    public class ManagedDeviceMobileAppConfigurationUserStatusItemRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                var managedDeviceMobileAppConfigurationUserStatusId = (string) parameters[1];
                ...
                PathParameters.Add("managedDeviceMobileAppConfigurationUserStatus_id", managedDeviceMobileAppConfigurationUserStatusId);
                var requestInfo = CreateDeleteRequestInformation(q => {
                });
                await RequestAdapter.SendNoContentAsync(requestInfo, errorMapping: default, cancellationToken: cancellationToken);
                Console.WriteLine("Success");
            }, new CollectionBinding(managedDeviceMobileAppConfigurationIdOption, managedDeviceMobileAppConfigurationUserStatusIdOption, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// List of ManagedDeviceMobileAppConfigurationUserStatus.
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(managedDeviceMobileAppConfigurationIdOption, managedDeviceMobileAppConfigurationUserStatusIdOption, selectOption, expandOption, outputOption, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// List of ManagedDeviceMobileAppConfigurationUserStatus.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                await RequestAdapter.SendNoContentAsync(requestInfo, errorMapping: default, cancellationToken: cancellationToken);
                Console.WriteLine("Success");
            }, new CollectionBinding(managedDeviceMobileAppConfigurationIdOption, managedDeviceMobileAppConfigurationUserStatusIdOption, bodyOption, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
