...
namespace ApiSdk.DeviceAppManagement.MobileAppConfigurations {
    ...
    public class MobileAppConfigurationsRequestBuilder {
        ...
        /// </summary>
        public RequestInformation CreateGetRequestInformation(Action<MobileAppConfigurationsRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ManagedDeviceMobileAppConfiguration body, Action<MobileAppConfigurationsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
