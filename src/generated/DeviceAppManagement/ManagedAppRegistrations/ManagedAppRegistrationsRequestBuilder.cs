...
namespace ApiSdk.DeviceAppManagement.ManagedAppRegistrations {
    ...
    public class ManagedAppRegistrationsRequestBuilder {
        ...
        public List<Command> BuildCommand() {
            ...
            commands.Add(builder.BuildAppliedPoliciesCommand());
            commands.Add(builder.BuildDeleteCommand());
            commands.Add(builder.BuildGetCommand());
            commands.Add(builder.BuildIntendedPoliciesCommand());
        ...
        /// <param name="options">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ManagedAppRegistration body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
