...
namespace ApiSdk.DeviceAppManagement.ManagedAppRegistrations.Item.Operations {
    ...
    public class OperationsRequestBuilder {
        ...
        public Command BuildListCommand() {
            ...
            command.Handler = CommandHandler.Create<string, int?, int?, string, string, bool?, object, object, object>(async (managedAppRegistrationId, top, skip, search, filter, count, orderby, select, expand) => {
