...
namespace ApiSdk.DeviceAppManagement.ManagedAppRegistrations.Item.Operations {
    ...
    public class OperationsRequestBuilder {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<ManagedAppOperation> PostAsync(ManagedAppOperation model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
