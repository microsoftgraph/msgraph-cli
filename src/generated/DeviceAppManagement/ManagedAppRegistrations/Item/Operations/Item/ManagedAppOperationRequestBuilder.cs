...
namespace ApiSdk.DeviceAppManagement.ManagedAppRegistrations.Item.Operations.Item {
    ...
    public class ManagedAppOperationRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string managedAppRegistrationId, string managedAppOperationId, IConsole console) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string managedAppRegistrationId, string managedAppOperationId, string[] select, string[] expand, FormatterType output, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
            ...
            }, managedAppRegistrationIdOption, managedAppOperationIdOption, selectOption, expandOption, outputOption);
            return command;
        }
        /// <summary>
        /// Zero or more long running operations triggered on the app registration.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string managedAppRegistrationId, string managedAppOperationId, string body, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
