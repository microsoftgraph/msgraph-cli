...
namespace ApiSdk.DeviceAppManagement.ManagedAppRegistrations.Item.Operations.Item {
    ...
    public class ManagedAppOperationRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string managedAppRegistrationId, string managedAppOperationId, IOutputFormatterFactory outputFormatterFactory, CancellationToken cancellationToken) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string managedAppRegistrationId, string managedAppOperationId, string[] select, string[] expand, FormatterType output, IOutputFormatterFactory outputFormatterFactory, CancellationToken cancellationToken) => {
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string managedAppRegistrationId, string managedAppOperationId, string body, IOutputFormatterFactory outputFormatterFactory, CancellationToken cancellationToken) => {
