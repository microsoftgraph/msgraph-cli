    ...
    public class TargetAppsRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.DeviceAppManagement.ManagedAppRegistrations.Item.AppliedPolicies.Item.ManagedAppProtection.TargetApps.TargetAppsRequestBody>(ApiSdk.DeviceAppManagement.ManagedAppRegistrations.Item.AppliedPolicies.Item.ManagedAppProtection.TargetApps.TargetAppsRequestBody.CreateFromDiscriminatorValue);
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ApiSdk.DeviceAppManagement.ManagedAppRegistrations.Item.AppliedPolicies.Item.ManagedAppProtection.TargetApps.TargetAppsRequestBody body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
