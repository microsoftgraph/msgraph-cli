...
namespace ApiSdk.DeviceAppManagement.ManagedAppRegistrations.Item.AppliedPolicies.Item.TargetedManagedAppProtection.TargetApps {
    ...
    public class TargetAppsRequestBody : IAdditionalDataHolder, IParsable {
        ...
        /// </summary>
        public static ApiSdk.DeviceAppManagement.ManagedAppRegistrations.Item.AppliedPolicies.Item.TargetedManagedAppProtection.TargetApps.TargetAppsRequestBody CreateFromDiscriminatorValue(IParseNode parseNode) {
