...
namespace ApiSdk.DeviceAppManagement.ManagedAppRegistrations.Item.AppliedPolicies {
    ...
    public class AppliedPoliciesRequestBuilder {
        ...
        public Command BuildCreateCommand() {
            ...
            }, new CollectionBinding(managedAppRegistrationIdOption, bodyOption, outputOption, queryOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// Zero or more policys already applied on the registered app when it last synchronized with managment service.
