...
namespace ApiSdk.DeviceAppManagement.ManagedAppRegistrations.Item.AppliedPolicies {
    ...
    public class AppliedPoliciesRequestBuilder {
        ...
        public List<Command> BuildCommand() {
            ...
            commands.Add(builder.BuildManagedAppProtectionCommand());
            commands.Add(builder.BuildPatchCommand());
            commands.Add(builder.BuildTargetAppsCommand());
            commands.Add(builder.BuildTargetedManagedAppProtectionCommand());
            commands.Add(builder.BuildWindowsInformationProtectionCommand());
            return commands;
        }
        /// <summary>
