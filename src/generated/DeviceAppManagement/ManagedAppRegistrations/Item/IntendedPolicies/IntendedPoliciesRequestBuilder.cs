...
namespace ApiSdk.DeviceAppManagement.ManagedAppRegistrations.Item.IntendedPolicies {
    ...
    public class IntendedPoliciesRequestBuilder : BaseCliRequestBuilder {
        ...
        public IntendedPoliciesRequestBuilder(string rawUrl) : base("{+baseurl}/deviceAppManagement/managedAppRegistrations/{managedAppRegistration%2Did}/intendedPolicies{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Zero or more policies admin intended for the app as of now.
        /// </summary>
