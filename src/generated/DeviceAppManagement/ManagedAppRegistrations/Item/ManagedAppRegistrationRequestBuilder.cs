...
namespace ApiSdk.DeviceAppManagement.ManagedAppRegistrations.Item {
    ...
    public class ManagedAppRegistrationRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string managedAppRegistrationId, IConsole console) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string managedAppRegistrationId, string[] select, string[] expand, FormatterType output, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string managedAppRegistrationId, string body, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
