...
namespace ApiSdk.DeviceAppManagement.WindowsInformationProtectionPolicies.Item.ExemptAppLockerFiles.Item {
    ...
    public class WindowsInformationProtectionAppLockerFileItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public WindowsInformationProtectionAppLockerFileItemRequestBuilder(string rawUrl) : base("{+baseurl}/deviceAppManagement/windowsInformationProtectionPolicies/{windowsInformationProtectionPolicy%2Did}/exemptAppLockerFiles/{windowsInformationProtectionAppLockerFile%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Delete navigation property exemptAppLockerFiles for deviceAppManagement
        /// </summary>
