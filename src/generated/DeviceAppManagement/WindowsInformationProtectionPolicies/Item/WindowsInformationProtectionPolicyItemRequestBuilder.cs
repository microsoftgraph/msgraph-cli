...
namespace ApiSdk.DeviceAppManagement.WindowsInformationProtectionPolicies.Item {
    ...
    public class WindowsInformationProtectionPolicyItemRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            var windowsInformationProtectionPolicyIdOption = new Option<string>("--windows-information-protection-policy-id", description: "key: id of windowsInformationProtectionPolicy") {
            };
            ...
            command.SetHandler(async (object[] parameters) => {
                var windowsInformationProtectionPolicyId = (string) parameters[0];
                var ifMatch = (string) parameters[1];
                var cancellationToken = (CancellationToken) parameters[2];
                var requestInfo = CreateDeleteRequestInformation(q => {
                });
                requestInfo.PathParameters.Add("windowsInformationProtectionPolicy%2Did", windowsInformationProtectionPolicyId);
            ...
            }, new CollectionBinding(windowsInformationProtectionPolicyIdOption, ifMatchOption, new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(windowsInformationProtectionPolicyIdOption, selectOption, expandOption, outputOption, queryOption, jsonNoIndentOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                await RequestAdapter.SendNoContentAsync(requestInfo, errorMapping: errorMapping, cancellationToken: cancellationToken);
                Console.WriteLine("Success");
            }, new CollectionBinding(windowsInformationProtectionPolicyIdOption, bodyOption, new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
