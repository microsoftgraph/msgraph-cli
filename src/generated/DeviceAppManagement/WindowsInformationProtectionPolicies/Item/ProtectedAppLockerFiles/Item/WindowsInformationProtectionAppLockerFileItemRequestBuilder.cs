...
namespace ApiSdk.DeviceAppManagement.WindowsInformationProtectionPolicies.Item.ProtectedAppLockerFiles.Item {
    ...
    public class WindowsInformationProtectionAppLockerFileItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public WindowsInformationProtectionAppLockerFileItemRequestBuilder(string rawUrl) : base("{+baseurl}/deviceAppManagement/windowsInformationProtectionPolicies/{windowsInformationProtectionPolicy%2Did}/protectedAppLockerFiles/{windowsInformationProtectionAppLockerFile%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Delete navigation property protectedAppLockerFiles for deviceAppManagement
        /// </summary>
