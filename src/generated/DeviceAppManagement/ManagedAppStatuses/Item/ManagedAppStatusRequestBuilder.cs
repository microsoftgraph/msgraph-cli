...
namespace ApiSdk.DeviceAppManagement.ManagedAppStatuses.Item {
    ...
    public class ManagedAppStatusRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string managedAppStatusId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, managedAppStatusIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The managed app statuses.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string managedAppStatusId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, managedAppStatusIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The managed app statuses.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string managedAppStatusId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, managedAppStatusIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
