...
namespace ApiSdk.Devices.GetAvailableExtensionProperties {
    ...
    public class GetAvailableExtensionPropertiesRequestBody : IAdditionalDataHolder, IParsable {
        ...
        /// </summary>
        public static ApiSdk.Devices.GetAvailableExtensionProperties.GetAvailableExtensionPropertiesRequestBody CreateFromDiscriminatorValue(IParseNode parseNode) {
