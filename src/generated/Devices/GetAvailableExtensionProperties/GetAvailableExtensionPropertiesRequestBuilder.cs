...
namespace ApiSdk.Devices.GetAvailableExtensionProperties {
    ...
    public class GetAvailableExtensionPropertiesRequestBuilder : BaseCliRequestBuilder {
        ...
        public GetAvailableExtensionPropertiesRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/devices/getAvailableExtensionProperties", pathParameters) {
        }
        /// <summary>
        /// Invoke action getAvailableExtensionProperties
        /// </summary>
