...
namespace ApiSdk.Devices {
    ...
    public class DevicesRequestBuilder {
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ApiSdk.Models.Device body, Action<DevicesRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
