...
namespace ApiSdk.Devices {
    ...
    public class DevicesRequestBuilder {
        ...
        public List<Command> BuildCommand() {
            var builder = new DeviceItemRequestBuilder(PathParameters, RequestAdapter);
            ...
            commands.Add(builder.BuildRegisteredOwnersCommand());
            commands.Add(builder.BuildRegisteredUsersCommand());
        ...
        public Command BuildCreateCommand() {
            ...
            command.Description = "Add new entity to devices";
        ...
        public Command BuildGetAvailableExtensionPropertiesCommand() {
            ...
            var builder = new ApiSdk.Devices.GetAvailableExtensionProperties.GetAvailableExtensionPropertiesRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildPostCommand());
            return command;
        }
        public Command BuildGetByIdsCommand() {
            var command = new Command("get-by-ids");
            var builder = new ApiSdk.Devices.GetByIds.GetByIdsRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildPostCommand());
            return command;
        }
        /// <summary>
        ...
        public Command BuildListCommand() {
            ...
            command.Description = "Get entities from devices";
            // Create options for all the parameters
        ...
        public Command BuildValidatePropertiesCommand() {
            ...
            var builder = new ApiSdk.Devices.ValidateProperties.ValidatePropertiesRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildPostCommand());
            return command;
        }
        /// <summary>
