...
namespace ApiSdk.Devices.Item.MemberOf.Item.MicrosoftGraphServicePrincipal {
    /// <summary>
    ...
    public class MicrosoftGraphServicePrincipalRequestBuilder {
        ...
        public MicrosoftGraphServicePrincipalRequestBuilder(Dictionary<string, object> pathParameters) {
            ...
            UrlTemplate = "{+baseurl}/devices/{device%2Did}/memberOf/{directoryObject%2Did}/microsoft.graph.servicePrincipal{?%24select,%24expand}";
