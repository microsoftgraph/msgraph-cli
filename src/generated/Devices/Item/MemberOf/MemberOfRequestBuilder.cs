...
using ApiSdk.Devices.Item.MemberOf.MicrosoftGraphApplication;
using ApiSdk.Devices.Item.MemberOf.MicrosoftGraphDevice;
using ApiSdk.Devices.Item.MemberOf.MicrosoftGraphGroup;
using ApiSdk.Devices.Item.MemberOf.MicrosoftGraphOrgContact;
using ApiSdk.Devices.Item.MemberOf.MicrosoftGraphServicePrincipal;
using ApiSdk.Devices.Item.MemberOf.MicrosoftGraphUser;
using ApiSdk.Models;
...
namespace ApiSdk.Devices.Item.MemberOf {
    ...
    public class MemberOfRequestBuilder {
        ...
        public MemberOfRequestBuilder(Dictionary<string, object> pathParameters) {
            ...
            UrlTemplate = "{+baseurl}/devices/{device%2Did}/memberOf{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
