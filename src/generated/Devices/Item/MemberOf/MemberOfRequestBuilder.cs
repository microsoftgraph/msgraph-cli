...
namespace ApiSdk.Devices.Item.MemberOf {
    ...
    public class MemberOfRequestBuilder : BaseCliRequestBuilder {
        ...
        public MemberOfRequestBuilder(string rawUrl) : base("{+baseurl}/devices/{device%2Did}/memberOf{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Groups and administrative units that this device is a member of. Read-only. Nullable. Supports $expand.
        /// </summary>
