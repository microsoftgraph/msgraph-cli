...
namespace ApiSdk.Devices.Item {
    ...
    public class DeviceRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string deviceId, string[] select, string[] expand, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string deviceId, string body, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
