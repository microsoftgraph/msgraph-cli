using ApiSdk.Devices.Item.RegisteredOwners.MicrosoftGraphServicePrincipal.Count;
using ApiSdk.Models;
...
namespace ApiSdk.Devices.Item.RegisteredOwners.MicrosoftGraphServicePrincipal {
    /// <summary>
