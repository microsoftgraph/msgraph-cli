using ApiSdk.Devices.Item.RegisteredOwners.GraphAppRoleAssignment.Count;
using ApiSdk.Models;
...
namespace ApiSdk.Devices.Item.RegisteredOwners.GraphAppRoleAssignment {
    /// <summary>
    ...
    public class GraphAppRoleAssignmentRequestBuilder : BaseCliRequestBuilder {
        ...
        public GraphAppRoleAssignmentRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/devices/{device%2Did}/registeredOwners/graph.appRoleAssignment{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Get the items of type microsoft.graph.appRoleAssignment in the microsoft.graph.directoryObject collection
        /// </summary>
