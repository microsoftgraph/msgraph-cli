using ApiSdk.Devices.Item.RegisteredOwners.MicrosoftGraphAppRoleAssignment.Count;
using ApiSdk.Models;
...
namespace ApiSdk.Devices.Item.RegisteredOwners.MicrosoftGraphAppRoleAssignment {
    /// <summary>
