using ApiSdk.Devices.Item.RegisteredOwners.Item.AppRoleAssignment;
using ApiSdk.Devices.Item.RegisteredOwners.Item.Endpoint;
using ApiSdk.Devices.Item.RegisteredOwners.Item.Ref;
using ApiSdk.Devices.Item.RegisteredOwners.Item.ServicePrincipal;
using ApiSdk.Devices.Item.RegisteredOwners.Item.User;
...
namespace ApiSdk.Devices.Item.RegisteredOwners.Item {
    /// <summary>Builds and executes requests for operations under \devices\{device-id}\registeredOwners\{directoryObject-id}</summary>
