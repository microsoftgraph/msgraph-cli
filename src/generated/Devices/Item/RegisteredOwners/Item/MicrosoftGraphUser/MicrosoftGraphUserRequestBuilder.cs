...
namespace ApiSdk.Devices.Item.RegisteredOwners.Item.MicrosoftGraphUser {
    /// <summary>
    ...
    public class MicrosoftGraphUserRequestBuilder {
        ...
        public MicrosoftGraphUserRequestBuilder(Dictionary<string, object> pathParameters) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            UrlTemplate = "{+baseurl}/devices/{device%2Did}/registeredOwners/{directoryObject%2Did}/microsoft.graph.user{?%24select,%24expand}";
