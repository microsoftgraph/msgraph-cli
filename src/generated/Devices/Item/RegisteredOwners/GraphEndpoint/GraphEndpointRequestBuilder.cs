using ApiSdk.Devices.Item.RegisteredOwners.GraphEndpoint.Count;
using ApiSdk.Models;
...
namespace ApiSdk.Devices.Item.RegisteredOwners.GraphEndpoint {
    /// <summary>
    ...
    public class GraphEndpointRequestBuilder : BaseCliRequestBuilder {
        ...
        public GraphEndpointRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/devices/{device%2Did}/registeredOwners/graph.endpoint{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Get the items of type microsoft.graph.endpoint in the microsoft.graph.directoryObject collection
        /// </summary>
