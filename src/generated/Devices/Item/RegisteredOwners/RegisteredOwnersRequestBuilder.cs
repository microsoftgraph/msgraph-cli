    ...
    public class RegisteredOwnersRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.Handler = CommandHandler.Create<string, int?, int?, string, string, bool?, object, object, object>(async (deviceId, top, skip, search, filter, count, orderby, select, expand) => {
                ...
                var result = await RequestAdapter.SendAsync<RegisteredOwnersResponse>(requestInfo);
        ...
        public Command BuildRefCommand() {
            ...
            var builder = new ApiSdk.Devices.Item.RegisteredOwners.@Ref.RefRequestBuilder(PathParameters, RequestAdapter);
