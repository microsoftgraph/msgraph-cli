...
namespace ApiSdk.Devices.Item.TransitiveMemberOf.OrgContact.Count {
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/devices/{device%2Did}/transitiveMemberOf/microsoft.graph.orgContact/$count";
