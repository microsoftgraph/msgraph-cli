...
namespace ApiSdk.Devices.Item.TransitiveMemberOf.Item {
    ...
    public class DirectoryObjectItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public DirectoryObjectItemRequestBuilder(string rawUrl) : base("{+baseurl}/devices/{device%2Did}/transitiveMemberOf/{directoryObject%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Groups and administrative units that the device is a member of. This operation is transitive. Supports $expand.
        /// </summary>
