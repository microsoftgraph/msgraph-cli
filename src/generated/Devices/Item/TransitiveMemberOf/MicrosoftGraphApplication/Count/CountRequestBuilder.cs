...
namespace ApiSdk.Devices.Item.TransitiveMemberOf.MicrosoftGraphApplication.Count {
    /// <summary>
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters) {
            ...
            UrlTemplate = "{+baseurl}/devices/{device%2Did}/transitiveMemberOf/microsoft.graph.application/$count{?%24search,%24filter}";
