...
namespace ApiSdk.Devices.Item.RegisteredUsers.AppRoleAssignment.Count {
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/devices/{device%2Did}/registeredUsers/microsoft.graph.appRoleAssignment/$count";
