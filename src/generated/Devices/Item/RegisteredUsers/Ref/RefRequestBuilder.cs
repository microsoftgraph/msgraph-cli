...
namespace ApiSdk.Devices.Item.RegisteredUsers.Ref {
    ...
    public class RefRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string deviceId, int? top, int? skip, string search, string filter, bool? count, string[] orderby, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, deviceIdOption, topOption, skipOption, searchOption, filterOption, countOption, orderbyOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// Collection of registered users of the device. For cloud joined devices and registered personal devices, registered users are set to the same value as registered owners at the time of registration. Read-only. Nullable. Supports $expand.
        ...
        public Command BuildPostCommand() {
            ...
            command.AddOption(outputOption);
            command.SetHandler(async (string deviceId, string body, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, deviceIdOption, bodyOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
