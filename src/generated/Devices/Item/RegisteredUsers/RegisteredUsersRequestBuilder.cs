    ...
    public class RegisteredUsersRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string deviceId, int? top, int? skip, string search, string filter, bool? count, string[] orderby, string[] select, string[] expand) => {
                ...
                var result = await RequestAdapter.SendAsync<RegisteredUsersResponse>(requestInfo);
        ...
        public Command BuildRefCommand() {
            ...
            var builder = new ApiSdk.Devices.Item.RegisteredUsers.@Ref.RefRequestBuilder(PathParameters, RequestAdapter);
