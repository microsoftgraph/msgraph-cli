...
namespace ApiSdk.Devices.Item.RegisteredUsers.Item.GraphEndpoint {
    /// <summary>
    ...
    public class GraphEndpointRequestBuilder : BaseCliRequestBuilder {
        ...
        public GraphEndpointRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/devices/{device%2Did}/registeredUsers/{directoryObject%2Did}/graph.endpoint{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Get the item of type microsoft.graph.directoryObject as microsoft.graph.endpoint
        /// </summary>
