...
namespace ApiSdk.Devices.Item.Restore {
    ...
    public class RestoreRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (string deviceId, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, deviceIdOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
