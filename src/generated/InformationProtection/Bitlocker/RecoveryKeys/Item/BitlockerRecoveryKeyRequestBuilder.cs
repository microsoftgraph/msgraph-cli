...
namespace ApiSdk.InformationProtection.Bitlocker.RecoveryKeys.Item {
    ...
    public class BitlockerRecoveryKeyRequestBuilder {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(BitlockerRecoveryKey model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
