...
namespace ApiSdk.InformationProtection.Bitlocker.RecoveryKeys.Item {
    ...
    public class BitlockerRecoveryKeyRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string bitlockerRecoveryKeyId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, bitlockerRecoveryKeyIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The recovery keys associated with the bitlocker entity.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string bitlockerRecoveryKeyId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, bitlockerRecoveryKeyIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The recovery keys associated with the bitlocker entity.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string bitlockerRecoveryKeyId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, bitlockerRecoveryKeyIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(BitlockerRecoveryKey model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
