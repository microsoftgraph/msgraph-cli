...
namespace ApiSdk.InformationProtection.Bitlocker.RecoveryKeys.Item {
    ...
    public class BitlockerRecoveryKeyRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string bitlockerRecoveryKeyId, IConsole console) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string bitlockerRecoveryKeyId, string[] select, string[] expand, FormatterType output, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string bitlockerRecoveryKeyId, string body, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
