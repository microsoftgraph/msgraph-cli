...
namespace ApiSdk.InformationProtection.Bitlocker.RecoveryKeys.Item {
    ...
    public class BitlockerRecoveryKeyRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            }, bitlockerRecoveryKeyIdOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// The recovery keys associated with the bitlocker entity.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string bitlockerRecoveryKeyId, string[] select, string[] expand, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
            ...
            }, bitlockerRecoveryKeyIdOption, selectOption, expandOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// The recovery keys associated with the bitlocker entity.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string bitlockerRecoveryKeyId, string body, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                ...
                await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                console.WriteLine("Success");
            }, bitlockerRecoveryKeyIdOption, bodyOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
