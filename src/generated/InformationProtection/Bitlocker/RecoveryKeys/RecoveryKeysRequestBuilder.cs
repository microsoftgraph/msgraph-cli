...
namespace ApiSdk.InformationProtection.Bitlocker.RecoveryKeys {
    ...
    public class RecoveryKeysRequestBuilder {
        ...
        public Command BuildCommand() {
            ...
            var builder = new BitlockerRecoveryKeyItemRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildCreateCommand() {
            ...
            command.Description = "Create new navigation property to recoveryKeys for informationProtection";
