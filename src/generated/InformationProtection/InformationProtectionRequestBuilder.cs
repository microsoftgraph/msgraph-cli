...
namespace ApiSdk.InformationProtection {
    ...
    public class InformationProtectionRequestBuilder {
        ...
        public Command BuildBitlockerCommand() {
            ...
            var builder = new BitlockerRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Models.Microsoft.Graph.InformationProtection>(ApiSdk.Models.Microsoft.Graph.InformationProtection.CreateFromDiscriminatorValue);
        ...
        public Command BuildThreatAssessmentRequestsCommand() {
            ...
            var builder = new ThreatAssessmentRequestsRequestBuilder(PathParameters, RequestAdapter);
        ...
        /// <param name="options">Request options</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(ApiSdk.Models.Microsoft.Graph.InformationProtection body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
