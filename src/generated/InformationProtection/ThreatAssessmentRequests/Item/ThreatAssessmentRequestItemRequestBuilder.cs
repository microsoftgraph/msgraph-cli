...
namespace ApiSdk.InformationProtection.ThreatAssessmentRequests.Item {
    ...
    public class ThreatAssessmentRequestItemRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(threatAssessmentRequestIdOption, selectOption, expandOption, outputOption, queryOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
