...
namespace ApiSdk.InformationProtection.ThreatAssessmentRequests.Item {
    ...
    public class ThreatAssessmentRequestItemRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(threatAssessmentRequestIdOption, selectOption, expandOption, outputOption, outputFilterOption, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
