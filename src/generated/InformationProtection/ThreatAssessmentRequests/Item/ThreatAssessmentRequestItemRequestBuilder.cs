...
namespace ApiSdk.InformationProtection.ThreatAssessmentRequests.Item {
    ...
    public class ThreatAssessmentRequestItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.Description = "Retrieve the properties and relationships of a specified threatAssessmentRequest object. A threat assessment request can be one of the following types: This API is available in the following national cloud deployments.\n\nFind more info here:\n  https://learn.microsoft.com/graph/api/threatassessmentrequest-get?view=graph-rest-1.0";
            var threatAssessmentRequestIdOption = new Option<string>("--threat-assessment-request-id", description: "The unique identifier of threatAssessmentRequest") {
            };
            threatAssessmentRequestIdOption.IsRequired = true;
            command.AddOption(threatAssessmentRequestIdOption);
        ...
        public ThreatAssessmentRequestItemRequestBuilder(string rawUrl) : base("{+baseurl}/informationProtection/threatAssessmentRequests/{threatAssessmentRequest%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Delete navigation property threatAssessmentRequests for informationProtection
        /// </summary>
