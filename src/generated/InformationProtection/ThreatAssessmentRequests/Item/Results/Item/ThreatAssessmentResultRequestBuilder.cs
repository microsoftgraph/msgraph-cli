...
namespace ApiSdk.InformationProtection.ThreatAssessmentRequests.Item.Results.Item {
    ...
    public class ThreatAssessmentResultRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string threatAssessmentRequestId, string threatAssessmentResultId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, threatAssessmentRequestIdOption, threatAssessmentResultIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// A collection of threat assessment results. Read-only. By default, a GET /threatAssessmentRequests/{id} does not return this property unless you apply $expand on it.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string threatAssessmentRequestId, string threatAssessmentResultId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, threatAssessmentRequestIdOption, threatAssessmentResultIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// A collection of threat assessment results. Read-only. By default, a GET /threatAssessmentRequests/{id} does not return this property unless you apply $expand on it.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string threatAssessmentRequestId, string threatAssessmentResultId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, threatAssessmentRequestIdOption, threatAssessmentResultIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
