...
namespace ApiSdk.InformationProtection.ThreatAssessmentRequests.Item.Results.Item {
    ...
    public class ThreatAssessmentResultRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string threatAssessmentRequestId, string threatAssessmentResultId, IConsole console) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string threatAssessmentRequestId, string threatAssessmentResultId, string[] select, string[] expand, FormatterType output, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string threatAssessmentRequestId, string threatAssessmentResultId, string body, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
