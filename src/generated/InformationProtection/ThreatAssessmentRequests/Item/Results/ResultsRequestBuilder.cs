...
namespace ApiSdk.InformationProtection.ThreatAssessmentRequests.Item.Results {
    ...
    public class ResultsRequestBuilder {
        ...
        public Command BuildListCommand() {
            ...
            command.Handler = CommandHandler.Create<string, int?, int?, string, string, bool?, object, object, object>(async (threatAssessmentRequestId, top, skip, search, filter, count, orderby, select, expand) => {
