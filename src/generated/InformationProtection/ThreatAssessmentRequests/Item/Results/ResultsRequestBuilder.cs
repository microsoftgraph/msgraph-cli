using ApiSdk.InformationProtection.ThreatAssessmentRequests.Item.Results.Count;
...
namespace ApiSdk.InformationProtection.ThreatAssessmentRequests.Item.Results {
    ...
    public class ResultsRequestBuilder {
        ...
        public Command BuildCreateCommand() {
            ...
            }, new CollectionBinding(threatAssessmentRequestIdOption, bodyOption, outputOption, queryOption, jsonNoIndentOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
