...
namespace ApiSdk.Sites.GetAllSites {
    ...
    public class GetAllSitesRequestBuilder : BaseCliRequestBuilder {
        ...
        public GetAllSitesRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/sites/getAllSites(){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}", pathParameters) {
        }
        /// <summary>
        /// Invoke function getAllSites
        /// </summary>
