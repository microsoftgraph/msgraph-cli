...
namespace ApiSdk.Sites.Item.Drives.Item {
    ...
    public class DriveRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string siteId, string driveId) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string siteId, string driveId, string[] select, string[] expand) => {
            ...
            }, siteIdOption, driveIdOption, selectOption, expandOption);
            return command;
        }
        /// <summary>
        /// The collection of drives (document libraries) under this site.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string siteId, string driveId, string body) => {
