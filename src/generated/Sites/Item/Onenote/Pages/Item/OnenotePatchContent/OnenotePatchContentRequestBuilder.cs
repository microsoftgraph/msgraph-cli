    ...
    public class OnenotePatchContentRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildPostCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Sites.Item.Onenote.Pages.Item.OnenotePatchContent.OnenotePatchContentPostRequestBody>(ApiSdk.Sites.Item.Onenote.Pages.Item.OnenotePatchContent.OnenotePatchContentPostRequestBody.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Sites.Item.Onenote.Pages.Item.OnenotePatchContent.OnenotePatchContentRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public RequestInformation ToPostRequestInformation(ApiSdk.Sites.Item.Onenote.Pages.Item.OnenotePatchContent.OnenotePatchContentPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(ApiSdk.Sites.Item.Onenote.Pages.Item.OnenotePatchContent.OnenotePatchContentPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
