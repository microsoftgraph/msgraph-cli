...
namespace ApiSdk.Sites.Item.Onenote.Pages.Item.ParentNotebook.SectionGroups.Item.Sections.Item.ParentNotebook {
    ...
    public class ParentNotebookRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string siteId, string onenotePageId, string sectionGroupId, string onenoteSectionId, string[] select, string[] expand) => {
            ...
            }, siteIdOption, onenotePageIdOption, sectionGroupIdOption, onenoteSectionIdOption, selectOption, expandOption);
            return command;
        }
        /// <summary>
        /// The notebook that contains the section.  Read-only.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string siteId, string onenotePageId, string sectionGroupId, string onenoteSectionId, string body) => {
