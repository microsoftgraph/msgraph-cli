...
namespace ApiSdk.Sites.Item.Onenote.Pages.Item.ParentNotebook.SectionGroups.Item.Sections.Item.Pages {
    ...
    public class PagesRequestBuilder {
        ...
        public Command BuildListCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string, string, int?, int?, string, string, bool?, object, object, object>(async (siteId, onenotePageId, sectionGroupId, onenoteSectionId, top, skip, search, filter, count, orderby, select, expand) => {
