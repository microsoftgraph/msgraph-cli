...
namespace ApiSdk.Sites.Item.Onenote.Pages.Item.ParentNotebook.Sections.Item.ParentSectionGroup.SectionGroups.Item {
    ...
    public class SectionGroupRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string siteId, string onenotePageId, string onenoteSectionId, string sectionGroupId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, siteIdOption, onenotePageIdOption, onenoteSectionIdOption, sectionGroupIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The section groups in the section. Read-only. Nullable.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string siteId, string onenotePageId, string onenoteSectionId, string sectionGroupId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, siteIdOption, onenotePageIdOption, onenoteSectionIdOption, sectionGroupIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The section groups in the section. Read-only. Nullable.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string siteId, string onenotePageId, string onenoteSectionId, string sectionGroupId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, siteIdOption, onenotePageIdOption, onenoteSectionIdOption, sectionGroupIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
