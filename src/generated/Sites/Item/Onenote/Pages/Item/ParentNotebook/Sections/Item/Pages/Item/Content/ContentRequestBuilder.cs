...
namespace ApiSdk.Sites.Item.Onenote.Pages.Item.ParentNotebook.Sections.Item.Pages.Item.Content {
    ...
    public class ContentRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string siteId, string onenotePageId, string onenoteSectionId, string onenotePageId1, FileInfo file, FormatterType output, IConsole console) => {
        ...
        public Command BuildPutCommand() {
            ...
            command.SetHandler(async (string siteId, string onenotePageId, string onenoteSectionId, string onenotePageId1, FileInfo file, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
