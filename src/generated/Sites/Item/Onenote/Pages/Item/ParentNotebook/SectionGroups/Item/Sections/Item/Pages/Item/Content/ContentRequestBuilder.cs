...
namespace ApiSdk.Sites.Item.Onenote.Pages.Item.ParentNotebook.SectionGroups.Item.Sections.Item.Pages.Item.Content {
    ...
    public class ContentRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string, string, string, FileInfo>(async (siteId, onenotePageId, sectionGroupId, onenoteSectionId, onenotePageId1, output) => {
        ...
        public Command BuildPutCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string, string, string, FileInfo>(async (siteId, onenotePageId, sectionGroupId, onenoteSectionId, onenotePageId1, file) => {
