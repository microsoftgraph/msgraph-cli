...
namespace ApiSdk.Sites.Item.Onenote.Pages.Item {
    ...
    public class OnenotePageItemRequestBuilder {
        ...
        public Command BuildContentCommand() {
            ...
            var builder = new ApiSdk.Sites.Item.Onenote.Pages.Item.Content.ContentRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildCopyToSectionCommand() {
            ...
            var builder = new ApiSdk.Sites.Item.Onenote.Pages.Item.CopyToSection.CopyToSectionRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildDeleteCommand() {
            ...
            }, new CollectionBinding(siteIdOption, onenotePageIdOption, new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// The pages in all OneNote notebooks that are owned by the user or group.  Read-only. Nullable.
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(siteIdOption, onenotePageIdOption, selectOption, expandOption, outputOption, queryOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        public Command BuildOnenotePatchContentCommand() {
            var command = new Command("onenote-patch-content");
            var builder = new ApiSdk.Sites.Item.Onenote.Pages.Item.OnenotePatchContent.OnenotePatchContentRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildPostCommand());
            return command;
        }
        public Command BuildParentNotebookCommand() {
            var command = new Command("parent-notebook");
            var builder = new ApiSdk.Sites.Item.Onenote.Pages.Item.ParentNotebook.ParentNotebookRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildParentSectionCommand() {
            ...
            var builder = new ApiSdk.Sites.Item.Onenote.Pages.Item.ParentSection.ParentSectionRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                await RequestAdapter.SendNoContentAsync(requestInfo, errorMapping: default, cancellationToken: cancellationToken);
                Console.WriteLine("Success");
            }, new CollectionBinding(siteIdOption, onenotePageIdOption, bodyOption, new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
