...
namespace ApiSdk.Sites.Item.Onenote.Pages.Item.ParentSection.Pages.Item.CopyToSection {
    ...
    public class CopyToSectionRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (string siteId, string onenotePageId, string onenotePageId1, string body, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, siteIdOption, onenotePageIdOption, onenotePageId1Option, bodyOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
