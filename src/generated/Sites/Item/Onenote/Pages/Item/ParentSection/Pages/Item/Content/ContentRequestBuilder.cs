...
namespace ApiSdk.Sites.Item.Onenote.Pages.Item.ParentSection.Pages.Item.Content {
    ...
    public class ContentRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string siteId, string onenotePageId, string onenotePageId1, FileInfo file, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
            ...
            }, siteIdOption, onenotePageIdOption, onenotePageId1Option, fileOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        ...
        public Command BuildPutCommand() {
            ...
            command.SetHandler(async (string siteId, string onenotePageId, string onenotePageId1, FileInfo file, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
