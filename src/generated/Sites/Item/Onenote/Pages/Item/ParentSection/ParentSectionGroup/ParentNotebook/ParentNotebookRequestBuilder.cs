...
namespace ApiSdk.Sites.Item.Onenote.Pages.Item.ParentSection.ParentSectionGroup.ParentNotebook {
    ...
    public class ParentNotebookRequestBuilder {
        ...
        public Command BuildCopyNotebookCommand() {
            ...
            var builder = new ApiSdk.Sites.Item.Onenote.Pages.Item.ParentSection.ParentSectionGroup.ParentNotebook.CopyNotebook.CopyNotebookRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string siteId, string onenotePageId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, siteIdOption, onenotePageIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The notebook that contains the section group. Read-only.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string siteId, string onenotePageId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, siteIdOption, onenotePageIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The notebook that contains the section group. Read-only.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string siteId, string onenotePageId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, siteIdOption, onenotePageIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        public Command BuildSectionGroupsCommand() {
            var command = new Command("section-groups");
            var builder = new ApiSdk.Sites.Item.Onenote.Pages.Item.ParentSection.ParentSectionGroup.ParentNotebook.SectionGroups.SectionGroupsRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildSectionsCommand() {
            ...
            var builder = new ApiSdk.Sites.Item.Onenote.Pages.Item.ParentSection.ParentSectionGroup.ParentNotebook.Sections.SectionsRequestBuilder(PathParameters, RequestAdapter);
            foreach (var cmd in builder.BuildCommand()) {
                command.AddCommand(cmd);
            }
            command.AddCommand(builder.BuildCreateCommand());
