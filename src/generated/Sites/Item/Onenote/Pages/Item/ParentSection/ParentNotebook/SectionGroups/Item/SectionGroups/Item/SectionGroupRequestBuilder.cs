...
namespace ApiSdk.Sites.Item.Onenote.Pages.Item.ParentSection.ParentNotebook.SectionGroups.Item.SectionGroups.Item {
    ...
    public class SectionGroupRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string siteId, string onenotePageId, string sectionGroupId, string sectionGroupId1, IConsole console) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string siteId, string onenotePageId, string sectionGroupId, string sectionGroupId1, string[] select, string[] expand, FormatterType output, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string siteId, string onenotePageId, string sectionGroupId, string sectionGroupId1, string body, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
