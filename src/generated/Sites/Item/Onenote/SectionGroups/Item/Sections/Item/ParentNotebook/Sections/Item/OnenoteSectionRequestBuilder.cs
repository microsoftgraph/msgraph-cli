...
namespace ApiSdk.Sites.Item.Onenote.SectionGroups.Item.Sections.Item.ParentNotebook.Sections.Item {
    ...
    public class OnenoteSectionRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string, string>(async (siteId, sectionGroupId, onenoteSectionId, onenoteSectionId1) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string, string, object, object>(async (siteId, sectionGroupId, onenoteSectionId, onenoteSectionId1, select, expand) => {
