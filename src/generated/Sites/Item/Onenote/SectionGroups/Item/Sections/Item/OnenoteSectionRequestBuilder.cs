...
namespace ApiSdk.Sites.Item.Onenote.SectionGroups.Item.Sections.Item {
    ...
    public class OnenoteSectionRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string siteId, string sectionGroupId, string onenoteSectionId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, siteIdOption, sectionGroupIdOption, onenoteSectionIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The sections in the section group. Read-only. Nullable.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string siteId, string sectionGroupId, string onenoteSectionId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, siteIdOption, sectionGroupIdOption, onenoteSectionIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string siteId, string sectionGroupId, string onenoteSectionId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, siteIdOption, sectionGroupIdOption, onenoteSectionIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
