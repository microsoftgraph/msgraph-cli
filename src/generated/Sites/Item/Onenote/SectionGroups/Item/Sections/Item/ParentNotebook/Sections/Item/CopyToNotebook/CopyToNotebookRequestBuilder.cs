...
namespace ApiSdk.Sites.Item.Onenote.SectionGroups.Item.Sections.Item.ParentNotebook.Sections.Item.CopyToNotebook {
    ...
    public class CopyToNotebookRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (string siteId, string sectionGroupId, string onenoteSectionId, string onenoteSectionId1, string body, FormatterType output, IConsole console) => {
