...
namespace ApiSdk.Sites.Item.Onenote.SectionGroups.Item.ParentSectionGroup {
    ...
    public class ParentSectionGroupRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string>(async (siteId, sectionGroupId) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, object, object>(async (siteId, sectionGroupId, select, expand) => {
        ...
        public Command BuildPatchCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string>(async (siteId, sectionGroupId, body) => {
