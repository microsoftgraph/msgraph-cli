...
namespace ApiSdk.Sites.Item.Onenote.SectionGroups.Item.ParentNotebook.Sections.Item.Pages.Item.ParentSection.CopyToNotebook {
    ...
    public class CopyToNotebookRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            }, new CollectionBinding(siteIdOption, sectionGroupIdOption, onenoteSectionIdOption, onenotePageIdOption, bodyOption, outputOption, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
