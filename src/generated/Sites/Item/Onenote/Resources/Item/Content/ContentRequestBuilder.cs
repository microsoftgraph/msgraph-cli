...
namespace ApiSdk.Sites.Item.Onenote.Resources.Item.Content {
    ...
    public class ContentRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string siteId, string onenoteResourceId, FileInfo output) => {
            ...
            }, siteIdOption, onenoteResourceIdOption, outputOption);
            return command;
        }
        /// <summary>
        ...
        public Command BuildPutCommand() {
            ...
            command.SetHandler(async (string siteId, string onenoteResourceId, FileInfo file) => {
