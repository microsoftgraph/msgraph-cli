...
using ApiSdk.Sites.Item.Onenote.Sections.Item.MicrosoftGraphCopyToNotebook;
using ApiSdk.Sites.Item.Onenote.Sections.Item.MicrosoftGraphCopyToSectionGroup;
