...
namespace ApiSdk.Sites.Item.Onenote.Sections.Item.ParentNotebook.SectionGroups.Item.Sections.Item.CopyToNotebook {
    ...
    public class CopyToNotebookRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            }, new CollectionBinding(siteIdOption, onenoteSectionIdOption, sectionGroupIdOption, onenoteSectionId1Option, bodyOption, outputOption, outputFilterOption, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
