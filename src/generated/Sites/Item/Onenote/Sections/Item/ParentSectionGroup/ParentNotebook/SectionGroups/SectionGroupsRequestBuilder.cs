...
namespace ApiSdk.Sites.Item.Onenote.Sections.Item.ParentSectionGroup.ParentNotebook.SectionGroups {
    ...
    public class SectionGroupsRequestBuilder {
        ...
        public Command BuildListCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, int?, int?, string, string, bool?, object, object, object>(async (siteId, onenoteSectionId, top, skip, search, filter, count, orderby, select, expand) => {
