...
namespace ApiSdk.Sites.Item.Onenote.Notebooks.GetNotebookFromWebUrl {
    ...
    public class GetNotebookFromWebUrlRequestBuilder {
        ...
        public GetNotebookFromWebUrlRequestBuilder(Dictionary<string, object> pathParameters) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            UrlTemplate = "{+baseurl}/sites/{site%2Did}/onenote/notebooks/getNotebookFromWebUrl";
