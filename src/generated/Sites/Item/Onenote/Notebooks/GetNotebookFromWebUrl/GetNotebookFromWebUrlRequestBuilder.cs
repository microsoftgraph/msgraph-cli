...
namespace ApiSdk.Sites.Item.Onenote.Notebooks.GetNotebookFromWebUrl {
    ...
    public class GetNotebookFromWebUrlRequestBuilder {
        ...
        /// </summary>
        public async Task<GetNotebookFromWebUrlResponse> PostAsync(GetNotebookFromWebUrlRequestBody model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
