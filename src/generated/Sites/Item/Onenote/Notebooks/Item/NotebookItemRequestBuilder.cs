...
namespace ApiSdk.Sites.Item.Onenote.Notebooks.Item
{
    ...
    public class NotebookItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildCopyNotebookNavCommand()
        {
            ...
            var builder = new ApiSdk.Sites.Item.Onenote.Notebooks.Item.CopyNotebook.CopyNotebookRequestBuilder(PathParameters);
        ...
        public Command BuildSectionGroupsNavCommand()
        {
            ...
            var builder = new ApiSdk.Sites.Item.Onenote.Notebooks.Item.SectionGroups.SectionGroupsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildSectionsNavCommand()
        {
            ...
            var builder = new ApiSdk.Sites.Item.Onenote.Notebooks.Item.Sections.SectionsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Sites.Item.Onenote.Notebooks.Item.NotebookItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Sites.Item.Onenote.Notebooks.Item.NotebookItemRequestBuilder.NotebookItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Sites.Item.Onenote.Notebooks.Item.NotebookItemRequestBuilder.NotebookItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
