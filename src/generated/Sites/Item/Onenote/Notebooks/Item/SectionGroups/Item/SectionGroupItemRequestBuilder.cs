...
namespace ApiSdk.Sites.Item.Onenote.Notebooks.Item.SectionGroups.Item
{
    ...
    public class SectionGroupItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildParentNotebookNavCommand()
        {
            ...
            var builder = new ApiSdk.Sites.Item.Onenote.Notebooks.Item.SectionGroups.Item.ParentNotebook.ParentNotebookRequestBuilder(PathParameters);
        ...
        public Command BuildParentSectionGroupNavCommand()
        {
            ...
            var builder = new ApiSdk.Sites.Item.Onenote.Notebooks.Item.SectionGroups.Item.ParentSectionGroup.ParentSectionGroupRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildSectionsNavCommand()
        {
            ...
            var builder = new ApiSdk.Sites.Item.Onenote.Notebooks.Item.SectionGroups.Item.Sections.SectionsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Sites.Item.Onenote.Notebooks.Item.SectionGroups.Item.SectionGroupItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Sites.Item.Onenote.Notebooks.Item.SectionGroups.Item.SectionGroupItemRequestBuilder.SectionGroupItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Sites.Item.Onenote.Notebooks.Item.SectionGroups.Item.SectionGroupItemRequestBuilder.SectionGroupItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
