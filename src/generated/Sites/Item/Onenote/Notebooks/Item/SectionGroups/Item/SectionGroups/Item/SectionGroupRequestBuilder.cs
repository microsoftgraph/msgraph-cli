...
namespace ApiSdk.Sites.Item.Onenote.Notebooks.Item.SectionGroups.Item.SectionGroups.Item {
    ...
    public class SectionGroupRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string, string>(async (siteId, notebookId, sectionGroupId, sectionGroupId1) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string, string, object, object>(async (siteId, notebookId, sectionGroupId, sectionGroupId1, select, expand) => {
        ...
        public Command BuildPatchCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string, string, string>(async (siteId, notebookId, sectionGroupId, sectionGroupId1, body) => {
