...
namespace ApiSdk.Sites.Item.Onenote.Notebooks.Item.SectionGroups.Item.ParentNotebook {
    ...
    public class ParentNotebookRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string siteId, string notebookId, string sectionGroupId, IConsole console) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string siteId, string notebookId, string sectionGroupId, string[] select, string[] expand, FormatterType output, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string siteId, string notebookId, string sectionGroupId, string body, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
