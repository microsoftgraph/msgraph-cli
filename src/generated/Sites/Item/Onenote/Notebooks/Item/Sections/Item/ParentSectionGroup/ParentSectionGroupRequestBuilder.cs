...
namespace ApiSdk.Sites.Item.Onenote.Notebooks.Item.Sections.Item.ParentSectionGroup {
    ...
    public class ParentSectionGroupRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string siteId, string notebookId, string onenoteSectionId, string[] select, string[] expand) => {
            ...
            }, siteIdOption, notebookIdOption, onenoteSectionIdOption, selectOption, expandOption);
            return command;
        }
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string siteId, string notebookId, string onenoteSectionId, string body) => {
