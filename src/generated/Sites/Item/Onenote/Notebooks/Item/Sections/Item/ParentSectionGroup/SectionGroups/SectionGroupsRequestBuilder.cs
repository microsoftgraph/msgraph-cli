...
namespace ApiSdk.Sites.Item.Onenote.Notebooks.Item.Sections.Item.ParentSectionGroup.SectionGroups {
    ...
    public class SectionGroupsRequestBuilder {
        ...
        public Command BuildListCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string, int?, int?, string, string, bool?, object, object, object>(async (siteId, notebookId, onenoteSectionId, top, skip, search, filter, count, orderby, select, expand) => {
