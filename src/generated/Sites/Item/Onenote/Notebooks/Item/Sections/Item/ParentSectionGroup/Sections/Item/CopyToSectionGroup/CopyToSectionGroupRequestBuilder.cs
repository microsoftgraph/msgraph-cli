...
namespace ApiSdk.Sites.Item.Onenote.Notebooks.Item.Sections.Item.ParentSectionGroup.Sections.Item.CopyToSectionGroup {
    ...
    public class CopyToSectionGroupRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            }, new CollectionBinding(siteIdOption, notebookIdOption, onenoteSectionIdOption, onenoteSectionId1Option, bodyOption, outputOption, outputFilterOption, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
