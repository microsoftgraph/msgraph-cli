...
namespace ApiSdk.Sites.Item.Onenote.Notebooks.Item.Sections.Item.ParentSectionGroup.Sections.Item.CopyToSectionGroup {
    ...
    public class CopyToSectionGroupRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (string siteId, string notebookId, string onenoteSectionId, string onenoteSectionId1, string body, FormatterType output, IOutputFormatterFactory outputFormatterFactory, CancellationToken cancellationToken) => {
            ...
            }, siteIdOption, notebookIdOption, onenoteSectionIdOption, onenoteSectionId1Option, bodyOption, outputOption);
            return command;
        }
        /// <summary>
