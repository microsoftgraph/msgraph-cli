...
namespace ApiSdk.Sites.Item.Onenote.Notebooks.Item.Sections.Item
{
    ...
    public class OnenoteSectionItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildCopyToNotebookNavCommand()
        {
            ...
            var builder = new ApiSdk.Sites.Item.Onenote.Notebooks.Item.Sections.Item.CopyToNotebook.CopyToNotebookRequestBuilder(PathParameters);
        ...
        public Command BuildCopyToSectionGroupNavCommand()
        {
            ...
            var builder = new ApiSdk.Sites.Item.Onenote.Notebooks.Item.Sections.Item.CopyToSectionGroup.CopyToSectionGroupRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildPagesNavCommand()
        {
            ...
            var builder = new ApiSdk.Sites.Item.Onenote.Notebooks.Item.Sections.Item.Pages.PagesRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildParentNotebookNavCommand()
        {
            ...
            var builder = new ApiSdk.Sites.Item.Onenote.Notebooks.Item.Sections.Item.ParentNotebook.ParentNotebookRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildParentSectionGroupNavCommand()
        {
            ...
            var builder = new ApiSdk.Sites.Item.Onenote.Notebooks.Item.Sections.Item.ParentSectionGroup.ParentSectionGroupRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Sites.Item.Onenote.Notebooks.Item.Sections.Item.OnenoteSectionItemRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public OnenoteSectionItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/sites/{site%2Did}/onenote/notebooks/{notebook%2Did}/sections/{onenoteSection%2Did}{?%24expand,%24select}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Sites.Item.Onenote.Notebooks.Item.Sections.Item.OnenoteSectionItemRequestBuilder"/> and sets the default values.
        ...
        public OnenoteSectionItemRequestBuilder(string rawUrl) : base("{+baseurl}/sites/{site%2Did}/onenote/notebooks/{notebook%2Did}/sections/{onenoteSection%2Did}{?%24expand,%24select}", rawUrl)
        {
        }
        /// <summary>
        /// Delete navigation property sections for sites
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Sites.Item.Onenote.Notebooks.Item.Sections.Item.OnenoteSectionItemRequestBuilder.OnenoteSectionItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Sites.Item.Onenote.Notebooks.Item.Sections.Item.OnenoteSectionItemRequestBuilder.OnenoteSectionItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
