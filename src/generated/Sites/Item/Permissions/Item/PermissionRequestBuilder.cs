...
namespace ApiSdk.Sites.Item.Permissions.Item {
    ...
    public class PermissionRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string>(async (siteId, permissionId) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, object, object>(async (siteId, permissionId, select, expand) => {
