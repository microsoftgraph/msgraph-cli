...
using ApiSdk.Models;
using ApiSdk.Sites.Item.Analytics.ItemActivityStats.Item.Activities;
...
using System;
namespace ApiSdk.Sites.Item.Analytics.ItemActivityStats.Item {
    /// <summary>
    ...
    public class ItemActivityStatItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public ItemActivityStatItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/sites/{site%2Did}/analytics/itemActivityStats/{itemActivityStat%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Delete navigation property itemActivityStats for sites
        /// </summary>
