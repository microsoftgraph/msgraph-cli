...
using ApiSdk.Models;
using ApiSdk.Sites.Item.Analytics.ItemActivityStats.Item.Activities.Count;
using ApiSdk.Sites.Item.Analytics.ItemActivityStats.Item.Activities.Item;
...
using System;
namespace ApiSdk.Sites.Item.Analytics.ItemActivityStats.Item.Activities {
    /// <summary>
    ...
    public class ActivitiesRequestBuilder : BaseCliRequestBuilder {
        ...
        public ActivitiesRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/sites/{site%2Did}/analytics/itemActivityStats/{itemActivityStat%2Did}/activities{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Exposes the itemActivities represented in this itemActivityStat resource.
        /// </summary>
