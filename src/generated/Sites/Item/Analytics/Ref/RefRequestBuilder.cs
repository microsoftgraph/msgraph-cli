...
namespace ApiSdk.Sites.Item.Analytics.Ref {
    ...
    public class RefRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string siteId, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                var requestInfo = CreateGetRequestInformation(q => {
                });
                var response = await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                var formatter = outputFormatterFactory.GetFormatter(output);
                formatter.WriteOutput(response, console);
            }, siteIdOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// Analytics about the view activities that took place in this site.
        ...
        public Command BuildPutCommand() {
            ...
            command.SetHandler(async (string siteId, string body, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
