using ApiSdk.Sites.Item.ExternalColumns.Ref;
    ...
    public class ExternalColumnsRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.Handler = CommandHandler.Create<string, int?, int?, string, string, bool?, object, object, object>(async (siteId, top, skip, search, filter, count, orderby, select, expand) => {
                ...
                var result = await RequestAdapter.SendAsync<ExternalColumnsResponse>(requestInfo);
        ...
        public Command BuildRefCommand() {
            ...
            var builder = new ApiSdk.Sites.Item.ExternalColumns.@Ref.RefRequestBuilder(PathParameters, RequestAdapter);
