...
namespace ApiSdk.Sites.Item.TermStore {
    ...
    public class TermStoreRequestBuilder {
        ...
        public Command BuildGroupsCommand() {
            ...
            var builder = new ApiSdk.Sites.Item.TermStore.Groups.GroupsRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildSetsCommand() {
            ...
            var builder = new ApiSdk.Sites.Item.TermStore.Sets.SetsRequestBuilder(PathParameters, RequestAdapter);
            foreach (var cmd in builder.BuildCommand()) {
                command.AddCommand(cmd);
            }
            command.AddCommand(builder.BuildCreateCommand());
