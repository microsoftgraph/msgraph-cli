...
namespace ApiSdk.Sites.Item.TermStore.Groups.Item {
    ...
    public class GroupRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string>(async (siteId, groupId) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, object, object>(async (siteId, groupId, select, expand) => {
