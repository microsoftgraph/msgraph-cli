...
namespace ApiSdk.Sites.Item.TermStore.Groups.Item {
    ...
    public class GroupRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string siteId, string groupId) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string siteId, string groupId, string[] select, string[] expand) => {
            ...
            }, siteIdOption, groupIdOption, selectOption, expandOption);
            return command;
        }
        /// <summary>
        /// Collection of all groups available in the term store.
