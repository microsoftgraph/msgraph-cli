...
namespace ApiSdk.Sites.Item.TermStore.Groups.Item {
    ...
    public class GroupRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string siteId, string groupId, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                var requestInfo = CreateDeleteRequestInformation(q => {
                });
                await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                console.WriteLine("Success");
            }, siteIdOption, groupIdOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// Collection of all groups available in the term store.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string siteId, string groupId, string[] select, string[] expand, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
            ...
            }, siteIdOption, groupIdOption, selectOption, expandOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// Collection of all groups available in the term store.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string siteId, string groupId, string body, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                ...
                await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                console.WriteLine("Success");
            }, siteIdOption, groupIdOption, bodyOption, new OutputFormatterFactoryBinder());
            return command;
        }
        public Command BuildSetsCommand() {
            var command = new Command("sets");
            var builder = new ApiSdk.Sites.Item.TermStore.Groups.Item.Sets.SetsRequestBuilder(PathParameters, RequestAdapter);
