...
namespace ApiSdk.Sites.Item.TermStore.Groups.Item.Sets.Item.Children.Item.Set.Ref {
    ...
    public class RefRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string siteId, string groupId, string setId, string termId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, siteIdOption, groupIdOption, setIdOption, termIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The [set] in which the term is created.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string siteId, string groupId, string setId, string termId, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, siteIdOption, groupIdOption, setIdOption, termIdOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The [set] in which the term is created.
        ...
        public Command BuildPutCommand() {
            ...
            command.SetHandler(async (string siteId, string groupId, string setId, string termId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, siteIdOption, groupIdOption, setIdOption, termIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
