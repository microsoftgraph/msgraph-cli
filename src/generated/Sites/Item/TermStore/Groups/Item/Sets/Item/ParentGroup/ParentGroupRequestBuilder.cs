...
namespace ApiSdk.Sites.Item.TermStore.Groups.Item.Sets.Item.ParentGroup {
    ...
    public class ParentGroupRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string siteId, string groupId, string setId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, siteIdOption, groupIdOption, setIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The parent [group] that contains the set.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string siteId, string groupId, string setId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, siteIdOption, groupIdOption, setIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The parent [group] that contains the set.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string siteId, string groupId, string setId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, siteIdOption, groupIdOption, setIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
