...
using ApiSdk.Sites.Item.TermStore.Groups.Item.Sets.Item.Relations.Count;
using ApiSdk.Sites.Item.TermStore.Groups.Item.Sets.Item.Relations.Item;
...
using System;
namespace ApiSdk.Sites.Item.TermStore.Groups.Item.Sets.Item.Relations {
    /// <summary>
    ...
    public class RelationsRequestBuilder : BaseCliRequestBuilder {
        ...
        public RelationsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/sites/{site%2Did}/termStore/groups/{group%2Did}/sets/{set%2Did}/relations{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Indicates which terms have been pinned or reused directly under the set.
        /// </summary>
