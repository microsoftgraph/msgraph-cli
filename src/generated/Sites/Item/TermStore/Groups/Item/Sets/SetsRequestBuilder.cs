...
namespace ApiSdk.Sites.Item.TermStore.Groups.Item.Sets {
    ...
    public class SetsRequestBuilder {
        ...
        public Command BuildListCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, int?, int?, string, string, bool?, object, object, object>(async (siteId, groupId, top, skip, search, filter, count, orderby, select, expand) => {
