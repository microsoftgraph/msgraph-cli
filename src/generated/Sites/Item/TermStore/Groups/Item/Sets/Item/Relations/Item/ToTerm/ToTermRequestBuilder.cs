...
using ApiSdk.Sites.Item.TermStore.Groups.Item.Sets.Item.Relations.Item.ToTerm.Ref;
...
namespace ApiSdk.Sites.Item.TermStore.Groups.Item.Sets.Item.Relations.Item.ToTerm {
    ...
    public class ToTermRequestBuilder {
        ...
        public Command BuildRefCommand() {
            ...
            var builder = new ApiSdk.Sites.Item.TermStore.Groups.Item.Sets.Item.Relations.Item.ToTerm.@Ref.RefRequestBuilder(PathParameters, RequestAdapter);
