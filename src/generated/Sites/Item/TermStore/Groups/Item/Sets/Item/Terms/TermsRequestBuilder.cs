...
using ApiSdk.Sites.Item.TermStore.Groups.Item.Sets.Item.Terms.Count;
using ApiSdk.Sites.Item.TermStore.Groups.Item.Sets.Item.Terms.Item;
...
namespace ApiSdk.Sites.Item.TermStore.Groups.Item.Sets.Item.Terms {
    ...
    public class TermsRequestBuilder : BaseCliRequestBuilder {
        ...
        public TermsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/sites/{site%2Did}/termStore/groups/{group%2Did}/sets/{set%2Did}/terms{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Read the properties and relationships of a term object.
        /// </summary>
