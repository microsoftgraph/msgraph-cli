...
namespace ApiSdk.Sites.Item.TermStore.Groups.Item.Sets.Item.Children.Item {
    ...
    public class TermRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string siteId, string groupId, string setId, string termId) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string siteId, string groupId, string setId, string termId, string[] select, string[] expand) => {
            ...
            }, siteIdOption, groupIdOption, setIdOption, termIdOption, selectOption, expandOption);
            return command;
        }
        /// <summary>
        /// Children terms of set in term [store].
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string siteId, string groupId, string setId, string termId, string body) => {
