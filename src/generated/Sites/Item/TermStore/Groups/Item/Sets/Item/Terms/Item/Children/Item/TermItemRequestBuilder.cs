...
using ApiSdk.Sites.Item.TermStore.Groups.Item.Sets.Item.Terms.Item.Children.Item.Relations;
using ApiSdk.Sites.Item.TermStore.Groups.Item.Sets.Item.Terms.Item.Children.Item.Set;
...
using System;
namespace ApiSdk.Sites.Item.TermStore.Groups.Item.Sets.Item.Terms.Item.Children.Item {
    /// <summary>
    ...
    public class TermItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public TermItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/sites/{site%2Did}/termStore/groups/{group%2Did}/sets/{set%2Did}/terms/{term%2Did}/children/{term%2Did1}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Delete navigation property children for sites
        /// </summary>
