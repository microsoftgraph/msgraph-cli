...
namespace ApiSdk.Sites.Item.TermStore.Groups.Item {
    ...
    public class GroupItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public GroupItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/sites/{site%2Did}/termStore/groups/{group%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Delete navigation property groups for sites
        /// </summary>
