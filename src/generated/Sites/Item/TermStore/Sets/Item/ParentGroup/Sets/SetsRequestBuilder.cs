...
namespace ApiSdk.Sites.Item.TermStore.Sets.Item.ParentGroup.Sets {
    ...
    public class SetsRequestBuilder : BaseCliRequestBuilder {
        ...
        public SetsRequestBuilder(string rawUrl) : base("{+baseurl}/sites/{site%2Did}/termStore/sets/{set%2Did}/parentGroup/sets{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Get a list of the set objects and their properties. This API is available in the following national cloud deployments.
        /// </summary>
