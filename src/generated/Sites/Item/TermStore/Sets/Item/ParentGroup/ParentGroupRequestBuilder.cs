...
namespace ApiSdk.Sites.Item.TermStore.Sets.Item.ParentGroup {
    ...
    public class ParentGroupRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string siteId, string setId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, siteIdOption, setIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The parent [group] that contains the set.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string siteId, string setId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, siteIdOption, setIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The parent [group] that contains the set.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string siteId, string setId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, siteIdOption, setIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
