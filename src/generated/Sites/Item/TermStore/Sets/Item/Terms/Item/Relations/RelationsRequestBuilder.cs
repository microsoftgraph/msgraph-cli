...
using ApiSdk.Sites.Item.TermStore.Sets.Item.Terms.Item.Relations.Count;
using ApiSdk.Sites.Item.TermStore.Sets.Item.Terms.Item.Relations.Item;
...
namespace ApiSdk.Sites.Item.TermStore.Sets.Item.Terms.Item.Relations {
    ...
    public class RelationsRequestBuilder : BaseCliRequestBuilder {
        ...
        public RelationsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/sites/{site%2Did}/termStore/sets/{set%2Did}/terms/{term%2Did}/relations{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// To indicate which terms are related to the current term as either pinned or reused.
        /// </summary>
