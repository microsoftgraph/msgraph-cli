...
namespace ApiSdk.Sites.Item.TermStore.Sets.Item.Terms.Item {
    ...
    public class TermRequestBuilder {
        ...
        public Command BuildChildrenCommand() {
            ...
            var builder = new ApiSdk.Sites.Item.TermStore.Sets.Item.Terms.Item.Children.ChildrenRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildRelationsCommand() {
            ...
            var builder = new ApiSdk.Sites.Item.TermStore.Sets.Item.Terms.Item.Relations.RelationsRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildListCommand());
            command.AddCommand(builder.BuildCreateCommand());
            foreach (var cmd in builder.BuildCommand()) {
                command.AddCommand(cmd);
        ...
        public Command BuildSetCommand() {
            ...
            var builder = new ApiSdk.Sites.Item.TermStore.Sets.Item.Terms.Item.Set.SetRequestBuilder(PathParameters, RequestAdapter);
