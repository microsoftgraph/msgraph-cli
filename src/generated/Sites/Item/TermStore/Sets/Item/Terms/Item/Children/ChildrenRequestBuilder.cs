...
namespace ApiSdk.Sites.Item.TermStore.Sets.Item.Terms.Item.Children {
    ...
    public class ChildrenRequestBuilder {
        ...
        public Command BuildListCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string, int?, int?, string, string, bool?, object, object, object>(async (siteId, setId, termId, top, skip, search, filter, count, orderby, select, expand) => {
