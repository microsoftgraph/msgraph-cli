...
namespace ApiSdk.Sites.Item.TermStore.Sets.Item.Terms.Item.Children.Item.Set {
    ...
    public class SetRequestBuilder : BaseCliRequestBuilder {
        ...
        public SetRequestBuilder(string rawUrl) : base("{+baseurl}/sites/{site%2Did}/termStore/sets/{set%2Did}/terms/{term%2Did}/children/{term%2Did1}/set{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// The [set] in which the term is created.
        /// </summary>
