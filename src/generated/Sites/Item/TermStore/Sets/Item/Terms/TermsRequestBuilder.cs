...
using ApiSdk.Sites.Item.TermStore.Sets.Item.Terms.Count;
using ApiSdk.Sites.Item.TermStore.Sets.Item.Terms.Item;
...
using System;
namespace ApiSdk.Sites.Item.TermStore.Sets.Item.Terms {
    /// <summary>
    ...
    public class TermsRequestBuilder : BaseCliRequestBuilder {
        ...
        public TermsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/sites/{site%2Did}/termStore/sets/{set%2Did}/terms{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// All the terms under the set.
        /// </summary>
