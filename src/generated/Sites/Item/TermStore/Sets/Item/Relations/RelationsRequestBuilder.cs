...
namespace ApiSdk.Sites.Item.TermStore.Sets.Item.Relations {
    ...
    public class RelationsRequestBuilder {
        ...
        public Command BuildCreateCommand() {
            ...
            command.SetHandler(async (string siteId, string setId, string body, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, siteIdOption, setIdOption, bodyOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// Indicates which terms have been pinned or reused directly under the set.
        ...
        public Command BuildListCommand() {
            ...
            command.AddOption(outputOption);
            command.SetHandler(async (string siteId, string setId, int? top, int? skip, string search, string filter, bool? count, string[] orderby, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, siteIdOption, setIdOption, topOption, skipOption, searchOption, filterOption, countOption, orderbyOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
