...
namespace ApiSdk.Sites.Item.TermStore.Sets.Item.Relations {
    ...
    public class RelationsRequestBuilder {
        ...
        public Command BuildCreateCommand() {
            ...
            command.SetHandler(async (string siteId, string setId, string body) => {
            ...
            }, siteIdOption, setIdOption, bodyOption);
            return command;
        }
        /// <summary>
        /// Indicates which terms have been pinned or reused directly under the set.
        ...
        public Command BuildListCommand() {
            ...
            command.SetHandler(async (string siteId, string setId, int? top, int? skip, string search, string filter, bool? count, string[] orderby, string[] select, string[] expand) => {
                ...
                var strContent = await reader.ReadToEndAsync();
                Console.Write(strContent + "\n");
            }, siteIdOption, setIdOption, topOption, skipOption, searchOption, filterOption, countOption, orderbyOption, selectOption, expandOption);
            return command;
        }
        /// <summary>
