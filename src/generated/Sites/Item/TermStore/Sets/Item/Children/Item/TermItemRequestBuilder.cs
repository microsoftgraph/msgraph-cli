...
namespace ApiSdk.Sites.Item.TermStore.Sets.Item.Children.Item {
    ...
    public class TermItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public Command BuildChildrenNavCommand() {
            ...
            var builder = new ApiSdk.Sites.Item.TermStore.Sets.Item.Children.Item.Children.ChildrenRequestBuilder(PathParameters);
        ...
        public TermItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/sites/{site%2Did}/termStore/sets/{set%2Did}/children/{term%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Delete navigation property children for sites
        /// </summary>
