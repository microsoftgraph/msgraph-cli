...
namespace ApiSdk.Sites.Item.TermStore.Sets.Item.Children.Item {
    ...
    public class TermRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            }, siteIdOption, setIdOption, termIdOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// Children terms of set in term [store].
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string siteId, string setId, string termId, string[] select, string[] expand, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
            ...
            }, siteIdOption, setIdOption, termIdOption, selectOption, expandOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// Children terms of set in term [store].
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string siteId, string setId, string termId, string body, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                ...
                await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                console.WriteLine("Success");
            }, siteIdOption, setIdOption, termIdOption, bodyOption, new OutputFormatterFactoryBinder());
            return command;
        }
