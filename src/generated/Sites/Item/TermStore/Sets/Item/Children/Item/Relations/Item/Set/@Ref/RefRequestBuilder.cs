...
namespace ApiSdk.Sites.Item.TermStore.Sets.Item.Children.Item.Relations.Item.Set.@Ref {
    ...
    public class RefRequestBuilder {
        ...
        public Command BuildPutCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string, string, string>(async (siteId, setId, termId, relationId, body) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Sites.Item.TermStore.Sets.Item.Children.Item.Relations.Item.Set.@Ref.@Ref>();
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePutRequestInformation(ApiSdk.Sites.Item.TermStore.Sets.Item.Children.Item.Relations.Item.Set.@Ref.@Ref body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PutAsync(ApiSdk.Sites.Item.TermStore.Sets.Item.Children.Item.Relations.Item.Set.@Ref.@Ref model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
