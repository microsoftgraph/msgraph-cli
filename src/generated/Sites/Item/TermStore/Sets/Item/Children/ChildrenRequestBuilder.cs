...
namespace ApiSdk.Sites.Item.TermStore.Sets.Item.Children {
    ...
    public class ChildrenRequestBuilder : BaseCliRequestBuilder {
        ...
        public ChildrenRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/sites/{site%2Did}/termStore/sets/{set%2Did}/children{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Children terms of set in term [store].
        /// </summary>
