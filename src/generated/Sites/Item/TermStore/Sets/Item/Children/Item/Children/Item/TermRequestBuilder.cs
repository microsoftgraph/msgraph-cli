...
namespace ApiSdk.Sites.Item.TermStore.Sets.Item.Children.Item.Children.Item {
    ...
    public class TermRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string siteId, string setId, string termId, string termId1, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, siteIdOption, setIdOption, termIdOption, termId1Option, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// Children of current term.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string siteId, string setId, string termId, string termId1, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, siteIdOption, setIdOption, termIdOption, termId1Option, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// Children of current term.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string siteId, string setId, string termId, string termId1, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, siteIdOption, setIdOption, termIdOption, termId1Option, bodyOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
