...
using ApiSdk.Sites.Item.TermStore.Sets.Item.Children.Item.Children.Item.Relations;
using ApiSdk.Sites.Item.TermStore.Sets.Item.Children.Item.Children.Item.Set;
...
namespace ApiSdk.Sites.Item.TermStore.Sets.Item.Children.Item.Children.Item {
    ...
    public class TermItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public TermItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/sites/{site%2Did}/termStore/sets/{set%2Did}/children/{term%2Did}/children/{term%2Did1}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Delete navigation property children for sites
        /// </summary>
