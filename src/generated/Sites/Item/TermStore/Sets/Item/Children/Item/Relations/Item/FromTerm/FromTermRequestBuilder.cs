...
using ApiSdk.Sites.Item.TermStore.Sets.Item.Children.Item.Relations.Item.FromTerm.Ref;
...
namespace ApiSdk.Sites.Item.TermStore.Sets.Item.Children.Item.Relations.Item.FromTerm {
    ...
    public class FromTermRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string siteId, string setId, string termId, string relationId, string[] select, string[] expand, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
            ...
            }, siteIdOption, setIdOption, termIdOption, relationIdOption, selectOption, expandOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        public Command BuildRefCommand() {
            var command = new Command("ref");
            var builder = new ApiSdk.Sites.Item.TermStore.Sets.Item.Children.Item.Relations.Item.FromTerm.Ref.RefRequestBuilder(PathParameters, RequestAdapter);
