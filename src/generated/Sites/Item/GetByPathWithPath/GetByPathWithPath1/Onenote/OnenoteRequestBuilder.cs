...
namespace ApiSdk.Sites.Item.GetByPathWithPath.GetByPathWithPath1.Onenote {
    ...
    public class OnenoteRequestBuilder : BaseCliRequestBuilder {
        ...
        public OnenoteRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/sites/{site%2Did}/getByPath(path='{path}')/getByPath(path='{path1}')/onenote{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new OnenoteRequestBuilder and sets the default values.
        /// </summary>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public OnenoteRequestBuilder(string rawUrl) : base("{+baseurl}/sites/{site%2Did}/getByPath(path='{path}')/getByPath(path='{path1}')/onenote{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Delete navigation property onenote for sites
        /// </summary>
