...
using ApiSdk.Sites.Item.GetByPathWithPath.GetActivitiesByInterval;
...
using ApiSdk.Sites.Item.GetByPathWithPath.TermStores;
...
namespace ApiSdk.Sites.Item.GetByPathWithPath
{
    ...
    public partial class GetByPathWithPathRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildGetActivitiesByIntervalNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Sites.Item.GetByPathWithPath.GetActivitiesByInterval.GetActivitiesByIntervalRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildTermStoresNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Sites.Item.GetByPathWithPath.TermStores.TermStoresRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
