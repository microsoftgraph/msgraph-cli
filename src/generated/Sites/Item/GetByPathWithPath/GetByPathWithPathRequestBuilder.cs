...
namespace ApiSdk.Sites.Item.GetByPathWithPath {
    ...
    public class GetByPathWithPathRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string siteId, string path, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, siteIdOption, pathOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
