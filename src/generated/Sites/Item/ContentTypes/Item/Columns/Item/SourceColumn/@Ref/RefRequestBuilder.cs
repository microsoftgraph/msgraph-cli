...
namespace ApiSdk.Sites.Item.ContentTypes.Item.Columns.Item.SourceColumn.@Ref {
    ...
    public class RefRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string siteId, string contentTypeId, string columnDefinitionId) => {
                var requestInfo = CreateDeleteRequestInformation(q => {
                });
                await RequestAdapter.SendNoContentAsync(requestInfo);
                // Print request output. What if the request has no return?
                Console.WriteLine("Success");
            }, siteIdOption, contentTypeIdOption, columnDefinitionIdOption);
            return command;
        }
        /// <summary>
        /// The source column for content type column.
        ...
        public Command BuildPutCommand() {
            ...
            command.SetHandler(async (string siteId, string contentTypeId, string columnDefinitionId, string body) => {
                ...
                // Print request output. What if the request has no return?
                Console.WriteLine("Success");
            }, siteIdOption, contentTypeIdOption, columnDefinitionIdOption, bodyOption);
            return command;
        }
        /// <summary>
