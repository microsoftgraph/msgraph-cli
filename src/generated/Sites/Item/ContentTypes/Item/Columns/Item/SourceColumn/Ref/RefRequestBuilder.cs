...
namespace ApiSdk.Sites.Item.ContentTypes.Item.Columns.Item.SourceColumn.Ref {
    ...
    public class RefRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string siteId, string contentTypeId, string columnDefinitionId, IOutputFormatterFactory outputFormatterFactory, CancellationToken cancellationToken) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string siteId, string contentTypeId, string columnDefinitionId, FormatterType output, IOutputFormatterFactory outputFormatterFactory, CancellationToken cancellationToken) => {
                var requestInfo = CreateGetRequestInformation(q => {
                });
                var response = await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo, errorMapping: default, cancellationToken: cancellationToken);
                var formatter = outputFormatterFactory.GetFormatter(output);
                formatter.WriteOutput(response);
            }, siteIdOption, contentTypeIdOption, columnDefinitionIdOption, outputOption);
            return command;
        }
        /// <summary>
        /// The source column for content type column.
        ...
        public Command BuildPutCommand() {
            ...
            command.SetHandler(async (string siteId, string contentTypeId, string columnDefinitionId, string body, IOutputFormatterFactory outputFormatterFactory, CancellationToken cancellationToken) => {
