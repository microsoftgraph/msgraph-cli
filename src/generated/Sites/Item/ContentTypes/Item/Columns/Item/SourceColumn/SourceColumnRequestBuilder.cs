...
namespace ApiSdk.Sites.Item.ContentTypes.Item.Columns.Item.SourceColumn {
    ...
    public class SourceColumnRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string siteId, string contentTypeId, string columnDefinitionId, string[] select, string[] expand, FormatterType output, IConsole console) => {
