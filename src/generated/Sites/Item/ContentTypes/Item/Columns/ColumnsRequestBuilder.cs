...
namespace ApiSdk.Sites.Item.ContentTypes.Item.Columns {
    ...
    public class ColumnsRequestBuilder {
        ...
        public Command BuildListCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, int?, int?, string, string, bool?, string[], string[], string[]>(async (siteId, contentTypeId, top, skip, search, filter, count, orderby, select, expand) => {
