using ApiSdk.Sites.Item.ContentTypes.Item.BaseTypes.AddCopy;
...
namespace ApiSdk.Sites.Item.ContentTypes.Item.BaseTypes {
    ...
    public class BaseTypesRequestBuilder {
        ...
        public Command BuildAddCopyCommand() {
            ...
            var builder = new ApiSdk.Sites.Item.ContentTypes.Item.BaseTypes.AddCopy.AddCopyRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildRefCommand() {
            ...
            var builder = new ApiSdk.Sites.Item.ContentTypes.Item.BaseTypes.@Ref.RefRequestBuilder(PathParameters, RequestAdapter);
