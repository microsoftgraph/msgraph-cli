...
using ApiSdk.Sites.Item.ContentTypes.Item.ColumnPositions.Count;
using ApiSdk.Sites.Item.ContentTypes.Item.ColumnPositions.Item;
...
namespace ApiSdk.Sites.Item.ContentTypes.Item.ColumnPositions {
    ...
    public class ColumnPositionsRequestBuilder : BaseCliRequestBuilder {
        ...
        public ColumnPositionsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/sites/{site%2Did}/contentTypes/{contentType%2Did}/columnPositions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Column order information in a content type.
        /// </summary>
