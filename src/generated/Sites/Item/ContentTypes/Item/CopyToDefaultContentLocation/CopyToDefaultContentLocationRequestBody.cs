...
namespace ApiSdk.Sites.Item.ContentTypes.Item.CopyToDefaultContentLocation {
    ...
    public class CopyToDefaultContentLocationRequestBody : IAdditionalDataHolder, IParsable {
        ...
        /// </summary>
        public static ApiSdk.Sites.Item.ContentTypes.Item.CopyToDefaultContentLocation.CopyToDefaultContentLocationRequestBody CreateFromDiscriminatorValue(IParseNode parseNode) {
