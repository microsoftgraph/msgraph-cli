...
namespace ApiSdk.Sites.Item.ContentTypes.Item.AssociateWithHubSites {
    ...
    public class AssociateWithHubSitesRequestBody : IAdditionalDataHolder, IParsable {
        ...
        /// </summary>
        public static ApiSdk.Sites.Item.ContentTypes.Item.AssociateWithHubSites.AssociateWithHubSitesRequestBody CreateFromDiscriminatorValue(IParseNode parseNode) {
