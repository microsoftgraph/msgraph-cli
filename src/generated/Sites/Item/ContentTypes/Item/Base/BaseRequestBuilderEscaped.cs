...
namespace ApiSdk.Sites.Item.ContentTypes.Item.Base {
    ...
    public class BaseRequestBuilderEscaped : BaseCliRequestBuilder {
        ...
        public BaseRequestBuilderEscaped(Dictionary<string, object> pathParameters) : base("{+baseurl}/sites/{site%2Did}/contentTypes/{contentType%2Did}/base{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Parent contentType from which this content type is derived.
        /// </summary>
