...
using ApiSdk.Sites.Item.ContentTypes.Item.Base.AssociateWithHubSites;
using ApiSdk.Sites.Item.ContentTypes.Item.Base.CopyToDefaultContentLocation;
using ApiSdk.Sites.Item.ContentTypes.Item.Base.IsPublished;
...
namespace ApiSdk.Sites.Item.ContentTypes.Item.Base {
    ...
    public class BaseRequestBuilder {
        ...
        public Command BuildAssociateWithHubSitesCommand() {
            ...
            var builder = new ApiSdk.Sites.Item.ContentTypes.Item.Base.AssociateWithHubSites.AssociateWithHubSitesRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildPostCommand());
            return command;
        }
        public Command BuildCopyToDefaultContentLocationCommand() {
            var command = new Command("copy-to-default-content-location");
            var builder = new ApiSdk.Sites.Item.ContentTypes.Item.Base.CopyToDefaultContentLocation.CopyToDefaultContentLocationRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildPostCommand());
            return command;
        }
        /// <summary>
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string siteId, string contentTypeId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, siteIdOption, contentTypeIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        public Command BuildPublishCommand() {
            var command = new Command("publish");
            var builder = new ApiSdk.Sites.Item.ContentTypes.Item.Base.Publish.PublishRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildPostCommand());
            return command;
        }
        public Command BuildRefCommand() {
            var command = new Command("ref");
            var builder = new ApiSdk.Sites.Item.ContentTypes.Item.Base.Ref.RefRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildUnpublishCommand() {
            ...
            var builder = new ApiSdk.Sites.Item.ContentTypes.Item.Base.Unpublish.UnpublishRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildPostCommand());
            return command;
        }
        /// <summary>
