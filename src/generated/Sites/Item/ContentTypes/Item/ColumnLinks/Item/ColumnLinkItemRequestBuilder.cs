...
namespace ApiSdk.Sites.Item.ContentTypes.Item.ColumnLinks.Item {
    ...
    public class ColumnLinkItemRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(siteIdOption, contentTypeIdOption, columnLinkIdOption, selectOption, expandOption, outputOption, outputFilterOption, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// The collection of columns that are required by this content type
