...
namespace ApiSdk.Sites.Item.ContentTypes.Item.ColumnLinks.Item {
    ...
    public class ColumnLinkRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string siteId, string contentTypeId, string columnLinkId, IOutputFormatterFactory outputFormatterFactory, CancellationToken cancellationToken) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string siteId, string contentTypeId, string columnLinkId, string[] select, string[] expand, FormatterType output, IOutputFormatterFactory outputFormatterFactory, CancellationToken cancellationToken) => {
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string siteId, string contentTypeId, string columnLinkId, string body, IOutputFormatterFactory outputFormatterFactory, CancellationToken cancellationToken) => {
