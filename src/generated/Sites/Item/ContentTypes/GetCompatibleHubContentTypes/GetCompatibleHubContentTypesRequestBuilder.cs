...
namespace ApiSdk.Sites.Item.ContentTypes.GetCompatibleHubContentTypes {
    ...
    public class GetCompatibleHubContentTypesRequestBuilder : BaseCliRequestBuilder {
        ...
        public GetCompatibleHubContentTypesRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/sites/{site%2Did}/contentTypes/getCompatibleHubContentTypes(){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}", pathParameters) {
        }
        /// <summary>
        /// Invoke function getCompatibleHubContentTypes
        /// </summary>
