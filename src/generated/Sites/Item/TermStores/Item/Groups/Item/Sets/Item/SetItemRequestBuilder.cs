...
namespace ApiSdk.Sites.Item.TermStores.Item.Groups.Item.Sets.Item {
    ...
    public class SetItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public SetItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/sites/{site%2Did}/termStores/{store%2Did}/groups/{group%2Did}/sets/{set%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Delete navigation property sets for sites
        /// </summary>
