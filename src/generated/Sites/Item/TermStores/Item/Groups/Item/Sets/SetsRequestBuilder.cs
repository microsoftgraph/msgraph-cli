...
namespace ApiSdk.Sites.Item.TermStores.Item.Groups.Item.Sets {
    ...
    public class SetsRequestBuilder {
        ...
        public Command BuildListCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string, int?, int?, string, string, bool?, object, object, object>(async (siteId, storeId, groupId, top, skip, search, filter, count, orderby, select, expand) => {
