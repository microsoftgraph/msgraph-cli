...
namespace ApiSdk.Sites.Item.TermStores.Item.Groups.Item.Sets {
    ...
    public class SetsRequestBuilder {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<ApiSdk.Models.Microsoft.Graph.TermStore.Set> PostAsync(ApiSdk.Models.Microsoft.Graph.TermStore.Set model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
