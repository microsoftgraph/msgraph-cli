...
using ApiSdk.Sites.Item.TermStores.Item.Groups.Item.Sets.Item.Children;
...
namespace ApiSdk.Sites.Item.TermStores.Item.Groups.Item.Sets.Item {
    ...
    public class SetRequestBuilder {
        ...
        public Command BuildChildrenCommand() {
            ...
            var builder = new ApiSdk.Sites.Item.TermStores.Item.Groups.Item.Sets.Item.Children.ChildrenRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string siteId, string storeId, string groupId, string setId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, siteIdOption, storeIdOption, groupIdOption, setIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// All sets under the group in a term [store].
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string siteId, string storeId, string groupId, string setId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, siteIdOption, storeIdOption, groupIdOption, setIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        public Command BuildParentGroupCommand() {
            var command = new Command("parent-group");
            var builder = new ApiSdk.Sites.Item.TermStores.Item.Groups.Item.Sets.Item.ParentGroup.ParentGroupRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string siteId, string storeId, string groupId, string setId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, siteIdOption, storeIdOption, groupIdOption, setIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        public Command BuildRelationsCommand() {
            var command = new Command("relations");
            var builder = new ApiSdk.Sites.Item.TermStores.Item.Groups.Item.Sets.Item.Relations.RelationsRequestBuilder(PathParameters, RequestAdapter);
            foreach (var cmd in builder.BuildCommand()) {
                command.AddCommand(cmd);
            }
            command.AddCommand(builder.BuildCreateCommand());
        ...
        public Command BuildTermsCommand() {
            ...
            var builder = new ApiSdk.Sites.Item.TermStores.Item.Groups.Item.Sets.Item.Terms.TermsRequestBuilder(PathParameters, RequestAdapter);
            foreach (var cmd in builder.BuildCommand()) {
                command.AddCommand(cmd);
            }
            command.AddCommand(builder.BuildCreateCommand());
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(ApiSdk.Models.Microsoft.Graph.TermStore.Set model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
