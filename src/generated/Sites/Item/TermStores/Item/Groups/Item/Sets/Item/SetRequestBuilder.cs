...
namespace ApiSdk.Sites.Item.TermStores.Item.Groups.Item.Sets.Item {
    ...
    public class SetRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string siteId, string storeId, string groupId, string setId) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string siteId, string storeId, string groupId, string setId, string[] select, string[] expand) => {
            ...
            }, siteIdOption, storeIdOption, groupIdOption, setIdOption, selectOption, expandOption);
            return command;
        }
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string siteId, string storeId, string groupId, string setId, string body) => {
