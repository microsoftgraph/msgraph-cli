...
namespace ApiSdk.Sites.Item.TermStores.Item.Groups.Item.Sets.Item.ParentGroup {
    ...
    public class ParentGroupRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            }, siteIdOption, storeIdOption, groupIdOption, setIdOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// The parent [group] that contains the set.
        ...
        public Command BuildGetCommand() {
            ...
            }, siteIdOption, storeIdOption, groupIdOption, setIdOption, selectOption, expandOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// The parent [group] that contains the set.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string siteId, string storeId, string groupId, string setId, string body, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                ...
                await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                console.WriteLine("Success");
            }, siteIdOption, storeIdOption, groupIdOption, setIdOption, bodyOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
