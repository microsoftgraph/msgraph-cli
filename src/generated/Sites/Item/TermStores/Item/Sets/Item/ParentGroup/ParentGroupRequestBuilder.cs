...
namespace ApiSdk.Sites.Item.TermStores.Item.Sets.Item.ParentGroup {
    ...
    public class ParentGroupRequestBuilder {
        ...
        public Command BuildSetsNavCommand() {
            ...
            var builder = new ApiSdk.Sites.Item.TermStores.Item.Sets.Item.ParentGroup.Sets.SetsRequestBuilder(PathParameters);
        ...
        public ParentGroupRequestBuilder(Dictionary<string, object> pathParameters) {
            ...
            UrlTemplate = "{+baseurl}/sites/{site%2Did}/termStores/{store%2Did}/sets/{set%2Did}/parentGroup{?%24select,%24expand}";
