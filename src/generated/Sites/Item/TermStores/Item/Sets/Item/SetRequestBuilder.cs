...
using ApiSdk.Sites.Item.TermStores.Item.Sets.Item.Children;
...
namespace ApiSdk.Sites.Item.TermStores.Item.Sets.Item {
    ...
    public class SetRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string siteId, string storeId, string setId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, siteIdOption, storeIdOption, setIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// Collection of all sets available in the term store.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string siteId, string storeId, string setId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, siteIdOption, storeIdOption, setIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        public Command BuildParentGroupCommand() {
            var command = new Command("parent-group");
            var builder = new ApiSdk.Sites.Item.TermStores.Item.Sets.Item.ParentGroup.ParentGroupRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string siteId, string storeId, string setId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, siteIdOption, storeIdOption, setIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
