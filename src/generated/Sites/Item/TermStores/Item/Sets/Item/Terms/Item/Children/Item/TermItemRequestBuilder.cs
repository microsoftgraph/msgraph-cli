...
using ApiSdk.Sites.Item.TermStores.Item.Sets.Item.Terms.Item.Children.Item.Relations;
using ApiSdk.Sites.Item.TermStores.Item.Sets.Item.Terms.Item.Children.Item.Set;
...
namespace ApiSdk.Sites.Item.TermStores.Item.Sets.Item.Terms.Item.Children.Item {
    ...
    public class TermItemRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            }, new CollectionBinding(siteIdOption, storeIdOption, setIdOption, termIdOption, termId1Option, ifMatchOption, new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(siteIdOption, storeIdOption, setIdOption, termIdOption, termId1Option, selectOption, expandOption, outputOption, queryOption, jsonNoIndentOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                await RequestAdapter.SendNoContentAsync(requestInfo, errorMapping: errorMapping, cancellationToken: cancellationToken);
                Console.WriteLine("Success");
            }, new CollectionBinding(siteIdOption, storeIdOption, setIdOption, termIdOption, termId1Option, bodyOption, new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        ...
        public TermItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/sites/{site%2Did}/termStores/{store%2Did}/sets/{set%2Did}/terms/{term%2Did}/children/{term%2Did1}{?%24select,%24expand}";
