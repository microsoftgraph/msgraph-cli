...
namespace ApiSdk.Sites.Item.TermStores.Item.Sets.Item.Children.Item.Relations.Item {
    ...
    public class RelationRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string siteId, string storeId, string setId, string termId, string relationId, IConsole console) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string siteId, string storeId, string setId, string termId, string relationId, string[] select, string[] expand, FormatterType output, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string siteId, string storeId, string setId, string termId, string relationId, string body, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
