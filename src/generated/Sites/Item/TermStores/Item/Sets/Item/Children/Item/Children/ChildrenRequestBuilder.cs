...
namespace ApiSdk.Sites.Item.TermStores.Item.Sets.Item.Children.Item.Children {
    ...
    public class ChildrenRequestBuilder {
        ...
        public Command BuildListCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string, string, int?, int?, string, string, bool?, object, object, object>(async (siteId, storeId, setId, termId, top, skip, search, filter, count, orderby, select, expand) => {
