...
namespace ApiSdk.Sites.Item.TermStores.Item.Sets.Item.Children.Item.Relations.Item {
    ...
    public class RelationItemRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(siteIdOption, storeIdOption, setIdOption, termIdOption, relationIdOption, selectOption, expandOption, outputOption, outputFilterOption, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// To indicate which terms are related to the current term as either pinned or reused.
