...
using ApiSdk.Sites.Item.TermStores.Item.Sets.Item.Children.Item.Relations.Count;
using ApiSdk.Sites.Item.TermStores.Item.Sets.Item.Children.Item.Relations.Item;
...
namespace ApiSdk.Sites.Item.TermStores.Item.Sets.Item.Children.Item.Relations {
    /// <summary>
    ...
    public class RelationsRequestBuilder : BaseCliRequestBuilder {
        ...
        public RelationsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/sites/{site%2Did}/termStores/{store%2Did}/sets/{set%2Did}/children/{term%2Did}/relations{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// To indicate which terms are related to the current term as either pinned or reused.
        /// </summary>
