...
namespace ApiSdk.Sites.Item.TermStores.Item.Sets.Item.Relations.Item {
    ...
    public class RelationRequestBuilder {
        ...
        public Command BuildFromTermCommand() {
            ...
            var builder = new ApiSdk.Sites.Item.TermStores.Item.Sets.Item.Relations.Item.FromTerm.FromTermRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string siteId, string storeId, string setId, string relationId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, siteIdOption, storeIdOption, setIdOption, relationIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// Indicates which terms have been pinned or reused directly under the set.
        ...
        public Command BuildSetCommand() {
            ...
            var builder = new ApiSdk.Sites.Item.TermStores.Item.Sets.Item.Relations.Item.Set.SetRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildGetCommand());
            command.AddCommand(builder.BuildRefCommand());
            return command;
        }
        public Command BuildToTermCommand() {
            ...
            var builder = new ApiSdk.Sites.Item.TermStores.Item.Sets.Item.Relations.Item.ToTerm.ToTermRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildGetCommand());
            command.AddCommand(builder.BuildRefCommand());
            return command;
        }
