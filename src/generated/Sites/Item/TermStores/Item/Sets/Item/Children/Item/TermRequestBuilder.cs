...
namespace ApiSdk.Sites.Item.TermStores.Item.Sets.Item.Children.Item {
    ...
    public class TermRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string siteId, string storeId, string setId, string termId) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string siteId, string storeId, string setId, string termId, string[] select, string[] expand) => {
            ...
            }, siteIdOption, storeIdOption, setIdOption, termIdOption, selectOption, expandOption);
            return command;
        }
        /// <summary>
        /// Children terms of set in term [store].
