...
using ApiSdk.Sites.Item.TermStores.Item.Sets.Item.Children.Item.Children;
using ApiSdk.Sites.Item.TermStores.Item.Sets.Item.Children.Item.Relations;
using ApiSdk.Sites.Item.TermStores.Item.Sets.Item.Children.Item.Set;
...
namespace ApiSdk.Sites.Item.TermStores.Item.Sets.Item.Children.Item {
    ...
    public class TermRequestBuilder {
        ...
        public Command BuildChildrenCommand() {
            ...
            var builder = new ApiSdk.Sites.Item.TermStores.Item.Sets.Item.Children.Item.Children.ChildrenRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string siteId, string storeId, string setId, string termId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, siteIdOption, storeIdOption, setIdOption, termIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// Children terms of set in term [store].
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string siteId, string storeId, string setId, string termId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, siteIdOption, storeIdOption, setIdOption, termIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// Children terms of set in term [store].
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string siteId, string storeId, string setId, string termId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, siteIdOption, storeIdOption, setIdOption, termIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        public Command BuildRelationsCommand() {
            var command = new Command("relations");
            var builder = new ApiSdk.Sites.Item.TermStores.Item.Sets.Item.Children.Item.Relations.RelationsRequestBuilder(PathParameters, RequestAdapter);
            foreach (var cmd in builder.BuildCommand()) {
                command.AddCommand(cmd);
            }
            command.AddCommand(builder.BuildCreateCommand());
        ...
        public Command BuildSetCommand() {
            ...
            var builder = new ApiSdk.Sites.Item.TermStores.Item.Sets.Item.Children.Item.Set.SetRequestBuilder(PathParameters, RequestAdapter);
