...
namespace ApiSdk.Sites.Item.TermStores.Item.Sets.Item.Terms.Item.Children.Item {
    ...
    public class TermRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string siteId, string storeId, string setId, string termId, string termId1) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string siteId, string storeId, string setId, string termId, string termId1, string[] select, string[] expand) => {
            ...
            }, siteIdOption, storeIdOption, setIdOption, termIdOption, termId1Option, selectOption, expandOption);
            return command;
        }
        /// <summary>
        /// Children of current term.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string siteId, string storeId, string setId, string termId, string termId1, string body) => {
