...
using ApiSdk.Sites.Item.TermStores.Item.Sets.Item.Terms.Item.Relations.Item.FromTerm;
using ApiSdk.Sites.Item.TermStores.Item.Sets.Item.Terms.Item.Relations.Item.Set;
using ApiSdk.Sites.Item.TermStores.Item.Sets.Item.Terms.Item.Relations.Item.ToTerm;
...
namespace ApiSdk.Sites.Item.TermStores.Item.Sets.Item.Terms.Item.Relations.Item {
    ...
    public class RelationRequestBuilder {
        ...
        public Command BuildFromTermCommand() {
            ...
            var builder = new ApiSdk.Sites.Item.TermStores.Item.Sets.Item.Terms.Item.Relations.Item.FromTerm.FromTermRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildSetCommand() {
            ...
            var builder = new ApiSdk.Sites.Item.TermStores.Item.Sets.Item.Terms.Item.Relations.Item.Set.SetRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildGetCommand());
            command.AddCommand(builder.BuildRefCommand());
            return command;
        }
        public Command BuildToTermCommand() {
            ...
            var builder = new ApiSdk.Sites.Item.TermStores.Item.Sets.Item.Terms.Item.Relations.Item.ToTerm.ToTermRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildGetCommand());
            command.AddCommand(builder.BuildRefCommand());
            return command;
        }
