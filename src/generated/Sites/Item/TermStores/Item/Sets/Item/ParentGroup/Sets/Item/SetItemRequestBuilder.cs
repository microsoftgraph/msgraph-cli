...
namespace ApiSdk.Sites.Item.TermStores.Item.Sets.Item.ParentGroup.Sets.Item {
    ...
    public class SetItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public SetItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/sites/{site%2Did}/termStores/{store%2Did}/sets/{set%2Did}/parentGroup/sets/{set%2Did1}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Delete navigation property sets for sites
        /// </summary>
