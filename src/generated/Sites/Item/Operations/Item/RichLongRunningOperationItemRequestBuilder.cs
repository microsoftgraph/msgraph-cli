...
namespace ApiSdk.Sites.Item.Operations.Item {
    ...
    public class RichLongRunningOperationItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public RichLongRunningOperationItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/sites/{site%2Did}/operations/{richLongRunningOperation%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Delete navigation property operations for sites
        /// </summary>
