...
namespace ApiSdk.Sites.Item.Lists.Item.Operations.Item {
    ...
    public class RichLongRunningOperationItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public RichLongRunningOperationItemRequestBuilder(string rawUrl) : base("{+baseurl}/sites/{site%2Did}/lists/{list%2Did}/operations/{richLongRunningOperation%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Delete navigation property operations for sites
        /// </summary>
