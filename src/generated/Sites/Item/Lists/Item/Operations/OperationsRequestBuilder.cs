...
using ApiSdk.Models;
using ApiSdk.Sites.Item.Lists.Item.Operations.Count;
using ApiSdk.Sites.Item.Lists.Item.Operations.Item;
...
using System;
namespace ApiSdk.Sites.Item.Lists.Item.Operations {
    /// <summary>
    ...
    public class OperationsRequestBuilder : BaseCliRequestBuilder {
        ...
        public OperationsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/sites/{site%2Did}/lists/{list%2Did}/operations{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// The collection of long-running operations on the list.
        /// </summary>
