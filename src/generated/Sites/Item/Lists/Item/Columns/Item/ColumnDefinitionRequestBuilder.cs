...
namespace ApiSdk.Sites.Item.Lists.Item.Columns.Item {
    ...
    public class ColumnDefinitionRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string siteId, string listId, string columnDefinitionId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, siteIdOption, listIdOption, columnDefinitionIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The collection of field definitions for this list.
