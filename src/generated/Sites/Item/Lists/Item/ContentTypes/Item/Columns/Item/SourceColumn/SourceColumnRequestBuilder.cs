...
using ApiSdk.Sites.Item.Lists.Item.ContentTypes.Item.Columns.Item.SourceColumn.Ref;
...
namespace ApiSdk.Sites.Item.Lists.Item.ContentTypes.Item.Columns.Item.SourceColumn {
    ...
    public class SourceColumnRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string siteId, string listId, string contentTypeId, string columnDefinitionId, string[] select, string[] expand, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
            ...
            }, siteIdOption, listIdOption, contentTypeIdOption, columnDefinitionIdOption, selectOption, expandOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        public Command BuildRefCommand() {
            var command = new Command("ref");
            var builder = new ApiSdk.Sites.Item.Lists.Item.ContentTypes.Item.Columns.Item.SourceColumn.Ref.RefRequestBuilder(PathParameters, RequestAdapter);
