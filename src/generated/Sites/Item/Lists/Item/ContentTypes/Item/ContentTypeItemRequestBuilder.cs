...
namespace ApiSdk.Sites.Item.Lists.Item.ContentTypes.Item {
    ...
    public class ContentTypeItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public ContentTypeItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/sites/{site%2Did}/lists/{list%2Did}/contentTypes/{contentType%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Delete navigation property contentTypes for sites
        /// </summary>
