...
namespace ApiSdk.Sites.Item.Lists.Item.ContentTypes.Item {
    ...
    public class ContentTypeRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string siteId, string listId, string contentTypeId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, siteIdOption, listIdOption, contentTypeIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The collection of content types present in this list.
