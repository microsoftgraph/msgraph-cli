...
namespace ApiSdk.Sites.Item.Lists.Item.ContentTypes.Item.BaseTypes.@Ref {
    ...
    public class RefRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string, int?, int?, string, string, bool?, object>(async (siteId, listId, contentTypeId, top, skip, search, filter, count, orderby) => {
