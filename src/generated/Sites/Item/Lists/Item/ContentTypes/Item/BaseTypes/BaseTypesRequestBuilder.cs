...
namespace ApiSdk.Sites.Item.Lists.Item.ContentTypes.Item.BaseTypes {
    ...
    public class BaseTypesRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string, int?, int?, string, string, bool?, string[], string[], string[]>(async (siteId, listId, contentTypeId, top, skip, search, filter, count, orderby, select, expand) => {
