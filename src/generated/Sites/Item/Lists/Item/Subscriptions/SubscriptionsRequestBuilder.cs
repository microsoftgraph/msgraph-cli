...
namespace ApiSdk.Sites.Item.Lists.Item.Subscriptions {
    ...
    public class SubscriptionsRequestBuilder : BaseCliRequestBuilder {
        ...
        public SubscriptionsRequestBuilder(string rawUrl) : base("{+baseurl}/sites/{site%2Did}/lists/{list%2Did}/subscriptions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// The set of subscriptions on the list.
        /// </summary>
