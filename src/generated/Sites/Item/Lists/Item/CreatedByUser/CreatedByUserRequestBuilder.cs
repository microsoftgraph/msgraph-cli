...
namespace ApiSdk.Sites.Item.Lists.Item.CreatedByUser {
    ...
    public class CreatedByUserRequestBuilder : BaseCliRequestBuilder {
        ...
        public CreatedByUserRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/sites/{site%2Did}/lists/{list%2Did}/createdByUser{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Identity of the user who created the item. Read-only.
        /// </summary>
