...
namespace ApiSdk.Sites.Item.Lists.Item.Items.Item.Versions.Item.Fields {
    ...
    public class FieldsRequestBuilder : BaseCliRequestBuilder {
        ...
        public FieldsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/sites/{site%2Did}/lists/{list%2Did}/items/{listItem%2Did}/versions/{listItemVersion%2Did}/fields{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Delete navigation property fields for sites
        /// </summary>
