...
namespace ApiSdk.Sites.Item.Lists.Item.Items.Item.Analytics.Ref {
    ...
    public class RefRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string siteId, string listId, string listItemId, IConsole console) => {
        ...
        public Command BuildPutCommand() {
            ...
            command.SetHandler(async (string siteId, string listId, string listItemId, string body, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
