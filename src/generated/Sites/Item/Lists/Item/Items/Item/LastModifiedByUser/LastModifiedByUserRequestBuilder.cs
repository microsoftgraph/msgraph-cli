...
namespace ApiSdk.Sites.Item.Lists.Item.Items.Item.LastModifiedByUser {
    ...
    public class LastModifiedByUserRequestBuilder : BaseCliRequestBuilder {
        ...
        public LastModifiedByUserRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/sites/{site%2Did}/lists/{list%2Did}/items/{listItem%2Did}/lastModifiedByUser{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Identity of the user who last modified the item. Read-only.
        /// </summary>
