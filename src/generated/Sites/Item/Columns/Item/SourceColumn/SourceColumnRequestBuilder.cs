...
namespace ApiSdk.Sites.Item.Columns.Item.SourceColumn {
    ...
    public class SourceColumnRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string siteId, string columnDefinitionId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, siteIdOption, columnDefinitionIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
