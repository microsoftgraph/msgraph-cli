...
namespace ApiSdk.Sites.Item.Columns.Item.SourceColumn {
    ...
    public class SourceColumnRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string siteId, string columnDefinitionId, string[] select, string[] expand) => {
            ...
            }, siteIdOption, columnDefinitionIdOption, selectOption, expandOption);
            return command;
        }
