...
namespace ApiSdk.Sites.Item.Sites.Item {
    ...
    public class SiteRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string siteId, string siteId1, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, siteIdOption, siteId1Option, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The collection of the sub-sites under this site.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string siteId, string siteId1, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, siteIdOption, siteId1Option, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The collection of the sub-sites under this site.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string siteId, string siteId1, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, siteIdOption, siteId1Option, bodyOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
