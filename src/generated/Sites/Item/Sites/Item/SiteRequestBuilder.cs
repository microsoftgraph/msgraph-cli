...
namespace ApiSdk.Sites.Item.Sites.Item {
    ...
    public class SiteRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.AddOption(new Option<string>("--site-id1", description: "key: id of site"));
            command.Handler = CommandHandler.Create<string, string>(async (siteId, siteId1) => {
                var requestInfo = CreateDeleteRequestInformation();
                if (!String.IsNullOrEmpty(siteId)) requestInfo.PathParameters.Add("site_id", siteId);
                if (!String.IsNullOrEmpty(siteId1)) requestInfo.PathParameters.Add("site_id1", siteId1);
        ...
        public Command BuildGetCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, object, object>(async (siteId, siteId1, select, expand) => {
        ...
        public Command BuildPatchCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string>(async (siteId, siteId1, body) => {
