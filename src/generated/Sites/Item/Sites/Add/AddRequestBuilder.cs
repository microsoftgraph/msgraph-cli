...
namespace ApiSdk.Sites.Item.Sites.Add {
    ...
    public class AddRequestBuilder : BaseCliRequestBuilder {
        ...
        public AddRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/sites/{site%2Did}/sites/add", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new <see cref="AddRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public AddRequestBuilder(string rawUrl) : base("{+baseurl}/sites/{site%2Did}/sites/add", rawUrl) {
        }
        /// <summary>
        /// Follow a user&apos;s site or multiple sites.
        /// </summary>
