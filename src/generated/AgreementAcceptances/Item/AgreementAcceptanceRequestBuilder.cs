...
namespace ApiSdk.AgreementAcceptances.Item {
    ...
    public class AgreementAcceptanceRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string agreementAcceptanceId, IConsole console) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string agreementAcceptanceId, string[] select, FormatterType output, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string agreementAcceptanceId, string body, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
