using ApiSdk.External.Connections.Item.Items.Item.Activities.Count;
using ApiSdk.External.Connections.Item.Items.Item.Activities.Item;
...
using System;
namespace ApiSdk.External.Connections.Item.Items.Item.Activities {
    /// <summary>
    ...
    public class ActivitiesRequestBuilder : BaseCliRequestBuilder {
        ...
        public Tuple<List<Command>, List<Command>> BuildCommand() {
            ...
            var builder = new ExternalActivityItemRequestBuilder(PathParameters);
            executables.Add(builder.BuildDeleteCommand());
            executables.Add(builder.BuildGetCommand());
            executables.Add(builder.BuildPatchCommand());
            commands.Add(builder.BuildPerformedByNavCommand());
        ...
        public Command BuildCreateCommand() {
            ...
            command.Description = "Create new navigation property to activities for external";
        ...
        public ActivitiesRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/external/connections/{externalConnection%2Did}/items/{externalItem%2Did}/activities{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Returns a list of activities performed on the item. Write-only.
        /// </summary>
