...
namespace ApiSdk.External.Connections.Item.Items.Item.Activities {
    ...
    public class ActivitiesRequestBuilder : BaseCliRequestBuilder {
        ...
        public ActivitiesRequestBuilder(string rawUrl) : base("{+baseurl}/external/connections/{externalConnection%2Did}/items/{externalItem%2Did}/activities{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Returns a list of activities performed on the item. Write-only.
        /// </summary>
