...
namespace ApiSdk.Functions.Item {
    ...
    public class AttributeMappingFunctionSchemaItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            attributeMappingFunctionSchemaIdOption.IsRequired = true;
            command.AddOption(attributeMappingFunctionSchemaIdOption);
            ...
            command.SetHandler(async (invocationContext) => {
                var attributeMappingFunctionSchemaId = invocationContext.ParseResult.GetValueForOption(attributeMappingFunctionSchemaIdOption);
                var ifMatch = invocationContext.ParseResult.GetValueForOption(ifMatchOption);
                var cancellationToken = invocationContext.GetCancellationToken();
                var reqAdapter = invocationContext.GetRequestAdapter();
                var requestInfo = ToDeleteRequestInformation(q => {
                });
                if (attributeMappingFunctionSchemaId is not null) requestInfo.PathParameters.Add("attributeMappingFunctionSchema%2Did", attributeMappingFunctionSchemaId);
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<AttributeMappingFunctionSchema>(AttributeMappingFunctionSchema.CreateFromDiscriminatorValue);
...
#nullable restore
        ...
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<AttributeMappingFunctionSchemaItemRequestBuilderGetQueryParameters>> requestConfiguration = default) {
            ...
            if (requestConfiguration != null) {
                var requestConfig = new RequestConfiguration<AttributeMappingFunctionSchemaItemRequestBuilderGetQueryParameters>();
                requestConfiguration.Invoke(requestConfig);
                requestInfo.AddQueryParameters(requestConfig.QueryParameters);
                requestInfo.AddRequestOptions(requestConfig.Options);
                requestInfo.AddHeaders(requestConfig.Headers);
