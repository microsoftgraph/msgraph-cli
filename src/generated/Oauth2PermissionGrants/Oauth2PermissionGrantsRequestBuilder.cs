...
namespace ApiSdk.Oauth2PermissionGrants {
    ...
    public class Oauth2PermissionGrantsRequestBuilder {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<OAuth2PermissionGrant> PostAsync(OAuth2PermissionGrant model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
