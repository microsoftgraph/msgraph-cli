...
namespace ApiSdk.AppCatalogs {
    ...
    public class AppCatalogsRequestBuilder {
        ...
        public AppCatalogsRequestBuilder(Dictionary<string, object> pathParameters) {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.AppCatalogs body, Action<AppCatalogsRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.AppCatalogs body, Action<AppCatalogsRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
