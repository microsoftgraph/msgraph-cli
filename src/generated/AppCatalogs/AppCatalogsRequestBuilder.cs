    ...
    public class AppCatalogsRequestBuilder {
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Models.Microsoft.Graph.AppCatalogs>(ApiSdk.Models.Microsoft.Graph.AppCatalogs.CreateFromDiscriminatorValue);
        ...
        public Command BuildTeamsAppsCommand() {
            ...
            var builder = new TeamsAppsRequestBuilder(PathParameters, RequestAdapter);
        ...
        /// <param name="options">Request options</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(ApiSdk.Models.Microsoft.Graph.AppCatalogs body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
