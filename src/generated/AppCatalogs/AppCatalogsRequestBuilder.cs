...
namespace ApiSdk.AppCatalogs {
    ...
    public class AppCatalogsRequestBuilder {
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(ApiSdk.Models.AppCatalogs body, Action<AppCatalogsRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
