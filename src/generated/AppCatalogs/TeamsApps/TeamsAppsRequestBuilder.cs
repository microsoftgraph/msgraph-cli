...
namespace ApiSdk.AppCatalogs.TeamsApps {
    ...
    public class TeamsAppsRequestBuilder {
        ...
        public List<Command> BuildCommand() {
            var builder = new TeamsAppItemRequestBuilder(PathParameters, RequestAdapter);
            var commands = new List<Command>();
            commands.Add(builder.BuildAppDefinitionsCommand());
        ...
        /// <param name="options">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ApiSdk.Models.Microsoft.Graph.TeamsApp body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
