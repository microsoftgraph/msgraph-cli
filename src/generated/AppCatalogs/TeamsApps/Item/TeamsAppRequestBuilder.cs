...
namespace ApiSdk.AppCatalogs.TeamsApps.Item {
    ...
    public class TeamsAppRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string teamsAppId, IConsole console) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string teamsAppId, string[] select, string[] expand, FormatterType output, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string teamsAppId, string body, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
