...
namespace ApiSdk.AppCatalogs.TeamsApps.Item.AppDefinitions.Item {
    ...
    public class TeamsAppDefinitionRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string teamsAppId, string teamsAppDefinitionId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, teamsAppIdOption, teamsAppDefinitionIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The details for each version of the app.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string teamsAppId, string teamsAppDefinitionId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, teamsAppIdOption, teamsAppDefinitionIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The details for each version of the app.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string teamsAppId, string teamsAppDefinitionId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, teamsAppIdOption, teamsAppDefinitionIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
