...
namespace ApiSdk.AppCatalogs.TeamsApps.Item.AppDefinitions.Item {
    ...
    public class TeamsAppDefinitionItemRequestBuilder {
        ...
        /// <param name="options">Request options</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(ApiSdk.Models.Microsoft.Graph.TeamsAppDefinition body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
