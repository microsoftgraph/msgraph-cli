...
namespace ApiSdk.AppCatalogs.TeamsApps.Item.AppDefinitions.Item.Bot {
    ...
    public class BotRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            }, teamsAppIdOption, teamsAppDefinitionIdOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// The details of the bot specified in the Teams app manifest.
        ...
        public Command BuildGetCommand() {
            ...
            }, teamsAppIdOption, teamsAppDefinitionIdOption, selectOption, expandOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// The details of the bot specified in the Teams app manifest.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string teamsAppId, string teamsAppDefinitionId, string body, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                ...
                await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                console.WriteLine("Success");
            }, teamsAppIdOption, teamsAppDefinitionIdOption, bodyOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
