...
namespace ApiSdk.AppCatalogs.TeamsApps.Item.AppDefinitions.Item.Bot {
    ...
    public class BotRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(teamsAppIdOption, teamsAppDefinitionIdOption, selectOption, expandOption, outputOption, queryOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// The details of the bot specified in the Teams app manifest.
