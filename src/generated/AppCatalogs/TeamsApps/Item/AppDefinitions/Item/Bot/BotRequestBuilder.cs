...
namespace ApiSdk.AppCatalogs.TeamsApps.Item.AppDefinitions.Item.Bot {
    ...
    public class BotRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string teamsAppId, string teamsAppDefinitionId, IConsole console) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string teamsAppId, string teamsAppDefinitionId, string[] select, string[] expand, FormatterType output, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string teamsAppId, string teamsAppDefinitionId, string body, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(TeamworkBot model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
