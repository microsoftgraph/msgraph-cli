...
namespace ApiSdk.AppCatalogs.TeamsApps.Item.AppDefinitions {
    ...
    public class AppDefinitionsRequestBuilder {
        ...
        /// <param name="options">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ApiSdk.Models.TeamsAppDefinition body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
