...
namespace ApiSdk.AppCatalogs.TeamsApps.Item.AppDefinitions {
    ...
    public class AppDefinitionsRequestBuilder {
        ...
        public Command BuildCommand() {
            ...
            command.AddCommand(builder.BuildBotCommand());
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ApiSdk.Models.TeamsAppDefinition body, Action<AppDefinitionsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
