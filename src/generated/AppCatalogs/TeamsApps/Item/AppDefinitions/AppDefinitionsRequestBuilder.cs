...
namespace ApiSdk.AppCatalogs.TeamsApps.Item.AppDefinitions {
    ...
    public class AppDefinitionsRequestBuilder {
        ...
        public Command BuildListCommand() {
            ...
            command.Handler = CommandHandler.Create<string, int?, int?, string, string, bool?, string[], string[], string[]>(async (teamsAppId, top, skip, search, filter, count, orderby, select, expand) => {
