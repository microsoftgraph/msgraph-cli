...
namespace ApiSdk.Connections.Item.Items.Item.Activities.Item.PerformedBy {
    ...
    public class PerformedByRequestBuilder : BaseCliRequestBuilder {
        ...
        public PerformedByRequestBuilder(string rawUrl) : base("{+baseurl}/connections/{externalConnection%2Did}/items/{externalItem%2Did}/activities/{externalActivity%2Did}/performedBy{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Represents an identity used to identify who is responsible for the activity.
        /// </summary>
