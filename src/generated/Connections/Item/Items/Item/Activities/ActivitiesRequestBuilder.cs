using ApiSdk.Connections.Item.Items.Item.Activities.Count;
using ApiSdk.Connections.Item.Items.Item.Activities.Item;
...
using System;
namespace ApiSdk.Connections.Item.Items.Item.Activities {
    /// <summary>
    ...
    public class ActivitiesRequestBuilder : BaseCliRequestBuilder {
        ...
        public Command BuildCreateCommand() {
            ...
            command.Description = "Create new navigation property to activities for connections";
        ...
        public ActivitiesRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/connections/{externalConnection%2Did}/items/{externalItem%2Did}/activities{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Returns a list of activities performed on the item. Write-only.
        /// </summary>
