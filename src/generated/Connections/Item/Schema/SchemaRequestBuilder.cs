...
namespace ApiSdk.Connections.Item.Schema {
    ...
    public class SchemaRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            }, new CollectionBinding(externalConnectionIdOption, ifMatchOption, new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// Read-only. Nullable.
        ...
        /// <param name="options">Request options</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(ApiSdk.Models.ExternalConnectors.Schema body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
