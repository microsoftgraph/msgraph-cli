...
namespace ApiSdk.Connections.Item.Schema {
    ...
    public class SchemaRequestBuilder {
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(ApiSdk.Models.ExternalConnectors.Schema body, Action<SchemaRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
