...
namespace ApiSdk.Connections.Item.Schema {
    ...
    public class SchemaRequestBuilder : BaseCliRequestBuilder {
        ...
        public SchemaRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/connections/{externalConnection%2Did}/schema{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Delete navigation property schema for connections
        /// </summary>
