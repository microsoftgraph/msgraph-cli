    ...
    public class GroupsRequestBuilder {
        ...
        public Command BuildCreateCommand() {
            ...
            command.SetHandler(async (string externalConnectionId, string body) => {
                ...
                var result = await RequestAdapter.SendAsync<ExternalGroup>(requestInfo);
        ...
        public Command BuildListCommand() {
            ...
            command.SetHandler(async (string externalConnectionId, int? top, int? skip, string search, string filter, bool? count, string[] orderby, string[] select, string[] expand) => {
                ...
                var strContent = await reader.ReadToEndAsync();
                Console.Write(strContent + "\n");
            }, externalConnectionIdOption, topOption, skipOption, searchOption, filterOption, countOption, orderbyOption, selectOption, expandOption);
            return command;
        }
        /// <summary>
