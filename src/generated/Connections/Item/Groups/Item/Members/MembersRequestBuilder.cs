...
namespace ApiSdk.Connections.Item.Groups.Item.Members {
    ...
    public class MembersRequestBuilder {
        ...
        public Command BuildCreateCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string>(async (externalConnectionId, externalGroupId, body) => {
        ...
        public Command BuildListCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, int?, int?, string, string, bool?, object, object, object>(async (externalConnectionId, externalGroupId, top, skip, search, filter, count, orderby, select, expand) => {
