...
namespace ApiSdk.Connections.Item.Groups.Item.Members {
    ...
    public class MembersRequestBuilder {
        ...
        public Command BuildListCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, int?, int?, string, string, bool?, string[], string[], string[]>(async (externalConnectionId, externalGroupId, top, skip, search, filter, count, orderby, select, expand) => {
