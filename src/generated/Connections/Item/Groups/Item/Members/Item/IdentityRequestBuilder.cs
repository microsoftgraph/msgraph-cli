...
namespace ApiSdk.Connections.Item.Groups.Item.Members.Item {
    ...
    public class IdentityRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            }, externalConnectionIdOption, externalGroupIdOption, identityIdOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// A member added to an externalGroup. You can add Azure Active Directory users, Azure Active Directory groups, or other externalGroups as members.
        ...
        public Command BuildGetCommand() {
            ...
            }, externalConnectionIdOption, externalGroupIdOption, identityIdOption, selectOption, expandOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// A member added to an externalGroup. You can add Azure Active Directory users, Azure Active Directory groups, or other externalGroups as members.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string externalConnectionId, string externalGroupId, string identityId, string body, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                ...
                await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                console.WriteLine("Success");
            }, externalConnectionIdOption, externalGroupIdOption, identityIdOption, bodyOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
