...
namespace ApiSdk.Localizations.Item {
    ...
    public class OrganizationalBrandingLocalizationRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string organizationalBrandingLocalizationId, IConsole console) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string organizationalBrandingLocalizationId, string[] select, string[] expand, FormatterType output, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string organizationalBrandingLocalizationId, string body, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
