...
using System;
namespace ApiSdk.Localizations.Item.CustomCSS {
    /// <summary>
    /// Provides operations to manage the media for the organizationalBrandingLocalization entity.
    /// </summary>
    public class CustomCSSRequestBuilder : BaseCliRequestBuilder {
        /// <summary>
        /// Get customCSS for organizationalBrandingLocalization from localizations
        /// </summary>
        public Command BuildGetCommand() {
            var command = new Command("get");
            command.Description = "Get customCSS for organizationalBrandingLocalization from localizations";
        ...
        public Command BuildPutCommand() {
            ...
            command.Description = "Update customCSS for organizationalBrandingLocalization in localizations";
            var organizationalBrandingLocalizationIdOption = new Option<string>("--organizational-branding-localization-id", description: "The unique identifier of organizationalBrandingLocalization") {
            };
            organizationalBrandingLocalizationIdOption.IsRequired = true;
            command.AddOption(organizationalBrandingLocalizationIdOption);
        ...
        public CustomCSSRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/localizations/{organizationalBrandingLocalization%2Did}/customCSS", pathParameters) {
        }
        /// <summary>
        /// Get customCSS for organizationalBrandingLocalization from localizations
        /// </summary>
