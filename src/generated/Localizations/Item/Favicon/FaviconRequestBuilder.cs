...
using System;
namespace ApiSdk.Localizations.Item.Favicon {
    /// <summary>
    ...
    public class FaviconRequestBuilder : BaseCliRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.Description = "Get favicon for organizationalBrandingLocalization from localizations";
        ...
        public Command BuildPutCommand() {
            ...
            command.Description = "Update favicon for organizationalBrandingLocalization in localizations";
            var organizationalBrandingLocalizationIdOption = new Option<string>("--organizational-branding-localization-id", description: "The unique identifier of organizationalBrandingLocalization") {
            };
            organizationalBrandingLocalizationIdOption.IsRequired = true;
            command.AddOption(organizationalBrandingLocalizationIdOption);
        ...
        public FaviconRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/localizations/{organizationalBrandingLocalization%2Did}/favicon", pathParameters) {
        }
        /// <summary>
        /// Get favicon for organizationalBrandingLocalization from localizations
        /// </summary>
