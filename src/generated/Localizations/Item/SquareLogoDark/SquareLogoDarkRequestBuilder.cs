...
using System;
namespace ApiSdk.Localizations.Item.SquareLogoDark {
    /// <summary>
    /// Provides operations to manage the media for the organizationalBrandingLocalization entity.
    /// </summary>
    public class SquareLogoDarkRequestBuilder : BaseCliRequestBuilder {
        /// <summary>
        /// Get squareLogoDark for organizationalBrandingLocalization from localizations
        /// </summary>
        public Command BuildGetCommand() {
            var command = new Command("get");
            command.Description = "Get squareLogoDark for organizationalBrandingLocalization from localizations";
        ...
        public Command BuildPutCommand() {
            ...
            command.Description = "Update squareLogoDark for organizationalBrandingLocalization in localizations";
            var organizationalBrandingLocalizationIdOption = new Option<string>("--organizational-branding-localization-id", description: "The unique identifier of organizationalBrandingLocalization") {
            };
            organizationalBrandingLocalizationIdOption.IsRequired = true;
            command.AddOption(organizationalBrandingLocalizationIdOption);
        ...
        public SquareLogoDarkRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/localizations/{organizationalBrandingLocalization%2Did}/squareLogoDark", pathParameters) {
        }
        /// <summary>
        /// Get squareLogoDark for organizationalBrandingLocalization from localizations
        /// </summary>
