...
using System;
namespace ApiSdk.Localizations.Item.HeaderLogo {
    /// <summary>
    ...
    public class HeaderLogoRequestBuilder : BaseCliRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.Description = "Get headerLogo for organizationalBrandingLocalization from localizations";
        ...
        public Command BuildPutCommand() {
            ...
            command.Description = "Update headerLogo for organizationalBrandingLocalization in localizations";
            var organizationalBrandingLocalizationIdOption = new Option<string>("--organizational-branding-localization-id", description: "The unique identifier of organizationalBrandingLocalization") {
            };
            organizationalBrandingLocalizationIdOption.IsRequired = true;
            command.AddOption(organizationalBrandingLocalizationIdOption);
        ...
        public HeaderLogoRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/localizations/{organizationalBrandingLocalization%2Did}/headerLogo", pathParameters) {
        }
        /// <summary>
        /// Get headerLogo for organizationalBrandingLocalization from localizations
        /// </summary>
