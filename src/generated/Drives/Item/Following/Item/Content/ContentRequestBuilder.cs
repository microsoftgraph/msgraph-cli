...
namespace ApiSdk.Drives.Item.Following.Item.Content {
    ...
    public class ContentRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string driveId, string driveItemId, FileInfo file, FormatterType output, IConsole console) => {
        ...
        public Command BuildPutCommand() {
            ...
            command.SetHandler(async (string driveId, string driveItemId, FileInfo file, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
