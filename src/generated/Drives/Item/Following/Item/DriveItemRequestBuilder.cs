...
namespace ApiSdk.Drives.Item.Following.Item {
    ...
    public class DriveItemRequestBuilder {
        ...
        public Command BuildContentCommand() {
            ...
            var builder = new ApiSdk.Drives.Item.Following.Item.Content.ContentRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string driveId, string driveItemId, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                var requestInfo = CreateDeleteRequestInformation(q => {
                });
                await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                console.WriteLine("Success");
            }, driveIdOption, driveItemIdOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// The list of items the user is following. Only in OneDrive for Business.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string driveId, string driveItemId, string[] select, string[] expand, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
            ...
            }, driveIdOption, driveItemIdOption, selectOption, expandOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// The list of items the user is following. Only in OneDrive for Business.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string driveId, string driveItemId, string body, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                ...
                await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                console.WriteLine("Success");
            }, driveIdOption, driveItemIdOption, bodyOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
