...
namespace ApiSdk.Drives.Item.Following.Item {
    ...
    public class DriveItemRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string driveId, string driveItemId, IConsole console) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string driveId, string driveItemId, string[] select, string[] expand, FormatterType output, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string driveId, string driveItemId, string body, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
