...
namespace ApiSdk.Drives.Item.Following.Item {
    ...
    public class DriveItemRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string driveId, string driveItemId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, driveIdOption, driveItemIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The list of items the user is following. Only in OneDrive for Business.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string driveId, string driveItemId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, driveIdOption, driveItemIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The list of items the user is following. Only in OneDrive for Business.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string driveId, string driveItemId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, driveIdOption, driveItemIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
