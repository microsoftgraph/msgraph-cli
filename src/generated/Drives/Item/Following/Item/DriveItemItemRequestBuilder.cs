...
namespace ApiSdk.Drives.Item.Following.Item {
    ...
    public class DriveItemItemRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            }, new CollectionBinding(driveIdOption, driveItemIdOption, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// The list of items the user is following. Only in OneDrive for Business.
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(driveIdOption, driveItemIdOption, selectOption, expandOption, outputOption, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// The list of items the user is following. Only in OneDrive for Business.
