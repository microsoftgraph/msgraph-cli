...
namespace ApiSdk.Drives.Item.Items {
    ...
    public class ItemsRequestBuilder : BaseCliRequestBuilder {
        ...
        public ItemsRequestBuilder(string rawUrl) : base("{+baseurl}/drives/{drive%2Did}/items{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// All items contained in the drive. Read-only. Nullable.
        /// </summary>
