...
namespace ApiSdk.Drives.Item.Items.Item.Workbook
{
    ...
    public partial class WorkbookRequestBuilder : BaseCliRequestBuilder
    {
        /// <summary>
        ...
        public Command BuildApplicationNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Drives.Item.Items.Item.Workbook.Application.ApplicationRequestBuilder(PathParameters);
        ...
        public Command BuildCloseSessionNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Drives.Item.Items.Item.Workbook.CloseSession.CloseSessionRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        public Command BuildCommentsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Drives.Item.Items.Item.Workbook.Comments.CommentsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
        ...
        public Command BuildCreateSessionNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Drives.Item.Items.Item.Workbook.CreateSession.CreateSessionRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildFunctionsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Drives.Item.Items.Item.Workbook.Functions.FunctionsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
        ...
        public Command BuildOperationsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Drives.Item.Items.Item.Workbook.Operations.OperationsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildCountNavCommand());
            execCommands.Add(builder.BuildCreateCommand());
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<global::ApiSdk.Models.Workbook>(global::ApiSdk.Models.Workbook.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        public Command BuildRefreshSessionNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Drives.Item.Items.Item.Workbook.RefreshSession.RefreshSessionRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildSessionInfoResourceWithKeyRbCommand()
        {
            ...
            var builder = new global::ApiSdk.Drives.Item.Items.Item.Workbook.SessionInfoResourceWithKey.SessionInfoResourceWithKeyRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildTableRowOperationResultWithKeyRbCommand()
        {
            ...
            var builder = new global::ApiSdk.Drives.Item.Items.Item.Workbook.TableRowOperationResultWithKey.TableRowOperationResultWithKeyRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildGetCommand());
            foreach (var cmd in execCommands)
            {
        ...
        public Command BuildWorksheetsNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Drives.Item.Items.Item.Workbook.Worksheets.WorksheetsRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            var nonExecCommands = new List<Command>();
            nonExecCommands.Add(builder.BuildAddNavCommand());
            nonExecCommands.Add(builder.BuildCountNavCommand());
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Drives.Item.Items.Item.Workbook.WorkbookRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Drives.Item.Items.Item.Workbook.WorkbookRequestBuilder.WorkbookRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Drives.Item.Items.Item.Workbook.WorkbookRequestBuilder.WorkbookRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.Workbook body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.Workbook body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
