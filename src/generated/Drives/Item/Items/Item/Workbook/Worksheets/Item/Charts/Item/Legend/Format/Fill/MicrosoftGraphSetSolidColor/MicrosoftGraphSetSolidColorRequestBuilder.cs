...
namespace ApiSdk.Drives.Item.Items.Item.Workbook.Worksheets.Item.Charts.Item.Legend.Format.Fill.MicrosoftGraphSetSolidColor {
    /// <summary>
    ...
    public class MicrosoftGraphSetSolidColorRequestBuilder {
        ...
        public MicrosoftGraphSetSolidColorRequestBuilder(Dictionary<string, object> pathParameters) {
