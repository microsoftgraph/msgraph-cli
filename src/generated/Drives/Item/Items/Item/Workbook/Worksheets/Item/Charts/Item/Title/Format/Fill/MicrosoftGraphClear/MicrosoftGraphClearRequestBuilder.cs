...
namespace ApiSdk.Drives.Item.Items.Item.Workbook.Worksheets.Item.Charts.Item.Title.Format.Fill.MicrosoftGraphClear {
    /// <summary>
    ...
    public class MicrosoftGraphClearRequestBuilder {
        ...
        public MicrosoftGraphClearRequestBuilder(Dictionary<string, object> pathParameters) {
            ...
            UrlTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/charts/{workbookChart%2Did}/title/format/fill/microsoft.graph.clear";
