...
namespace ApiSdk.Drives.Item.Items.Item.Workbook.Worksheets.Item.Charts.ItemAtWithIndex.Legend {
    ...
    public class LegendRequestBuilder : BaseCliRequestBuilder {
        ...
        public LegendRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/charts/itemAt(index={index})/legend{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new LegendRequestBuilder and sets the default values.
        /// </summary>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public LegendRequestBuilder(string rawUrl) : base("{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/charts/itemAt(index={index})/legend{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Delete navigation property legend for drives
        /// </summary>
