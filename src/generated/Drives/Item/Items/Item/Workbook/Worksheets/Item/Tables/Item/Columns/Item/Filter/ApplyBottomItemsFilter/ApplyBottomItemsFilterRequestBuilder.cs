...
namespace ApiSdk.Drives.Item.Items.Item.Workbook.Worksheets.Item.Tables.Item.Columns.Item.Filter.ApplyBottomItemsFilter {
    /// <summary>
    ...
    public class ApplyBottomItemsFilterRequestBuilder : BaseCliRequestBuilder {
        ...
        public ApplyBottomItemsFilterRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/tables/{workbookTable%2Did}/columns/{workbookTableColumn%2Did}/filter/applyBottomItemsFilter", pathParameters) {
        }
        /// <summary>
        /// Invoke action applyBottomItemsFilter
        /// </summary>
