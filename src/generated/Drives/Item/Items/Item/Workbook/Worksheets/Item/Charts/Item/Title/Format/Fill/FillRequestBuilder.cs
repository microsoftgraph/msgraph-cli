using ApiSdk.Drives.Item.Items.Item.Workbook.Worksheets.Item.Charts.Item.Title.Format.Fill.MicrosoftGraphClear;
using ApiSdk.Drives.Item.Items.Item.Workbook.Worksheets.Item.Charts.Item.Title.Format.Fill.MicrosoftGraphSetSolidColor;
using ApiSdk.Models;
...
namespace ApiSdk.Drives.Item.Items.Item.Workbook.Worksheets.Item.Charts.Item.Title.Format.Fill {
    /// <summary>
    ...
    public class FillRequestBuilder {
        ...
        /// </summary>
        public Command BuildMicrosoftGraphSetSolidColorCommand() {
            var command = new Command("microsoft-graph-set-solid-color");
            command.Description = "Provides operations to call the setSolidColor method.";
            var builder = new SetSolidColorRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildPostCommand());
            return command;
        }
        /// <summary>
        ...
        public FillRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/charts/{workbookChart%2Did}/title/format/fill{?%24select,%24expand}";
