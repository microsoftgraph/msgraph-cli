...
namespace ApiSdk.Drives.Item.Items.Item.Workbook.Worksheets.Item.Tables.Item.Rows.ItemAtWithIndex {
    ...
    public class ItemAtWithIndexRequestBuilder : BaseCliRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.Description = "Invoke function itemAt\n\nFind more info here:\n  https://docs.microsoft.com/graph/api/tablerowcollection-itemat?view=graph-rest-1.0";
        ...
        public ItemAtWithIndexRequestBuilder(Dictionary<string, object> pathParameters, int? index = default) : base("{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/tables/{workbookTable%2Did}/rows/itemAt(index={index})", pathParameters) {
