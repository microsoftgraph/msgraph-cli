...
namespace ApiSdk.Drives.Item.Items.Item.Workbook.Worksheets.Item.Names.Item.Worksheet {
    ...
    public class WorksheetRequestBuilder : BaseCliRequestBuilder {
        ...
        public WorksheetRequestBuilder(string rawUrl) : base("{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/names/{workbookNamedItem%2Did}/worksheet{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Returns the worksheet on which the named item is scoped to. Available only if the item is scoped to the worksheet. Read-only.
        /// </summary>
