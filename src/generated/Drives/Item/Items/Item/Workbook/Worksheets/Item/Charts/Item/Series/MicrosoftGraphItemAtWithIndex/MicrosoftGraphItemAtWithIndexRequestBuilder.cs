...
namespace ApiSdk.Drives.Item.Items.Item.Workbook.Worksheets.Item.Charts.Item.Series.MicrosoftGraphItemAtWithIndex {
    /// <summary>
    ...
    public class MicrosoftGraphItemAtWithIndexRequestBuilder {
        ...
        public MicrosoftGraphItemAtWithIndexRequestBuilder(Dictionary<string, object> pathParameters, int? index = default) {
            ...
            UrlTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/charts/{workbookChart%2Did}/series/microsoft.graph.itemAt(index={index})";
