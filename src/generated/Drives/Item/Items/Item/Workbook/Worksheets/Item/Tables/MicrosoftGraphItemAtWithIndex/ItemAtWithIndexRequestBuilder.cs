...
namespace ApiSdk.Drives.Item.Items.Item.Workbook.Worksheets.Item.Tables.MicrosoftGraphItemAtWithIndex {
    /// <summary>
    ...
    public class ItemAtWithIndexRequestBuilder {
        ...
        public ItemAtWithIndexRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter, int? index = default) {
            ...
            UrlTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/tables/microsoft.graph.itemAt(index={index})";
