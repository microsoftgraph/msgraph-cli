...
namespace ApiSdk.Drives.Item.Items.Item.Workbook.Worksheets.Item.Charts.Item.Axes.CategoryAxis.Title.Format.Font {
    ...
    public class FontRequestBuilder : BaseCliRequestBuilder {
        ...
        public FontRequestBuilder(string rawUrl) : base("{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/charts/{workbookChart%2Did}/axes/categoryAxis/title/format/font{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Delete navigation property font for drives
        /// </summary>
