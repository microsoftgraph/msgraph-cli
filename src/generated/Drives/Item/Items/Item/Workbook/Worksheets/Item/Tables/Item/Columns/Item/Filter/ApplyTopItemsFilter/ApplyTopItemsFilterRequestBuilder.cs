...
namespace ApiSdk.Drives.Item.Items.Item.Workbook.Worksheets.Item.Tables.Item.Columns.Item.Filter.ApplyTopItemsFilter {
    ...
    public class ApplyTopItemsFilterRequestBuilder : BaseCliRequestBuilder {
        ...
        public ApplyTopItemsFilterRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/tables/{workbookTable%2Did}/columns/{workbookTableColumn%2Did}/filter/applyTopItemsFilter", pathParameters) {
        }
        /// <summary>
        /// Invoke action applyTopItemsFilter
        /// </summary>
