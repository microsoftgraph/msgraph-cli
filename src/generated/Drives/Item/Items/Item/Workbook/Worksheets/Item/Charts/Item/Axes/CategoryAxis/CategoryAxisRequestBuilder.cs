...
namespace ApiSdk.Drives.Item.Items.Item.Workbook.Worksheets.Item.Charts.Item.Axes.CategoryAxis {
    ...
    public class CategoryAxisRequestBuilder : BaseCliRequestBuilder {
        ...
        public CategoryAxisRequestBuilder(string rawUrl) : base("{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/charts/{workbookChart%2Did}/axes/categoryAxis{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Delete navigation property categoryAxis for drives
        /// </summary>
