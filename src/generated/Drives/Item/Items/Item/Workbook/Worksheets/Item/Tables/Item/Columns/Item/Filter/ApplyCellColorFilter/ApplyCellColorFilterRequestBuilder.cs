...
namespace ApiSdk.Drives.Item.Items.Item.Workbook.Worksheets.Item.Tables.Item.Columns.Item.Filter.ApplyCellColorFilter {
    ...
    public class ApplyCellColorFilterRequestBuilder : BaseCliRequestBuilder {
        ...
        public ApplyCellColorFilterRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/tables/{workbookTable%2Did}/columns/{workbookTableColumn%2Did}/filter/applyCellColorFilter", pathParameters) {
        }
        /// <summary>
        /// Invoke action applyCellColorFilter
        /// </summary>
