...
using System;
namespace ApiSdk.Drives.Item.Items.Item.Workbook.Worksheets.Item.Tables.Item.Columns.Item.Filter.ApplyTopPercentFilter {
    /// <summary>
    ...
    public class ApplyTopPercentFilterRequestBuilder : BaseCliRequestBuilder {
        ...
        public ApplyTopPercentFilterRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/tables/{workbookTable%2Did}/columns/{workbookTableColumn%2Did}/filter/applyTopPercentFilter", pathParameters) {
        }
        /// <summary>
        /// Invoke action applyTopPercentFilter
        /// </summary>
