...
namespace ApiSdk.Drives.Item.Items.Item.Workbook.Worksheets.Item.Charts.Item.Axes.CategoryAxis.MajorGridlines.Format {
    ...
    public class FormatRequestBuilder : BaseCliRequestBuilder {
        ...
        public FormatRequestBuilder(string rawUrl) : base("{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/charts/{workbookChart%2Did}/axes/categoryAxis/majorGridlines/format{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Delete navigation property format for drives
        /// </summary>
