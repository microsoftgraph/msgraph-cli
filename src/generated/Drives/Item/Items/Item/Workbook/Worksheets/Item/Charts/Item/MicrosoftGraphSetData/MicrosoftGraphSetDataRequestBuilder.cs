...
namespace ApiSdk.Drives.Item.Items.Item.Workbook.Worksheets.Item.Charts.Item.MicrosoftGraphSetData {
    /// <summary>
    ...
    public class MicrosoftGraphSetDataRequestBuilder {
        ...
        public MicrosoftGraphSetDataRequestBuilder(Dictionary<string, object> pathParameters) {
