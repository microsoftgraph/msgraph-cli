...
using ApiSdk.Drives.Item.Items.Item.Workbook.Worksheets.Item.Tables.MicrosoftGraphAdd;
using ApiSdk.Drives.Item.Items.Item.Workbook.Worksheets.Item.Tables.MicrosoftGraphCount;
using ApiSdk.Drives.Item.Items.Item.Workbook.Worksheets.Item.Tables.MicrosoftGraphItemAtWithIndex;
using ApiSdk.Models;
...
namespace ApiSdk.Drives.Item.Items.Item.Workbook.Worksheets.Item.Tables {
    ...
    public class TablesRequestBuilder {
        ...
        public TablesRequestBuilder(Dictionary<string, object> pathParameters) {
