...
namespace ApiSdk.Drives.Item.Items.Item.Workbook.Worksheets.Item.Charts.ItemAtWithIndex.Axes {
    ...
    public class AxesRequestBuilder : BaseCliRequestBuilder {
        ...
        public AxesRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/charts/itemAt(index={index})/axes{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new AxesRequestBuilder and sets the default values.
        /// </summary>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public AxesRequestBuilder(string rawUrl) : base("{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/charts/itemAt(index={index})/axes{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Delete navigation property axes for drives
        /// </summary>
