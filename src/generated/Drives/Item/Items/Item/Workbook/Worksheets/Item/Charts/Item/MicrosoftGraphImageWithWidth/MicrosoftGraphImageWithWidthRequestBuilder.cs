...
namespace ApiSdk.Drives.Item.Items.Item.Workbook.Worksheets.Item.Charts.Item.MicrosoftGraphImageWithWidth {
    /// <summary>
    ...
    public class MicrosoftGraphImageWithWidthRequestBuilder {
        ...
        public MicrosoftGraphImageWithWidthRequestBuilder(Dictionary<string, object> pathParameters, int? width = default) {
