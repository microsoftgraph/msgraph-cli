...
namespace ApiSdk.Drives.Item.Items.Item.Workbook.Worksheets.Item.Charts.Item.Axes.ValueAxis.Title {
    ...
    public class TitleRequestBuilder : BaseCliRequestBuilder {
        ...
        public TitleRequestBuilder(string rawUrl) : base("{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/charts/{workbookChart%2Did}/axes/valueAxis/title{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Delete navigation property title for drives
        /// </summary>
