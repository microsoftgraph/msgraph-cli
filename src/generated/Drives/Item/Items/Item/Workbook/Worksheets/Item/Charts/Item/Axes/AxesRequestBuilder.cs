...
namespace ApiSdk.Drives.Item.Items.Item.Workbook.Worksheets.Item.Charts.Item.Axes {
    ...
    public class AxesRequestBuilder {
        ...
        public Command BuildCategoryAxisCommand() {
            ...
            var builder = new CategoryAxisRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildSeriesAxisCommand() {
            ...
            var builder = new SeriesAxisRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildDeleteCommand());
            command.AddCommand(builder.BuildFormatCommand());
            command.AddCommand(builder.BuildGetCommand());
            command.AddCommand(builder.BuildMajorGridlinesCommand());
        ...
        public Command BuildValueAxisCommand() {
            ...
            var builder = new ValueAxisRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildDeleteCommand());
            command.AddCommand(builder.BuildFormatCommand());
            command.AddCommand(builder.BuildGetCommand());
            command.AddCommand(builder.BuildMajorGridlinesCommand());
