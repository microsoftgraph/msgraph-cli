...
namespace ApiSdk.Drives.Item.Items.Item.Workbook.Worksheets.Item.Charts.Item.Axes.ValueAxis.Format.Font {
    ...
    public class FontRequestBuilder : BaseCliRequestBuilder {
        ...
        public FontRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/charts/{workbookChart%2Did}/axes/valueAxis/format/font{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Delete navigation property font for drives
        /// </summary>
