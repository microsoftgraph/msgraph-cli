using ApiSdk.Drives.Item.Items.Item.Workbook.Worksheets.Item.Charts.Item.Title.Format.Fill;
using ApiSdk.Drives.Item.Items.Item.Workbook.Worksheets.Item.Charts.Item.Title.Format.Font;
using ApiSdk.Models;
...
namespace ApiSdk.Drives.Item.Items.Item.Workbook.Worksheets.Item.Charts.Item.Title.Format {
    ...
    public class FormatRequestBuilder : BaseCliRequestBuilder {
        ...
        public FormatRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/charts/{workbookChart%2Did}/title/format{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Delete navigation property format for drives
        /// </summary>
