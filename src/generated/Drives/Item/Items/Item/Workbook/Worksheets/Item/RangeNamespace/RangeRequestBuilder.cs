...
using System;
namespace ApiSdk.Drives.Item.Items.Item.Workbook.Worksheets.Item.RangeNamespace {
    /// <summary>
    ...
    public class RangeRequestBuilder : BaseCliRequestBuilder {
        ...
        public RangeRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/range()", pathParameters) {
        }
        /// <summary>
        /// Invoke function range
        /// </summary>
