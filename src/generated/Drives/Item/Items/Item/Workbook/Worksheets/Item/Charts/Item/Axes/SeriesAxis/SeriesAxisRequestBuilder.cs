...
namespace ApiSdk.Drives.Item.Items.Item.Workbook.Worksheets.Item.Charts.Item.Axes.SeriesAxis {
    ...
    public class SeriesAxisRequestBuilder : BaseCliRequestBuilder {
        ...
        public SeriesAxisRequestBuilder(string rawUrl) : base("{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/charts/{workbookChart%2Did}/axes/seriesAxis{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Delete navigation property seriesAxis for drives
        /// </summary>
