...
namespace ApiSdk.Drives.Item.Items.Item.Workbook.Worksheets.Item.Charts.Item.MicrosoftGraphImageWithWidthWithHeightWithFittingMode {
    /// <summary>
    /// Provides operations to call the image method.
    /// </summary>
    public class MicrosoftGraphImageWithWidthWithHeightWithFittingModeRequestBuilder {
        ...
        public MicrosoftGraphImageWithWidthWithHeightWithFittingModeRequestBuilder(Dictionary<string, object> pathParameters, string fittingMode = "", int? height = default, int? width = default) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            UrlTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/charts/{workbookChart%2Did}/microsoft.graph.image(width={width},height={height},fittingMode='{fittingMode}')";
...
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<MicrosoftGraphImageWithWidthWithHeightWithFittingModeRequestBuilderGetRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<MicrosoftGraphImageWithWidthWithHeightWithFittingModeRequestBuilderGetRequestConfiguration> requestConfiguration = default) {
#endif
            ...
            if (requestConfiguration != null) {
                var requestConfig = new MicrosoftGraphImageWithWidthWithHeightWithFittingModeRequestBuilderGetRequestConfiguration();
        ...
        /// </summary>
        public class MicrosoftGraphImageWithWidthWithHeightWithFittingModeRequestBuilderGetRequestConfiguration {
            /// <summary>Request headers</summary>
            public RequestHeaders Headers { get; set; }
            /// <summary>Request options</summary>
            public IList<IRequestOption> Options { get; set; }
            /// <summary>
            /// Instantiates a new microsoftGraphImageWithWidthWithHeightWithFittingModeRequestBuilderGetRequestConfiguration and sets the default values.
            /// </summary>
            public MicrosoftGraphImageWithWidthWithHeightWithFittingModeRequestBuilderGetRequestConfiguration() {
