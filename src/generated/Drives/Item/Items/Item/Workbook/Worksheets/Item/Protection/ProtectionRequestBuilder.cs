...
namespace ApiSdk.Drives.Item.Items.Item.Workbook.Worksheets.Item.Protection
{
    ...
    public partial class ProtectionRequestBuilder : BaseCliRequestBuilder
    {
        /// <summary>
        ...
        public Command BuildGetCommand()
        {
            ...
            command.Description = "The sheet protection object for a worksheet. Read-only.";
            var driveIdOption = new Option<string>("--drive-id", description: "The unique identifier of drive") {
            };
            driveIdOption.IsRequired = true;
            command.AddOption(driveIdOption);
        ...
        public Command BuildPatchCommand()
        {
            ...
            command.SetHandler(async (invocationContext) => {
                ...
                var model = parseNode.GetObjectValue<global::ApiSdk.Models.WorkbookWorksheetProtection>(global::ApiSdk.Models.WorkbookWorksheetProtection.CreateFromDiscriminatorValue);
                if (model is null) {
        ...
        public Command BuildProtectNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Drives.Item.Items.Item.Workbook.Worksheets.Item.Protection.Protect.ProtectRequestBuilder(PathParameters);
        ...
        public Command BuildUnprotectNavCommand()
        {
            ...
            var builder = new global::ApiSdk.Drives.Item.Items.Item.Workbook.Worksheets.Item.Protection.Unprotect.UnprotectRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Drives.Item.Items.Item.Workbook.Worksheets.Item.Protection.ProtectionRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Drives.Item.Items.Item.Workbook.Worksheets.Item.Protection.ProtectionRequestBuilder.ProtectionRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Drives.Item.Items.Item.Workbook.Worksheets.Item.Protection.ProtectionRequestBuilder.ProtectionRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.WorkbookWorksheetProtection body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(global::ApiSdk.Models.WorkbookWorksheetProtection body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
