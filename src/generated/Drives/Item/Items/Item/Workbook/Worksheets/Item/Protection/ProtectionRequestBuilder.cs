...
namespace ApiSdk.Drives.Item.Items.Item.Workbook.Worksheets.Item.Protection
{
    ...
    public class ProtectionRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildProtectNavCommand()
        {
            ...
            var builder = new ApiSdk.Drives.Item.Items.Item.Workbook.Worksheets.Item.Protection.Protect.ProtectRequestBuilder(PathParameters);
        ...
        public Command BuildUnprotectNavCommand()
        {
            ...
            var builder = new ApiSdk.Drives.Item.Items.Item.Workbook.Worksheets.Item.Protection.Unprotect.UnprotectRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
            execCommands.Add(builder.BuildPostCommand());
            foreach (var cmd in execCommands)
            {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Drives.Item.Items.Item.Workbook.Worksheets.Item.Protection.ProtectionRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Drives.Item.Items.Item.Workbook.Worksheets.Item.Protection.ProtectionRequestBuilder.ProtectionRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Drives.Item.Items.Item.Workbook.Worksheets.Item.Protection.ProtectionRequestBuilder.ProtectionRequestBuilderGetQueryParameters>> requestConfiguration = default)
