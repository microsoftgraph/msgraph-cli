...
namespace ApiSdk.Drives.Item.Items.Item.Workbook.Worksheets.Item.Charts.MicrosoftGraphItemAtWithIndex {
    /// <summary>
    ...
    public class MicrosoftGraphItemAtWithIndexRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.Description = "Invoke function itemAt\n\nFind more info here:\n  https://docs.microsoft.com/graph/api/chartcollection-itemat?view=graph-rest-1.0";
        ...
        public MicrosoftGraphItemAtWithIndexRequestBuilder(Dictionary<string, object> pathParameters, int? index = default) {
            ...
            UrlTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/charts/microsoft.graph.itemAt(index={index})";
