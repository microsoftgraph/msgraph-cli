using ApiSdk.Drives.Item.Items.Item.Workbook.Worksheets.Item.Names.Add;
using ApiSdk.Drives.Item.Items.Item.Workbook.Worksheets.Item.Names.AddFormulaLocal;
...
#nullable restore
        ...
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<NamesRequestBuilderGetQueryParameters>> requestConfiguration = default) {
            ...
            if (requestConfiguration != null) {
                var requestConfig = new RequestConfiguration<NamesRequestBuilderGetQueryParameters>();
