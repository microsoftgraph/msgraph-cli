...
namespace ApiSdk.Drives.Item.Items.Item.Workbook.Worksheets.Item.RangeWithAddress {
    /// <summary>
    ...
    public class RangeWithAddressRequestBuilder {
        ...
        public RangeWithAddressRequestBuilder(Dictionary<string, object> pathParameters, string address = "") {
