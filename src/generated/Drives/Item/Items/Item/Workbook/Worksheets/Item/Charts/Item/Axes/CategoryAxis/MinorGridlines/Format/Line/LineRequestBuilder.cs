using ApiSdk.Drives.Item.Items.Item.Workbook.Worksheets.Item.Charts.Item.Axes.CategoryAxis.MinorGridlines.Format.Line.Clear;
using ApiSdk.Models;
...
namespace ApiSdk.Drives.Item.Items.Item.Workbook.Worksheets.Item.Charts.Item.Axes.CategoryAxis.MinorGridlines.Format.Line {
    /// <summary>
    ...
    public class LineRequestBuilder : BaseCliRequestBuilder {
        ...
        public LineRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/charts/{workbookChart%2Did}/axes/categoryAxis/minorGridlines/format/line{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Delete navigation property line for drives
        /// </summary>
