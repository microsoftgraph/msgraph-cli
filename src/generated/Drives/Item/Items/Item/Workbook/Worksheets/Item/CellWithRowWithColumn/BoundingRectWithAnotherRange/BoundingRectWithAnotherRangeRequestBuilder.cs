...
using System;
namespace ApiSdk.Drives.Item.Items.Item.Workbook.Worksheets.Item.CellWithRowWithColumn.BoundingRectWithAnotherRange
{
    /// <summary>
    ...
    public partial class BoundingRectWithAnotherRangeRequestBuilder : BaseCliRequestBuilder
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Drives.Item.Items.Item.Workbook.Worksheets.Item.CellWithRowWithColumn.BoundingRectWithAnotherRange.BoundingRectWithAnotherRangeRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        public BoundingRectWithAnotherRangeRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/cell(row={row},column={column})/boundingRect(anotherRange='{anotherRange}')", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Drives.Item.Items.Item.Workbook.Worksheets.Item.CellWithRowWithColumn.BoundingRectWithAnotherRange.BoundingRectWithAnotherRangeRequestBuilder"/> and sets the default values.
        ...
        public BoundingRectWithAnotherRangeRequestBuilder(string rawUrl) : base("{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/cell(row={row},column={column})/boundingRect(anotherRange='{anotherRange}')", rawUrl)
        {
        }
        /// <summary>
        /// Invoke function boundingRect
