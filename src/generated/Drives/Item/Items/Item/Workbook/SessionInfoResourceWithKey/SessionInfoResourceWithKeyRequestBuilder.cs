...
namespace ApiSdk.Drives.Item.Items.Item.Workbook.SessionInfoResourceWithKey {
    /// <summary>
    ...
    public class SessionInfoResourceWithKeyRequestBuilder {
        ...
        public SessionInfoResourceWithKeyRequestBuilder(Dictionary<string, object> pathParameters, string key = "") {
