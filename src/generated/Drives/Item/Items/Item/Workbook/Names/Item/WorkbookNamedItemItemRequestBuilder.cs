...
namespace ApiSdk.Drives.Item.Items.Item.Workbook.Names.Item {
    ...
    public class WorkbookNamedItemItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public WorkbookNamedItemItemRequestBuilder(string rawUrl) : base("{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/names/{workbookNamedItem%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Delete navigation property names for drives
        /// </summary>
