...
namespace ApiSdk.Drives.Item.Items.Item.Workbook.Tables.Item.Columns.Item.Filter.ApplyValuesFilter {
    ...
    public class ApplyValuesFilterRequestBuilder : BaseCliRequestBuilder {
        ...
        public ApplyValuesFilterRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/tables/{workbookTable%2Did}/columns/{workbookTableColumn%2Did}/filter/applyValuesFilter", pathParameters) {
        }
        /// <summary>
        /// Invoke action applyValuesFilter
        /// </summary>
