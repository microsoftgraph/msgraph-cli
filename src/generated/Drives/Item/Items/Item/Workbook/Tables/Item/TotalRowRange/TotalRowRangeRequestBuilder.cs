...
namespace ApiSdk.Drives.Item.Items.Item.Workbook.Tables.Item.TotalRowRange {
    ...
    public class TotalRowRangeRequestBuilder {
        ...
        public TotalRowRangeRequestBuilder(Dictionary<string, object> pathParameters) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            UrlTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/tables/{workbookTable%2Did}/totalRowRange()";
