using ApiSdk.Drives.Item.Items.Item.Workbook.Tables.Item.ClearFilters;
using ApiSdk.Drives.Item.Items.Item.Workbook.Tables.Item.Columns;
using ApiSdk.Drives.Item.Items.Item.Workbook.Tables.Item.ConvertToRange;
using ApiSdk.Drives.Item.Items.Item.Workbook.Tables.Item.DataBodyRange;
using ApiSdk.Drives.Item.Items.Item.Workbook.Tables.Item.HeaderRowRange;
using ApiSdk.Drives.Item.Items.Item.Workbook.Tables.Item.RangeNamespace;
using ApiSdk.Drives.Item.Items.Item.Workbook.Tables.Item.ReapplyFilters;
...
using ApiSdk.Drives.Item.Items.Item.Workbook.Tables.Item.TotalRowRange;
...
namespace ApiSdk.Drives.Item.Items.Item.Workbook.Tables.Item {
    ...
    public class WorkbookTableItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.Description = "Deletes the table.\n\nFind more info here:\n  https://docs.microsoft.com/graph/api/table-delete?view=graph-rest-1.0";
        ...
        public Command BuildPatchCommand() {
            ...
            command.Description = "Update the properties of table object.\n\nFind more info here:\n  https://docs.microsoft.com/graph/api/table-update?view=graph-rest-1.0";
            var driveIdOption = new Option<string>("--drive-id", description: "The unique identifier of drive") {
            };
            driveIdOption.IsRequired = true;
            command.AddOption(driveIdOption);
        ...
        public WorkbookTableItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/tables/{workbookTable%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Deletes the table.
        /// </summary>
...
#nullable restore
        ...
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<WorkbookTableItemRequestBuilderGetQueryParameters>> requestConfiguration = default) {
            ...
            if (requestConfiguration != null) {
                var requestConfig = new RequestConfiguration<WorkbookTableItemRequestBuilderGetQueryParameters>();
                requestConfiguration.Invoke(requestConfig);
                requestInfo.AddQueryParameters(requestConfig.QueryParameters);
                requestInfo.AddRequestOptions(requestConfig.Options);
                requestInfo.AddHeaders(requestConfig.Headers);
