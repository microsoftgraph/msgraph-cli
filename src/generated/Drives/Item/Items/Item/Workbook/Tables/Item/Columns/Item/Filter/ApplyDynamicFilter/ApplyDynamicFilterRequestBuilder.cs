...
namespace ApiSdk.Drives.Item.Items.Item.Workbook.Tables.Item.Columns.Item.Filter.ApplyDynamicFilter {
    ...
    public class ApplyDynamicFilterRequestBuilder : BaseCliRequestBuilder {
        ...
        public ApplyDynamicFilterRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/tables/{workbookTable%2Did}/columns/{workbookTableColumn%2Did}/filter/applyDynamicFilter", pathParameters) {
        }
        /// <summary>
        /// Invoke action applyDynamicFilter
        /// </summary>
