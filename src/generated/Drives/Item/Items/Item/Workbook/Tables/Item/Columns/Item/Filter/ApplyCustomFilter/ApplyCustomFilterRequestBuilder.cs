...
namespace ApiSdk.Drives.Item.Items.Item.Workbook.Tables.Item.Columns.Item.Filter.ApplyCustomFilter {
    /// <summary>
    ...
    public class ApplyCustomFilterRequestBuilder : BaseCliRequestBuilder {
        ...
        public ApplyCustomFilterRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/tables/{workbookTable%2Did}/columns/{workbookTableColumn%2Did}/filter/applyCustomFilter", pathParameters) {
        }
        /// <summary>
        /// Invoke action applyCustomFilter
        /// </summary>
