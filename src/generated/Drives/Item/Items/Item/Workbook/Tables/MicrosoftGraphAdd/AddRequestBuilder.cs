...
namespace ApiSdk.Drives.Item.Items.Item.Workbook.Tables.MicrosoftGraphAdd {
    /// <summary>
    ...
    public class AddRequestBuilder {
        ...
        public AddRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/tables/microsoft.graph.add";
