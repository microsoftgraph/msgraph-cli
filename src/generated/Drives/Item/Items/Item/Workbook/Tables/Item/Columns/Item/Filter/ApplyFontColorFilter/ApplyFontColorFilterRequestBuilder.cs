...
namespace ApiSdk.Drives.Item.Items.Item.Workbook.Tables.Item.Columns.Item.Filter.ApplyFontColorFilter {
    ...
    public class ApplyFontColorFilterRequestBuilder : BaseCliRequestBuilder {
        ...
        public ApplyFontColorFilterRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/tables/{workbookTable%2Did}/columns/{workbookTableColumn%2Did}/filter/applyFontColorFilter", pathParameters) {
        }
        /// <summary>
        /// Invoke action applyFontColorFilter
        /// </summary>
