...
using System;
namespace ApiSdk.Drives.Item.Items.Item.Workbook.Tables.Item.Worksheet {
    /// <summary>
    ...
    public class WorksheetRequestBuilder : BaseCliRequestBuilder {
        ...
        public WorksheetRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/tables/{workbookTable%2Did}/worksheet{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// The worksheet containing the current table. Read-only.
        /// </summary>
