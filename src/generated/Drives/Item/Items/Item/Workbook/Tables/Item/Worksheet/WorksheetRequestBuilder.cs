...
namespace ApiSdk.Drives.Item.Items.Item.Workbook.Tables.Item.Worksheet {
    ...
    public class WorksheetRequestBuilder : BaseCliRequestBuilder {
        ...
        public WorksheetRequestBuilder(string rawUrl) : base("{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/tables/{workbookTable%2Did}/worksheet{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// The worksheet containing the current table. Read-only.
        /// </summary>
