...
namespace ApiSdk.Drives.Item.Items.Item.Workbook.Tables.Item.Sort {
    ...
    public class SortRequestBuilder : BaseCliRequestBuilder {
        ...
        public SortRequestBuilder(string rawUrl) : base("{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/tables/{workbookTable%2Did}/sort{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Delete navigation property sort for drives
        /// </summary>
