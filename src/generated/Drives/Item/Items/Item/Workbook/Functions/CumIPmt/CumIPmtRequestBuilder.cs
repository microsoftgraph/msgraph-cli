...
namespace ApiSdk.Drives.Item.Items.Item.Workbook.Functions.CumIPmt {
    ...
    public class CumIPmtRequestBuilder : BaseCliRequestBuilder {
        ...
        public CumIPmtRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/cumIPmt", pathParameters) {
        }
        /// <summary>
        /// Invoke action cumIPmt
        /// </summary>
