...
namespace ApiSdk.Drives.Item.Items.Item.Workbook.Functions.MicrosoftGraphCombin {
    /// <summary>
    ...
    public class CombinRequestBuilder {
        ...
        public CombinRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/microsoft.graph.combin";
