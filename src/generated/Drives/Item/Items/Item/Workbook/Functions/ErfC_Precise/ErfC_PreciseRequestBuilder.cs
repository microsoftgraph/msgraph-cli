...
namespace ApiSdk.Drives.Item.Items.Item.Workbook.Functions.ErfC_Precise {
    ...
    public class ErfC_PreciseRequestBuilder {
        ...
        public ErfC_PreciseRequestBuilder(Dictionary<string, object> pathParameters) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            UrlTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/erfC_Precise";
