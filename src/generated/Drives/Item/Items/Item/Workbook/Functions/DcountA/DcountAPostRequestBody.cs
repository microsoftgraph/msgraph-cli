...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Drives.Item.Items.Item.Workbook.Functions.DcountA.DcountAPostRequestBody"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Drives.Item.Items.Item.Workbook.Functions.DcountA.DcountAPostRequestBody"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static ApiSdk.Drives.Item.Items.Item.Workbook.Functions.DcountA.DcountAPostRequestBody CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Drives.Item.Items.Item.Workbook.Functions.DcountA.DcountAPostRequestBody();
        }
        /// <summary>
