...
namespace ApiSdk.Drives.Item.Items.Item.Workbook.Functions.Binom_Dist_Range {
    ...
    public class Binom_Dist_RangeRequestBuilder {
        ...
        public Binom_Dist_RangeRequestBuilder(Dictionary<string, object> pathParameters) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            UrlTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/binom_Dist_Range";
