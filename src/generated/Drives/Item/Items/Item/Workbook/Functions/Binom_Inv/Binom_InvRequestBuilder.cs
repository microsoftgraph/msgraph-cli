...
namespace ApiSdk.Drives.Item.Items.Item.Workbook.Functions.Binom_Inv {
    ...
    public class Binom_InvRequestBuilder : BaseCliRequestBuilder {
        ...
        public Binom_InvRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/binom_Inv", pathParameters) {
        }
        /// <summary>
        /// Invoke action binom_Inv
        /// </summary>
