...
namespace ApiSdk.Drives.Item.Items.Item.Workbook.Functions.Columns {
    ...
    public class ColumnsRequestBuilder : BaseCliRequestBuilder {
        ...
        public ColumnsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/columns", pathParameters) {
        }
        /// <summary>
        /// Invoke action columns
        /// </summary>
