...
namespace ApiSdk.Drives.Item.Items.Item.Workbook.Functions.Fisher {
    ...
    public class FisherRequestBuilder {
        ...
        public FisherRequestBuilder(Dictionary<string, object> pathParameters) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            UrlTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/fisher";
