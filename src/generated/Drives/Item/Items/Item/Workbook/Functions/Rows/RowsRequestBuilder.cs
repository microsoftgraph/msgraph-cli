...
namespace ApiSdk.Drives.Item.Items.Item.Workbook.Functions.Rows {
    ...
    public class RowsRequestBuilder : BaseCliRequestBuilder {
        ...
        public RowsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/rows", pathParameters) {
        }
        /// <summary>
        /// Invoke action rows
        /// </summary>
