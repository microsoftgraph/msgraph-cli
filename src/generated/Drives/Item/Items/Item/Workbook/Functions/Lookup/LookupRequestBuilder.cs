...
namespace ApiSdk.Drives.Item.Items.Item.Workbook.Functions.Lookup {
    ...
    public class LookupRequestBuilder : BaseCliRequestBuilder {
        ...
        public LookupRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/lookup", pathParameters) {
        }
        /// <summary>
        /// Invoke action lookup
        /// </summary>
