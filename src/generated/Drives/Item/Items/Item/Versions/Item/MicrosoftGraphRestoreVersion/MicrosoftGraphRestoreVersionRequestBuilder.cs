...
namespace ApiSdk.Drives.Item.Items.Item.Versions.Item.MicrosoftGraphRestoreVersion {
    /// <summary>
    ...
    public class MicrosoftGraphRestoreVersionRequestBuilder {
        ...
        public MicrosoftGraphRestoreVersionRequestBuilder(Dictionary<string, object> pathParameters) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            UrlTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/versions/{driveItemVersion%2Did}/microsoft.graph.restoreVersion";
