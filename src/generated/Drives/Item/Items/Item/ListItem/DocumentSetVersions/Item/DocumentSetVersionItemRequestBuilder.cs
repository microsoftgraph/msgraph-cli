using ApiSdk.Drives.Item.Items.Item.ListItem.DocumentSetVersions.Item.Restore;
using ApiSdk.Models;
...
namespace ApiSdk.Drives.Item.Items.Item.ListItem.DocumentSetVersions.Item {
    /// <summary>
    ...
    public class DocumentSetVersionItemRequestBuilder {
        ...
        public Command BuildPatchCommand() {
            ...
            command.Description = "Update the navigation property documentSetVersions in drives";
            // Create options for all the parameters
            var driveIdOption = new Option<string>("--drive-id", description: "key: id of drive") {
            };
            driveIdOption.IsRequired = true;
