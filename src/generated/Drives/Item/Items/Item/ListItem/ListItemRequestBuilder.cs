using ApiSdk.Drives.Item.Items.Item.ListItem.Analytics;
using ApiSdk.Drives.Item.Items.Item.ListItem.DriveItem;
using ApiSdk.Drives.Item.Items.Item.ListItem.Fields;
using ApiSdk.Drives.Item.Items.Item.ListItem.GetActivitiesByInterval;
using ApiSdk.Drives.Item.Items.Item.ListItem.GetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithInterval;
using ApiSdk.Drives.Item.Items.Item.ListItem.Versions;
using ApiSdk.Models;
...
namespace ApiSdk.Drives.Item.Items.Item.ListItem {
    ...
    public class ListItemRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.Description = "Delete navigation property listItem for drives";
        ...
        public Command BuildDriveItemCommand() {
            ...
            var builder = new ApiSdk.Drives.Item.Items.Item.ListItem.DriveItem.DriveItemRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(driveIdOption, driveItemIdOption, selectOption, expandOption, outputOption, queryOption, jsonNoIndentOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        ...
        public Command BuildPatchCommand() {
            ...
            command.Description = "Update the navigation property listItem in drives";
            // Create options for all the parameters
            var driveIdOption = new Option<string>("--drive-id", description: "key: id of drive") {
            };
            driveIdOption.IsRequired = true;
        ...
        public ListItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/listItem{?%24select,%24expand}";
