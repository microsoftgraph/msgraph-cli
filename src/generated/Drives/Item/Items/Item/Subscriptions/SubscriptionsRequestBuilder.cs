using ApiSdk.Drives.Item.Items.Item.Subscriptions.Count;
using ApiSdk.Drives.Item.Items.Item.Subscriptions.Item;
...
using System;
namespace ApiSdk.Drives.Item.Items.Item.Subscriptions {
    /// <summary>
    ...
    public class SubscriptionsRequestBuilder : BaseCliRequestBuilder {
        ...
        public SubscriptionsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/subscriptions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// The set of subscriptions on the item. Only supported on the root of a drive.
        /// </summary>
