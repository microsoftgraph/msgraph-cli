using ApiSdk.Drives.Item.Items.Item.Subscriptions.Item.MicrosoftGraphReauthorize;
using ApiSdk.Models;
...
namespace ApiSdk.Drives.Item.Items.Item.Subscriptions.Item {
    ...
    public class SubscriptionItemRequestBuilder {
        ...
        public SubscriptionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/subscriptions/{subscription%2Did}{?%24select,%24expand}";
