...
namespace ApiSdk.Drives.Item.Items.Item.LastModifiedByUser {
    ...
    public class LastModifiedByUserRequestBuilder : BaseCliRequestBuilder {
        ...
        public LastModifiedByUserRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/lastModifiedByUser{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Identity of the user who last modified the item. Read-only.
        /// </summary>
