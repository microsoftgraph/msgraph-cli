...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Drives.Item.Items.Item.GetActivitiesByInterval.GetActivitiesByIntervalGetResponse"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static new ApiSdk.Drives.Item.Items.Item.GetActivitiesByInterval.GetActivitiesByIntervalGetResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Drives.Item.Items.Item.GetActivitiesByInterval.GetActivitiesByIntervalGetResponse();
        }
        /// <summary>
