using ApiSdk.Drives.Item.Items.Item.Analytics.ItemActivityStats.Item.Activities.Count;
using ApiSdk.Drives.Item.Items.Item.Analytics.ItemActivityStats.Item.Activities.Item;
using ApiSdk.Models;
...
namespace ApiSdk.Drives.Item.Items.Item.Analytics.ItemActivityStats.Item.Activities {
    /// <summary>
    ...
    public class ActivitiesRequestBuilder : BaseCliRequestBuilder {
        ...
        public ActivitiesRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/analytics/itemActivityStats/{itemActivityStat%2Did}/activities{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Exposes the itemActivities represented in this itemActivityStat resource.
        /// </summary>
...
#nullable restore
        ...
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ActivitiesRequestBuilderGetQueryParameters>> requestConfiguration = default) {
            ...
            if (requestConfiguration != null) {
                var requestConfig = new RequestConfiguration<ActivitiesRequestBuilderGetQueryParameters>();
