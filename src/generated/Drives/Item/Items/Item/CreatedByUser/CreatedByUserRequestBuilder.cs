...
namespace ApiSdk.Drives.Item.Items.Item.CreatedByUser {
    ...
    public class CreatedByUserRequestBuilder : BaseCliRequestBuilder {
        ...
        public CreatedByUserRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/createdByUser{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Identity of the user who created the item. Read-only.
        /// </summary>
