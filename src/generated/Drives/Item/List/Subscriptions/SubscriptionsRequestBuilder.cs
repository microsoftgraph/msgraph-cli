...
namespace ApiSdk.Drives.Item.List.Subscriptions {
    ...
    public class SubscriptionsRequestBuilder : BaseCliRequestBuilder {
        ...
        public SubscriptionsRequestBuilder(string rawUrl) : base("{+baseurl}/drives/{drive%2Did}/list/subscriptions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// The set of subscriptions on the list.
        /// </summary>
