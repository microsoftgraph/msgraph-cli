...
namespace ApiSdk.Drives.Item.List.Subscriptions.Item {
    ...
    public class SubscriptionRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string>(async (driveId, subscriptionId) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string[], string[]>(async (driveId, subscriptionId, select, expand) => {
        ...
        public Command BuildPatchCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, string>(async (driveId, subscriptionId, body) => {
