...
namespace ApiSdk.Drives.Item.List.Subscriptions.Item {
    ...
    public class SubscriptionRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string driveId, string subscriptionId, string[] select, string[] expand) => {
            ...
            }, driveIdOption, subscriptionIdOption, selectOption, expandOption);
            return command;
        }
        /// <summary>
        /// The set of subscriptions on the list.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string driveId, string subscriptionId, string body) => {
