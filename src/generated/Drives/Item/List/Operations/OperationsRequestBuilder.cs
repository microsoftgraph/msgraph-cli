using ApiSdk.Drives.Item.List.Operations.Count;
using ApiSdk.Drives.Item.List.Operations.Item;
...
using System;
namespace ApiSdk.Drives.Item.List.Operations {
    /// <summary>
    ...
    public class OperationsRequestBuilder : BaseCliRequestBuilder {
        ...
        public OperationsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/drives/{drive%2Did}/list/operations{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// The collection of long-running operations on the list.
        /// </summary>
