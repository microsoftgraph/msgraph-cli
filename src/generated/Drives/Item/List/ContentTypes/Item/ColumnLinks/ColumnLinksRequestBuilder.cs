...
namespace ApiSdk.Drives.Item.List.ContentTypes.Item.ColumnLinks {
    ...
    public class ColumnLinksRequestBuilder {
        ...
        public Command BuildListCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, int?, int?, string, string, bool?, object, object, object>(async (driveId, contentTypeId, top, skip, search, filter, count, orderby, select, expand) => {
