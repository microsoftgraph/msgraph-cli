...
namespace ApiSdk.Drives.Item.List.ContentTypes.Item.ColumnLinks.Item {
    ...
    public class ColumnLinkRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string driveId, string contentTypeId, string columnLinkId) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string driveId, string contentTypeId, string columnLinkId, string[] select, string[] expand) => {
            ...
            }, driveIdOption, contentTypeIdOption, columnLinkIdOption, selectOption, expandOption);
            return command;
        }
        /// <summary>
        /// The collection of columns that are required by this content type
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string driveId, string contentTypeId, string columnLinkId, string body) => {
