...
namespace ApiSdk.Drives.Item.List.ContentTypes.Item.Columns.Item {
    ...
    public class ColumnDefinitionRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string driveId, string contentTypeId, string columnDefinitionId, string[] select, string[] expand, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
            ...
            }, driveIdOption, contentTypeIdOption, columnDefinitionIdOption, selectOption, expandOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// The collection of column definitions for this contentType.
        ...
        public Command BuildSourceColumnCommand() {
            ...
            var builder = new ApiSdk.Drives.Item.List.ContentTypes.Item.Columns.Item.SourceColumn.SourceColumnRequestBuilder(PathParameters, RequestAdapter);
