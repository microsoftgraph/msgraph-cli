...
namespace ApiSdk.Drives.Item.List.ContentTypes.Item.BaseTypes.Item {
    ...
    public class ContentTypeItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public ContentTypeItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/drives/{drive%2Did}/list/contentTypes/{contentType%2Did}/baseTypes/{contentType%2Did1}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// The collection of content types that are ancestors of this content type.
        /// </summary>
