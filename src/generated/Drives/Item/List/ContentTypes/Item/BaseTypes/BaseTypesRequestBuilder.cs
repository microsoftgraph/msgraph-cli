...
namespace ApiSdk.Drives.Item.List.ContentTypes.Item.BaseTypes {
    ...
    public class BaseTypesRequestBuilder {
        ...
        public Command BuildAddCopyCommand() {
            ...
            var builder = new ApiSdk.Drives.Item.List.ContentTypes.Item.BaseTypes.AddCopy.AddCopyRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildRefCommand() {
            ...
            var builder = new ApiSdk.Drives.Item.List.ContentTypes.Item.BaseTypes.@Ref.RefRequestBuilder(PathParameters, RequestAdapter);
