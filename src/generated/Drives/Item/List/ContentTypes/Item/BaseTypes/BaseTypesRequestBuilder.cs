using ApiSdk.Drives.Item.List.ContentTypes.Item.BaseTypes.Count;
using ApiSdk.Drives.Item.List.ContentTypes.Item.BaseTypes.Item;
...
namespace ApiSdk.Drives.Item.List.ContentTypes.Item.BaseTypes {
    ...
    public class BaseTypesRequestBuilder : BaseCliRequestBuilder {
        ...
        public BaseTypesRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/drives/{drive%2Did}/list/contentTypes/{contentType%2Did}/baseTypes{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// The collection of content types that are ancestors of this content type.
        /// </summary>
