    ...
    public class AddCopyRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Drives.Item.List.ContentTypes.AddCopy.AddCopyRequestBody>(ApiSdk.Drives.Item.List.ContentTypes.AddCopy.AddCopyRequestBody.CreateFromDiscriminatorValue);
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ApiSdk.Drives.Item.List.ContentTypes.AddCopy.AddCopyRequestBody body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
