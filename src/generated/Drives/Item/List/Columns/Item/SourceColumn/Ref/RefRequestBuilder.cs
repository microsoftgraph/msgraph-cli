...
namespace ApiSdk.Drives.Item.List.Columns.Item.SourceColumn.Ref {
    ...
    public class RefRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string driveId, string columnDefinitionId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, driveIdOption, columnDefinitionIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The source column for content type column.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string driveId, string columnDefinitionId, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, driveIdOption, columnDefinitionIdOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The source column for content type column.
        ...
        public Command BuildPutCommand() {
            ...
            command.SetHandler(async (string driveId, string columnDefinitionId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, driveIdOption, columnDefinitionIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        ...
        /// <param name="o">Request options</param>
        /// </summary>
        public RequestInformation CreatePutRequestInformation(ApiSdk.Drives.Item.List.Columns.Item.SourceColumn.Ref.Ref body, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default) {
