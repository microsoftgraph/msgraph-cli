...
namespace ApiSdk.Drives.Item.List.Columns {
    ...
    public class ColumnsRequestBuilder {
        ...
        public Command BuildListCommand() {
            ...
            command.Handler = CommandHandler.Create<string, int?, int?, string, string, bool?, string[], string[], string[]>(async (driveId, top, skip, search, filter, count, orderby, select, expand) => {
