...
namespace ApiSdk.Drives.Item.List.Columns {
    ...
    public class ColumnsRequestBuilder {
        ...
        public Command BuildCreateCommand() {
            ...
            }, driveIdOption, bodyOption, outputOption);
            return command;
        }
        /// <summary>
        /// The collection of field definitions for this list.
        ...
        public Command BuildListCommand() {
            ...
            command.SetHandler(async (string driveId, int? top, int? skip, string search, string filter, bool? count, string[] orderby, string[] select, string[] expand, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                ...
                var formatter = outputFormatterFactory.GetFormatter(output);
                formatter.WriteOutput(response, console);
            }, driveIdOption, topOption, skipOption, searchOption, filterOption, countOption, orderbyOption, selectOption, expandOption, outputOption);
            return command;
        }
        /// <summary>
