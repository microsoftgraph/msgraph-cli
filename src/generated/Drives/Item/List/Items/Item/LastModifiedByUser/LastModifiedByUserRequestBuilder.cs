...
namespace ApiSdk.Drives.Item.List.Items.Item.LastModifiedByUser {
    ...
    public class LastModifiedByUserRequestBuilder : BaseCliRequestBuilder {
        ...
        public LastModifiedByUserRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/drives/{drive%2Did}/list/items/{listItem%2Did}/lastModifiedByUser{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Identity of the user who last modified the item. Read-only.
        /// </summary>
