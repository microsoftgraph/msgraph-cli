...
namespace ApiSdk.Drives.Item.List.Items.Item.DocumentSetVersions.Item
{
    ...
    public class DocumentSetVersionItemRequestBuilder : BaseCliRequestBuilder
    {
        ...
        public Command BuildFieldsNavCommand()
        {
            ...
            var builder = new ApiSdk.Drives.Item.List.Items.Item.DocumentSetVersions.Item.Fields.FieldsRequestBuilder(PathParameters);
        ...
        public Command BuildRestoreNavCommand()
        {
            ...
            var builder = new ApiSdk.Drives.Item.List.Items.Item.DocumentSetVersions.Item.Restore.RestoreRequestBuilder(PathParameters);
            var execCommands = new List<Command>();
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Drives.Item.List.Items.Item.DocumentSetVersions.Item.DocumentSetVersionItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Drives.Item.List.Items.Item.DocumentSetVersions.Item.DocumentSetVersionItemRequestBuilder.DocumentSetVersionItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ApiSdk.Drives.Item.List.Items.Item.DocumentSetVersions.Item.DocumentSetVersionItemRequestBuilder.DocumentSetVersionItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
