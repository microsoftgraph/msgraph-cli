...
namespace ApiSdk.Drives.Item.List.Items.Item {
    ...
    public class ListItemRequestBuilder {
        ...
        public Command BuildAnalyticsCommand() {
            ...
            var builder = new ApiSdk.Drives.Item.List.Items.Item.Analytics.AnalyticsRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildDriveItemCommand() {
            ...
            var builder = new ApiSdk.Drives.Item.List.Items.Item.DriveItem.DriveItemRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildFieldsCommand() {
            ...
            var builder = new ApiSdk.Drives.Item.List.Items.Item.Fields.FieldsRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildDeleteCommand());
            command.AddCommand(builder.BuildGetCommand());
            command.AddCommand(builder.BuildPatchCommand());
            return command;
        ...
        public Command BuildVersionsCommand() {
            ...
            var builder = new ApiSdk.Drives.Item.List.Items.Item.Versions.VersionsRequestBuilder(PathParameters, RequestAdapter);
