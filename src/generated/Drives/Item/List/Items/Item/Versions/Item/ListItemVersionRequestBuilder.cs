...
namespace ApiSdk.Drives.Item.List.Items.Item.Versions.Item {
    ...
    public class ListItemVersionRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string driveId, string listItemId, string listItemVersionId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, driveIdOption, listItemIdOption, listItemVersionIdOption, new ServiceProviderBinder());
            return command;
        }
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string driveId, string listItemId, string listItemVersionId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, driveIdOption, listItemIdOption, listItemVersionIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The list of previous versions of the list item.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string driveId, string listItemId, string listItemVersionId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, driveIdOption, listItemIdOption, listItemVersionIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
