...
namespace ApiSdk.Drives.Item.List.Items.Item.Versions.Item {
    ...
    public class ListItemVersionRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string driveId, string listItemId, string listItemVersionId, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                var requestInfo = CreateDeleteRequestInformation(q => {
                });
                await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                console.WriteLine("Success");
            }, driveIdOption, listItemIdOption, listItemVersionIdOption, new OutputFormatterFactoryBinder());
            return command;
        }
        public Command BuildFieldsCommand() {
            var command = new Command("fields");
            var builder = new ApiSdk.Drives.Item.List.Items.Item.Versions.Item.Fields.FieldsRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string driveId, string listItemId, string listItemVersionId, string[] select, string[] expand, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
            ...
            }, driveIdOption, listItemIdOption, listItemVersionIdOption, selectOption, expandOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// The list of previous versions of the list item.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string driveId, string listItemId, string listItemVersionId, string body, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                ...
                await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                console.WriteLine("Success");
            }, driveIdOption, listItemIdOption, listItemVersionIdOption, bodyOption, new OutputFormatterFactoryBinder());
            return command;
        }
        public Command BuildRestoreVersionCommand() {
            var command = new Command("restore-version");
            var builder = new ApiSdk.Drives.Item.List.Items.Item.Versions.Item.RestoreVersion.RestoreVersionRequestBuilder(PathParameters, RequestAdapter);
