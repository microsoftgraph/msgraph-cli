using ApiSdk.Drives.Item.Root.ListItem.Analytics;
using ApiSdk.Drives.Item.Root.ListItem.DocumentSetVersions;
using ApiSdk.Drives.Item.Root.ListItem.DriveItem;
using ApiSdk.Drives.Item.Root.ListItem.Fields;
using ApiSdk.Drives.Item.Root.ListItem.GetActivitiesByInterval;
using ApiSdk.Drives.Item.Root.ListItem.GetActivitiesByIntervalWithStartDateTimeWithEndDateTimeWithInterval;
using ApiSdk.Drives.Item.Root.ListItem.Versions;
using ApiSdk.Models;
...
namespace ApiSdk.Drives.Item.Root.ListItem {
    ...
    public class ListItemRequestBuilder {
        ...
        public Command BuildDriveItemCommand() {
            ...
            var builder = new ApiSdk.Drives.Item.Root.ListItem.DriveItem.DriveItemRequestBuilder(PathParameters, RequestAdapter);
        ...
        public ListItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drives/{drive%2Did}/root/listItem{?%24select,%24expand}";
