using ApiSdk.Drives.Item.Root.ListItem.DriveItem.Content;
using ApiSdk.Models;
...
namespace ApiSdk.Drives.Item.Root.ListItem.DriveItem {
    ...
    public class DriveItemRequestBuilder {
        ...
        public DriveItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drives/{drive%2Did}/root/listItem/driveItem{?%24select,%24expand}";
