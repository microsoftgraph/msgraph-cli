...
namespace ApiSdk.Drives.Item.Root.Subscriptions.Item.Reauthorize {
    /// <summary>
    ...
    public class ReauthorizeRequestBuilder {
        ...
        public ReauthorizeRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drives/{drive%2Did}/root/subscriptions/{subscription%2Did}/microsoft.graph.reauthorize";
