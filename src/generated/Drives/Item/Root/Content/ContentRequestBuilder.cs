...
namespace ApiSdk.Drives.Item.Root.Content {
    ...
    public class ContentRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string driveId, FileInfo file, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, driveIdOption, fileOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        ...
        public Command BuildPutCommand() {
            ...
            command.SetHandler(async (string driveId, FileInfo file, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
