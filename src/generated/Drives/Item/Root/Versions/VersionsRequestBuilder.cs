using ApiSdk.Drives.Item.Root.Versions.Count;
using ApiSdk.Drives.Item.Root.Versions.Item;
using ApiSdk.Models;
...
namespace ApiSdk.Drives.Item.Root.Versions {
    ...
    public class VersionsRequestBuilder {
        ...
        public VersionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drives/{drive%2Did}/root/versions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
