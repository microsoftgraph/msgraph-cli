using ApiSdk.Drives.Item.Root.Versions.Item.Content;
using ApiSdk.Drives.Item.Root.Versions.Item.RestoreVersion;
using ApiSdk.Models;
...
namespace ApiSdk.Drives.Item.Root.Versions.Item {
    ...
    public class DriveItemVersionItemRequestBuilder {
        ...
        public DriveItemVersionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/drives/{drive%2Did}/root/versions/{driveItemVersion%2Did}{?%24select,%24expand}";
