...
namespace ApiSdk.Drives.Item.SearchWithQ {
    ...
    public class SearchWithQRequestBuilder : BaseCliRequestBuilder {
        ...
        public SearchWithQRequestBuilder(Dictionary<string, object> pathParameters, string q = "") : base("{+baseurl}/drives/{drive%2Did}/search(q='{q}'){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}", pathParameters) {
...
#nullable restore
        ...
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<SearchWithQRequestBuilderGetQueryParameters>> requestConfiguration = default) {
            ...
            if (requestConfiguration != null) {
                var requestConfig = new RequestConfiguration<SearchWithQRequestBuilderGetQueryParameters>();
