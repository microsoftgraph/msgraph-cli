...
namespace ApiSdk.Drives.Item.SearchWithQ {
    ...
    public class SearchWithQRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string driveId, string q, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, driveIdOption, qOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
