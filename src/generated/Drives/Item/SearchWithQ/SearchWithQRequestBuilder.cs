...
namespace ApiSdk.Drives.Item.SearchWithQ {
    ...
    public class SearchWithQRequestBuilder : BaseCliRequestBuilder {
        ...
        public SearchWithQRequestBuilder(string rawUrl) : base("{+baseurl}/drives/{drive%2Did}/search(q='{q}'){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}", rawUrl) {
        }
        /// <summary>
        /// Invoke function search
        /// </summary>
