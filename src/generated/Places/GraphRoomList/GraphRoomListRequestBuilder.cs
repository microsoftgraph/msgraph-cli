...
using ApiSdk.Models;
using ApiSdk.Places.GraphRoomList.Count;
...
using System;
namespace ApiSdk.Places.GraphRoomList {
    /// <summary>
    ...
    public class GraphRoomListRequestBuilder : BaseCliRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.Description = "Get the items of type microsoft.graph.roomList in the microsoft.graph.place collection";
        ...
        public GraphRoomListRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/places/graph.roomList{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Get the items of type microsoft.graph.roomList in the microsoft.graph.place collection
        /// </summary>
...
#nullable restore
        ...
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<GraphRoomListRequestBuilderGetQueryParameters>> requestConfiguration = default) {
            ...
            if (requestConfiguration != null) {
                var requestConfig = new RequestConfiguration<GraphRoomListRequestBuilderGetQueryParameters>();
