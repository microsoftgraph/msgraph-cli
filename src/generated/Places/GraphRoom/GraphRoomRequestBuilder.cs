...
namespace ApiSdk.Places.GraphRoom {
    ...
    public class GraphRoomRequestBuilder : BaseCliRequestBuilder {
        ...
        public GraphRoomRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/places/graph.room{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Get the items of type microsoft.graph.room in the microsoft.graph.place collection
        /// </summary>
...
#nullable restore
        ...
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<GraphRoomRequestBuilderGetQueryParameters>> requestConfiguration = default) {
            ...
            if (requestConfiguration != null) {
                var requestConfig = new RequestConfiguration<GraphRoomRequestBuilderGetQueryParameters>();
