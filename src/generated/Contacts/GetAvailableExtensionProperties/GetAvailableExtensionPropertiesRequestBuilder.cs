    ...
    public class GetAvailableExtensionPropertiesRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Contacts.GetAvailableExtensionProperties.GetAvailableExtensionPropertiesRequestBody>(ApiSdk.Contacts.GetAvailableExtensionProperties.GetAvailableExtensionPropertiesRequestBody.CreateFromDiscriminatorValue);
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ApiSdk.Contacts.GetAvailableExtensionProperties.GetAvailableExtensionPropertiesRequestBody body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
