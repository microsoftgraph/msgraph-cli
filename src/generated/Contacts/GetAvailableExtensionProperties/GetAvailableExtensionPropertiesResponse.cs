...
namespace ApiSdk.Contacts.GetAvailableExtensionProperties {
    ...
    public class GetAvailableExtensionPropertiesResponse : IAdditionalDataHolder, IParsable {
        ...
        /// </summary>
        public static ApiSdk.Contacts.GetAvailableExtensionProperties.GetAvailableExtensionPropertiesResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
