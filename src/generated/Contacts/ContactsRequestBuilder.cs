...
namespace ApiSdk.Contacts {
    ...
    public class ContactsRequestBuilder {
        ...
        public Command BuildGetAvailableExtensionPropertiesCommand() {
            ...
            var builder = new ApiSdk.Contacts.GetAvailableExtensionProperties.GetAvailableExtensionPropertiesRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildPostCommand());
            return command;
        }
        public Command BuildGetByIdsCommand() {
            var command = new Command("get-by-ids");
            var builder = new ApiSdk.Contacts.GetByIds.GetByIdsRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildPostCommand());
            return command;
        }
        /// <summary>
        ...
        public Command BuildValidatePropertiesCommand() {
            ...
            var builder = new ApiSdk.Contacts.ValidateProperties.ValidatePropertiesRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildPostCommand());
            return command;
        }
        /// <summary>
