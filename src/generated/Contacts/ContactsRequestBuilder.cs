...
namespace ApiSdk.Contacts {
    ...
    public class ContactsRequestBuilder : BaseCliRequestBuilder {
        ...
        public ContactsRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/contacts{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Get the list of organizational contacts for this organization.
        /// </summary>
