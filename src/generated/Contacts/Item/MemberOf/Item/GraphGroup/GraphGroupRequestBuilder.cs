...
namespace ApiSdk.Contacts.Item.MemberOf.Item.GraphGroup {
    /// <summary>
    ...
    public class GraphGroupRequestBuilder {
        ...
        public GraphGroupRequestBuilder(Dictionary<string, object> pathParameters) {
            ...
            UrlTemplate = "{+baseurl}/contacts/{orgContact%2Did}/memberOf/{directoryObject%2Did}/graph.group{?%24select,%24expand}";
