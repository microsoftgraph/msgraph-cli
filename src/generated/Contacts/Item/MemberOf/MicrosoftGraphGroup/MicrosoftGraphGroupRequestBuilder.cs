using ApiSdk.Contacts.Item.MemberOf.MicrosoftGraphGroup.Count;
using ApiSdk.Models;
...
namespace ApiSdk.Contacts.Item.MemberOf.MicrosoftGraphGroup {
    /// <summary>
    ...
    public class MicrosoftGraphGroupRequestBuilder {
        ...
        public MicrosoftGraphGroupRequestBuilder(Dictionary<string, object> pathParameters) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            UrlTemplate = "{+baseurl}/contacts/{orgContact%2Did}/memberOf/microsoft.graph.group{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
