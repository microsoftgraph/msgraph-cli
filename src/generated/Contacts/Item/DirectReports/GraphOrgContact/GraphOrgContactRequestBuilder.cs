using ApiSdk.Contacts.Item.DirectReports.GraphOrgContact.Count;
...
using System;
namespace ApiSdk.Contacts.Item.DirectReports.GraphOrgContact {
    /// <summary>
    ...
    public class GraphOrgContactRequestBuilder : BaseCliRequestBuilder {
        ...
        public GraphOrgContactRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/contacts/{orgContact%2Did}/directReports/graph.orgContact{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Get the items of type microsoft.graph.orgContact in the microsoft.graph.directoryObject collection
        /// </summary>
