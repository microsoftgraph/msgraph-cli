...
namespace ApiSdk.Contacts.Item.DirectReports.Item.MicrosoftGraphUser {
    /// <summary>
    ...
    public class UserRequestBuilder {
        ...
        public UserRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/contacts/{orgContact%2Did}/directReports/{directoryObject%2Did}/microsoft.graph.user{?%24select,%24expand}";
