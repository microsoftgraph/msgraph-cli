...
namespace ApiSdk.Contacts.Item.DirectReports.Item.GraphUser {
    ...
    public class GraphUserRequestBuilder : BaseCliRequestBuilder {
        ...
        public GraphUserRequestBuilder(string rawUrl) : base("{+baseurl}/contacts/{orgContact%2Did}/directReports/{directoryObject%2Did}/graph.user{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Get the item of type microsoft.graph.directoryObject as microsoft.graph.user
        /// </summary>
