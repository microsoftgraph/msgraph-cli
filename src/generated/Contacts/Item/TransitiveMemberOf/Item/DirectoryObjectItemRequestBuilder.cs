using ApiSdk.Contacts.Item.TransitiveMemberOf.Item.MicrosoftGraphApplication;
using ApiSdk.Contacts.Item.TransitiveMemberOf.Item.MicrosoftGraphDevice;
using ApiSdk.Contacts.Item.TransitiveMemberOf.Item.MicrosoftGraphGroup;
using ApiSdk.Contacts.Item.TransitiveMemberOf.Item.MicrosoftGraphOrgContact;
using ApiSdk.Contacts.Item.TransitiveMemberOf.Item.MicrosoftGraphServicePrincipal;
using ApiSdk.Contacts.Item.TransitiveMemberOf.Item.MicrosoftGraphUser;
using ApiSdk.Models;
...
namespace ApiSdk.Contacts.Item.TransitiveMemberOf.Item {
    ...
    public class DirectoryObjectItemRequestBuilder {
        ...
        public DirectoryObjectItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/contacts/{orgContact%2Did}/transitiveMemberOf/{directoryObject%2Did}{?%24select,%24expand}";
