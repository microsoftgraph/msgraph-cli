...
using ApiSdk.Contacts.Item.TransitiveMemberOf.MicrosoftGraphApplication;
using ApiSdk.Contacts.Item.TransitiveMemberOf.MicrosoftGraphDevice;
using ApiSdk.Contacts.Item.TransitiveMemberOf.MicrosoftGraphGroup;
using ApiSdk.Contacts.Item.TransitiveMemberOf.MicrosoftGraphOrgContact;
using ApiSdk.Contacts.Item.TransitiveMemberOf.MicrosoftGraphServicePrincipal;
using ApiSdk.Contacts.Item.TransitiveMemberOf.MicrosoftGraphUser;
using ApiSdk.Models;
...
namespace ApiSdk.Contacts.Item.TransitiveMemberOf {
    ...
    public class TransitiveMemberOfRequestBuilder {
        ...
        public Command BuildListCommand() {
            ...
            command.Description = "Get transitiveMemberOf from contacts\n\nFind more info here:\n  https://docs.microsoft.com/graph/api/orgcontact-list-transitivememberof?view=graph-rest-1.0";
