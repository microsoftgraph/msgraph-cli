using ApiSdk.Contacts.Item.TransitiveMemberOf.MicrosoftGraphServicePrincipal.Count;
using ApiSdk.Models;
...
namespace ApiSdk.Contacts.Item.TransitiveMemberOf.MicrosoftGraphServicePrincipal {
    /// <summary>
