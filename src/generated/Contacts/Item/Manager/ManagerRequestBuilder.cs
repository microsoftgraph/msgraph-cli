...
namespace ApiSdk.Contacts.Item.Manager {
    ...
    public class ManagerRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(orgContactIdOption, selectOption, expandOption, outputOption, queryOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        public Command BuildRefCommand() {
            var command = new Command("ref");
            var builder = new ApiSdk.Contacts.Item.Manager.Ref.RefRequestBuilder(PathParameters, RequestAdapter);
