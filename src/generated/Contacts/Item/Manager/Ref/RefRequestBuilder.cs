...
namespace ApiSdk.Contacts.Item.Manager.Ref {
    ...
    public class RefRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string orgContactId, IConsole console) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string orgContactId, FormatterType output, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
        ...
        public Command BuildPutCommand() {
            ...
            command.SetHandler(async (string orgContactId, string body, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
