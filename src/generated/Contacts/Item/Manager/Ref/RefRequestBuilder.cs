...
namespace ApiSdk.Contacts.Item.Manager.Ref {
    ...
    public class RefRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string orgContactId, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                var requestInfo = CreateGetRequestInformation(q => {
                });
                var response = await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                var formatter = outputFormatterFactory.GetFormatter(output);
                formatter.WriteOutput(response, console);
            }, orgContactIdOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// The user or contact that is this contact's manager. Read-only. Supports $expand.
        ...
        public Command BuildPutCommand() {
            ...
            command.SetHandler(async (string orgContactId, string body, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
