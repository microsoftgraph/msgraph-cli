...
namespace ApiSdk.Contacts {
    public class ContactsResponse : IAdditionalDataHolder, IParsable {
        ...
        public IDictionary<string, Action<T, IParseNode>> GetFieldDeserializers<T>() {
            return new Dictionary<string, Action<T, IParseNode>> {
                ...
                {"value", (o,n) => { (o as ContactsResponse).Value = n.GetCollectionOfObjectValues<OrgContact>(OrgContact.CreateFromDiscriminatorValue).ToList(); } },
            };
        }
        /// <summary>
