...
namespace ApiSdk.Directory.AdministrativeUnits.Item.ScopedRoleMembers.Item {
    ...
    public class ScopedRoleMembershipRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string administrativeUnitId, string scopedRoleMembershipId, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                var requestInfo = CreateDeleteRequestInformation(q => {
                });
                await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                console.WriteLine("Success");
            }, administrativeUnitIdOption, scopedRoleMembershipIdOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// Scoped-role members of this administrative unit.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string administrativeUnitId, string scopedRoleMembershipId, string[] select, string[] expand, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
            ...
            }, administrativeUnitIdOption, scopedRoleMembershipIdOption, selectOption, expandOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// Scoped-role members of this administrative unit.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string administrativeUnitId, string scopedRoleMembershipId, string body, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                ...
                await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                console.WriteLine("Success");
            }, administrativeUnitIdOption, scopedRoleMembershipIdOption, bodyOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
