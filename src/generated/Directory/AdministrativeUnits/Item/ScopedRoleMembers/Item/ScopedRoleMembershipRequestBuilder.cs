...
namespace ApiSdk.Directory.AdministrativeUnits.Item.ScopedRoleMembers.Item {
    ...
    public class ScopedRoleMembershipRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string administrativeUnitId, string scopedRoleMembershipId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, administrativeUnitIdOption, scopedRoleMembershipIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// Scoped-role members of this administrative unit.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string administrativeUnitId, string scopedRoleMembershipId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, administrativeUnitIdOption, scopedRoleMembershipIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// Scoped-role members of this administrative unit.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string administrativeUnitId, string scopedRoleMembershipId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, administrativeUnitIdOption, scopedRoleMembershipIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
