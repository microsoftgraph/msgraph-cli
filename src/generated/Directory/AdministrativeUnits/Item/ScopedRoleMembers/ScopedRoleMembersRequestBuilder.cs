using ApiSdk.Directory.AdministrativeUnits.Item.ScopedRoleMembers.Count;
...
namespace ApiSdk.Directory.AdministrativeUnits.Item.ScopedRoleMembers {
    ...
    public class ScopedRoleMembersRequestBuilder {
        ...
        public Command BuildCreateCommand() {
            ...
            }, new CollectionBinding(administrativeUnitIdOption, bodyOption, outputOption, queryOption, jsonNoIndentOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
