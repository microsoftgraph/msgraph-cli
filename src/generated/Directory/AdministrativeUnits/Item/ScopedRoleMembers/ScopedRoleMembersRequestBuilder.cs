...
namespace ApiSdk.Directory.AdministrativeUnits.Item.ScopedRoleMembers {
    ...
    public class ScopedRoleMembersRequestBuilder {
        ...
        public Command BuildListCommand() {
            ...
            command.Handler = CommandHandler.Create<string, int?, int?, string, string, bool?, string[], string[], string[]>(async (administrativeUnitId, top, skip, search, filter, count, orderby, select, expand) => {
