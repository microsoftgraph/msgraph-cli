...
namespace ApiSdk.Directory.AdministrativeUnits.Item.Members.Ref {
    ...
    public class RefRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string administrativeUnitId, int? top, int? skip, string search, string filter, bool? count, string[] orderby, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, administrativeUnitIdOption, topOption, skipOption, searchOption, filterOption, countOption, orderbyOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// Users and groups that are members of this administrative unit. Supports $expand.
