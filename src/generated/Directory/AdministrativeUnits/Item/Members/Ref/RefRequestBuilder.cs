...
namespace ApiSdk.Directory.AdministrativeUnits.Item.Members.Ref {
    ...
    public class RefRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(administrativeUnitIdOption, topOption, skipOption, searchOption, filterOption, countOption, orderbyOption, outputOption, queryOption, jsonNoIndentOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// Users and groups that are members of this administrative unit. Supports $expand.
