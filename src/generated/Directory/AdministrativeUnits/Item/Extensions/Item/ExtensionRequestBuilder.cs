...
namespace ApiSdk.Directory.AdministrativeUnits.Item.Extensions.Item {
    ...
    public class ExtensionRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string administrativeUnitId, string extensionId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, administrativeUnitIdOption, extensionIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The collection of open extensions defined for this administrative unit. Nullable.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string administrativeUnitId, string extensionId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, administrativeUnitIdOption, extensionIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The collection of open extensions defined for this administrative unit. Nullable.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string administrativeUnitId, string extensionId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, administrativeUnitIdOption, extensionIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
