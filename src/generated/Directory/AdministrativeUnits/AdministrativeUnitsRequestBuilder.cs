using ApiSdk.Directory.AdministrativeUnits.Count;
...
namespace ApiSdk.Directory.AdministrativeUnits {
    ...
    public class AdministrativeUnitsRequestBuilder {
        ...
        public Command BuildCommand() {
            ...
            var builder = new AdministrativeUnitItemRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildDeleteCommand());
            command.AddCommand(builder.BuildExtensionsCommand());
            command.AddCommand(builder.BuildGetCommand());
            command.AddCommand(builder.BuildMembersCommand());
            command.AddCommand(builder.BuildPatchCommand());
            command.AddCommand(builder.BuildScopedRoleMembersCommand());
            return command;
        }
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ApiSdk.Models.AdministrativeUnit body, Action<AdministrativeUnitsRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
