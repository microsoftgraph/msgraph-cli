...
namespace ApiSdk.Directory.AdministrativeUnits {
    ...
    public class AdministrativeUnitsRequestBuilder {
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<ApiSdk.Models.Microsoft.Graph.AdministrativeUnit> PostAsync(ApiSdk.Models.Microsoft.Graph.AdministrativeUnit model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
