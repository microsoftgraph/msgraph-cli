...
namespace ApiSdk.Directory.AdministrativeUnits {
    ...
    public class AdministrativeUnitsRequestBuilder {
        ...
        public List<Command> BuildCommand() {
            var builder = new AdministrativeUnitRequestBuilder(PathParameters, RequestAdapter);
            var commands = new List<Command> { 
                ...
                builder.BuildScopedRoleMembersCommand(),
            };
            return commands;
        }
        /// <summary>
        ...
        public Command BuildListCommand() {
            ...
            command.Handler = CommandHandler.Create<int?, int?, string, string, bool?, object, object, object>(async (top, skip, search, filter, count, orderby, select, expand) => {
                ...
                var result = await RequestAdapter.SendAsync<AdministrativeUnitsResponse>(requestInfo);
                // Print request output. What if the request has no return?
                using var serializer = RequestAdapter.SerializationWriterFactory.GetSerializationWriter("application/json");
                serializer.WriteObjectValue(null, result);
                using var content = serializer.GetSerializedContent();
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<ApiSdk.Models.Microsoft.Graph.AdministrativeUnit> PostAsync(ApiSdk.Models.Microsoft.Graph.AdministrativeUnit model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
