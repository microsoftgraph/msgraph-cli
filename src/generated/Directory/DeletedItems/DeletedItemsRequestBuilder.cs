using ApiSdk.Directory.DeletedItems.Application;
using ApiSdk.Directory.DeletedItems.Count;
using ApiSdk.Directory.DeletedItems.GetAvailableExtensionProperties;
using ApiSdk.Directory.DeletedItems.GetByIds;
using ApiSdk.Directory.DeletedItems.Group;
using ApiSdk.Directory.DeletedItems.Item;
using ApiSdk.Directory.DeletedItems.User;
using ApiSdk.Directory.DeletedItems.ValidateProperties;
using ApiSdk.Models;
