...
namespace ApiSdk.DirectoryRoles.Item {
    ...
    public class DirectoryRoleRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            }, directoryRoleIdOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string directoryRoleId, string[] select, string[] expand, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
            ...
            }, directoryRoleIdOption, selectOption, expandOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string directoryRoleId, string body, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                ...
                await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                console.WriteLine("Success");
            }, directoryRoleIdOption, bodyOption, new OutputFormatterFactoryBinder());
            return command;
        }
