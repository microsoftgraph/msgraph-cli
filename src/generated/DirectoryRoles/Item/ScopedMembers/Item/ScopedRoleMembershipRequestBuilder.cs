...
namespace ApiSdk.DirectoryRoles.Item.ScopedMembers.Item {
    ...
    public class ScopedRoleMembershipRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            }, directoryRoleIdOption, scopedRoleMembershipIdOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// Members of this directory role that are scoped to administrative units. Read-only. Nullable.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string directoryRoleId, string scopedRoleMembershipId, string[] select, string[] expand, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
            ...
            }, directoryRoleIdOption, scopedRoleMembershipIdOption, selectOption, expandOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// Members of this directory role that are scoped to administrative units. Read-only. Nullable.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string directoryRoleId, string scopedRoleMembershipId, string body, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                ...
                await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                console.WriteLine("Success");
            }, directoryRoleIdOption, scopedRoleMembershipIdOption, bodyOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
