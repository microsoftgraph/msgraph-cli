...
namespace ApiSdk.DirectoryRoles.Item.ScopedMembers.Item {
    ...
    public class ScopedRoleMembershipRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string directoryRoleId, string scopedRoleMembershipId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, directoryRoleIdOption, scopedRoleMembershipIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// Members of this directory role that are scoped to administrative units. Read-only. Nullable.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string directoryRoleId, string scopedRoleMembershipId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, directoryRoleIdOption, scopedRoleMembershipIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// Members of this directory role that are scoped to administrative units. Read-only. Nullable.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string directoryRoleId, string scopedRoleMembershipId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, directoryRoleIdOption, scopedRoleMembershipIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
