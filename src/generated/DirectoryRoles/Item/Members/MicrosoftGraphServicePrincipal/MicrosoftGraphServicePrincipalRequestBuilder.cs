using ApiSdk.DirectoryRoles.Item.Members.MicrosoftGraphServicePrincipal.Count;
using ApiSdk.Models;
...
namespace ApiSdk.DirectoryRoles.Item.Members.MicrosoftGraphServicePrincipal {
    /// <summary>
