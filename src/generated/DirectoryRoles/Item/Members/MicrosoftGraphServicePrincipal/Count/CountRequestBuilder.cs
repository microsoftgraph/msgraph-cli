...
namespace ApiSdk.DirectoryRoles.Item.Members.MicrosoftGraphServicePrincipal.Count {
    /// <summary>
    ...
    public class CountRequestBuilder {
        ...
        public CountRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/directoryRoles/{directoryRole%2Did}/members/microsoft.graph.servicePrincipal/$count{?%24search,%24filter}";
