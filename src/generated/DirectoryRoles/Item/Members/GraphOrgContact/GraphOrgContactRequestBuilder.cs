...
namespace ApiSdk.DirectoryRoles.Item.Members.GraphOrgContact {
    ...
    public class GraphOrgContactRequestBuilder : BaseCliRequestBuilder {
        ...
        public GraphOrgContactRequestBuilder(string rawUrl) : base("{+baseurl}/directoryRoles/{directoryRole%2Did}/members/graph.orgContact{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Get the items of type microsoft.graph.orgContact in the microsoft.graph.directoryObject collection
        /// </summary>
