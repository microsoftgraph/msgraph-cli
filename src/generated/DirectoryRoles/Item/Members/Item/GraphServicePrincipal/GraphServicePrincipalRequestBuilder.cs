...
namespace ApiSdk.DirectoryRoles.Item.Members.Item.GraphServicePrincipal {
    ...
    public class GraphServicePrincipalRequestBuilder : BaseCliRequestBuilder {
        ...
        public GraphServicePrincipalRequestBuilder(string rawUrl) : base("{+baseurl}/directoryRoles/{directoryRole%2Did}/members/{directoryObject%2Did}/graph.servicePrincipal{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Get the item of type microsoft.graph.directoryObject as microsoft.graph.servicePrincipal
        /// </summary>
