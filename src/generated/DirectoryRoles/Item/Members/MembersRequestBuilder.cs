...
namespace ApiSdk.DirectoryRoles.Item.Members {
    ...
    public class MembersRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(directoryRoleIdOption, topOption, skipOption, searchOption, filterOption, countOption, orderbyOption, selectOption, expandOption, outputOption, queryOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
