...
namespace ApiSdk.DirectoryRoles.Item.Restore {
    ...
    public class RestoreRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (string directoryRoleId, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, directoryRoleIdOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
