...
namespace ApiSdk.DirectoryRoles.Item.CheckMemberObjects {
    ...
    public class CheckMemberObjectsRequestBuilder {
        ...
        /// </summary>
        public async Task<IEnumerable<string>> PostAsync(CheckMemberObjectsRequestBody model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default) {
