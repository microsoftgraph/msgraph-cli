...
namespace ApiSdk.DirectoryRoles.GetAvailableExtensionProperties {
    ...
    public class GetAvailableExtensionPropertiesRequestBody : IAdditionalDataHolder, IParsable {
        ...
        /// </summary>
        public static ApiSdk.DirectoryRoles.GetAvailableExtensionProperties.GetAvailableExtensionPropertiesRequestBody CreateFromDiscriminatorValue(IParseNode parseNode) {
