...
namespace ApiSdk.Policies.ActivityBasedTimeoutPolicies.Item {
    ...
    public class ActivityBasedTimeoutPolicyItemRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            }, new CollectionBinding(activityBasedTimeoutPolicyIdOption, new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// The policy that controls the idle time out for web sessions for applications.
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(activityBasedTimeoutPolicyIdOption, selectOption, expandOption, outputOption, queryOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// The policy that controls the idle time out for web sessions for applications.
