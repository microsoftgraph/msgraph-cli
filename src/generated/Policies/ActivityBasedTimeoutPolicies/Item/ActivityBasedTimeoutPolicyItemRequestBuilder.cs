...
namespace ApiSdk.Policies.ActivityBasedTimeoutPolicies.Item {
    ...
    public class ActivityBasedTimeoutPolicyItemRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(activityBasedTimeoutPolicyIdOption, selectOption, expandOption, outputOption, outputFilterOption, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// The policy that controls the idle time out for web sessions for applications.
