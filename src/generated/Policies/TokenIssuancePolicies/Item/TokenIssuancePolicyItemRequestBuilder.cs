...
namespace ApiSdk.Policies.TokenIssuancePolicies.Item {
    ...
    public class TokenIssuancePolicyItemRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(tokenIssuancePolicyIdOption, selectOption, expandOption, outputOption, outputFilterOption, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// The policy that specifies the characteristics of SAML tokens issued by Azure AD.
