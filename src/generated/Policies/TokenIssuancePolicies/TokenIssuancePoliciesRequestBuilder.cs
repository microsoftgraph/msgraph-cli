...
namespace ApiSdk.Policies.TokenIssuancePolicies {
    ...
    public class TokenIssuancePoliciesRequestBuilder {
        ...
        public List<Command> BuildCommand() {
            var builder = new TokenIssuancePolicyRequestBuilder(PathParameters, RequestAdapter);
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<TokenIssuancePolicy> PostAsync(TokenIssuancePolicy model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
