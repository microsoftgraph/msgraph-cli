...
namespace ApiSdk.Policies.ConditionalAccessPolicies.Item {
    ...
    public class ConditionalAccessPolicyItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public ConditionalAccessPolicyItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/policies/conditionalAccessPolicies/{conditionalAccessPolicy%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Delete navigation property conditionalAccessPolicies for policies
        /// </summary>
