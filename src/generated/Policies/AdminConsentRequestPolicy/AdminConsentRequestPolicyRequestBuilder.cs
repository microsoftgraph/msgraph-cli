    ...
    public class AdminConsentRequestPolicyRequestBuilder {
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Models.Microsoft.Graph.AdminConsentRequestPolicy>(ApiSdk.Models.Microsoft.Graph.AdminConsentRequestPolicy.CreateFromDiscriminatorValue);
        ...
        /// <param name="options">Request options</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(ApiSdk.Models.Microsoft.Graph.AdminConsentRequestPolicy body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
