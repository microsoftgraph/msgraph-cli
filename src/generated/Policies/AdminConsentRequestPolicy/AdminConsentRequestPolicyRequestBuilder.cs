...
namespace ApiSdk.Policies.AdminConsentRequestPolicy {
    ...
    public class AdminConsentRequestPolicyRequestBuilder {
        ...
        /// <param name="options">Request options</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(ApiSdk.Models.AdminConsentRequestPolicy body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
