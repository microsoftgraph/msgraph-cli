...
namespace ApiSdk.Policies.IdentitySecurityDefaultsEnforcementPolicy {
    ...
    public class IdentitySecurityDefaultsEnforcementPolicyRequestBuilder {
        ...
        /// <param name="options">Request options</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(ApiSdk.Models.IdentitySecurityDefaultsEnforcementPolicy body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
