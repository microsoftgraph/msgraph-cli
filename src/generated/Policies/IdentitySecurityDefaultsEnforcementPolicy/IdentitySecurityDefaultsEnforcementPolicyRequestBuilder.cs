...
namespace ApiSdk.Policies.IdentitySecurityDefaultsEnforcementPolicy {
    ...
    public class IdentitySecurityDefaultsEnforcementPolicyRequestBuilder {
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(ApiSdk.Models.IdentitySecurityDefaultsEnforcementPolicy body, Action<IdentitySecurityDefaultsEnforcementPolicyRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
