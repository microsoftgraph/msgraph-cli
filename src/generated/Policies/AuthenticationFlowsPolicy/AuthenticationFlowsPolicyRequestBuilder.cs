...
namespace ApiSdk.Policies.AuthenticationFlowsPolicy {
    ...
    public class AuthenticationFlowsPolicyRequestBuilder {
        ...
        public AuthenticationFlowsPolicyRequestBuilder(Dictionary<string, object> pathParameters) {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.AuthenticationFlowsPolicy body, Action<AuthenticationFlowsPolicyRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.AuthenticationFlowsPolicy body, Action<AuthenticationFlowsPolicyRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
