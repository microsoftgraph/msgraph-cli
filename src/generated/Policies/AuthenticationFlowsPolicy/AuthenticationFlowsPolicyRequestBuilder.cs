...
namespace ApiSdk.Policies.AuthenticationFlowsPolicy {
    ...
    public class AuthenticationFlowsPolicyRequestBuilder {
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(ApiSdk.Models.AuthenticationFlowsPolicy body, Action<AuthenticationFlowsPolicyRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
