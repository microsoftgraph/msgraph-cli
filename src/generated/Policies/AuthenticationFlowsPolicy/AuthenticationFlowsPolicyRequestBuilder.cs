...
namespace ApiSdk.Policies.AuthenticationFlowsPolicy {
    ...
    public class AuthenticationFlowsPolicyRequestBuilder {
        ...
        /// <param name="options">Request options</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(ApiSdk.Models.AuthenticationFlowsPolicy body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
