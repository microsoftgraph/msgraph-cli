...
namespace ApiSdk.Policies.PermissionGrantPolicies {
    ...
    public class PermissionGrantPoliciesRequestBuilder {
        ...
        public Command BuildCommand() {
            ...
            var builder = new PermissionGrantPolicyItemRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildDeleteCommand());
            command.AddCommand(builder.BuildExcludesCommand());
            command.AddCommand(builder.BuildGetCommand());
            command.AddCommand(builder.BuildIncludesCommand());
