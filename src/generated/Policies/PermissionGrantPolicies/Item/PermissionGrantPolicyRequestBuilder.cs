...
namespace ApiSdk.Policies.PermissionGrantPolicies.Item {
    ...
    public class PermissionGrantPolicyRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string permissionGrantPolicyId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, permissionGrantPolicyIdOption, new ServiceProviderBinder());
            return command;
        }
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string permissionGrantPolicyId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, permissionGrantPolicyIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string permissionGrantPolicyId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, permissionGrantPolicyIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
