...
namespace ApiSdk.Policies.PermissionGrantPolicies.Item.Excludes.Item {
    ...
    public class PermissionGrantConditionSetItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public PermissionGrantConditionSetItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/policies/permissionGrantPolicies/{permissionGrantPolicy%2Did}/excludes/{permissionGrantConditionSet%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Deletes a permissionGrantConditionSet from the **excludes** collection of a permissionGrantPolicy.
        /// </summary>
