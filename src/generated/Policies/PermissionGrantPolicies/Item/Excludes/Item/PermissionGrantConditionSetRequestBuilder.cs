...
namespace ApiSdk.Policies.PermissionGrantPolicies.Item.Excludes.Item {
    ...
    public class PermissionGrantConditionSetRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string permissionGrantPolicyId, string permissionGrantConditionSetId, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                var requestInfo = CreateDeleteRequestInformation(q => {
                });
                await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                console.WriteLine("Success");
            }, permissionGrantPolicyIdOption, permissionGrantConditionSetIdOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// Condition sets which are excluded in this permission grant policy. Automatically expanded on GET.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string permissionGrantPolicyId, string permissionGrantConditionSetId, string[] select, string[] expand, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
            ...
            }, permissionGrantPolicyIdOption, permissionGrantConditionSetIdOption, selectOption, expandOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// Condition sets which are excluded in this permission grant policy. Automatically expanded on GET.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string permissionGrantPolicyId, string permissionGrantConditionSetId, string body, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                ...
                await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                console.WriteLine("Success");
            }, permissionGrantPolicyIdOption, permissionGrantConditionSetIdOption, bodyOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
