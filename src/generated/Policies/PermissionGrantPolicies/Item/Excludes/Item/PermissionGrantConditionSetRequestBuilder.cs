...
namespace ApiSdk.Policies.PermissionGrantPolicies.Item.Excludes.Item {
    ...
    public class PermissionGrantConditionSetRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string permissionGrantPolicyId, string permissionGrantConditionSetId, IConsole console) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string permissionGrantPolicyId, string permissionGrantConditionSetId, string[] select, string[] expand, FormatterType output, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string permissionGrantPolicyId, string permissionGrantConditionSetId, string body, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
