...
namespace ApiSdk.Policies.PermissionGrantPolicies.Item.Excludes {
    ...
    public class ExcludesRequestBuilder : BaseCliRequestBuilder {
        ...
        public ExcludesRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/policies/permissionGrantPolicies/{permissionGrantPolicy%2Did}/excludes{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Retrieve the condition sets which are *excluded* in a permissionGrantPolicy.
        /// </summary>
...
#nullable restore
        ...
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<ExcludesRequestBuilderGetQueryParameters>> requestConfiguration = default) {
            ...
            if (requestConfiguration != null) {
                var requestConfig = new RequestConfiguration<ExcludesRequestBuilderGetQueryParameters>();
