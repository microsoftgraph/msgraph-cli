...
namespace ApiSdk.Policies.PermissionGrantPolicies.Item.Includes.Item {
    ...
    public class PermissionGrantConditionSetRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string permissionGrantPolicyId, string permissionGrantConditionSetId, IOutputFormatterFactory outputFormatterFactory, CancellationToken cancellationToken) => {
                var requestInfo = CreateDeleteRequestInformation(q => {
                });
                await RequestAdapter.SendNoContentAsync(requestInfo, errorMapping: default, cancellationToken: cancellationToken);
                Console.WriteLine("Success");
            }, permissionGrantPolicyIdOption, permissionGrantConditionSetIdOption);
            return command;
        }
        /// <summary>
        /// Condition sets which are included in this permission grant policy. Automatically expanded on GET.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string permissionGrantPolicyId, string permissionGrantConditionSetId, string[] select, string[] expand, FormatterType output, IOutputFormatterFactory outputFormatterFactory, CancellationToken cancellationToken) => {
            ...
            }, permissionGrantPolicyIdOption, permissionGrantConditionSetIdOption, selectOption, expandOption, outputOption);
            return command;
        }
        /// <summary>
        /// Condition sets which are included in this permission grant policy. Automatically expanded on GET.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string permissionGrantPolicyId, string permissionGrantConditionSetId, string body, IOutputFormatterFactory outputFormatterFactory, CancellationToken cancellationToken) => {
                ...
                await RequestAdapter.SendNoContentAsync(requestInfo, errorMapping: default, cancellationToken: cancellationToken);
                Console.WriteLine("Success");
            }, permissionGrantPolicyIdOption, permissionGrantConditionSetIdOption, bodyOption);
            return command;
        }
        /// <summary>
