...
namespace ApiSdk.Policies.PermissionGrantPolicies.Item.Includes.Item {
    ...
    public class PermissionGrantConditionSetItemRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(permissionGrantPolicyIdOption, permissionGrantConditionSetIdOption, selectOption, expandOption, outputOption, outputFilterOption, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// Condition sets which are included in this permission grant policy. Automatically expanded on GET.
