...
namespace ApiSdk.Policies.CrossTenantAccessPolicy {
    ...
    public class CrossTenantAccessPolicyRequestBuilder {
        ...
        public Command BuildPartnersCommand() {
            ...
            var builder = new PartnersRequestBuilder(PathParameters, RequestAdapter);
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(ApiSdk.Models.CrossTenantAccessPolicy body, Action<CrossTenantAccessPolicyRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
