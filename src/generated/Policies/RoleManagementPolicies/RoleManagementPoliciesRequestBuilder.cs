...
namespace ApiSdk.Policies.RoleManagementPolicies {
    ...
    public class RoleManagementPoliciesRequestBuilder {
        ...
        public Command BuildCommand() {
            ...
            var builder = new UnifiedRoleManagementPolicyItemRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildDeleteCommand());
            command.AddCommand(builder.BuildEffectiveRulesCommand());
            command.AddCommand(builder.BuildGetCommand());
            command.AddCommand(builder.BuildPatchCommand());
            command.AddCommand(builder.BuildRulesCommand());
            return command;
        }
