...
namespace ApiSdk.Policies.RoleManagementPolicies.Item {
    ...
    public class UnifiedRoleManagementPolicyItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.Description = "Retrieve the details of a role management policy. This API is available in the following national cloud deployments.\n\nFind more info here:\n  https://learn.microsoft.com/graph/api/unifiedrolemanagementpolicy-get?view=graph-rest-1.0";
            var unifiedRoleManagementPolicyIdOption = new Option<string>("--unified-role-management-policy-id", description: "The unique identifier of unifiedRoleManagementPolicy") {
            };
            unifiedRoleManagementPolicyIdOption.IsRequired = true;
            command.AddOption(unifiedRoleManagementPolicyIdOption);
        ...
        public UnifiedRoleManagementPolicyItemRequestBuilder(string rawUrl) : base("{+baseurl}/policies/roleManagementPolicies/{unifiedRoleManagementPolicy%2Did}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Delete navigation property roleManagementPolicies for policies
        /// </summary>
