...
namespace ApiSdk.Policies.AuthorizationPolicy {
    ...
    public class AuthorizationPolicyRequestBuilder {
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public RequestInformation CreatePatchRequestInformation(ApiSdk.Models.AuthorizationPolicy body, Action<AuthorizationPolicyRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
