...
namespace ApiSdk.Policies.AuthorizationPolicy {
    ...
    public class AuthorizationPolicyRequestBuilder {
        ...
        public AuthorizationPolicyRequestBuilder(Dictionary<string, object> pathParameters) {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.AuthorizationPolicy body, Action<AuthorizationPolicyRequestBuilderPatchRequestConfiguration>? requestConfiguration = default) {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(ApiSdk.Models.AuthorizationPolicy body, Action<AuthorizationPolicyRequestBuilderPatchRequestConfiguration> requestConfiguration = default) {
#endif
