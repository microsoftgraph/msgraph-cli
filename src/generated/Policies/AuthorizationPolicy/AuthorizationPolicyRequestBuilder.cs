...
namespace ApiSdk.Policies.AuthorizationPolicy {
    ...
    public class AuthorizationPolicyRequestBuilder : BaseCliRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            command.Description = "Retrieve the properties of an authorizationPolicy object.\n\nFind more info here:\n  https://docs.microsoft.com/graph/api/authorizationpolicy-get?view=graph-rest-1.0";
        ...
        public AuthorizationPolicyRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/policies/authorizationPolicy{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Delete navigation property authorizationPolicy for policies
        /// </summary>
...
#nullable restore
        ...
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<AuthorizationPolicyRequestBuilderGetQueryParameters>> requestConfiguration = default) {
            ...
            if (requestConfiguration != null) {
                var requestConfig = new RequestConfiguration<AuthorizationPolicyRequestBuilderGetQueryParameters>();
                requestConfiguration.Invoke(requestConfig);
                requestInfo.AddQueryParameters(requestConfig.QueryParameters);
                requestInfo.AddRequestOptions(requestConfig.Options);
                requestInfo.AddHeaders(requestConfig.Headers);
