...
namespace ApiSdk.Policies.TokenLifetimePolicies.Item {
    ...
    public class TokenLifetimePolicyRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            }, tokenLifetimePolicyIdOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// The policy that controls the lifetime of a JWT access token, an ID token, or a SAML 1.1/2.0 token issued by Azure AD.
        ...
        public Command BuildGetCommand() {
            ...
            }, tokenLifetimePolicyIdOption, selectOption, expandOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// The policy that controls the lifetime of a JWT access token, an ID token, or a SAML 1.1/2.0 token issued by Azure AD.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string tokenLifetimePolicyId, string body, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                ...
                await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                console.WriteLine("Success");
            }, tokenLifetimePolicyIdOption, bodyOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
