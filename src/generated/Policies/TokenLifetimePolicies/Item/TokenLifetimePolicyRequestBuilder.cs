...
namespace ApiSdk.Policies.TokenLifetimePolicies.Item {
    ...
    public class TokenLifetimePolicyRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string tokenLifetimePolicyId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, tokenLifetimePolicyIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The policy that controls the lifetime of a JWT access token, an ID token, or a SAML 1.1/2.0 token issued by Azure AD.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string tokenLifetimePolicyId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, tokenLifetimePolicyIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The policy that controls the lifetime of a JWT access token, an ID token, or a SAML 1.1/2.0 token issued by Azure AD.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string tokenLifetimePolicyId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, tokenLifetimePolicyIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
