...
namespace ApiSdk.Policies.TokenLifetimePolicies {
    ...
    public class TokenLifetimePoliciesRequestBuilder {
        ...
        /// <param name="options">Request options</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(TokenLifetimePolicy body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
