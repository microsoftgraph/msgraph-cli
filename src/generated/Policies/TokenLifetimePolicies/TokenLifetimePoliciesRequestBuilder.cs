...
namespace ApiSdk.Policies.TokenLifetimePolicies {
    ...
    public class TokenLifetimePoliciesRequestBuilder {
        ...
        public List<Command> BuildCommand() {
            var builder = new TokenLifetimePolicyRequestBuilder(PathParameters, RequestAdapter);
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<TokenLifetimePolicy> PostAsync(TokenLifetimePolicy model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
