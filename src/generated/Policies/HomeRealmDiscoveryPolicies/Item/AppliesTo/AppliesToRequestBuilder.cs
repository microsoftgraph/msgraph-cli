...
namespace ApiSdk.Policies.HomeRealmDiscoveryPolicies.Item.AppliesTo {
    ...
    public class AppliesToRequestBuilder : BaseCliRequestBuilder {
        ...
        public AppliesToRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/policies/homeRealmDiscoveryPolicies/{homeRealmDiscoveryPolicy%2Did}/appliesTo{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Get appliesTo from policies
        /// </summary>
