...
namespace ApiSdk.Policies.FeatureRolloutPolicies.Item.AppliesTo.Item {
    ...
    public class DirectoryObjectRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            }, featureRolloutPolicyIdOption, directoryObjectIdOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// Nullable. Specifies a list of directoryObjects that feature is enabled for.
        ...
        public Command BuildGetCommand() {
            ...
            }, featureRolloutPolicyIdOption, directoryObjectIdOption, selectOption, expandOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// Nullable. Specifies a list of directoryObjects that feature is enabled for.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string featureRolloutPolicyId, string directoryObjectId, string body, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                ...
                await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                console.WriteLine("Success");
            }, featureRolloutPolicyIdOption, directoryObjectIdOption, bodyOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
