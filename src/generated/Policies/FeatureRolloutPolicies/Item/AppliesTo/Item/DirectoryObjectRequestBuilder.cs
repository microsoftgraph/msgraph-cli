...
namespace ApiSdk.Policies.FeatureRolloutPolicies.Item.AppliesTo.Item {
    ...
    public class DirectoryObjectRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string featureRolloutPolicyId, string directoryObjectId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, featureRolloutPolicyIdOption, directoryObjectIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// Nullable. Specifies a list of directoryObjects that feature is enabled for.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string featureRolloutPolicyId, string directoryObjectId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, featureRolloutPolicyIdOption, directoryObjectIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// Nullable. Specifies a list of directoryObjects that feature is enabled for.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string featureRolloutPolicyId, string directoryObjectId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, featureRolloutPolicyIdOption, directoryObjectIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
