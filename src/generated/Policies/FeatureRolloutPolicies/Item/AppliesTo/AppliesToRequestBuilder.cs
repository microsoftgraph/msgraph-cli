...
namespace ApiSdk.Policies.FeatureRolloutPolicies.Item.AppliesTo {
    ...
    public class AppliesToRequestBuilder {
        ...
        public Command BuildCreateCommand() {
            ...
            }, new CollectionBinding(featureRolloutPolicyIdOption, bodyOption, outputOption, queryOption, jsonNoIndentOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// Nullable. Specifies a list of directoryObjects that feature is enabled for.
