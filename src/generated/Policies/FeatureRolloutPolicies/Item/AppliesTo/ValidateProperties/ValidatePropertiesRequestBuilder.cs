...
namespace ApiSdk.Policies.FeatureRolloutPolicies.Item.AppliesTo.ValidateProperties {
    ...
    public class ValidatePropertiesRequestBuilder : BaseCliRequestBuilder {
        ...
        public ValidatePropertiesRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/policies/featureRolloutPolicies/{featureRolloutPolicy%2Did}/appliesTo/validateProperties", pathParameters) {
        }
        /// <summary>
        /// Invoke action validateProperties
        /// </summary>
