...
namespace ApiSdk.Policies.FeatureRolloutPolicies.Item {
    ...
    public class FeatureRolloutPolicyItemRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(featureRolloutPolicyIdOption, selectOption, expandOption, outputOption, queryOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// The feature rollout policy associated with a directory object.
