...
namespace ApiSdk.Policies.FeatureRolloutPolicies.Item {
    ...
    public class FeatureRolloutPolicyRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string featureRolloutPolicyId, IConsole console) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string featureRolloutPolicyId, string[] select, string[] expand, FormatterType output, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string featureRolloutPolicyId, string body, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
