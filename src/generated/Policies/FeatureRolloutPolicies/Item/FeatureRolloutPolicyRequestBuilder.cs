...
namespace ApiSdk.Policies.FeatureRolloutPolicies.Item {
    ...
    public class FeatureRolloutPolicyRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string featureRolloutPolicyId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, featureRolloutPolicyIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The feature rollout policy associated with a directory object.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string featureRolloutPolicyId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, featureRolloutPolicyIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The feature rollout policy associated with a directory object.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string featureRolloutPolicyId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, featureRolloutPolicyIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
