...
namespace ApiSdk.Policies.FeatureRolloutPolicies.Item {
    ...
    public class FeatureRolloutPolicyRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            }, featureRolloutPolicyIdOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// The feature rollout policy associated with a directory object.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string featureRolloutPolicyId, string[] select, string[] expand, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
            ...
            }, featureRolloutPolicyIdOption, selectOption, expandOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// The feature rollout policy associated with a directory object.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string featureRolloutPolicyId, string body, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                ...
                await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                console.WriteLine("Success");
            }, featureRolloutPolicyIdOption, bodyOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
