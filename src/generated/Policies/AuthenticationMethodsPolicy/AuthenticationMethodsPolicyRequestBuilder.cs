...
namespace ApiSdk.Policies.AuthenticationMethodsPolicy {
    ...
    public class AuthenticationMethodsPolicyRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.Description = "The authentication methods and the users that are allowed to use them to sign in and perform multi-factor authentication (MFA) in Azure Active Directory (Azure AD).";
