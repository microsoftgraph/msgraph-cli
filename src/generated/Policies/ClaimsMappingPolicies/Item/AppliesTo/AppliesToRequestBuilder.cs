...
namespace ApiSdk.Policies.ClaimsMappingPolicies.Item.AppliesTo {
    ...
    public class AppliesToRequestBuilder : BaseCliRequestBuilder {
        ...
        public AppliesToRequestBuilder(string rawUrl) : base("{+baseurl}/policies/claimsMappingPolicies/{claimsMappingPolicy%2Did}/appliesTo{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Get appliesTo from policies
        /// </summary>
