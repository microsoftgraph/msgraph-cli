...
namespace ApiSdk.Policies.ClaimsMappingPolicies.Item {
    ...
    public class ClaimsMappingPolicyRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            }, claimsMappingPolicyIdOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// The claim-mapping policies for WS-Fed, SAML, OAuth 2.0, and OpenID Connect protocols, for tokens issued to a specific application.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string claimsMappingPolicyId, string[] select, string[] expand, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
            ...
            }, claimsMappingPolicyIdOption, selectOption, expandOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// The claim-mapping policies for WS-Fed, SAML, OAuth 2.0, and OpenID Connect protocols, for tokens issued to a specific application.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string claimsMappingPolicyId, string body, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                ...
                await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                console.WriteLine("Success");
            }, claimsMappingPolicyIdOption, bodyOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
