...
namespace ApiSdk.Policies.ClaimsMappingPolicies.Item {
    ...
    public class ClaimsMappingPolicyRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            var claimsMappingPolicyIdOption = new Option<string>("--claimsmappingpolicy-id", description: "key: id of claimsMappingPolicy") {
            };
            claimsMappingPolicyIdOption.IsRequired = true;
            command.AddOption(claimsMappingPolicyIdOption);
            command.SetHandler(async (string claimsMappingPolicyId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, claimsMappingPolicyIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The claim-mapping policies for WS-Fed, SAML, OAuth 2.0, and OpenID Connect protocols, for tokens issued to a specific application.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string claimsMappingPolicyId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, claimsMappingPolicyIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// The claim-mapping policies for WS-Fed, SAML, OAuth 2.0, and OpenID Connect protocols, for tokens issued to a specific application.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string claimsMappingPolicyId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, claimsMappingPolicyIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
