...
namespace ApiSdk.Solutions.VirtualEvents.Webinars.GetByUserIdAndRoleWithUserIdWithRole {
    ...
    public class GetByUserIdAndRoleWithUserIdWithRoleRequestBuilder : BaseCliRequestBuilder {
        ...
        public GetByUserIdAndRoleWithUserIdWithRoleRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/solutions/virtualEvents/webinars/getByUserIdAndRole(userId='{userId}',role='{role}'){?%24count,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new GetByUserIdAndRoleWithUserIdWithRoleRequestBuilder and sets the default values.
        /// </summary>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public GetByUserIdAndRoleWithUserIdWithRoleRequestBuilder(string rawUrl) : base("{+baseurl}/solutions/virtualEvents/webinars/getByUserIdAndRole(userId='{userId}',role='{role}'){?%24count,%24filter,%24orderby,%24search,%24select,%24skip,%24top}", rawUrl) {
        }
        /// <summary>
        /// Invoke function getByUserIdAndRole
        /// </summary>
