...
namespace ApiSdk.Solutions {
    ...
    public class SolutionsRequestBuilder {
        ...
        public Command BuildBookingBusinessesCommand() {
            ...
            var builder = new BookingBusinessesRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildBookingCurrenciesCommand() {
            ...
            var builder = new BookingCurrenciesRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildCommand());
            command.AddCommand(builder.BuildCountCommand());
            command.AddCommand(builder.BuildCreateCommand());
            command.AddCommand(builder.BuildListCommand());
