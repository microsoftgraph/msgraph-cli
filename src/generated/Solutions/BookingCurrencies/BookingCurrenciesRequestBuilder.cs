...
namespace ApiSdk.Solutions.BookingCurrencies {
    ...
    public class BookingCurrenciesRequestBuilder {
        ...
        public List<Command> BuildCommand() {
            var builder = new BookingCurrencyRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildCreateCommand() {
            ...
            command.SetHandler(async (string body) => {
                ...
                var result = await RequestAdapter.SendAsync<BookingCurrency>(requestInfo);
        ...
        public Command BuildListCommand() {
            ...
            command.SetHandler(async (int? top, int? skip, string search, string filter, bool? count, string[] orderby, string[] select, string[] expand) => {
                ...
                var result = await RequestAdapter.SendAsync<BookingCurrenciesResponse>(requestInfo);
                // Print request output. What if the request has no return?
                using var serializer = RequestAdapter.SerializationWriterFactory.GetSerializationWriter("application/json");
                serializer.WriteObjectValue(null, result);
                using var content = serializer.GetSerializedContent();
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<BookingCurrency> PostAsync(BookingCurrency model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
