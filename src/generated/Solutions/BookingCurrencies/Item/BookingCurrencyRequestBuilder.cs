...
namespace ApiSdk.Solutions.BookingCurrencies.Item {
    ...
    public class BookingCurrencyRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string bookingCurrencyId, IConsole console) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string bookingCurrencyId, string[] select, string[] expand, FormatterType output, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string bookingCurrencyId, string body, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
