...
namespace ApiSdk.Solutions.BookingBusinesses {
    ...
    public class BookingBusinessesRequestBuilder {
        ...
        public List<Command> BuildCommand() {
            var builder = new BookingBusinessRequestBuilder(PathParameters, RequestAdapter);
            var commands = new List<Command> { 
                builder.BuildAppointmentsCommand(),
                builder.BuildCalendarViewCommand(),
                builder.BuildCustomersCommand(),
                builder.BuildCustomQuestionsCommand(),
                builder.BuildDeleteCommand(),
                builder.BuildGetCommand(),
                builder.BuildPatchCommand(),
                builder.BuildPublishCommand(),
                builder.BuildServicesCommand(),
                builder.BuildStaffMembersCommand(),
        ...
        public Command BuildListCommand() {
            ...
            command.Handler = CommandHandler.Create<int?, int?, string, string, bool?, string[], string[], string[]>(async (top, skip, search, filter, count, orderby, select, expand) => {
                ...
                var result = await RequestAdapter.SendAsync<BookingBusinessesResponse>(requestInfo);
                // Print request output. What if the request has no return?
                using var serializer = RequestAdapter.SerializationWriterFactory.GetSerializationWriter("application/json");
                serializer.WriteObjectValue(null, result);
                using var content = serializer.GetSerializedContent();
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task<BookingBusiness> PostAsync(BookingBusiness model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
