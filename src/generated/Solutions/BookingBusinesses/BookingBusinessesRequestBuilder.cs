...
namespace ApiSdk.Solutions.BookingBusinesses {
    ...
    public class BookingBusinessesRequestBuilder {
        ...
        public Command BuildCommand() {
            ...
            var builder = new BookingBusinessItemRequestBuilder(PathParameters, RequestAdapter);
            command.AddCommand(builder.BuildAppointmentsCommand());
            command.AddCommand(builder.BuildCalendarViewCommand());
            command.AddCommand(builder.BuildCustomersCommand());
