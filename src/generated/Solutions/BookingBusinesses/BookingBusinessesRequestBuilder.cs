...
namespace ApiSdk.Solutions.BookingBusinesses {
    ...
    public class BookingBusinessesRequestBuilder {
        ...
        public List<Command> BuildCommand() {
            ...
            commands.Add(builder.BuildAppointmentsCommand());
            commands.Add(builder.BuildCalendarViewCommand());
            commands.Add(builder.BuildCustomersCommand());
            commands.Add(builder.BuildCustomQuestionsCommand());
            commands.Add(builder.BuildDeleteCommand());
            commands.Add(builder.BuildGetCommand());
            commands.Add(builder.BuildPatchCommand());
            commands.Add(builder.BuildPublishCommand());
            commands.Add(builder.BuildServicesCommand());
            commands.Add(builder.BuildStaffMembersCommand());
