...
namespace ApiSdk.Solutions.BookingBusinesses.Item.MicrosoftGraphGetStaffAvailability {
    /// <summary>
    ...
    public class GetStaffAvailabilityRequestBuilder {
        ...
        public GetStaffAvailabilityRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/solutions/bookingBusinesses/{bookingBusiness%2Did}/microsoft.graph.getStaffAvailability";
