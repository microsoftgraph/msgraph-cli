...
namespace ApiSdk.Solutions.BookingBusinesses.Item.Customers {
    ...
    public class CustomersRequestBuilder {
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(BookingCustomerBase body, Action<CustomersRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
