...
namespace ApiSdk.Solutions.BookingBusinesses.Item.Customers.Item {
    ...
    public class BookingCustomerBaseRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string bookingBusinessId, string bookingCustomerBaseId, IConsole console) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string bookingBusinessId, string bookingCustomerBaseId, string[] select, string[] expand, FormatterType output, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string bookingBusinessId, string bookingCustomerBaseId, string body, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
