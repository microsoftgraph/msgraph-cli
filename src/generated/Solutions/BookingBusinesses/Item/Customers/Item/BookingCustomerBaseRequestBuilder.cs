...
namespace ApiSdk.Solutions.BookingBusinesses.Item.Customers.Item {
    ...
    public class BookingCustomerBaseRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string bookingBusinessId, string bookingCustomerBaseId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, bookingBusinessIdOption, bookingCustomerBaseIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// All the customers of this business. Read-only. Nullable.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string bookingBusinessId, string bookingCustomerBaseId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, bookingBusinessIdOption, bookingCustomerBaseIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// All the customers of this business. Read-only. Nullable.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string bookingBusinessId, string bookingCustomerBaseId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, bookingBusinessIdOption, bookingCustomerBaseIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
