...
namespace ApiSdk.Solutions.BookingBusinesses.Item.CalendarView {
    ...
    public class CalendarViewRequestBuilder {
        ...
        public Command BuildCommand() {
            ...
            var builder = new BookingAppointmentItemRequestBuilder(PathParameters, RequestAdapter);
        ...
        public CalendarViewRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) {
            ...
            UrlTemplate = "{+baseurl}/solutions/bookingBusinesses/{bookingBusiness%2Did}/calendarView{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}";
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// </summary>
        public RequestInformation CreatePostRequestInformation(BookingAppointment body, Action<CalendarViewRequestBuilderPostRequestConfiguration> requestConfiguration = default) {
