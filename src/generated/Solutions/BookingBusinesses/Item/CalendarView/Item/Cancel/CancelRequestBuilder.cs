    ...
    public class CancelRequestBuilder {
        ...
        public Command BuildPostCommand() {
            ...
            command.SetHandler(async (object[] parameters) => {
                ...
                var model = parseNode.GetObjectValue<ApiSdk.Solutions.BookingBusinesses.Item.CalendarView.Item.Cancel.CancelRequestBody>(ApiSdk.Solutions.BookingBusinesses.Item.CalendarView.Item.Cancel.CancelRequestBody.CreateFromDiscriminatorValue);
        ...
        /// </summary>
        public RequestInformation CreatePostRequestInformation(ApiSdk.Solutions.BookingBusinesses.Item.CalendarView.Item.Cancel.CancelRequestBody body, Action<IDictionary<string, string>> headers = default, IEnumerable<IRequestOption> options = default) {
