...
namespace ApiSdk.Solutions.BookingBusinesses.Item.Appointments.Item {
    ...
    public class BookingAppointmentRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string bookingBusinessId, string bookingAppointmentId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, bookingBusinessIdOption, bookingAppointmentIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// All the appointments of this business. Read-only. Nullable.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string bookingBusinessId, string bookingAppointmentId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, bookingBusinessIdOption, bookingAppointmentIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// All the appointments of this business. Read-only. Nullable.
        ...
        /// <param name="responseHandler">Response handler to use in place of the default response handling provided by the core service</param>
        /// </summary>
        public async Task PatchAsync(BookingAppointment model, Action<IDictionary<string, string>> h = default, IEnumerable<IRequestOption> o = default, IResponseHandler responseHandler = default, CancellationToken cancellationToken = default) {
