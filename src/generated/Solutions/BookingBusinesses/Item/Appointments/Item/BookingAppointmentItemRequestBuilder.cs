...
namespace ApiSdk.Solutions.BookingBusinesses.Item.Appointments.Item {
    ...
    public class BookingAppointmentItemRequestBuilder : BaseCliRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.Description = "Delete a bookingAppointment in the specified bookingBusiness.\n\nFind more info here:\n  https://docs.microsoft.com/graph/api/bookingappointment-delete?view=graph-rest-1.0";
        ...
        public BookingAppointmentItemRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/solutions/bookingBusinesses/{bookingBusiness%2Did}/appointments/{bookingAppointment%2Did}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Delete a bookingAppointment in the specified bookingBusiness.
        /// </summary>
