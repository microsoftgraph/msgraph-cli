...
namespace ApiSdk.Solutions.BookingBusinesses.Item.CustomQuestions.Item {
    ...
    public class BookingCustomQuestionRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string bookingBusinessId, string bookingCustomQuestionId) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string bookingBusinessId, string bookingCustomQuestionId, string[] select, string[] expand) => {
                var requestInfo = CreateGetRequestInformation(q => {
                    q.Select = select;
                    q.Expand = expand;
                });
                var result = await RequestAdapter.SendAsync<BookingCustomQuestion>(requestInfo);
                // Print request output. What if the request has no return?
            ...
            }, bookingBusinessIdOption, bookingCustomQuestionIdOption, selectOption, expandOption);
            return command;
        }
        /// <summary>
        /// All the custom questions of this business. Read-only. Nullable.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string bookingBusinessId, string bookingCustomQuestionId, string body) => {
