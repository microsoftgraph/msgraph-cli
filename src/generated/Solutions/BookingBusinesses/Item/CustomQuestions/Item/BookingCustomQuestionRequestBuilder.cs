...
namespace ApiSdk.Solutions.BookingBusinesses.Item.CustomQuestions.Item {
    ...
    public class BookingCustomQuestionRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string bookingBusinessId, string bookingCustomQuestionId, IConsole console) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string bookingBusinessId, string bookingCustomQuestionId, string[] select, string[] expand, FormatterType output, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string bookingBusinessId, string bookingCustomQuestionId, string body, IConsole console) => {
                var responseHandler = new NativeResponseHandler();
