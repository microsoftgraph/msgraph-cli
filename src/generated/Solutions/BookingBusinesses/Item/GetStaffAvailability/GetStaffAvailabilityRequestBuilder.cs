...
namespace ApiSdk.Solutions.BookingBusinesses.Item.GetStaffAvailability {
    ...
    public class GetStaffAvailabilityRequestBuilder {
        ...
        public GetStaffAvailabilityRequestBuilder(Dictionary<string, object> pathParameters) {
            _ = pathParameters ?? throw new ArgumentNullException(nameof(pathParameters));
            UrlTemplate = "{+baseurl}/solutions/bookingBusinesses/{bookingBusiness%2Did}/getStaffAvailability";
