...
namespace ApiSdk.Solutions.BookingBusinesses.Item.StaffMembers.Item {
    ...
    public class BookingStaffMemberBaseItemRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(bookingBusinessIdOption, bookingStaffMemberBaseIdOption, selectOption, expandOption, outputOption, outputFilterOption, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// All the staff members that provide services in this business. Read-only. Nullable.
