...
namespace ApiSdk.Solutions.BookingBusinesses.Item.StaffMembers {
    ...
    public class StaffMembersRequestBuilder : BaseCliRequestBuilder {
        ...
        public Tuple<List<Command>, List<Command>> BuildCommand() {
            ...
            var builder = new BookingStaffMemberBaseItemRequestBuilder(PathParameters);
...
#nullable restore
        ...
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<StaffMembersRequestBuilderGetQueryParameters>> requestConfiguration = default) {
            ...
            if (requestConfiguration != null) {
                var requestConfig = new RequestConfiguration<StaffMembersRequestBuilderGetQueryParameters>();
