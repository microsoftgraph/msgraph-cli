...
namespace ApiSdk.Solutions.BookingBusinesses.Item.Services.Item {
    ...
    public class BookingServiceRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string bookingBusinessId, string bookingServiceId, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                var requestInfo = CreateDeleteRequestInformation(q => {
                });
                await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                console.WriteLine("Success");
            }, bookingBusinessIdOption, bookingServiceIdOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// All the services offered by this business. Read-only. Nullable.
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string bookingBusinessId, string bookingServiceId, string[] select, string[] expand, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
            ...
            }, bookingBusinessIdOption, bookingServiceIdOption, selectOption, expandOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// All the services offered by this business. Read-only. Nullable.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string bookingBusinessId, string bookingServiceId, string body, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                ...
                await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                console.WriteLine("Success");
            }, bookingBusinessIdOption, bookingServiceIdOption, bodyOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
