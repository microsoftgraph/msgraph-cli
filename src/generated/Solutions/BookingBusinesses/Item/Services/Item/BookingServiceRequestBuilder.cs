...
namespace ApiSdk.Solutions.BookingBusinesses.Item.Services.Item {
    ...
    public class BookingServiceRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string bookingBusinessId, string bookingServiceId) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string bookingBusinessId, string bookingServiceId, string[] select, string[] expand) => {
            ...
            }, bookingBusinessIdOption, bookingServiceIdOption, selectOption, expandOption);
            return command;
        }
        /// <summary>
        /// All the services offered by this business. Read-only. Nullable.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string bookingBusinessId, string bookingServiceId, string body) => {
