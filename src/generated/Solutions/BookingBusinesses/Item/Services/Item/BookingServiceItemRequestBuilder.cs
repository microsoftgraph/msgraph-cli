...
namespace ApiSdk.Solutions.BookingBusinesses.Item.Services.Item {
    ...
    public class BookingServiceItemRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(bookingBusinessIdOption, bookingServiceIdOption, selectOption, expandOption, outputOption, queryOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// All the services offered by this business. Read-only. Nullable.
