...
namespace ApiSdk.Planner.Buckets.Item.Tasks.Item {
    ...
    public class PlannerTaskRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string plannerBucketId, string plannerTaskId) => {
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string plannerBucketId, string plannerTaskId, string[] select, string[] expand) => {
            ...
            }, plannerBucketIdOption, plannerTaskIdOption, selectOption, expandOption);
            return command;
        }
        /// <summary>
        /// Read-only. Nullable. The collection of tasks in the bucket.
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string plannerBucketId, string plannerTaskId, string body) => {
