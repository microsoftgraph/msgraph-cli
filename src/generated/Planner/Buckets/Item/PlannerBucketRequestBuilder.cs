...
namespace ApiSdk.Planner.Buckets.Item {
    ...
    public class PlannerBucketRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            command.SetHandler(async (string plannerBucketId, IServiceProvider serviceProvider, IConsole console) => {
            ...
            }, plannerBucketIdOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// Read-only. Nullable. Returns a collection of the specified buckets
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string plannerBucketId, string[] select, string[] expand, FormatterType output, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
            ...
            }, plannerBucketIdOption, selectOption, expandOption, outputOption, new ServiceProviderBinder());
            return command;
        }
        /// <summary>
        /// Read-only. Nullable. Returns a collection of the specified buckets
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string plannerBucketId, string body, IServiceProvider serviceProvider, IConsole console) => {
                var responseHandler = serviceProvider.GetService(typeof(IResponseHandler)) as IResponseHandler;
                ...
                // Print request output. What if the request has no return?
                console.WriteLine("Success");
            }, plannerBucketIdOption, bodyOption, new ServiceProviderBinder());
            return command;
        }
