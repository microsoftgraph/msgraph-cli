...
namespace ApiSdk.Planner.Buckets.Item {
    ...
    public class PlannerBucketRequestBuilder {
        ...
        public Command BuildDeleteCommand() {
            ...
            }, plannerBucketIdOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// Read-only. Nullable. Returns a collection of the specified buckets
        ...
        public Command BuildGetCommand() {
            ...
            command.SetHandler(async (string plannerBucketId, string[] select, string[] expand, FormatterType output, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
            ...
            }, plannerBucketIdOption, selectOption, expandOption, outputOption, new OutputFormatterFactoryBinder());
            return command;
        }
        /// <summary>
        /// Read-only. Nullable. Returns a collection of the specified buckets
        ...
        public Command BuildPatchCommand() {
            ...
            command.SetHandler(async (string plannerBucketId, string body, IOutputFormatterFactory outputFormatterFactory, IConsole console) => {
                ...
                await RequestAdapter.SendPrimitiveAsync<Stream>(requestInfo);
                console.WriteLine("Success");
            }, plannerBucketIdOption, bodyOption, new OutputFormatterFactoryBinder());
            return command;
        }
