...
namespace ApiSdk.Planner.Plans.Item {
    ...
    public class PlannerPlanRequestBuilder {
        ...
        public Command BuildBucketsCommand() {
            ...
            var builder = new ApiSdk.Planner.Plans.Item.Buckets.BucketsRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildDetailsCommand() {
            ...
            var builder = new ApiSdk.Planner.Plans.Item.Details.DetailsRequestBuilder(PathParameters, RequestAdapter);
        ...
        public Command BuildTasksCommand() {
            ...
            var builder = new ApiSdk.Planner.Plans.Item.Tasks.TasksRequestBuilder(PathParameters, RequestAdapter);
            foreach (var cmd in builder.BuildCommand()) {
                command.AddCommand(cmd);
            }
            command.AddCommand(builder.BuildCreateCommand());
