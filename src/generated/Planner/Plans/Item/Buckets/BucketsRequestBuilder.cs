...
namespace ApiSdk.Planner.Plans.Item.Buckets {
    ...
    public class BucketsRequestBuilder : BaseCliRequestBuilder {
        ...
        public BucketsRequestBuilder(string rawUrl) : base("{+baseurl}/planner/plans/{plannerPlan%2Did}/buckets{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
        /// Retrieve a list of plannerBucket objects contained by a plannerPlan object. This API is available in the following national cloud deployments.
        /// </summary>
