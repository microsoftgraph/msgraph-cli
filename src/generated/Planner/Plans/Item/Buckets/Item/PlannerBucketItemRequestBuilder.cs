...
namespace ApiSdk.Planner.Plans.Item.Buckets.Item {
    ...
    public class PlannerBucketItemRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(plannerPlanIdOption, plannerBucketIdOption, selectOption, expandOption, outputOption, outputFilterOption, new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// Collection of buckets in the plan. Read-only. Nullable.
