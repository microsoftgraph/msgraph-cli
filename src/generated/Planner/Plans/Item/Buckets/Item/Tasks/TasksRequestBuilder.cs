...
namespace ApiSdk.Planner.Plans.Item.Buckets.Item.Tasks {
    ...
    public class TasksRequestBuilder {
        ...
        public Command BuildListCommand() {
            ...
            command.Handler = CommandHandler.Create<string, string, int?, int?, string, string, bool?, object, object, object>(async (plannerPlanId, plannerBucketId, top, skip, search, filter, count, orderby, select, expand) => {
