...
namespace ApiSdk.Planner.Plans.Item.Tasks {
    ...
    public class TasksRequestBuilder : BaseCliRequestBuilder {
        ...
        public TasksRequestBuilder(Dictionary<string, object> pathParameters) : base("{+baseurl}/planner/plans/{plannerPlan%2Did}/tasks{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Retrieve a list of plannerTask objects associated with a plannerPlan object.
        /// </summary>
