...
namespace ApiSdk.Planner.Plans.Item.Tasks.Item {
    ...
    public class PlannerTaskItemRequestBuilder {
        ...
        public Command BuildGetCommand() {
            ...
            }, new CollectionBinding(plannerPlanIdOption, plannerTaskIdOption, selectOption, expandOption, outputOption, queryOption, new TypeBinding(typeof(IOutputFilter)), new TypeBinding(typeof(IOutputFormatterFactory)), new TypeBinding(typeof(CancellationToken))));
            return command;
        }
        /// <summary>
        /// Collection of tasks in the plan. Read-only. Nullable.
